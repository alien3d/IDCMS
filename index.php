...
$newFakeDocumentRoot = str_replace("index.php/", "", str_replace("//", "/", $fakeDocumentRoot)); // start
...
@font-face {
  ...
  src: local('Open Sans Bold Italic'), local('OpenSans-BoldItalic'), url('./fonts/open_sans_italic_700.woff') format('woff');
	...
	<body id="login">
		...
		<header id="header">
			...
			<div id="logo-group">
				<span id="logo"> <img src="img/logo.png" alt="Sn"> </span>
			...
			<div id="content" class="container">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-7 col-lg-7 hidden-xs hidden-sm">
						<h1 class="txt-color-red login-header-big">IDCMS APPLICATION SUITE</h1>
						<div class="hero">

							<div class="pull-left login-desc-box-l">
								<h4 class="paragraph-header">Mostly Enterprise Application Is Suck !!! . Sometimes we need both version Simple and Complex.</h4>
						  <div class="login-app-icons">
									<a href="javascript:void(0);" class="btn btn-danger btn-sm">Simple Review</a>
									<a href="javascript:void(0);" class="btn btn-danger btn-sm">Complex Version Review</a>
								</div>
							</div>
						...
						<div class="row">
							<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
								<h5 class="about-heading">Simple ?</h5>
						  <p>I just simple invoice to customer and see my cashflow,</p>
						  </div>
							<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
								<h5 class="about-heading">Complex</h5>
						  <p>
									We need approval process on each of our department  same as other ERP solution.</p>
							</div>
						</div>
 ...
 <div id="left">
            ...
            <h1>SMARTADMIN TERMS AND CONDITIONS TEMPLATE</h1>
