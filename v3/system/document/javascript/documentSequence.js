function getApplication(leafId, url, securityToken) {
    $.ajax({
        type: 'GET',
        url: url,
        data: {
        ...
        success: function(data) {
            ...
            if (success === false) {
                ...
                $("#applicationId").html('').empty().html(data.data).trigger("chosen:updated");
...
function getModule(leafId, url, securityToken) {
    $.ajax({
        type: 'GET',
        url: url,
        data: {
...
function checkDuplicate(leafId, page, securityToken) {
    var $documentSequenceCode = $("#documentSequenceCode");
    if ($documentSequenceCode.val().length === 0) {
    ...
    $.ajax({
        ...
        url: page,
        data: {
            documentSequenceCode: $documentSequenceCode.val(),
            method: 'duplicate',
            securityToken: securityToken,
            leafId: leafId
        },
        ...
        success: function(data) {
            ...
            if (success === true) {
                if (total !== 0) {
                    $("#documentSequenceCode").val('').focus();
                    $("#documentSequenceCodeForm").removeClass().addClass("form-group has-error");
                ...
                $("#documentSequenceForm").removeClass().addClass("form-group has-error");
            }
            if ($infoPanel.is(':hidden')) {
                $infoPanel.show();
            }
...
function showFormUpdate(leafId, url, urlList, securityToken, documentSequenceId, updateAccess, deleteAccess) {
    sleep(500);
...
function showModalDelete(documentSequenceId, applicationId, moduleId, documentSequenceCode, documentSequenceNumber, documentSequenceStart, documentSequenceEnd, documentSequenceDescription) {
    $('#documentSequenceIdPreview').val('').val(decodeURIComponent(documentSequenceId));
    $('#applicationIdPreview').val('').val(decodeURIComponent(applicationId));
    $('#moduleIdPreview').val('').val(decodeURIComponent(moduleId));
    $('#documentSequenceCodePreview').val('').val(decodeURIComponent(documentSequenceCode));
    $('#documentSequenceNumberPreview').val('').val(decodeURIComponent(documentSequenceNumber));
    $('#documentSequenceStartPreview').val('').val(decodeURIComponent(documentSequenceStart));
    $('#documentSequenceEndPreview').val('').val(decodeURIComponent(documentSequenceEnd));
    $('#documentSequenceDescriptionPreview').val('').val(decodeURIComponent(documentSequenceDescription));
...
function deleteGridRecord(leafId, url, urlList, securityToken) {
    $.ajax({
        ...
        data: {
            method: 'delete',
            output: 'json',
            documentSequenceId: $('#documentSequenceIdPreview').val(),
            securityToken: securityToken,
            leafId: leafId
        },
        beforeSend: function() {
...
function deleteGridRecordCheckbox(leafId, url, urlList, securityToken) {
    var stringText = '';
    var counter = 0;
    $('input:checkbox[name="documentSequenceId[]"]').each(function() {
        stringText = stringText + "&documentSequenceId[]=" + $(this).val();
    });
...
function newRecord(leafId, url, urlList, securityToken, type, createAccess, updateAccess, deleteAccess) {
    ...
    var $documentSequenceCode = $('#documentSequenceCode');
    var $documentSequenceNumber = $('#documentSequenceNumber');
    var $documentSequenceStart = $('#documentSequenceStart');
    var $documentSequenceEnd = $('#documentSequenceEnd');
    var $documentSequenceDescription = $('#documentSequenceDescription');
    if (css.search('disabled') > 0) {
        return false;
    } else {
        if (type === 1) {
            if ($applicationId.val().length === 0) {
                ...
                $applicationId.data('chosen').activate_action();
                return false;
            }
            if ($moduleId.val().length === 0) {
                ...
                $moduleId.data('chosen').activate_action();
                return false;
            }
            if ($documentSequenceCode.val().length === 0) {
                $('#documentSequenceCodeHelpMe').html('').empty().html("<span class='label label-important'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['documentSequenceCodeLabel'] + " </span>");
                $('#documentSequenceCodeForm').removeClass().addClass('form-group has-error');
                $documentSequenceCode.focus();
                return false;
            }
            if ($documentSequenceNumber.val().length === 0) {
                $('#documentSequenceNumberHelpMe').html('').empty().html("<span class='label label-important'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['documentSequenceNumberLabel'] + " </span>");
                $('#documentSequenceNumberForm').removeClass().addClass('form-group has-error');
                $documentSequenceNumber.focus();
                return false;
            }
            if ($documentSequenceStart.val().length === 0) {
                $('#documentSequenceStartHelpMe').html('').empty().html("<span class='label label-important'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['documentSequenceStartLabel'] + " </span>");
                $('#documentSequenceStartForm').removeClass().addClass('form-group has-error');
                $documentSequenceStart.focus();
                return false;
            }
            if ($documentSequenceEnd.val().length === 0) {
                $('#documentSequenceEndHelpMe').html('').empty().html("<span class='label label-important'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['documentSequenceEndLabel'] + " </span>");
                $('#documentSequenceEndForm').removeClass().addClass('form-group has-error');
                $documentSequenceEnd.focus();
                return false;
            }
            if ($documentSequenceDescription.val().length === 0) {
                $('#documentSequenceDescriptionHelpMe').html('').empty().html("<span class='label label-important'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['documentSequenceDescriptionLabel'] + " </span>");
                $('#documentSequenceDescriptionForm').removeClass().addClass('form-group has-error');
                $documentSequenceDescription.focus();
                return false;
            }
            $.ajax({
                type: 'POST',
                ...
                data: {
                    ...
                    documentSequenceCode: $documentSequenceCode.val(),
                    documentSequenceNumber: $documentSequenceNumber.val(),
                    documentSequenceStart: $documentSequenceStart.val(),
                    documentSequenceEnd: $documentSequenceEnd.val(),
                    documentSequenceDescription: $documentSequenceDescription.val(),
                    securityToken: securityToken,
                    leafId: leafId
                },
                beforeSend: function() {
                ...
                success: function(data) {
                    ...
                    if (success === true) {
                        ...
                        $documentSequenceCode.val('');
                        $('#documentSequenceCodeHelpMe').html('').empty();
                        $documentSequenceNumber.val('');
                        $('#documentSequenceNumberHelpMe').html('').empty();
                        $documentSequenceStart.val('');
                        $('#documentSequenceStartHelpMe').html('').empty();
                        $documentSequenceEnd.val('');
                        $('#documentSequenceEndHelpMe').html('').empty();
                        $documentSequenceDescription.val('');
                        $('#documentSequenceDescriptionForm').removeClass().addClass('form-group');
                        $('#documentSequenceDescriptionHelpMe').html('').empty();
                    } else if (success === false) {
                        $infoPanel.html('').empty().html("<span class='label label-important'>&nbsp;" + message + "</span>");
                        if ($infoPanel.is(':hidden')) {
                            $infoPanel.show();
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (success === true) {
                        ...
                        $('#documentSequenceId').val(data.documentSequenceId);
                        $('#newRecordButton1').removeClass().addClass('btn btn-success disabled').attr('onClick', '');
                        $('#newRecordButton2').removeClass().addClass('btn dropdown-toggle btn-success disabled');
                        $('#newRecordButton3').attr('onClick', '');
                        $('#newRecordButton4').attr('onClick', '');
        ...
        if (type === 1) {
            ...
            $.ajax({
                ...
                data: {
                    method: 'save',
                    output: 'json',
                    documentSequenceId: $documentSequenceId.val(),
                    applicationId: $applicationId.val(),
                    moduleId: $moduleId.val(),
                    documentSequenceCode: $documentSequenceCode.val(),
                    documentSequenceNumber: $documentSequenceNumber.val(),
...
function deleteRecord(leafId, url, urlList, securityToken, deleteAccess) {
    var $infoPanel = $('#infoPanel');
    var $documentSequenceId = $('#documentSequenceId');
    ...
    if (css.search('disabled') > 0) {
        ...
        if (deleteAccess === 1) {
            if (confirm(decodeURIComponent(t['deleteRecordMessageLabel']))) {
                var value = $documentSequenceId.val();
                if (!value) {
...
function resetRecord(leafId, url, urlList, securityToken, createAccess, updateAccess, deleteAccess) {
    ...
    $("#documentSequenceId").val('');
    $("#documentSequenceIdHelpMe").empty().html('');
    ...
    $('#moduleId').trigger("chosen:updated");
    $("#documentSequenceCode").val('');
    $("#documentSequenceCodeHelpMe").empty().html('');
    $("#documentSequenceNumber").val('');
    $("#documentSequenceNumberHelpMe").empty().html('');
    $("#documentSequenceStart").val('');
    $("#documentSequenceStartHelpMe").empty().html('');
    $("#documentSequenceEnd").val('');
    $("#documentSequenceEndHelpMe").empty().html('');
    $("#documentSequenceDescription").val('');
    $("#documentSequenceDescriptionHelpMe").empty().html('');
    $('#documentSequenceDescription').empty().val('');
}
function postRecord() {
            ...
            success: function(data) {
                ...
                if (success === true) {
                    $.ajax({
                        ...
                        data: {
                            method: 'read',
                            documentSequenceId: firstRecord,
                            output: 'json',
                            securityToken: securityToken,
                            leafId: leafId
                        },
                        ...
                        success: function(data) {
                            ...
                            if (success === true) {
                                $('#documentSequenceId').val(data.data.documentSequenceId);
                                $('#applicationId').val(data.data.applicationId).trigger("chosen:updated");
                                $('#moduleId').val(data.data.moduleId).trigger("chosen:updated");
                                $('#documentSequenceCode').val(data.data.documentSequenceCode);
                                $('#documentSequenceNumber').val(data.data.documentSequenceNumber);
                                $('#documentSequenceStart').val(data.data.documentSequenceStart);
                                $('#documentSequenceEnd').val(data.data.documentSequenceEnd);
                                $('#documentSequenceDescription').val(data.data.documentSequenceDescription);
                                if (nextRecord > 0) {
                                    $('#previousRecordButton').removeClass().addClass('btn btn-default disabled').attr('onClick', '');
    ...
    if (css.search('disabled') > 0) {
        ...
        if (parseFloat($previousRecordCounter.val()) > 0 && parseFloat($previousRecordCounter.val()) < parseFloat($('#lastRecordCounter').val())) {
            $.ajax({
                ...
                data: {
                    method: 'read',
                    documentSequenceId: $previousRecordCounter.val(),
                    output: 'json',
                    securityToken: securityToken,
                    leafId: leafId
                },
    ...
    if (css.search('disabled') > 0) {
        ...
        if (parseFloat($nextRecordCounter.val()) <= parseFloat($('#lastRecordCounter').val())) {
            $.ajax({
                ...
                data: {
                    method: 'read',
                    documentSequenceId: $nextRecordCounter.val(),
                    output: 'json',
                    securityToken: securityToken,
                    leafId: leafId
                },
