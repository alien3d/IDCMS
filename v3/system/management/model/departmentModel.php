 ...
 * @version 2
 * @author hafizan
 * @package Core\System\Management\Department\Model;
...
class DepartmentModel extends ValidationClass {
    ...
    public function execute() {
        ...
        $this->setMasterForeignKeyName('departmentId');
        $this->setFilterCharacter('departmentDescription');
        //$this->setFilterCharacter('departmentNote');
        $this->setFilterDate('executeTime');
        /**
         * All the $_POST Environment
         */
        if (isset($_POST ['departmentId'])) {
            $this->setDepartmentId($this->strict($_POST ['departmentId'], 'int'), 0, 'single');
        }
        ...
        if (isset($_POST ['departmentCode'])) {
            $this->setDepartmentCode($this->strict($_POST ['departmentCode'], 'string'));
        }
        if (isset($_POST ['departmentDescription'])) {
            $this->setDepartmentDescription($this->strict($_POST ['departmentDescription'], 'string'));
        }
        /**
         * All the $_GET Environment
         */
        if (isset($_GET ['departmentId'])) {
            $this->setDepartmentId($this->strict($_GET ['departmentId'], 'int'), 0, 'single');
        }
        ...
        if (isset($_GET ['departmentCode'])) {
            $this->setDepartmentCode($this->strict($_GET ['departmentCode'], 'string'));
        }
        if (isset($_GET ['departmentDescription'])) {
            $this->setDepartmentDescription($this->strict($_GET ['departmentDescription'], 'string'));
        }
        if (isset($_GET ['departmentId'])) {
     ...
     * @return \Core\System\Management\Department\Model\DepartmentModel
     */
    public function setDepartmentId($value, $key, $type) {
        if ($type == 'single') {
            ...
            if ($type == 'array') {
                ...
                echo json_encode(
                        array("success" => false, "message" => "Cannot Identify Type String Or Array:setDepartmentId?")
                );
                exit();
            }
        }
    ...
    public function getDepartmentId($key, $type) {
        if ($type == 'single') {
            ...
            if ($type == 'array') {
                ...
                echo json_encode(
                        array("success" => false, "message" => "Cannot Identify Type String Or Array:getDepartmentId ?")
                );
                exit();
            }
        }
    ...
    /**
     * To Set Code
     * @param string $departmentCode Code
     * @return \Core\System\Management\Department\Model\DepartmentModel
     */
    ...
    /**
     * To Set Description
     * @param string $departmentDescription Description
     * @return \Core\System\Management\Department\Model\DepartmentModel
     */
