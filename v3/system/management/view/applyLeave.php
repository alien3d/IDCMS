...
if (isset($_POST['method']) && isset($_POST['type'])) {
    if ($_POST['method'] == 'read' && $_POST['type'] == 'list') {
        ?>
        <input type="hidden" name="from" id="from" value="personnel">
        <div class="row">
                    ...
                    <div class="panel panel-default">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                        ...
                                                        <div class="form-group" id="leaveStartDateDiv">
                                                            ...
                                                            <div class="col-xs-8 col-sm-8 col-md-8">
                                                                <input type="text" class="form-control" name="leaveStartDatePreview"
                                                        ...
                                                        <div class="form-group" id="leaveEndDateDiv">
                                                            ...
                                                            <div class="col-xs-8 col-sm-8 col-md-8">
                                                                <input type="text" class="form-control" name="leaveEndDatePreview"
                                                        ...
                                                        <div class="form-group" id="leaveDescriptionDiv">
                                                            ...
                                                            <div class="col-xs-8 col-sm-8 col-md-8">
                                                                <input type="text" class="form-control" name="leaveDescriptionPreview"
                                                                       id="leaveDescriptionPreview">
                                                            </div>
                                                        </div>
                                                </div>
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12">
                                            <div class="panel panel-default">
                                                <table class="table table table-bordered table-striped table-condensed table-hover smart-form has-tickbox" id="tableData">
                                                    ...
                                                    <th width="150px"><?php echo ucwords($leafTranslation['leaveTypeIdLabel']); ?></th>
                                                    ...
                                                    <th width="75px"><?php echo ucwords($leafTranslation['isReviewLabel']); ?></th>
                                                    <th width="75px"><?php echo ucwords($leafTranslation['isRejectedLabel']); ?></th>
                                                    <th width="75px"><?php echo ucwords($leafTranslation['isApprovedLabel']); ?></th>
                                                    </tr>
                                                    </thead>
                                                    <tbody id="tableBody">
                                                        <?php
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                ...
                                                                                <?php } else { ?>
                                                                                    &nbsp;
                                                                                        <?php } ?>
                                                                                <div class="pull-right"><span class="label label-success pull-right"><?php
                                                                                        echo intval(
                                                                                                $leave->getLeaveBalance(
                                                                                                        $leaveArray[$i]['employeeId'], $leaveArray[$i]['leaveTypeId']
                                                                                                )
                                                                                        );
                                                                                        ?></span></div>
                                                                            </td>
                        ...
                        <?php } ?>
                                                                            ...
                                                                            <td vAlign="middle" align="center"><?php
                                                                                if ($leaveArray[$i]['isReview'] == 1) {
                                                                                    echo "<a class=\"img-thumbnail\" href=\"javascript:void(0)\"><img src=\"./images/icons/tick.png\" class=\"img-rounded\"></a>";
                                                                                } else {
                                                                                    echo "<a class=\"img-thumbnail\" href=\"javascript:void(0)\"><img src=\"./images/icons/cross-script.png\" class=\"img-rounded\"></a>";
                                                                                }
                                                                                ?></td>
                                                                            <td vAlign="middle" align="center"><?php
                                                                                if ($leaveArray[$i]['isRejected'] == 1) {
                                                                                    echo "<a class=\"img-thumbnail\" href=\"javascript:void(0)\"><img src=\"./images/icons/tick.png\" class=\"img-rounded\"></a>";
                                                                                } else {
                                                                                    echo "<a class=\"img-thumbnail\" href=\"javascript:void(0)\"><img src=\"./images/icons/cross-script.png\" class=\"img-rounded\"></a>";
                                                                                }
                                                                    ...
                                                                    ?>
                                                                    <tr>
                                                                        <td colspan="10"><?php $leave->exceptionMessage($t['recordNotFoundLabel']); ?></td>
                                                                    </tr>
                                                                    <?php
                                                                }
                                                            } else {
                                                            ...
                                                            ?>
                                                            <tr>
                                                                <td colspan="10"><?php $leave->exceptionMessage($t['loadFailureLabel']); ?></td>
                                                            </tr>
                                                            <?php
                                                        }
                                                        ?>
                                                ...
                                                <div class="col-xs-6 col-sm-6 col-md-6 form-group" id="employeeIdForm">
                                                    ...
                                                    <div class="col-xs-8 col-sm-8 col-md-8">
                                                        <input type="text" name="employeeName" id="employeeName"
                                                               value="<?php echo $_SESSION['staffName']; ?>" class="form-control">
                                                        <input type="hidden" name="employeeId" id="employeeId" value="<?php
                                                        echo $leave->getEmployeeIdSpecial(
                                                                $_SESSION['staffId']
                                                        );
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12 col-sm-12 col-md-12">
                                                <div class="form-group" id="leaveDescriptionForm">
                                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                                        <textarea class="form-control" name="leaveDescription" id="leaveDescription"
                                                                  onKeyUp="removeMeError('leaveDescription');" rows="5"><?php
