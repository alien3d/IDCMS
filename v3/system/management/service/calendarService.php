...
namespace Core\System\Management\Calendar\Service;
 ...
 * @version 2
 * @author hafizan
 * @package Core\System\Management\Calendar\Service
 * @subpackage Management
 * @link http://www.hafizan.com
 * @license http://www.gnu.org/copyleft/lesser.html LGPL
 */
class CalendarService extends ConfigClass {
    ...
    public function getColor() {
        ...
        if ($this->getVendor() == self::MYSQL) {
         ...
         ORDER BY    [isDefault]";
            ...
            $sql = "
         SELECT      COLORID AS \"colorId\",
                     COLORDESCRIPTION AS \"colorDescription\"
         FROM        COLOR
         WHERE       ISACTIVE    =   1
         AND         COMPANYID   =   '" . $this->getCompanyId() . "'
         ORDER BY    ISDEFAULT";
        ...
        if ($result) {
            ...
            while (($row = $this->q->fetchArray($result)) == TRUE) {
                if ($this->getServiceOutput() == 'option') {
                    $str.="<option value='" . $row['colorId'] . "'>" . $d . ". " . $row['colorDescription'] . "</option>";
                } else if ($this->getServiceOutput() == 'html') {
                    $items[] = $row;
                }
                $d++;
     ...
     * @return int
     */
    public function getColorDefaultValue() {
        //initialize dummy value.. no content header.pure html
        $sql = null;
        $str = null;
        $colorId = null;
