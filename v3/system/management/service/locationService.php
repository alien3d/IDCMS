...
namespace Core\System\Management\Location\Service;
 ...
 * @version 2
 * @author hafizan
 * @package Core\System\Management\Location\Service;
 * @subpackage Management
 * @link http://www.hafizan.com
 * @license http://www.gnu.org/copyleft/lesser.html LGPL
 */
class LocationService extends ConfigClass {
     ...
     * @return array|string
     */
    public function getDepartment($branchId = null) {
        //initialize dummy value.. no content header.pure html
        $sql = null;
        $str = null;
        $items = array();
