...
function showFormUpdate(leafId, url, urlList, securityToken, calendarId, updateAccess, deleteAccess) {
    sleep(500);
...
function showModalDelete(calendarId, staffId, colorId, calendarTitle, calendarIcon, CalendarDescription, calendarIsAllDayEvent) {
    // clear first old record if exist
    $('#calendarIdPreview').val('').val(decodeURIComponent(calendarId));
    $('#staffIdPreview').val('').val(decodeURIComponent(staffId));
    $('#colorIdPreview').val('').val(decodeURIComponent(colorId));
    $('#calendarTitlePreview').val('').val(decodeURIComponent(calendarTitle));
    $('#calendarIconPreview').val('').val(decodeURIComponent(calendarIcon));
    $('#CalendarDescriptionPreview').val('').val(decodeURIComponent(CalendarDescription));
    $('#calendarIsAllDayEventPreview').val('').val(decodeURIComponent(calendarIsAllDayEvent));
...
function deleteGridRecord(leafId, url, urlList, securityToken) {
    $.ajax({
        ...
        data: {
            method: 'delete',
            output: 'json',
            calendarId: $('#calendarIdPreview').val(),
            securityToken: securityToken,
            leafId: leafId
        },
        beforeSend: function() {
...
function deleteGridRecordCheckbox(leafId, url, urlList, securityToken) {
    var stringText = '';
    var counter = 0;
    $('input:checkbox[name="calendarId[]"]').each(function() {
        stringText = stringText + "&calendarId[]=" + $(this).val();
    });
...
function newRecord(leafId, url, urlList, securityToken, type, createAccess, updateAccess, deleteAccess) {
    ...
    var $calendarIsAllDayEvent = $('#calendarIsAllDayEvent');
    if (css.search('disabled') > 0) {
        return false;
    } else {
        if (type === 1) {
            ...
            if ($colorId.val().length === 0) {
                $('#colorIdHelpMe')
                        .html('').empty()
                        .html("<span class='label label-important'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['colorIdLabel'] + " </span>");
                $('#colorIdForm')
                        .removeClass().addClass('form-group has-error');
                $colorId.focus();
                return false;
            }
            if ($calendarTitle.val().length === 0) {
                $('#calendarTitleHelpMe')
                        .html('').empty()
                        .html("<span class='label label-important'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['calendarTitleLabel'] + " </span>");
                $('#calendarTitleForm')
                        .removeClass().addClass('form-group has-error');
                $calendarTitle.focus();
                return false;
            }
            if ($calendarIcon.val().length === 0) {
                $('#calendarIconHelpMe')
                        .html('').empty()
                        .html("<span class='label label-important'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['calendarIconLabel'] + " </span>");
                $('#calendarIconForm')
                        .removeClass().addClass('form-group has-error');
                $calendarIcon.focus();
                return false;
            }
            if ($CalendarDescription.val().length === 0) {
                $('#CalendarDescriptionHelpMe')
                        .html('').empty()
                        .html("<span class='label label-important'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['CalendarDescriptionLabel'] + " </span>");
                $('#CalendarDescriptionForm')
                        .removeClass().addClass('form-group has-error');
                $CalendarDescription.focus();
                return false;
            }
            if ($calendarIsAllDayEvent.val().length === 0) {
                $('#calendarIsAllDayEventHelpMe')
                        .html('').empty()
                        .html("<span class='label label-important'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['calendarIsAllDayEventLabel'] + " </span>");
                $('#calendarIsAllDayEventForm')
                        .removeClass().addClass('form-group has-error');
                $calendarIsAllDayEvent.focus();
                return false;
            }
            $.ajax({
                type: 'POST',
                ...
                data: {
                    ...
                    calendarIcon: $calendarIcon.val(),
                    CalendarDescription: $CalendarDescription.val(),
                    calendarIsAllDayEvent: $calendarIsAllDayEvent.val(),
                    securityToken: securityToken,
                    leafId: leafId
                },
                beforeSend: function() {
                ...
                success: function(data) {
                    ...
                    if (success === true) {
                        ...
                        $('#staffIdHelpMe')
                                .html('').empty();
                        $colorId.val('');
                        $colorId.trigger("chosen:updated");
                        $('#colorIdHelpMe')
                                .html('').empty();
                        $calendarTitle.val('');
                        $('#calendarTitleHelpMe')
        ...
        if (type === 1) {
            ...
            if ($colorId.val().length === 0) {
                $('#colorIdHelpMe')
                        .html('').empty()
                        .html("<span class='label label-important'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['colorIdLabel'] + " </span>");
                $('#colorIdForm').removeClass().addClass('form-group has-error');
                $colorId.focus();
                return false;
            }
            if ($calendarTitle.val().length === 0) {
                $('#calendarTitleHelpMe')
                        .html('').empty()
                        .html("<span class='label label-important'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['calendarTitleLabel'] + " </span>");
                $('#calendarTitleForm').removeClass().addClass('form-group has-error');
                $calendarTitle.focus();
                return false;
            }
            if ($calendarIcon.val().length === 0) {
                $('#calendarIconHelpMe')
                        .html('').empty()
                        .html("<span class='label label-important'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['calendarIconLabel'] + " </span>");
                $('#calendarIconForm').removeClass().addClass('form-group has-error');
                $calendarIcon.focus();
                return false;
            }
            if ($CalendarDescription.val().length === 0) {
                $('#CalendarDescriptionHelpMe')
                        .html('').empty()
                        .html("<span class='label label-important'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['CalendarDescriptionLabel'] + " </span>");
                $('#CalendarDescriptionForm').removeClass().addClass('form-group has-error');
                $CalendarDescription.focus();
                return false;
            }
            if ($calendarIsAllDayEvent.val().length === 0) {
                $('#calendarIsAllDayEventHelpMe')
                        .html('').empty()
                        .html("<span class='label label-important'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['calendarIsAllDayEventLabel'] + " </span>");
                $('#calendarIsAllDayEventForm').removeClass().addClass('form-group has-error');
                $calendarIsAllDayEvent.focus();
                return false;
            }
            if ($infoPanel.is(':hidden')) {
                ...
                if (success === true) {
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            if (success === true) {
                                $('#calendarId').val(data.data.calendarId);
                                $('#staffId').val(data.data.staffId).trigger("chosen:updated");
                                $('#colorId').val(data.data.colorId).trigger("chosen:updated");
                                $('#calendarTitle').val(data.data.calendarTitle);
                                $('#calendarIcon').val(data.data.calendarIcon);
                                $('#CalendarDescription').val(data.data.CalendarDescription);
                                $('#calendarIsAllDayEvent').val(data.data.calendarIsAllDayEvent);
                                if (nextRecord > 0) {
                                    $('#previousRecordButton')
                                            .removeClass().addClass('btn btn-default disabled')
                                            .attr('onClick', '');
    ...
    if (css.search('disabled') > 0) {
        ...
        if (parseFloat($previousRecordCounter.val()) > 0 && parseFloat($previousRecordCounter.val()) < parseFloat($('#lastRecordCounter').val())) {
            $.ajax({
                ...
                data: {
                    method: 'read',
                    calendarId: $previousRecordCounter.val(),
                    output: 'json',
                    securityToken: securityToken,
                    leafId: leafId
                },
    ...
    if (css.search('disabled') > 0) {
        ...
        if (parseFloat($nextRecordCounter.val()) <= parseFloat($('#lastRecordCounter').val())) {
            $.ajax({
                ...
                data: {
                    method: 'read',
                    calendarId: $nextRecordCounter.val(),
                    output: 'json',
                    securityToken: securityToken,
                    leafId: leafId
                },
