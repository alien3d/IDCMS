    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            if (success === true) {
                if (total !== 0) {
                    $("#roleCode").val('').focus();
                    $("#roleCodeForm").removeClass().addClass("form-group has-error");
                ...
                $("#roleForm").removeClass().addClass("form-group has-error");
            }
            if ($infoPanel.is(':hidden')) {
                $infoPanel.show();
            }
...
function showFormUpdate(leafId, url, urlList, securityToken, roleId, updateAccess, deleteAccess) {
    sleep(500);
...
function showModalDelete(roleId, roleCode, roleDescription, isAdmin, isHumanResource, isCustomer, isGeneralLedger, isAccountReceivable, isAccountPayable, isBranch) {
    $('#roleIdPreview').val('').val(decodeURIComponent(roleId));
    $('#roleCodePreview').val('').val(decodeURIComponent(roleCode));
    $('#roleDescriptionPreview').val('').val(decodeURIComponent(roleDescription));
    $('#isAdminPreview').val('').val(decodeURIComponent(isAdmin));
    $('#isHumanResourcePreview').val('').val(decodeURIComponent(isHumanResource));
    $('#isCustomerPreview').val('').val(decodeURIComponent(isCustomer));
    $('#isGeneralLedgerPreview').val('').val(decodeURIComponent(isGeneralLedger));
    $('#isAccountReceivablePreview').val('').val(decodeURIComponent(isAccountReceivable));
    $('#isAccountPayablePreview').val('').val(decodeURIComponent(isAccountPayable));
    $('#isBranchPreview').val('').val(decodeURIComponent(isBranch));
...
function deleteGridRecordCheckbox(leafId, url, urlList, securityToken) {
    var stringText = '';
    var counter = 0;
    $('input:checkbox[name="roleId[]"]').each(function() {
        stringText = stringText + "&roleId[]=" + $(this).val();
    });
...
function newRecord(leafId, url, urlList, securityToken, type, createAccess, updateAccess, deleteAccess) {
    ...
    var $isAdmin = $('#isAdmin');
    var $isHumanResource = $('#isHumanResource');
    var $isCustomer = $('#isCustomer');
    var $isGeneralLedger = $('#isGeneralLedger');
    var $isAccountReceivable = $('#isAccountReceivable');
    var $isAccountPayable = $('#isAccountPayable');
    ...
    if (css.search('disabled') > 0) {
        ...
        if (type === 1) {
            if ($roleCode.val().length === 0) {
                $('#roleCodeHelpMe').html('').empty().html("<span class='label label-important'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['roleCodeLabel'] + " </span>");
                $('#roleCodeForm').removeClass().addClass('form-group has-error');
                $roleCode.focus();
                return false;
            }
            if ($roleDescription.val().length === 0) {
                $('#roleDescriptionHelpMe').html('').empty().html("<span class='label label-important'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['roleDescriptionLabel'] + " </span>");
                $('#roleDescriptionForm').removeClass().addClass('form-group has-error');
                $roleDescription.focus();
                return false;
            }
            if ($isHumanResource.val().length === 0) {
                $('#isHumanResourceHelpMe').html('').empty().html("<span class='label label-important'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['isHumanResourceLabel'] + " </span>");
                $('#isHumanResourceForm').removeClass().addClass('form-group has-error');
                $isHumanResource.focus();
                return false;
            }
            if ($isCustomer.val().length === 0) {
                $('#isCustomerHelpMe').html('').empty().html("<span class='label label-important'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['isCustomerLabel'] + " </span>");
                $('#isCustomerForm').removeClass().addClass('form-group has-error');
                $isCustomer.focus();
                return false;
            }
            if ($isGeneralLedger.val().length === 0) {
                $('#isGeneralLedgerHelpMe').html('').empty().html("<span class='label label-important'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['isGeneralLedgerLabel'] + " </span>");
                $('#isGeneralLedgerForm').removeClass().addClass('form-group has-error');
                $isGeneralLedger.focus();
                return false;
            }
            if ($isAccountReceivable.val().length === 0) {
                $('#isAccountReceivableHelpMe').html('').empty().html("<span class='label label-important'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['isAccountReceivableLabel'] + " </span>");
                $('#isAccountReceivableForm').removeClass().addClass('form-group has-error');
                $isAccountReceivable.focus();
                return false;
            }
            if ($isAccountPayable.val().length === 0) {
                $('#isAccountPayableHelpMe').html('').empty().html("<span class='label label-important'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['isAccountPayableLabel'] + " </span>");
                $('#isAccountPayableForm').removeClass().addClass('form-group has-error');
                $isAccountPayable.focus();
                return false;
            }
            if ($isBranch.val().length === 0) {
                $('#isBranchHelpMe').html('').empty().html("<span class='label label-important'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['isBranchLabel'] + " </span>");
                $('#isBranchForm').removeClass().addClass('form-group has-error');
                $isBranch.focus();
                return false;
            }
            $.ajax({
                ...
                data: {
                    ...
                    isAdmin: $isAdmin.val(),
                    isHumanResource: $isHumanResource.val(),
                    isCustomer: $isCustomer.val(),
                    isGeneralLedger: $isGeneralLedger.val(),
                    isAccountReceivable: $isAccountReceivable.val(),
                    isAccountPayable: $isAccountPayable.val(),
                ...
                success: function(data) {
                    ...
                    if (success === true) {
                        ...
                        $roleCode.val('');
                        $('#roleCodeHelpMe').html('').empty();
                        $roleDescription.val('');
                        $('#roleDescriptionHelpMe').html('').empty();
                        $isAdmin.val('');
                        $('#isAdminHelpMe').html('').empty();
                        $isHumanResource.val('');
                        $('#isHumanResourceHelpMe').html('').empty();
                        $isCustomer.val('');
                        $('#isCustomerHelpMe').html('').empty();
                        $isGeneralLedger.val('');
                        $('#isGeneralLedgerHelpMe').html('').empty();
                        $isAccountReceivable.val('');
                        $('#isAccountReceivableHelpMe').html('').empty();
                        $isAccountPayable.val('');
                        $('#isAccountPayableHelpMe').html('').empty();
                        $isBranch.val('');
                        $('#isBranchHelpMe').html('').empty();
                    } else if (success === false) {
                        $infoPanel.html('').empty().html("<span class='label label-important'>&nbsp;" + message + "</span>");
                        if ($infoPanel.is(':hidden')) {
                            $infoPanel.show();
...
function resetRecord(leafId, url, urlList, securityToken, createAccess, updateAccess, deleteAccess) {
    ...
    $("#roleId").val('');
    $("#roleIdHelpMe").empty().html('');
    
    $("#roleCode").val('');
    $("#roleCodeHelpMe").empty().html('');
    $("#roleDescription").val('');
    $("#roleDescriptionHelpMe").empty().html('');
    $("#isAdmin").val('');
    $("#isAdminHelpMe").empty().html('');
    $("#isHumanResource").val('');
    $("#isHumanResourceHelpMe").empty().html('');
    $("#isCustomer").val('');
    $("#isCustomerHelpMe").empty().html('');
    $("#isGeneralLedger").val('');
    $("#isGeneralLedgerHelpMe").empty().html('');
    $("#isAccountReceivable").val('');
    $("#isAccountReceivableHelpMe").empty().html('');
    $("#isAccountPayable").val('');
    $("#isAccountPayableHelpMe").empty().html('');
    $("#isBranch").val('');
    $("#isBranchHelpMe").empty().html('');
}
function postRecord() {
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            if (success === true) {
                                ...
                                $('#isHumanResource').val(data.data.isHumanResource);
                                $('#isCustomer').val(data.data.isCustomer);
                                $('#isGeneralLedger').val(data.data.isGeneralLedger);
                                $('#isAccountReceivable').val(data.data.isAccountReceivable);
                                $('#isAccountPayable').val(data.data.isAccountPayable);
                                $('#isBranch').val(data.data.isBranch);
                                if (nextRecord > 0) {
                                    $('#previousRecordButton').removeClass().addClass('btn btn-default disabled').attr('onClick', '');
    ...
    if (css.search('disabled') > 0) {
        ...
        if (parseFloat($previousRecordCounter.val()) > 0 && parseFloat($previousRecordCounter.val()) < parseFloat($('#lastRecordCounter').val())) {
            $.ajax({
                ...
                data: {
                    method: 'read',
                    roleId: $previousRecordCounter.val(),
                    output: 'json',
                    securityToken: securityToken,
                    leafId: leafId
                },
