...
use Core\System\Common\Marriage\Model\MarriageModel;
use Core\System\Common\Marriage\Service\MarriageService;
...
require_once($newFakeDocumentRoot . "v3/system/common/model/marriageModel.php");
require_once($newFakeDocumentRoot . "v3/system/common/service/marriageService.php");
 ...
 * @version 2
 * @author hafizan
 * @package  Core\System\Common\Marriage\Controller
 * @subpackage Common
...
class MarriageClass extends ConfigClass {
    ...
    /**
     * Model
     * @var \Core\System\Common\Marriage\Model\MarriageModel
     */
    public $model;

    /**
     * Service-Business Application Process or other ajax request
     * @var \Core\System\Common\Marriage\Service\MarriageService
     */
    public $service;
    ...
    function __construct() {
        ...
        $this->setViewPath("./v3/system/common/view/marriage.php");
        $this->setControllerPath("./v3/system/common/controller/marriageController.php");
        $this->setServicePath("./v3/system/common/service/marriageService.php");
    }
...
if (isset($_POST ['method'])) {
    if (isset($_POST['output'])) {
        ...
        if (isset($_POST ['offset'])) {
            $marriageObject->setStart($_POST ['offset']);
        }
        if (isset($_POST ['leafId'])) {
            $marriageObject->setLimit($_POST ['limit']);
        }
