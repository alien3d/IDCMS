function checkDuplicate(leafId, page, securityToken) {
    ...
    $.ajax({type: 'GET', url: page, data: {countryCode: $countryCode.val(), method: 'duplicate', securityToken: securityToken, leafId: leafId}, beforeSend: function() {
            ...
            if (success === true) {
                if (total !== 0) {
                    $("#countryCode").val('').focus();
                    $("#countryCodeForm").removeClass().addClass("form-group has-error");
                ...
                $("#countryForm").removeClass().addClass("form-group has-error");
            }
            if ($infoPanel.is(':hidden')) {
                $infoPanel.show();
            }
...
function showFormUpdate(leafId, url, urlList, securityToken, countryId, updateAccess, deleteAccess) {
    sleep(500);
    $('a[rel=tooltip]').tooltip('hide');
    $.ajax({type: 'POST', url: urlList, data: {method: 'read', type: 'form', countryId: countryId, securityToken: securityToken, leafId: leafId}, beforeSend: function() {
            var smileyRoll = './images/icons/smiley-roll.png';
            var $infoPanel = $('#infoPanel');
            $infoPanel.html('').empty().html("<span class='label label-warning'><img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
            if ($infoPanel.is(':hidden')) {
...
function showModalDelete(countryId, countryCode, countryCurrencyCode, countryCurrencyCodeDescription, localeOne, localeTwo, localeThree, localeFour, localeFive, countryDescription) {
    $('#countryIdPreview').val('').val(decodeURIComponent(countryId));
    $('#countryCodePreview').val('').val(decodeURIComponent(countryCode));
    $('#countryCurrencyCodePreview').val('').val(decodeURIComponent(countryCurrencyCode));
    $('#countryCurrencyCodeDescriptionPreview').val('').val(decodeURIComponent(countryCurrencyCodeDescription));
    $('#localeOnePreview').val('').val(decodeURIComponent(localeOne));
    $('#localeTwoPreview').val('').val(decodeURIComponent(localeTwo));
    $('#localeThreePreview').val('').val(decodeURIComponent(localeThree));
    $('#localeFourPreview').val('').val(decodeURIComponent(localeFour));
    $('#localeFivePreview').val('').val(decodeURIComponent(localeFive));
    $('#countryDescriptionPreview').val('').val(decodeURIComponent(countryDescription));
    showMeModal('deletePreview', 1);
}
function deleteGridRecord(leafId, url, urlList, securityToken) {
    $.ajax({type: 'POST', url: url, data: {method: 'delete', output: 'json', countryId: $('#countryIdPreview').val(), securityToken: securityToken, leafId: leafId}, beforeSend: function() {
            var smileyRoll = './images/icons/smiley-roll.png';
            var $infoPanel = $('#infoPanel');
            $infoPanel.html('').empty().html("<span class='label label-warning'><img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
            if ($infoPanel.is(':hidden')) {
...
function deleteGridRecordCheckbox(leafId, url, urlList, securityToken) {
    var stringText = '';
    var counter = 0;
    $('input:checkbox[name="countryId[]"]').each(function() {
        stringText = stringText + "&countryId[]=" + $(this).val();
    });
...
function newRecord(leafId, url, urlList, securityToken, type, createAccess, updateAccess, deleteAccess) {
    ...
    if (css.search('disabled') > 0) {
        ...
        if (type === 1) {
            if ($('#countryCode').val().length === 0) {
                $('#countryCodeHelpMe').html('').empty().html("<span class='label label-important'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['countryCodeLabel'] + " </span>");
                $('#countryCodeForm').removeClass().addClass('form-group has-error');
                $('#countryCode').focus();
                return false;
            }
            if ($('#countryCurrencyCode').val().length === 0) {
                $('#countryCurrencyCodeHelpMe').html('').empty().html("<span class='label label-important'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['countryCurrencyCodeLabel'] + " </span>");
                $('#countryCurrencyCodeForm').removeClass().addClass('form-group has-error');
                $('#countryCurrencyCode').focus();
                return false;
            }
            if ($('#localeOne').val().length === 0) {
                $('#localeOneHelpMe').html('').empty().html("<span class='label label-important'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['localeOneLabel'] + " </span>");
                $('#localeOneForm').removeClass().addClass('form-group has-error');
                $('#localeOne').focus();
                return false;
            }
            if ($('#countryDescription').val().length === 0) {
                $('#countryDescriptionHelpMe').html('').empty().html("<span class='label label-important'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['countryDescriptionLabel'] + " </span>");
                $('#countryDescriptionForm').removeClass().addClass('form-group has-error');
                $('#countryDescription').focus();
                return false;
            }
            $.ajax({type: 'POST', url: url, data: {method: 'create', output: 'json', countryCode: $('#countryCode').val(), countryCurrencyCode: $('#countryCurrencyCode').val(), countryCurrencyCodeDescription: $('#countryCurrencyCodeDescription').val(), localeOne: $('#localeOne').val(), localeTwo: $('#localeTwo').val(), localeThree: $('#localeThree').val(), localeFour: $('#localeFour').val(), localeFive: $('#localeFive').val(), countryDescription: $('#countryDescription').val(), securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                    var smileyRoll = './images/icons/smiley-roll.png';
                    var $infoPanel = $('#infoPanel');
                    $infoPanel.html('').empty().html("<span class='label label-warning'>&nbsp;<img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
                    if ($infoPanel.is(':hidden')) {
                    ...
                    if (success === true) {
                        ...
                        $('#countryCode').val('');
                        $('#countryCodeHelpMe').empty().html('');
                        $('#countryCurrencyCode').val('');
                        $('#countryCurrencyCodeHelpMe').empty().html('');
                        $('#countryCurrencyCodeDescription').setValue('');
                        $('#countryCurrencyCodeDescriptionForm').removeClass().addClass('form-group');
                        $('#countryCurrencyCodeDescription').val('');
                        $('#countryCurrencyCodeDescriptionHelpMe').empty().html('');
                        $('#localeOne').val('');
                        $('#localeOneHelpMe').empty().html('');
                        $('#localeTwo').val('');
                        $('#localeTwoHelpMe').empty().html('');
                        $('#localeThree').val('');
                        $('#localeThreeHelpMe').empty().html('');
                        $('#localeFour').val('');
                        $('#localeFourHelpMe').empty().html('');
                        $('#localeFive').val('');
                        $('#localeFiveHelpMe').empty().html('');
                        $('#countryDescription').val('');
                        $('#countryDescriptionForm').removeClass().addClass('form-group');
                        $('#countryDescription').val('');
                        $('#countryDescriptionHelpMe').empty().html('');
                    } else if (success === false) {
                        $infoPanel.html('').empty().html("<span class='label label-important'>&nbsp;" + message + "</span>");
                        if ($infoPanel.is(':hidden')) {
                            $infoPanel.show();
...
function updateRecord(leafId, url, urlList, securityToken, type, deleteAccess) {
    ...
    if (css.search('disabled') > 0) {
        ...
        if (type === 1) {
            ...
            $infoPanel.html('').empty();
            $.ajax({type: 'POST', url: url, data: {method: 'save', output: 'json', countryId: $('#countryId').val(), countryCode: $('#countryCode').val(), countryCurrencyCode: $('#countryCurrencyCode').val(), countryCurrencyCodeDescription: $('#countryCurrencyCodeDescription').val(), localeOne: $('#localeOne').val(), localeTwo: $('#localeTwo').val(), localeThree: $('#localeThree').val(), localeFour: $('#localeFour').val(), localeFive: $('#localeFive').val(), countryDescription: $('#countryDescription').val(), securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                    var smileyRoll = './images/icons/smiley-roll.png';
                    var $infoPanel = $('#infoPanel');
                    $infoPanel.html('').empty().html("<span class='label label-warning'>&nbsp;<img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
                    if ($infoPanel.is(':hidden')) {
        ...
        if (deleteAccess === 1) {
            if (confirm(decodeURIComponent(t['deleteRecordMessageLabel']))) {
                ...
                if (!value) {
                    ...
                    $.ajax({type: 'POST', url: url, data: {method: 'delete', output: 'json', countryId: $countryId.val(), securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                            var smileyRoll = './images/icons/smiley-roll.png';
                            var $infoPanel = $('#infoPanel');
                            $infoPanel.html('').empty().html("<span class='label label-warning'>&nbsp;<img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
                            if ($infoPanel.is(':hidden')) {
...
function firstRecord(leafId, url, urlList, securityToken, updateAccess, deleteAccess) {
    ...
    if (css.search('disabled') > 0) {
        ...
        $.ajax({type: 'GET', url: url, data: {method: 'dataNavigationRequest', dataNavigation: 'firstRecord', output: 'json', securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                ...
                if (success === true) {
                    $.ajax({type: 'POST', url: url, data: {method: 'read', countryId: firstRecord, output: 'json', securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                            var smileyRoll = './images/icons/smiley-roll.png';
                            $infoPanel.html('').empty().html("<span class='label label-warning'>&nbsp;<img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
                            if ($infoPanel.is(':hidden')) {
                                $infoPanel.show();
                            ...
                            if (success === true) {
                                ...
                                $('#countryCurrencyCode').val(data.data.countryCurrencyCode);
                                $('#countryCurrencyCodeDescription').val(data.data.countryCurrencyCodeDescription);
                                $('#localeOne').val(data.data.localeOne);
                                $('#localeTwo').val(data.data.localeTwo);
                                $('#localeThree').val(data.data.localeThree);
                                $('#localeFour').val(data.data.localeFour);
                                $('#localeFive').val(data.data.localeFive);
                                $('#countryDescription').val(data.data.countryDescription);
                                if (nextRecord > 0) {
                                    $('#previousRecordButton').removeClass().addClass('btn btn-default disabled').attr('onClick', '');
...
function endRecord(leafId, url, urlList, securityToken, updateAccess, deleteAccess) {
    ...
    if (css.search('disabled') > 0) {
        ...
        $.ajax({type: 'GET', url: url, data: {method: 'dataNavigationRequest', dataNavigation: 'lastRecord', output: 'json', securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                ...
                var lastRecord = data.lastRecord;
                if (success === true) {
                    $.ajax({type: 'POST', url: url, data: {method: 'read', countryId: lastRecord, output: 'json', securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                            var smileyRoll = './images/icons/smiley-roll.png';
                            $infoPanel.html('').empty().html("<span class='label label-warning'>&nbsp;<img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
                            if ($infoPanel.is(':hidden')) {
                                $infoPanel.show();
...
function previousRecord(leafId, url, urlList, securityToken, updateAccess, deleteAccess) {
    ...
    if (css.search('disabled') > 0) {
        ...
        if (parseFloat($previousRecordCounter.val()) > 0 && parseFloat($previousRecordCounter.val()) < parseFloat($('#lastRecordCounter').val())) {
            $.ajax({type: 'POST', url: url, data: {method: 'read', countryId: $previousRecordCounter.val(), output: 'json', securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                    var smileyRoll = './images/icons/smiley-roll.png';
                    var $infoPanel = $('#infoPanel');
                    $infoPanel.html('').empty().html("<span class='label label-warning'>&nbsp;<img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
                    if ($infoPanel.is(':hidden')) {
                    ...
                    if (success === true) {
                        ...
                        $('#countryCode').val(data.data.countryCode);
                        $('#countryCurrencyCode').val(data.data.countryCurrencyCode);
                        $('#countryCurrencyCodeDescription').editor.setValue(data.data.countryCurrencyCodeDescription);
                        $('#localeOne').val(data.data.localeOne);
                        $('#localeTwo').val(data.data.localeTwo);
                        $('#localeThree').val(data.data.localeThree);
                        $('#localeFour').val(data.data.localeFour);
...
function nextRecord(leafId, url, urlList, securityToken, updateAccess, deleteAccess) {
    ...
    if (css.search('disabled') > 0) {
        ...
        if (parseFloat($nextRecordCounter.val()) <= parseFloat($('#lastRecordCounter').val())) {
            $.ajax({type: 'POST', url: url, data: {method: 'read', countryId: $nextRecordCounter.val(), output: 'json', securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                    var smileyRoll = './images/icons/smiley-roll.png';
                    var $infoPanel = $('#infoPanel');
                    $infoPanel.html('').empty().html("<span class='label label-warning'>&nbsp;<img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
                    if ($infoPanel.is(':hidden')) {
