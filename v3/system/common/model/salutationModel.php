...
namespace Core\System\Common\Salutation\Model;
 ...
 * @version 2
 * @author hafizan
 * @package Core\System\Common\Salutation\Model;
 * @subpackage Common
...
class SalutationModel extends ValidationClass {
    ...
    public function execute() {
        ...
        $this->setMasterForeignKeyName('salutationId');
        $this->setFilterCharacter('salutationDescription');
        //$this->setFilterCharacter('salutationNote');
        $this->setFilterDate('executeTime');
        /**
         * All the $_POST Environment
         */
        if (isset($_POST ['salutationId'])) {
            $this->setSalutationId($this->strict($_POST ['salutationId'], 'integer'), 0, 'single');
        }
        ...
        if (isset($_POST ['salutationDescription'])) {
            $this->setSalutationDescription($this->strict($_POST ['salutationDescription'], 'string'));
        }
        /**
         * All the $_GET Environment
         */
        if (isset($_GET ['salutationId'])) {
            $this->setSalutationId($this->strict($_GET ['salutationId'], 'integer'), 0, 'single');
        }
        if (isset($_GET ['companyId'])) {
            $this->setCompanyId($this->strict($_GET ['companyId'], 'integer'));
        }
        if (isset($_GET ['salutationCode'])) {
            $this->setSalutationCode($this->strict($_GET ['salutationCode'], 'string'));
        }
        if (isset($_GET ['salutationDescription'])) {
            $this->setSalutationDescription($this->strict($_GET ['salutationDescription'], 'string'));
        }
        if (isset($_GET ['salutationId'])) {
            $this->setTotal(count($_GET ['salutationId']));
            if (is_array($_GET ['salutationId'])) {
                $this->salutationId = array();
            }
        }
     ...
     * @return \Core\System\Common\Salutation\Model\SalutationModel
     */
    public function setSalutationId($value, $key, $type) {
        if ($type == 'single') {
            ...
            if ($type == 'array') {
                ...
                echo json_encode(
                        array("success" => false, "message" => "Cannot Identify Type String Or Array:setSalutationId?")
                );
                exit();
            }
        }
    ...
    public function getSalutationId($key, $type) {
        if ($type == 'single') {
            ...
            if ($type == 'array') {
                ...
                echo json_encode(
                        array("success" => false, "message" => "Cannot Identify Type String Or Array:getSalutationId ?")
                );
                exit();
            }
        }
    ...
    /**
     * To Set Code
     * @param string $salutationCode Code
     * @return \Core\System\Common\Salutation\Model\SalutationModel
     */
    ...
    /**
     * To Set Description
     * @param string $salutationDescription Description
     * @return \Core\System\Common\Salutation\Model\SalutationModel
     */
