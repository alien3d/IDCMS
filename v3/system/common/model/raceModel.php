 ...
 * @version 2
 * @author hafizan
 * @package Core\System\Common\Race\Model;
 * @subpackage Common
 * @link http://www.hafizan.com
 * @license http://www.gnu.org/copyleft/lesser.html LGPL
 */
class RaceModel extends ValidationClass {
    ...
    public function execute() {
        ...
        $this->setFilterCharacter('raceDescription');
        ...
        if (isset($_POST ['raceId'])) {
            $this->setRaceId($this->strict($_POST ['raceId'], 'integer'), 0, 'single');
        }
        if (isset($_POST ['companyId'])) {
            $this->setCompanyId($this->strict($_POST ['companyId'], 'integer'));
        }
        if (isset($_POST ['raceCode'])) {
            $this->setRaceCode($this->strict($_POST ['raceCode'], 'string'));
        }
        if (isset($_POST ['raceDescription'])) {
            $this->setRaceDescription($this->strict($_POST ['raceDescription'], 'string'));
        }
        /**
         * All the $_GET Environment
         */
        if (isset($_GET ['raceId'])) {
            $this->setRaceId($this->strict($_GET ['raceId'], 'integer'), 0, 'single');
        }
        if (isset($_GET ['companyId'])) {
            $this->setCompanyId($this->strict($_GET ['companyId'], 'integer'));
        }
        if (isset($_GET ['raceCode'])) {
            $this->setRaceCode($this->strict($_GET ['raceCode'], 'string'));
        }
        if (isset($_GET ['raceDescription'])) {
            $this->setRaceDescription($this->strict($_GET ['raceDescription'], 'string'));
        }
        if (isset($_GET ['raceId'])) {
     ...
     * @return \Core\System\Common\Race\Model\RaceModel
     */
    public function setRaceId($value, $key, $type) {
        if ($type == 'single') {
            ...
            if ($type == 'array') {
                ...
                echo json_encode(
                        array("success" => false, "message" => "Cannot Identify Type String Or Array:setRaceId?")
                );
                exit();
            }
        }
    ...
    public function getRaceId($key, $type) {
        if ($type == 'single') {
            ...
            if ($type == 'array') {
                ...
                echo json_encode(
                        array("success" => false, "message" => "Cannot Identify Type String Or Array:getRaceId ?")
                );
                exit();
            }
        }
    ...
    /**
     * To Set Description
     * @param string $raceDescription Description
     * @return \Core\System\Common\Race\Model\RaceModel
     */
