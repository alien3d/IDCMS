...
namespace Core\System\Common\District\Model;
 ...
 * @version 2
 * @author hafizan
 * @package Core\System\Common\District\Model;
 * @subpackage Common
...
class DistrictModel extends ValidationClass {
    ...
    public function execute() {
        ...
        $this->setMasterForeignKeyName('districtId');
        $this->setFilterCharacter('districtDescription');
        //$this->setFilterCharacter('districtNote');
        $this->setFilterDate('executeTime');
        /**
         * All the $_POST Environment
         */
        if (isset($_POST ['districtId'])) {
            $this->setDistrictId($this->strict($_POST ['districtId'], 'integer'), 0, 'single');
        }
        ...
        if (isset($_POST ['districtDescription'])) {
            $this->setDistrictDescription($this->strict($_POST ['districtDescription'], 'string'));
        }
        /**
         * All the $_GET Environment
         */
        if (isset($_GET ['districtId'])) {
            $this->setDistrictId($this->strict($_GET ['districtId'], 'integer'), 0, 'single');
        }
        ...
        if (isset($_GET ['districtCode'])) {
            $this->setDistrictCode($this->strict($_GET ['districtCode'], 'string'));
        }
        if (isset($_GET ['districtDescription'])) {
            $this->setDistrictDescription($this->strict($_GET ['districtDescription'], 'string'));
        }
        if (isset($_GET ['districtId'])) {
            $this->setTotal(count($_GET ['districtId']));
            if (is_array($_GET ['districtId'])) {
                $this->districtId = array();
            }
        }
     ...
     * @return \Core\System\Common\District\Model\DistrictModel
     */
    public function setDistrictId($value, $key, $type) {
        if ($type == 'single') {
            ...
            if ($type == 'array') {
                ...
                echo json_encode(
                        array("success" => false, "message" => "Cannot Identify Type String Or Array:setDistrictId?")
                );
                exit();
            }
        }
    ...
    public function getDistrictId($key, $type) {
        if ($type == 'single') {
            ...
            if ($type == 'array') {
                ...
                echo json_encode(
                        array("success" => false, "message" => "Cannot Identify Type String Or Array:getDistrictId ?")
                );
                exit();
            }
        }
    ...
    /**
     * To Set Code
     * @param string $districtCode Code
     * @return \Core\System\Common\District\Model\DistrictModel
     */
     ...
     * @return string $districtDescription
     */
    ...
    /**
     * To Set Description
     * @param string $districtDescription Description
     * @return \Core\System\Common\District\Model\DistrictModel
     */
