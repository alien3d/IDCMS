...
require_once($newFakeDocumentRoot . "v3/system/common/controller/raceController.php");
...
if (isset($_POST)) {
    if (isset($_POST['method'])) {
        ...
        $race->setServiceOutput('html');
        $race->setLeafId($leafId);
        $race->execute();
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            ...
                            <table class="table table-striped table-condensed table-hover">
                                <tr>
                                    <td>&nbsp;</td>
                                    <td align="center"><div align="center"><img src="./images/icons/calendar-select-days-span.png" alt="<?php echo $t['allDay'] ?>"></div></td>
                                    <td align="center">
                                        <a chref="javascript:void(0)" onClick="ajaxQuerySearchAllDate(<?php echo $leafId; ?>, '<?php
                                        echo $race->getViewPath();
                                ...
                                <tr>
                                    <td align="left">
                                        <a class="btn btn-primary btn-xs" href="javascript:void(0)" rel="tooltip" title="Previous Day <?php echo $previousDay; ?>"
                                    ...
                                    <td align="right">
                                        <a class="btn btn-primary btn-xs" href="javascript:void(0)" rel="tooltip" title="Next Day <?php echo $nextDay; ?>"
                                           onClick="ajaxQuerySearchAllDate(<?php echo $leafId; ?>, '<?php
                                           echo $race->getViewPath();
                                ...
                                <tr>
                                    <td align="left">
                                        <a class="btn btn-primary btn-xs" href="javascript:void(0)" rel="tooltip" title="Previous Week<?php
                                    ...
                                    <td align="right">
                                        <a class="btn btn-primary btn-xs" href="javascript:void(0)" rel="tooltip" title="Next Week <?php
                                        echo $dateConvert->getCurrentWeekInfo(
                                                $dateRangeStart, 'next'
                                        );
                                        ?>" onClick="ajaxQuerySearchAllDate(<?php echo $leafId; ?>, '<?php
                                ...
                                <tr>
                                    <td align="left">
                                        <a class="btn btn-primary btn-xs" href="javascript:void(0)" rel="tooltip" title="Previous Month <?php echo $previousMonth; ?>"
                                           onClick="ajaxQuerySearchAllDate(<?php echo $leafId; ?>, '<?php
                                           echo $race->getViewPath();
                                    ...
                                    <td align="right">
                                        <a class="btn btn-primary btn-xs" href="javascript:void(0)" rel="tooltip" title="Next Month <?php echo $nextMonth; ?>"
                                           onClick="ajaxQuerySearchAllDate(<?php echo $leafId; ?>, '<?php
                                           echo $race->getViewPath();
                                ...
                                <tr>
                                    <td align="left">
                                        <a class="btn btn-primary btn-xs" href="javascript:void(0)" rel="tooltip" title="Previous Year <?php echo $previousYear; ?>"
                                           onClick="ajaxQuerySearchAllDate(<?php echo $leafId; ?>, '<?php
                                           echo $race->getViewPath();
                                    ...
                                    <td align="right">
                                        <a class="btn btn-primary btn-xs" href="javascript:void(0)" rel="tooltip" title="Next Year <?php echo $nextYear; ?>"
                                           onClick="ajaxQuerySearchAllDate(<?php echo $leafId; ?>, '<?php
                                           echo $race->getViewPath();
                                           ?>', '<?php echo $securityToken; ?>', '<?php echo $nextYear; ?>', '', 'year', 'next');">&raquo;</a>
                                    </td>
                                </tr>
                            </table><div class="input-group"><input type="text" class="form-control"
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form class="form-horizontal">
                                    ...
                                    <div class="form-group" id="raceCodeDiv">
                                        <label for="raceCodePreview"
                                               class="control-label col-xs-4 col-sm-4 col-md-4"><?php echo $leafTranslation['raceCodeLabel']; ?></label>

                                        <div class="col-xs-8 col-sm-8 col-md-8">
                                            <input class="form-control" type="text" name="raceCodePreview"
                                                   id="raceCodePreview">
                                        </div>
                                    </div>
                                    <div class="form-group" id="raceDescriptionDiv">
                                        <label for="raceDescriptionPreview"
                                               class="control-label col-xs-4 col-sm-4 col-md-4"><?php echo $leafTranslation['raceDescriptionLabel']; ?></label>

                                        <div class="col-xs-8 col-sm-8 col-md-8">
                                            <input class="form-control" type="text" name="raceDescriptionPreview"
                                                   id="raceDescriptionPreview">
                                        </div>
                                    </div>
                                </form>
                            </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="panel panel-default">
                            <table class="table table table-bordered table-striped table-condensed table-hover smart-form has-tickbox" id="tableData">
                                ...
                                <th width="100px">
                                <div align="center"><?php echo ucwords($leafTranslation['raceCodeLabel']); ?></div>
                                </th>
                                <th><?php echo ucwords($leafTranslation['raceDescriptionLabel']); ?></th>
                                <th width="100px">
                                        ...
                                        if (is_array($raceArray)) {
                                            ...
                                            if ($totalRecord > 0) {
                                                ...
                                                for ($i = 0; $i < $totalRecord; $i++) {
                                                    ...
                                                    ?>
                                                    <tr <?php
                                                    if ($raceArray[$i]['isDelete'] == 1) {
                                                        echo "class=\"danger\"";
                                                    } else {
                                                        if ($raceArray[$i]['isDraft'] == 1) {
                                                            echo "class=\"warning\"";
                                                        }
                                                    }
                                                    ?>>
                                                        ...
                                                        <td align="center">
															<?php if($raceArray [$i]['raceCode'] !='UNBL') { ?>
                                                            <div class="btn-group" align="center">
                                                                ...
                                                                ?>', '<?php
                                                                echo rawurlencode(
                                                                        $raceArray [$i]['raceCode']
                                                                );
                                                                ?>', '<?php echo rawurlencode($raceArray [$i]['raceDescription']); ?>');">
                                                        ...
                                                        <td>
                                                            <div align="center">
                                                                <?php
                                                                if (isset($raceArray[$i]['raceCode'])) {
                                                                    if (isset($_POST['query']) || isset($_POST['character'])) {
                                                                        if (isset($_POST['query']) && strlen($_POST['query']) > 0) {
                                                                            if (strpos(
                                                                                            strtolower($raceArray[$i]['raceCode']), strtolower($_POST['query'])
                                                                                    ) !== false
                                                                            ) {
                                                                                echo str_replace(
                                                                                        $_POST['query'], "<span class=\"label label-info\">" . $_POST['query'] . "</span>", $raceArray[$i]['raceCode']
                                                                                );
                                                                            } else {
                                                                                echo $raceArray[$i]['raceCode'];
                                                                            }
                                                                        } else {
                                                                            if (isset($_POST['character']) && strlen($_POST['character']) > 0) {
                                                                                if (strpos(
                                                                                                strtolower($raceArray[$i]['raceCode']), strtolower($_POST['character'])
                                                                                        ) !== false
                                                                                ) {
                                                                                    echo str_replace(
                                                                                            $_POST['character'], "<span class=\"label label-info\">" . $_POST['character'] . "</span>", $raceArray[$i]['raceCode']
                                                                                    );
                                                                                } else {
                                                                                    echo $raceArray[$i]['raceCode'];
                                                                                }
                                                        ...
                                                        <td>
                                                            <div class="pull-left">
                                                                <?php
                                                                if (isset($raceArray[$i]['raceDescription'])) {
                                                                    if (isset($_POST['query']) || isset($_POST['character'])) {
                                                                        if (isset($_POST['query']) && strlen($_POST['query']) > 0) {
                                                                            if (strpos(
                                                                                            strtolower($raceArray[$i]['raceDescription']), strtolower($_POST['query'])
                                                                                    ) !== false
                                                                            ) {
                                                                                echo str_replace(
                                                                                        $_POST['query'], "<span class=\"label label-info\">" . $_POST['query'] . "</span>", $raceArray[$i]['raceDescription']
                                                                                );
                                                                            } else {
                                                                                echo $raceArray[$i]['raceDescription'];
                                                                            }
                                                                        } else {
                                                                            if (isset($_POST['character']) && strlen($_POST['character']) > 0) {
                                                                                if (strpos(
                                                                                                strtolower($raceArray[$i]['raceDescription']), strtolower($_POST['character'])
                                                                                        ) !== false
                                                                                ) {
                                                                                    echo str_replace(
                                                                                            $_POST['character'], "<span class=\"label label-info\">" . $_POST['character'] . "</span>", $raceArray[$i]['raceDescription']
                                                                                    );
                                                                                } else {
                                                                                    echo $raceArray[$i]['raceDescription'];
                                                                                }
                                                        ...
                                                        <td>
                                                            <div align="center">
                                                                ...
                                                                if (isset($raceArray[$i]['executeBy'])) {
                                                                    if (isset($_POST['query']) || isset($_POST['character'])) {
                                                                        if (isset($_POST['query']) && strlen($_POST['query']) > 0) {
                                                                            if (strpos($raceArray[$i]['staffName'], $_POST['query']) !== false) {
                                                                                echo str_replace(
                                                                                        $_POST['query'], "<span class=\"label label-info\">" . $_POST['query'] . "</span>", $raceArray[$i]['staffName']
                                                                                );
                                                                            } else {
                                                                                echo $raceArray[$i]['staffName'];
                                                                            }
                                                                        } else {
                                                                            if (isset($_POST['character']) && strlen($_POST['character']) > 0) {
                                                                                if (strpos(
                                                                                                $raceArray[$i]['staffName'], $_POST['character']
                                                                                        ) !== false
                                                                                ) {
                                                                                    echo str_replace(
                                                                                            $_POST['character'], "<span class=\"label label-info\">" . $_POST['character'] . "</span>", $raceArray[$i]['staffName']
                                                                                    );
                                                                                } else {
                                                                                    echo $raceArray[$i]['staffName'];
                                                                                }
                                                        ...
                                                        ?>
                                                        <td><?php if($raceArray [$i]['raceCode'] !='UNBL') { ?>
                                                            <input style="display:none;" type="checkbox" name="raceId[]"
                                                                   value="<?php echo $raceArray[$i]['raceId']; ?>">
                                                            <input <?php echo $checked; ?> type="checkbox" name="isDelete[]"
                                                                                           value="<?php echo $raceArray[$i]['isDelete']; ?>">
																<?php } else { ?>&nbsp;<?php } ?>
                                                        </td>
                                                    </tr>
                                                    <?php
                    ...
                    <div class="col-xs-3 col-sm-3 col-md-3 pagination">
                        <div class="pull-right">
                            <button class="delete btn btn-warning" type="button" 
                                    ...
                                    echo $race->getControllerPath();
                                    ?>', '<?php echo $race->getViewPath(); ?>', '<?php echo $securityToken; ?>');">
...
if ((isset($_POST['method']) == 'new' || isset($_POST['method']) == 'read') && $_POST['type'] == 'form') {
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            <input type="hidden" name="raceId" id="raceId" value="<?php
                            if (isset($_POST['raceId'])) {
                                echo $_POST['raceId'];
                            }
                            ?>">

                            <div class="form-group" id="raceCodeForm">
                                <label class="control-label col-xs-2 col-sm-2 col-md-2" for="raceCode"><strong><?php
                                        echo ucfirst(
                                                $leafTranslation['raceCodeLabel']
                                        );
                                        ?></strong></label>

                                <div class="control-label col-xs-4 col-sm-4 col-md-4">
                                    <div class="input-group">
                                        <input class="form-control" type="text" name="raceCode" id="raceCode" value="<?php
                                        if (isset($raceArray) && is_array($raceArray)) {
                                            if (isset($raceArray[0]['raceCode'])) {
                                                echo htmlentities($raceArray[0]['raceCode']);
                                            }
                                        }
                                        ?>" maxlength="16"><span class="input-group-addon"><img
                                                src="./images/icons/document-code.png"></span>
                                    </div>
                                    <span class="help-block" id="raceCodeHelpMe"></span>
                                </div>
                            </div>
                            <div class="form-group" id="raceDescriptionForm">
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <textarea rows="5" class="form-control" name="raceDescription" id="raceDescription"><?php
                                        if (isset($raceArray[0]['raceDescription'])) {
                                            if ($raceArray[0]['raceDescription']) {
                                                echo htmlentities($raceArray[0]['raceDescription']);
                                            }
                                        }
                                        ?></textarea> <span class="help-block" id="raceDescriptionHelpMe"></span>
                                </div>
                            </div>
                        </div>
    ...
    <?php if ($leafAccess['leafAccessCreateValue'] == 1) { ?>
                    newRecord(<?php echo $leafId; ?>, '<?php echo $race->getControllerPath(); ?>', '<?php echo $race->getViewPath(); ?>', '<?php echo $securityToken; ?>', 1);
    <?php } ?>
                return false;
            }
            // shift+s save event
    ...
    <?php if ($leafAccess['leafAccessUpdateValue'] == 1) { ?>
                    updateRecord(<?php echo $leafId; ?>, '<?php echo $race->getControllerPath(); ?>', '<?php echo $race->getViewPath(); ?>', '<?php echo $securityToken; ?>', 1, <?php echo $leafAccess['leafAccessDeleteValue']; ?>);
    <?php } ?>
                return false;
            }
    ...
    <?php if ($leafAccess['leafAccessDeleteValue'] == 1) { ?>
                    deleteRecord(<?php echo $leafId; ?>, '<?php echo $race->getControllerPath(); ?>', '<?php echo $race->getViewPath(); ?>', '<?php echo $securityToken; ?>', <?php echo $leafAccess['leafAccessDeleteValue']; ?>);
    ...
    <?php } ?>
            ...
            switch (e.keyCode) {
                case 37:
                    previousRecord(<?php echo $leafId; ?>, '<?php echo $race->getControllerPath(); ?>', '<?php echo $race->getViewPath(); ?>', '<?php echo $securityToken; ?>', <?php echo $leafAccess['leafAccessUpdateValue']; ?>, <?php echo $leafAccess['leafAccessDeleteValue']; ?>);
                    
                    return false;
                    break;
                case 39:
                    nextRecord(<?php echo $leafId; ?>, '<?php echo $race->getControllerPath(); ?>', '<?php echo $race->getViewPath(); ?>', '<?php echo $securityToken; ?>', <?php echo $leafAccess['leafAccessUpdateValue']; ?>, <?php echo $leafAccess['leafAccessDeleteValue']; ?>);
    ...
    <?php if ($_POST['method'] == "new") { ?>
        ...
        <?php if ($leafAccess['leafAccessCreateValue'] == 1) { ?>
                    $('#newRecordButton1')
                            .removeClass().addClass('btn btn-success').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $race->getControllerPath(); ?>','<?php echo $race->getViewPath(); ?>','<?php echo $securityToken; ?>',1)");
                    $('#newRecordButton2')
                            .removeClass().addClass('btn dropdown-toggle btn-success');
                    $('#newRecordButton3').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $race->getControllerPath(); ?>','<?php echo $race->getViewPath(); ?>','<?php echo $securityToken; ?>',1)");
                    $('#newRecordButton4').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $race->getControllerPath(); ?>','<?php echo $race->getViewPath(); ?>','<?php echo $securityToken; ?>',2)");
                    $('#newRecordButton5').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $race->getControllerPath(); ?>','<?php echo $race->getViewPath(); ?>','<?php echo $securityToken; ?>',3)");
                    $('#newRecordButton6').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $race->getControllerPath(); ?>','<?php echo $race->getViewPath(); ?>','<?php echo $securityToken; ?>',4)");
                    $('#newRecordButton7').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $race->getControllerPath(); ?>','<?php echo $race->getViewPath(); ?>','<?php echo $securityToken; ?>',5)");
        <?php } else { ?>
                    $('#newRecordButton1')
        ...
        if ($_POST['raceId']) {
            ...
            <?php if ($leafAccess['leafAccessUpdateValue'] == 1) { ?>
                        $('#updateRecordButton1')
                                .removeClass().addClass('btn btn-info').attr('onClick', "updateRecord(<?php echo $leafId; ?>,'<?php echo $race->getControllerPath(); ?>','<?php echo $race->getViewPath(); ?>','<?php echo $securityToken; ?>',1,<?php echo $leafAccess['leafAccessDeleteValue']; ?>);");
                        $('#updateRecordButton2')
                                .removeClass().addClass('btn dropdown-toggle btn-info');
                        $('#updateRecordButton3').attr('onClick', "updateRecord(<?php echo $leafId; ?>,'<?php echo $race->getControllerPath(); ?>','<?php echo $race->getViewPath(); ?>','<?php echo $securityToken; ?>',1,<?php echo $leafAccess['leafAccessDeleteValue']; ?>);");
                        $('#updateRecordButton4').attr('onClick', "updateRecord(<?php echo $leafId; ?>,'<?php echo $race->getControllerPath(); ?>','<?php echo $race->getViewPath(); ?>','<?php echo $securityToken; ?>',2,<?php echo $leafAccess['leafAccessDeleteValue']; ?>);");
                        $('#updateRecordButton5').attr('onClick', "updateRecord(<?php echo $leafId; ?>,'<?php echo $race->getControllerPath(); ?>','<?php echo $race->getViewPath(); ?>','<?php echo $securityToken; ?>',3,<?php echo $leafAccess['leafAccessDeleteValue']; ?>);");
            <?php } else { ?>
                        $('#updateRecordButton1')
                                .removeClass().addClass(' btn btn-info disabled');
                        $('#updateRecordButton2')
            ...
            <?php if ($leafAccess['leafAccessDeleteValue'] == 1) { ?>
                        $('#deleteRecordButton')
                                ...
                                .attr('onClick', "deleteRecord(<?php echo $leafId; ?>,'<?php echo $race->getControllerPath(); ?>','<?php echo $race->getViewPath(); ?>','<?php echo $securityToken; ?>',<?php echo $leafAccess['leafAccessDeleteValue']; ?>);");
            <?php } else { ?>
                        $('#deleteRecordButton')
                                .removeClass().addClass('btn btn-danger disabled')
                                .attr('onClick', '');
...
<?php } ?>
<script type="text/javascript" src="./v3/system/common/javascript/race.js"></script>
<hr>
