...
require_once($newFakeDocumentRoot . "v3/system/common/controller/cityController.php");
...
$translator->setCurrentTable('city');
...
if (isset($_POST)) {
    if (isset($_POST['method'])) {
        $city = new \Core\System\Common\City\Controller\CityClass();
        define('LIMIT', 10);
        ...
        if (isset($_POST ['query'])) {
            $city->setFieldQuery($_POST ['query']);
        }
        if (isset($_POST ['filter'])) {
            $city->setGridQuery($_POST ['filter']);
        }
        if (isset($_POST ['character'])) {
            $city->setCharacterQuery($_POST['character']);
        }
        if (isset($_POST ['dateRangeStart'])) {
            $city->setDateRangeStartQuery($_POST['dateRangeStart']);
            //explode the data to get day,month,year
            $start = explode('-', $_POST ['dateRangeStart']);
            $city->setStartDay($start[2]);
            $city->setStartMonth($start[1]);
            $city->setStartYear($start[0]);
        }
        if (isset($_POST ['dateRangeEnd']) && (strlen($_POST['dateRangeEnd']) > 0)) {
            $city->setDateRangeEndQuery($_POST['dateRangeEnd']);
            //explode the data to get day,month,year
            $start = explode('-', $_POST ['dateRangeEnd']);
            $city->setEndDay($start[2]);
            $city->setEndMonth($start[1]);
            $city->setEndYear($start[0]);
        }
        if (isset($_POST ['dateRangeType'])) {
            $city->setDateRangeTypeQuery($_POST['dateRangeType']);
        }
        if (isset($_POST ['dateRangeExtraType'])) {
            $city->setDateRangeExtraTypeQuery($_POST['dateRangeExtraType']);
        }
        $city->setServiceOutput('html');
        $city->setLeafId($leafId);
        $city->execute();
        $countryArray = $city->getCountry();
        $stateArray = $city->getState();
        if ($_POST['method'] == 'read') {
            $city->setStart($offset);
            $city->setLimit($limit); // normal system don't like paging..
            $city->setPageOutput('html');
            $cityArray = $city->read();
            if (isset($cityArray [0]['firstRecord'])) {
                $firstRecord = $cityArray [0]['firstRecord'];
            }
            if (isset($cityArray [0]['nextRecord'])) {
                $nextRecord = $cityArray [0]['nextRecord'];
            }
            if (isset($cityArray [0]['previousRecord'])) {
                $previousRecord = $cityArray [0]['previousRecord'];
            }
            if (isset($cityArray [0]['lastRecord'])) {
                $lastRecord = $cityArray [0]['lastRecord'];
                $endRecord = $cityArray [0]['lastRecord'];
            }
            $navigation = new \Core\Paging\HtmlPaging();
            $navigation->setLeafId($leafId);
            $navigation->setViewPath($city->getViewPath());
            ...
            if (isset($cityArray [0]['total'])) {
                $total = $cityArray [0]['total'];
            } else {
                $total = 0;
            }
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <form class="form-forizontal">
                                ...
                                <table class="table table table-bordered table-striped table-condensed table-hover smart-form has-tickbox tableSpace">
                                    <tr>
                                        <td>&nbsp;</td>
                                    ...
                                    <tr>
                                        ...
                                        <td align="center"><img src="./images/icons/calendar-select-days.png" alt="<?php echo $t['dayTextLabel'] ?>"> </td>
                                        <td align="center"><a href="javascript:void(0)" onclick="ajaxQuerySearchAllDate(<?php echo $leafId; ?>, '<?php
                                            echo $city->getViewPath();
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form class="form-horizontal">
                                        <input type="hidden" name="cityIdPreview" id="cityIdPreview">
                                        ...
                                        <div class="form-group" id="districtIdDiv">
                                            <label for="districtIdPreview"
                                                   class="control-label col-xs-4 col-sm-4 col-md-4"><?php echo $leafTranslation['districtIdLabel']; ?></label>
                                            <div class="col-xs-8 col-sm-8 col-md-8">
                                                <input class="form-control" type="text" name="districtIdPreview"
                                                       id="districtIdPreview">
                                            </div>
                                        </div>
                                        <div class="form-group" id="cityCodeDiv">
                                            <label for="cityCodePreview"
                                                   class="control-label col-xs-4 col-sm-4 col-md-4"><?php echo $leafTranslation['cityCodeLabel']; ?></label>
                                            <div class="col-xs-8 col-sm-8 col-md-8">
                                                <input class="form-control" type="text" name="cityCodePreview"
                                                       id="cityCodePreview">
                                            </div>
                                        </div>
                                        <div class="form-group" id="cityDescriptionDiv">
                                            <label for="cityDescriptionPreview"
                                                   class="control-label col-xs-4 col-sm-4 col-md-4"><?php echo $leafTranslation['cityDescriptionLabel']; ?></label>
                                            <div class="col-xs-8 col-sm-8 col-md-8">
                                                <input class="form-control" type="text" name="cityDescriptionPreview"
                                                       id="cityDescriptionPreview">
                                            </div>
                                        </div>
                                    </form>
                                </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="panel panel-default">
                                <table class="table table table-bordered table-striped table-condensed table-hover smart-form has-tickbox" id="tableData">
                                    ...
                                    <th><?php echo ucwords($leafTranslation['cityDescriptionLabel']); ?></th>
                                            ...
                                            if (is_array($cityArray)) {
                                                ...
                                                if ($totalRecord > 0) {
                                                    ...
                                                    for ($i = 0; $i < $totalRecord; $i++) {
                                                        ...
                                                        ?>
                                                        <tr <?php
                                                        if ($cityArray[$i]['isDelete'] == 1) {
                                                            echo "class=\"danger\"";
                                                        } else {
                                                            if ($cityArray[$i]['isDraft'] == 1) {
                                                                echo "class=\"warning\"";
                                                            }
                                                        }
                                                        ?>>
                                                            ...
                                                            <td align="center">
															<?php if($cityArray [$i]['cityCode'] !='UNBL') { ?>
															<div class="btn-group" align="center">
                                                                    ...
                                                                    ?>', '<?php
                                                                    echo rawurlencode(
                                                                            $cityArray [$i]['countryDescription']
                                                                    );
                                                                    ?>', '<?php
                                                                    echo rawurlencode(
                                                                            $cityArray [$i]['stateDescription']
                                                                    );
                                                                    ?>', '<?php
                                                                    echo rawurlencode(
                                                                            $cityArray [$i]['districtDescription']
                                                                    );
                                                                    ?>', '<?php
                                                                    echo rawurlencode(
                                                                            $cityArray [$i]['cityCode']
                                                                    );
                                                                    ?>', '<?php echo rawurlencode($cityArray [$i]['cityDescription']); ?>');"> <i class="glyphicon glyphicon-trash glyphicon-white"></i></button>
                                                                </div><?php } else { ?>&nbsp;<?php } ?></td>
                                                            <td><div class="pull-left">
                                                                    <?php
                                                                    if (isset($cityArray[$i]['countryDescription'])) {
                                                                        if (isset($_POST['query']) || isset($_POST['character'])) {
                                                                            if (isset($_POST['query']) && strlen($_POST['query']) > 0) {
                                                                                if (strpos(
                                                                                                $cityArray[$i]['countryDescription'], $_POST['query']
                                                                                        ) !== false
                                                                                ) {
                                                                                    echo str_replace(
                                                                                            $_POST['query'], "<span class=\"label label-info\">" . $_POST['query'] . "</span>", $cityArray[$i]['countryDescription']
                                                                                    );
                                                                                } else {
                                                                                    echo $cityArray[$i]['countryDescription'];
                                                                                }
                                                                            } else {
                                                                                if (isset($_POST['character']) && strlen($_POST['character']) > 0) {
                                                                                    if (strpos(
                                                                                                    $cityArray[$i]['countryDescription'], $_POST['character']
                                                                                            ) !== false
                                                                                    ) {
                                                                                        echo str_replace(
                                                                                                $_POST['character'], "<span class=\"label label-info\">" . $_POST['character'] . "</span>", $cityArray[$i]['countryDescription']
                                                                                        );
                                                                                    } else {
                                                                                        echo $cityArray[$i]['countryDescription'];
                                                                                    }
                                                            ...
                                                            <td><div class="pull-left">
                                                                    <?php
                                                                    if (isset($cityArray[$i]['stateDescription'])) {
                                                                        if (isset($_POST['query']) || isset($_POST['character'])) {
                                                                            if (isset($_POST['query']) && strlen($_POST['query']) > 0) {
                                                                                if (strpos($cityArray[$i]['stateDescription'], $_POST['query']) !== false) {
                                                                                    echo str_replace(
                                                                                            $_POST['query'], "<span class=\"label label-info\">" . $_POST['query'] . "</span>", $cityArray[$i]['stateDescription']
                                                                                    );
                                                                                } else {
                                                                                    echo $cityArray[$i]['stateDescription'];
                                                                                }
                                                                            } else {
                                                                                if (isset($_POST['character']) && strlen($_POST['character']) > 0) {
                                                                                    if (strpos(
                                                                                                    $cityArray[$i]['stateDescription'], $_POST['character']
                                                                                            ) !== false
                                                                                    ) {
                                                                                        echo str_replace(
                                                                                                $_POST['character'], "<span class=\"label label-info\">" . $_POST['character'] . "</span>", $cityArray[$i]['stateDescription']
                                                                                        );
                                                                                    } else {
                                                                                        echo $cityArray[$i]['stateDescription'];
                                                                                    }
                                                            ...
                                                            <td><div class="pull-left">
                                                                    <?php
                                                                    if (isset($cityArray[$i]['cityDescription'])) {
                                                                        if (isset($_POST['query']) || isset($_POST['character'])) {
                                                                            if (isset($_POST['query']) && strlen($_POST['query']) > 0) {
                                                                                if (strpos(
                                                                                                strtolower($cityArray[$i]['cityDescription']), strtolower($_POST['query'])
                                                                                        ) !== false
                                                                                ) {
                                                                                    echo str_replace(
                                                                                            $_POST['query'], "<span class=\"label label-info\">" . $_POST['query'] . "</span>", $cityArray[$i]['cityDescription']
                                                                                    );
                                                                                } else {
                                                                                    echo $cityArray[$i]['cityDescription'];
                                                                                }
                                                                            } else {
                                                                                if (isset($_POST['character']) && strlen($_POST['character']) > 0) {
                                                                                    if (strpos(
                                                                                                    strtolower($cityArray[$i]['cityDescription']), strtolower($_POST['character'])
                                                                                            ) !== false
                                                                                    ) {
                                                                                        echo str_replace(
                                                                                                $_POST['character'], "<span class=\"label label-info\">" . $_POST['character'] . "</span>", $cityArray[$i]['cityDescription']
                                                                                        );
                                                                                    } else {
                                                                                        echo $cityArray[$i]['cityDescription'];
                                                                                    }
                                                            ...
                                                            <td><div align="center">
                                                                    <?php
                                                                    if (isset($cityArray[$i]['executeBy'])) {
                                                                        if (isset($_POST['query']) || isset($_POST['character'])) {
                                                                            if (isset($_POST['query']) && strlen($_POST['query']) > 0) {
                                                                                if (strpos($cityArray[$i]['staffName'], $_POST['query']) !== false) {
                                                                                    echo str_replace(
                                                                                            $_POST['query'], "<span class=\"label label-info\">" . $_POST['query'] . "</span>", $cityArray[$i]['staffName']
                                                                                    );
                                                                                } else {
                                                                                    echo $cityArray[$i]['staffName'];
                                                                                }
                                                                            } else {
                                                                                if (isset($_POST['character']) && strlen($_POST['character']) > 0) {
                                                                                    if (strpos(
                                                                                                    $cityArray[$i]['staffName'], $_POST['character']
                                                                                            ) !== false
                                                                                    ) {
                                                                                        echo str_replace(
                                                                                                $_POST['character'], "<span class=\"label label-info\">" . $_POST['character'] . "</span>", $cityArray[$i]['staffName']
                                                                                        );
                                                                                    } else {
                                                                                        echo $cityArray[$i]['staffName'];
                                                                                    }
                                                            ...
                                                            <?php
                                                            if (isset($cityArray[$i]['executeTime'])) {
                                                                $valueArray = $cityArray[$i]['executeTime'];
                                                            ...
                                                            <?php } ?>
                                                            <?php
                                                            if ($cityArray[$i]['isDelete']) {
                                                                $checked = "checked";
                                                            } else {
                                                                $checked = null;
                                                            }
                                                            ?>
                                                            <td><?php if($cityArray [$i]['cityCode'] !='UNBL') { ?><input style="display:none;" type="checkbox" name="cityId[]"
                                                                       value="<?php echo $cityArray[$i]['cityId']; ?>">
                                                                <input <?php echo $checked; ?> type="checkbox" name="isDelete[]"
                                                                                               value="<?php echo $cityArray[$i]['isDelete']; ?>">
																<?php } else { ?>&nbsp;<?php } ?>
                                                            </td>
                                                        </tr>
                                                        <?php
                        ...
                        <div class="col-xs-3 col-sm-3 col-md-3 pagination">
                            <div class="pull-right">
                                <button class="delete btn btn-warning" type="button" 
                                        ...
                                        echo $city->getControllerPath();
                                        ?>', '<?php echo $city->getViewPath(); ?>', '<?php echo $securityToken; ?>');"> <i class="glyphicon glyphicon-white glyphicon-trash"></i> </button>
                            </div>
                        </div>
                    </div>
                    <script type="text/javascript">
...
if ((isset($_POST['method']) == 'new' || isset($_POST['method']) == 'read') && $_POST['type'] == 'form') {
    ...
    <form class="form-horizontal">
        ...
        <div id="content" style="opacity: 1;">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="panel panel-info">
                        <div class="panel-heading">
                            <div align="right">
                                <div class="btn-group"> <button type="button" id="firstRecordbutton" class="btn btn-default"
                                            ...
                                            class="glyphicon glyphicon-fast-backward glyphicon-white"></i> <?php echo $t['firstButtonLabel']; ?> </button> </div>
                                <div class="btn-group"> <button type="button" id="previousRecordbutton" class="btn btn-default disabled"
                                                           onclick="previousRecord(<?php echo $leafId; ?>, '<?php
                                                           echo $city->getControllerPath();
                                                           ?>', '<?php
                                                           echo $city->getViewPath();
                                                           ?>', '<?php echo $securityToken; ?>',<?php echo $leafAccess['leafAccessUpdateValue']; ?>,<?php echo $leafAccess['leafAccessDeleteValue']; ?>);"><i
                                            class="glyphicon glyphicon-backward glyphicon-white"></i> <?php echo $t['previousButtonLabel']; ?> </button> </div>
                                <div class="btn-group"> <button type="button" id="nextRecordbutton" class="btn btn-default disabled"
                                                           onclick="nextRecord(<?php echo $leafId; ?>, '<?php
                                                           echo $city->getControllerPath();
                                                           ?>', '<?php
                                                           echo $city->getViewPath();
                                                           ?>', '<?php echo $securityToken; ?>',<?php echo $leafAccess['leafAccessUpdateValue']; ?>,<?php echo $leafAccess['leafAccessDeleteValue']; ?>);"><i
                                            class="glyphicon glyphicon-forward glyphicon-white"></i> <?php echo $t['nextButtonLabel']; ?> </button> </div>
                                <div class="btn-group"> <button type="button" id="endRecordbutton" class="btn btn-default"
                                                           onclick="endRecord(<?php echo $leafId; ?>, '<?php
                                                           echo $city->getControllerPath();
                                                           ?>', '<?php
                                                           echo $city->getViewPath();
                                                           ?>', '<?php echo $securityToken; ?>',<?php echo $leafAccess['leafAccessUpdateValue']; ?>,<?php echo $leafAccess['leafAccessDeleteValue']; ?>);"><i
                                            class="glyphicon glyphicon-fast-forward glyphicon-white"></i> <?php echo $t['endButtonLabel']; ?></button></div>
                            </div>
                        </div>
                        <div class="panel-body">
                            <input type="hidden" name="cityId" id="cityId" value="<?php
                                    ...
                                    <div class="col-xs-6 col-sm-6 col-md-6 form-group" id="countryIdForm">
                                        ...
                                        <div class="col-xs-8 col-sm-8 col-md-8">
                                            <select name="countryId" id="countryId" class="chzn-select form-control"
                                                    onChange="getState(<?php echo $leafId; ?>, '<?php
                                                    echo $city->getControllerPath();
                                                    ?>', '<?php echo $securityToken; ?>');">
                                                <option value=""></option>
                                                <?php
                                                if (is_array($countryArray)) {
                                                    ...
                                                    if ($totalRecord > 0) {
                                                        $d = 1;
                                                        for ($i = 0; $i < $totalRecord; $i++) {
                                                            if (isset($cityArray[0]['countryId'])) {
                                                                if ($cityArray[0]['countryId'] == $countryArray[$i]['countryId']) {
                                                                    $selected = "selected";
                                                                } else {
                                                                    $selected = null;
                                                                }
                                            ...
                                            <select name="stateId" id="stateId" class="chzn-select form-control">
                                                ...
                                                if (is_array($stateArray)) {
                                                    ...
                                                    if ($totalRecord > 0) {
                                                        $d = 1;
                                                        for ($i = 0; $i < $totalRecord; $i++) {
                                                            if (isset($cityArray[0]['stateId'])) {
                                                                if ($cityArray[0]['stateId'] == $stateArray[$i]['stateId']) {
                                                                    $selected = "selected";
                                                                } else {
                                                                    $selected = null;
                                                                }
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group" id="cityDescriptionForm">
                                        <div class="col-xs-12 col-sm-12 col-md-12">
                                            <textarea class="form-control" rows="5" name="cityDescription"
                                                      id="cityDescription"><?php
                                                          if (isset($cityArray[0]['cityDescription'])) {
                                                              echo htmlentities($cityArray[0]['cityDescription']);
                                                          }
                                                          ?>
                                            </textarea>
                                            <span class="help-block" id="cityDescriptionHelpMe"></span> </div>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <!---<li><a id="updateRecordButton4" href="javascript:void(0)"><i class="glyphicon glyphicon-print"></i><?php //echo $t['updateButtonPrintLabel'];                       ?></a></li> -->
                            ...
                            <div class="btn-group"> <a id="resetRecordbutton" class="btn btn-info"
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            validateMeAlphaNumeric('cityCode');
    <?php if ($_POST['method'] == "new") { ?>
        ...
        <?php if ($leafAccess['leafAccessCreateValue'] == 1) { ?>
                    $('#newRecordButton1')
                            .removeClass().addClass('btn btn-success').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $city->getControllerPath(); ?>','<?php echo $city->getViewPath(); ?>','<?php echo $securityToken; ?>',1)");
                    $('#newRecordButton2')
                            .removeClass().addClass('btn dropdown-toggle btn-success');
                    $('#newRecordButton3').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $city->getControllerPath(); ?>','<?php echo $city->getViewPath(); ?>','<?php echo $securityToken; ?>',1)");
                    $('#newRecordButton4').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $city->getControllerPath(); ?>','<?php echo $city->getViewPath(); ?>','<?php echo $securityToken; ?>',2)");
                    $('#newRecordButton5').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $city->getControllerPath(); ?>','<?php echo $city->getViewPath(); ?>','<?php echo $securityToken; ?>',3)");
                    $('#newRecordButton6').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $city->getControllerPath(); ?>','<?php echo $city->getViewPath(); ?>','<?php echo $securityToken; ?>',4)");
                    $('#newRecordButton7').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $city->getControllerPath(); ?>','<?php echo $city->getViewPath(); ?>','<?php echo $securityToken; ?>',5)");
        <?php } else { ?>
                    $('#newRecordButton1')
        ...
        if ($_POST['cityId']) {
            ...
            <?php if ($leafAccess['leafAccessUpdateValue'] == 1) { ?>
                        $('#updateRecordButton1')
                                .removeClass().addClass('btn btn-info').attr('onClick', "updateRecord(<?php echo $leafId; ?>,'<?php echo $city->getControllerPath(); ?>','<?php echo $city->getViewPath(); ?>','<?php echo $securityToken; ?>',1,<?php echo $leafAccess['leafAccessDeleteValue']; ?>);");
                        $('#updateRecordButton2')
                                .removeClass().addClass('btn dropdown-toggle btn-info');
                        $('#updateRecordButton3').attr('onClick', "updateRecord(<?php echo $leafId; ?>,'<?php echo $city->getControllerPath(); ?>','<?php echo $city->getViewPath(); ?>','<?php echo $securityToken; ?>',1,<?php echo $leafAccess['leafAccessDeleteValue']; ?>);");
                        $('#updateRecordButton4').attr('onClick', "updateRecord(<?php echo $leafId; ?>,'<?php echo $city->getControllerPath(); ?>','<?php echo $city->getViewPath(); ?>','<?php echo $securityToken; ?>',2,<?php echo $leafAccess['leafAccessDeleteValue']; ?>);");
                        $('#updateRecordButton5').attr('onClick', "updateRecord(<?php echo $leafId; ?>,'<?php echo $city->getControllerPath(); ?>','<?php echo $city->getViewPath(); ?>','<?php echo $securityToken; ?>',3,<?php echo $leafAccess['leafAccessDeleteValue']; ?>);");
            <?php } else { ?>
                        $('#updateRecordButton1')
                                .removeClass().addClass(' btn btn-info disabled');
                        $('#updateRecordButton2')
            ...
            <?php if ($leafAccess['leafAccessDeleteValue'] == 1) { ?>
                        $('#deleteRecordButton')
                                ...
                                .attr('onClick', "deleteRecord(<?php echo $leafId; ?>,'<?php echo $city->getControllerPath(); ?>','<?php echo $city->getViewPath(); ?>','<?php echo $securityToken; ?>',<?php echo $leafAccess['leafAccessDeleteValue']; ?>);");
            <?php } else { ?>
                        $('#deleteRecordButton')
                                .removeClass().addClass('btn btn-danger disabled')
                                .attr('onClick', '');
...
<?php } ?>
<script type="text/javascript" src="./v3/system/common/javascript/city.js"></script>
<hr>
<footer>
    <p>IDCMS 2012/2013</p>
</footer>
