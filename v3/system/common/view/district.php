...
require_once($newFakeDocumentRoot . "v3/system/common/controller/districtController.php");
...
$translator->setCurrentTable('district');
...
if (isset($_POST)) {
    if (isset($_POST['method'])) {
        $district = new \Core\System\Common\District\Controller\DistrictClass();
        define('LIMIT', 10);
        ...
        if (isset($_POST ['query'])) {
            $district->setFieldQuery($_POST ['query']);
        }
        if (isset($_POST ['filter'])) {
            $district->setGridQuery($_POST ['filter']);
        }
        if (isset($_POST ['character'])) {
            $district->setCharacterQuery($_POST['character']);
        }
        if (isset($_POST ['dateRangeStart'])) {
            $district->setDateRangeStartQuery($_POST['dateRangeStart']);
            //explode the data to get day,month,year
            $start = explode('-', $_POST ['dateRangeStart']);
            $district->setStartDay($start[2]);
            $district->setStartMonth($start[1]);
            $district->setStartYear($start[0]);
        }
        if (isset($_POST ['dateRangeEnd']) && (strlen($_POST['dateRangeEnd']) > 0)) {
            $district->setDateRangeEndQuery($_POST['dateRangeEnd']);
            //explode the data to get day,month,year
            $start = explode('-', $_POST ['dateRangeEnd']);
            $district->setEndDay($start[2]);
            $district->setEndMonth($start[1]);
            $district->setEndYear($start[0]);
        }
        if (isset($_POST ['dateRangeType'])) {
            $district->setDateRangeTypeQuery($_POST['dateRangeType']);
        }
        if (isset($_POST ['dateRangeExtraType'])) {
            $district->setDateRangeExtraTypeQuery($_POST['dateRangeExtraType']);
        }
        $district->setServiceOutput('html');
        $district->setLeafId($leafId);
        $district->execute();
        $countryArray = $district->getCountry();
        $stateArray = $district->getState();
        if ($_POST['method'] == 'read') {
            $district->setStart($offset);
            $district->setLimit($limit); // normal system don't like paging..
            $district->setPageOutput('html');
            $districtArray = $district->read();
            if (isset($districtArray [0]['firstRecord'])) {
                $firstRecord = $districtArray [0]['firstRecord'];
            }
            if (isset($districtArray [0]['nextRecord'])) {
                $nextRecord = $districtArray [0]['nextRecord'];
            }
            if (isset($districtArray [0]['previousRecord'])) {
                $previousRecord = $districtArray [0]['previousRecord'];
            }
            if (isset($districtArray [0]['lastRecord'])) {
                $lastRecord = $districtArray [0]['lastRecord'];
                $endRecord = $districtArray [0]['lastRecord'];
            }
            $navigation = new \Core\Paging\HtmlPaging();
            $navigation->setLeafId($leafId);
            $navigation->setViewPath($district->getViewPath());
            ...
            if (isset($districtArray [0]['total'])) {
                $total = $districtArray [0]['total'];
            } else {
                $total = 0;
            }
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu" style="text-align:left">
                                <li>
                                    ...
                                    echo $district->getControllerPath();
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form class="form-horizontal">
                                        <input type="hidden" name="districtIdPreview" id="districtIdPreview">
                                        ...
                                        <div class="form-group" id="districtCodeDiv">
                                            <label for="districtCodePreview"
                                                   class="control-label col-xs-4 col-sm-4 col-md-4"><?php echo $leafTranslation['districtCodeLabel']; ?></label>

                                            <div class="col-xs-8 col-sm-8 col-md-8">
                                                <input class="form-control" type="text" name="districtCodePreview"
                                                       id="districtCodePreview">
                                            </div>
                                        </div>
                                        <div class="form-group" id="districtDescriptionDiv">
                                            <label for="districtDescriptionPreview"
                                                   class="control-label col-xs-4 col-sm-4 col-md-4"><?php echo $leafTranslation['districtDescriptionLabel']; ?></label>

                                            <div class="col-xs-8 col-sm-8 col-md-8">
                                                <input class="form-control" type="text" name="districtDescriptionPreview"
                                                       id="districtDescriptionPreview">
                                            </div>
                                        </div>
                                    </form>
                                </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="panel panel-default">
                                <table class="table table table-bordered table-striped table-condensed table-hover smart-form has-tickbox" id="tableData">
                                    ...
                                    <th><?php echo ucwords($leafTranslation['stateIdLabel']); ?></th>
                                    <th width="100px">
                                    <div align="center"><?php echo ucwords($leafTranslation['districtCodeLabel']); ?></div>
                                    </th>
                                    <th><?php echo ucwords($leafTranslation['districtDescriptionLabel']); ?></th>
                                    <th width="100px">
                                    ...
                                    <tbody id="tableBody">
                                        ...
                                        if ($_POST['method'] == 'read' && $_POST['type'] == 'list' && $_POST['detail'] == 'body') {
                                            if (is_array($districtArray)) {
                                                $totalRecord = intval(count($districtArray));
                                                if ($totalRecord > 0) {
                                                    $counter = 0;
                                                    for ($i = 0; $i < $totalRecord; $i++) {
                                                        ...
                                                        ?>
                                                        <tr <?php
                                                        if ($districtArray[$i]['isDelete'] == 1) {
                                                            echo "class=\"danger\"";
                                                        } else {
                                                            if ($districtArray[$i]['isDraft'] == 1) {
                                                                echo "class=\"warning\"";
                                                            }
                                                        }
                                                        ?>>
                                                            ...
                                                            <td align="center">
															   <?php if($districtArray [$i]['districtCode'] !='UNBL') { ?>
                                                                <div class="btn-group" align="center">
                                                                    ...
                                                                    ?>', '<?php
                                                                    echo rawurlencode(
                                                                            $districtArray [$i]['countryDescription']
                                                                    );
                                                                    ?>', '<?php
                                                                    echo rawurlencode(
                                                                            $districtArray [$i]['stateDescription']
                                                                    );
                                                                    ?>', '<?php
                                                                    echo rawurlencode(
                                                                            $districtArray [$i]['districtCode']
                                                                    );
                                                                    ?>', '<?php
                                                                    echo rawurlencode(
                                                                            $districtArray [$i]['districtDescription']
                                                                    );
                                                                    ?>');">
                                                            ...
                                                            <td>
                                                                <div class="pull-left">
                                                                    <?php
                                                                    if (isset($districtArray[$i]['countryDescription'])) {
                                                                        if (isset($_POST['query']) || isset($_POST['character'])) {
                                                                            if (isset($_POST['query']) && strlen($_POST['query']) > 0) {
                                                                                if (strpos(
                                                                                                $districtArray[$i]['countryDescription'], $_POST['query']
                                                                                        ) !== false
                                                                                ) {
                                                                                    echo str_replace(
                                                                                            $_POST['query'], "<span class=\"label label-info\">" . $_POST['query'] . "</span>", $districtArray[$i]['countryDescription']
                                                                                    );
                                                                                } else {
                                                                                    echo $districtArray[$i]['countryDescription'];
                                                                                }
                                                                            } else {
                                                                                if (isset($_POST['character']) && strlen($_POST['character']) > 0) {
                                                                                    if (strpos(
                                                                                                    $districtArray[$i]['countryDescription'], $_POST['character']
                                                                                            ) !== false
                                                                                    ) {
                                                                                        echo str_replace(
                                                                                                $_POST['character'], "<span class=\"label label-info\">" . $_POST['character'] . "</span>", $districtArray[$i]['countryDescription']
                                                                                        );
                                                                                    } else {
                                                                                        echo $districtArray[$i]['countryDescription'];
                                                                                    }
                                                            ...
                                                            <td>
                                                                <div class="pull-left">
                                                                    <?php
                                                                    if (isset($districtArray[$i]['stateDescription'])) {
                                                                        if (isset($_POST['query']) || isset($_POST['character'])) {
                                                                            if (isset($_POST['query']) && strlen($_POST['query']) > 0) {
                                                                                if (strpos(
                                                                                                $districtArray[$i]['stateDescription'], $_POST['query']
                                                                                        ) !== false
                                                                                ) {
                                                                                    echo str_replace(
                                                                                            $_POST['query'], "<span class=\"label label-info\">" . $_POST['query'] . "</span>", $districtArray[$i]['stateDescription']
                                                                                    );
                                                                                } else {
                                                                                    echo $districtArray[$i]['stateDescription'];
                                                                                }
                                                                            } else {
                                                                                if (isset($_POST['character']) && strlen($_POST['character']) > 0) {
                                                                                    if (strpos(
                                                                                                    $districtArray[$i]['stateDescription'], $_POST['character']
                                                                                            ) !== false
                                                                                    ) {
                                                                                        echo str_replace(
                                                                                                $_POST['character'], "<span class=\"label label-info\">" . $_POST['character'] . "</span>", $districtArray[$i]['stateDescription']
                                                                                        );
                                                                                    } else {
                                                                                        echo $districtArray[$i]['stateDescription'];
                                                                                    }
                                                            ...
                                                            <td>
                                                                <div class="pull-left">
                                                                    <?php
                                                                    if (isset($districtArray[$i]['districtCode'])) {
                                                                        if (isset($_POST['query']) || isset($_POST['character'])) {
                                                                            if (isset($_POST['query']) && strlen($_POST['query']) > 0) {
                                                                                if (strpos(
                                                                                                strtolower($districtArray[$i]['districtCode']), strtolower($_POST['query'])
                                                                                        ) !== false
                                                                                ) {
                                                                                    echo str_replace(
                                                                                            $_POST['query'], "<span class=\"label label-info\">" . $_POST['query'] . "</span>", $districtArray[$i]['districtCode']
                                                                                    );
                                                                                } else {
                                                                                    echo $districtArray[$i]['districtCode'];
                                                                                }
                                                                            } else {
                                                                                if (isset($_POST['character']) && strlen($_POST['character']) > 0) {
                                                                                    if (strpos(
                                                                                                    strtolower($districtArray[$i]['districtCode']), strtolower($_POST['character'])
                                                                                            ) !== false
                                                                                    ) {
                                                                                        echo str_replace(
                                                                                                $_POST['character'], "<span class=\"label label-info\">" . $_POST['character'] . "</span>", $districtArray[$i]['districtCode']
                                                                                        );
                                                                                    } else {
                                                                                        echo $districtArray[$i]['districtCode'];
                                                                                    }
                                                            ...
                                                            <td>
                                                                <div class="pull-left">
                                                                    <?php
                                                                    if (isset($districtArray[$i]['districtDescription'])) {
                                                                        if (isset($_POST['query']) || isset($_POST['character'])) {
                                                                            if (isset($_POST['query']) && strlen($_POST['query']) > 0) {
                                                                                if (strpos(
                                                                                                strtolower($districtArray[$i]['districtDescription']), strtolower($_POST['query'])
                                                                                        ) !== false
                                                                                ) {
                                                                                    echo str_replace(
                                                                                            $_POST['query'], "<span class=\"label label-info\">" . $_POST['query'] . "</span>", $districtArray[$i]['districtDescription']
                                                                                    );
                                                                                } else {
                                                                                    echo $districtArray[$i]['districtDescription'];
                                                                                }
                                                                            } else {
                                                                                if (isset($_POST['character']) && strlen($_POST['character']) > 0) {
                                                                                    if (strpos(
                                                                                                    strtolower($districtArray[$i]['districtDescription']), strtolower($_POST['character'])
                                                                                            ) !== false
                                                                                    ) {
                                                                                        echo str_replace(
                                                                                                $_POST['character'], "<span class=\"label label-info\">" . $_POST['character'] . "</span>", $districtArray[$i]['districtDescription']
                                                                                        );
                                                                                    } else {
                                                                                        echo $districtArray[$i]['districtDescription'];
                                                                                    }
                                                            ...
                                                            <td>
                                                                <div align="center">
                                                                    <?php
                                                                    if (isset($districtArray[$i]['executeBy'])) {
                                                                        if (isset($_POST['query']) || isset($_POST['character'])) {
                                                                            if (isset($_POST['query']) && strlen($_POST['query']) > 0) {
                                                                                if (strpos($districtArray[$i]['staffName'], $_POST['query']) !== false) {
                                                                                    echo str_replace(
                                                                                            $_POST['query'], "<span class=\"label label-info\">" . $_POST['query'] . "</span>", $districtArray[$i]['staffName']
                                                                                    );
                                                                                } else {
                                                                                    echo $districtArray[$i]['staffName'];
                                                                                }
                                                                            } else {
                                                                                if (isset($_POST['character']) && strlen($_POST['character']) > 0) {
                                                                                    if (strpos(
                                                                                                    $districtArray[$i]['staffName'], $_POST['character']
                                                                                            ) !== false
                                                                                    ) {
                                                                                        echo str_replace(
                                                                                                $_POST['character'], "<span class=\"label label-info\">" . $_POST['character'] . "</span>", $districtArray[$i]['staffName']
                                                                                        );
                                                                                    } else {
                                                                                        echo $districtArray[$i]['staffName'];
                                                                                    }
                                                            ...
                                                            <?php
                                                            if (isset($districtArray[$i]['executeTime'])) {
                                                                $valueArray = $districtArray[$i]['executeTime'];
                                                            ...
                                                            <td>
															<?php if($districtArray [$i]['districtCode'] !='UNBL') { ?>
                                                                <input style="display:none;" type="checkbox" name="districtId[]"
                                                                       value="<?php echo $districtArray[$i]['districtId']; ?>">
                                                                <input <?php echo $checked; ?> type="checkbox" name="isDelete[]"
                                                                                               value="<?php echo $districtArray[$i]['isDelete']; ?>">
																<?php } else { ?>&nbsp;<?php } ?>
                                                            </td>
                                                        </tr>
                                                        <?php
                        ...
                        <div class="col-xs-3 col-sm-3 col-md-3 pagination">
                            <div class="pull-right">
                                <button class="delete btn btn-warning" type="button" 
                                        ...
                                        echo $district->getControllerPath();
                                        ?>', '<?php echo $district->getViewPath(); ?>', '<?php echo $securityToken; ?>');">
...
if ((isset($_POST['method']) == 'new' || isset($_POST['method']) == 'read') && $_POST['type'] == 'form') {
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            <input type="hidden" name="districtId" id="districtId" value="<?php
                            if (isset($_POST['districtId'])) {
                                echo $_POST['districtId'];
                            }
                            ?>">
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="col-xs-6 col-sm-6 col-md-6 form-group" id="countryIdForm">
                                        ...
                                        <div class="col-xs-8 col-sm-8 col-md-8">
                                            <select name="countryId" id="countryId" class="chzn-select form-control" onClick="
                                                    getState(<?php echo $leafId; ?>, '<?php echo $district->getControllerPath(); ?>', '<?php echo $securityToken; ?>');">
                                                <option value=""></option>
                                                <?php
                                                if (is_array($countryArray)) {
                                                    ...
                                                    if ($totalRecord > 0) {
                                                        $d = 1;
                                                        for ($i = 0; $i < $totalRecord; $i++) {
                                                            if (isset($districtArray[0]['countryId'])) {
                                                                if ($districtArray[0]['countryId'] == $countryArray[$i]['countryId']) {
                                                                    $selected = "selected";
                                                                } else {
                                                                    $selected = null;
                                                                }
                                    ...
                                    <div class="col-xs-6 col-sm-6 col-md-6 form-group" id="stateIdForm">
                                        <label class="control-label col-xs-4 col-sm-4 col-md-4" for="stateId"><strong><?php
                                                echo ucfirst(
                                            ...
                                            <select name="stateId" id="stateId" class="chzn-select form-control">
                                                ...
                                                if (is_array($stateArray)) {
                                                    ...
                                                    if ($totalRecord > 0) {
                                                        $d = 1;
                                                        for ($i = 0; $i < $totalRecord; $i++) {
                                                            if (isset($districtArray[0]['stateId'])) {
                                                                if ($districtArray[0]['stateId'] == $stateArray[$i]['stateId']) {
                                                                    $selected = "selected";
                                                                } else {
                                                                    $selected = null;
                                                                }
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group" id="districtCodeForm">
                                        <label class="control-label col-xs-2 col-sm-2 col-md-2" for="districtCode"><strong><?php
                                                echo ucfirst(
                                                        $leafTranslation['districtCodeLabel']
                                                );
                                                ?></strong></label>

                                        <div class="control-label col-xs-4 col-sm-4 col-md-4">
                                            <div class="input-group">
                                                <input class="form-control" type="text" name="districtCode" id="districtCode"
                                                       value="<?php
                                                       if (isset($districtArray) && is_array($districtArray)) {
                                                           if (isset($districtArray[0]['districtCode'])) {
                                                               echo htmlentities($districtArray[0]['districtCode']);
                                                           }
                                                       }
                                                       ?>" maxlength="16"><span class="input-group-addon"><img
                                                        src="./images/icons/document-code.png"></span>
                                            </div>
                                            <span class="help-block" id="districtCodeHelpMe"></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group" id="districtDescriptionForm">
                                        <div class="col-xs-12 col-sm-12 col-md-12">
                                            <textarea rows="5" class="form-control" name="districtDescription" id="districtDescription"><?php
                                                if (isset($districtArray[0]['districtDescription'])) {
                                                    echo htmlentities($districtArray[0]['districtDescription']);
                                                }
                                                ?></textarea> <span class="help-block" id="districtDescriptionHelpMe"></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <?php if ($leafAccess['leafAccessCreateValue'] == 1) { ?>
                    ...
                    if (e.which === 78 && e.which === 18  && e.shiftKey) {
                        ...
                        newRecord(<?php echo $leafId; ?>, '<?php echo $district->getControllerPath(); ?>', '<?php echo $district->getViewPath(); ?>', '<?php echo $securityToken; ?>', 1);
    ...
    <?php if ($leafAccess['leafAccessUpdateValue'] == 1) { ?>
                    ...
                    if (e.which === 83 && e.which === 18  && e.shiftKey) {
                        ...
                        updateRecord(<?php echo $leafId; ?>, '<?php echo $district->getControllerPath(); ?>', '<?php echo $district->getViewPath(); ?>', '<?php echo $securityToken; ?>', 1, <?php echo $leafAccess['leafAccessDeleteValue']; ?>);
    ...
    <?php if ($leafAccess['leafAccessDeleteValue'] == 1) { ?>
                    ...
                    if (e.which === 88 && e.which === 18 && e.shiftKey) {
                        ...
                        deleteRecord(<?php echo $leafId; ?>, '<?php echo $district->getControllerPath(); ?>', '<?php echo $district->getViewPath(); ?>', '<?php echo $securityToken; ?>', <?php echo $leafAccess['leafAccessDeleteValue']; ?>);
    ...
    <?php } ?>
                switch (e.keyCode) {
                    case 37:
                        previousRecord(<?php echo $leafId; ?>, '<?php echo $district->getControllerPath(); ?>', '<?php echo $district->getViewPath(); ?>', '<?php echo $securityToken; ?>', <?php echo $leafAccess['leafAccessUpdateValue']; ?>, <?php echo $leafAccess['leafAccessDeleteValue']; ?>);
                        
                        return false;
                        break;
                    case 39:
                        nextRecord(<?php echo $leafId; ?>, '<?php echo $district->getControllerPath(); ?>', '<?php echo $district->getViewPath(); ?>', '<?php echo $securityToken; ?>', <?php echo $leafAccess['leafAccessUpdateValue']; ?>, <?php echo $leafAccess['leafAccessDeleteValue']; ?>);
            ...
            $(document).ready(function() {
                ...
                validateMeNumeric('districtId');
                validateMeNumeric('countryId');
                validateMeNumeric('stateId');
                validateMeAlphaNumeric('districtCode');
    <?php if ($_POST['method'] == "new") { ?>
                    $('#resetRecordButton').removeClass().addClass('btn btn-default');
        <?php if ($leafAccess['leafAccessCreateValue'] == 1) { ?>
                        $('#newRecordButton1')
                                .removeClass().addClass('btn btn-success').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $district->getControllerPath(); ?>','<?php echo $district->getViewPath(); ?>','<?php echo $securityToken; ?>',1)");
                        $('#newRecordButton2')
                                .removeClass().addClass('btn dropdown-toggle btn-success');
                        $('#newRecordButton3').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $district->getControllerPath(); ?>','<?php echo $district->getViewPath(); ?>','<?php echo $securityToken; ?>',1)");
                        $('#newRecordButton4').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $district->getControllerPath(); ?>','<?php echo $district->getViewPath(); ?>','<?php echo $securityToken; ?>',2)");
                        $('#newRecordButton5').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $district->getControllerPath(); ?>','<?php echo $district->getViewPath(); ?>','<?php echo $securityToken; ?>',3)");
                        $('#newRecordButton6').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $district->getControllerPath(); ?>','<?php echo $district->getViewPath(); ?>','<?php echo $securityToken; ?>',4)");
                        $('#newRecordButton7').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $district->getControllerPath(); ?>','<?php echo $district->getViewPath(); ?>','<?php echo $securityToken; ?>',5)");
        <?php } else { ?>
                        $('#newRecordButton1')
        ...
        if ($_POST['districtId']) {
            ...
            <?php if ($leafAccess['leafAccessUpdateValue'] == 1) { ?>
                            $('#updateRecordButton1')
                                    .removeClass().addClass('btn btn-info').attr('onClick', "updateRecord(<?php echo $leafId; ?>,'<?php echo $district->getControllerPath(); ?>','<?php echo $district->getViewPath(); ?>','<?php echo $securityToken; ?>',1,<?php echo $leafAccess['leafAccessDeleteValue']; ?>);");
                            $('#updateRecordButton2')
                                    .removeClass().addClass('btn dropdown-toggle btn-info');
                            $('#updateRecordButton3').attr('onClick', "updateRecord(<?php echo $leafId; ?>,'<?php echo $district->getControllerPath(); ?>','<?php echo $district->getViewPath(); ?>','<?php echo $securityToken; ?>',1,<?php echo $leafAccess['leafAccessDeleteValue']; ?>);");
                            $('#updateRecordButton4').attr('onClick', "updateRecord(<?php echo $leafId; ?>,'<?php echo $district->getControllerPath(); ?>','<?php echo $district->getViewPath(); ?>','<?php echo $securityToken; ?>',2,<?php echo $leafAccess['leafAccessDeleteValue']; ?>);");
                            $('#updateRecordButton5').attr('onClick', "updateRecord(<?php echo $leafId; ?>,'<?php echo $district->getControllerPath(); ?>','<?php echo $district->getViewPath(); ?>','<?php echo $securityToken; ?>',3,<?php echo $leafAccess['leafAccessDeleteValue']; ?>);");
            <?php } else { ?>
                            $('#updateRecordButton1')
                                    .removeClass().addClass(' btn btn-info disabled');
                            $('#updateRecordButton2')
            ...
            <?php if ($leafAccess['leafAccessDeleteValue'] == 1) { ?>
                            $('#deleteRecordButton')
                                    ...
                                    .attr('onClick', "deleteRecord(<?php echo $leafId; ?>,'<?php echo $district->getControllerPath(); ?>','<?php echo $district->getViewPath(); ?>','<?php echo $securityToken; ?>',<?php echo $leafAccess['leafAccessDeleteValue']; ?>);");
            <?php } else { ?>
                            $('#deleteRecordButton')
                                    .removeClass().addClass('btn btn-danger disabled')
                                    .attr('onClick', '');
...
<script type="text/javascript" src="./v3/system/common/javascript/district.js"></script>
<hr>
