function getBusinessPartner(leafId, url, securityToken) {
    $.ajax({
        ...
        data: {
            ...
            from: 'purchaseInvoiceCreditNote.php'
        },
        beforeSend: function() {
...
function showFormUpdateDetail(leafId, url, securityToken, purchaseInvoiceCreditNoteDetailId) {
    ...
    $.ajax({
        ...
        data: {
            ...
            purchaseInvoiceId: $('#purchaseInvoiceId' + purchaseInvoiceCreditNoteDetailId).val(),
            purchaseInvoiceCreditNoteId: $('#purchaseInvoiceCreditNoteId').val(),
            chartOfAccountId: $('#chartOfAccountId' + purchaseInvoiceCreditNoteDetailId).val(),
            businessPartnerId: $('#businessPartnerId' + purchaseInvoiceCreditNoteDetailId).val(),
            documentNumber: $('#documentNumber' + purchaseInvoiceCreditNoteDetailId).val(),
            journalNumber: $('#journalNumber' + purchaseInvoiceCreditNoteDetailId).val(),
...
function newRecord(leafId, url, urlList, securityToken, type, createAccess, updateAccess, deleteAccess) {
    ...
    var $purchaseInvoiceCreditNoteText = $('#purchaseInvoiceCreditNoteText');
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (success === true) {
                    ...
                    $('#purchaseInvoiceCreditNoteId').val(data.purchaseInvoiceCreditNoteId);
                    $('#newRecordButton1').removeClass().addClass('btn btn-success disabled');
                    if (updateAccess === 1) {
                        $('#updateRecordButton1').removeClass().addClass('btn btn-info');
                        $('#updateRecordButton2').removeClass().addClass('btn dropdown-toggle btn-info');
    ...
    if (css.search('disabled') > 0) {
        ...
        if (type === 1) {
            ...
            if ($purchaseInvoiceCreditNoteDate.val().length === 0) {
                ...
                $('#purchaseInvoiceCreditNoteDateForm').removeClass().addClass('form-group has-error');
