function getBusinessPartner(leafId, url, securityToken) {
    $.ajax({
        ...
        data: {
            ...
            from: 'purchaseInvoiceCreditNoteMaintenance.php'
        },
        beforeSend: function() {
...
function checkDuplicate(leafId, page, securityToken) {
    var $purchaseInvoiceCreditNoteCode = $("#purchaseInvoiceCreditNoteCode");
    if ($purchaseInvoiceCreditNoteCode.val().length === 0) {
    ...
    $.ajax({
        ...
        url: page,
        data: {
            purchaseInvoiceCreditNoteCode: $purchaseInvoiceCreditNoteCode.val(),
            method: 'duplicate',
            securityToken: securityToken,
            leafId: leafId,
            from: 'purchaseInvoiceCreditNoteMaintenance.php'
        ...
        success: function(data) {
            ...
            if (success === true) {
                if (total !== 0) {
                    $("#purchaseInvoiceCreditNoteCode").val('').focus();
                    $("#purchaseInvoiceCreditNoteCodeForm").removeClass().addClass("form-group has-error");
                ...
                $("#purchaseInvoiceCreditNoteForm").removeClass().addClass("form-group has-error");
            }
            if ($infoPanel.is(':hidden')) {
                $infoPanel.show();
            }
...
function showFormUpdate(leafId, url, urlList, securityToken, purchaseInvoiceCreditNoteId, updateAccess, deleteAccess) {
    sleep(500);
...
function showModalDelete(purchaseInvoiceCreditNoteId, businessPartnerId, purchaseInvoiceId, purchaseInvoiceCreditNoteTitle, documentNumber, purchaseInvoiceCreditNoteAmount, purchaseInvoiceCreditNoteText, referenceNumber, purchaseInvoiceCreditNoteDate, purchaseInvoiceCreditNoteDescription) {
    $('#purchaseInvoiceCreditNoteIdPreview').val('').val(decodeURIComponent(purchaseInvoiceCreditNoteId));
    ...
    $('#purchaseInvoiceCreditNoteTitlePreview').val('').val(decodeURIComponent(purchaseInvoiceCreditNoteTitle));
    $('#documentNumberPreview').val('').val(decodeURIComponent(documentNumber));
    $('#purchaseInvoiceCreditNoteAmountPreview').val('').val(decodeURIComponent(purchaseInvoiceCreditNoteAmount));
    $('#purchaseInvoiceCreditNoteTextPreview').val('').val(decodeURIComponent(purchaseInvoiceCreditNoteText));
    $('#referenceNumberPreview').val('').val(decodeURIComponent(referenceNumber));
    $('#purchaseInvoiceCreditNoteDatePreview').val('').val(decodeURIComponent(purchaseInvoiceCreditNoteDate));
    $('#purchaseInvoiceCreditNoteDescriptionPreview').val('').val(decodeURIComponent(purchaseInvoiceCreditNoteDescription));
...
function deleteGridRecord(leafId, url, urlList, securityToken) {
    $.ajax({
        ...
        data: {
            method: 'delete',
            output: 'json',
            purchaseInvoiceCreditNoteId: $('#purchaseInvoiceCreditNoteIdPreview').val(),
            securityToken: securityToken,
            leafId: leafId,
            from: 'purchaseInvoiceCreditNoteMaintenance.php'
        },
...
function showFormCreateDetail(leafId, url, securityToken) {
    ...
    if ($('#purchaseInvoiceCreditNoteDetailAmount9999').val().length === 0) {
        $infoPanel.html('').empty().html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['purchaseInvoiceCreditNoteDetailAmountLabel'] + "</span>");
        $('#purchaseInvoiceCreditNoteDetailAmount9999HelpMe').html('').empty().html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['purchaseInvoiceCreditNoteDetailAmountLabel'] + "</span>");
        $('#purchaseInvoiceCreditNoteDetailAmount9999Form').removeClass().addClass('form-group has-error');
        $('#purchaseInvoiceCreditNoteDetailAmount9999').focus();
        return false;
    }
    ...
    $.ajax({
        ...
        data: {
            method: 'create',
            output: 'json',
            purchaseInvoiceCreditNoteId: $('#purchaseInvoiceCreditNoteId').val(),
            purchaseInvoiceId: $('#purchaseInvoice').val(),
            chartOfAccountId: $('#chartOfAccountId9999').val(),
            businessPartnerId: $('#businessPartnerId').val(),
            purchaseInvoiceCreditNoteDetailAmount: $('#purchaseInvoiceCreditNoteDetailAmount9999').val(),
            securityToken: securityToken,
            leafId: leafId,
            from: 'purchaseInvoiceCreditNoteMaintenance.php'
        },
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (success === true) {
                            ...
                            $("#purchaseInvoiceCreditNoteDetailAmount9999").prop("disabled", "false").removeAttr("disabled", "").val('');
                            $(".chzn-select").chosen();
                            $infoPanel.html('').empty().html("<span class='label label-success'>&nbsp;<img src='" + smileyLol + "'> " + decodeURIComponent(t['loadingCompleteTextLabel']) + "</span>").delay(1000).fadeOut();
                            if ($infoPanel.is(':hidden')) {
                                $infoPanel.show();
...
function showFormUpdateDetail(leafId, url, securityToken, purchaseInvoiceCreditNoteDetailId) {
    var $infoPanel = $('#infoPanel');
    if ($('#chartOfAccountId' + purchaseInvoiceCreditNoteDetailId).val().length === 0) {
        ...
        $('#chartOfAccountId' + purchaseInvoiceCreditNoteDetailId + 'HelpMe').html('').empty().html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + ' :' + leafTranslation['chartOfAccountIdLabel'] + "</span>");
        $('#chartOfAccountId' + purchaseInvoiceCreditNoteDetailId).removeClass().addClass('form-group has-error');
        $('#chartOfAccountId' + purchaseInvoiceCreditNoteDetailId).focus();
        return false;
    }
    if ($('#purchaseInvoiceCreditNoteDetailAmount' + purchaseInvoiceCreditNoteDetailId).val().length === 0) {
        $infoPanel.html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + ' :' + leafTranslation['purchaseInvoiceCreditNoteDetailAmountLabel'] + "</span>");
        $('#purchaseInvoiceCreditNoteDetailAmount' + purchaseInvoiceCreditNoteDetailId + 'HelpMe').html('').empty().html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + ' :' + leafTranslation['purchaseInvoiceCreditNoteDetailAmountLabel'] + "</span>");
        $('#purchaseInvoiceCreditNoteDetailAmount' + purchaseInvoiceCreditNoteDetailId).removeClass().addClass('form-group has-error');
        $('#purchaseInvoiceCreditNoteDetailAmount' + purchaseInvoiceCreditNoteDetailId).focus();
        return false;
    }
    $.ajax({
        type: 'POST',
        ...
        data: {
            method: 'save',
            output: 'json',
            purchaseInvoiceCreditNoteDetailId: $('#purchaseInvoiceCreditNoteDetailId' + purchaseInvoiceCreditNoteDetailId).val(),
            purchaseInvoiceId: $('#purchaseInvoiceId').val(),
            purchaseInvoiceCreditNoteId: $('#purchaseInvoiceCreditNoteId').val(),
            chartOfAccountId: $('#chartOfAccountId' + purchaseInvoiceCreditNoteDetailId).val(),
            businessPartnerId: $('#businessPartnerId').val(),
            purchaseInvoiceCreditNoteDetailAmount: $('#purchaseInvoiceCreditNoteDetailAmount' + purchaseInvoiceCreditNoteDetailId).val(),
            securityToken: securityToken,
            leafId: leafId,
            from: 'purchaseInvoiceCreditNoteMaintenance.php'
        },
        beforeSend: function() {
            ...
            var $infoPanel = $('#infoPanel');
            $infoPanel.html('').empty().html("<span class='label label-warning'>&nbsp;<img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
            $('#miniInfoPanel' + purchaseInvoiceCreditNoteDetailId).html('').empty().html("<span class='label label-warning'> <img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
            if ($infoPanel.is(':hidden')) {
                $infoPanel.show();
            }
        },
        success: function(data) {
            var $infoPanel = $('#infoPanel');
            var $miniInfoPanel = $('#miniInfoPanel' + purchaseInvoiceCreditNoteDetailId);
            var smileyLol = './images/icons/smiley-lol.png';
            var success = data.success;
            var message = data.message;
            if (success === true) {
...
function showModalDeleteDetail(purchaseInvoiceCreditNoteDetailId) {
    $('#purchaseInvoiceCreditNoteDetailIdPreview').val('').val(decodeURIComponent($("#purchaseInvoiceCreditNoteDetailId" + purchaseInvoiceCreditNoteDetailId).val()));
    $('#purchaseInvoiceIdPreview').val('').val(decodeURIComponent($("#purchaseInvoiceId" + purchaseInvoiceCreditNoteDetailId + " option:selected").text()));
    $('#chartOfAccountIdPreview').val('').val(decodeURIComponent($("#chartOfAccountId" + purchaseInvoiceCreditNoteDetailId + " option:selected").text()));
    $('#businessPartnerIdPreview').val('').val(decodeURIComponent($("#businessPartnerId" + purchaseInvoiceCreditNoteDetailId + " option:selected").text()));
    $('#documentNumberPreview').val('').val(decodeURIComponent($("#documentNumber" + purchaseInvoiceCreditNoteDetailId).val()));
    $('#journalNumberPreview').val('').val(decodeURIComponent($("#journalNumber" + purchaseInvoiceCreditNoteDetailId).val()));
    $('#purchaseInvoiceCreditNoteDetailAmountPreview').val('').val(decodeURIComponent($("#purchaseInvoiceCreditNoteDetailAmount" + purchaseInvoiceCreditNoteDetailId).val()));
...
function deleteGridRecordDetail(leafId, url, urlList, securityToken) {
    $.ajax({
        ...
        data: {
            method: 'delete',
            output: 'json',
            purchaseInvoiceCreditNoteDetailId: $('#purchaseInvoiceCreditNoteDetailIdPreview').val(),
            securityToken: securityToken,
            leafId: leafId,
            from: 'purchaseInvoiceCreditNoteMaintenance.php'
        },
        ...
        success: function(data) {
            ...
            if (success === true) {
                ...
                removeMeTr($('#purchaseInvoiceCreditNoteDetailIdPreview').val());
            } else if (success === false) {
                $infoPanel.html('').empty().html("<span class='label label-danger'> " + message + "</span>");
                if ($infoPanel.is(':hidden')) {
                    $infoPanel.show();
...
function deleteGridRecordCheckbox(leafId, url, urlList, securityToken) {
    var stringText = '';
    var counter = 0;
    $('input:checkbox[name="purchaseInvoiceCreditNoteId[]"]').each(function() {
        stringText = stringText + "&purchaseInvoiceCreditNoteId[]=" + $(this).val();
    });
...
function updateRecord(leafId, url, urlList, securityToken, type, deleteAccess) {
    ...
    var $purchaseInvoiceCreditNoteId = $('#purchaseInvoiceCreditNoteId');
    var $businessPartnerId = $('#businessPartnerId');
    var $purchaseInvoiceId = $('#purchaseInvoiceId');
    var $purchaseInvoiceCreditNoteAmount = $('#purchaseInvoiceCreditNoteAmount');
    var $referenceNumber = $('#referenceNumber');
    var $purchaseInvoiceCreditNoteDate = $('#purchaseInvoiceCreditNoteDate');
    var $purchaseInvoiceCreditNoteDescription = $('#purchaseInvoiceCreditNoteDescription');
    if (css.search('disabled') > 0) {
        return false;
    } else {
        ...
        if (type === 1) {
            ...
            if ($purchaseInvoiceId.val().length === 0) {
                $('#purchaseInvoiceIdHelpMe').html('').empty().html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['purchaseInvoiceIdLabel'] + " </span>");
                $purchaseInvoiceId.data('chosen').activate_action();
                return false;
            }
            if ($purchaseInvoiceCreditNoteDate.val().length === 0) {
                $('#purchaseInvoiceCreditNoteDateHelpMe').html('').empty().html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['purchaseInvoiceCreditNoteDateLabel'] + " </span>");
                $('#purchaseInvoiceCreditNoteDateForm').removeClass().addClass('col-xs-4 col-sm-4 col-md-4 col-lg-4 form-group has-error');
                $purchaseInvoiceCreditNoteDate.focus();
                return false;
            }
            $infoPanel.html('').empty();
            $.ajax({
                ...
                data: {
                    ...
                    businessPartnerId: $businessPartnerId.val(),
                    purchaseInvoiceId: $purchaseInvoiceId.val(),
                    purchaseInvoiceCreditNoteAmount: $purchaseInvoiceCreditNoteAmount.val(),
                    referenceNumber: $referenceNumber.val(),
                    purchaseInvoiceCreditNoteDate: $purchaseInvoiceCreditNoteDate.val(),
                    purchaseInvoiceCreditNoteDescription: $purchaseInvoiceCreditNoteDescription.val(),
                    securityToken: securityToken,
                    leafId: leafId,
                    from: 'purchaseInvoiceCreditNoteMaintenance.php'
                },
    ...
    if (css.search('disabled') > 0) {
        ...
        if (deleteAccess === 1) {
            if (confirm(decodeURIComponent(t['deleteRecordMessageLabel']))) {
                var value = $purchaseInvoiceCreditNoteId.val();
                if (!value) {
...
function resetRecord(leafId, url, urlList, urlPurchaseInvoiceCreditNoteDetail, securityToken, createAccess, updateAccess, deleteAccess) {
    ...
    $('#firstRecordButton').removeClass().addClass('btn btn-default').attr('onClick', "firstRecord(" + leafId + ",'" + url + "','" + urlList + "','" + urlPurchaseInvoiceCreditNoteDetail + "','" + securityToken + "'," + updateAccess + "," + deleteAccess + ")");
    ...
    $('#endRecordButton').removeClass().addClass('btn btn-default').attr('onClick', "endRecord(" + leafId + ",'" + url + "','" + urlList + "','" + urlPurchaseInvoiceCreditNoteDetail + "','" + securityToken + "'," + updateAccess + ")");
    $("#purchaseInvoiceCreditNoteId").val('');
    $("#purchaseInvoiceCreditNoteIdHelpMe").empty().html('');
    ...
    $("#purchaseInvoiceCreditNoteAmount").val('');
    $("#purchaseInvoiceCreditNoteAmountHelpMe").empty().html('');
    $("#purchaseInvoiceCreditNoteText").val('');
    $("#purchaseInvoiceCreditNoteTextHelpMe").empty().html('');
    $("#referenceNumber").val('');
    $("#referenceNumberHelpMe").empty().html('');
    $("#purchaseInvoiceCreditNoteDate").val('');
    $("#purchaseInvoiceCreditNoteDateHelpMe").empty().html('');
    $("#purchaseInvoiceCreditNoteDescription").val('');
    $("#purchaseInvoiceCreditNoteDescriptionHelpMe").empty().html('');
    $("#chartOfAccountId9999").prop("disabled", "true").attr("disabled", "disabled").val('').trigger("chosen:updated");
    $("#purchaseInvoiceCreditNoteDetailAmount9999").prop("disabled", "true").attr("disabled", "disabled").val('');
...
function firstRecord(leafId, url, urlList, urlPurchaseInvoiceCreditNoteDetail, securityToken, updateAccess, deleteAccess) {
            ...
            success: function(data) {
                ...
                if (success === true) {
                    $.ajax({
                        ...
                        data: {
                            method: 'read',
                            purchaseInvoiceCreditNoteId: firstRecord,
                            output: 'json',
                            securityToken: securityToken,
                            leafId: leafId,
                            from: 'purchaseInvoiceCreditNoteMaintenance.php'
                        ...
                        success: function(data) {
                            ...
                            if (success === true) {
                                $('#purchaseInvoiceCreditNoteId').val(data.data.purchaseInvoiceCreditNoteId);
                                ...
                                $('#purchaseInvoiceCreditNoteText').val(data.data.purchaseInvoiceCreditNoteText);
                                $('#referenceNumber').val(data.data.referenceNumber);
                                x = data.data.purchaseInvoiceCreditNoteDate;
                                x = x.split("-");
                                output = x[2] + "-" + x[1] + "-" + x[0];
                                output = output.toString();
                                $('#purchaseInvoiceCreditNoteDate').val(output);
                                $('#purchaseInvoiceCreditNoteDescription').val(data.data.purchaseInvoiceCreditNoteDescription);
                                $("#chartOfAccountId9999").prop("disabled", "false").removeAttr("disabled", "").val('').trigger("chosen:updated");
                                $("#purchaseInvoiceCreditNoteDetailAmount9999").prop("disabled", "false").removeAttr("disabled", "").val('');
                                $.ajax({
                                    type: 'POST',
                                    url: urlPurchaseInvoiceCreditNoteDetail,
                                    data: {
                                        method: 'read',
                                        purchaseInvoiceCreditNoteId: data.firstRecord,
                                        output: 'table',
                                        securityToken: securityToken,
                                        leafId: leafId,
                                        from: 'purchaseInvoiceCreditNoteMaintenance.php'
                                ...
                                if (nextRecord > 0) {
                                    $('#previousRecordButton').removeClass().addClass('btn btn-default disabled').attr('onClick', '');
                                    $('#nextRecordButton').removeClass().addClass('btn btn-default').attr('onClick', '').attr('onClick', "nextRecord(" + leafId + ",'" + url + "','" + urlList + "','" + urlPurchaseInvoiceCreditNoteDetail + "','" + securityToken + "'," + updateAccess + "," + deleteAccess + ")");
...
function endRecord(leafId, url, urlList, urlPurchaseInvoiceCreditNoteDetail, securityToken, updateAccess, deleteAccess) {
    var $infoPanel = $('#infoPanel');
            ...
            success: function(data) {
                ...
                if (success === true) {
                    $.ajax({
                        ...
                        data: {
                            method: 'read',
                            purchaseInvoiceCreditNoteId: lastRecord,
                            output: 'json',
                            securityToken: securityToken,
                            leafId: leafId,
                            from: 'purchaseInvoiceCreditNoteMaintenance.php'
                        ...
                        success: function(data) {
                            ...
                            if (success === true) {
                                ...
                                $('#purchaseInvoiceId').val(data.data.purchaseInvoiceId).trigger("chosen:updated");
                                $('#documentNumber').val(data.data.documentNumber);
                                $('#purchaseInvoiceCreditNoteAmount').val(data.data.purchaseInvoiceCreditNoteAmount);
                                $('#referenceNumber').val(data.data.referenceNumber);
                                x = data.data.purchaseInvoiceCreditNoteDate;
                                x = x.split("-");
                                output = x[2] + "-" + x[1] + "-" + x[0];
                                ...
                                if (lastRecord !== 0) {
                                    $('#previousRecordButton').removeClass().addClass('btn btn-default').attr('onClick', "previousRecord(" + leafId + ",'" + url + "','" + urlList + "','" + urlPurchaseInvoiceCreditNoteDetail + "','" + securityToken + "'," + updateAccess + "," + deleteAccess + ")");
                                    $('#nextRecordButton').removeClass().addClass('btn btn-default disabled').attr('onClick', '');
                                    $('#firstRecordCounter').val(firstRecord);
                                    $('#previousRecordCounter').val(previousRecord);
                                    $('#nextRecordCounter').val(nextRecord);
...
function previousRecord(leafId, url, urlList, urlPurchaseInvoiceCreditNoteDetail, securityToken, updateAccess, deleteAccess) {
    ...
    if (css.search('disabled') > 0) {
        ...
        if (parseFloat($previousRecordCounter.val()) > 0 && parseFloat($previousRecordCounter.val()) < parseFloat($('#lastRecordCounter').val())) {
            $.ajax({
                ...
                data: {
                    method: 'read',
                    purchaseInvoiceCreditNoteId: $previousRecordCounter.val(),
                    output: 'json',
                    securityToken: securityToken,
                    leafId: leafId,
                    from: 'purchaseInvoiceCreditNoteMaintenance.php'
...
function nextRecord(leafId, url, urlList, urlPurchaseInvoiceCreditNoteDetail, securityToken, updateAccess, deleteAccess) {
    var $infoPanel = $('#infoPanel');
    ...
    if (css.search('disabled') > 0) {
        ...
        if (parseFloat($nextRecordCounter.val()) <= parseFloat($('#lastRecordCounter').val())) {
            $.ajax({
                ...
                data: {
                    method: 'read',
                    purchaseInvoiceCreditNoteId: $nextRecordCounter.val(),
                    output: 'json',
                    securityToken: securityToken,
                    leafId: leafId,
                    from: 'purchaseInvoiceCreditNoteMaintenance.php'
