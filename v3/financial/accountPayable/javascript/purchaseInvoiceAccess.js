...
function checkDuplicate(leafId, page, securityToken) {
    var $purchaseInvoiceAccessCode = $("#purchaseInvoiceAccessCode");
    if ($purchaseInvoiceAccessCode.val().length === 0) {
    ...
    $.ajax({
        ...
        url: page,
        data: {
            purchaseInvoiceAccessCode: $purchaseInvoiceAccessCode.val(),
            method: 'duplicate',
            securityToken: securityToken,
            leafId: leafId
        },
        ...
        success: function(data) {
            ...
            if (success === true) {
                if (total !== 0) {
                    $("#purchaseInvoiceAccessCode")
                            .val('')
                            .focus();
                    $("#purchaseInvoiceAccessCodeForm")
...
function showFormUpdate(leafId, url, urlList, securityToken, purchaseInvoiceAccessId, updateAccess, deleteAccess) {
    sleep(500);
...
function showModalDelete(purchaseInvoiceAccessId, staffId, purchaseInvoiceAccessMinimumAmount, purchaseInvoiceAccessMaximumAmount) {
    // clear first old record if exist
    $('#purchaseInvoiceAccessIdPreview').val('').val(decodeURIComponent(purchaseInvoiceAccessId));
    $('#staffIdPreview').val('').val(decodeURIComponent(staffId));
    $('#purchaseInvoiceAccessMinimumAmountPreview').val('').val(decodeURIComponent(purchaseInvoiceAccessMinimumAmount));
    $('#purchaseInvoiceAccessMaximumAmountPreview').val('').val(decodeURIComponent(purchaseInvoiceAccessMaximumAmount));
...
function deleteGridRecord(leafId, url, urlList, securityToken) {
    $.ajax({
        ...
        data: {
            method: 'delete',
            output: 'json',
            purchaseInvoiceAccessId: $('#purchaseInvoiceAccessIdPreview').val(),
            securityToken: securityToken,
            leafId: leafId
        },
        beforeSend: function() {
...
function deleteGridRecordCheckbox(leafId, url, urlList, securityToken) {
    var stringText = '';
    var counter = 0;
    $('input:checkbox[name="purchaseInvoiceAccessId[]"]').each(function() {
        stringText = stringText + "&purchaseInvoiceAccessId[]=" + $(this).val();
    });
...
function newRecord(leafId, url, urlList, securityToken, type, createAccess, updateAccess, deleteAccess) {
    ...
    var $staffId = $('#staffId');
    var $purchaseInvoiceAccessMinimumAmount = $('#purchaseInvoiceAccessMinimumAmount');
    var $purchaseInvoiceAccessMaximumAmount = $('#purchaseInvoiceAccessMaximumAmount');
    if (css.search('disabled') > 0) {
        return false;
    } else {
        if (type === 1) {
            if ($staffId.val().length === 0) {
                $('#staffIdHelpMe')
                        .html('').empty()
                        .html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['staffIdLabel'] + " </span>");
                $staffId.data('chosen').activate_action();
                return false;
            }
            if ($purchaseInvoiceAccessMinimumAmount.val().length === 0) {
                $('#purchaseInvoiceAccessMinimumAmountHelpMe')
                        .html('').empty()
                        .html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['purchaseInvoiceAccessMinimumAmountLabel'] + " </span>");
                $('#purchaseInvoiceAccessMinimumAmountForm')
                        .removeClass().addClass('form-group has-error');
                $purchaseInvoiceAccessMinimumAmount.focus();
                return false;
            }
            if ($purchaseInvoiceAccessMaximumAmount.val().length === 0) {
                $('#purchaseInvoiceAccessMaximumAmountHelpMe')
                        .html('').empty()
                        .html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['purchaseInvoiceAccessMaximumAmountLabel'] + " </span>");
                $('#purchaseInvoiceAccessMaximumAmountForm')
                        .removeClass().addClass('form-group has-error');
                $purchaseInvoiceAccessMaximumAmount.focus();
                return false;
            }
            $.ajax({
                type: 'POST',
                ...
                data: {
                    ...
                    output: 'json',
                    staffId: $staffId.val(),
                    purchaseInvoiceAccessMinimumAmount: $purchaseInvoiceAccessMinimumAmount.val(),
                    purchaseInvoiceAccessMaximumAmount: $purchaseInvoiceAccessMaximumAmount.val(),
                    securityToken: securityToken,
                    leafId: leafId
                },
                beforeSend: function() {
                ...
                success: function(data) {
                    ...
                    if (success === true) {
                        ...
                        $('#staffIdHelpMe')
                                .html('').empty();
                        $purchaseInvoiceAccessMinimumAmount.val('');
                        $('#purchaseInvoiceAccessMinimumAmountHelpMe')
                                .html('').empty();
                        $purchaseInvoiceAccessMaximumAmount.val('');
                        $('#purchaseInvoiceAccessMaximumAmountHelpMe')
                                .html('').empty();
                    } else if (success === false) {
                        $infoPanel
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (success === true) {
                        ...
                        $('#purchaseInvoiceAccessId').val(data.purchaseInvoiceAccessId);
...
function updateRecord(leafId, url, urlList, securityToken, type, deleteAccess) {
    ...
    var $purchaseInvoiceAccessId = $('#purchaseInvoiceAccessId');
    var $staffId = $('#staffId');
    var $purchaseInvoiceAccessMinimumAmount = $('#purchaseInvoiceAccessMinimumAmount');
    var $purchaseInvoiceAccessMaximumAmount = $('#purchaseInvoiceAccessMaximumAmount');
    if (css.search('disabled') > 0) {
        ...
        if (type === 1) {
            ...
            $.ajax({
                ...
                data: {
                    method: 'save',
                    output: 'json',
                    purchaseInvoiceAccessId: $purchaseInvoiceAccessId.val(),
                    staffId: $staffId.val(),
                    purchaseInvoiceAccessMinimumAmount: $purchaseInvoiceAccessMinimumAmount.val(),
                    purchaseInvoiceAccessMaximumAmount: $purchaseInvoiceAccessMaximumAmount.val(),
                    securityToken: securityToken,
            ...
            if ($purchaseInvoiceAccessMinimumAmount.val().length === 0) {
                $('#purchaseInvoiceAccessMinimumAmountHelpMe')
                        .html('').empty()
                        .html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['purchaseInvoiceAccessMinimumAmountLabel'] + " </span>");
                $('#purchaseInvoiceAccessMinimumAmountForm').removeClass().addClass('form-group has-error');
                $purchaseInvoiceAccessMinimumAmount.focus();
                return false;
            }
            if ($purchaseInvoiceAccessMaximumAmount.val().length === 0) {
                $('#purchaseInvoiceAccessMaximumAmountHelpMe')
                        .html('').empty()
                        .html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['purchaseInvoiceAccessMaximumAmountLabel'] + " </span>");
                $('#purchaseInvoiceAccessMaximumAmountForm').removeClass().addClass('form-group has-error');
                $purchaseInvoiceAccessMaximumAmount.focus();
                return false;
            }
            if ($infoPanel.is(':hidden')) {
    ...
    if (css.search('disabled') > 0) {
        ...
        if (deleteAccess === 1) {
            if (confirm(decodeURIComponent(t['deleteRecordMessageLabel']))) {
                var value = $purchaseInvoiceAccessId.val();
                if (!value) {
                    $infoPanel
                            .html('').empty()
...
function resetRecord(leafId, url, urlList, securityToken, createAccess, updateAccess, deleteAccess) {
    ...
    $("#purchaseInvoiceAccessId").val('');
    $("#purchaseInvoiceAccessIdHelpMe")
            .empty().html('');
    $("#staffId").val('');
    $("#staffIdHelpMe")
            .empty().html('');
            ...
            success: function(data) {
                ...
                if (success === true) {
                    $.ajax({
                        ...
                        data: {
                            method: 'read',
                            purchaseInvoiceAccessId: firstRecord,
                            output: 'json',
                            securityToken: securityToken,
                            leafId: leafId
                        },
                        ...
                        success: function(data) {
                            ...
                            if (success === true) {
                                $('#purchaseInvoiceAccessId').val(data.data.purchaseInvoiceAccessId);
                                $('#staffId').val(data.data.staffId).trigger("chosen:updated");
                                $('#purchaseInvoiceAccessMinimumAmount').val(data.data.purchaseInvoiceAccessMinimumAmount);
                                $('#purchaseInvoiceAccessMaximumAmount').val(data.data.purchaseInvoiceAccessMaximumAmount);
                                if (nextRecord > 0) {
                                    $('#previousRecordButton')
                                            .removeClass().addClass('btn btn-default disabled')
                                            .attr('onClick', '');
            ...
            success: function(data) {
                ...
                if (success === true) {
                    $.ajax({
                        ...
                        data: {
                            method: 'read',
                            purchaseInvoiceAccessId: lastRecord,
                            output: 'json',
                            securityToken: securityToken,
                            leafId: leafId
                        },
    ...
    if (css.search('disabled') > 0) {
        ...
        if (parseFloat($previousRecordCounter.val()) > 0 && parseFloat($previousRecordCounter.val()) < parseFloat($('#lastRecordCounter').val())) {
            $.ajax({
                ...
                data: {
                    method: 'read',
                    purchaseInvoiceAccessId: $previousRecordCounter.val(),
                    output: 'json',
                    securityToken: securityToken,
                    leafId: leafId
                },
    ...
    if (css.search('disabled') > 0) {
        ...
        if (parseFloat($nextRecordCounter.val()) <= parseFloat($('#lastRecordCounter').val())) {
            $.ajax({
                ...
                data: {
                    method: 'read',
                    purchaseInvoiceAccessId: $nextRecordCounter.val(),
                    output: 'json',
                    securityToken: securityToken,
                    leafId: leafId
                },
