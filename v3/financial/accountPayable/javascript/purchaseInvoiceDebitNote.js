function getBusinessPartner(leafId, url, securityToken) {
    $.ajax({
        ...
        data: {
            ...
            from: 'purchaseInvoiceDebitNote.php'
        },
        beforeSend: function() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (success === true) {
                    ...
                    $('#purchaseInvoiceDebitNoteId').val(data.purchaseInvoiceDebitNoteId);
                    $('#newRecordButton1').removeClass().addClass('btn btn-success disabled');
                    if (updateAccess === 1) {
                        $('#updateRecordButton1').removeClass().addClass('btn btn-info');
                        $('#updateRecordButton2').removeClass().addClass('btn dropdown-toggle btn-info');
    ...
    if (css.search('disabled') > 0) {
        ...
        if (type === 1) {
            ...
            if ($referenceNumber.val().length === 0) {
                $('#referenceNumberHelpMe').html('').empty().html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['referenceNumberLabel'] + " </span>");
