function getBusinessPartner(leafId, url, securityToken) {
    $.ajax({
        ...
        data: {
            ...
            from: 'purchaseInvoiceDebitNoteMaintenance.php'
        },
        beforeSend: function() {
...
function showModalDelete(purchaseInvoiceDebitNoteId, businessPartnerId, purchaseInvoiceId, purchaseInvoiceDebitNoteTitle, from, documentNumber, purchaseInvoiceDebitNoteAmount, referenceNumber, purchaseInvoiceDebitNoteDate, purchaseInvoiceDebitNoteDescription) {
    ...
    $('#purchaseInvoiceDebitNoteTitlePreview').val('').val(decodeURIComponent(purchaseInvoiceDebitNoteTitle));
...
function deleteGridRecord(leafId, url, urlList, securityToken) {
    $.ajax({
        ...
        data: {
            method: 'delete',
            output: 'json',
            purchaseInvoiceDebitNoteId: $('#purchaseInvoiceDebitNoteIdPreview').val(),
            securityToken: securityToken,
            leafId: leafId,
            from: 'purchaseInvoiceDebitNoteMaintenance.php'
        },
...
function showFormCreateDetail(leafId, url, securityToken) {
    ...
    if ($('#purchaseInvoiceDebitNoteDetailAmount9999').val().length === 0) {
        $infoPanel.html('').empty().html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['purchaseInvoiceDebitNoteDetailAmountLabel'] + "</span>");
        $('#purchaseInvoiceDebitNoteDetailAmount9999HelpMe').html('').empty().html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['purchaseInvoiceDebitNoteDetailAmountLabel'] + "</span>");
        $('#purchaseInvoiceDebitNoteDetailAmount9999Form').removeClass().addClass('form-group has-error');
        $('#purchaseInvoiceDebitNoteDetailAmount9999').focus();
        return false;
    }
    ...
    $.ajax({
        ...
        data: {
            ...
            businessPartnerId: $('#businessPartnerId').val(),
            purchaseInvoiceDebitNoteDetailAmount: $('#purchaseInvoiceDebitNoteDetailAmount9999').val(),
            securityToken: securityToken,
            leafId: leafId,
            from: 'purchaseInvoiceDebitNoteMaintenance.php'
        },
            ...
            if (success === true) {
                $.ajax({
                    ...
                    data: {
                        ...
                        offset: '0',
                        limit: '9999',
                        purchaseInvoiceDebitNoteId: $('#purchaseInvoiceDebitNoteId').val(),
                        securityToken: securityToken,
                        leafId: leafId,
                        from: 'purchaseInvoiceDebitNoteMaintenance.php'
                    },
...
function showFormUpdateDetail(leafId, url, securityToken, purchaseInvoiceDebitNoteDetailId) {
    var $infoPanel = $('#infoPanel');
    if ($('#chartOfAccountId' + purchaseInvoiceDebitNoteDetailId).val().length === 0) {
        ...
        $('#chartOfAccountId' + purchaseInvoiceDebitNoteDetailId + 'HelpMe').html('').empty().html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + ' :' + leafTranslation['chartOfAccountIdLabel'] + "</span>");
        $('#chartOfAccountId' + purchaseInvoiceDebitNoteDetailId).removeClass().addClass('form-group has-error');
        $('#chartOfAccountId' + purchaseInvoiceDebitNoteDetailId).focus();
        return false;
    }
    if ($('#purchaseInvoiceDebitNoteDetailAmount' + purchaseInvoiceDebitNoteDetailId).val().length === 0) {
        $infoPanel.html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + ' :' + leafTranslation['purchaseInvoiceDebitNoteDetailAmountLabel'] + "</span>");
        $('#purchaseInvoiceDebitNoteDetailAmount' + purchaseInvoiceDebitNoteDetailId + 'HelpMe').html('').empty().html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + ' :' + leafTranslation['purchaseInvoiceDebitNoteDetailAmountLabel'] + "</span>");
        $('#purchaseInvoiceDebitNoteDetailAmount' + purchaseInvoiceDebitNoteDetailId).removeClass().addClass('form-group has-error');
        $('#purchaseInvoiceDebitNoteDetailAmount' + purchaseInvoiceDebitNoteDetailId).focus();
        return false;
    }
    $.ajax({
        type: 'POST',
        ...
        data: {
            method: 'save',
            output: 'json',
            purchaseInvoiceDebitNoteDetailId: $('#purchaseInvoiceDebitNoteDetailId' + purchaseInvoiceDebitNoteDetailId).val(),
            chartOfAccountId: $('#chartOfAccountId' + purchaseInvoiceDebitNoteDetailId).val(),
            businessPartnerId: $('#businessPartnerId').val(),
            purchaseInvoiceDebitNoteDetailAmount: $('#purchaseInvoiceDebitNoteDetailAmount' + purchaseInvoiceDebitNoteDetailId).val(),
            securityToken: securityToken,
            leafId: leafId,
            from: 'purchaseInvoiceDebitNoteMaintenance.php'
        },
        beforeSend: function() {
            ...
            var $infoPanel = $('#infoPanel');
            $infoPanel.html('').empty().html("<span class='label label-warning'>&nbsp;<img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
            $('#miniInfoPanel' + purchaseInvoiceDebitNoteDetailId).html('').empty().html("<span class='label label-warning'> <img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
            if ($infoPanel.is(':hidden')) {
                $infoPanel.show();
            }
        },
        success: function(data) {
            var $infoPanel = $('#infoPanel');
            var $miniInfoPanel = $('#miniInfoPanel' + purchaseInvoiceDebitNoteDetailId);
            var smileyLol = './images/icons/smiley-lol.png';
            var success = data.success;
            var message = data.message;
            if (success === true) {
...
function deleteGridRecordDetail(leafId, url, urlList, securityToken) {
    $.ajax({
        ...
        data: {
            method: 'delete',
            output: 'json',
            purchaseInvoiceDebitNoteDetailId: $('#purchaseInvoiceDebitNoteDetailIdPreview').val(),
            securityToken: securityToken,
            leafId: leafId,
            from: 'purchaseInvoiceDebitNoteMaintenance.php'
        },
        ...
        success: function(data) {
            ...
            if (success === true) {
                ...
                removeMeTr($('#purchaseInvoiceDebitNoteDetailIdPreview').val());
            } else if (success === false) {
                $infoPanel.html('').empty().html("<span class='label label-danger'> " + message + "</span>");
                if ($infoPanel.is(':hidden')) {
                    $infoPanel.show();
...
function deleteGridRecordCheckbox(leafId, url, urlList, securityToken) {
    var stringText = '';
    var counter = 0;
    $('input:checkbox[name="purchaseInvoiceDebitNoteId[]"]').each(function() {
        stringText = stringText + "&purchaseInvoiceDebitNoteId[]=" + $(this).val();
    });
...
function updateRecord(leafId, url, urlList, securityToken, type, deleteAccess) {
    ...
    var $purchaseInvoiceDebitNoteId = $('#purchaseInvoiceDebitNoteId');
    var $businessPartnerId = $('#businessPartnerId');
    var $purchaseInvoiceId = $('#purchaseInvoiceId');
    var $purchaseInvoiceDebitNoteTitle = $('#purchaseInvoiceDebitNoteTitle');
    var $from = $('#from');
    var $purchaseInvoiceDebitNoteAmount = $('#purchaseInvoiceDebitNoteAmount');
    var $referenceNumber = $('#referenceNumber');
    var $purchaseInvoiceDebitNoteDate = $('#purchaseInvoiceDebitNoteDate');
    var $purchaseInvoiceDebitNoteDescription = $('#purchaseInvoiceDebitNoteDescription');
    if (css.search('disabled') > 0) {
        ...
        if (type === 1) {
            ...
            if ($purchaseInvoiceDebitNoteDate.val().length === 0) {
                $('#purchaseInvoiceDebitNoteDateHelpMe').html('').empty().html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['purchaseInvoiceDebitNoteDateLabel'] + " </span>");
                $('#purchaseInvoiceDebitNoteDateForm').removeClass().addClass('col-xs-4 col-sm-4 col-md-4 col-lg-4 form-group has-error');
                $purchaseInvoiceDebitNoteDate.focus();
                return false;
            }
            $infoPanel.html('').empty();
            $.ajax({
                ...
                data: {
                    ...
                    purchaseInvoiceId: $purchaseInvoiceId.val(),
                    from: 'purchaseInvoiceDebitNoteMaintenance.php',
                    purchaseInvoiceDebitNoteAmount: $purchaseInvoiceDebitNoteAmount.val(),
                    referenceNumber: $referenceNumber.val(),
                    purchaseInvoiceDebitNoteDate: $purchaseInvoiceDebitNoteDate.val(),
                    purchaseInvoiceDebitNoteDescription: $purchaseInvoiceDebitNoteDescription.val(),
                    securityToken: securityToken,
                    leafId: leafId
                },
                beforeSend: function() {
    ...
    if (css.search('disabled') > 0) {
        ...
        if (deleteAccess === 1) {
            if (confirm(decodeURIComponent(t['deleteRecordMessageLabel']))) {
                var value = $purchaseInvoiceDebitNoteId.val();
                if (!value) {
...
function updateRecord(leafId, url, urlList, securityToken, type, deleteAccess) {
    ...
    if (css.search('disabled') > 0) {
        ...
        if (type === 1) {
            ...
            if ($purchaseInvoiceDebitNoteAmount.val().length === 0) {
                $('#purchaseInvoiceDebitNoteAmountHelpMe').html('').empty().html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['purchaseInvoiceDebitNoteAmountLabel'] + " </span>");
                $('#purchaseInvoiceDebitNoteAmountForm').removeClass().addClass('form-group has-error');
                $purchaseInvoiceDebitNoteAmount.focus();
                return false;
            }
            if ($purchaseInvoiceDebitNoteDate.val().length === 0) {
                $('#purchaseInvoiceDebitNoteDateHelpMe').html('').empty().html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['purchaseInvoiceDebitNoteDateLabel'] + " </span>");
                $('#purchaseInvoiceDebitNoteDateForm').removeClass().addClass('form-group has-error');
                $purchaseInvoiceDebitNoteDate.focus();
                return false;
            }
            $infoPanel.html('').empty();
