...
function getFollowUp(leafId, url, securityToken) {
    $.ajax({
        type: 'GET',
        url: url,
        data: {
...
function checkDuplicate(leafId, page, securityToken) {
    var $purchaseInvoiceFollowUpCode = $("#purchaseInvoiceFollowUpCode");
    if ($purchaseInvoiceFollowUpCode.val().length === 0) {
    ...
    $.ajax({
        ...
        url: page,
        data: {
            purchaseInvoiceFollowUpCode: $purchaseInvoiceFollowUpCode.val(),
            method: 'duplicate',
            securityToken: securityToken,
            leafId: leafId
        },
        ...
        success: function(data) {
            ...
            if (success === true) {
                if (total !== 0) {
                    $("#purchaseInvoiceFollowUpCode")
                            .val('')
                            .focus();
                    $("#purchaseInvoiceFollowUpCodeForm")
...
function showFormUpdate(leafId, url, urlList, securityToken, purchaseInvoiceFollowUpId, updateAccess, deleteAccess) {
    sleep(500);
...
function showModalDelete(purchaseInvoiceFollowUpId, purchaseInvoiceId, followUpId, documentNumber, purchaseInvoiceFollowUpDate, purchaseInvoiceFollowUpDescription) {
    // clear first old record if exist
    $('#purchaseInvoiceFollowUpIdPreview').val('').val(decodeURIComponent(purchaseInvoiceFollowUpId));
    $('#purchaseInvoiceIdPreview').val('').val(decodeURIComponent(purchaseInvoiceId));
    $('#followUpIdPreview').val('').val(decodeURIComponent(followUpId));
    $('#documentNumberPreview').val('').val(decodeURIComponent(documentNumber));
    $('#purchaseInvoiceFollowUpDatePreview').val('').val(decodeURIComponent(purchaseInvoiceFollowUpDate));
    $('#purchaseInvoiceFollowUpDescriptionPreview').val('').val(decodeURIComponent(purchaseInvoiceFollowUpDescription));
...
function deleteGridRecord(leafId, url, urlList, securityToken) {
    $.ajax({
        ...
        data: {
            method: 'delete',
            output: 'json',
            purchaseInvoiceFollowUpId: $('#purchaseInvoiceFollowUpIdPreview').val(),
            securityToken: securityToken,
            leafId: leafId
        },
        beforeSend: function() {
...
function deleteGridRecordCheckbox(leafId, url, urlList, securityToken) {
    var stringText = '';
    var counter = 0;
    $('input:checkbox[name="purchaseInvoiceFollowUpId[]"]').each(function() {
        stringText = stringText + "&purchaseInvoiceFollowUpId[]=" + $(this).val();
    });
...
function newRecord(leafId, url, urlList, securityToken, type, createAccess, updateAccess, deleteAccess) {
    ...
    var $purchaseInvoiceFollowUpDate = $('#purchaseInvoiceFollowUpDate');
    var $purchaseInvoiceFollowUpDescription = $('#purchaseInvoiceFollowUpDescription');
    if (css.search('disabled') > 0) {
        return false;
    } else {
        if (type === 1) {
            if ($purchaseInvoiceId.val().length === 0) {
                $('#purchaseInvoiceIdHelpMe')
                        .html('').empty()
                        .html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['purchaseInvoiceIdLabel'] + " </span>");
                $purchaseInvoiceId.data('chosen').activate_action();
                return false;
            }
            if ($followUpId.val().length === 0) {
                $('#followUpIdHelpMe')
                        .html('').empty()
                        .html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['followUpIdLabel'] + " </span>");
                $followUpId.data('chosen').activate_action();
                return false;
            }
            if ($purchaseInvoiceFollowUpDate.val().length === 0) {
                $('#purchaseInvoiceFollowUpDateHelpMe')
                        .html('').empty()
                        .html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['purchaseInvoiceFollowUpDateLabel'] + " </span>");
                $('#purchaseInvoiceFollowUpDateForm')
                        .removeClass().addClass('form-group has-error');
                $purchaseInvoiceFollowUpDate.focus();
                return false;
            }
            if ($purchaseInvoiceFollowUpDescription.val().length === 0) {
                $('#purchaseInvoiceFollowUpDescriptionHelpMe')
                        .html('').empty()
                        .html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['purchaseInvoiceFollowUpDescriptionLabel'] + " </span>");
                $('#purchaseInvoiceFollowUpDescriptionForm')
                        .removeClass().addClass('form-group has-error');
                $purchaseInvoiceFollowUpDescription.focus();
                return false;
            }
            $.ajax({
                type: 'POST',
                ...
                data: {
                    ...
                    purchaseInvoiceFollowUpDate: $purchaseInvoiceFollowUpDate.val(),
                    purchaseInvoiceFollowUpDescription: $purchaseInvoiceFollowUpDescription.val(),
                    securityToken: securityToken,
                    leafId: leafId
                },
                beforeSend: function() {
                ...
                success: function(data) {
                    ...
                    if (success === true) {
                        ...
                        $('#purchaseInvoiceIdHelpMe')
                                .html('').empty();
                        $followUpId.val('');
                        $followUpId.trigger("chosen:updated");
                        $('#followUpIdHelpMe')
                                .html('').empty();
                        $("documentNumber").val('');
                        $('#documentNumberHelpMe')
                                .html('').empty();
                        $purchaseInvoiceFollowUpDate.val('');
                        $('#purchaseInvoiceFollowUpDateHelpMe')
                                .html('').empty();
                        $purchaseInvoiceFollowUpDescription.val('');
                        $('#purchaseInvoiceFollowUpDescriptionHelpMe')
                                .html('').empty();
                    } else if (success === false) {
                        $infoPanel
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (success === true) {
                        ...
                        $('#purchaseInvoiceFollowUpId').val(data.purchaseInvoiceFollowUpId);
                        $('#newRecordButton1')
                                .removeClass().addClass('btn btn-success disabled');
                        $('#newRecordButton2')
                                .removeClass().addClass('btn dropdown-toggle btn-success disabled');
...
function updateRecord(leafId, url, urlList, securityToken, type, deleteAccess) {
    ...
    var $purchaseInvoiceFollowUpId = $('#purchaseInvoiceFollowUpId');
    var $purchaseInvoiceId = $('#purchaseInvoiceId');
    var $followUpId = $('#followUpId');
    var $purchaseInvoiceFollowUpDate = $('#purchaseInvoiceFollowUpDate');
    var $purchaseInvoiceFollowUpDescription = $('#purchaseInvoiceFollowUpDescription');
        ...
        if (type === 1) {
            ...
            $.ajax({
                ...
                data: {
                    method: 'save',
                    output: 'json',
                    purchaseInvoiceFollowUpId: $purchaseInvoiceFollowUpId.val(),
                    purchaseInvoiceId: $purchaseInvoiceId.val(),
                    followUpId: $followUpId.val(),
                    purchaseInvoiceFollowUpDate: $purchaseInvoiceFollowUpDate.val(),
                    purchaseInvoiceFollowUpDescription: $purchaseInvoiceFollowUpDescription.val(),
            ...
            if ($purchaseInvoiceFollowUpDescription.val().length === 0) {
                $('#purchaseInvoiceFollowUpDescriptionHelpMe')
                        .html('').empty()
                        .html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['purchaseInvoiceFollowUpDescriptionLabel'] + " </span>");
                $('#purchaseInvoiceFollowUpDescriptionForm').removeClass().addClass('form-group has-error');
                $purchaseInvoiceFollowUpDescription.focus();
                return false;
            }
            if ($infoPanel.is(':hidden')) {
    ...
    if (css.search('disabled') > 0) {
        ...
        if (deleteAccess === 1) {
            if (confirm(decodeURIComponent(t['deleteRecordMessageLabel']))) {
                var value = $purchaseInvoiceFollowUpId.val();
                if (!value) {
                    $infoPanel
                            .html('').empty()
...
function resetRecord(leafId, url, urlList, urlPurchaseInvoiceCreditNoteDetail, securityToken, createAccess, updateAccess, deleteAccess) {
    ...
    $("#purchaseInvoiceFollowUpId").val('');
    $("#purchaseInvoiceFollowUpIdHelpMe")
            .empty().html('');
            ...
            success: function(data) {
                ...
                if (success === true) {
                    $.ajax({
                        ...
                        data: {
                            method: 'read',
                            purchaseInvoiceFollowUpId: firstRecord,
                            output: 'json',
                            securityToken: securityToken,
                            leafId: leafId
                        },
                        ...
                        success: function(data) {
                            ...
                            if (success === true) {
                                $('#purchaseInvoiceFollowUpId').val(data.data.purchaseInvoiceFollowUpId);
                                $('#purchaseInvoiceId').val(data.data.purchaseInvoiceId).trigger("chosen:updated");
                                $('#followUpId').val(data.data.followUpId).trigger("chosen:updated");
                                $('#documentNumber').val(data.data.documentNumber);
                                x = data.data.purchaseInvoiceFollowUpDate;
                                x = x.split("-");
                                output = x[2] + "-" + x[1] + "-" + x[0];
                                output = output.toString();
                                $('#purchaseInvoiceFollowUpDate').val(output);
                                $('#purchaseInvoiceFollowUpDescription').val(data.data.purchaseInvoiceFollowUpDescription);
                                if (nextRecord > 0) {
                                    $('#previousRecordButton')
                                            .removeClass().addClass('btn btn-default disabled')
                                            .attr('onClick', '');
            ...
            success: function(data) {
                ...
                if (success === true) {
                    $.ajax({
                        ...
                        data: {
                            method: 'read',
                            purchaseInvoiceFollowUpId: lastRecord,
                            output: 'json',
                            securityToken: securityToken,
                            leafId: leafId
                        },
    ...
    if (css.search('disabled') > 0) {
        ...
        if (parseFloat($previousRecordCounter.val()) > 0 && parseFloat($previousRecordCounter.val()) < parseFloat($('#lastRecordCounter').val())) {
            $.ajax({
                ...
                data: {
                    method: 'read',
                    purchaseInvoiceFollowUpId: $previousRecordCounter.val(),
                    output: 'json',
                    securityToken: securityToken,
                    leafId: leafId
                },
    ...
    if (css.search('disabled') > 0) {
        ...
        if (parseFloat($nextRecordCounter.val()) <= parseFloat($('#lastRecordCounter').val())) {
            $.ajax({
                ...
                data: {
                    method: 'read',
                    purchaseInvoiceFollowUpId: $nextRecordCounter.val(),
                    output: 'json',
                    securityToken: securityToken,
                    leafId: leafId
                },
