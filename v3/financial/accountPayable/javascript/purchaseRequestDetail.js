function getPurchaseRequest(leafId, url, securityToken) {
    $.ajax({
        type: 'GET',
        url: url,
        data: {
...
function checkDuplicate(leafId, page, securityToken) {
    var $purchaseRequestDetailCode = $("#purchaseRequestDetailCode");
    if ($purchaseRequestDetailCode.val().length === 0) {
    ...
    $.ajax({
        ...
        url: page,
        data: {
            purchaseRequestDetailCode: $purchaseRequestDetailCode.val(),
            method: 'duplicate',
            securityToken: securityToken,
            leafId: leafId
        },
        ...
        success: function(data) {
            ...
            if (success === true) {
                if (total !== 0) {
                    $("#purchaseRequestDetailCode")
                            .val('')
                            .focus();
                    $("#purchaseRequestDetailCodeForm")
...
function showFormUpdate(leafId, url, urlList, securityToken, purchaseRequestDetailId, updateAccess, deleteAccess) {
    sleep(500);
...
function showModalDelete(purchaseRequestDetailId, purchaseRequestId, productId, unitOfMeasurementId, businessPartnerId, chartOfAccountId, purchaseRequestDetailQuantity, purchaseRequestDetailDescription, purchaseRequestDetailEstimatedPrice, purchaseRequestDetailBudget) {
    // clear first old record if exist
    $('#purchaseRequestDetailIdPreview').val('').val(decodeURIComponent(purchaseRequestDetailId));
    ...
    $('#purchaseRequestDetailQuantityPreview').val('').val(decodeURIComponent(purchaseRequestDetailQuantity));
    $('#purchaseRequestDetailDescriptionPreview').val('').val(decodeURIComponent(purchaseRequestDetailDescription));
    $('#purchaseRequestDetailEstimatedPricePreview').val('').val(decodeURIComponent(purchaseRequestDetailEstimatedPrice));
    $('#purchaseRequestDetailBudgetPreview').val('').val(decodeURIComponent(purchaseRequestDetailBudget));
...
function deleteGridRecordCheckbox(leafId, url, urlList, securityToken) {
    var stringText = '';
    var counter = 0;
    $('input:checkbox[name="purchaseRequestDetailId[]"]').each(function() {
        stringText = stringText + "&purchaseRequestDetailId[]=" + $(this).val();
    });
...
function newRecord(leafId, url, urlList, securityToken, type, createAccess, updateAccess, deleteAccess) {
    ...
    var $purchaseRequestDetailQuantity = $('#purchaseRequestDetailQuantity');
    var $purchaseRequestDetailDescription = $('#purchaseRequestDetailDescription');
    var $purchaseRequestDetailEstimatedPrice = $('#purchaseRequestDetailEstimatedPrice');
    var $purchaseRequestDetailBudget = $('#purchaseRequestDetailBudget');
    if (css.search('disabled') > 0) {
        return false;
    } else {
        if (type === 1) {
            if ($purchaseRequestId.val().length === 0) {
                $('#purchaseRequestIdHelpMe')
                        .html('').empty()
                        .html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['purchaseRequestIdLabel'] + " </span>");
                $purchaseRequestId.data('chosen').activate_action();
                return false;
            }
            ...
            if ($chartOfAccountId.val().length === 0) {
                ...
                $('#chartOfAccountIdForm')
                        .removeClass().addClass('form-group has-error');
                $chartOfAccountId.focus();
                return false;
            }
            if ($purchaseRequestDetailQuantity.val().length === 0) {
                $('#purchaseRequestDetailQuantityHelpMe')
                        .html('').empty()
                        .html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['purchaseRequestDetailQuantityLabel'] + " </span>");
                $('#purchaseRequestDetailQuantityForm')
                        .removeClass().addClass('form-group has-error');
                $purchaseRequestDetailQuantity.focus();
                return false;
            }
            if ($purchaseRequestDetailDescription.val().length === 0) {
                $('#purchaseRequestDetailDescriptionHelpMe')
                        .html('').empty()
                        .html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['purchaseRequestDetailDescriptionLabel'] + " </span>");
                $('#purchaseRequestDetailDescriptionForm')
                        .removeClass().addClass('form-group has-error');
                $purchaseRequestDetailDescription.focus();
                return false;
            }
            if ($purchaseRequestDetailEstimatedPrice.val().length === 0) {
                $('#purchaseRequestDetailEstimatedPriceHelpMe')
                        .html('').empty()
                        .html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['purchaseRequestDetailEstimatedPriceLabel'] + " </span>");
                $('#purchaseRequestDetailEstimatedPriceForm')
                        .removeClass().addClass('form-group has-error');
                $purchaseRequestDetailEstimatedPrice.focus();
                return false;
            }
            if ($purchaseRequestDetailBudget.val().length === 0) {
                $('#purchaseRequestDetailBudgetHelpMe')
                        .html('').empty()
                        .html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['purchaseRequestDetailBudgetLabel'] + " </span>");
                $('#purchaseRequestDetailBudgetForm')
                        .removeClass().addClass('form-group has-error');
                $purchaseRequestDetailBudget.focus();
                return false;
            }
            $.ajax({
                type: 'POST',
                ...
                data: {
                    ...
                    unitOfMeasurementId: $unitOfMeasurementId.val(),
                    businessPartnerId: $businessPartnerId.val(),
                    chartOfAccountId: $chartOfAccountId.val(),
                    purchaseRequestDetailQuantity: $purchaseRequestDetailQuantity.val(),
                    purchaseRequestDetailDescription: $purchaseRequestDetailDescription.val(),
                    purchaseRequestDetailEstimatedPrice: $purchaseRequestDetailEstimatedPrice.val(),
                    purchaseRequestDetailBudget: $purchaseRequestDetailBudget.val(),
                    securityToken: securityToken,
                    leafId: leafId
                },
                beforeSend: function() {
                ...
                success: function(data) {
                    ...
                    if (success === true) {
                        ...
                        $purchaseRequestId.trigger("chosen:updated");
                        $('#purchaseRequestIdHelpMe')
                                .html('').empty();
                        $productId.val('');
                        ...
                        $('#chartOfAccountIdHelpMe')
                                .html('').empty();
                        $purchaseRequestDetailQuantity.val('');
                        $('#purchaseRequestDetailQuantityHelpMe')
                                .html('').empty();
                        $purchaseRequestDetailDescription.val('');
                        $('#purchaseRequestDetailDescriptionHelpMe')
                                .html('').empty();
                        $purchaseRequestDetailEstimatedPrice.val('');
                        $('#purchaseRequestDetailEstimatedPriceHelpMe')
                                .html('').empty();
                        $purchaseRequestDetailBudget.val('');
                        $('#purchaseRequestDetailBudgetHelpMe')
                                .html('').empty();
                    } else if (success === false) {
                        $infoPanel
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (success === true) {
                        ...
                        $('#purchaseRequestDetailId').val(data.purchaseRequestDetailId);
        ...
        if (type === 1) {
            ...
            $.ajax({
                ...
                data: {
                    method: 'save',
                    output: 'json',
                    purchaseRequestDetailId: $purchaseRequestDetailId.val(),
                    purchaseRequestId: $purchaseRequestId.val(),
                    productId: $productId.val(),
                    unitOfMeasurementId: $unitOfMeasurementId.val(),
                    businessPartnerId: $businessPartnerId.val(),
            ...
            if ($chartOfAccountId.val().length === 0) {
                $('#chartOfAccountIdHelpMe')
                        .html('').empty()
                        .html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['chartOfAccountIdLabel'] + " </span>");
                $('#chartOfAccountIdForm').removeClass().addClass('form-group has-error');
                $chartOfAccountId.focus();
                return false;
            }
            if ($purchaseRequestDetailQuantity.val().length === 0) {
                $('#purchaseRequestDetailQuantityHelpMe')
                        .html('').empty()
                        .html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['purchaseRequestDetailQuantityLabel'] + " </span>");
                $('#purchaseRequestDetailQuantityForm').removeClass().addClass('form-group has-error');
                $purchaseRequestDetailQuantity.focus();
                return false;
            }
            if ($purchaseRequestDetailDescription.val().length === 0) {
                $('#purchaseRequestDetailDescriptionHelpMe')
                        .html('').empty()
                        .html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['purchaseRequestDetailDescriptionLabel'] + " </span>");
                $('#purchaseRequestDetailDescriptionForm').removeClass().addClass('form-group has-error');
                $purchaseRequestDetailDescription.focus();
                return false;
            }
            if ($purchaseRequestDetailEstimatedPrice.val().length === 0) {
                $('#purchaseRequestDetailEstimatedPriceHelpMe')
                        .html('').empty()
                        .html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['purchaseRequestDetailEstimatedPriceLabel'] + " </span>");
                $('#purchaseRequestDetailEstimatedPriceForm').removeClass().addClass('form-group has-error');
                $purchaseRequestDetailEstimatedPrice.focus();
                return false;
            }
            if ($purchaseRequestDetailBudget.val().length === 0) {
                $('#purchaseRequestDetailBudgetHelpMe')
                        .html('').empty()
                        .html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['purchaseRequestDetailBudgetLabel'] + " </span>");
                $('#purchaseRequestDetailBudgetForm').removeClass().addClass('form-group has-error');
                $purchaseRequestDetailBudget.focus();
                return false;
            }
            if ($infoPanel.is(':hidden')) {
    ...
    if (css.search('disabled') > 0) {
        ...
        if (deleteAccess === 1) {
            if (confirm(decodeURIComponent(t['deleteRecordMessageLabel']))) {
                var value = $purchaseRequestDetailId.val();
                if (!value) {
                    $infoPanel
                            .html('').empty()
...
function resetRecord(leafId, url, urlList, securityToken, createAccess, updateAccess, deleteAccess) {
    ...
    $("#purchaseRequestDetailId").val('');
    $("#purchaseRequestDetailIdHelpMe")
            .empty().html('');
    $("#purchaseRequestId").val('');
    $("#purchaseRequestIdHelpMe")
            .empty().html('');
            ...
            success: function(data) {
                ...
                if (success === true) {
                    $.ajax({
                        ...
                        data: {
                            method: 'read',
                            purchaseRequestDetailId: firstRecord,
                            output: 'json',
                            securityToken: securityToken,
                            leafId: leafId
                        },
                        ...
                        success: function(data) {
                            ...
                            if (success === true) {
                                $('#purchaseRequestDetailId').val(data.data.purchaseRequestDetailId);
                                $('#purchaseRequestId').val(data.data.purchaseRequestId).trigger("chosen:updated");
                                ...
                                $('#purchaseRequestDetailQuantity').val(data.data.purchaseRequestDetailQuantity);
                                $('#purchaseRequestDetailDescription').val(data.data.purchaseRequestDetailDescription);
                                $('#purchaseRequestDetailEstimatedPrice').val(data.data.purchaseRequestDetailEstimatedPrice);
                                $('#purchaseRequestDetailBudget').val(data.data.purchaseRequestDetailBudget);
                                if (nextRecord > 0) {
                                    $('#previousRecordButton')
                                            .removeClass().addClass('btn btn-default disabled')
                                            .attr('onClick', '');
            ...
            success: function(data) {
                ...
                if (success === true) {
                    $.ajax({
                        ...
                        data: {
                            method: 'read',
                            purchaseRequestDetailId: lastRecord,
                            output: 'json',
                            securityToken: securityToken,
                            leafId: leafId
                        },
    ...
    if (css.search('disabled') > 0) {
        ...
        if (parseFloat($previousRecordCounter.val()) > 0 && parseFloat($previousRecordCounter.val()) < parseFloat($('#lastRecordCounter').val())) {
            $.ajax({
                ...
                data: {
                    method: 'read',
                    purchaseRequestDetailId: $previousRecordCounter.val(),
                    output: 'json',
                    securityToken: securityToken,
                    leafId: leafId
                },
    ...
    if (css.search('disabled') > 0) {
        ...
        if (parseFloat($nextRecordCounter.val()) <= parseFloat($('#lastRecordCounter').val())) {
            $.ajax({
                ...
                data: {
                    method: 'read',
                    purchaseRequestDetailId: $nextRecordCounter.val(),
                    output: 'json',
                    securityToken: securityToken,
                    leafId: leafId
                },
