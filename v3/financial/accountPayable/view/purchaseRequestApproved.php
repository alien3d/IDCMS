...
$_POST['from'] = 'purchaseRequestApproved.php';
$_GET['from'] = 'purchaseRequestApproved.php';
if (isset($_POST)) {
                                                ...
                                                if ($totalRecord > 0) {
                                                    ...
                                                    for ($i = 0; $i < $totalRecord; $i++) {
                                                        ...
                                                        <tr <?php
                                                            ...
                                                            <?php if($leafAccess['isApproved']==1) { ?>
                                                            <div class="btn-group" align="center">
                                                                    <button type="button"  class="btn btn-warning btn-sm" title="Approved" onClick="showFormUpdate('<?php echo $leafId; ?>', '<?php echo $purchaseRequestDetail->getControllerPath(); ?>', '<?php echo $purchaseRequestDetail->getViewPath(); ?>', '<?php echo $securityToken; ?>', '<?php echo intval($purchaseRequestDetailArray [$i]['purchaseRequestDetailId']); ?>', '<?php echo $leafAccess['leafAccessUpdateValue']; ?>', '<?php echo $leafAccess['leafAccessDeleteValue']; ?>')" value="Approved"><i class="glyphicon glyphicon-edit glyphicon-white"></i> <?php echo $t['approvedButtonLabel']; ?></button>
                                                                    </div>
                                                            <?php } ?>
