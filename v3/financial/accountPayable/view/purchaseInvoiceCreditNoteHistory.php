...
$_POST['from'] = 'purchaseInvoiceCreditNoteHistory.php';
$_GET['from'] = 'purchaseInvoiceCreditNoteHistory.php';
if (isset($_POST)) {
                                                ...
                                                if ($totalRecord > 0) {
                                                    ...
                                                    for ($i = 0; $i < $totalRecord; $i++) {
                                                        ...
                                                        ?>>
                                                            ...
                                                            ?>
                                                            <td valign="top"><input class="form-control" style="display:none;" type="checkbox" name="purchaseInvoiceCreditNoteId[]"  value="<?php echo $purchaseInvoiceCreditNoteArray[$i]['purchaseInvoiceCreditNoteId']; ?>">
                                                                <input class="form-control" <?php echo $checked; ?> type="checkbox" name="isDelete[]" value="<?php echo $purchaseInvoiceCreditNoteArray[$i]['isDelete']; ?>"></td>
                                                        </tr>
                                                        <?php
                                                    }
                                                } else {
...
<?php } ?>
<script type="text/javascript" src="./v3/financial/accountPayable/javascript/purchaseInvoiceCreditNoteHistory.js"></script>
<hr>
<footer>
    <p>IDCMS 2012/2013</p>
</footer>
