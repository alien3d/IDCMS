...
$_POST['from'] = 'purchaseInvoiceMaintenance.php';
$_GET['from'] = 'purchaseInvoiceMaintenance.php';
if (isset($_POST)) {
...
if ((isset($_POST['method']) == 'new' || isset($_POST['method']) == 'read') && $_POST['type'] == 'form') {
                                        ...
                                        <div class="col-xs-8 col-sm-8 col-md-8">
                                            <div class="input-group">
                                                <input type="text" name="documentNumber" id="documentNumber"
                                                       ...
                                                       value="<?php
                                                       if (isset($documentNumberArray) && is_array($purchaseInvoiceArray)) {
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 form-group" id="purchaseInvoiceCreditTermForm">
                                        ...
                                        <div class="col-xs-8 col-sm-8 col-md-8">
                                            <div class="input-group">
                                                <input class="form-control" type="text" name="purchaseInvoiceCreditTerm" id="purchaseInvoiceCreditTerm" onKeyUp="removeMeError('purchaseInvoiceCreditTerm')"  value="<?php
                                                if (isset($purchaseInvoiceArray) && is_array($purchaseInvoiceArray)) {
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 form-group" id="purchaseInvoiceDescriptionForm">
                                        <div class="col-xs-12 col-sm-12 col-md-12">
                                            <textarea class="form-control" name="purchaseInvoiceDescription" id="purchaseInvoiceDescription" onKeyUp="removeMeError('purchaseInvoiceDescription')"><?php
            ...
            <div class="row">
                ...
                <div class="col-xs-6 col-sm-6 col-md-6" align="right">
                    <button type="button"  class="btn btn-success" title="<?php echo $t['newButtonLabel']; ?>"
                            ...
                            ;
                            ?>', '<?php
                            echo $purchaseInvoice->getControllerPath();
                    ...
                    <table class="table table-bordered table-striped table-condensed table-hover" id="tableData">
                        ...
                        <tr>
                            ...
                            <td vAlign="top" class="form-group" id="purchaseInvoiceDetailAmount9999Detail">
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <input class="form-control" <?php echo $disabledDetail; ?> type="text" name="purchaseInvoiceDetailAmount[]" id="purchaseInvoiceDetailAmount9999" onBlur="removeMeErrorDetail('purchaseInvoiceDetailAmount9999');" onKeyUp="removeMeErrorDetail('purchaseInvoiceDetailAmount9999');">
                                </div>
                                        ...
                                        for ($j = 0; $j < $totalRecordDetail; $j++) {
                                            ...
                                            <tr id="<?php echo $purchaseInvoiceDetailArray[$j]['purchaseInvoiceDetailId']; ?>">
                                                ...
                                                <td vAlign="top" class="form-group" id="chartOfAccountIdAmount<?php echo $purchaseInvoiceDetailArray[$j]['purchaseInvoiceDetailId']; ?>Detail">
                                                    <select name="chartOfAccountId[]" id="chartOfAccountId<?php echo $purchaseInvoiceDetailArray[$j]['purchaseInvoiceDetailId']; ?>" class="form-control chzn-select inpu-sm">
                                                        <option value=""></option>
                                                        <?php
                                                        if (is_array($chartOfAccountArray)) {
                                                            $totalRecord = intval(count($chartOfAccountArray));
    ...
    <?php if ($leafAccess['leafAccessUpdateValue'] == 1) { ?>
                        ...
                        if (e.which === 83 && e.which === 18 && e.shiftKey) {
                            ...
                            updateRecord(<?php echo $leafId; ?>, '<?php echo $purchaseInvoice->getControllerPath(); ?>', '<?php echo $purchaseInvoice->getViewPath(); ?>', '<?php echo $securityToken; ?>', 1, <?php echo $leafAccess['leafAccessUpdateValue']; ?>);
                            return false;
                        }
    <?php } ?>
    <?php if ($leafAccess['leafAccessDeleteValue'] == 1) { ?>
                        ...
                        if (e.which === 88 && e.which === 18 && e.shiftKey) {
                            ...
                            deleteRecord(<?php echo $leafId; ?>, '<?php echo $purchaseInvoice->getControllerPath(); ?>', '<?php echo $purchaseInvoice->getViewPath(); ?>', '<?php echo $securityToken; ?>', <?php echo $leafAccess['leafAccessDeleteValue']; ?>);
                            return false;
                        }
    <?php } ?>
    ...
    <?php } else if ($_POST['purchaseInvoiceId']) { ?>
        ...
        <?php if ($leafAccess['leafAccessUpdateValue'] == 1) { ?>
                            $('#updateRecordButton1').removeClass().addClass('btn btn-info').attr('onClick', "updateRecord(<?php echo $leafId; ?>,'<?php echo $purchaseInvoice->getControllerPath(); ?>','<?php echo $purchaseInvoice->getViewPath(); ?>','<?php echo $securityToken; ?>',1,<?php echo $leafAccess['leafAccessDeleteValue']; ?>)");
...
<script type="text/javascript" src="./v3/financial/accountPayable/javascript/purchaseInvoiceMaintenance.js"></script>
<hr>
<footer>
    <p>IDCMS 2012/2013</p>
</footer>