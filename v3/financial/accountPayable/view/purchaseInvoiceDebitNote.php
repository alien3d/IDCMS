...
$_POST['from'] = 'purchaseInvoiceDebitNote.php';
$_GET['from'] = 'purchaseInvoiceDebitNote.php';
if (isset($_POST)) {
                        ...
                        <div class="panel-body">
                            <div class="col-xs-1 col-sm-1 col-md-1">
                                <button type="button"  name="newRecordbutton"  id="newRecordbutton"  class="btn btn-success"
                                        ...
                                        echo $purchaseInvoiceDebitNote->getViewPath();
...
if ((isset($_POST['method']) == 'new' || isset($_POST['method']) == 'read') && $_POST['type'] == 'form') {
                        ...
                        <div class="panel-body">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 form-group" id="businessPartnerIdForm">
                                        ...
                                        <div class="col-xs-8 col-sm-8 col-md-8">
                                            <select name="businessPartnerId" id="businessPartnerId" class="chzn-select form-control"onChange="getPurchaseInvoice(<?php echo $leafId; ?>, '<?php echo $purchaseInvoiceDebitNote->getControllerPath(); ?>', '<?php echo $securityToken; ?>');">
                                                <option value=""></option>
                                                <?php
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    ...
                                    <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 form-group" id="purchaseInvoiceDebitNoteAmountForm">
                                        ...
                                        <div class="col-xs-8 col-sm-8 col-md-8">
                                            <div class="input-group">
                                                <input class="form-control" type="text" name="purchaseInvoiceDebitNoteAmount" id="purchaseInvoiceDebitNoteAmount" value="<?php
                                                if (isset($purchaseInvoiceDebitNoteArray) && is_array($purchaseInvoiceDebitNoteArray)) {
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 form-group" id="purchaseInvoiceDebitNoteDescriptionForm">
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <textarea class="form-control" name="purchaseInvoiceDebitNoteDescription" id="purchaseInvoiceDebitNoteDescription" placeholder="<?php echo ucfirst($leafTranslation['purchaseInvoiceDebitNoteDescriptionLabel']); ?>"><?php
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6" align="right">
                                    <button type="button"  class="btn btn-success" title="<?php echo $t['newButtonLabel']; ?>" onclick="showFormCreateDetail('<?php echo $leafId; ?>', '<?php echo $purchaseInvoiceDebitNoteDetail->getControllerPath(); ?>', '<?php echo $securityToken; ?>');" value="<?php echo $t['newButtonLabel']; ?>"> <i class="glyphicon glyphicon-plus  glyphicon-white"></i></button>
                                </div>
                            </div>
                            <br>
                            <table class="table table-bordered table-striped table-condensed table-hover" id="tableData">
                                ...
                                <tr>
                                    <?php
                                    $disabledDetail = null;
                                    if (isset($_POST['purchaseInvoiceDebitNoteId']) && (strlen($_POST['purchaseInvoiceDebitNoteId']) > 0)) {
                                        $disabledDetail = null;
                                    } else {
                                ...
                                <tr>
                                    ...
                                    <td valign="top" class="form-group" id="purchaseInvoiceDebitNoteDetailAmount9999Detail"><input class="form-control" <?php echo $disabledDetail; ?> type="text" name="purchaseInvoiceDebitNoteDetailAmount[]" id="purchaseInvoiceDebitNoteDetailAmount9999"></td>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
                                </tr>
                                </thead>
                                            ...
                                            if ($totalRecordDetail > 0) {
                                                ...
                                                for ($j = 0; $j < $totalRecordDetail; $j++) {
                                                    ...
                                                    <tr id="<?php echo $purchaseInvoiceDebitNoteDetailArray[$j]['purchaseInvoiceDebitNoteDetailId']; ?>">
                                                        ...
                                                        <td valign="top"><input class="form-control input-sm" style="text-align:right" type="text" name="purchaseInvoiceDebitNoteDetailAmount[]" id="purchaseInvoiceDebitNoteDetailAmount<?php echo $purchaseInvoiceDebitNoteDetailArray[$j]['purchaseInvoiceDebitNoteDetailId']; ?>"   value="<?php
                                                            ...
                                                            $totalCredit += $y;
                                                            ?>
                                                        <td valign="middle"><div id="debit_<?php echo $purchaseInvoiceDebitNoteDetailArray[$j]['purchaseInvoiceDebitNoteDetailId']; ?>" class="pull-right"><?php echo $debit; ?></div></td>
                                                        <td valign="middle"><div id="credit_<?php echo $purchaseInvoiceDebitNoteDetailArray[$j]['purchaseInvoiceDebitNoteDetailId']; ?>" class="pull-right"><?php echo $credit; ?></div></td>
                                                    </tr>
                                                    <?php
                                                }
                                            } else {
    ...
    <?php if ($_POST['method'] == "new") { ?>
        ...
        <?php if ($leafAccess['leafAccessCreateValue'] == 1) { ?>
                    $('#newRecordButton1').removeClass().addClass('btn btn-success').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $purchaseInvoiceDebitNote->getControllerPath(); ?>','<?php echo $purchaseInvoiceDebitNote->getViewPath(); ?>','<?php echo $securityToken; ?>',1)");
                    $('#newRecordButton2').removeClass().addClass('btn  dropdown-toggle btn-success');
                    $('#newRecordButton3').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $purchaseInvoiceDebitNote->getControllerPath(); ?>','<?php echo $purchaseInvoiceDebitNote->getViewPath(); ?>','<?php echo $securityToken; ?>',1)");
                    $('#newRecordButton4').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $purchaseInvoiceDebitNote->getControllerPath(); ?>','<?php echo $purchaseInvoiceDebitNote->getViewPath(); ?>','<?php echo $securityToken; ?>',2)");
                    $('#newRecordButton5').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $purchaseInvoiceDebitNote->getControllerPath(); ?>','<?php echo $purchaseInvoiceDebitNote->getViewPath(); ?>','<?php echo $securityToken; ?>',3)");
                    $('#newRecordButton6').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $purchaseInvoiceDebitNote->getControllerPath(); ?>','<?php echo $purchaseInvoiceDebitNote->getViewPath(); ?>','<?php echo $securityToken; ?>',4)");
                    $('#newRecordButton7').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $purchaseInvoiceDebitNote->getControllerPath(); ?>','<?php echo $purchaseInvoiceDebitNote->getViewPath(); ?>','<?php echo $securityToken; ?>',5)");
        <?php } else { ?>
    ...
    <?php } else if ($_POST['purchaseInvoiceDebitNoteId']) { ?>
                $('#newRecordButton1').removeClass().addClass('btn btn-success disabled').attr('onClick', '');
                $('#newRecordButton2').removeClass().addClass('btn dropdown-toggle btn-success disabled');
        ...
        <?php if ($leafAccess['leafAccessUpdateValue'] == 1) { ?>
                    $('#updateRecordButton1').removeClass().addClass('btn btn-info').attr('onClick', "updateRecord(<?php echo $leafId; ?>,'<?php echo $purchaseInvoiceDebitNote->getControllerPath(); ?>','<?php echo $purchaseInvoiceDebitNote->getViewPath(); ?>','<?php echo $securityToken; ?>',1,<?php echo $leafAccess['leafAccessDeleteValue']; ?>)");
                    $('#updateRecordButton2').removeClass().addClass('btn dropdown-toggle btn-info');
                    $('#updateRecordButton3').attr('onClick', "updateRecord(<?php echo $leafId; ?>,'<?php echo $purchaseInvoiceDebitNote->getControllerPath(); ?>','<?php echo $purchaseInvoiceDebitNote->getViewPath(); ?>','<?php echo $securityToken; ?>',1,<?php echo $leafAccess['leafAccessDeleteValue']; ?>)");
                    $('#updateRecordButton4').attr('onClick', "updateRecord(<?php echo $leafId; ?>,'<?php echo $purchaseInvoiceDebitNote->getControllerPath(); ?>','<?php echo $purchaseInvoiceDebitNote->getViewPath(); ?>','<?php echo $securityToken; ?>',2,<?php echo $leafAccess['leafAccessDeleteValue']; ?>)");
                    $('#updateRecordButton5').attr('onClick', "updateRecord(<?php echo $leafId; ?>,'<?php echo $purchaseInvoiceDebitNote->getControllerPath(); ?>','<?php echo $purchaseInvoiceDebitNote->getViewPath(); ?>','<?php echo $securityToken; ?>',3,<?php echo $leafAccess['leafAccessDeleteValue']; ?>)");
        <?php } else { ?>
        ...
        <?php } ?>
        <?php if ($leafAccess['leafAccessDeleteValue'] == 1) { ?>
                    $('#deleteRecordButton').removeClass().addClass('btn btn-danger').attr('onClick', "deleteRecord(<?php echo $leafId; ?>,'<?php echo $purchaseInvoiceDebitNote->getControllerPath(); ?>','<?php echo $purchaseInvoiceDebitNote->getViewPath(); ?>','<?php echo $securityToken; ?>',<?php echo $leafAccess['leafAccessDeleteValue']; ?>)");
        <?php } else { ?>
                    $('#deleteRecordButton').removeClass().addClass('btn btn-danger disabled').attr('onClick', '');
        <?php } ?>
    <?php } ?>
...
<?php } ?>
<script type="text/javascript" src="./v3/financial/accountPayable/javascript/purchaseInvoiceDebitNote.js"></script>
<hr>
<footer>
    <p>IDCMS 2012/2013</p>
</footer>
