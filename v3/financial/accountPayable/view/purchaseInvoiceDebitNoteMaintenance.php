...
$_POST['from'] = 'purchaseInvoiceDebitNoteMaintenance.php';
$_GET['from'] = 'purchaseInvoiceDebitNoteMaintenance.php';
if (isset($_POST)) {
                                        ...
                                        if ($_POST['method'] == 'read' && $_POST['type'] == 'list' && $_POST['detail'] == 'body') {
                                            if (is_array($purchaseInvoiceDebitNoteArray)) {
                                                ...
                                                if ($totalRecord > 0) {
                                                    ...
                                                    ?>
                                                    <tr>
                                                        <td colspan="13" valign="top" align="center"><?php $purchaseInvoiceDebitNote->exceptionMessage($t['recordNotFoundLabel']); ?></td>
                                                    </tr>
                                                    <?php
                                                }
                                            } else {
                                            ...
                                            ?>
                                            <tr>
                                                <td colspan="13" valign="top" align="center"><?php $purchaseInvoiceDebitNote->exceptionMessage($t['loadFailureLabel']); ?></td>
                                            </tr>
                                            <?php
                                        }
                                        ?>
        ...
        <div class="row">
            ...
            <div class="col-xs-6 col-sm-6 col-md-6" align="right">
                <button type="button"  class="btn btn-success" title="<?php echo $t['newButtonLabel']; ?>"
                        ...
                        ;
                        ?>', '<?php
                        echo $purchaseInvoiceDebitNoteDetail->getControllerPath();
                ...
                <table class="table table-bordered table-striped table-condensed table-hover" id="tableData">
                    ...
                    <tr>
                        ...
                        <td valign="top" align="center"><div align="center">
                                ...
                                echo $leafId;
                                ;
                                ?>', '<?php echo $purchaseInvoiceDebitNoteDetail->getControllerPath(); ?>', '<?php echo $securityToken; ?>')">
                        ...
                        <td valign="top"><div class="form-group" id="purchaseInvoiceDebitNoteDetailAmount9999Detail">
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <input class="form-control" <?php echo $disabledDetail; ?> type="text" name="purchaseInvoiceDebitNoteDetailAmount[]" id="purchaseInvoiceDebitNoteDetailAmount9999">
                                </div>
                                <span class="help-block" id="purchaseInvoiceDebitNoteDetailAmount9999HelpMe"></span></div></td>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                    </tr>
                    </thead>
...
<?php } ?>
<script type="text/javascript" src="./v3/financial/accountPayable/javascript/purchaseInvoiceDebitNoteMaintenance.js"></script>
<hr>
<footer>
    <p>IDCMS 2012/2013</p>
</footer>