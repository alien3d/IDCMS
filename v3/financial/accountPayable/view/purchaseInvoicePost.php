...
$_POST['from'] = 'purchaseInvoicePost.php';
$_GET['from'] = 'purchaseInvoicePost.php';
if (isset($_POST)) {
                ...
                <div id="rightViewport" class="col-xs-9 col-sm-9 col-md-9">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-3 col-sm-3 col-md-3 pull-right pagination" align="right">
                            <button type="button"  class="delete btn btn-warning" onClick="postGridRecordCheckbox('<?php echo $leafId; ?>', '<?php echo $purchaseInvoice->getControllerPath(); ?>', '<?php echo $purchaseInvoice->getViewPath(); ?>', '<?php echo $securityToken; ?>')"> <i class="glyphicon glyphicon-white glyphicon-wrench"></i> </button>
                        </div>
                    </div>
                    <script type="text/javascript">
                                    ...
                                    if ($totalRecordDetail > 0) {
                                        ...
                                        for ($j = 0; $j < $totalRecordDetail; $j++) {
                                            ...
                                            <tr id="<?php echo $purchaseInvoiceDetailArray[$j]['purchaseInvoiceDetailId']; ?>">
                                                ...
                                                <td vAlign="top" class="form-group" id="chartOfAccountIdAmount<?php echo $purchaseInvoiceDetailArray[$j]['purchaseInvoiceDetailId']; ?>Detail"><div class="form-group" id="chartOfAccountId<?php echo $purchaseInvoiceDetailArray[$j]['purchaseInvoiceDetailId']; ?>Detail">
...
<script type="text/javascript" src="./v3/financial/accountPayable/javascript/purchaseInvoicePost.js"></script>
<hr>
<footer>
    <p>IDCMS 2012/2013</p>
</footer>