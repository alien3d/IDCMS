...
$_POST['from'] = 'purchaseInvoiceCreditNote.php';
$_GET['from'] = 'purchaseInvoiceCreditNote.php';
if (isset($_POST)) {
                        ...
                        <div class="panel-body">
                            <div class="col-xs-1 col-sm-1 col-md-1">
                                <button type="button"  name="newRecordbutton"  id="newRecordbutton"  class="btn btn-success"
                                        ...
                                        echo $purchaseInvoiceCreditNote->getViewPath();
                            ...
                            <div class="col-xs-3 col-sm-3 col-md-3">
                                <div class="input-group"><input type="text" class="form-control" name="queryWidget"  id="queryWidget" value="<?php
                                    ...
                                    ?>" placeholder="<?php echo $t['searchButtonLabel']; ?>"><span class="input-group-btn"><button  name="searchString" id="searchString" value="<?php echo $t['searchButtonLabel']; ?>"
                                ...
                                <div align="left" class="pull-left">
                                    <div class="btn-group">								
                                        ...
                                        <ul class="dropdown-menu">
                                            <li> <a href="javascript:void(0)" onclick="reportRequest('<?php echo $leafId; ?>', '<?php echo $purchaseInvoiceCreditNote->getControllerPath(); ?>', '<?php echo $securityToken; ?>', 'excel')"> <i class="pull-right glyphicon glyphicon-download"></i>Excel 2007 </a> </li>
                                            <li> <a href ="javascript:void(0)" onclick="reportRequest('<?php echo $leafId; ?>', '<?php echo $purchaseInvoiceCreditNote->getControllerPath(); ?>', '<?php echo $securityToken; ?>', 'csv')"> <i class ="pull-right glyphicon glyphicon-download"></i>CSV </a> </li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="row">
                <div id="rightViewport" class="col-xs-12 col-sm-12 col-md-12">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form class="form-horizontal">
                                        ...
                                        <div class="form-group" id="purchaseInvoiceCreditNoteAmountDiv">
                                            <label class="control-label col-xs-4 col-sm-4 col-md-4 col-lg-4" for="purchaseInvoiceCreditNoteAmountPreview"><?php echo $leafTranslation['purchaseInvoiceCreditNoteAmountLabel']; ?></label>
                                            <div class=" col-xs-8 col-sm-8 col-md-8 col-lg-8">
                                                <input class="form-control" type="text" name="purchaseInvoiceCreditNoteAmountPreview" id="purchaseInvoiceCreditNoteAmountPreview">
                                            </div>
                                        </div>
                                ...
                                <div class="modal-footer">
                                    <button type="button"  class="btn btn-danger" onclick="deleteGridRecord('<?php echo $leafId; ?>', '<?php echo $purchaseInvoiceCreditNote->getControllerPath(); ?>', '<?php echo $purchaseInvoiceCreditNote->getViewPath(); ?>', '<?php echo $securityToken; ?>')" value="<?php echo $t['deleteButtonLabel']; ?>"><?php echo $t['deleteButtonLabel']; ?></button>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="panel panel-default">
                                <table class ="table table-bordered table-striped table-condensed table-hover has-tickbox" id="tableData">
                                    <thead>
                                        <tr>
                                        ...
                                        if ($_POST['method'] == 'read' && $_POST['type'] == 'list' && $_POST['detail'] == 'body') {
                                            if (is_array($purchaseInvoiceCreditNoteArray)) {
                                                ...
                                                if ($totalRecord > 0) {
                                                        ...
                                                        ?>>
                                                            ...
                                                            <td valign="top" align="center"><?php if ($purchaseInvoiceCreditNoteArray[$i]['purchaseInvoiceCreditNoteCode'] != 'UNBL') { ?><div class="btn-group" align="center">
                                                                        <?php if ($leafAccess['leafAccessUpdateValue'] == 1) { ?>
                                                                            <button type="button"  class="btn btn-warning btn-sm" title="Edit" onclick="showFormUpdate('<?php echo $leafId; ?>', '<?php echo $purchaseInvoiceCreditNote->getControllerPath(); ?>', '<?php echo $purchaseInvoiceCreditNote->getViewPath(); ?>', '<?php echo $securityToken; ?>', '<?php echo intval($purchaseInvoiceCreditNoteArray [$i]['purchaseInvoiceCreditNoteId']); ?>', <?php echo $leafAccess['leafAccessUpdateValue']; ?>, <?php echo $leafAccess['leafAccessDeleteValue']; ?>);"><i class="glyphicon glyphicon-edit glyphicon-white"></i></button>
                                                                        <?php } ?>
                                                                            <?php if ($leafAccess['leafAccessDeleteValue'] == 1) { ?><button type="button"  class="btn btn-danger btn-sm" title="Delete" onclick="showModalDelete('<?php echo rawurlencode($purchaseInvoiceCreditNoteArray [$i]['purchaseInvoiceCreditNoteId']); ?>', '<?php echo rawurlencode($purchaseInvoiceCreditNoteArray [$i]['businessPartnerCompany']); ?>', '<?php echo rawurlencode($purchaseInvoiceCreditNoteArray [$i]['purchaseInvoiceDescription']); ?>', '<?php echo rawurlencode($purchaseInvoiceCreditNoteArray [$i]['purchaseInvoiceTitle']); ?>', '<?php echo rawurlencode($purchaseInvoiceCreditNoteArray [$i]['documentNumber']); ?>', '<?php echo rawurlencode($purchaseInvoiceCreditNoteArray [$i]['purchaseInvoiceCreditNoteAmount']); ?>', '<?php echo rawurlencode($purchaseInvoiceCreditNoteArray [$i]['referenceNumber']); ?>', '<?php echo rawurlencode($purchaseInvoiceCreditNoteArray [$i]['purchaseInvoiceCreditNoteDate']); ?>', '<?php echo rawurlencode($purchaseInvoiceCreditNoteArray [$i]['purchaseInvoiceDescription']); ?>');"><i class="glyphicon glyphicon-trash glyphicon-white"></i></button>
                                                                        <?php } ?></div><?php } ?></td>
                                                    ...
                                                    ?>
                                                    <tr>
                                                        <td colspan="10" valign="top" align="center"><?php $purchaseInvoiceCreditNote->exceptionMessage($t['recordNotFoundLabel']); ?></td>
                                                    </tr>
                                                    <?php
                                                }
                                            } else {
                                            ...
                                            ?>
                                            <tr>
                                                <td colspan="10" valign="top" align="center"><?php $purchaseInvoiceCreditNote->exceptionMessage($t['loadFailureLabel']); ?></td>
                                            </tr>
                                            <?php
                                        }
                                        ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-3 col-sm-3 col-md-3 pull-right pagination" align="right">
                            <button type="button"  class="delete btn btn-warning" onclick="deleteGridRecordCheckbox('<?php echo $leafId; ?>', '<?php echo $purchaseInvoiceCreditNote->getControllerPath(); ?>', '<?php echo $purchaseInvoiceCreditNote->getViewPath(); ?>', '<?php echo $securityToken; ?>')"> <i class="glyphicon glyphicon-white glyphicon-trash"></i> </button>
                        </div>
                    </div>
                    <script type="text/javascript">
...
if ((isset($_POST['method']) == 'new' || isset($_POST['method']) == 'read') && $_POST['type'] == 'form') {
                        ...
                        <div class="panel-body">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 form-group" id="businessPartnerIdForm">
                                        ...
                                        <div class="col-xs-8 col-sm-8 col-md-8">
                                            <select name="businessPartnerId" id="businessPartnerId" class="chzn-select form-control"onChange="getPurchaseInvoice(<?php echo $leafId; ?>, '<?php echo $purchaseInvoiceCreditNote->getControllerPath(); ?>', '<?php echo $securityToken; ?>');">
                                                <option value=""></option>
                                                <?php
                                    ...
                                    <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 form-group" id="purchaseInvoiceIdForm">
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    ...
                                    ?>
                                    <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 form-group" id="purchaseInvoiceCreditNoteDateForm">
                                    ...
                                    <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 form-group" id="purchaseInvoiceCreditNoteAmountForm">
                                        <label class="control-label col-xs-4 col-sm-4 col-md-4" for="purchaseInvoiceCreditNoteAmount"><strong><?php echo ucfirst($leafTranslation['purchaseInvoiceCreditNoteAmountLabel']); ?></strong></label>
                                        <div class="col-xs-8 col-sm-8 col-md-8">
                                            <div class="input-group">
                                                <input class="form-control" type="text" name="purchaseInvoiceCreditNoteAmount" id="purchaseInvoiceCreditNoteAmount" onkeyup="removeMeError('purchaseInvoiceCreditNoteAmount', 4)"  value="<?php
                                                if (isset($purchaseInvoiceCreditNoteArray) && is_array($purchaseInvoiceCreditNoteArray)) {
                                                    if (isset($purchaseInvoiceCreditNoteArray[0]['purchaseInvoiceCreditNoteAmount'])) {
                                                        echo htmlentities($purchaseInvoiceCreditNoteArray[0]['purchaseInvoiceCreditNoteAmount']);
                                                    }
                                                }
                                                ?>">
                                                <span class="input-group-addon"><img src="./images/icons/currency.png"></span></div>
                                            <span class="help-block" id="purchaseInvoiceCreditNoteAmountHelpMe"></span> </div>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    ...
                                    <div class="form-group" id="purchaseInvoiceDescriptionForm">
                                        <div class="col-xs-12 col-sm-12 col-md-12">
                                            <textarea class="form-control" name="purchaseInvoiceDescription" id="purchaseInvoiceDescription" placeholder="<?php echo ucfirst($leafTranslation['purchaseInvoiceCreditNoteDescriptionLabel']); ?>"><?php
                        ...
                        <div class="panel-body">
                            ...
                            <table class="table table-bordered table-striped table-condensed table-hover" id="tableData">
                                ...
                                <tr>
                                    <?php
                                    $disabledDetail = null;
                                    if (isset($_POST['purchaseInvoiceCreditNoteId']) && (strlen($_POST['purchaseInvoiceCreditNoteId']) > 0)) {
                                        $disabledDetail = null;
                                    } else {
                                ...
                                <tr>
                                    ...
                                    <td valign="top" class="form-group" id="purchaseInvoiceCreditNoteDetailAmount9999Detail">
                                        <input class="form-control" <?php echo $disabledDetail; ?> type="text" name="purchaseInvoiceCreditNoteDetailAmount[]" id="purchaseInvoiceCreditNoteDetailAmount9999">
                                    </td>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
                                </tr>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            validateMeAlphaNumeric('purchaseInvoiceTitle');

            validateMeCurrency('purchaseInvoiceCreditNoteAmount');
    ...
    <?php if ($_POST['method'] == "new") { ?>
        ...
        <?php if ($leafAccess['leafAccessCreateValue'] == 1) { ?>
                    $('#newRecordButton1').removeClass().addClass('btn btn-success').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $purchaseInvoiceCreditNote->getControllerPath(); ?>','<?php echo $purchaseInvoiceCreditNote->getViewPath(); ?>','<?php echo $securityToken; ?>',1)");
                    $('#newRecordButton2').removeClass().addClass('btn  dropdown-toggle btn-success');
                    $('#newRecordButton3').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $purchaseInvoiceCreditNote->getControllerPath(); ?>','<?php echo $purchaseInvoiceCreditNote->getViewPath(); ?>','<?php echo $securityToken; ?>',1)");
                    $('#newRecordButton4').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $purchaseInvoiceCreditNote->getControllerPath(); ?>','<?php echo $purchaseInvoiceCreditNote->getViewPath(); ?>','<?php echo $securityToken; ?>',2)");
                    $('#newRecordButton5').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $purchaseInvoiceCreditNote->getControllerPath(); ?>','<?php echo $purchaseInvoiceCreditNote->getViewPath(); ?>','<?php echo $securityToken; ?>',3)");
                    $('#newRecordButton6').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $purchaseInvoiceCreditNote->getControllerPath(); ?>','<?php echo $purchaseInvoiceCreditNote->getViewPath(); ?>','<?php echo $securityToken; ?>',4)");
                    $('#newRecordButton7').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $purchaseInvoiceCreditNote->getControllerPath(); ?>','<?php echo $purchaseInvoiceCreditNote->getViewPath(); ?>','<?php echo $securityToken; ?>',5)");
        <?php } else { ?>
    ...
    <?php } else if ($_POST['purchaseInvoiceCreditNoteId']) { ?>
                $('#newRecordButton1').removeClass().addClass('btn btn-success disabled').attr('onClick', '');
                $('#newRecordButton2').removeClass().addClass('btn dropdown-toggle btn-success disabled');
        ...
        <?php if ($leafAccess['leafAccessUpdateValue'] == 1) { ?>
                    $('#updateRecordButton1').removeClass().addClass('btn btn-info').attr('onClick', "updateRecord(<?php echo $leafId; ?>,'<?php echo $purchaseInvoiceCreditNote->getControllerPath(); ?>','<?php echo $purchaseInvoiceCreditNote->getViewPath(); ?>','<?php echo $securityToken; ?>',1,<?php echo $leafAccess['leafAccessDeleteValue']; ?>)");
                    $('#updateRecordButton2').removeClass().addClass('btn dropdown-toggle btn-info');
                    $('#updateRecordButton3').attr('onClick', "updateRecord(<?php echo $leafId; ?>,'<?php echo $purchaseInvoiceCreditNote->getControllerPath(); ?>','<?php echo $purchaseInvoiceCreditNote->getViewPath(); ?>','<?php echo $securityToken; ?>',1,<?php echo $leafAccess['leafAccessDeleteValue']; ?>)");
                    $('#updateRecordButton4').attr('onClick', "updateRecord(<?php echo $leafId; ?>,'<?php echo $purchaseInvoiceCreditNote->getControllerPath(); ?>','<?php echo $purchaseInvoiceCreditNote->getViewPath(); ?>','<?php echo $securityToken; ?>',2,<?php echo $leafAccess['leafAccessDeleteValue']; ?>)");
                    $('#updateRecordButton5').attr('onClick', "updateRecord(<?php echo $leafId; ?>,'<?php echo $purchaseInvoiceCreditNote->getControllerPath(); ?>','<?php echo $purchaseInvoiceCreditNote->getViewPath(); ?>','<?php echo $securityToken; ?>',3,<?php echo $leafAccess['leafAccessDeleteValue']; ?>)");
        <?php } else { ?>
        ...
        <?php if ($leafAccess['leafAccessDeleteValue'] == 1) { ?>
                    $('#deleteRecordButton').removeClass().addClass('btn btn-danger').attr('onClick', "deleteRecord(<?php echo $leafId; ?>,'<?php echo $purchaseInvoiceCreditNote->getControllerPath(); ?>','<?php echo $purchaseInvoiceCreditNote->getViewPath(); ?>','<?php echo $securityToken; ?>',<?php echo $leafAccess['leafAccessDeleteValue']; ?>)");
        <?php } else { ?>
                    $('#deleteRecordButton').removeClass().addClass('btn btn-danger disabled').attr('onClick', '');
        <?php } ?>
    <?php } ?>
...
<?php } ?>
<script type="text/javascript" src="./v3/financial/accountPayable/javascript/purchaseInvoiceCreditNote.js"></script>
<hr>
<footer>
    <p>IDCMS 2012/2013</p>
</footer>