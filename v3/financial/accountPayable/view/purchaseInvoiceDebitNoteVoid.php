...
$_POST['from'] = 'purchaseInvoiceDebitNoteVoid.php';
$_GET['from'] = 'purchaseInvoiceDebitNoteVoid.php';
if (isset($_POST)) {
...
<?php } ?>
<script type="text/javascript" src="./v3/financial/accountPayable/javascript/purchaseInvoiceDebitNoteVoid.js"></script>
<hr>
<footer>
    <p>IDCMS 2012/2013</p>
</footer>
