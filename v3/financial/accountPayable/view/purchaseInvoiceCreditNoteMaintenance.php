...
$_POST['from'] = 'purchaseInvoiceCreditNoteMaintenance.php';
$_GET['from'] = 'purchaseInvoiceCreditNoteMaintenance.php';
if (isset($_POST)) {
...
if (isset($_POST['method']) && isset($_POST['type'])) {
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="panel panel-info" id="masterForm">
                            <div class="panel-heading">
                                <div class="pull-left">
                                    <div class="btn-group"> 
                                        <button id="printRecordbutton" type="button" class="btn btn-primary"><i class="glyphicon glyphicon-print glyphicon-white"></i> <?php echo $t['printerToolbarLabel']; ?> </button> 
    ...
    <?php if ($_POST['purchaseInvoiceCreditNoteId']) { ?>
    ...
    <?php } ?>
    <script type="text/javascript" src="./v3/financial/accountPayable/javascript/purchaseInvoiceCreditNoteMaintenance.js"></script>
    <hr>
    <footer>
        <p>IDCMS 2012/2013</p>
    </footer>