            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12">
                    ...
                    <div class="panel-footer">
                        <button type="button"  onClick="showMeModal('newBusinessPartner', 1);"
                                class="btn btn-info"><?php echo $t['newButtonLabel']; ?></button>

                        <button type="button"  onClick="showMeModal('infoBusinessPartner', 1);"
                                class="btn btn-info"><?php echo $t['informationTextLabel']; ?></button>
                                    ...
                                    <div id='content' class="tab-content">
                                            ...
                                            <div class="row">
                                                <div class="col-xs-12 col-sm-12 col-md-12" align="right">
                                                    <form class="form-inline">&nbsp;&nbsp;&nbsp;
                                                        <input type="text" name="searchQuoteInvoice" id="searchDueInvoice"
                                                               class="input-sm form-control" style="width:70%">
                                                        <button type="button"  class="btn btn-sm btn-info" name="searchDueInvoicebutton 
                                                                id="searchDueInvoicebutton 
                                                                value="<?php echo $t['searchButtonLabel']; ?>"><?php echo $t['searchButtonLabel']; ?></button>
                                                        <button type="button"  class="btn btn-sm btn-info" name="clearDueInvoicebutton 
                                                                id="clearDueInvoicebutton 
                                            ...
                                            <div class="row">
                                                <div class="col-xs-12 col-sm-12 col-md-12">&nbsp;
                                                    <div style="padding:5px">
                                                        <table class="table table table-bordered table-striped table-condensed table-hover smart-form has-tickbox"
                                                               id="tableData">
                                                            <thead>
                                                                <tr>
                                                                    <th>aa</th>
                                        ...
                                        <div class="tab-pane fade in active" id="dueInvoice">
                                            ...
                                            <div class="row">
                                                <div class="col-xs-12 col-sm-12 col-md-12" align="right">
                                                    <form class="form-inline">&nbsp;&nbsp;&nbsp;
                                                        <input type="text" name="searchDueInvoice" id="searchDueInvoice"
                                                               class="input-sm form-control" style="width:70%">
                                                        <button type="button"  class="btn btn-sm btn-info" name="searchDueInvoicebutton 
                                                                id="searchDueInvoicebutton 
                                                                value="<?php echo $t['searchButtonLabel']; ?>"><?php echo $t['searchButtonLabel']; ?></button>
                        ...
                        <div class="col-xs-6 col-sm-6 col-md-6">
                            <div style="min-height:600px;" class="panel panel-default">
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <form class="form-inline">&nbsp;&nbsp;&nbsp;
                                            <input type="text" name="followUpDescription" id="followUpDescription" class="form-control"
                                                   style="width:200px">
                                                ...
                                                if (is_array($followUpArray)) {
                                                    ...
                                                    if ($totalRecord > 0) {
                                                        ...
                                                        for ($i = 0; $i < $totalRecord; $i++) {
                                                            ?>
                                                            <option
                                                                value="<?php echo $followUpArray[$i]['followUpId']; ?>"><?php echo $d; ?>
                                                                . <?php echo $followUpArray[$i]['followUpDescription']; ?></option>
                                                            <?php
                                                            $d++;
                                                        }
                                                    } else {
                                            ...
                                            <button type="button"  class="btn btn-sm btn-info" name="searchDueInvoicebutton 
                                                    id="searchDueInvoicebutton 
                                                    value="<?php echo $t['followUpButtonLabel']; ?>"><?php echo $t['followUpButtonLabel']; ?></button>
                                            &nbsp;</form>
                                    </div>
                                </div>
                                <div class="row">
