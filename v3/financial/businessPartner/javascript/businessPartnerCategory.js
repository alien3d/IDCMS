	function checkDuplicate(leafId, page, securityToken){
		var $businessPartnerCategoryCode = $("#businessPartnerCategoryCode");
	    if($businessPartnerCategoryCode.val().length ===0 ){
	    ...
	    $.ajax({
	        ...
	        url: page,
	        data: {
	            businessPartnerCategoryCode : $businessPartnerCategoryCode.val(),
	            method : 'duplicate',
				...
				if(success === true){
					if(total  !==0){
						$("#businessPartnerCategoryCode")
							.val('')
             				.focus();
             			$("#businessPartnerCategoryCodeForm")
	...
	function showFormUpdate(leafId,url,urlList, securityToken, businessPartnerCategoryId,updateAccess,deleteAccess) {
		sleep(500);
	...
	function showModalDelete(businessPartnerCategoryId,businessPartnerCategoryCode,businessPartnerCategoryDescription,isCreditor,isDebtor,isGlobal) {
		// clear first old record if exist
		$('#businessPartnerCategoryIdPreview').val('').val(decodeURIComponent(businessPartnerCategoryId));
		$('#businessPartnerCategoryCodePreview').val('').val(decodeURIComponent(businessPartnerCategoryCode));
		$('#businessPartnerCategoryDescriptionPreview').val('').val(decodeURIComponent(businessPartnerCategoryDescription));
		$('#isCreditorPreview').val('').val(decodeURIComponent(isCreditor));
		$('#isDebtorPreview').val('').val(decodeURIComponent(isDebtor));
		$('#isGlobalPreview').val('').val(decodeURIComponent(isGlobal));
	...
	function deleteGridRecord(leafId,url,urlList,securityToken) {
		$.ajax({
			...
			data    :   {
				method          :   'delete',
				output          :   'json',
				businessPartnerCategoryId	:   $('#businessPartnerCategoryIdPreview').val(),
				securityToken   :   securityToken,
				leafId          :   leafId
			},
			beforeSend: function () {
	...
	function deleteGridRecordCheckbox(leafId,url,urlList,securityToken) { 
		var stringText='';
		var counter = 0; 
		$('input:checkbox[name="businessPartnerCategoryId[]"]').each( function() {
			stringText=stringText+"&businessPartnerCategoryId[]="+$(this).val();  
		});
 ...
 function auditRecord() {
	...
	function newRecord(leafId,url,urlList,securityToken, type,createAccess,updateAccess,deleteAccess) {
		...
		var $businessPartnerCategoryCode = $('#businessPartnerCategoryCode');
		var $businessPartnerCategoryDescription = $('#businessPartnerCategoryDescription');
		...
		if (css.search('disabled') > 0) {
			...
			if (type === 1) {
			if ($businessPartnerCategoryCode.val().length === 0) {
				$('#businessPartnerCategoryCodeHelpMe')
					.html('').empty()
                  	.html("<span class='label label-important'>&nbsp;"+decodeURIComponent(t['requiredTextLabel'])+" : "+leafTranslation['businessPartnerCategoryCodeLabel']+" </span>");
			$('#businessPartnerCategoryCodeForm')
				.removeClass().addClass('form-group has-error');
			$businessPartnerCategoryCode.focus();
				return false ;
			}
			if ($businessPartnerCategoryDescription.val().length === 0) {
				$('#businessPartnerCategoryDescriptionHelpMe')
					.html('').empty()
                  	.html("<span class='label label-important'>&nbsp;"+decodeURIComponent(t['requiredTextLabel'])+" : "+leafTranslation['businessPartnerCategoryDescriptionLabel']+" </span>");
			$('#businessPartnerCategoryDescriptionForm')
				.removeClass().addClass('form-group has-error');
			$businessPartnerCategoryDescription.focus();
				return false ;
			}
			if ($isCreditor.val().length === 0) {
				$('#isCreditorHelpMe')
					.html('').empty()
                  	.html("<span class='label label-important'>&nbsp;"+decodeURIComponent(t['requiredTextLabel'])+" : "+leafTranslation['isCreditorLabel']+" </span>");
			$('#isCreditorForm')
				.removeClass().addClass('form-group has-error');
			$isCreditor.focus();
				return false ;
			...
			if ($isDebtor.val().length === 0) {
				$('#isDebtorHelpMe')
					.html('').empty()
                  	.html("<span class='label label-important'>&nbsp;"+decodeURIComponent(t['requiredTextLabel'])+" : "+leafTranslation['isDebtorLabel']+" </span>");
			$('#isDebtorForm')
				.removeClass().addClass('form-group has-error');
			$isDebtor.focus();
				return false ;
			}
			if ($isGlobal.val().length === 0) {
				$('#isGlobalHelpMe')
					.html('').empty()
                  	.html("<span class='label label-important'>&nbsp;"+decodeURIComponent(t['requiredTextLabel'])+" : "+leafTranslation['isGlobalLabel']+" </span>");
			$('#isGlobalForm')
				.removeClass().addClass('form-group has-error');
			$isGlobal.focus();
				return false ;
			...
			$.ajax({
                     ...
                     data	:   {
                         ...
                         output  :   'json',
                         businessPartnerCategoryCode :   $businessPartnerCategoryCode.val(),
                         businessPartnerCategoryDescription :   $businessPartnerCategoryDescription.val(),
                         isCreditor :   $isCreditor.val(),
                         isDebtor :   $isDebtor.val(),
					...
					success: function (data) {
						...
						if (success === true) {
							...
							if($infoPanel.is(':hidden')) {
                             ...
                             $businessPartnerCategoryCode.val('');
                             $('#businessPartnerCategoryCodeHelpMe')
                            	.html('').empty();
                             $businessPartnerCategoryDescription.val('');
                             $('#businessPartnerCategoryDescriptionHelpMe')
                            	.html('').empty();
                             $isCreditor.val('');
                             $('#isCreditorHelpMe')
                    ...
                    success: function (data) {
						...
						var message = data.message;
                         if (success === true) {
                             ...
                             $('#businessPartnerCategoryId').val(data.businessPartnerCategoryId); 
             ...
             // update record and listing
               if ($businessPartnerCategoryCode.val().length === 0) {
				   $('#businessPartnerCategoryCodeHelpMe')
				   	.html('').empty()
                 	.html("<span class='label label-important'>&nbsp;"+decodeURIComponent(t['requiredTextLabel'])+" : "+leafTranslation['businessPartnerCategoryCodeLabel']+" </span>");
                 $('#businessPartnerCategoryCodeForm').removeClass().addClass('form-group has-error');
                 $businessPartnerCategoryCode.focus();
                 return false ;
               }
               if ($businessPartnerCategoryDescription.val().length === 0) {
				   $('#businessPartnerCategoryDescriptionHelpMe')
				   	.html('').empty()
                 	.html("<span class='label label-important'>&nbsp;"+decodeURIComponent(t['requiredTextLabel'])+" : "+leafTranslation['businessPartnerCategoryDescriptionLabel']+" </span>");
                 $('#businessPartnerCategoryDescriptionForm').removeClass().addClass('form-group has-error');
                 $businessPartnerCategoryDescription.focus();
                 return false ;
               }
               if ($isCreditor.val().length === 0) {
               ...
               if ($isGlobal.val().length === 0) {
				   $('#isGlobalHelpMe')
				   	.html('').empty()
                 	.html("<span class='label label-important'>&nbsp;"+decodeURIComponent(t['requiredTextLabel'])+" : "+leafTranslation['isGlobalLabel']+" </span>");
                 $('#isGlobalForm').removeClass().addClass('form-group has-error');
                 $isGlobal.focus();
                 return false ;
               }
						if($infoPanel.is(':hidden')) {
	...
	function deleteRecord(leafId,url,urlList,securityToken,deleteAccess) {
		...
		if (css.search('disabled') > 0) {
			...
			if(deleteAccess === 1 ) {
				if(confirm(decodeURIComponent(t['deleteRecordMessageLabel']))) { 
					var value=$businessPartnerCategoryId.val(); 
					if(!value) {
						$infoPanel
							.html('').empty()
 	...
 	function resetRecord(leafId,url,urlList,securityToken,createAccess,updateAccess,deleteAccess) {
       ...
       var resetIcon = './images/icons/fruit-orange.png';
		...
		$("#businessPartnerCategoryIdHelpMe")
			.empty().html('');
		$("#businessPartnerCategoryCode").val('');
		$("#businessPartnerCategoryCodeHelpMe")
			.empty().html('');
		...
		$("#isCreditorHelpMe")
			.empty().html('');
		$("#isCreditor").removeAttr("checked");
		$('input[name="isCreditor"]').bootstrapSwitch('state', false);
		$("#isDebtor").val('');
		$("#isDebtorHelpMe")
			.empty().html('');
		$("#isDebtor").removeAttr("checked");
		$('input[name="isDebtor"]').bootstrapSwitch('state', false);
		$("#isGlobal").val('');
		$("#isGlobalHelpMe")
			.empty().html('');
		$("#isGlobal").removeAttr("checked");
		$('input[name="isGlobal"]').bootstrapSwitch('state', false);
 }
 function postRecord() {
			...
			success: function (data) {
				...
				if (success === true) {
					$.ajax({
						...
						data	:	{
							method  			:   'read',
							businessPartnerCategoryId	:   firstRecord,
							output          	:   'json',
							securityToken   	:   securityToken,
							leafId          	:   leafId
						},
						...
						success: function (data) {
							...
							if (success === true) {
								...
								$('#businessPartnerCategoryCode').val(data.data.businessPartnerCategoryCode);
								$('#businessPartnerCategoryDescription').val(data.data.businessPartnerCategoryDescription);
                                     if(data.data.isCreditor == true || data.data.isCreditor ==1) { 
                                     	$("#isCreditor").attr("checked","checked");
                                     	$('input[name="isCreditor"]').bootstrapSwitch('state',true);
                                     } else { 
                                     $("#isCreditor").removeAttr("checked");
                                     $('input[name="isCreditor"]').bootstrapSwitch('state', false);
                                     }
...
;
                                     if(data.data.isDebtor == true || data.data.isDebtor ==1) { 
                                     	$("#isDebtor").attr("checked","checked");
                                     	$('input[name="isDebtor"]').bootstrapSwitch('state',true);
                                     } else { 
                                     $("#isDebtor").removeAttr("checked");
                                     $('input[name="isDebtor"]').bootstrapSwitch('state', false);
                                     }
...
;
                                     if(data.data.isGlobal == true || data.data.isGlobal ==1) { 
                                     	$("#isGlobal").attr("checked","checked");
                                     	$('input[name="isGlobal"]').bootstrapSwitch('state',true);
                                     } else { 
                                     $("#isGlobal").removeAttr("checked");
                                     $('input[name="isGlobal"]').bootstrapSwitch('state', false);
                                     }
                                     $("#isGlobal").val(data.data.isGlobal);
;
									if (nextRecord > 0) {
										$('#previousRecordButton')
											.removeClass().addClass('btn btn-default disabled')
				...
				success: function (data) {
					...
					if (success === true) {
						$.ajax({
							...
							data    		:   {
								method          :   'read',
								businessPartnerCategoryId  :   lastRecord,
								output          :   'json',
								securityToken   :   securityToken,
								leafId          :   leafId
							},
		...
		if (css.search('disabled') > 0) {
			...
			if (parseFloat($previousRecordCounter.val()) > 0 && parseFloat($previousRecordCounter.val()) < parseFloat($('#lastRecordCounter').val())) {
				$.ajax({
					...
					data    :   {
						method          : 	'read',
						businessPartnerCategoryId  :   $previousRecordCounter.val(),
						output          :   'json',
						securityToken   :   securityToken,
						leafId          :   leafId
					},
		...
		if (css.search('disabled') > 0) {
			...
			if (parseFloat($nextRecordCounter.val()) <= parseFloat($('#lastRecordCounter').val())) {
				$.ajax({
					...
					data	:   {
					method          : 	'read',
					businessPartnerCategoryId  :   $nextRecordCounter.val(),
					output          : 	'json',
					securityToken   :   securityToken,
					leafId          :   leafId
				},
