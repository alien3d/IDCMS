...
function showFormUpdate(leafId, url, urlList, securityToken, businessPartnerContactId, updateAccess, deleteAccess) {
    sleep(500);
    // unlimited for searching because  lazy paging.
    $.ajax({
        type: 'POST',
...
function showModalDelete(businessPartnerContactId, businessPartnerId, businessPartnerContactName, businessPartnerContactTitle, businessPartnerContactPhone, businessPartnerContactEmail) {
    // clear first old record if exist
    $('#businessPartnerContactIdPreview').val('');
    $('#businessPartnerContactIdPreview').val(decodeURIComponent(businessPartnerContactId));

    $('#businessPartnerIdPreview').val('');
    $('#businessPartnerIdPreview').val(decodeURIComponent(businessPartnerId));

    $('#businessPartnerContactNamePreview').val('');
    $('#businessPartnerContactNamePreview').val(decodeURIComponent(businessPartnerContactName));

    $('#businessPartnerContactTitlePreview').val('');
    $('#businessPartnerContactTitlePreview').val(decodeURIComponent(businessPartnerContactTitle));

    $('#businessPartnerContactPhonePreview').val('');
    $('#businessPartnerContactPhonePreview').val(decodeURIComponent(businessPartnerContactPhone));

    $('#businessPartnerContactEmailPreview').val('');
    $('#businessPartnerContactEmailPreview').val(decodeURIComponent(businessPartnerContactEmail));
...
function deleteGridRecord(leafId, url, urlList, securityToken) {
    $.ajax({
        ...
        data: {
            method: 'delete',
            output: 'json',
            businessPartnerContactId: $('#businessPartnerContactIdPreview').val(),
            securityToken: securityToken,
            leafId: leafId
        },
        beforeSend: function() {
...
function deleteGridRecordCheckbox(leafId, url, urlList, securityToken) {
    var stringText = '';
    var counter = 0;
    $('input:checkbox[name="businessPartnerContactId[]"]').each(function() {
        stringText = stringText + "&businessPartnerContactId[]=" + $(this).val();
    });
...
function reportRequest(leafId, url, securityToken, mode) {
    $.ajax({
        ...
        success: function(data) {
            // successful request; do something with the data
            if (data.success == true) {
                var path = './package/financial/businessPartner/document/' + data.folder + '/' + data.filename;
    ...
    if (css.search('disabled') > 0) {
        ...
        if (type == 1) {
            ...
            if ($('#businessPartnerId').val().length == 0) {
                $('#infoPanel').html('<div class=\'alert alert-error col-md-12\'>' + decodeURIComponent(t['requiredTextLabel']) + ' : ' + leafTranslation['businessPartnerIdLabel'] + ' </div>');
                $('#businessPartnerId').addClass('form-group has-error');
                $('#businessPartnerId').focus();

            } else if ($('#businessPartnerContactName').val().length == 0) {
                $('#infoPanel').html('<div class=\'alert alert-error col-md-12\'>' + decodeURIComponent(t['requiredTextLabel']) + ' : ' + leafTranslation['businessPartnerContactNameLabel'] + ' </div>');
                $('#businessPartnerContactNameForm').addClass('form-group has-error');
                $('#businessPartnerContactName').focus();

            } else if ($('#businessPartnerContactTitle').val().length == 0) {
                $('#infoPanel').html('<div class=\'alert alert-error col-md-12\'>' + decodeURIComponent(t['requiredTextLabel']) + ' : ' + leafTranslation['businessPartnerContactTitleLabel'] + ' </div>');
                $('#businessPartnerContactTitleForm').addClass('form-group has-error');
                $('#businessPartnerContactTitle').focus();

            } else if ($('#businessPartnerContactPhone').val().length == 0) {
                $('#infoPanel').html('<div class=\'alert alert-error col-md-12\'>' + decodeURIComponent(t['requiredTextLabel']) + ' : ' + leafTranslation['businessPartnerContactPhoneLabel'] + ' </div>');
                $('#businessPartnerContactPhoneForm').addClass('form-group has-error');
                $('#businessPartnerContactPhone').focus();

            } else if ($('#businessPartnerContactEmail').val().length == 0) {
                $('#infoPanel').html('<div class=\'alert alert-error col-md-12\'>' + decodeURIComponent(t['requiredTextLabel']) + ' : ' + leafTranslation['businessPartnerContactEmailLabel'] + ' </div>');
                $('#businessPartnerContactEmailForm').addClass('form-group has-error');
                $('#businessPartnerContactEmail').focus();
                ...
                $.ajax({
                    ...
                    data: {
                        ...
                        businessPartnerContactName: $('#businessPartnerContactName').val(),
                        businessPartnerContactTitle: $('#businessPartnerContactTitle').val(),
                        businessPartnerContactPhone: $('#businessPartnerContactPhone').val(),
                        businessPartnerContactEmail: $('#businessPartnerContactEmail').val(),
                        securityToken: securityToken,
                        leafId: leafId
                    },
                    beforeSend: function() {
                    ...
                    success: function(data) {
                        ...
                        if (data.success == true) {
                            ...
                            $('#businessPartnerContactName').val('');
                            $('#businessPartnerContactTitle').val('');
                            $('#businessPartnerContactPhone').val('');
                            $('#businessPartnerContactEmail').val('');
                        } else if (data.success == false) {
                            $('#infoPanel').html('<div class=\'alert alert-error col-md-12\'>' + data.message + '</div>');
                        }
                    },
            ...
            if ($('#businessPartnerId').val().length == 0) {
                ...
                $('#infoPanel').html('<div class=\'alert alert-error col-md-12\'>' + decodeURIComponent(t['requiredTextLabel']) + ' : ' + leafTranslation['businessPartnerContactNameLabel'] + ' </div>');
                $('#businessPartnerContactName').addClass('form-group has-error');
                $('#businessPartnerContactName').focus();

            } else if ($('#businessPartnerContactTitle').val().length == 0) {
                $('#infoPanel').html('<div class=\'alert alert-error col-md-12\'>' + decodeURIComponent(t['requiredTextLabel']) + ' : ' + leafTranslation['businessPartnerContactTitleLabel'] + ' </div>');
                $('#businessPartnerContactTitle').addClass('form-group has-error');
                $('#businessPartnerContactTitle').focus();

            } else if ($('#businessPartnerContactPhone').val().length == 0) {
                $('#infoPanel').html('<div class=\'alert alert-error col-md-12\'>' + decodeURIComponent(t['requiredTextLabel']) + ' : ' + leafTranslation['businessPartnerContactPhoneLabel'] + ' </div>');
                $('#businessPartnerContactPhone').addClass('form-group has-error');
                $('#businessPartnerContactPhone').focus();

            } else if ($('#businessPartnerContactEmail').val().length == 0) {
                $('#infoPanel').html('<div class=\'alert alert-error col-md-12\'>' + decodeURIComponent(t['requiredTextLabel']) + ' : ' + leafTranslation['businessPartnerContactEmailLabel'] + ' </div>');
                $('#businessPartnerContactEmail').addClass('form-group has-error');
                $('#businessPartnerContactEmail').focus();
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (data.success == true) {
                            ...
                            $('#businessPartnerContactId').val(data.businessPartnerContactId);
                            $('#newRecordButton1').removeClass();
                            $('#newRecordButton2').removeClass();
                            $('#newRecordButton3').removeClass();
                            $('#newRecordButton4').removeClass();
    ...
    if (css.search('disabled') > 0) {
        ...
        if (type == 1) {
            ...
            if ($('#companyId').val().length == 0) {
                ...
                $('#companyId').focus();
            } else if ($('#businessPartnerId').val().length == 0) {
                $('#infoPanel').html('<div class=\'alert alert-error col-md-12\'>' + decodeURIComponent(t['requiredTextLabel']) + ' : ' + leafTranslation['businessPartnerIdLabel'] + ' </div>');
                $('#businessPartnerId').addClass('form-group has-error');
                $('#businessPartnerId').focus();
            } else if ($('#businessPartnerContactName').val().length == 0) {
    ...
    if (css.search('disabled') > 0) {
        ...
        if (deleteAccess == 1) {
            if (confirm(decodeURIComponent(t['deleteRecordMessageLabel']))) {
                var value = $('#businessPartnerContactId').val();
                if (!value) {
                    $('#infoPanel').empty();
                    $('#infoPanel').html('');
            ...
            success: function(data) {
                ...
                if (data.success == true) {
                    $.ajax({
                        ...
                        data: {
                            method: 'read',
                            businessPartnerContactId: data.firstRecord,
                            output: 'json',
                            securityToken: securityToken,
                            leafId: leafId
                        },
                        ...
                        success: function(data) {
                            ...
                            if (data.success == true) {
                                ...
                                // reseting field value
                                $('#businessPartnerContactId').val(data.data.businessPartnerContactId);
                                $('#businessPartnerId').val(data.data.businessPartnerId);
                                $('#businessPartnerContactName').val(data.data.businessPartnerContactName);
                                $('#businessPartnerContactTitle').val(data.data.businessPartnerContactTitle);
                                $('#businessPartnerContactPhone').val(data.data.businessPartnerContactPhone);
                                $('#businessPartnerContactEmail').val(data.data.businessPartnerContactEmail);
            ...
            success: function(data) {
                ...
                if (data.success == true) {
                    $.ajax({
                        ...
                        data: {
                            method: 'read',
                            businessPartnerContactId: data.lastRecord,
                            output: 'json',
                            securityToken: securityToken,
                            leafId: leafId
                        },
    ...
    if (css.search('disabled') > 0) {
        ...
        if (parseFloat($('#previousRecordCounter').val()) > 0 && parseFloat($('#previousRecordCounter').val()) < parseFloat($('#lastRecordCounter').val())) {
            $.ajax({
                ...
                data: {
                    method: 'read',
                    businessPartnerContactId: $('#previousRecordCounter').val(),
                    output: 'json',
                    securityToken: securityToken,
                    leafId: leafId
                },
    ...
    if (css.search('disabled') > 0) {
        ...
        if (parseFloat($('#nextRecordCounter').val()) <= parseFloat($('#lastRecordCounter').val())) {
            $.ajax({
                ...
                data: {
                    method: 'read',
                    businessPartnerContactId: $('#nextRecordCounter').val(),
                    output: 'json',
                    securityToken: securityToken,
                    leafId: leafId
                },
