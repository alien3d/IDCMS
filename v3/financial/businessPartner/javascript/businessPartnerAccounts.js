...
function showFormUpdate(leafId, url, urlList, securityToken, businessPartnerAccountId, updateAccess, deleteAccess) {
    sleep(500);
    // unlimited for searching because  lazy paging.
    $.ajax({
        type: 'POST',
        ...
        data: {
            method: 'read',
            type: 'form',
            businessPartnerAccountId: businessPartnerAccountId,
            securityToken: securityToken,
            leafId: leafId
        },
        beforeSend: function() {
...
function showModalDelete(businessPartnerAccountId, businessPartnerId, chartOfAccountId) {
    // clear first old record if exist
    $('#businessPartnerAccountIdPreview').val('');
    $('#businessPartnerAccountIdPreview').val(decodeURIComponent(businessPartnerAccountId));

    $('#businessPartnerIdPreview').val('');
    $('#businessPartnerIdPreview').val(decodeURIComponent(businessPartnerId));

    $('#chartOfAccountIdPreview').val('');
    $('#chartOfAccountIdPreview').val(decodeURIComponent(chartOfAccountId));
...
function deleteGridRecord(leafId, url, urlList, securityToken) {
    $.ajax({
        ...
        data: {
            method: 'delete',
            output: 'json',
            businessPartnerAccountId: $('#businessPartnerAccountIdPreview').val(),
            securityToken: securityToken,
            leafId: leafId
        },
        beforeSend: function() {
...
function deleteGridRecordCheckbox(leafId, url, urlList, securityToken) {
    var stringText = '';
    var counter = 0;
    $('input:checkbox[name="businessPartnerAccountId[]"]').each(function() {
        stringText = stringText + "&businessPartnerAccountId[]=" + $(this).val();
    });
...
function newRecord(leafId, url, urlList, securityToken, type, createAccesss, updateAccess, deleteAccess) {
    ...
    if (css.search('disabled') > 0) {
        ...
        if (type == 1) {
            ...
            if ($('#businessPartnerId').val().length == 0) {
            ...
            } else if ($('#chartOfAccountId').val().length == 0) {
                ...
                $('#chartOfAccountIdForm').addClass('form-group has-error');
            ...
            if ($('#businessPartnerId').val().length == 0) {
                ...
                $('#infoPanel').html('<div class=\'alert alert-error col-md-12\'>' + decodeURIComponent(t['requiredTextLabel']) + ' : ' + leafTranslation['chartOfAccountIdLabel'] + ' </div>');
                $('#chartOfAccountId').addClass('form-group has-error');
                $('#chartOfAccountId').focus();
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (data.success == true) {
                            ...
                            $('#businessPartnerAccountId').val(data.businessPartnerAccountId);
                            $('#newRecordButton1').removeClass();
                            $('#newRecordButton2').removeClass();
                            $('#newRecordButton3').removeClass();
                            $('#newRecordButton4').removeClass();
            ...
            if ($('#companyId').val().length == 0) {
                ...
                $.ajax({
                    ...
                    data: {
                        method: 'save',
                        output: 'json',
                        businessPartnerAccountId: $('#businessPartnerAccountId').val(),
                        businessPartnerId: $('#businessPartnerId').val(),
                        chartOfAccountId: $('#chartOfAccountId').val(),
                        securityToken: securityToken,
                        leafId: leafId
    ...
    if (css.search('disabled') > 0) {
        ...
        if (deleteAccess == 1) {
            if (confirm(decodeURIComponent(t['deleteRecordMessageLabel']))) {
                var value = $('#businessPartnerAccountId').val();
                if (!value) {
                    $('#infoPanel').empty();
                    $('#infoPanel').html('');
            ...
            success: function(data) {
                ...
                if (data.success == true) {
                    $.ajax({
                        ...
                        data: {
                            method: 'read',
                            businessPartnerAccountId: data.firstRecord,
                            output: 'json',
                            securityToken: securityToken,
                            leafId: leafId
                        },
                        ...
                        success: function(data) {
                            ...
                            if (data.success == true) {
                                ...
                                // reseting field value
                                $('#businessPartnerAccountId').val(data.data.businessPartnerAccountId);
            ...
            success: function(data) {
                ...
                if (data.success == true) {
                    $.ajax({
                        ...
                        data: {
                            method: 'read',
                            businessPartnerAccountId: data.lastRecord,
                            output: 'json',
                            securityToken: securityToken,
                            leafId: leafId
                        },
    ...
    if (css.search('disabled') > 0) {
        ...
        if (parseFloat($('#previousRecordCounter').val()) > 0 && parseFloat($('#previousRecordCounter').val()) < parseFloat($('#lastRecordCounter').val())) {
            $.ajax({
                ...
                data: {
                    method: 'read',
                    businessPartnerAccountId: $('#previousRecordCounter').val(),
                    output: 'json',
                    securityToken: securityToken,
                    leafId: leafId
                },
    ...
    if (css.search('disabled') > 0) {
        ...
        if (parseFloat($('#nextRecordCounter').val()) <= parseFloat($('#lastRecordCounter').val())) {
            $.ajax({
                ...
                data: {
                    method: 'read',
                    businessPartnerAccountId: $('#nextRecordCounter').val(),
                    output: 'json',
                    securityToken: securityToken,
                    leafId: leafId
                },
