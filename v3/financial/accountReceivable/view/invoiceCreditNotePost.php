...
$invoiceArray = array();
$_POST['from'] = 'invoiceCreditNotePost.php';
$_GET['from'] = 'invoiceCreditNotePost.php';
if (isset($_POST)) {
                                                ...
                                                if ($totalRecord > 0) {
                                                    ...
                                                    for ($i = 0; $i < $totalRecord; $i++) {
                                                        ...
                                                        ?>>
                                                            ...
                                                            <td valign="top" align="center"><?php if ($invoiceCreditNoteArray[$i]['invoiceCreditNoteCode'] != 'UNBL') { ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-3 col-sm-3 col-md-3 pull-right pagination" align="right">
                            <?php if ($leafAccess['leafAccessPostValue'] == 1) { ?>
                                <button type="button"  class="delete btn btn-warning" onclick="postGridRecordCheckbox('<?php echo $leafId; ?>', '<?php echo $invoiceCreditNote->getControllerPath(); ?>', '<?php echo $invoiceCreditNote->getViewPath(); ?>', '<?php echo $securityToken; ?>')"> <i class="glyphicon glyphicon-white glyphicon-trash"></i> </button>
                            <?php } ?>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    <div class="form-group" id="invoiceCreditNoteDescriptionForm">
                                        <label class="control-label col-xs-4 col-sm-4 col-md-4" for="invoiceCreditNoteDescription"><strong><?php echo ucfirst($leafTranslation['invoiceCreditNoteDescriptionLabel']); ?></strong></label>
                                        <div class="col-xs-8 col-sm-8 col-md-8">
                                            <textarea class="form-control" name="invoiceCreditNoteDescription" id="invoiceCreditNoteDescription">
                                                <?php
...
<?php } ?>
<script type="text/javascript" src="./v3/financial/accountReceivable/javascript/invoiceCreditNotePost.js"></script>
<hr>
<footer>
    <p>IDCMS 2012/2013</p>
</footer>