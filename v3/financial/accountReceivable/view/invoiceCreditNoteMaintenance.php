...
$invoiceArray = array();
$_POST['from'] = 'invoiceCreditNoteMaintenance.php';
$_GET['from'] = 'invoiceCreditNoteMaintenance.php';
if (isset($_POST)) {
...
if ((isset($_POST['method']) == 'new' || isset($_POST['method']) == 'read') && $_POST['type'] == 'form') {
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="panel panel-info" id="masterForm">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                        ...
                                        <div class="col-xs-8 col-sm-8 col-md-8">
                                            <div class="input-group">
                                                ...
                                                ?>
                                                       ...
                                                       ?>"
                                                       value="<?php
                                                       if (isset($documentNumberArray) && is_array($invoiceCreditNoteArray)) {
                                    ...
                                    <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 form-group" id="invoiceCreditNoteAmountForm">
                                        ...
                                        <div class="col-xs-8 col-sm-8 col-md-8">
                                            <div class="input-group">
                                                <input class="form-control" type="text" name="invoiceCreditNoteAmount" id="invoiceCreditNoteAmount" value="<?php
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    <div class="form-group" id="invoiceCreditNoteDescriptionForm">
                                        <div class="col-xs-12 col-sm-12 col-md-12">
                ...
                <table class="table table-bordered table-striped table-condensed table-hover" id="tableData">
                    ...
                    <tr>
                        ...
                        <td valign="top" align="center"><div align="center">
                                ...
                                echo $leafId;
                                ;
                                ?>', '<?php echo $invoiceCreditNoteDetail->getControllerPath(); ?>', '<?php echo $securityToken; ?>')">
                        ...
                        <td valign="top"><div class="form-group" id="invoiceCreditNoteDetailAmount9999Detail">
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <input class="form-control" <?php echo $disabledDetail; ?> type="text" name="invoiceCreditNoteDetailAmount[]" id="invoiceCreditNoteDetailAmount9999">
                                </div>
                                <span class="help-block" id="invoiceCreditNoteDetailAmount9999HelpMe"></span></div></td>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                    </tr>
                    </thead>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            validateMeAlphaNumeric('invoiceCreditNoteTitle');
    ...
    <?php if ($_POST['invoiceCreditNoteId']) { ?>
        ...
        <?php if ($leafAccess['leafAccessUpdateValue'] == 1) { ?>
                    $('#updateRecordButton1').removeClass().addClass('btn btn-info').attr('onClick', "updateRecord(<?php echo $leafId; ?>,'<?php echo $invoiceCreditNote->getControllerPath(); ?>','<?php echo $invoiceCreditNote->getViewPath(); ?>','<?php echo $securityToken; ?>',1,<?php echo $leafAccess['leafAccessDeleteValue']; ?>)");
...
<?php } ?>
<script type="text/javascript" src="./v3/financial/accountReceivable/javascript/invoiceCreditNoteMaintenance.js"></script>
<hr>
<footer>
    <p>IDCMS 2012/2013</p>
</footer>