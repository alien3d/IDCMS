...
$invoiceArray = array();
$_POST['from'] = 'invoiceDebitNoteHistory.php';
$_GET['from'] = 'invoiceDebitNoteHistory.php';
if (isset($_POST)) {
...
<?php } ?>
<script type="text/javascript" src="./v3/financial/accountReceivable/javascript/invoiceDebitNoteHistory.js"></script>
<hr>
<footer>
    <p>IDCMS 2012/2013</p>
</footer>