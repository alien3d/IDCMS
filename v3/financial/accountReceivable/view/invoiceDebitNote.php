...
$invoiceArray = array();
$_POST['from'] = 'invoiceDebitNote.php';
$_GET['from'] = 'invoiceDebitNote.php';
if (isset($_POST)) {
                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-xs-3 col-sm-3 col-md-3">
                                <div class="input-group"><input type="text" class="form-control" name="queryWidget"  id="queryWidget" value="<?php
                                    ...
                                    ?>"><span class="input-group-btn"><button name="searchString" id="searchString" value="<?php echo $t['searchButtonLabel']; ?>"
                                            class="btn btn-warning " onClick="ajaxQuerySearchAll(<?php echo $leafId; ?>, '<?php
                                            echo $invoiceDebitNote->getViewPath();
                                            ?>', '<?php echo $securityToken; ?>');"><i class="glyphicon glyphicon-zoom-in"></i></button></span>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <?php if ($leafAccess['leafAccessDeleteValue'] == 1) { ?>
                                        <button type="button"  class="btn btn-danger" onclick="deleteGridRecord('<?php echo $leafId; ?>', '<?php echo $invoiceDebitNote->getControllerPath(); ?>', '<?php echo $invoiceDebitNote->getViewPath(); ?>', '<?php echo $securityToken; ?>')" value="<?php echo $t['deleteButtonLabel']; ?>"><?php echo $t['deleteButtonLabel']; ?></button>
                                    <?php } ?>
                            ...
                            <div class="panel panel-default">
                                <table class ="table table-striped table-condensed table-hover" id="tableData">
                                    ...
                                    <tbody id="tableBody">
                                        ...
                                        if ($_POST['method'] == 'read' && $_POST['type'] == 'list' && $_POST['detail'] == 'body') {
                                                ...
                                                if ($totalRecord > 0) {
                                                    ...
                                                    for ($i = 0; $i < $totalRecord; $i++) {
                                                        ...
                                                        ?>>
                                                            ...
                                                            <td valign="top" align="center"><?php if ($invoiceDebitNoteArray[$i]['invoiceDebitNoteCode'] != 'UNBL') { ?><div class="btn-group" align="center">
                                                                        ...
                                                                        <?php } ?>
                                                                        <?php if ($leafAccess['leafAccessDeleteValue'] == 1) { ?>
                                                                            <button type="button"  class="btn btn-danger btn-sm" title="Delete" onclick="showModalDelete('<?php echo rawurlencode($invoiceDebitNoteArray [$i]['invoiceDebitNoteId']); ?>', '<?php echo rawurlencode($invoiceDebitNoteArray [$i]['businessPartnerCompany']); ?>', '<?php echo rawurlencode($invoiceDebitNoteArray [$i]['invoiceDescription']); ?>', '<?php echo rawurlencode($invoiceDebitNoteArray [$i]['invoiceDebitNoteTitle']); ?>', '<?php echo rawurlencode($invoiceDebitNoteArray [$i]['documentNumber']); ?>', '<?php echo rawurlencode($invoiceDebitNoteArray [$i]['invoiceDebitNoteAmount']); ?>', '<?php echo rawurlencode($invoiceDebitNoteArray [$i]['referenceNumber']); ?>', '<?php echo rawurlencode($invoiceDebitNoteArray [$i]['invoiceDebitNoteDate']); ?>', '<?php echo rawurlencode($invoiceDebitNoteArray [$i]['invoiceDebitNoteDescription']); ?>');"><i class="glyphicon glyphicon-trash glyphicon-white"></i></button>
                                                                        <?php } ?>
                                                                    </div><?php } ?></td>
                                                            ...
                                                            <td valign="top"><?php echo $value; ?></td>
                                                            <?php
                                                            if ($invoiceDebitNoteArray[$i]['isDelete']) {
                                                                $checked = "checked";
                                                            } else {
                                                                $checked = NULL;
                                                            }
                                                            ?>
                                                            <td valign="top"><?php if ($invoiceDebitNoteArray[$i]['invoiceDebitNoteCode'] != 'UNBL') { ?><input class="form-control" style="display:none;" type="checkbox" name="invoiceDebitNoteId[]"  value="<?php echo $invoiceDebitNoteArray[$i]['invoiceDebitNoteId']; ?>">
                                                                    <input class="form-control" <?php echo $checked; ?> type="checkbox" name="isDelete[]" value="<?php echo $invoiceDebitNoteArray[$i]['isDelete']; ?>"><?php } ?></td>
                                                        </tr>
                                                        <?php
                                                    }
                                                } else {
                                                    ?>
                                                    <tr>
                                                        <td colspan="10" valign="top" align="center"><?php $invoiceDebitNote->exceptionMessage($t['recordNotFoundLabel']); ?></td>
                                                    </tr>
                                                    <?php
                                                }
                                            } else {
                                            ...
                                            ?>
                                            <tr>
                                                <td colspan="10" valign="top" align="center"><?php $invoiceDebitNote->exceptionMessage($t['loadFailureLabel']); ?></td>
                                            </tr>
                                            <?php
                                        }
                                        ?>
                                ...
                                <div class="row" style="padding:10px">
                                    ...
                                    <div class="col-xs-3 col-sm-3 col-md-3 pull-right pagination" align="right">
                                        <?php if ($leafAccess['leafAccessDeleteValue'] == 1) { ?>
                                            <button type="button"  class="btn btn-danger" onclick="deleteGridRecordCheckbox('<?php echo $leafId; ?>', '<?php echo $invoiceDebitNote->getControllerPath(); ?>', '<?php echo $invoiceDebitNote->getViewPath(); ?>', '<?php echo $securityToken; ?>')"> <i class="glyphicon glyphicon-white glyphicon-trash"></i> </button>
                                        <?php } ?>
                                    </div>
                                </div>
                            </div>
...
if ((isset($_POST['method']) == 'new' || isset($_POST['method']) == 'read') && $_POST['type'] == 'form') {
                    ...
                    <div class="panel panel-info" id="masterForm">
                        <div class="panel-heading">
                            <div class="pull-left">
                                ...
                                <div class="btn-group"> 
                                    <button id="newRecordButton1" class="btn btn-success disabled" type="button"><i class="glyphicon glyphicon-plus glyphicon-white"></i> <?php echo $t['newButtonLabel']; ?> </button> 
                                </div>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 form-group" id="businessPartnerIdForm">
                                        ...
                                        <div class="col-xs-8 col-sm-8 col-md-8">
                                            <select name="businessPartnerId" id="businessPartnerId" class="form-control  chzn-select" onChange="getInvoice(<?php echo $leafId; ?>, '<?php echo $invoiceDebitNote->getControllerPath(); ?>', '<?php echo $securityToken; ?>');">
                                                <option value=""></option>
                                                <?php
                                                ...
                                                if (is_array($businessPartnerArray)) {
                                                    ...
                                                    if ($totalRecord > 0) {
                                                        ...
                                                        for ($i = 0; $i < $totalRecord; $i++) {
                                                            ...
                                                            ?>
                                                            <option value="<?php echo $businessPartnerArray[$i]['businessPartnerId']; ?>" <?php echo $selected; ?>><?php echo $businessPartnerArray[$i]['businessPartnerRegistrationNumber']; ?>. <?php echo $businessPartnerArray[$i]['businessPartnerCompany']; ?></option>
                                                            <?php
                                                            $d++;
                                                        }
                                                        echo "</optgroup>";
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    ...
                                    <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 form-group" id="invoiceDebitNoteAmountForm">
                                        ...
                                        <div class="col-xs-8 col-sm-8 col-md-8">
                                            <div class="input-group">
                                                <input class="form-control" type="text" name="invoiceDebitNoteAmount" id="invoiceDebitNoteAmount" value="<?php
                                                if (isset($invoiceDebitNoteArray) && is_array($invoiceDebitNoteArray)) {
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 form-group" id="invoiceCreditNoteDescriptionForm">
                                        <div class="col-xs-12 col-sm-12 col-md-12">
                                            <textarea class="form-control" name="invoiceCreditNoteDescription" id="invoiceCreditNoteDescription" placeholder="<?php echo ucfirst($leafTranslation['invoiceDebitNoteDescriptionLabel']); ?>"><?php
            ...
            <div class="modal fade" id="deletePreview" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <input type="hidden" name="invoiceDebitNoteDetailIdPreview" id="invoiceDebitNoteDetailIdPreview">
                            ...
                            <div class="form-group" id="invoiceDebitNoteDetailAmountDiv">
                                <label class="control-label col-xs-4 col-sm-4 col-md-4" for="invoiceDebitNoteDetailAmountPreview"><?php echo $leafTranslation['invoiceDebitNoteDetailAmountLabel']; ?></label>
                                <div class="col-xs-8 col-sm-8 col-md-8">
                                    <input class="form-control" type="text" name="invoiceDebitNoteDetailAmountPreview" id="invoiceDebitNoteDetailAmountPreview">
                                </div>
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button"  class="btn btn-danger" onclick="deleteGridRecordDetail('<?php echo $leafId; ?>', '<?php echo $invoiceDebitNoteDetail->getControllerPath(); ?>', '<?php echo $invoiceDebitNoteDetail->getViewPath(); ?>', '<?php echo $securityToken; ?>')" value="<?php echo $t['deleteButtonLabel']; ?>"><?php echo $t['deleteButtonLabel']; ?></button>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6" align="right">
                                    <button type="button"  class="btn btn-success" title="<?php echo $t['newButtonLabel']; ?>" onclick="showFormCreateDetail('<?php echo $leafId; ?>', '<?php echo $invoiceDebitNoteDetail->getControllerPath(); ?>', '<?php echo $securityToken; ?>');" value="<?php echo $t['newButtonLabel']; ?>">
                            ...
                            <table class="table table-bordered table-striped table-condensed table-hover" id="tableData">
                                ...
                                <tr>
                                    <?php
                                    $disabledDetail = null;
                                    if (isset($_POST['invoiceDebitNoteId']) && (strlen($_POST['invoiceDebitNoteId']) > 0)) {
                                        $disabledDetail = null;
                                    } else {
                                ...
                                <tr>
                                    ...
                                    <td valign="top" class="form-group" id="invoiceDebitNoteDetailAmount9999Detail"><input class="form-control" <?php echo $disabledDetail; ?> type="text" name="invoiceDebitNoteDetailAmount[]" id="invoiceDebitNoteDetailAmount9999"></td>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
                                </tr>
                                </thead>
                                                ...
                                                for ($j = 0; $j < $totalRecordDetail; $j++) {
                                                    ...
                                                    <tr id="<?php echo $invoiceDebitNoteDetailArray[$j]['invoiceDebitNoteDetailId']; ?>">
                                                        <td valign="top" align="center"><div class="btn-group" align="center">
                                                                <input type="hidden" name="invoiceDebitNoteDetailId[]" id="invoiceDebitNoteDetailId<?php echo $invoiceDebitNoteDetailArray[$j]['invoiceDebitNoteDetailId']; ?>" value="<?php echo $invoiceDebitNoteDetailArray[$j]['invoiceDebitNoteDetailId']; ?>">
                                                                <input type="hidden" name="invoiceDebitNoteId[]" id="invoiceDebitNoteId<?php echo $invoiceDebitNoteDetailArray[$j]['invoiceDebitNoteDetailId']; ?>" value="<?php echo $invoiceDebitNoteDetailArray[$j]['invoiceDebitNoteId']; ?>">
                                                                <button type="button"  class="btn btn-warning btn-mini" title="Edit" onclick="showFormUpdateDetail('<?php echo $leafId; ?>', '<?php echo $invoiceDebitNoteDetail->getControllerPath(); ?>', '<?php echo $securityToken; ?>', '<?php echo intval($invoiceDebitNoteDetailArray [$j]['invoiceDebitNoteDetailId']); ?>')"><i class="glyphicon glyphicon-edit glyphicon-white"></i></button>
                                                                <button type="button"  class="btn btn-danger btn-mini" title="Delete" onclick="showModalDeleteDetail('<?php echo $invoiceDebitNoteDetailArray[$j]['invoiceDebitNoteDetailId']; ?>')"><i class="glyphicon glyphicon-trash  glyphicon-white"></i></button>
                                                                <div id="miniInfoPanel<?php echo $invoiceDebitNoteDetailArray[$j]['invoiceDebitNoteDetailId']; ?>"></div>
                                                            </div></td>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            validateMeAlphaNumeric('invoiceDebitNoteTitle');

            validateMeCurrency('invoiceDebitNoteAmount');
            ...
            validateMeAlphaNumeric('invoiceDebitNoteDescription');
            validateMeNumericRange('invoiceDebitNoteDetailId');
            validateMeNumericRange('invoiceId');
            validateMeNumericRange('invoiceDebitNoteId');
            validateMeNumericRange('chartOfAccountId');
            validateMeCurrencyRange('invoiceDebitNoteDetailAmount');
    <?php if ($_POST['method'] == "new") { ?>
                $('#resetRecordButton').removeClass().addClass('btn btn-info');
        <?php if ($leafAccess['leafAccessCreateValue'] == 1) { ?>
                    $('#newRecordButton1').removeClass().addClass('btn btn-success').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $invoiceDebitNote->getControllerPath(); ?>','<?php echo $invoiceDebitNote->getViewPath(); ?>','<?php echo $securityToken; ?>',1)");
                    $('#newRecordButton2').removeClass().addClass('btn  dropdown-toggle btn-success');
                    $('#newRecordButton3').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $invoiceDebitNote->getControllerPath(); ?>','<?php echo $invoiceDebitNote->getViewPath(); ?>','<?php echo $securityToken; ?>',1)");
                    $('#newRecordButton4').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $invoiceDebitNote->getControllerPath(); ?>','<?php echo $invoiceDebitNote->getViewPath(); ?>','<?php echo $securityToken; ?>',2)");
                    $('#newRecordButton5').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $invoiceDebitNote->getControllerPath(); ?>','<?php echo $invoiceDebitNote->getViewPath(); ?>','<?php echo $securityToken; ?>',3)");
                    $('#newRecordButton6').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $invoiceDebitNote->getControllerPath(); ?>','<?php echo $invoiceDebitNote->getViewPath(); ?>','<?php echo $securityToken; ?>',4)");
                    $('#newRecordButton7').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $invoiceDebitNote->getControllerPath(); ?>','<?php echo $invoiceDebitNote->getViewPath(); ?>','<?php echo $securityToken; ?>',5)");
        <?php } else { ?>
    ...
    <?php } else if ($_POST['invoiceDebitNoteId']) { ?>
                $('#newRecordButton1').removeClass().addClass('btn btn-success disabled').attr('onClick', '');
                $('#newRecordButton2').removeClass().addClass('btn dropdown-toggle btn-success disabled');
        ...
        <?php if ($leafAccess['leafAccessUpdateValue'] == 1) { ?>
                    $('#updateRecordButton1').removeClass().addClass('btn btn-info').attr('onClick', "updateRecord(<?php echo $leafId; ?>,'<?php echo $invoiceDebitNote->getControllerPath(); ?>','<?php echo $invoiceDebitNote->getViewPath(); ?>','<?php echo $securityToken; ?>',1,<?php echo $leafAccess['leafAccessDeleteValue']; ?>)");
                    $('#updateRecordButton2').removeClass().addClass('btn dropdown-toggle btn-info');
                    $('#updateRecordButton3').attr('onClick', "updateRecord(<?php echo $leafId; ?>,'<?php echo $invoiceDebitNote->getControllerPath(); ?>','<?php echo $invoiceDebitNote->getViewPath(); ?>','<?php echo $securityToken; ?>',1,<?php echo $leafAccess['leafAccessDeleteValue']; ?>)");
                    $('#updateRecordButton4').attr('onClick', "updateRecord(<?php echo $leafId; ?>,'<?php echo $invoiceDebitNote->getControllerPath(); ?>','<?php echo $invoiceDebitNote->getViewPath(); ?>','<?php echo $securityToken; ?>',2,<?php echo $leafAccess['leafAccessDeleteValue']; ?>)");
                    $('#updateRecordButton5').attr('onClick', "updateRecord(<?php echo $leafId; ?>,'<?php echo $invoiceDebitNote->getControllerPath(); ?>','<?php echo $invoiceDebitNote->getViewPath(); ?>','<?php echo $securityToken; ?>',3,<?php echo $leafAccess['leafAccessDeleteValue']; ?>)");
        <?php } else { ?>
        ...
        <?php } ?>
        <?php if ($leafAccess['leafAccessDeleteValue'] == 1) { ?>
                    $('#deleteRecordButton').removeClass().addClass('btn btn-danger').attr('onClick', "deleteRecord(<?php echo $leafId; ?>,'<?php echo $invoiceDebitNote->getControllerPath(); ?>','<?php echo $invoiceDebitNote->getViewPath(); ?>','<?php echo $securityToken; ?>',<?php echo $leafAccess['leafAccessDeleteValue']; ?>)");
        <?php } else { ?>
                    $('#deleteRecordButton').removeClass().addClass('btn btn-danger disabled').attr('onClick', '');
        <?php } ?>
    <?php } ?>
...
<?php } ?>
<script type="text/javascript" src="./v3/financial/accountReceivable/javascript/invoiceDebitNote.js"></script>
<hr>
<footer>
    <p>IDCMS 2012/2013</p>
</footer>