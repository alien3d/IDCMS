...
$invoiceArray = array();
$_POST['from'] = 'invoiceDebitNotePost.php';
$_GET['from'] = 'invoiceDebitNotePost.php';
if (isset($_POST)) {
                    ...
                    <div align="right" class="pull-right">
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li> <a href ="javascript:void(0)" onclick="reportRequest('<?php echo $leafId; ?>', '<?php echo $invoiceDebitNote->getControllerPath(); ?>', '<?php echo $securityToken; ?>', 'html')"> <i class ="pull-right glyphicon glyphicon-download"></i>Html </a> </li>
                            </ul>
                        </div>
                    </div>
                </div>
                                        ...
                                        if ($_POST['method'] == 'read' && $_POST['type'] == 'list' && $_POST['detail'] == 'body') {
                                            ...
                                            if (is_array($invoiceDebitNoteArray)) {
                                                ...
                                                if ($totalRecord > 0) {
                                                    ...
                                                    ?>
                                                    <tr>
                                                        <td colspan="11" valign="top" align="center"><?php $invoiceDebitNote->exceptionMessage($t['recordNotFoundLabel']); ?></td>
                                                    </tr>
                                                    <?php
                                                }
                                            } else {
                                            ...
                                            ?>
                                            <tr>
                                                <td colspan="11" valign="top" align="center"><?php $invoiceDebitNote->exceptionMessage($t['loadFailureLabel']); ?></td>
                                            </tr>
                                            <?php
                                        }
                                        ?>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 form-group" id="invoiceDebitNoteAmountForm">
                                        ...
                                        <div class="col-xs-8 col-sm-8 col-md-8">
                                            <div class="input-group">
                                                <input class="form-control" type="text" name="invoiceDebitNoteAmount" id="invoiceDebitNoteAmount"  readonly  value="<?php
                                                if (isset($invoiceDebitNoteArray) && is_array($invoiceDebitNoteArray)) {
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    ...
                                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 form-group" id="invoiceDebitNoteDescriptionForm">
                                        ...
                                        <div class="col-xs-8 col-sm-8 col-md-8">
                                            <textarea class="form-control" name="invoiceDebitNoteDescription" id="invoiceDebitNoteDescription"  readonly>
                                                <?php
...
<?php } ?>
<script type="text/javascript" src="./v3/financial/accountReceivable/javascript/invoiceDebitNotePost.js"></script>
<hr>
<footer>
    <p>IDCMS 2012/2013</p>
</footer>