...
$invoiceArray = array();
$_POST['from'] = 'invoiceDebitNoteMaintenance.php';
$_GET['from'] = 'invoiceDebitNoteMaintenance.php';
if (isset($_POST)) {
                ...
                <div id="rightViewport" class="col-xs-12 col-sm-12 col-md-12">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="panel panel-default">
                                <table class ="table table-bordered table-striped table-condensed table-hover smart-form has-tickbox" id="tableData">
                                    <thead>
                                        <tr>                                        <th width="25px" align="center"><div align="center">#</div></th>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-3 col-sm-3 col-md-3 pull-right pagination" align="right">
                            <?php if ($leafAccess['leafAccessDeleteValue'] == 1) { ?>
                                <button type="button"  class="delete btn btn-warning" onclick="deleteGridRecordCheckbox('<?php echo $leafId; ?>', '<?php echo $invoiceDebitNote->getControllerPath(); ?>', '<?php echo $invoiceDebitNote->getViewPath(); ?>', '<?php echo $securityToken; ?>')"> <i class="glyphicon glyphicon-white glyphicon-trash"></i> </button>
                            <?php } ?>
                        </div>
                    </div>
                    <script type="text/javascript">
...
if ((isset($_POST['method']) == 'new' || isset($_POST['method']) == 'read') && $_POST['type'] == 'form') {
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    ...
                                    <div class="form-group" id="invoiceDebitNoteDescriptionForm">
                                        <label class="control-label col-xs-4 col-sm-4 col-md-4" for="invoiceDebitNoteDescription"><strong><?php echo ucfirst($leafTranslation['invoiceDebitNoteDescriptionLabel']); ?></strong></label>
                                        <div class="col-xs-8 col-sm-8 col-md-8">
                                            <textarea class="form-control" name="invoiceDebitNoteDescription" id="invoiceDebitNoteDescription">
                                                <?php
        ...
        <div class="row">
            ...
            <div class="col-xs-6 col-sm-6 col-md-6" align="right">
                <button type="button"  class="btn btn-success" title="<?php echo $t['newButtonLabel']; ?>"
                        ...
                        ;
                        ?>', '<?php
                        echo $invoiceDebitNoteDetail->getControllerPath();
                        ?>', '<?php echo $securityToken; ?>');" value="<?php echo $t['newButtonLabel']; ?>">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <table class="table table-bordered table-striped table-condensed table-hover" id="tableData">
                    ...
                    <tr>
                        ...
                        <td valign="top"><div class="form-group" id="invoiceDebitNoteDetailAmount9999Detail">
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <input class="form-control" <?php echo $disabledDetail; ?> type="text" name="invoiceDebitNoteDetailAmount[]" id="invoiceDebitNoteDetailAmount9999">
                                </div>
                                <span class="help-block" id="invoiceDebitNoteDetailAmount9999HelpMe"></span></div></td>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                    </tr>
                    </thead>
    ...
    <?php if ($_POST['invoiceDebitNoteId']) { ?>
        ...
        <?php if ($leafAccess['leafAccessUpdateValue'] == 1) { ?>
                    $('#updateRecordButton1').removeClass().addClass('btn btn-info').addClass('btn dropdown-toggle btn-info').attr('onClick', "updateRecord(<?php echo $leafId; ?>,'<?php echo $invoiceDebitNote->getControllerPath(); ?>','<?php echo $invoiceDebitNote->getViewPath(); ?>','<?php echo $securityToken; ?>',1,<?php echo $leafAccess['leafAccessDeleteValue']; ?>)");
                    ;
...
<?php } ?>
<script type="text/javascript" src="./v3/financial/accountReceivable/javascript/invoiceDebitNoteMaintenance.js"></script>
<hr>
<footer>
    <p>IDCMS 2012/2013</p>
</footer>