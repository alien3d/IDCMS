...
$invoiceArray = array();
$_POST['from'] = 'invoiceCreditNoteVoid.php';
$_GET['from'] = 'invoiceCreditNoteVoid.php';
if (isset($_POST)) {
                                    ...
                                    <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 form-group" id="documentNumberForm">
                                        ...
                                        <div class="col-xs-8 col-sm-8 col-md-8">
                                            <div class="input-group">
                                                <input type="text" name="documentNumber" id="documentNumber" disabled
...
<?php } ?>
<script type="text/javascript" src="./v3/financial/accountReceivable/javascript/invoiceCreditNoteVoid.js"></script>
<hr>
<footer>
    <p>IDCMS 2012/2013</p>
</footer>