...
function checkDuplicate(leafId, page, securityToken) {
    var $invoiceCreditNoteCode = $("#invoiceCreditNoteCode");
    if ($invoiceCreditNoteCode.val().length === 0) {
    ...
    $.ajax({
        ...
        url: page,
        data: {
            invoiceCreditNoteCode: $invoiceCreditNoteCode.val(),
            method: 'duplicate',
            securityToken: securityToken,
            leafId: leafId,
            from: 'invoiceCreditNote.php'
        ...
        success: function(data) {
            ...
            if (success === true) {
                if (total !== 0) {
                    $("#invoiceCreditNoteCode").val('').focus();
                    $("#invoiceCreditNoteCodeForm").removeClass().addClass("form-group has-error");
                ...
                $("#invoiceCreditNoteForm").removeClass().addClass("form-group has-error");
            }
            if ($infoPanel.is(':hidden')) {
                $infoPanel.show();
            }
...
function showFormUpdate(leafId, url, urlList, securityToken, invoiceCreditNoteId, updateAccess, deleteAccess) {
    sleep(500);
...
function showModalDelete(invoiceCreditNoteId, businessPartnerId, invoiceId, invoiceCreditNoteTitle, documentNumber, invoiceCreditNoteAmount, referenceNumber, invoiceCreditNoteDate, invoiceCreditNoteDescription) {
    $('#invoiceCreditNoteIdPreview').val('').val(decodeURIComponent(invoiceCreditNoteId));
    ...
    $('#invoiceCreditNoteAmountPreview').val('').val(decodeURIComponent(invoiceCreditNoteAmount));
    $('#referenceNumberPreview').val('').val(decodeURIComponent(referenceNumber));
    $('#invoiceCreditNoteDatePreview').val('').val(decodeURIComponent(invoiceCreditNoteDate));
    $('#invoiceCreditNoteDescriptionPreview').val('').val(decodeURIComponent(invoiceCreditNoteDescription));
...
function deleteGridRecord(leafId, url, urlList, securityToken) {
    $.ajax({
        ...
        data: {
            method: 'delete',
            output: 'json',
            invoiceCreditNoteId: $('#invoiceCreditNoteIdPreview').val(),
            securityToken: securityToken,
            leafId: leafId,
            from: 'invoiceCreditNote.php'
        },
...
function showFormCreateDetail(leafId, url, securityToken) {
    ...
    if ($('#invoiceCreditNoteDetailAmount9999').val().length === 0) {
        $infoPanel.html('').empty().html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['invoiceCreditNoteDetailAmountLabel'] + "</span>");
        $('#invoiceCreditNoteDetailAmount9999HelpMe').html('').empty().html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['invoiceCreditNoteDetailAmountLabel'] + "</span>");
        $('#invoiceCreditNoteDetailAmount9999Form').removeClass().addClass('form-group has-error');
        $('#invoiceCreditNoteDetailAmount9999').focus();
        return false;
    }
    ...
    $.ajax({
        ...
        data: {
            method: 'create',
            output: 'json',
            invoiceCreditNoteId: $('#invoiceCreditNoteId').val(),
            invoiceId: $('#invoiceId').val(),
            chartOfAccountId: $('#chartOfAccountId9999').val(),
            businessPartnerId: $('#businessPartnerId').val(),
            invoiceCreditNoteDetailAmount: $('#invoiceCreditNoteDetailAmount9999').val(),
            securityToken: securityToken,
            leafId: leafId,
            from: 'invoiceCreditNote.php'
        },
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (success === true) {
                            ...
                            $("#invoiceCreditNoteDetailAmount9999").prop("disabled", "false").removeAttr("disabled", "").val('');
                            $(".chzn-select").chosen();
                            $infoPanel.html('').empty().html("<span class='label label-success'>&nbsp;<img src='" + smileyLol + "'> " + decodeURIComponent(t['loadingCompleteTextLabel']) + "</span>").delay(1000).fadeOut();
                            if ($infoPanel.is(':hidden')) {
                                $infoPanel.show();
...
function showFormUpdateDetail(leafId, url, securityToken, invoiceCreditNoteDetailId) {
    var $infoPanel = $('#infoPanel');

    if ($('#chartOfAccountId' + invoiceCreditNoteDetailId).val().length === 0) {
        ...
        $('#chartOfAccountId' + invoiceCreditNoteDetailId + 'HelpMe').html('').empty().html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + ' :' + leafTranslation['chartOfAccountIdLabel'] + "</span>");
        $('#chartOfAccountId' + invoiceCreditNoteDetailId).removeClass().addClass('form-group has-error');
        $('#chartOfAccountId' + invoiceCreditNoteDetailId).focus();
        return false;
    }
    if ($('#invoiceCreditNoteDetailAmount' + invoiceCreditNoteDetailId).val().length === 0) {
        $infoPanel.html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + ' :' + leafTranslation['invoiceCreditNoteDetailAmountLabel'] + "</span>");
        $('#invoiceCreditNoteDetailAmount' + invoiceCreditNoteDetailId + 'HelpMe').html('').empty().html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + ' :' + leafTranslation['invoiceCreditNoteDetailAmountLabel'] + "</span>");
        $('#invoiceCreditNoteDetailAmount' + invoiceCreditNoteDetailId).removeClass().addClass('form-group has-error');
        $('#invoiceCreditNoteDetailAmount' + invoiceCreditNoteDetailId).focus();
        return false;
    }
    $.ajax({
        type: 'POST',
        ...
        data: {
            method: 'save',
            output: 'json',
            invoiceCreditNoteDetailId: $('#invoiceCreditNoteDetailId' + invoiceCreditNoteDetailId).val(),
            invoiceId: $('#invoiceId').val(),
            invoiceCreditNoteId: $('#invoiceCreditNoteId').val(),
            chartOfAccountId: $('#chartOfAccountId' + invoiceCreditNoteDetailId).val(),
            businessPartnerId: $('#businessPartnerId').val(),
            invoiceCreditNoteDetailAmount: $('#invoiceCreditNoteDetailAmount' + invoiceCreditNoteDetailId).val(),
            securityToken: securityToken,
            leafId: leafId,
            from: 'invoiceCreditNote.php'
        },
        beforeSend: function() {
            ...
            var $infoPanel = $('#infoPanel');
            $infoPanel.html('').empty().html("<span class='label label-warning'>&nbsp;<img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
            $('#miniInfoPanel' + invoiceCreditNoteDetailId).html('').empty().html("<span class='label label-warning'> <img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
            if ($infoPanel.is(':hidden')) {
                $infoPanel.show();
            }
        },
        success: function(data) {
            var $infoPanel = $('#infoPanel');
            var $miniInfoPanel = $('#miniInfoPanel' + invoiceCreditNoteDetailId);
            var smileyLol = './images/icons/smiley-lol.png';
            var success = data.success;
            var message = data.message;
            if (success === true) {
...
function showModalDeleteDetail(invoiceCreditNoteDetailId) {
    $('#invoiceCreditNoteDetailIdPreview').val('').val(decodeURIComponent($("#invoiceCreditNoteDetailId" + invoiceCreditNoteDetailId).val()));
    $('#invoiceIdPreview').val('').val(decodeURIComponent($("#invoiceId" + invoiceCreditNoteDetailId + " option:selected").text()));
    $('#chartOfAccountIdPreview').val('').val(decodeURIComponent($("#chartOfAccountId" + invoiceCreditNoteDetailId + " option:selected").text()));
    $('#businessPartnerIdPreview').val('').val(decodeURIComponent($("#businessPartnerId" + invoiceCreditNoteDetailId + " option:selected").text()));
    $('#documentNumberPreview').val('').val(decodeURIComponent($("#documentNumber" + invoiceCreditNoteDetailId).val()));
    $('#journalNumberPreview').val('').val(decodeURIComponent($("#journalNumber" + invoiceCreditNoteDetailId).val()));
    $('#invoiceCreditNoteDetailAmountPreview').val('').val(decodeURIComponent($("#invoiceCreditNoteDetailAmount" + invoiceCreditNoteDetailId).val()));
...
function deleteGridRecordDetail(leafId, url, urlList, securityToken) {
    $.ajax({
        ...
        data: {
            method: 'delete',
            output: 'json',
            invoiceCreditNoteDetailId: $('#invoiceCreditNoteDetailIdPreview').val(),
            securityToken: securityToken,
            leafId: leafId,
            from: 'invoiceCreditNote.php'
        },
        ...
        success: function(data) {
            ...
            if (success === true) {
                ...
                removeMeTr($('#invoiceCreditNoteDetailIdPreview').val());
            } else if (success === false) {
                $infoPanel.html('').empty().html("<span class='label label-danger'> " + message + "</span>");
                if ($infoPanel.is(':hidden')) {
                    $infoPanel.show();
...
function deleteGridRecordCheckbox(leafId, url, urlList, securityToken) {
    var stringText = '';
    var counter = 0;
    $('input:checkbox[name="invoiceCreditNoteId[]"]').each(function() {
        stringText = stringText + "&invoiceCreditNoteId[]=" + $(this).val();
    });
...
function newRecord(leafId, url, urlList, securityToken, type, createAccess, updateAccess, deleteAccess) {
    ...
    var $invoiceCreditNoteAmount = $('#invoiceCreditNoteAmount');
    var $referenceNumber = $('#referenceNumber');
    var $invoiceCreditNoteDate = $('#invoiceCreditNoteDate');
    var $invoiceCreditNoteDescription = $('#invoiceCreditNoteDescription');
    if (css.search('disabled') > 0) {
        return false;
    } else {
        ...
        if ($invoiceCreditNoteAmount.val().length === 0) {
            $('#invoiceCreditNoteAmountHelpMe').html('').empty().html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['invoiceCreditNoteAmountLabel'] + " </span>");
            $('#invoiceCreditNoteAmountForm').removeClass().addClass('form-group has-error');
            $invoiceCreditNoteAmount.focus();
            return false;
        }
        if ($invoiceCreditNoteDate.val().length === 0) {
            $('#invoiceCreditNoteDateHelpMe').html('').empty().html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['invoiceCreditNoteDateLabel'] + " </span>");
            $('#invoiceCreditNoteDateForm').removeClass().addClass('form-group has-error');
            $invoiceCreditNoteDate.focus();
            return false;
        }
        $.ajax({
            type: 'POST',
            ...
            data: {
                ...
                businessPartnerId: $businessPartnerId.val(),
                invoiceId: $invoiceId.val(),
                invoiceCreditNoteAmount: $invoiceCreditNoteAmount.val(),
                referenceNumber: $referenceNumber.val(),
                invoiceCreditNoteDate: $invoiceCreditNoteDate.val(),
                invoiceCreditNoteDescription: $invoiceCreditNoteDescription.val(),
                securityToken: securityToken,
                leafId: leafId,
                from: 'invoiceCreditNote.php'
            },
            ...
            success: function(data) {
                ...
                if (success === true) {
                    ...
                    $('#invoiceCreditNoteId').val(data.invoiceCreditNoteId);
                    $('#newRecordButton1').removeClass().addClass('btn btn-success disabled');
                    if (updateAccess === 1) {
                        $('#updateRecordButton1').removeClass().addClass('btn btn-info');
                        $('#updateRecordButton2').removeClass().addClass('btn dropdown-toggle btn-info');
...
function updateRecord(leafId, url, urlList, securityToken, type, deleteAccess) {
    ...
    var $invoiceCreditNoteId = $('#invoiceCreditNoteId');
    var $businessPartnerId = $('#businessPartnerId');
    var $invoiceId = $('#invoiceId');
    var $invoiceCreditNoteAmount = $('#invoiceCreditNoteAmount');
    var $referenceNumber = $('#referenceNumber');
        ...
        if (type === 1) {
            ...
            $.ajax({
                ...
                data: {
                    ...
                    businessPartnerId: $businessPartnerId.val(),
                    invoiceId: $invoiceId.val(),
                    invoiceCreditNoteTitle: $invoiceCreditNoteTitle.val(),
                    invoiceCreditNoteAmount: $invoiceCreditNoteAmount.val(),
                    referenceNumber: $referenceNumber.val(),
                    invoiceCreditNoteDate: $invoiceCreditNoteDate.val(),
                    invoiceCreditNoteDescription: $invoiceCreditNoteDescription.val(),
    ...
    if (css.search('disabled') > 0) {
        ...
        if (deleteAccess === 1) {
            if (confirm(decodeURIComponent(t['deleteRecordMessageLabel']))) {
                var value = $invoiceCreditNoteId.val();
                if (!value) {
...
function resetRecord(leafId, url, urlList, urlInvoiceCreditNoteDetail, securityToken, createAccess, updateAccess, deleteAccess) {
    var $infoPanel = $('#infoPanel');
    ...
    $('#firstRecordButton').removeClass().addClass('btn btn-default').attr('onClick', "firstRecord(" + leafId + ",'" + url + "','" + urlList + "','" + urlInvoiceCreditNoteDetail + "','" + securityToken + "'," + updateAccess + "," + deleteAccess + ")");
    ...
    $('#endRecordButton').removeClass().addClass('btn btn-default').attr('onClick', "endRecord(" + leafId + ",'" + url + "','" + urlList + "','" + urlInvoiceCreditNoteDetail + "','" + securityToken + "'," + updateAccess + ")");
    $("#invoiceCreditNoteId").val('');
    $("#invoiceCreditNoteIdHelpMe").empty().html('');
    ...
    $("#invoiceCreditNoteAmount").val('');
    $("#invoiceCreditNoteAmountHelpMe").empty().html('');
    $("#referenceNumber").val('');
    $("#referenceNumberHelpMe").empty().html('');
    $("#invoiceCreditNoteDate").val('');
    $("#invoiceCreditNoteDateHelpMe").empty().html('');
    $("#invoiceCreditNoteDescription").val('');
    $("#invoiceCreditNoteDescriptionHelpMe").empty().html('');
    $("#chartOfAccountId9999").prop("disabled", "true").attr("disabled", "disabled").val('').trigger("chosen:updated");
    $("#invoiceCreditNoteDetailAmount9999").prop("disabled", "true").attr("disabled", "disabled").val('');
...
function firstRecord(leafId, url, urlList, urlInvoiceCreditNoteDetail, securityToken, updateAccess, deleteAccess) {
            ...
            success: function(data) {
                ...
                if (success === true) {
                    $.ajax({
                        ...
                        data: {
                            method: 'read',
                            invoiceCreditNoteId: firstRecord,
                            output: 'json',
                            securityToken: securityToken,
                            leafId: leafId,
                            from: 'invoiceCreditNote.php'
                        ...
                        success: function(data) {
                            ...
                            if (success === true) {
                                $('#invoiceCreditNoteId').val(data.data.invoiceCreditNoteId);
                                ...
                                $('#invoiceCreditNoteAmount').val(data.data.invoiceCreditNoteAmount);
                                $('#referenceNumber').val(data.data.referenceNumber);
                                x = data.data.invoiceCreditNoteDate;
                                x = x.split("-");
                                output = x[2] + "-" + x[1] + "-" + x[0];
                                output = output.toString();
                                $('#invoiceCreditNoteDate').val(output);
                                $('#invoiceCreditNoteDescription').val(data.data.invoiceCreditNoteDescription);
                                $("#chartOfAccountId9999").prop("disabled", "false").removeAttr("disabled", "").val('').trigger("chosen:updated");
                                $("#invoiceCreditNoteDetailAmount9999").prop("disabled", "false").removeAttr("disabled", "").val('');
                                $.ajax({
                                    type: 'POST',
                                    url: urlInvoiceCreditNoteDetail,
                                    data: {
                                        method: 'read',
                                        invoiceCreditNoteId: data.firstRecord,
                                        output: 'table',
                                        securityToken: securityToken,
                                        leafId: leafId,
                                        from: 'invoiceCreditNote.php'
                                ...
                                if (nextRecord > 0) {
                                    $('#previousRecordButton').removeClass().addClass('btn btn-default disabled').attr('onClick', '');
                                    $('#nextRecordButton').removeClass().addClass('btn btn-default').attr('onClick', '').attr('onClick', "nextRecord(" + leafId + ",'" + url + "','" + urlList + "','" + urlInvoiceCreditNoteDetail + "','" + securityToken + "'," + updateAccess + "," + deleteAccess + ")");
...
function endRecord(leafId, url, urlList, urlInvoiceCreditNoteDetail, securityToken, updateAccess, deleteAccess) {
    var $infoPanel = $('#infoPanel');
            ...
            success: function(data) {
                ...
                if (success === true) {
                    $.ajax({
                        ...
                        data: {
                            method: 'read',
                            invoiceCreditNoteId: lastRecord,
                            output: 'json',
                            securityToken: securityToken,
                            leafId: leafId,
                            from: 'invoiceCreditNote.php'
                        ...
                        success: function(data) {
                            ...
                            if (success === true) {
                                ...
                                if (lastRecord !== 0) {
                                    $('#previousRecordButton').removeClass().addClass('btn btn-default').attr('onClick', "previousRecord(" + leafId + ",'" + url + "','" + urlList + "','" + urlInvoiceCreditNoteDetail + "','" + securityToken + "'," + updateAccess + "," + deleteAccess + ")");
                                    $('#nextRecordButton').removeClass().addClass('btn btn-default disabled').attr('onClick', '');
                                    $('#firstRecordCounter').val(firstRecord);
                                    $('#previousRecordCounter').val(previousRecord);
                                    $('#nextRecordCounter').val(nextRecord);
...
function previousRecord(leafId, url, urlList, urlInvoiceCreditNoteDetail, securityToken, updateAccess, deleteAccess) {
    ...
    if (css.search('disabled') > 0) {
        ...
        if (parseFloat($previousRecordCounter.val()) > 0 && parseFloat($previousRecordCounter.val()) < parseFloat($('#lastRecordCounter').val())) {
            $.ajax({
                ...
                data: {
                    method: 'read',
                    invoiceCreditNoteId: $previousRecordCounter.val(),
                    output: 'json',
                    securityToken: securityToken,
                    leafId: leafId,
                    from: 'invoiceCreditNote.php'
...
function nextRecord(leafId, url, urlList, urlInvoiceCreditNoteDetail, securityToken, updateAccess, deleteAccess) {
    var $infoPanel = $('#infoPanel');
    ...
    if (css.search('disabled') > 0) {
        ...
        if (parseFloat($nextRecordCounter.val()) <= parseFloat($('#lastRecordCounter').val())) {
            $.ajax({
                ...
                data: {
                    method: 'read',
                    invoiceCreditNoteId: $nextRecordCounter.val(),
                    output: 'json',
                    securityToken: securityToken,
                    leafId: leafId,
                    from: 'invoiceCreditNote.php'
