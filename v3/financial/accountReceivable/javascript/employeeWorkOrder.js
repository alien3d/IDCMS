...
function getShift(leafId, url, securityToken) {
    $.ajax({type: 'GET', url: url, data: {offset: 0, limit: 99999, method: 'read', type: 'filter', securityToken: securityToken, leafId: leafId, filter: 'shift'}, beforeSend: function() {
            var smileyRoll = './images/icons/smiley-roll.png';
            var $infoPanel = $('#infoPanel');
            $infoPanel.html('').empty().html("<span class='label label-warning'><img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
            if ($infoPanel.is(':hidden')) {
            ...
            if (success === false) {
                ...
                $("#shiftId").html('').empty().html(data.data).trigger("chosen:updated");
                $infoPanel.html('').empty().html("<span class='label label-success'>&nbsp;<img src='" + smileyLol + "'>  " + decodeURIComponent(t['loadingCompleteTextLabel']) + "</span>").delay(5000).fadeOut();
            }
        }, error: function(xhr) {
            var smileyRollSweat = './images/icons/smiley-roll-sweat.png';
...
function getInvoiceProject(leafId, url, securityToken) {
    $.ajax({type: 'GET', url: url, data: {offset: 0, limit: 99999, method: 'read', type: 'filter', securityToken: securityToken, leafId: leafId, filter: 'invoiceProject'}, beforeSend: function() {
            var smileyRoll = './images/icons/smiley-roll.png';
            var $infoPanel = $('#infoPanel');
            $infoPanel.html('').empty().html("<span class='label label-warning'><img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
            if ($infoPanel.is(':hidden')) {
            ...
            if (success === false) {
                ...
                $("#invoiceProjectId").html('').empty().html(data.data).trigger("chosen:updated");
                $infoPanel.html('').empty().html("<span class='label label-success'>&nbsp;<img src='" + smileyLol + "'>  " + decodeURIComponent(t['loadingCompleteTextLabel']) + "</span>").delay(5000).fadeOut();
            }
        }, error: function(xhr) {
            var smileyRollSweat = './images/icons/smiley-roll-sweat.png';
...
function getMilestone(leafId, url, securityToken) {
    $.ajax({type: 'GET', url: url, data: {offset: 0, limit: 99999, method: 'read', type: 'filter', securityToken: securityToken, leafId: leafId, filter: 'milestone'}, beforeSend: function() {
            var smileyRoll = './images/icons/smiley-roll.png';
            var $infoPanel = $('#infoPanel');
            $infoPanel.html('').empty().html("<span class='label label-warning'><img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
            if ($infoPanel.is(':hidden')) {
            ...
            if (success === false) {
                ...
                $("#milestoneId").html('').empty().html(data.data).trigger("chosen:updated");
                $infoPanel.html('').empty().html("<span class='label label-success'>&nbsp;<img src='" + smileyLol + "'>  " + decodeURIComponent(t['loadingCompleteTextLabel']) + "</span>").delay(5000).fadeOut();
            }
        }, error: function(xhr) {
            var smileyRollSweat = './images/icons/smiley-roll-sweat.png';
...
function checkDuplicate(leafId, page, securityToken) {
    ...
    $.ajax({type: 'GET', url: page, data: {employeeWorkOrderCode: $employeeWorkOrderCode.val(), method: 'duplicate', securityToken: securityToken, leafId: leafId}, beforeSend: function() {
            var smileyRoll = './images/icons/smiley-roll.png';
            var $infoPanel = $('#infoPanel');
            $infoPanel.html('').empty().html("<span class='label label-warning'><img src='" + smileyRoll + "'>&nbsp;" + decodeURIComponent(t['loadingTextLabel']) + "....</span>");
            if ($infoPanel.is(':hidden')) {
            ...
            if (success === true) {
                if (total !== 0) {
                    $("#employeeWorkOrderCode").val('').focus();
                    $("#employeeWorkOrderCodeForm").removeClass().addClass("form-group has-error");
                ...
                $("#employeeWorkOrderForm").removeClass().addClass("form-group has-error");
            }
            if ($infoPanel.is(':hidden')) {
                $infoPanel.show();
            }
...
function showFormUpdate(leafId, url, urlList, securityToken, employeeWorkOrderId, updateAccess, deleteAccess) {
    ...
    $.ajax({type: 'POST', url: urlList, data: {method: 'read', type: 'form', employeeWorkOrderId: employeeWorkOrderId, securityToken: securityToken, leafId: leafId}, beforeSend: function() {
            var smileyRoll = './images/icons/smiley-roll.png';
            var $infoPanel = $('#infoPanel');
            $infoPanel.html('').empty().html("<span class='label label-warning'><img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
            if ($infoPanel.is(':hidden')) {
...
function showModalDelete(employeeWorkOrderId, employeeId, shiftId, invoiceProjectId, invoiceId, milestoneId, branchId, locationId, employeeWorkOrderColorId, documentNumber, employeeWorkOrderDate, employeeWorkOrderStartDate, employeeWorkOrderEndDate, employeeWorkOrderDueDate, employeeWorkOrderRate, employeeWorkOrderDescription, isClientViewable, isAllDayEvent, isComplete) {
    ...
    $('#employeeWorkOrderColorIdPreview').val('').val(decodeURIComponent(employeeWorkOrderColorId));
...
function deleteGridRecord(leafId, url, urlList, securityToken) {
    $.ajax({type: 'POST', url: url, data: {method: 'delete', output: 'json', employeeWorkOrderId: $('#employeeWorkOrderIdPreview').val(), securityToken: securityToken, leafId: leafId}, beforeSend: function() {
            var smileyRoll = './images/icons/smiley-roll.png';
            var $infoPanel = $('#infoPanel');
            $infoPanel.html('').empty().html("<span class='label label-warning'><img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
            if ($infoPanel.is(':hidden')) {
...
function newRecord(leafId, url, urlList, securityToken, type, createAccess, updateAccess, deleteAccess) {
    ...
    var $employeeWorkOrderColorId = $('#employeeWorkOrderColorId');
    ...
    if (css.search('disabled') > 0) {
        ...
        if (type === 1) {
            ...
            if ($shiftId.val().length === 0) {
                $('#shiftIdHelpMe').html('').empty().html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['shiftIdLabel'] + " </span>");
                $shiftId.data('chosen').activate_action();
                return false;
            }
            if ($invoiceProjectId.val().length === 0) {
                $('#invoiceProjectIdHelpMe').html('').empty().html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['invoiceProjectIdLabel'] + " </span>");
            ...
            if ($milestoneId.val().length === 0) {
                $('#milestoneIdHelpMe').html('').empty().html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['milestoneIdLabel'] + " </span>");
                $milestoneId.data('chosen').activate_action();
                return false;
            }
            if ($branchId.val().length === 0) {
                $('#branchIdHelpMe').html('').empty().html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['branchIdLabel'] + " </span>");
                $branchId.data('chosen').activate_action();
                return false;
            }
            if ($locationId.val().length === 0) {
                $('#locationIdHelpMe').html('').empty().html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['locationIdLabel'] + " </span>");
                $locationId.data('chosen').activate_action();
                return false;
            }
            if ($employeeWorkOrderColorId.val().length === 0) {
                $('#employeeWorkOrderColorIdHelpMe').html('').empty().html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['employeeWorkOrderColorIdLabel'] + " </span>");
                $('#employeeWorkOrderColorIdForm').removeClass().addClass('form-group has-error');
                $employeeWorkOrderColorId.focus();
                return false;
            }
            if ($employeeWorkOrderDate.val().length === 0) {
                $('#employeeWorkOrderDateHelpMe').html('').empty().html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['employeeWorkOrderDateLabel'] + " </span>");
            ...
            if ($employeeWorkOrderStartDate.val().length === 0) {
                $('#employeeWorkOrderStartDateHelpMe').html('').empty().html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['employeeWorkOrderStartDateLabel'] + " </span>");
            ...
            if ($employeeWorkOrderEndDate.val().length === 0) {
                $('#employeeWorkOrderEndDateHelpMe').html('').empty().html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['employeeWorkOrderEndDateLabel'] + " </span>");
            ...
            if ($employeeWorkOrderDueDate.val().length === 0) {
                $('#employeeWorkOrderDueDateHelpMe').html('').empty().html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['employeeWorkOrderDueDateLabel'] + " </span>");
            ...
            if ($employeeWorkOrderRate.val().length === 0) {
                $('#employeeWorkOrderRateHelpMe').html('').empty().html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['employeeWorkOrderRateLabel'] + " </span>");
            ...
            if ($employeeWorkOrderDescription.val().length === 0) {
                $('#employeeWorkOrderDescriptionHelpMe').html('').empty().html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['employeeWorkOrderDescriptionLabel'] + " </span>");
            ...
            if ($isClientViewable.val().length === 0) {
                $('#isClientViewableHelpMe').html('').empty().html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['isClientViewableLabel'] + " </span>");
                $('#isClientViewableForm').removeClass().addClass('form-group has-error');
                $isClientViewable.focus();
                return false;
            }
            if ($isAllDayEvent.val().length === 0) {
                $('#isAllDayEventHelpMe').html('').empty().html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['isAllDayEventLabel'] + " </span>");
                $('#isAllDayEventForm').removeClass().addClass('form-group has-error');
                $isAllDayEvent.focus();
                return false;
            }
            if ($isComplete.val().length === 0) {
                $('#isCompleteHelpMe').html('').empty().html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['isCompleteLabel'] + " </span>");
                $('#isCompleteForm').removeClass().addClass('form-group has-error');
                $isComplete.focus();
                return false;
            }
            $.ajax({type: 'POST', url: url, data: {method: 'create', output: 'json', employeeId: $employeeId.val(), shiftId: $shiftId.val(), invoiceProjectId: $invoiceProjectId.val(), invoiceId: $invoiceId.val(), milestoneId: $milestoneId.val(), branchId: $branchId.val(), locationId: $locationId.val(), employeeWorkOrderColorId: $employeeWorkOrderColorId.val(), employeeWorkOrderDate: $employeeWorkOrderDate.val(), employeeWorkOrderStartDate: $employeeWorkOrderStartDate.val(), employeeWorkOrderEndDate: $employeeWorkOrderEndDate.val(), employeeWorkOrderDueDate: $employeeWorkOrderDueDate.val(), employeeWorkOrderRate: $employeeWorkOrderRate.val(), employeeWorkOrderDescription: $employeeWorkOrderDescription.val(), isClientViewable: $isClientViewable.val(), isAllDayEvent: $isAllDayEvent.val(), isComplete: $isComplete.val(), securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                    var smileyRoll = './images/icons/smiley-roll.png';
                    var $infoPanel = $('#infoPanel');
                    $infoPanel.html('').empty().html("<span class='label label-warning'>&nbsp;<img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
                    if ($infoPanel.is(':hidden')) {
                    ...
                    if (success === true) {
                        ...
                        $employeeWorkOrderColorId.val('');
                        $('#employeeWorkOrderColorIdHelpMe').html('').empty();
                        $("documentNumber").val('');
                        $('#documentNumberHelpMe').html('').empty();
                        $employeeWorkOrderDate.val('');
                        $('#employeeWorkOrderDateHelpMe').html('').empty();
                        $employeeWorkOrderStartDate.val('');
                        $('#employeeWorkOrderStartDateHelpMe').html('').empty();
                        $employeeWorkOrderEndDate.val('');
                        $('#employeeWorkOrderEndDateHelpMe').html('').empty();
                        $employeeWorkOrderDueDate.val('');
                        $('#employeeWorkOrderDueDateHelpMe').html('').empty();
                        $employeeWorkOrderRate.val('');
                        $('#employeeWorkOrderRateHelpMe').html('').empty();
                        $employeeWorkOrderDescription.val('');
                        $('#employeeWorkOrderDescriptionHelpMe').html('').empty();
                        $isClientViewable.val('');
                        $('#isClientViewableHelpMe').html('').empty();
                        $isAllDayEvent.val('');
                        $('#isAllDayEventHelpMe').html('').empty();
                        $isComplete.val('');
                        $('#isCompleteHelpMe').html('').empty();
                    } else if (success === false) {
                        $infoPanel.html('').empty().html("<span class='label label-danger'>&nbsp;" + message + "</span>");
                        if ($infoPanel.is(':hidden')) {
                            $infoPanel.show();
...
function updateRecord(leafId, url, urlList, securityToken, type, deleteAccess) {
    ...
    if (css.search('disabled') > 0) {
        ...
        if (type === 1) {
            ...
            $infoPanel.html('').empty();
            $.ajax({type: 'POST', url: url, data: {method: 'save', output: 'json', employeeWorkOrderId: $employeeWorkOrderId.val(), employeeId: $employeeId.val(), shiftId: $shiftId.val(), invoiceProjectId: $invoiceProjectId.val(), invoiceId: $invoiceId.val(), milestoneId: $milestoneId.val(), branchId: $branchId.val(), locationId: $locationId.val(), employeeWorkOrderColorId: $employeeWorkOrderColorId.val(), employeeWorkOrderDate: $employeeWorkOrderDate.val(), employeeWorkOrderStartDate: $employeeWorkOrderStartDate.val(), employeeWorkOrderEndDate: $employeeWorkOrderEndDate.val(), employeeWorkOrderDueDate: $employeeWorkOrderDueDate.val(), employeeWorkOrderRate: $employeeWorkOrderRate.val(), employeeWorkOrderDescription: $employeeWorkOrderDescription.val(), isClientViewable: $isClientViewable.val(), isAllDayEvent: $isAllDayEvent.val(), isComplete: $isComplete.val(), securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                    var smileyRoll = './images/icons/smiley-roll.png';
                    var $infoPanel = $('#infoPanel');
                    $infoPanel.html('').empty().html("<span class='label label-warning'>&nbsp;<img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
                    if ($infoPanel.is(':hidden')) {
        ...
        if (deleteAccess === 1) {
            if (confirm(decodeURIComponent(t['deleteRecordMessageLabel']))) {
                ...
                if (!value) {
                    ...
                    $.ajax({type: 'POST', url: url, data: {method: 'delete', output: 'json', employeeWorkOrderId: $employeeWorkOrderId.val(), securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                            var smileyRoll = './images/icons/smiley-roll.png';
                            var $infoPanel = $('#infoPanel');
                            $infoPanel.html('').empty().html("<span class='label label-warning'>&nbsp;<img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
                            if ($infoPanel.is(':hidden')) {
...
function resetRecord(leafId, url, urlList, securityToken, createAccess, updateAccess, deleteAccess) {
    ...
    $("#employeeWorkOrderIdHelpMe").empty().html('');

    $("#employeeId").val('');
    $("#employeeIdHelpMe").empty().html('');
    $('#employeeId').trigger("chosen:updated");
    $("#shiftId").val('');
    $("#shiftIdHelpMe").empty().html('');
    $('#shiftId').trigger("chosen:updated");
    $("#invoiceProjectId").val('');
    ...
    $('#locationId').trigger("chosen:updated");
    $("#employeeWorkOrderColorId").val('');
    $("#employeeWorkOrderColorIdHelpMe").empty().html('');
    $("#documentNumber").val('');
    $("#documentNumberHelpMe").empty().html('');
    $("#employeeWorkOrderDate").val('');
    $("#employeeWorkOrderDateHelpMe").empty().html('');
    $("#employeeWorkOrderStartDate").val('');
    $("#employeeWorkOrderStartDateHelpMe").empty().html('');
    $("#employeeWorkOrderEndDate").val('');
    $("#employeeWorkOrderEndDateHelpMe").empty().html('');
    $("#employeeWorkOrderDueDate").val('');
    $("#employeeWorkOrderDueDateHelpMe").empty().html('');
    $("#employeeWorkOrderRate").val('');
    $("#employeeWorkOrderRateHelpMe").empty().html('');
    $("#employeeWorkOrderDescription").val('');
    $("#employeeWorkOrderDescriptionHelpMe").empty().html('');
    $("#isClientViewable").val('');
    $("#isClientViewableHelpMe").empty().html('');
    $("#isAllDayEvent").val('');
    $("#isAllDayEventHelpMe").empty().html('');
    $("#isComplete").val('');
    $("#isCompleteHelpMe").empty().html('');
}
function postRecord() {
...
function firstRecord(leafId, url, urlList, securityToken, updateAccess, deleteAccess) {
    ...
    if (css.search('disabled') > 0) {
        ...
        $.ajax({type: 'GET', url: url, data: {method: 'dataNavigationRequest', dataNavigation: 'firstRecord', output: 'json', securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                ...
                if (success === true) {
                    $.ajax({type: 'POST', url: url, data: {method: 'read', employeeWorkOrderId: firstRecord, output: 'json', securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                            var smileyRoll = './images/icons/smiley-roll.png';
                            $infoPanel.html('').empty().html("<span class='label label-warning'>&nbsp;<img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
                            if ($infoPanel.is(':hidden')) {
                                $infoPanel.show();
                            ...
                            if (success === true) {
                                ...
                                $('#employeeWorkOrderColorId').val(data.data.employeeWorkOrderColorId);
...
function endRecord(leafId, url, urlList, securityToken, updateAccess, deleteAccess) {
    ...
    if (css.search('disabled') > 0) {
        ...
        $.ajax({type: 'GET', url: url, data: {method: 'dataNavigationRequest', dataNavigation: 'lastRecord', output: 'json', securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                ...
                if (success === true) {
                    $.ajax({type: 'POST', url: url, data: {method: 'read', employeeWorkOrderId: lastRecord, output: 'json', securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                            var smileyRoll = './images/icons/smiley-roll.png';
                            $infoPanel.html('').empty().html("<span class='label label-warning'>&nbsp;<img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
                            if ($infoPanel.is(':hidden')) {
                                $infoPanel.show();
...
function previousRecord(leafId, url, urlList, securityToken, updateAccess, deleteAccess) {
    ...
    if (css.search('disabled') > 0) {
        ...
        if (parseFloat($previousRecordCounter.val()) > 0 && parseFloat($previousRecordCounter.val()) < parseFloat($('#lastRecordCounter').val())) {
            $.ajax({type: 'POST', url: url, data: {method: 'read', employeeWorkOrderId: $previousRecordCounter.val(), output: 'json', securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                    var smileyRoll = './images/icons/smiley-roll.png';
                    var $infoPanel = $('#infoPanel');
                    $infoPanel.html('').empty().html("<span class='label label-warning'>&nbsp;<img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
                    if ($infoPanel.is(':hidden')) {
...
function nextRecord(leafId, url, urlList, securityToken, updateAccess, deleteAccess) {
    ...
    if (css.search('disabled') > 0) {
        ...
        if (parseFloat($nextRecordCounter.val()) <= parseFloat($('#lastRecordCounter').val())) {
            $.ajax({type: 'POST', url: url, data: {method: 'read', employeeWorkOrderId: $nextRecordCounter.val(), output: 'json', securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                    var smileyRoll = './images/icons/smiley-roll.png';
                    var $infoPanel = $('#infoPanel');
                    $infoPanel.html('').empty().html("<span class='label label-warning'>&nbsp;<img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
                    if ($infoPanel.is(':hidden')) {
