function getBusinessPartner(leafId, url, securityToken) {
    $.ajax({
        ...
        data: {
            ...
            from: 'invoiceDebitNoteMaintenance.php'
        },
        beforeSend: function() {
    ...
    if (css.search('disabled') > 0) {
        ...
        if (type === 1) {
            ...
            if ($invoiceDebitNoteAmount.val().length === 0) {
                ...
                $('#invoiceDebitNoteAmountForm').removeClass().addClass('col-xs-4 col-sm-4 col-md-4 col-lg-4 form-group has-error');
            ...
            if ($invoiceDebitNoteDate.val().length === 0) {
                ...
                $('#invoiceDebitNoteDateForm').removeClass().addClass('col-xs-4 col-sm-4 col-md-4 col-lg-4 form-group has-error');
