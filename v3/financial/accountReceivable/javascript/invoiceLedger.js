...
function checkDuplicate(leafId, page, securityToken) {
    var $invoiceLedgerCode = $("#invoiceLedgerCode");
    if ($invoiceLedgerCode.val().length === 0) {
    ...
    $.ajax({
        ...
        url: page,
        data: {
            invoiceLedgerCode: $invoiceLedgerCode.val(),
            method: 'duplicate',
            securityToken: securityToken,
            leafId: leafId
        },
...
function showFormUpdate(leafId, url, urlList, securityToken, invoiceLedgerId, updateAccess, deleteAccess) {
    sleep(500);
...
function showModalDelete(invoiceLedgerId, businessPartnerId, chartOfAccountId, invoiceProjectId, invoiceId, invoiceDebitNoteId, invoiceCreditNoteId, collectionId, documentNumber, invoiceLedgerDate, invoiceDueDate, invoiceLedgerAmount, invoiceLedgerDescription, leafId, leafName) {
    // clear first old record if exist
    $('#invoiceLedgerIdPreview').val('').val(decodeURIComponent(invoiceLedgerId));
    ...
    $('#invoiceLedgerDatePreview').val('').val(decodeURIComponent(invoiceLedgerDate));
    $('#invoiceDueDatePreview').val('').val(decodeURIComponent(invoiceDueDate));
    $('#invoiceLedgerAmountPreview').val('').val(decodeURIComponent(invoiceLedgerAmount));
    $('#invoiceLedgerDescriptionPreview').val('').val(decodeURIComponent(invoiceLedgerDescription));
...
function deleteGridRecord(leafId, url, urlList, securityToken) {
    $.ajax({
        ...
        data: {
            method: 'delete',
            output: 'json',
            invoiceLedgerId: $('#invoiceLedgerIdPreview').val(),
            securityToken: securityToken,
            leafId: leafId
        },
        beforeSend: function() {
...
function deleteGridRecordCheckbox(leafId, url, urlList, securityToken) {
    var stringText = '';
    var counter = 0;
    $('input:checkbox[name="invoiceLedgerId[]"]').each(function() {
        stringText = stringText + "&invoiceLedgerId[]=" + $(this).val();
    });
...
function newRecord(leafId, url, urlList, securityToken, type, createAccess, updateAccess, deleteAccess) {
    ...
    var $invoiceLedgerDate = $('#invoiceLedgerDate');
    var $invoiceDueDate = $('#invoiceDueDate');
    var $invoiceLedgerAmount = $('#invoiceLedgerAmount');
    var $invoiceLedgerDescription = $('#invoiceLedgerDescription');
    var $leafId = $('#leafId');
    var $leafName = $('#leafName');
    if (css.search('disabled') > 0) {
        return false;
    } else {
        if (type === 1) {
            ...
            if ($invoiceProjectId.val().length === 0) {
                ...
                $('#invoiceProjectIdForm')
                        .removeClass().addClass('form-group has-error');
                $invoiceProjectId.focus();
                return false;
            }
            if ($invoiceId.val().length === 0) {
                $('#invoiceIdHelpMe')
                        .html('').empty()
                        .html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['invoiceIdLabel'] + " </span>");
                $('#invoiceIdForm')
                        .removeClass().addClass('form-group has-error');
                $invoiceId.focus();
                return false;
            }
            if ($invoiceDebitNoteId.val().length === 0) {
                $('#invoiceDebitNoteIdHelpMe')
                        .html('').empty()
                        .html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['invoiceDebitNoteIdLabel'] + " </span>");
                $('#invoiceDebitNoteIdForm')
                        .removeClass().addClass('form-group has-error');
                $invoiceDebitNoteId.focus();
                return false;
            }
            if ($invoiceCreditNoteId.val().length === 0) {
                $('#invoiceCreditNoteIdHelpMe')
                        .html('').empty()
                        .html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['invoiceCreditNoteIdLabel'] + " </span>");
                $('#invoiceCreditNoteIdForm')
                        .removeClass().addClass('form-group has-error');
                $invoiceCreditNoteId.focus();
                return false;
            }
            ...
            if ($invoiceLedgerDate.val().length === 0) {
                $('#invoiceLedgerDateHelpMe')
                        .html('').empty()
                        .html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['invoiceLedgerDateLabel'] + " </span>");
                $('#invoiceLedgerDateForm')
                        .removeClass().addClass('form-group has-error');
                $invoiceLedgerDate.focus();
                return false;
            }
            ...
            if ($invoiceLedgerAmount.val().length === 0) {
                $('#invoiceLedgerAmountHelpMe')
                        .html('').empty()
                        .html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['invoiceLedgerAmountLabel'] + " </span>");
                $('#invoiceLedgerAmountForm')
                        .removeClass().addClass('form-group has-error');
                $invoiceLedgerAmount.focus();
                return false;
            }
            if ($invoiceLedgerDescription.val().length === 0) {
                $('#invoiceLedgerDescriptionHelpMe')
                        .html('').empty()
                        .html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['invoiceLedgerDescriptionLabel'] + " </span>");
                $('#invoiceLedgerDescriptionForm')
                        .removeClass().addClass('form-group has-error');
                $invoiceLedgerDescription.focus();
                return false;
            }
            ...
            if ($leafName.val().length === 0) {
                $('#leafNameHelpMe')
                        .html('').empty()
                        .html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['leafNameLabel'] + " </span>");
                $('#leafNameForm')
                        .removeClass().addClass('form-group has-error');
                $leafName.focus();
                return false;
            ...
            $.ajax({
                ...
                data: {
                    ...
                    invoiceLedgerDate: $invoiceLedgerDate.val(),
                    invoiceDueDate: $invoiceDueDate.val(),
                    invoiceLedgerAmount: $invoiceLedgerAmount.val(),
                    invoiceLedgerDescription: $invoiceLedgerDescription.val(),
                    leafId: $leafId.val(),
                ...
                success: function(data) {
                    ...
                    if (success === true) {
                        ...
                        $invoiceDebitNoteId.trigger("chosen:updated");
                        $('#invoiceDebitNoteIdHelpMe')
                                .html('').empty();
                        $invoiceCreditNoteId.val('');
                        $invoiceCreditNoteId.trigger("chosen:updated");
                        $('#invoiceCreditNoteIdHelpMe')
                                .html('').empty();
                        $collectionId.val('');
                        ...
                        $('#documentNumberHelpMe')
                                .html('').empty();
                        $invoiceLedgerDate.val('');
                        $('#invoiceLedgerDateHelpMe')
                                .html('').empty();
                        $invoiceDueDate.val('');
                        $('#invoiceDueDateHelpMe')
                                .html('').empty();
                        $invoiceLedgerAmount.val('');
                        $('#invoiceLedgerAmountHelpMe')
                                .html('').empty();
                        $invoiceLedgerDescription.val('');
                        $('#invoiceLedgerDescriptionHelpMe')
                                .html('').empty();
                        $leafId.val('');
                        $('#leafIdHelpMe')
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (success === true) {
                        ...
                        $('#invoiceLedgerId').val(data.invoiceLedgerId);
...
function updateRecord(leafId, url, urlList, securityToken, type, deleteAccess) {
    ...
    var $invoiceLedgerId = $('#invoiceLedgerId');
    var $businessPartnerId = $('#businessPartnerId');
    var $chartOfAccountId = $('#chartOfAccountId');
    var $invoiceProjectId = $('#invoiceProjectId');
    var $invoiceId = $('#invoiceId');
        ...
        if (type === 1) {
            ...
            $.ajax({
                ...
                data: {
                    method: 'save',
                    output: 'json',
                    invoiceLedgerId: $invoiceLedgerId.val(),
                    businessPartnerId: $businessPartnerId.val(),
                    chartOfAccountId: $chartOfAccountId.val(),
                    invoiceProjectId: $invoiceProjectId.val(),
                    invoiceId: $invoiceId.val(),
            ...
            if ($invoiceProjectId.val().length === 0) {
                $('#invoiceProjectIdHelpMe')
                        .html('').empty()
                        .html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['invoiceProjectIdLabel'] + " </span>");
                $('#invoiceProjectIdForm').removeClass().addClass('form-group has-error');
                $invoiceProjectId.focus();
                return false;
            }
            if ($invoiceId.val().length === 0) {
                $('#invoiceIdHelpMe')
                        .html('').empty()
                        .html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['invoiceIdLabel'] + " </span>");
                $('#invoiceIdForm').removeClass().addClass('form-group has-error');
                $invoiceId.focus();
                return false;
            }
            if ($invoiceDebitNoteId.val().length === 0) {
                $('#invoiceDebitNoteIdHelpMe')
                        .html('').empty()
                        .html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['invoiceDebitNoteIdLabel'] + " </span>");
                $('#invoiceDebitNoteIdForm').removeClass().addClass('form-group has-error');
                $invoiceDebitNoteId.focus();
                return false;
            }
            if ($invoiceCreditNoteId.val().length === 0) {
                $('#invoiceCreditNoteIdHelpMe')
                        .html('').empty()
                        .html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['invoiceCreditNoteIdLabel'] + " </span>");
                $('#invoiceCreditNoteIdForm').removeClass().addClass('form-group has-error');
                $invoiceCreditNoteId.focus();
                return false;
            }
            if ($collectionId.val().length === 0) {
            ...
            if ($invoiceLedgerDate.val().length === 0) {
                $('#invoiceLedgerDateHelpMe')
                        .html('').empty()
                        .html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['invoiceLedgerDateLabel'] + " </span>");
                $('#invoiceLedgerDateForm').removeClass().addClass('form-group has-error');
                $invoiceLedgerDate.focus();
                return false;
            }
            if ($invoiceDueDate.val().length === 0) {
            ...
            if ($invoiceLedgerAmount.val().length === 0) {
                $('#invoiceLedgerAmountHelpMe')
                        .html('').empty()
                        .html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['invoiceLedgerAmountLabel'] + " </span>");
                $('#invoiceLedgerAmountForm').removeClass().addClass('form-group has-error');
                $invoiceLedgerAmount.focus();
                return false;
            }
            if ($invoiceLedgerDescription.val().length === 0) {
                $('#invoiceLedgerDescriptionHelpMe')
                        .html('').empty()
                        .html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['invoiceLedgerDescriptionLabel'] + " </span>");
                $('#invoiceLedgerDescriptionForm').removeClass().addClass('form-group has-error');
                $invoiceLedgerDescription.focus();
                return false;
            }
            if ($leafId.val().length === 0) {
            ...
            if ($leafName.val().length === 0) {
                $('#leafNameHelpMe')
                        .html('').empty()
                        .html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['leafNameLabel'] + " </span>");
                $('#leafNameForm').removeClass().addClass('form-group has-error');
                $leafName.focus();
                return false;
            }
            if ($infoPanel.is(':hidden')) {
                ...
                if (success === true) {
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            if (success === true) {
                                $('#invoiceLedgerId').val(data.data.invoiceLedgerId);
                                ...
                                $('#invoiceDebitNoteId').val(data.data.invoiceDebitNoteId).trigger("chosen:updated");
                                $('#invoiceCreditNoteId').val(data.data.invoiceCreditNoteId).trigger("chosen:updated");
                                $('#collectionId').val(data.data.collectionId).trigger("chosen:updated");
                                $('#documentNumber').val(data.data.documentNumber);
                                x = data.data.invoiceLedgerDate;
                                x = x.split("-");
                                output = x[2] + "-" + x[1] + "-" + x[0];
                                output = output.toString();
                                $('#invoiceLedgerDate').val(output);
                                x = data.data.invoiceDueDate;
                                x = x.split("-");
                                output = x[2] + "-" + x[1] + "-" + x[0];
                                output = output.toString();
                                $('#invoiceDueDate').val(output);
                                $('#invoiceLedgerAmount').val(data.data.invoiceLedgerAmount);
                                $('#invoiceLedgerDescription').val(data.data.invoiceLedgerDescription);
                                $('#leafId').val(data.data.leafId);
                                $('#leafName').val(data.data.leafName);
                                if (nextRecord > 0) {
                                    $('#previousRecordButton')
                                            .removeClass().addClass('btn btn-default disabled')
                                            .attr('onClick', '');
    ...
    if (css.search('disabled') > 0) {
        ...
        if (parseFloat($previousRecordCounter.val()) > 0 && parseFloat($previousRecordCounter.val()) < parseFloat($('#lastRecordCounter').val())) {
            $.ajax({
                ...
                data: {
                    method: 'read',
                    invoiceLedgerId: $previousRecordCounter.val(),
                    output: 'json',
                    securityToken: securityToken,
                    leafId: leafId
                },
    ...
    if (css.search('disabled') > 0) {
        ...
        if (parseFloat($nextRecordCounter.val()) <= parseFloat($('#lastRecordCounter').val())) {
            $.ajax({
                ...
                data: {
                    method: 'read',
                    invoiceLedgerId: $nextRecordCounter.val(),
                    output: 'json',
                    securityToken: securityToken,
                    leafId: leafId
                },
