function getBusinessPartner(leafId, url, securityToken) {
    $.ajax({
        ...
        data: {
            ...
            from: 'invoiceCreditNoteMaintenance.php'
        },
        beforeSend: function() {
    ...
    if (css.search('disabled') > 0) {
        ...
        if (type === 1) {
            ...
            if ($invoiceCreditNoteAmount.val().length === 0) {
                ...
                $('#invoiceCreditNoteAmountForm').removeClass().addClass('col-xs-4 col-sm-4 col-md-4 col-lg-4 form-group has-error');
            ...
            if ($invoiceCreditNoteDate.val().length === 0) {
                ...
                $('#invoiceCreditNoteDateForm').removeClass().addClass('col-xs-4 col-sm-4 col-md-4 col-lg-4 form-group has-error');
