function checkDuplicate(leafId, page, securityToken) {
    if ($("#lateInterestTypeCode").val().length == 0) {
        alert(t['oddTextLabel']);
        return false;
    }
    $.ajax({type: 'GET', url: page, data: {lateInterestTypeCode: $("#lateInterestTypeCode").val(), method: 'duplicate', securityToken: securityToken, leafId: leafId}, beforeSend: function() {
            $('#infoPanel').empty();
            $('#infoPanel').html('');
            ...
            if (data.success == true) {
                if (data.total != 0) {
                    $("#lateInterestTypeCode").empty();
                    $("#lateInterestTypeCode").val('');
                    $("#lateInterestTypeCode").focus();
                    $("#lateInterestTypeCodeForm").removeClass();
                    $("#lateInterestTypeCodeForm").addClass("col-md-12 form-group has-error");
                    $('#infoPanel').empty();
                    $('#infoPanel').html('');
                ...
                $("#lateInterestTypeForm").removeClass();
                $("#lateInterestTypeForm").addClass("col-md-12 form-group has-error");
            }
        }, error: function(xhr) {
            $('#infoError').empty();
            $('#infoError').html('');
...
function showFormUpdate(leafId, url, urlList, securityToken, lateInterestTypeId, updateAccess, deleteAccess) {
    sleep(500);
    $.ajax({type: 'POST', url: urlList, data: {method: 'read', type: 'form', lateInterestTypeId: lateInterestTypeId, securityToken: securityToken, leafId: leafId}, beforeSend: function() {
            $('#infoPanel').empty();
            $('#infoPanel').html("<span class='label label-warning'><img src='./images/icons/smiley-roll.png'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
            if ($('#infoPanel').is(':hidden')) {
                $('#infoPanel').show();
...
function showModalDelete(lateInterestTypeId, lateInterestTypeCode, lateInterestTypeDescription) {
    $('#lateInterestTypeIdPreview').val('');
    $('#lateInterestTypeIdPreview').val(decodeURIComponent(lateInterestTypeId));
    $('#lateInterestTypeCodePreview').val('');
    $('#lateInterestTypeCodePreview').val(decodeURIComponent(lateInterestTypeCode));
    $('#lateInterestTypeDescriptionPreview').val('');
    $('#lateInterestTypeDescriptionPreview').val(decodeURIComponent(lateInterestTypeDescription));
    showMeModal('deletePreview', 1);
}
function deleteGridRecord(leafId, url, urlList, securityToken) {
    $.ajax({type: 'POST', url: url, data: {method: 'delete', output: 'json', lateInterestTypeId: $('#lateInterestTypeIdPreview').val(), securityToken: securityToken, leafId: leafId}, beforeSend: function() {
            $('#infoPanel').empty();
            $('#infoPanel').html('');
            $('#infoPanel').html("<span class='label label-warning'><img src='./images/icons/smiley-roll.png'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
            if ($('#infoPanel').is(':hidden')) {
...
function deleteGridRecordCheckbox(leafId, url, urlList, securityToken) {
    var stringText = '';
    var counter = 0;
    $('input:checkbox[name="lateInterestTypeId[]"]').each(function() {
        stringText = stringText + "&lateInterestTypeId[]=" + $(this).val();
    });
...
function newRecord(leafId, url, urlList, securityToken, type, createAccess, updateAccess, deleteAccess) {
    ...
    if (css.search('disabled') > 0) {
        ...
        if (type == 1) {
            if ($('#lateInterestTypeCode').val().length == 0) {
                $('#lateInterestTypeCodeHelpMe').empty();
                $('#lateInterestTypeCodeHelpMe').html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['lateInterestTypeCodeLabel'] + " </span>");
                $('#lateInterestTypeCodeForm').addClass('form-group has-error');
                $('#lateInterestTypeCode').focus();
                return false;
            }
            if ($('#lateInterestTypeDescription').val().length == 0) {
                $('#lateInterestTypeDescriptionHelpMe').empty();
                $('#lateInterestTypeDescriptionHelpMe').html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['lateInterestTypeDescriptionLabel'] + " </span>");
                $('#lateInterestTypeDescriptionForm').addClass('form-group has-error');
                $('#lateInterestTypeDescription').focus();
                return false;
            }
            $.ajax({type: 'POST', url: url, data: {method: 'create', output: 'json', lateInterestTypeCode: $('#lateInterestTypeCode').val(), lateInterestTypeDescription: $('#lateInterestTypeDescription').val(), securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                    $('#infoPanel').empty();
                    $('#infoPanel').html('');
                    $('#infoPanel').html("<span class='label label-warning'>&nbsp;<img src='./images/icons/smiley-roll.png'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
                    if ($('#infoPanel').is(':hidden')) {
                    ...
                    if (data.success == true) {
                        ...
                        $('#lateInterestTypeCode').val('');
                        $('#lateInterestTypeCodeHelpMe').empty();
                        $('#lateInterestTypeCodeHelpMe').html('');
                        $('#lateInterestTypeDescription').val('');
                        $('#lateInterestTypeDescriptionForm').removeClass().addClass('col-md-12 form-group');
                        $('#lateInterestTypeDescription').val('');
                        $('#lateInterestTypeDescriptionHelpMe').empty();
                        $('#lateInterestTypeDescriptionHelpMe').html('');
                    } else if (data.success == false) {
                        $('#infoPanel').empty();
                        $('#infoPanel').html("<span class='label label-danger'>&nbsp;" + data.message + "</span>");
                        if ($('#infoPanel').is(':hidden')) {
            ...
            $.ajax({type: 'POST', url: url, data: {method: 'create', output: 'json', lateInterestTypeCode: $('#lateInterestTypeCode').val(), lateInterestTypeDescription: $('#lateInterestTypeDescription').val(), securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                    ...
                    if (data.success == true) {
                        ...
                        $('#lateInterestTypeId').val(data.lateInterestTypeId);
                        $('#newRecordButton1').removeClass();
                        $('#newRecordButton2').removeClass();
                        $('#newRecordButton3').removeClass();
                        $('#newRecordButton4').removeClass();
...
function updateRecord(leafId, url, urlList, securityToken, type, deleteAccess) {
    ...
    if (css.search('disabled') > 0) {
        ...
        if (type == 1) {
            ...
            $('#infoPanel').empty();
            $('#infoPanel').html('');
            $.ajax({type: 'POST', url: url, data: {method: 'save', output: 'json', lateInterestTypeId: $('#lateInterestTypeId').val(), lateInterestTypeCode: $('#lateInterestTypeCode').val(), lateInterestTypeDescription: $('#lateInterestTypeDescription').val(), securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                    $('#infoPanel').empty();
                    $('#infoPanel').html('');
                    $('#infoPanel').html("<span class='label label-warning'>&nbsp;<img src='./images/icons/smiley-roll.png'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
                    if ($('#infoPanel').is(':hidden')) {
    ...
    if (css.search('disabled') > 0) {
        ...
        if (deleteAccess == 1) {
            if (confirm(decodeURIComponent(t['deleteRecordMessageLabel']))) {
                var value = $('#lateInterestTypeId').val();
                if (!value) {
                    $('#infoPanel').empty();
                    $('#infoPanel').html('');
                    ...
                    $.ajax({type: 'POST', url: url, data: {method: 'delete', output: 'json', lateInterestTypeId: $('#lateInterestTypeId').val(), securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                            $('#infoPanel').empty();
                            $('#infoPanel').html('');
                            $('#infoPanel').html("<span class='label label-warning'>&nbsp;<img src='./images/icons/smiley-roll.png'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
                            if ($('#infoPanel').is(':hidden')) {
...
function resetRecord(leafId, url, urlList, securityToken, createAccess, updateAccess, deleteAccess) {
    ...
    $("#lateInterestTypeCode").val('');
    $("#lateInterestTypeDescription").val('');
    $('#lateInterestTypeDescription').empty();
    $('#lateInterestTypeDescription').val('');
    $(".chzn-select").chosen();
}
...
function firstRecord(leafId, url, urlList, securityToken, updateAccess, deleteAccess) {
    ...
    if (css.search('disabled') > 0) {
        ...
        $.ajax({type: 'GET', url: url, data: {method: 'dataNavigationRequest', dataNavigation: 'firstRecord', output: 'json', securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                ...
                if (data.success == true) {
                    $.ajax({type: 'POST', url: url, data: {method: 'read', lateInterestTypeId: data.firstRecord, output: 'json', securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                            $('#infoPanel').empty();
                            $('#infoPanel').html('');
                            $('#infoPanel').html("<span class='label label-warning'>&nbsp;<img src='./images/icons/smiley-roll.png'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
                            if ($('#infoPanel').is(':hidden')) {
                            ...
                            if (data.success == true) {
                                ...
                                $('#lateInterestTypeCode').val(data.data.lateInterestTypeCode);
                                $('#lateInterestTypeCode').val(data.data.lateInterestTypeCode);
                                $('#lateInterestTypeDescription').val(data.data.lateInterestTypeDescription);
                                $('#lateInterestTypeDescription').val(data.data.lateInterestTypeDescription);
...
function endRecord(leafId, url, urlList, securityToken, updateAccess, deleteAccess) {
    ...
    if (css.search('disabled') > 0) {
        ...
        $.ajax({type: 'GET', url: url, data: {method: 'dataNavigationRequest', dataNavigation: 'lastRecord', output: 'json', securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                ...
                if (data.success == true) {
                    $.ajax({type: 'POST', url: url, data: {method: 'read', lateInterestTypeId: data.lastRecord, output: 'json', securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                            $('#infoPanel').empty();
                            $('#infoPanel').html('');
                            $('#infoPanel').html("<span class='label label-warning'>&nbsp;<img src='./images/icons/smiley-roll.png'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
                            if ($('#infoPanel').is(':hidden')) {
...
function previousRecord(leafId, url, urlList, securityToken, updateAccess, deleteAccess) {
    ...
    if (css.search('disabled') > 0) {
        ...
        if (parseFloat($('#previousRecordCounter').val()) > 0 && parseFloat($('#previousRecordCounter').val()) < parseFloat($('#lastRecordCounter').val())) {
            $.ajax({type: 'POST', url: url, data: {method: 'read', lateInterestTypeId: $('#previousRecordCounter').val(), output: 'json', securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                    $('#infoPanel').empty();
                    $('#infoPanel').html('');
                    $('#infoPanel').html("<span class='label label-warning'>&nbsp;<img src='./images/icons/smiley-roll.png'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
                    if ($('#infoPanel').is(':hidden')) {
...
function nextRecord(leafId, url, urlList, securityToken, updateAccess, deleteAccess) {
    ...
    if (css.search('disabled') > 0) {
        ...
        if (parseFloat($('#nextRecordCounter').val()) <= parseFloat($('#lastRecordCounter').val())) {
            $.ajax({type: 'POST', url: url, data: {method: 'read', lateInterestTypeId: $('#nextRecordCounter').val(), output: 'json', securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                    $('#infoPanel').empty();
                    $('#infoPanel').html('');
                    $('#infoPanel').html("<span class='label label-warning'>&nbsp;<img src='./images/icons/smiley-roll.png'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
                    if ($('#infoPanel').is(':hidden')) {
