...
namespace Core\Financial\Inventory\ProductResourcesBillOfMaterial\Service;
...
/**
 * Class ProductResourcesBillOfMaterialService
 * Contain extra processing function / method.
 * @name IDCMS 
 * @version 2 
 * @author hafizan 
 * @package Core\Financial\Inventory\ProductResourcesBillOfMaterial\Service
 * @subpackage Inventory 
 * @link http://www.hafizan.com 
 * @license http://www.gnu.org/copyleft/lesser.html LGPL 
 */
class ProductResourcesBillOfMaterialService extends ConfigClass {
    ...
    public function getProductResources() {
        ...
        if ($this->getVendor() == self::MYSQL) {
         ...
         SELECT      PRODUCTRESOURCESID AS \"productResourcesId\",
                     PRODUCTRESOURCESTASK AS \"productResourcesTask\"
         FROM        PRODUCTRESOURCES  
         WHERE       ISACTIVE    =   1
         AND         COMPANYID   =   '" . $this->getCompanyId() . "'
         ORDER BY    ISDEFAULT";
