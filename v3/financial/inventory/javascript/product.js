...
function checkDuplicate(leafId, page, securityToken) {
    ...
    $.ajax({type: 'GET', url: page, data: {productCode: $productCode.val(), method: 'duplicate', securityToken: securityToken, leafId: leafId}, beforeSend: function() {
            var smileyRoll = './images/icons/smiley-roll.png';
            var $infoPanel = $('#infoPanel');
            $infoPanel.html('').empty().html("<span class='label label-warning'><img src='" + smileyRoll + "'>&nbsp;" + decodeURIComponent(t['loadingTextLabel']) + "....</span>");
            if ($infoPanel.is(':hidden')) {
            ...
            if (success === true) {
                if (total !== 0) {
                    ...
                    $("#productCodeForm").removeClass().addClass("form-group has-error");
                ...
                $("#productForm").removeClass().addClass("form-group has-error");
            }
            if ($infoPanel.is(':hidden')) {
                $infoPanel.show();
            }
...
function showFormUpdate(leafId, url, urlList, securityToken, productId, updateAccess, deleteAccess) {
    sleep(500);
    $('a[rel=tooltip]').tooltip('hide');
    $.ajax({type: 'POST', url: urlList, data: {method: 'read', type: 'form', productId: productId, securityToken: securityToken, leafId: leafId}, beforeSend: function() {
            var smileyRoll = './images/icons/smiley-roll.png';
            var $infoPanel = $('#infoPanel');
            $infoPanel.html('').empty().html("<span class='label label-warning'><img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
            if ($infoPanel.is(':hidden')) {
...
function showModalDelete(productId, itemCategoryId, itemTypeId, countryId, productName, productCode, productBarcode, productSerialNumber, productModel, productSellingPrice, productCostPrice, productPicture, productDescription) {
    ...
    $('#productNamePreview').val('').val(decodeURIComponent(productName));
    $('#productCodePreview').val('').val(decodeURIComponent(productCode));
    $('#productBarcodePreview').val('').val(decodeURIComponent(productBarcode));
    $('#productSerialNumberPreview').val('').val(decodeURIComponent(productSerialNumber));
    $('#productModelPreview').val('').val(decodeURIComponent(productModel));
    $('#productSellingPricePreview').val('').val(decodeURIComponent(productSellingPrice));
    $('#productCostPricePreview').val('').val(decodeURIComponent(productCostPrice));
    $('#productPicturePreview').val('').val(decodeURIComponent(productPicture));
    $('#productDescriptionPreview').val('').val(decodeURIComponent(productDescription));
    showMeModal('deletePreview', 1);
}
function deleteGridRecord(leafId, url, urlList, securityToken) {
    $.ajax({type: 'POST', url: url, data: {method: 'delete', output: 'json', productId: $('#productIdPreview').val(), securityToken: securityToken, leafId: leafId}, beforeSend: function() {
            var smileyRoll = './images/icons/smiley-roll.png';
            var $infoPanel = $('#infoPanel');
            $infoPanel.html('').empty().html("<span class='label label-warning'><img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
            if ($infoPanel.is(':hidden')) {
...
function deleteGridRecordCheckbox(leafId, url, urlList, securityToken) {
    ...
    $('input:checkbox[name="productId[]"]').each(function() {
        stringText = stringText + "&productId[]=" + $(this).val();
    });
    ...
    if (css.search('disabled') > 0) {
        ...
        if (type === 1) {
            ...
            if ($productName.val().length === 0) {
                $('#productNameHelpMe').html('').empty().html("<span class='label label-important'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['productNameLabel'] + " </span>");
                $('#productNameForm').removeClass().addClass('form-group has-error');
                $productName.focus();
                return false;
            }
            if ($productCode.val().length === 0) {
                $('#productCodeHelpMe').html('').empty().html("<span class='label label-important'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['productCodeLabel'] + " </span>");
                $('#productCodeForm').removeClass().addClass('form-group has-error');
                $productCode.focus();
                return false;
            }
            if ($productBarcode.val().length === 0) {
                $('#productBarcodeHelpMe').html('').empty().html("<span class='label label-important'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['productBarcodeLabel'] + " </span>");
                $('#productBarcodeForm').removeClass().addClass('form-group has-error');
                $productBarcode.focus();
                return false;
            }
            if ($productSerialNumber.val().length === 0) {
                $('#productSerialNumberHelpMe').html('').empty().html("<span class='label label-important'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['productSerialNumberLabel'] + " </span>");
                $('#productSerialNumberForm').removeClass().addClass('form-group has-error');
                $productSerialNumber.focus();
                return false;
            }
            if ($productModel.val().length === 0) {
                $('#productModelHelpMe').html('').empty().html("<span class='label label-important'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['productModelLabel'] + " </span>");
                $('#productModelForm').removeClass().addClass('form-group has-error');
                $productModel.focus();
                return false;
            }
            if ($productSellingPrice.val().length === 0) {
                $('#productSellingPriceHelpMe').html('').empty().html("<span class='label label-important'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['productSellingPriceLabel'] + " </span>");
                $('#productSellingPriceForm').removeClass().addClass('form-group has-error');
                $productSellingPrice.focus();
                return false;
            }
            if ($productCostPrice.val().length === 0) {
                $('#productCostPriceHelpMe').html('').empty().html("<span class='label label-important'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['productCostPriceLabel'] + " </span>");
                $('#productCostPriceForm').removeClass().addClass('form-group has-error');
                $productCostPrice.focus();
                return false;
            }
            if ($productPicture.val().length === 0) {
                $('#productPictureHelpMe').html('').empty().html("<span class='label label-important'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['productPictureLabel'] + " </span>");
                $('#productPictureForm').removeClass().addClass('form-group has-error');
                $productPicture.focus();
                return false;
            }
            if ($productDescription.val().length === 0) {
                $('#productDescriptionHelpMe').html('').empty().html("<span class='label label-important'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['productDescriptionLabel'] + " </span>");
                $('#productDescriptionForm').removeClass().addClass('form-group has-error');
                $productDescription.focus();
                return false;
            }
            $.ajax({type: 'POST', url: url, data: {method: 'create', output: 'json', itemCategoryId: $itemCategoryId.val(), itemTypeId: $itemTypeId.val(), countryId: $countryId.val(), productName: $productName.val(), productCode: $productCode.val(), productBarcode: $productBarcode.val(), productSerialNumber: $productSerialNumber.val(), productModel: $productModel.val(), productSellingPrice: $productSellingPrice.val(), productCostPrice: $productCostPrice.val(), productPicture: $productPicture.val(), productDescription: $productDescription.val(), securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                    var smileyRoll = './images/icons/smiley-roll.png';
                    var $infoPanel = $('#infoPanel');
                    $infoPanel.html('').empty().html("<span class='label label-warning'>&nbsp;<img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
                    if ($infoPanel.is(':hidden')) {
                    ...
                    if (success === true) {
                        ...
                        $productName.val('');
                        $('#productNameHelpMe').html('').empty();
                        $productCode.val('');
                        $('#productCodeHelpMe').html('').empty();
                        $productBarcode.val('');
                        $('#productBarcodeHelpMe').html('').empty();
                        $productSerialNumber.val('');
                        $('#productSerialNumberHelpMe').html('').empty();
                        $productModel.val('');
                        $('#productModelHelpMe').html('').empty();
                        $productSellingPrice.val('');
                        $('#productSellingPriceHelpMe').html('').empty();
                        $productCostPrice.val('');
                        $('#productCostPriceHelpMe').html('').empty();
                        $productPicture.val('');
                        $('#productPictureForm').removeClass().addClass('form-group');
                        $('#productPictureHelpMe').html('').empty();
                        $productDescription.val('');
                        $('#productDescriptionForm').removeClass().addClass('form-group');
                        $('#productDescriptionHelpMe').html('').empty();
                    } else if (success === false) {
                        $infoPanel.html('').empty().html("<span class='label label-important'>&nbsp;" + message + "</span>");
                        if ($infoPanel.is(':hidden')) {
                            $infoPanel.show();
...
function updateRecord(leafId, url, urlList, securityToken, type, deleteAccess) {
    ...
    if (css.search('disabled') > 0) {
        ...
        if (type === 1) {
            ...
            $infoPanel.html('').empty();
            $.ajax({type: 'POST', url: url, data: {method: 'save', output: 'json', productId: $productId.val(), itemCategoryId: $itemCategoryId.val(), itemTypeId: $itemTypeId.val(), countryId: $countryId.val(), productName: $productName.val(), productCode: $productCode.val(), productBarcode: $productBarcode.val(), productSerialNumber: $productSerialNumber.val(), productModel: $productModel.val(), productSellingPrice: $productSellingPrice.val(), productCostPrice: $productCostPrice.val(), productPicture: $productPicture.val(), productDescription: $productDescription.val(), securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                    var smileyRoll = './images/icons/smiley-roll.png';
                    var $infoPanel = $('#infoPanel');
                    $infoPanel.html('').empty().html("<span class='label label-warning'>&nbsp;<img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
                    if ($infoPanel.is(':hidden')) {
        ...
        if (deleteAccess === 1) {
            if (confirm(decodeURIComponent(t['deleteRecordMessageLabel']))) {
                ...
                if (!value) {
                    ...
                    $.ajax({type: 'POST', url: url, data: {method: 'delete', output: 'json', productId: $productId.val(), securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                            var smileyRoll = './images/icons/smiley-roll.png';
                            var $infoPanel = $('#infoPanel');
                            $infoPanel.html('').empty().html("<span class='label label-warning'>&nbsp;<img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
                            if ($infoPanel.is(':hidden')) {
...
function resetRecord(leafId, url, urlList, securityToken, createAccess, updateAccess, deleteAccess) {
    ...
    $('#countryId').trigger("chosen:updated");
    $("#productName").val('');
    $("#productNameHelpMe").empty().html('');
    $("#productCode").val('');
    $("#productCodeHelpMe").empty().html('');
    $("#productBarcode").val('');
    $("#productBarcodeHelpMe").empty().html('');
    $("#productSerialNumber").val('');
    $("#productSerialNumberHelpMe").empty().html('');
    $("#productModel").val('');
    $("#productModelHelpMe").empty().html('');
    $("#productSellingPrice").val('');
    $("#productSellingPriceHelpMe").empty().html('');
    $("#productCostPrice").val('');
    $("#productCostPriceHelpMe").empty().html('');
    $("#productPicture").val('');
    $("#productPictureHelpMe").empty().html('');
    $('#productPicture').val('');
    $("#productDescription").val('');
    $("#productDescriptionHelpMe").empty().html('');
    $('#productDescription').val('');
}
function postRecord() {
...
function firstRecord(leafId, url, urlList, securityToken, updateAccess, deleteAccess) {
    ...
    if (css.search('disabled') > 0) {
        ...
        $.ajax({type: 'GET', url: url, data: {method: 'dataNavigationRequest', dataNavigation: 'firstRecord', output: 'json', securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                ...
                if (success === true) {
                    $.ajax({type: 'POST', url: url, data: {method: 'read', productId: firstRecord, output: 'json', securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                            var smileyRoll = './images/icons/smiley-roll.png';
                            $infoPanel.html('').empty().html("<span class='label label-warning'>&nbsp;<img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
                            if ($infoPanel.is(':hidden')) {
                                $infoPanel.show();
                            ...
                            if (success === true) {
                                ...
                                $('#productBarcode').val(data.data.productBarcode);
                                $('#productSerialNumber').val(data.data.productSerialNumber);
                                $('#productModel').val(data.data.productModel);
                                $('#productSellingPrice').val(data.data.productSellingPrice);
                                $('#productCostPrice').val(data.data.productCostPrice);
                                $('#productPicture').val(data.data.productPicture);
...
function endRecord(leafId, url, urlList, securityToken, updateAccess, deleteAccess) {
    ...
    if (css.search('disabled') > 0) {
        ...
        $.ajax({type: 'GET', url: url, data: {method: 'dataNavigationRequest', dataNavigation: 'lastRecord', output: 'json', securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                ...
                if (success === true) {
                    $.ajax({type: 'POST', url: url, data: {method: 'read', productId: lastRecord, output: 'json', securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                            var smileyRoll = './images/icons/smiley-roll.png';
                            $infoPanel.html('').empty().html("<span class='label label-warning'>&nbsp;<img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
                            if ($infoPanel.is(':hidden')) {
                                $infoPanel.show();
...
function previousRecord(leafId, url, urlList, securityToken, updateAccess, deleteAccess) {
    ...
    if (css.search('disabled') > 0) {
        ...
        if (parseFloat($previousRecordCounter.val()) > 0 && parseFloat($previousRecordCounter.val()) < parseFloat($('#lastRecordCounter').val())) {
            $.ajax({type: 'POST', url: url, data: {method: 'read', productId: $previousRecordCounter.val(), output: 'json', securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                    var smileyRoll = './images/icons/smiley-roll.png';
                    var $infoPanel = $('#infoPanel');
                    $infoPanel.html('').empty().html("<span class='label label-warning'>&nbsp;<img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
                    if ($infoPanel.is(':hidden')) {
...
function nextRecord(leafId, url, urlList, securityToken, updateAccess, deleteAccess) {
    ...
    if (css.search('disabled') > 0) {
        ...
        if (parseFloat($nextRecordCounter.val()) <= parseFloat($('#lastRecordCounter').val())) {
            $.ajax({type: 'POST', url: url, data: {method: 'read', productId: $nextRecordCounter.val(), output: 'json', securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                    var smileyRoll = './images/icons/smiley-roll.png';
                    var $infoPanel = $('#infoPanel');
                    $infoPanel.html('').empty().html("<span class='label label-warning'>&nbsp;<img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
                    if ($infoPanel.is(':hidden')) {
