function getProductResourcesChartOfAccountSalesAccount(leafId, url, securityToken) {
    $.ajax({type: 'GET', url: url, data: {offset: 0, limit: 99999, method: 'read', type: 'filter', securityToken: securityToken, leafId: leafId, filter: 'productResourcesChartOfAccountSalesAccount'}, beforeSend: function() {
            ...
            if (success === false) {
                ...
                $("#productResourcesChartOfAccountSalesAccount").html('').empty().html(data.data).trigger("chosen:updated");
...
function getProductResourcesChartOfAccountCostOfSalesAccount(leafId, url, securityToken) {
    $.ajax({type: 'GET', url: url, data: {offset: 0, limit: 99999, method: 'read', type: 'filter', securityToken: securityToken, leafId: leafId, filter: 'productResourcesChartOfAccountCostOfSalesAccount'}, beforeSend: function() {
            var smileyRoll = './images/icons/smiley-roll.png';
            var $infoPanel = $('#infoPanel');
            $infoPanel.html('').empty().html("<span class='label label-warning'><img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
            if ($infoPanel.is(':hidden')) {
            ...
            if (success === false) {
                ...
                $("#productResourcesChartOfAccountCostOfSalesAccount").html('').empty().html(data.data).trigger("chosen:updated");
                $infoPanel.html('').empty().html("<span class='label label-success'>&nbsp;<img src='" + smileyLol + "'>  " + decodeURIComponent(t['loadingCompleteTextLabel']) + "</span>").delay(5000).fadeOut();
            }
        }, error: function(xhr) {
            var smileyRollSweat = './images/icons/smiley-roll-sweat.png';
...
function getProductResourcesChartOfAccountInventoryAccount(leafId, url, securityToken) {
    $.ajax({type: 'GET', url: url, data: {offset: 0, limit: 99999, method: 'read', type: 'filter', securityToken: securityToken, leafId: leafId, filter: 'productResourcesChartOfAccountInventoryAccount'}, beforeSend: function() {
            var smileyRoll = './images/icons/smiley-roll.png';
            var $infoPanel = $('#infoPanel');
            $infoPanel.html('').empty().html("<span class='label label-warning'><img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
            if ($infoPanel.is(':hidden')) {
            ...
            if (success === false) {
                ...
                $("#productResourcesChartOfAccountInventoryAccount").html('').empty().html(data.data).trigger("chosen:updated");
                $infoPanel.html('').empty().html("<span class='label label-success'>&nbsp;<img src='" + smileyLol + "'>  " + decodeURIComponent(t['loadingCompleteTextLabel']) + "</span>").delay(5000).fadeOut();
            }
        }, error: function(xhr) {
            var smileyRollSweat = './images/icons/smiley-roll-sweat.png';
...
function checkDuplicate(leafId, page, securityToken) {
    var $productResourcesChartOfAccountCode = $("#productResourcesChartOfAccountCode");
    if ($productResourcesChartOfAccountCode.val().length === 0) {
        alert(t['oddTextLabel']);
        return false;
    }
    $.ajax({type: 'GET', url: page, data: {productResourcesChartOfAccountCode: $productResourcesChartOfAccountCode.val(), method: 'duplicate', securityToken: securityToken, leafId: leafId}, beforeSend: function() {
            var smileyRoll = './images/icons/smiley-roll.png';
            var $infoPanel = $('#infoPanel');
            $infoPanel.html('').empty().html("<span class='label label-warning'><img src='" + smileyRoll + "'>&nbsp;" + decodeURIComponent(t['loadingTextLabel']) + "....</span>");
            if ($infoPanel.is(':hidden')) {
            ...
            if (success === true) {
                if (total !== 0) {
                    $("#productResourcesChartOfAccountCode").val('').focus();
                    $("#productResourcesChartOfAccountCodeForm").removeClass().addClass("form-group has-error");
                ...
                $("#productResourcesChartOfAccountForm").removeClass().addClass("form-group has-error");
            }
            if ($infoPanel.is(':hidden')) {
                $infoPanel.show();
            }
...
function showFormUpdate(leafId, url, urlList, securityToken, productResourcesChartOfAccountId, updateAccess, deleteAccess) {
    sleep(500);
    $('a[rel=tooltip]').tooltip('hide');
    $.ajax({type: 'POST', url: urlList, data: {method: 'read', type: 'form', productResourcesChartOfAccountId: productResourcesChartOfAccountId, securityToken: securityToken, leafId: leafId}, beforeSend: function() {
            var smileyRoll = './images/icons/smiley-roll.png';
            var $infoPanel = $('#infoPanel');
            $infoPanel.html('').empty().html("<span class='label label-warning'><img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
            if ($infoPanel.is(':hidden')) {
...
function showModalDelete(productResourcesChartOfAccountId, productResourcesChartOfAccountSalesAccount, productResourcesChartOfAccountCostOfSalesAccount, productResourcesChartOfAccountInventoryAccount) {
    $('#productResourcesChartOfAccountIdPreview').val('').val(decodeURIComponent(productResourcesChartOfAccountId));
    $('#productResourcesChartOfAccountSalesAccountPreview').val('').val(decodeURIComponent(productResourcesChartOfAccountSalesAccount));
    $('#productResourcesChartOfAccountCostOfSalesAccountPreview').val('').val(decodeURIComponent(productResourcesChartOfAccountCostOfSalesAccount));
    $('#productResourcesChartOfAccountInventoryAccountPreview').val('').val(decodeURIComponent(productResourcesChartOfAccountInventoryAccount));
    showMeModal('deletePreview', 1);
}
function deleteGridRecord(leafId, url, urlList, securityToken) {
    $.ajax({type: 'POST', url: url, data: {method: 'delete', output: 'json', productResourcesChartOfAccountId: $('#productResourcesChartOfAccountIdPreview').val(), securityToken: securityToken, leafId: leafId}, beforeSend: function() {
            var smileyRoll = './images/icons/smiley-roll.png';
            var $infoPanel = $('#infoPanel');
            $infoPanel.html('').empty().html("<span class='label label-warning'><img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
            if ($infoPanel.is(':hidden')) {
...
function deleteGridRecordCheckbox(leafId, url, urlList, securityToken) {
    var stringText = '';
    var counter = 0;
    $('input:checkbox[name="productResourcesChartOfAccountId[]"]').each(function() {
        stringText = stringText + "&productResourcesChartOfAccountId[]=" + $(this).val();
    });
...
function newRecord(leafId, url, urlList, securityToken, type, createAccess, updateAccess, deleteAccess) {
    ...
    var $productResourcesChartOfAccountSalesAccount = $('#productResourcesChartOfAccountSalesAccount');
    var $productResourcesChartOfAccountCostOfSalesAccount = $('#productResourcesChartOfAccountCostOfSalesAccount');
    var $productResourcesChartOfAccountInventoryAccount = $('#productResourcesChartOfAccountInventoryAccount');
    if (css.search('disabled') > 0) {
        return false;
    } else {
        if (type === 1) {
            if ($productResourcesChartOfAccountSalesAccount.val().length === 0) {
                $('#productResourcesChartOfAccountSalesAccountHelpMe').html('').empty().html("<span class='label label-important'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['productResourcesChartOfAccountSalesAccountLabel'] + " </span>");
                $productResourcesChartOfAccountSalesAccount.data('chosen').activate_action();
                return false;
            }
            if ($productResourcesChartOfAccountCostOfSalesAccount.val().length === 0) {
                $('#productResourcesChartOfAccountCostOfSalesAccountHelpMe').html('').empty().html("<span class='label label-important'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['productResourcesChartOfAccountCostOfSalesAccountLabel'] + " </span>");
                $productResourcesChartOfAccountCostOfSalesAccount.data('chosen').activate_action();
                return false;
            }
            if ($productResourcesChartOfAccountInventoryAccount.val().length === 0) {
                $('#productResourcesChartOfAccountInventoryAccountHelpMe').html('').empty().html("<span class='label label-important'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['productResourcesChartOfAccountInventoryAccountLabel'] + " </span>");
                $productResourcesChartOfAccountInventoryAccount.data('chosen').activate_action();
                return false;
            }
            $.ajax({type: 'POST', url: url, data: {method: 'create', output: 'json', productResourcesChartOfAccountSalesAccount: $productResourcesChartOfAccountSalesAccount.val(), productResourcesChartOfAccountCostOfSalesAccount: $productResourcesChartOfAccountCostOfSalesAccount.val(), productResourcesChartOfAccountInventoryAccount: $productResourcesChartOfAccountInventoryAccount.val(), securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                    var smileyRoll = './images/icons/smiley-roll.png';
                    var $infoPanel = $('#infoPanel');
                    $infoPanel.html('').empty().html("<span class='label label-warning'>&nbsp;<img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
                    if ($infoPanel.is(':hidden')) {
                    ...
                    if (success === true) {
                        ...
                        $productResourcesChartOfAccountSalesAccount.val('');
                        $productResourcesChartOfAccountSalesAccount.trigger("chosen:updated");
                        $('#productResourcesChartOfAccountSalesAccountHelpMe').html('').empty();
                        $productResourcesChartOfAccountCostOfSalesAccount.val('');
                        $productResourcesChartOfAccountCostOfSalesAccount.trigger("chosen:updated");
                        $('#productResourcesChartOfAccountCostOfSalesAccountHelpMe').html('').empty();
                        $productResourcesChartOfAccountInventoryAccount.val('');
                        $productResourcesChartOfAccountInventoryAccount.trigger("chosen:updated");
                        $('#productResourcesChartOfAccountInventoryAccountHelpMe').html('').empty();
                    } else if (success === false) {
                        $infoPanel.html('').empty().html("<span class='label label-important'>&nbsp;" + message + "</span>");
                        if ($infoPanel.is(':hidden')) {
                            $infoPanel.show();
            ...
            $.ajax({type: 'POST', url: url, data: {method: 'create', output: 'json', productResourcesChartOfAccountSalesAccount: $productResourcesChartOfAccountSalesAccount.val(), productResourcesChartOfAccountCostOfSalesAccount: $productResourcesChartOfAccountCostOfSalesAccount.val(), productResourcesChartOfAccountInventoryAccount: $productResourcesChartOfAccountInventoryAccount.val(), securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                    ...
                    if (success === true) {
                        ...
                        $('#productResourcesChartOfAccountId').val(data.productResourcesChartOfAccountId);
                        $('#newRecordButton1').removeClass().addClass('btn btn-success disabled');
                        $('#newRecordButton2').removeClass().addClass('btn dropdown-toggle btn-success disabled');
                        $('#newRecordButton3').attr('onClick', '');
                        $('#newRecordButton4').attr('onClick', '');
...
function updateRecord(leafId, url, urlList, securityToken, type, deleteAccess) {
    ...
    if (css.search('disabled') > 0) {
        ...
        if (type === 1) {
            ...
            $infoPanel.html('').empty();
            $.ajax({type: 'POST', url: url, data: {method: 'save', output: 'json', productResourcesChartOfAccountId: $productResourcesChartOfAccountId.val(), productResourcesChartOfAccountSalesAccount: $productResourcesChartOfAccountSalesAccount.val(), productResourcesChartOfAccountCostOfSalesAccount: $productResourcesChartOfAccountCostOfSalesAccount.val(), productResourcesChartOfAccountInventoryAccount: $productResourcesChartOfAccountInventoryAccount.val(), securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                    var smileyRoll = './images/icons/smiley-roll.png';
                    var $infoPanel = $('#infoPanel');
                    $infoPanel.html('').empty().html("<span class='label label-warning'>&nbsp;<img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
                    if ($infoPanel.is(':hidden')) {
...
function deleteRecord(leafId, url, urlList, securityToken, deleteAccess) {
    var $infoPanel = $('#infoPanel');
    var $productResourcesChartOfAccountId = $('#productResourcesChartOfAccountId');
    ...
    if (css.search('disabled') > 0) {
        ...
        if (deleteAccess === 1) {
            if (confirm(decodeURIComponent(t['deleteRecordMessageLabel']))) {
                var value = $productResourcesChartOfAccountId.val();
                if (!value) {
                    ...
                    $.ajax({type: 'POST', url: url, data: {method: 'delete', output: 'json', productResourcesChartOfAccountId: $productResourcesChartOfAccountId.val(), securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                            var smileyRoll = './images/icons/smiley-roll.png';
                            var $infoPanel = $('#infoPanel');
                            $infoPanel.html('').empty().html("<span class='label label-warning'>&nbsp;<img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
                            if ($infoPanel.is(':hidden')) {
...
function resetRecord(leafId, url, urlList, securityToken, createAccess, updateAccess, deleteAccess) {
    ...
    $("#productResourcesChartOfAccountId").val('');
    $("#productResourcesChartOfAccountIdHelpMe").empty().html('');
    
    $("#productResourcesChartOfAccountSalesAccount").val('');
    $("#productResourcesChartOfAccountSalesAccountHelpMe").empty().html('');
    $('#productResourcesChartOfAccountSalesAccount').trigger("chosen:updated");
    $("#productResourcesChartOfAccountCostOfSalesAccount").val('');
    $("#productResourcesChartOfAccountCostOfSalesAccountHelpMe").empty().html('');
    $('#productResourcesChartOfAccountCostOfSalesAccount').trigger("chosen:updated");
    $("#productResourcesChartOfAccountInventoryAccount").val('');
    $("#productResourcesChartOfAccountInventoryAccountHelpMe").empty().html('');
    $('#productResourcesChartOfAccountInventoryAccount').trigger("chosen:updated");
}
function postRecord() {
...
function firstRecord(leafId, url, urlList, securityToken, updateAccess, deleteAccess) {
    ...
    if (css.search('disabled') > 0) {
        ...
        $.ajax({type: 'GET', url: url, data: {method: 'dataNavigationRequest', dataNavigation: 'firstRecord', output: 'json', securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                ...
                if (success === true) {
                    $.ajax({type: 'POST', url: url, data: {method: 'read', productResourcesChartOfAccountId: firstRecord, output: 'json', securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                            var smileyRoll = './images/icons/smiley-roll.png';
                            $infoPanel.html('').empty().html("<span class='label label-warning'>&nbsp;<img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
                            if ($infoPanel.is(':hidden')) {
                                $infoPanel.show();
                            ...
                            if (success === true) {
                                $('#productResourcesChartOfAccountId').val(data.data.productResourcesChartOfAccountId);
                                $('#productResourcesChartOfAccountSalesAccount').val(data.data.productResourcesChartOfAccountSalesAccount).trigger("chosen:updated");
                                $('#productResourcesChartOfAccountCostOfSalesAccount').val(data.data.productResourcesChartOfAccountCostOfSalesAccount).trigger("chosen:updated");
                                $('#productResourcesChartOfAccountInventoryAccount').val(data.data.productResourcesChartOfAccountInventoryAccount).trigger("chosen:updated");
                                if (nextRecord > 0) {
                                    $('#previousRecordButton').removeClass().addClass('btn btn-default disabled').attr('onClick', '');
...
function endRecord(leafId, url, urlList, securityToken, updateAccess, deleteAccess) {
    ...
    if (css.search('disabled') > 0) {
        ...
        $.ajax({type: 'GET', url: url, data: {method: 'dataNavigationRequest', dataNavigation: 'lastRecord', output: 'json', securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                ...
                if (success === true) {
                    $.ajax({type: 'POST', url: url, data: {method: 'read', productResourcesChartOfAccountId: lastRecord, output: 'json', securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                            var smileyRoll = './images/icons/smiley-roll.png';
                            $infoPanel.html('').empty().html("<span class='label label-warning'>&nbsp;<img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
                            if ($infoPanel.is(':hidden')) {
                                $infoPanel.show();
...
function previousRecord(leafId, url, urlList, securityToken, updateAccess, deleteAccess) {
    ...
    if (css.search('disabled') > 0) {
        ...
        if (parseFloat($previousRecordCounter.val()) > 0 && parseFloat($previousRecordCounter.val()) < parseFloat($('#lastRecordCounter').val())) {
            $.ajax({type: 'POST', url: url, data: {method: 'read', productResourcesChartOfAccountId: $previousRecordCounter.val(), output: 'json', securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                    var smileyRoll = './images/icons/smiley-roll.png';
                    var $infoPanel = $('#infoPanel');
                    $infoPanel.html('').empty().html("<span class='label label-warning'>&nbsp;<img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
                    if ($infoPanel.is(':hidden')) {
...
function nextRecord(leafId, url, urlList, securityToken, updateAccess, deleteAccess) {
    ...
    if (css.search('disabled') > 0) {
        ...
        if (parseFloat($nextRecordCounter.val()) <= parseFloat($('#lastRecordCounter').val())) {
            $.ajax({type: 'POST', url: url, data: {method: 'read', productResourcesChartOfAccountId: $nextRecordCounter.val(), output: 'json', securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                    var smileyRoll = './images/icons/smiley-roll.png';
                    var $infoPanel = $('#infoPanel');
                    $infoPanel.html('').empty().html("<span class='label label-warning'>&nbsp;<img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
                    if ($infoPanel.is(':hidden')) {
