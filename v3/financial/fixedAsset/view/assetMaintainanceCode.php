...
require_once($newFakeDocumentRoot . "v3/financial/fixedAsset/controller/assetMaintenanceCodeController.php");
...
$translator->setCurrentTable('assetMaintenanceCode');
...
if (isset($_POST)) {
    if (isset($_POST['method'])) {
        $assetMaintenanceCode = new \Core\Financial\FixedAsset\AssetMaintenanceCode\Controller\AssetMaintenanceCodeClass( );
        define('LIMIT', 10);
        ...
        if (isset($_POST ['query'])) {
            $assetMaintenanceCode->setFieldQuery($_POST ['query']);
        }
        if (isset($_POST ['filter'])) {
            $assetMaintenanceCode->setGridQuery($_POST ['filter']);
        }
        if (isset($_POST ['character'])) {
            $assetMaintenanceCode->setCharacterQuery($_POST['character']);
        }
        if (isset($_POST ['dateRangeStart'])) {
            $assetMaintenanceCode->setDateRangeStartQuery($_POST['dateRangeStart']);
            //explode the data to get day,month,year
            $start = explode('-', $_POST ['dateRangeStart']);
            $assetMaintenanceCode->setStartDay($start[2]);
            $assetMaintenanceCode->setStartMonth($start[1]);
            $assetMaintenanceCode->setStartYear($start[0]);
        }
        if (isset($_POST ['dateRangeEnd']) && (strlen($_POST['dateRangeEnd']) > 0)) {
            $assetMaintenanceCode->setDateRangeEndQuery($_POST['dateRangeEnd']);
            //explode the data to get day,month,year
            $start = explode('-', $_POST ['dateRangeEnd']);
            $assetMaintenanceCode->setEndDay($start[2]);
            $assetMaintenanceCode->setEndMonth($start[1]);
            $assetMaintenanceCode->setEndYear($start[0]);
        }
        if (isset($_POST ['dateRangeType'])) {
            $assetMaintenanceCode->setDateRangeTypeQuery($_POST['dateRangeType']);
        }
        if (isset($_POST ['dateRangeExtraType'])) {
            $assetMaintenanceCode->setDateRangeExtraTypeQuery($_POST['dateRangeExtraType']);
        }
        $assetMaintenanceCode->setServiceOutput('html');
        $assetMaintenanceCode->setLeafId($leafId);
        $assetMaintenanceCode->execute();
        if ($_POST['method'] == 'read') {
            $assetMaintenanceCode->setStart($offset);
            $assetMaintenanceCode->setLimit($limit); // normal system don't like paging..
            $assetMaintenanceCode->setPageOutput('html');
            $assetMaintenanceCodeArray = $assetMaintenanceCode->read();
            if (isset($assetMaintenanceCodeArray [0]['firstRecord'])) {
                $firstRecord = $assetMaintenanceCodeArray [0]['firstRecord'];
            }
            if (isset($assetMaintenanceCodeArray [0]['nextRecord'])) {
                $nextRecord = $assetMaintenanceCodeArray [0]['nextRecord'];
            }
            if (isset($assetMaintenanceCodeArray [0]['previousRecord'])) {
                $previousRecord = $assetMaintenanceCodeArray [0]['previousRecord'];
            }
            if (isset($assetMaintenanceCodeArray [0]['lastRecord'])) {
                $lastRecord = $assetMaintenanceCodeArray [0]['lastRecord'];
                $endRecord = $assetMaintenanceCodeArray [0]['lastRecord'];
            }
            $navigation = new \Core\Paging\HtmlPaging();
            $navigation->setLeafId($leafId);
            $navigation->setViewPath($assetMaintenanceCode->getViewPath());
            ...
            if (isset($assetMaintenanceCodeArray [0]['total'])) {
                $total = $assetMaintenanceCodeArray [0]['total'];
            } else {
                $total = 0;
            }
            ...
            <div class="row">
                <div class="pull-left btn-group col-xs-10 col-sm-10 col-md-10">
                    <button title="A" class="btn btn-success btn-sm" type="button" 
                            ...
                            echo $assetMaintenanceCode->getViewPath();
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu" style="text-align:left">
                                <li>
                                    ...
                                    echo $assetMaintenanceCode->getControllerPath();
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form class="form-horizontal">
                                        <input type="hidden" name="assetMaintenanceCodeIdPreview"
                                               id="assetMaintenanceCodeIdPreview">

                                        <div class="form-group" id="assetMaintenanceCodeDiv">
                                            <label for="assetMaintenanceCodePreview"
                                                   class="control-label col-xs-4 col-sm-4 col-md-4"><?php echo $leafTranslation['assetMaintenanceCodeLabel']; ?></label>

                                            <div class="col-xs-8 col-sm-8 col-md-8">
                                                <input class="form-control" type="text" name="assetMaintenanceCodePreview"
                                                       id="assetMaintenanceCodePreview">
                                            </div>
                                        </div>
                                        <div class="form-group" id="assetMaintenanceCodeDescriptionDiv">
                                            <label for="assetMaintenanceCodeDescriptionPreview"
                                                   class="control-label col-xs-4 col-sm-4 col-md-4"><?php echo $leafTranslation['assetMaintenanceCodeDescriptionLabel']; ?></label>

                                            <div class="col-xs-8 col-sm-8 col-md-8">
                                                <input class="form-control" type="text"
                                                       name="assetMaintenanceCodeDescriptionPreview"
                                                       id="assetMaintenanceCodeDescriptionPreview">
                                            </div>
                                        </div>
                                    </form>
                                </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="panel panel-default">
                                <table class="table table table-bordered table-striped table-condensed table-hover smart-form has-tickbox" id="tableData">
                                    ...
                                    <th width="75px"><?php echo ucwords($leafTranslation['assetMaintenanceCodeLabel']); ?></th>
                                    <th><?php echo ucwords($leafTranslation['assetMaintenanceCodeDescriptionLabel']); ?></th>
                                            ...
                                            if (is_array($assetMaintenanceCodeArray)) {
                                                ...
                                                if ($totalRecord > 0) {
                                                    ...
                                                    for ($i = 0; $i < $totalRecord; $i++) {
                                                        ...
                                                        ?>
                                                        <tr <?php
                                                        if ($assetMaintenanceCodeArray[$i]['isDelete'] == 1) {
                                                            echo "class=\"danger\"";
                                                        } else {
                                                            if ($assetMaintenanceCodeArray[$i]['isDraft'] == 1) {
                                                                echo "class=\"warning\"";
                                                            }
                                                        }
                                                        ?>>
                                                            ...
                                                            <td align="center">
																<?php if( $assetMaintenanceCodeArray [$i]['assetMaintenanceCode'] !='UNBL') { ?>
                                                                <div class="btn-group" align="center">
                                                                    <button type="button"  class="btn btn-info btn-sm" title="Edit"
                                                                            ...
                                                                            echo intval(
                                                                                    $assetMaintenanceCodeArray [$i]['assetMaintenanceCodeId']
                                                                            );
                                                                    ...
                                                                    <button type="button"  class="btn btn-danger btn-sm" title="Delete"
                                                                            ...
                                                                            ?>', '<?php
                                                                            echo rawurlencode(
                                                                                    $assetMaintenanceCodeArray [$i]['assetMaintenanceCode']
                                                                            );
                                                                            ?>', '<?php
                                                                            echo rawurlencode(
                                                                                    $assetMaintenanceCodeArray [$i]['assetMaintenanceCodeDescription']
                                                                            );
                                                                            ?>');">
                                                            ...
                                                            <td>
                                                                <div class="pull-left">
                                                                    <?php
                                                                    if (isset($assetMaintenanceCodeArray[$i]['assetMaintenanceCode'])) {
                                                                        if (isset($_POST['query']) || isset($_POST['character'])) {
                                                                            if (isset($_POST['query']) && strlen($_POST['query']) > 0) {
                                                                                if (strpos(
                                                                                    ...
                                                                                    echo str_replace(
                                                                                            $_POST['query'], "<span class=\"label label-info\">" . $_POST['query'] . "</span>", $assetMaintenanceCodeArray[$i]['assetMaintenanceCode']
                                                                                    );
                                                                                } else {
                                                                                    echo $assetMaintenanceCodeArray[$i]['assetMaintenanceCode'];
                                                                                }
                                                                            } else {
                                                                                if (isset($_POST['character']) && strlen($_POST['character']) > 0) {
                                                                                    if (strpos(
                                                                                        ...
                                                                                        echo str_replace(
                                                                                                $_POST['character'], "<span class=\"label label-info\">" . $_POST['character'] . "</span>", $assetMaintenanceCodeArray[$i]['assetMaintenanceCode']
                                                                                        );
                                                                                    } else {
                                                                                        echo $assetMaintenanceCodeArray[$i]['assetMaintenanceCode'];
                                                                                    }
                                                            ...
                                                            <td>
                                                                <div class="pull-left">
                                                                    <?php
                                                                    if (isset($assetMaintenanceCodeArray[$i]['assetMaintenanceCodeDescription'])) {
                                                                        if (isset($_POST['query']) || isset($_POST['character'])) {
                                                                            if (isset($_POST['query']) && strlen($_POST['query']) > 0) {
                                                                                if (strpos(
                                                                                                strtolower(
                                                                                    ...
                                                                                    echo str_replace(
                                                                                            $_POST['query'], "<span class=\"label label-info\">" . $_POST['query'] . "</span>", $assetMaintenanceCodeArray[$i]['assetMaintenanceCodeDescription']
                                                                                    );
                                                                                } else {
                                                                                    echo $assetMaintenanceCodeArray[$i]['assetMaintenanceCodeDescription'];
                                                                                }
                                                                            } else {
                                                                                if (isset($_POST['character']) && strlen($_POST['character']) > 0) {
                                                                                    if (strpos(
                                                                                        ...
                                                                                        echo str_replace(
                                                                                                $_POST['character'], "<span class=\"label label-info\">" . $_POST['character'] . "</span>", $assetMaintenanceCodeArray[$i]['assetMaintenanceCodeDescription']
                                                                                        );
                                                                                    } else {
                                                                                        echo $assetMaintenanceCodeArray[$i]['assetMaintenanceCodeDescription'];
                                                                                    }
                                                            ...
                                                            <td>
                                                                <div class="pull-left">
                                                                    <?php
                                                                    if (isset($assetMaintenanceCodeArray[$i]['executeBy'])) {
                                                                        if (isset($_POST['query']) || isset($_POST['character'])) {
                                                                            if (isset($_POST['query']) && strlen($_POST['query']) > 0) {
                                                                                if (strpos(
                                                                                                $assetMaintenanceCodeArray[$i]['staffName'], $_POST['query']
                                                                                        ) !== false
                                                                                ) {
                                                                                    echo str_replace(
                                                                                            $_POST['query'], "<span class=\"label label-info\">" . $_POST['query'] . "</span>", $assetMaintenanceCodeArray[$i]['staffName']
                                                                                    );
                                                                                } else {
                                                                                    echo $assetMaintenanceCodeArray[$i]['staffName'];
                                                                                }
                                                                            } else {
                                                                                if (isset($_POST['character']) && strlen($_POST['character']) > 0) {
                                                                                    if (strpos(
                                                                                                    $assetMaintenanceCodeArray[$i]['staffName'], $_POST['character']
                                                                                            ) !== false
                                                                                    ) {
                                                                                        echo str_replace(
                                                                                                $_POST['character'], "<span class=\"label label-info\">" . $_POST['character'] . "</span>", $assetMaintenanceCodeArray[$i]['staffName']
                                                                                        );
                                                                                    } else {
                                                                                        echo $assetMaintenanceCodeArray[$i]['staffName'];
                                                                                    }
                                                            ...
                                                            <?php
                                                            if (isset($assetMaintenanceCodeArray[$i]['executeTime'])) {
                                                                $valueArray = $assetMaintenanceCodeArray[$i]['executeTime'];
                                                            ...
                                                            <?php
                                                            if ($assetMaintenanceCodeArray[$i]['isDelete']) {
                                                                $checked = "checked";
                                                            } else {
                                                                $checked = null;
                                                            }
                                                            ...
                                                            <td>
																<?php if( $assetMaintenanceCodeArray [$i]['assetMaintenanceCode'] !='UNBL') { ?>
                                                                <input style="display:none;" type="checkbox" name="assetMaintenanceCodeId[]"
                                                                       value="<?php echo $assetMaintenanceCodeArray[$i]['assetMaintenanceCodeId']; ?>">
                                                                <input <?php echo $checked; ?> type="checkbox" name="isDelete[]"
                                                                                               value="<?php echo $assetMaintenanceCodeArray[$i]['isDelete']; ?>">
																<?php } ?>
                                                            </td>
                                                        </tr>
                                                        <?php
                                                    ...
                                                    <tr>
                                                        <td colspan="7" valign="top" align="center"><?php
                                                            $assetMaintenanceCode->exceptionMessage(
...
if ((isset($_POST['method']) == 'new' || isset($_POST['method']) == 'read') && $_POST['type'] == 'form') {
        ...
        <div id="content" style="opacity: 1;">
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            <input type="hidden" name="assetMaintenanceCodeId" id="assetMaintenanceCodeId" value="<?php
                            if (isset($_POST['assetMaintenanceCodeId'])) {
                                echo $_POST['assetMaintenanceCodeId'];
                            }
                            ?>">
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="col-xs-6 col-sm-6 col-md-6 form-group" id="assetMaintenanceCodeForm">
                                        <label for="assetMaintenanceCode"><strong><?php
                                                echo ucfirst(
                                                        $leafTranslation['assetMaintenanceCodeLabel']
                                                );
                                                ?></strong></label>

                                        <div class="col-xs-8 col-sm-8 col-md-8">
                                            <div class="input-group">
                                                <input type="text" class="form-control" name="assetMaintenanceCode"
                                                       id="assetMaintenanceCode" value="<?php
                                                       if (isset($assetMaintenanceCodeArray) && is_array($assetMaintenanceCodeArray)) {
                                                           echo htmlentities($assetMaintenanceCodeArray[0]['assetMaintenanceCode']);
                                                       }
                                                       ?>" maxlength="16">
                                                <span class="input-group-addon"><img src="./images/icons/document-code.png"></span>
                                            </div>
                                            <span class="help-block" id="assetMaintenanceCodeHelpMe"></span>
                                        </div>
                                    </div>
                                    <div class="col-xs-6 col-sm-6 col-md-6 form-group" id="assetMaintenanceCodeDescriptionForm">
                                        <label for="assetMaintenanceCodeDescription"><strong><?php
                                                echo ucfirst(
                                                        $leafTranslation['assetMaintenanceCodeDescriptionLabel']
                                                );
                                                ?></strong></label>

                                        <div class="col-xs-8 col-sm-8 col-md-8">
                                            <div class="input-group">
                                                <input type="text" class="form-control" name="assetMaintenanceCodeDescription"
                                                       id="assetMaintenanceCodeDescription" value="<?php
                                                       if (isset($assetMaintenanceCodeArray) && is_array($assetMaintenanceCodeArray)) {
                                                           echo htmlentities(
                                                                   $assetMaintenanceCodeArray[0]['assetMaintenanceCodeDescription']
                                                           );
                                                       }
                                                       ?>" maxlength="16">
                                                <span class="input-group-addon"><img src="./images/icons/document-code.png"></span>
                                            </div>
                                            <span class="help-block" id="assetMaintenanceCodeDescriptionHelpMe"></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <script type="text/javascript">
                ...
                $(document).ready(function() {
                    ...
                    validateMeAlphaNumeric('assetMaintenanceCode');
    <?php if ($_POST['method'] == "new") { ?>
                        $('#resetRecordButton')
                                .removeClass().addClass('btn btn-default');
        <?php if ($leafAccess['leafAccessCreateValue'] == 1) { ?>
                            $('#newRecordButton1')
                                    .removeClass().addClass('btn btn-success').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $assetMaintenanceCode->getControllerPath(); ?>','<?php echo $assetMaintenanceCode->getViewPath(); ?>','<?php echo $securityToken; ?>',1)");
                            $('#newRecordButton2')
                                    .removeClass().addClass('btn dropdown-toggle btn-success');
                            $('#newRecordButton3').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $assetMaintenanceCode->getControllerPath(); ?>','<?php echo $assetMaintenanceCode->getViewPath(); ?>','<?php echo $securityToken; ?>',1)");
                            $('#newRecordButton4').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $assetMaintenanceCode->getControllerPath(); ?>','<?php echo $assetMaintenanceCode->getViewPath(); ?>','<?php echo $securityToken; ?>',2)");
                            $('#newRecordButton5').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $assetMaintenanceCode->getControllerPath(); ?>','<?php echo $assetMaintenanceCode->getViewPath(); ?>','<?php echo $securityToken; ?>',3)");
                            $('#newRecordButton6').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $assetMaintenanceCode->getControllerPath(); ?>','<?php echo $assetMaintenanceCode->getViewPath(); ?>','<?php echo $securityToken; ?>',4)");
                            $('#newRecordButton7').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $assetMaintenanceCode->getControllerPath(); ?>','<?php echo $assetMaintenanceCode->getViewPath(); ?>','<?php echo $securityToken; ?>',5)");
        <?php } else { ?>
                            $('#newRecordButton1')
        ...
        if ($_POST['assetMaintenanceCodeId']) {
            ?>
                            $('#newRecordButton1')
                                    .removeClass().addClass('btn btn-success disabled');
                            $('#newRecordButton2')
            ...
            <?php if ($leafAccess['leafAccessUpdateValue'] == 1) { ?>
                                $('#updateRecordButton1')
                                        .removeClass().addClass('btn btn-info').attr('onClick', "updateRecord(<?php echo $leafId; ?>,'<?php echo $assetMaintenanceCode->getControllerPath(); ?>','<?php echo $assetMaintenanceCode->getViewPath(); ?>','<?php echo $securityToken; ?>',1,<?php echo $leafAccess['leafAccessDeleteValue']; ?>);");
                                $('#updateRecordButton2')
                                        .removeClass().addClass('btn dropdown-toggle btn-info');
                                $('#updateRecordButton3').attr('onClick', "updateRecord(<?php echo $leafId; ?>,'<?php echo $assetMaintenanceCode->getControllerPath(); ?>','<?php echo $assetMaintenanceCode->getViewPath(); ?>','<?php echo $securityToken; ?>',1,<?php echo $leafAccess['leafAccessDeleteValue']; ?>);");
                                $('#updateRecordButton4').attr('onClick', "updateRecord(<?php echo $leafId; ?>,'<?php echo $assetMaintenanceCode->getControllerPath(); ?>','<?php echo $assetMaintenanceCode->getViewPath(); ?>','<?php echo $securityToken; ?>',2,<?php echo $leafAccess['leafAccessDeleteValue']; ?>);");
                                $('#updateRecordButton5').attr('onClick', "updateRecord(<?php echo $leafId; ?>,'<?php echo $assetMaintenanceCode->getControllerPath(); ?>','<?php echo $assetMaintenanceCode->getViewPath(); ?>','<?php echo $securityToken; ?>',3,<?php echo $leafAccess['leafAccessDeleteValue']; ?>);");
            <?php } else { ?>
                                $('#updateRecordButton1')
                                        .removeClass().addClass(' btn btn-info disabled');
                                $('#updateRecordButton2')
            ...
            <?php if ($leafAccess['leafAccessDeleteValue'] == 1) { ?>
                                $('#deleteRecordButton')
                                        .removeClass().addClass('btn btn-danger').attr('onClick', "deleteRecord(<?php echo $leafId; ?>,'<?php echo $assetMaintenanceCode->getControllerPath(); ?>','<?php echo $assetMaintenanceCode->getViewPath(); ?>','<?php echo $securityToken; ?>',<?php echo $leafAccess['leafAccessDeleteValue']; ?>);");
            <?php } else { ?>
                                $('#deleteRecordButton')
                                        .removeClass().addClass('btn btn-danger disabled')
                                        .attr('onClick', '');
    ...
    <?php } ?>
    <script type="text/javascript" src="./v3/financial/fixedAsset/javascript/assetMaintenanceCode.js"></script>
    <hr>
