...
require_once($newFakeDocumentRoot . "v3/financial/fixedAsset/controller/assetPartsFaultController.php");
...
$translator->setCurrentTable('assetPartsFault');
...
$assetPartsFaultArray = array();
$assetArray = array();
$assetPartsArray = array();
$assetMaintenanceCodeArray = array();
if (isset($_POST)) {
    if (isset($_POST['method'])) {
        $assetPartsFault = new \Core\Financial\FixedAsset\AssetPartsFault\Controller\AssetPartsFaultClass();
        define('LIMIT', 10);
        ...
        if (isset($_POST ['query'])) {
            $assetPartsFault->setFieldQuery($_POST ['query']);
        }
        if (isset($_POST ['filter'])) {
            $assetPartsFault->setGridQuery($_POST ['filter']);
        }
        if (isset($_POST ['character'])) {
            $assetPartsFault->setCharacterQuery($_POST['character']);
        }
        if (isset($_POST ['dateRangeStart'])) {
            $assetPartsFault->setDateRangeStartQuery($_POST['dateRangeStart']);
            //explode the data to get day,month,year
            $start = explode('-', $_POST ['dateRangeStart']);
            $assetPartsFault->setStartDay($start[2]);
            $assetPartsFault->setStartMonth($start[1]);
            $assetPartsFault->setStartYear($start[0]);
        }
        if (isset($_POST ['dateRangeEnd']) && (strlen($_POST['dateRangeEnd']) > 0)) {
            $assetPartsFault->setDateRangeEndQuery($_POST['dateRangeEnd']);
            //explode the data to get day,month,year
            $start = explode('-', $_POST ['dateRangeEnd']);
            $assetPartsFault->setEndDay($start[2]);
            $assetPartsFault->setEndMonth($start[1]);
            $assetPartsFault->setEndYear($start[0]);
        }
        if (isset($_POST ['dateRangeType'])) {
            $assetPartsFault->setDateRangeTypeQuery($_POST['dateRangeType']);
        }
        if (isset($_POST ['dateRangeExtraType'])) {
            $assetPartsFault->setDateRangeExtraTypeQuery($_POST['dateRangeExtraType']);
        }
        $assetPartsFault->setServiceOutput('html');
        $assetPartsFault->setLeafId($leafId);
        $assetPartsFault->execute();
        $assetArray = $assetPartsFault->getAsset();
        $assetPartsArray = $assetPartsFault->getAssetParts();
        $assetMaintenanceCodeArray = $assetPartsFault->getAssetMaintenanceCode();
        if ($_POST['method'] == 'read') {
            $assetPartsFault->setStart($offset);
            $assetPartsFault->setLimit($limit); // normal system don't like paging..
            $assetPartsFault->setPageOutput('html');
            $assetPartsFaultArray = $assetPartsFault->read();
            if (isset($assetPartsFaultArray [0]['firstRecord'])) {
                $firstRecord = $assetPartsFaultArray [0]['firstRecord'];
            }
            if (isset($assetPartsFaultArray [0]['nextRecord'])) {
                $nextRecord = $assetPartsFaultArray [0]['nextRecord'];
            }
            if (isset($assetPartsFaultArray [0]['previousRecord'])) {
                $previousRecord = $assetPartsFaultArray [0]['previousRecord'];
            }
            if (isset($assetPartsFaultArray [0]['lastRecord'])) {
                $lastRecord = $assetPartsFaultArray [0]['lastRecord'];
                $endRecord = $assetPartsFaultArray [0]['lastRecord'];
            }
            $navigation = new \Core\Paging\HtmlPaging();
            $navigation->setLeafId($leafId);
            $navigation->setViewPath($assetPartsFault->getViewPath());
            ...
            if (isset($assetPartsFaultArray [0]['total'])) {
                $total = $assetPartsFaultArray [0]['total'];
            } else {
                $total = 0;
            }
            ...
            <div class="row">
                <div class="pull-left btn-group col-xs-10 col-sm-10 col-md-10">
                    <button title="A" class="btn btn-success btn-sm" type="button" 
                            ...
                            echo $assetPartsFault->getViewPath();
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu" style="text-align:left">
                                <li>
                                    ...
                                    echo $assetPartsFault->getControllerPath();
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                        <input type="hidden" name="assetPartsFaultIdPreview" id="assetPartsFaultIdPreview">
                                        ...
                                        <div class="form-group" id="assetPartsIdDiv">
                                            <label for="assetPartsIdPreview"
                                                   class="control-label col-xs-4 col-sm-4 col-md-4"><?php echo $leafTranslation['assetPartsIdLabel']; ?></label>

                                            <div class="col-xs-8 col-sm-8 col-md-8">
                                                <input class="form-control" type="text" name="assetPartsIdPreview"
                                                       id="assetPartsIdPreview">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group" id="assetPartsFaultDateDiv">
                                            <label for="assetPartsFaultDatePreview"
                                                   class="control-label col-xs-4 col-sm-4 col-md-4"><?php echo $leafTranslation['assetPartsFaultDateLabel']; ?></label>

                                            <div class="col-xs-8 col-sm-8 col-md-8">
                                                <input class="form-control" type="text"
                                                       name="assetPartsFaultDatePreview" id="assetPartsFaultDatePreview">
                                            </div>
                                        </div>
                                        <div class="form-group" id="assetPartsFaultDescriptionDiv">
                                            <label for="assetPartsFaultDescriptionPreview"
                                                   class="control-label col-xs-4 col-sm-4 col-md-4"><?php echo $leafTranslation['assetPartsFaultDescriptionLabel']; ?></label>
                                            <input class="form-control" type="text"
                                                   name="assetPartsFaultDescriptionPreview"
                                                   id="assetPartsFaultDescriptionPreview">
                                        </div>
                                </div>
                            </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="panel panel-default">
                            <table class="table table table-bordered table-striped table-condensed table-hover smart-form has-tickbox" id="tableData">
                                ...
                                <th width="75px">
                                <div align="center"><?php echo ucwords($leafTranslation['assetPartsFaultDateLabel']); ?></div>
                                </th>
                                <th width="125px"><?php echo ucwords($leafTranslation['assetIdLabel']); ?></th>
                                <th width="125px"><?php echo ucwords($leafTranslation['assetPartsIdLabel']); ?></th>
                                <th width="125px"><?php echo ucwords($leafTranslation['assetMaintenanceCodeIdLabel']); ?></th>
                                <th><?php echo ucwords($leafTranslation['assetPartsFaultDescriptionLabel']); ?></th>
                                ...
                                <tbody id="tableBody">
                                    ...
                                    if ($_POST['method'] == 'read' && $_POST['type'] == 'list' && $_POST['detail'] == 'body') {
                                        if (is_array($assetPartsFaultArray)) {
                                            $totalRecord = intval(count($assetPartsFaultArray));
                                            if ($totalRecord > 0) {
                                                $counter = 0;
                                                for ($i = 0; $i < $totalRecord; $i++) {
                                                    ...
                                                    ?>
                                                    <tr <?php
                                                    if ($assetPartsFaultArray[$i]['isDelete'] == 1) {
                                                        echo "class=\"danger\"";
                                                    } else {
                                                        if ($assetPartsFaultArray[$i]['isDraft'] == 1) {
                                                            echo "class=\"warning\"";
                                                        }
                                                    }
                                                    ?>>
                                                        ...
                                                        <td align="center">
                                                            <div class="btn-group" align="center">
                                                                <button type="button"  class="btn btn-info btn-sm" title="Edit"
                                                                        ...
                                                                        echo intval(
                                                                                $assetPartsFaultArray [$i]['assetPartsFaultId']
                                                                        );
                                                                ...
                                                                <button type="button"  class="btn btn-danger btn-sm" title="Delete"
                                                                        ...
                                                                        ?>', '<?php
                                                                        echo rawurlencode(
                                                                                $assetPartsFaultArray [$i]['assetDescription']
                                                                        );
                                                                        ?>', '<?php
                                                                        echo rawurlencode(
                                                                                $assetPartsFaultArray [$i]['assetPartsDescription']
                                                                        );
                                                                        ?>', '<?php
                                                                        echo rawurlencode(
                                                                                $assetPartsFaultArray [$i]['assetMaintenanceCodeDescription']
                                                                        );
                                                                        ?>', '<?php
                                                                        echo rawurlencode(
                                                                                $assetPartsFaultArray [$i]['documentNumber']
                                                                        );
                                                                        ?>', '<?php
                                                                        echo rawurlencode(
                                                                                $assetPartsFaultArray [$i]['assetPartsFaultDate']
                                                                        );
                                                                        ?>', '<?php
                                                                        echo rawurlencode(
                                                                                $assetPartsFaultArray [$i]['assetPartsFaultDescription']
                                                                        );
                                                                        ?>');">
                                                        ...
                                                        <td>
                                                            <div class="pull-left">
                                                                <?php
                                                                if (isset($assetPartsFaultArray[$i]['assetDescription'])) {
                                                                    if (isset($_POST['query']) || isset($_POST['character'])) {
                                                                        if (isset($_POST['query']) && strlen($_POST['query']) > 0) {
                                                                            if (strpos(
                                                                                            $assetPartsFaultArray[$i]['assetDescription'], $_POST['query']
                                                                                    ) !== false
                                                                            ) {
                                                                                echo str_replace(
                                                                                        $_POST['query'], "<span class=\"label label-info\">" . $_POST['query'] . "</span>", $assetPartsFaultArray[$i]['assetDescription']
                                                                                );
                                                                            } else {
                                                                                echo $assetPartsFaultArray[$i]['assetDescription'];
                                                                            }
                                                                        } else {
                                                                            if (isset($_POST['character']) && strlen($_POST['character']) > 0) {
                                                                                if (strpos(
                                                                                                $assetPartsFaultArray[$i]['assetDescription'], $_POST['character']
                                                                                        ) !== false
                                                                                ) {
                                                                                    echo str_replace(
                                                                                            $_POST['character'], "<span class=\"label label-info\">" . $_POST['character'] . "</span>", $assetPartsFaultArray[$i]['assetDescription']
                                                                                    );
                                                                                } else {
                                                                                    echo $assetPartsFaultArray[$i]['assetDescription'];
                                                                                }
                                                        ...
                                                        <td>
                                                            <div class="pull-left">
                                                                <?php
                                                                if (isset($assetPartsFaultArray[$i]['assetPartsDescription'])) {
                                                                    if (isset($_POST['query']) || isset($_POST['character'])) {
                                                                        if (isset($_POST['query']) && strlen($_POST['query']) > 0) {
                                                                            if (strpos(
                                                                                            $assetPartsFaultArray[$i]['assetPartsDescription'], $_POST['query']
                                                                                    ) !== false
                                                                            ) {
                                                                                echo str_replace(
                                                                                        $_POST['query'], "<span class=\"label label-info\">" . $_POST['query'] . "</span>", $assetPartsFaultArray[$i]['assetPartsDescription']
                                                                                );
                                                                            } else {
                                                                                echo $assetPartsFaultArray[$i]['assetPartsDescription'];
                                                                            }
                                                                        } else {
                                                                            if (isset($_POST['character']) && strlen($_POST['character']) > 0) {
                                                                                if (strpos(
                                                                                                $assetPartsFaultArray[$i]['assetPartsDescription'], $_POST['character']
                                                                                        ) !== false
                                                                                ) {
                                                                                    echo str_replace(
                                                                                            $_POST['character'], "<span class=\"label label-info\">" . $_POST['character'] . "</span>", $assetPartsFaultArray[$i]['assetPartsDescription']
                                                                                    );
                                                                                } else {
                                                                                    echo $assetPartsFaultArray[$i]['assetPartsDescription'];
                                                                                }
                                                        ...
                                                        <td>
                                                            <div class="pull-left">
                                                                <?php
                                                                if (isset($assetPartsFaultArray[$i]['assetMaintenanceCodeDescription'])) {
                                                                    if (isset($_POST['query']) || isset($_POST['character'])) {
                                                                        if (isset($_POST['query']) && strlen($_POST['query']) > 0) {
                                                                            if (strpos(
                                                                                            $assetPartsFaultArray[$i]['assetMaintenanceCodeDescription'], $_POST['query']
                                                                                    ) !== false
                                                                            ) {
                                                                                echo str_replace(
                                                                                        $_POST['query'], "<span class=\"label label-info\">" . $_POST['query'] . "</span>", $assetPartsFaultArray[$i]['assetMaintenanceCodeDescription']
                                                                                );
                                                                            } else {
                                                                                echo $assetPartsFaultArray[$i]['assetMaintenanceCodeDescription'];
                                                                            }
                                                                        } else {
                                                                            if (isset($_POST['character']) && strlen($_POST['character']) > 0) {
                                                                                if (strpos(
                                                                                                $assetPartsFaultArray[$i]['assetMaintenanceCodeDescription'], $_POST['character']
                                                                                        ) !== false
                                                                                ) {
                                                                                    echo str_replace(
                                                                                            $_POST['character'], "<span class=\"label label-info\">" . $_POST['character'] . "</span>", $assetPartsFaultArray[$i]['assetMaintenanceCodeDescription']
                                                                                    );
                                                                                } else {
                                                                                    echo $assetPartsFaultArray[$i]['assetMaintenanceCodeDescription'];
                                                                                }
                                                        ...
                                                        <td>
                                                            <div class="pull-left">
                                                                <?php
                                                                if (isset($assetPartsFaultArray[$i]['documentNumber'])) {
                                                                    if (isset($_POST['query']) || isset($_POST['character'])) {
                                                                        if (isset($_POST['query']) && strlen($_POST['query']) > 0) {
                                                                            if (strpos(
                                                                                            strtolower($assetPartsFaultArray[$i]['documentNumber']), strtolower($_POST['query'])
                                                                                    ) !== false
                                                                            ) {
                                                                                echo str_replace(
                                                                                        $_POST['query'], "<span class=\"label label-info\">" . $_POST['query'] . "</span>", $assetPartsFaultArray[$i]['documentNumber']
                                                                                );
                                                                            } else {
                                                                                echo $assetPartsFaultArray[$i]['documentNumber'];
                                                                            }
                                                                        } else {
                                                                            if (isset($_POST['character']) && strlen($_POST['character']) > 0) {
                                                                                if (strpos(
                                                                                                strtolower($assetPartsFaultArray[$i]['documentNumber']), strtolower($_POST['character'])
                                                                                        ) !== false
                                                                                ) {
                                                                                    echo str_replace(
                                                                                            $_POST['character'], "<span class=\"label label-info\">" . $_POST['character'] . "</span>", $assetPartsFaultArray[$i]['documentNumber']
                                                                                    );
                                                                                } else {
                                                                                    echo $assetPartsFaultArray[$i]['documentNumber'];
                                                                                }
                                                        ...
                                                        <?php
                                                        if (isset($assetPartsFaultArray[$i]['assetPartsFaultDate'])) {
                                                            $valueArray = $assetPartsFaultArray[$i]['assetPartsFaultDate'];
                                                        ...
                                                        <td>
                                                            <div class="pull-left">
                                                                <?php
                                                                if (isset($assetPartsFaultArray[$i]['assetPartsFaultDescription'])) {
                                                                    if (isset($_POST['query']) || isset($_POST['character'])) {
                                                                        if (isset($_POST['query']) && strlen($_POST['query']) > 0) {
                                                                            if (strpos(
                                                                                            strtolower($assetPartsFaultArray[$i]['assetPartsFaultDescription']), strtolower($_POST['query'])
                                                                                    ) !== false
                                                                            ) {
                                                                                echo str_replace(
                                                                                        $_POST['query'], "<span class=\"label label-info\">" . $_POST['query'] . "</span>", $assetPartsFaultArray[$i]['assetPartsFaultDescription']
                                                                                );
                                                                            } else {
                                                                                echo $assetPartsFaultArray[$i]['assetPartsFaultDescription'];
                                                                            }
                                                                        } else {
                                                                            if (isset($_POST['character']) && strlen($_POST['character']) > 0) {
                                                                                if (strpos(
                                                                                                strtolower($assetPartsFaultArray[$i]['assetPartsFaultDescription']), strtolower($_POST['character'])
                                                                                        ) !== false
                                                                                ) {
                                                                                    echo str_replace(
                                                                                            $_POST['character'], "<span class=\"label label-info\">" . $_POST['character'] . "</span>", $assetPartsFaultArray[$i]['assetPartsFaultDescription']
                                                                                    );
                                                                                } else {
                                                                                    echo $assetPartsFaultArray[$i]['assetPartsFaultDescription'];
                                                                                }
                                                        ...
                                                        <td>
                                                            <div class="pull-left">
                                                                <?php
                                                                if (isset($assetPartsFaultArray[$i]['executeBy'])) {
                                                                    if (isset($_POST['query']) || isset($_POST['character'])) {
                                                                        if (isset($_POST['query']) && strlen($_POST['query']) > 0) {
                                                                            if (strpos($assetPartsFaultArray[$i]['staffName'], $_POST['query']) !== false) {
                                                                                echo str_replace(
                                                                                        $_POST['query'], "<span class=\"label label-info\">" . $_POST['query'] . "</span>", $assetPartsFaultArray[$i]['staffName']
                                                                                );
                                                                            } else {
                                                                                echo $assetPartsFaultArray[$i]['staffName'];
                                                                            }
                                                                        } else {
                                                                            if (isset($_POST['character']) && strlen($_POST['character']) > 0) {
                                                                                if (strpos(
                                                                                                $assetPartsFaultArray[$i]['staffName'], $_POST['character']
                                                                                        ) !== false
                                                                                ) {
                                                                                    echo str_replace(
                                                                                            $_POST['character'], "<span class=\"label label-info\">" . $_POST['character'] . "</span>", $assetPartsFaultArray[$i]['staffName']
                                                                                    );
                                                                                } else {
                                                                                    echo $assetPartsFaultArray[$i]['staffName'];
                                                                                }
                                                        ...
                                                        <?php
                                                        if (isset($assetPartsFaultArray[$i]['executeTime'])) {
                                                            $valueArray = $assetPartsFaultArray[$i]['executeTime'];
                                                            ...
                                                            <td><?php echo $value; ?></td>
                                                        <?php
                                                        if ($assetPartsFaultArray[$i]['isDelete']) {
                                                            $checked = "checked";
                                                        } else {
                                                            $checked = null;
                                                        }
                                                        ?>
                                                        <td>
                                                            <input style="display:none;" type="checkbox" name="assetPartsFaultId[]"
                                                                   value="<?php echo $assetPartsFaultArray[$i]['assetPartsFaultId']; ?>">
                                                            <input <?php echo $checked; ?> type="checkbox" name="isDelete[]"
                                                                                           value="<?php echo $assetPartsFaultArray[$i]['isDelete']; ?>">
                                                        </td>
                                                    </tr>
                                                    <?php
                                                }
                                                ...
                                                <tr>
                                                    <td colspan="7" valign="top" align="center"><?php
                                                        $assetPartsFault->exceptionMessage(
                    ...
                    <div class="col-xs-3 col-sm-3 col-md-3 pagination">
                        <div class="pull-right">
                            <button class="delete btn btn-warning" type="button" 
                                    ...
                                    echo $assetPartsFault->getControllerPath();
                                    ?>', '<?php echo $assetPartsFault->getViewPath(); ?>', '<?php echo $securityToken; ?>');">
...
if ((isset($_POST['method']) == 'new' || isset($_POST['method']) == 'read') && $_POST['type'] == 'form') {
        ...
        <div id="content" style="opacity: 1;">
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            <input type="hidden" name="assetPartsFaultId" id="assetPartsFaultId" value="<?php
                            if (isset($_POST['assetPartsFaultId'])) {
                                echo $_POST['assetPartsFaultId'];
                            }
                            ?>">
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                            ...
                                            <select name="assetId" id="assetId" class="chzn-select form-control">
                                                ...
                                                if (is_array($assetArray)) {
                                                    ...
                                                    if ($totalRecord > 0) {
                                                        $d = 1;
                                                        for ($i = 0; $i < $totalRecord; $i++) {
                                                            if ($assetPartsFaultArray[0]['assetId'] == $assetArray[$i]['assetId']) {
                                                                $selected = "selected";
                                                            } else {
                                                                $selected = null;
                                                            }
                                    ...
                                    <div class="col-xs-6 col-sm-6 col-md-6 form-group" id="assetPartsIdForm">
                                        <label for="assetPartsId" class="control-label col-xs-4 col-sm-4 col-md-4"><strong><?php
                                                echo ucfirst(
                                                        $leafTranslation['assetPartsIdLabel']
                                                );
                                                ?></strong></label>

                                        <div class="col-xs-8 col-sm-8 col-md-8">
                                            <select name="assetPartsId" id="assetPartsId" class="chzn-select form-control">
                                                <option value=""></option>
                                                <?php
                                                if (is_array($assetPartsArray)) {
                                                    $totalRecord = intval(count($assetPartsArray));
                                                    if ($totalRecord > 0) {
                                                        $d = 1;
                                                        for ($i = 0; $i < $totalRecord; $i++) {
                                                            if ($assetPartsFaultArray[0]['assetPartsId'] == $assetPartsArray[$i]['assetPartsId']) {
                                                                $selected = "selected";
                                                            } else {
                                                                $selected = null;
                                                            }
                                                            ?>
                                                            <option
                                                                value="<?php echo $assetPartsArray[$i]['assetPartsId']; ?>" <?php echo $selected; ?>><?php echo $d; ?>
                                                                . <?php echo $assetPartsArray[$i]['assetPartsDescription']; ?></option>
                                                            <?php
                                                            $d++;
                                                        }
                                                    } else {
                                                    ...
                                                    <option value=""><?php echo $t['notAvailableTextLabel']; ?></option>
                                                <?php } ?>
                                            </select> <span class="help-block" id="assetPartsIdHelpMe"></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <select name="assetMaintenanceCodeId" id="assetMaintenanceCodeId"
                                                ...
                                                if (is_array($assetMaintenanceCodeArray)) {
                                                    ...
                                                    if ($totalRecord > 0) {
                                                        $d = 1;
                                                        for ($i = 0; $i < $totalRecord; $i++) {
                                                            if ($assetPartsFaultArray[0]['assetMaintenanceCodeId'] == $assetMaintenanceCodeArray[$i]['assetMaintenanceCodeId']) {
                                                                $selected = "selected";
                                                            } else {
                                                                $selected = null;
                                                            }
                                        ...
                                        <div class="col-xs-8 col-sm-8 col-md-8">
                                            <div class="input-group">
                                                ...
                                                ?>
                                                       ...
                                                       ?>" value="<?php
                                                       if (isset($assetPartsFaultArray) && is_array($assetPartsFaultArray)) {
                                                           echo htmlentities($assetPartsFaultArray[0]['documentNumber']);
                                                       }
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    ...
                                    if (isset($assetPartsFaultArray) && is_array($assetPartsFaultArray)) {
                                        ...
                                        $valueArray = $assetPartsFaultArray[0]['assetPartsFaultDate'];
                                        if ($dateConvert->checkDate($valueArray)) {
                                            $valueData = explode('-', $valueArray);
                                            $year = $valueData[0];
                                            $month = $valueData[1];
                                    ...
                                    ?>
                                    <div class="col-xs-6 col-sm-6 col-md-6 form-group" id="assetPartsFaultDateForm">
                                        <label for="assetPartsFaultDate" class="control-label col-xs-4 col-sm-4 col-md-4"><strong><?php
                                                echo ucfirst(
                                                        $leafTranslation['assetPartsFaultDateLabel']
                                                );
                                                ?></strong></label>

                                        <div class="col-xs-8 col-sm-8 col-md-8">
                                            <div class="input-group">
                                                <input type="text" class="form-control" name="assetPartsFaultDate" id="assetPartsFaultDate"
                                                       value="<?php
                                                       if (isset($value)) {
                                                           echo $value;
                                                       }
                                                ...
                                                <span class="input-group-addon"><img src="./images/icons/calendar.png"
                                                                                     id="assetPartsFaultDateImage"></span>
                                            </div>
                                            <span class="help-block" id="assetPartsFaultDateHelpMe"></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group" id="assetPartsFaultDescriptionForm">
                                        <div class="col-xs-12 col-sm-12 col-md-12">
                                            <textarea class="form-control" rows="5" name="assetPartsFaultDescription"
                                                      id="assetPartsFaultDescription"><?php
                                                          if (isset($assetPartsFaultArray[0]['assetPartsFaultDescription'])) {
                                                              echo htmlentities($assetPartsFaultArray[0]['assetPartsFaultDescription']);
                                                          }
                                                          ?></textarea> <span class="help-block" id="assetPartsFaultDescriptionHelpMe"></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <script type="text/javascript">
                $(document).ready(function() {
                    ...
                    validateMeNumeric('assetPartsFaultId');
                    validateMeNumeric('assetId');
                    validateMeNumeric('assetPartsId');
                    validateMeNumeric('assetMaintenanceCodeId');
                    
                    $('#assetPartsFaultDate').datepicker({
                        format: "<?php echo $systemFormat['systemSettingDateFormat']; ?>"
                    }).on('changeDate', function() {
                        $(this).datepicker('hide');
                    });
    <?php if ($_POST['method'] == "new") { ?>
        ...
        <?php if ($leafAccess['leafAccessCreateValue'] == 1) { ?>
                            $('#newRecordButton1')
                                    .removeClass().addClass('btn btn-success').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $assetPartsFault->getControllerPath(); ?>','<?php echo $assetPartsFault->getViewPath(); ?>','<?php echo $securityToken; ?>',1)");
                            $('#newRecordButton2')
                                    .removeClass().addClass('btn dropdown-toggle btn-success');
                            $('#newRecordButton3').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $assetPartsFault->getControllerPath(); ?>','<?php echo $assetPartsFault->getViewPath(); ?>','<?php echo $securityToken; ?>',1)");
                            $('#newRecordButton4').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $assetPartsFault->getControllerPath(); ?>','<?php echo $assetPartsFault->getViewPath(); ?>','<?php echo $securityToken; ?>',2)");
                            $('#newRecordButton5').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $assetPartsFault->getControllerPath(); ?>','<?php echo $assetPartsFault->getViewPath(); ?>','<?php echo $securityToken; ?>',3)");
                            $('#newRecordButton6').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $assetPartsFault->getControllerPath(); ?>','<?php echo $assetPartsFault->getViewPath(); ?>','<?php echo $securityToken; ?>',4)");
                            $('#newRecordButton7').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $assetPartsFault->getControllerPath(); ?>','<?php echo $assetPartsFault->getViewPath(); ?>','<?php echo $securityToken; ?>',5)");
        <?php } else { ?>
                            $('#newRecordButton1')
        ...
        if ($_POST['assetPartsFaultId']) {
            ...
            <?php if ($leafAccess['leafAccessUpdateValue'] == 1) { ?>
                                $('#updateRecordButton1')
                                        .removeClass().addClass('btn btn-info').attr('onClick', "updateRecord(<?php echo $leafId; ?>,'<?php echo $assetPartsFault->getControllerPath(); ?>','<?php echo $assetPartsFault->getViewPath(); ?>','<?php echo $securityToken; ?>',1,<?php echo $leafAccess['leafAccessDeleteValue']; ?>);");
                                $('#updateRecordButton2')
                                        .removeClass().addClass('btn dropdown-toggle btn-info');
                                $('#updateRecordButton3').attr('onClick', "updateRecord(<?php echo $leafId; ?>,'<?php echo $assetPartsFault->getControllerPath(); ?>','<?php echo $assetPartsFault->getViewPath(); ?>','<?php echo $securityToken; ?>',1,<?php echo $leafAccess['leafAccessDeleteValue']; ?>);");
                                $('#updateRecordButton4').attr('onClick', "updateRecord(<?php echo $leafId; ?>,'<?php echo $assetPartsFault->getControllerPath(); ?>','<?php echo $assetPartsFault->getViewPath(); ?>','<?php echo $securityToken; ?>',2,<?php echo $leafAccess['leafAccessDeleteValue']; ?>);");
                                $('#updateRecordButton5').attr('onClick', "updateRecord(<?php echo $leafId; ?>,'<?php echo $assetPartsFault->getControllerPath(); ?>','<?php echo $assetPartsFault->getViewPath(); ?>','<?php echo $securityToken; ?>',3,<?php echo $leafAccess['leafAccessDeleteValue']; ?>);");
            <?php } else { ?>
                                $('#updateRecordButton1')
                                        .removeClass().addClass(' btn btn-info disabled');
                                $('#updateRecordButton2')
            ...
            <?php if ($leafAccess['leafAccessDeleteValue'] == 1) { ?>
                                $('#deleteRecordButton')
                                        ...
                                        .attr('onClick', "deleteRecord(<?php echo $leafId; ?>,'<?php echo $assetPartsFault->getControllerPath(); ?>','<?php echo $assetPartsFault->getViewPath(); ?>','<?php echo $securityToken; ?>',<?php echo $leafAccess['leafAccessDeleteValue']; ?>);");
            <?php } else { ?>
                                $('#deleteRecordButton')
                                        .removeClass().addClass('btn btn-danger disabled')
                                        .attr('onClick', '');
    ...
    <?php } ?>
    <script type="text/javascript" src="./v3/financial/fixedAsset/javascript/assetPartsFault.js"></script>
    <hr>
