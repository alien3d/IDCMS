...
require_once($newFakeDocumentRoot . "v3/financial/fixedAsset/controller/assetPartsController.php");
...
$translator->setCurrentTable('assetParts');
...
if (isset($_POST)) {
    if (isset($_POST['method'])) {
        $assetParts = new \Core\Financial\FixedAsset\AssetParts\Controller\AssetPartsClass();
        define('LIMIT', 10);
        ...
        if (isset($_POST ['query'])) {
            $assetParts->setFieldQuery($_POST ['query']);
        }
        if (isset($_POST ['filter'])) {
            $assetParts->setGridQuery($_POST ['filter']);
        }
        if (isset($_POST ['character'])) {
            $assetParts->setCharacterQuery($_POST['character']);
        }
        if (isset($_POST ['dateRangeStart'])) {
            $assetParts->setDateRangeStartQuery($_POST['dateRangeStart']);
            //explode the data to get day,month,year
            $start = explode('-', $_POST ['dateRangeStart']);
            $assetParts->setStartDay($start[2]);
            $assetParts->setStartMonth($start[1]);
            $assetParts->setStartYear($start[0]);
        }
        if (isset($_POST ['dateRangeEnd']) && (strlen($_POST['dateRangeEnd']) > 0)) {
            $assetParts->setDateRangeEndQuery($_POST['dateRangeEnd']);
            //explode the data to get day,month,year
            $start = explode('-', $_POST ['dateRangeEnd']);
            $assetParts->setEndDay($start[2]);
            $assetParts->setEndMonth($start[1]);
            $assetParts->setEndYear($start[0]);
        }
        if (isset($_POST ['dateRangeType'])) {
            $assetParts->setDateRangeTypeQuery($_POST['dateRangeType']);
        }
        if (isset($_POST ['dateRangeExtraType'])) {
            $assetParts->setDateRangeExtraTypeQuery($_POST['dateRangeExtraType']);
        }
        $assetParts->setServiceOutput('html');
        $assetParts->setLeafId($leafId);
        $assetParts->execute();
        $assetArray = $assetParts->getAsset();
        if ($_POST['method'] == 'read') {
            $assetParts->setStart($offset);
            $assetParts->setLimit($limit); // normal system don't like paging..
            $assetParts->setPageOutput('html');
            $assetPartsArray = $assetParts->read();
            if (isset($assetPartsArray [0]['firstRecord'])) {
                $firstRecord = $assetPartsArray [0]['firstRecord'];
            }
            if (isset($assetPartsArray [0]['nextRecord'])) {
                $nextRecord = $assetPartsArray [0]['nextRecord'];
            }
            if (isset($assetPartsArray [0]['previousRecord'])) {
                $previousRecord = $assetPartsArray [0]['previousRecord'];
            }
            if (isset($assetPartsArray [0]['lastRecord'])) {
                $lastRecord = $assetPartsArray [0]['lastRecord'];
                $endRecord = $assetPartsArray [0]['lastRecord'];
            }
            $navigation = new \Core\Paging\HtmlPaging();
            $navigation->setLeafId($leafId);
            $navigation->setViewPath($assetParts->getViewPath());
            ...
            if (isset($assetPartsArray [0]['total'])) {
                $total = $assetPartsArray [0]['total'];
            } else {
                $total = 0;
            }
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu" style="text-align:left">
                                <li>
                                    ...
                                    echo $assetParts->getControllerPath();
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form class="form-horizontal">
                                        <input type="hidden" name="assetPartsIdPreview" id="assetPartsIdPreview">
                                        ...
                                        <div class="form-group" id="assetPartsCodeDiv">
                                            <label for="assetPartsCodePreview"
                                                   class="control-label col-xs-4 col-sm-4 col-md-4"><?php echo $leafTranslation['assetPartsCodeLabel']; ?></label>

                                            <div class="col-xs-8 col-sm-8 col-md-8">
                                                <input class="form-control" type="text" name="assetPartsCodePreview"
                                                       id="assetPartsCodePreview">
                                            </div>
                                        </div>
                                        <div class="form-group" id="assetPartsSerialNumberDiv">
                                            <label for="assetPartsSerialNumberPreview"
                                                   class="control-label col-xs-4 col-sm-4 col-md-4"><?php echo $leafTranslation['assetPartsSerialNumberLabel']; ?></label>

                                            <div class="col-xs-8 col-sm-8 col-md-8">
                                                <input class="form-control" type="text"
                                                       name="assetPartsSerialNumberPreview" id="assetPartsSerialNumberPreview">
                                            </div>
                                        </div>
                                        <div class="form-group" id="assetPartDescriptionDiv">
                                            <label for="assetPartDescriptionPreview"
                                                   class="control-label col-xs-4 col-sm-4 col-md-4"><?php echo $leafTranslation['assetPartDescriptionLabel']; ?></label>

                                            <div class="col-xs-8 col-sm-8 col-md-8">
                                                <input class="form-control" type="text" name="assetPartDescriptionPreview"
                                                       id="assetPartDescriptionPreview">
                                            </div>
                                        </div>
                                    </form>
                                </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="panel panel-default">
                                <table class="table table table-bordered table-striped table-condensed table-hover smart-form has-tickbox" id="tableData">
                                    ...
                                    <th width="75px">
                                    <div align="center"><?php echo ucwords($leafTranslation['assetPartsCodeLabel']); ?></div>
                                    </th>
                                    <th width="100px">
                                    <div align="center"><?php echo ucwords($leafTranslation['assetPartsSerialNumberLabel']); ?></div>
                                    </th>
                                    <th><?php echo ucwords($leafTranslation['assetPartDescriptionLabel']); ?></th>
                                    <th width="100px">
                                            ...
                                            if (is_array($assetPartsArray)) {
                                                ...
                                                if ($totalRecord > 0) {
                                                    ...
                                                    for ($i = 0; $i < $totalRecord; $i++) {
                                                        ...
                                                        ?>
                                                        <tr <?php
                                                        if ($assetPartsArray[$i]['isDelete'] == 1) {
                                                            echo "class=\"danger\"";
                                                        } else {
                                                            if ($assetPartsArray[$i]['isDraft'] == 1) {
                                                                echo "class=\"warning\"";
                                                            }
                                                        }
                                                        ?>>
                                                            ...
                                                            <td align="center">
                                                                <div class="btn-group" align="center">
                                                                    <button type="button"  class="btn btn-info btn-sm" title="Edit"
                                                                            ...
                                                                            echo intval(
                                                                                    $assetPartsArray [$i]['assetPartsId']
                                                                            );
                                                                    ...
                                                                    <button type="button"  class="btn btn-danger btn-sm" title="Delete"
                                                                            ...
                                                                            ?>', '<?php
                                                                            echo rawurlencode(
                                                                                    $assetPartsArray [$i]['assetDescription']
                                                                            );
                                                                            ?>', '<?php
                                                                            echo rawurlencode(
                                                                                    $assetPartsArray [$i]['assetPartsCode']
                                                                            );
                                                                            ?>', '<?php
                                                                            echo rawurlencode(
                                                                                    $assetPartsArray [$i]['assetPartsSerialNumber']
                                                                            );
                                                                            ?>', '<?php
                                                                            echo rawurlencode(
                                                                                    $assetPartsArray [$i]['assetPartDescription']
                                                                            );
                                                                            ?>');">
                                                            ...
                                                            <td>
                                                                <div class="pull-left">
                                                                    <?php
                                                                    if (isset($assetPartsArray[$i]['assetDescription'])) {
                                                                        if (isset($_POST['query']) || isset($_POST['character'])) {
                                                                            if (isset($_POST['query']) && strlen($_POST['query']) > 0) {
                                                                                if (strpos(
                                                                                                $assetPartsArray[$i]['assetDescription'], $_POST['query']
                                                                                        ) !== false
                                                                                ) {
                                                                                    echo str_replace(
                                                                                            $_POST['query'], "<span class=\"label label-info\">" . $_POST['query'] . "</span>", $assetPartsArray[$i]['assetDescription']
                                                                                    );
                                                                                } else {
                                                                                    echo $assetPartsArray[$i]['assetDescription'];
                                                                                }
                                                                            } else {
                                                                                if (isset($_POST['character']) && strlen($_POST['character']) > 0) {
                                                                                    if (strpos(
                                                                                                    $assetPartsArray[$i]['assetDescription'], $_POST['character']
                                                                                            ) !== false
                                                                                    ) {
                                                                                        echo str_replace(
                                                                                                $_POST['character'], "<span class=\"label label-info\">" . $_POST['character'] . "</span>", $assetPartsArray[$i]['assetDescription']
                                                                                        );
                                                                                    } else {
                                                                                        echo $assetPartsArray[$i]['assetDescription'];
                                                                                    }
                                                            ...
                                                            <td>
                                                                <div class="pull-left">
                                                                    <?php
                                                                    if (isset($assetPartsArray[$i]['assetPartsCode'])) {
                                                                        if (isset($_POST['query']) || isset($_POST['character'])) {
                                                                            if (isset($_POST['query']) && strlen($_POST['query']) > 0) {
                                                                                if (strpos(
                                                                                                strtolower($assetPartsArray[$i]['assetPartsCode']), strtolower($_POST['query'])
                                                                                        ) !== false
                                                                                ) {
                                                                                    echo str_replace(
                                                                                            $_POST['query'], "<span class=\"label label-info\">" . $_POST['query'] . "</span>", $assetPartsArray[$i]['assetPartsCode']
                                                                                    );
                                                                                } else {
                                                                                    echo $assetPartsArray[$i]['assetPartsCode'];
                                                                                }
                                                                            } else {
                                                                                if (isset($_POST['character']) && strlen($_POST['character']) > 0) {
                                                                                    if (strpos(
                                                                                                    strtolower($assetPartsArray[$i]['assetPartsCode']), strtolower($_POST['character'])
                                                                                            ) !== false
                                                                                    ) {
                                                                                        echo str_replace(
                                                                                                $_POST['character'], "<span class=\"label label-info\">" . $_POST['character'] . "</span>", $assetPartsArray[$i]['assetPartsCode']
                                                                                        );
                                                                                    } else {
                                                                                        echo $assetPartsArray[$i]['assetPartsCode'];
                                                                                    }
                                                            ...
                                                            <td>
                                                                <div class="pull-left">
                                                                    <?php
                                                                    if (isset($assetPartsArray[$i]['assetPartsSerialNumber'])) {
                                                                        if (isset($_POST['query']) || isset($_POST['character'])) {
                                                                            if (isset($_POST['query']) && strlen($_POST['query']) > 0) {
                                                                                if (strpos(
                                                                                                strtolower($assetPartsArray[$i]['assetPartsSerialNumber']), strtolower($_POST['query'])
                                                                                        ) !== false
                                                                                ) {
                                                                                    echo str_replace(
                                                                                            $_POST['query'], "<span class=\"label label-info\">" . $_POST['query'] . "</span>", $assetPartsArray[$i]['assetPartsSerialNumber']
                                                                                    );
                                                                                } else {
                                                                                    echo $assetPartsArray[$i]['assetPartsSerialNumber'];
                                                                                }
                                                                            } else {
                                                                                if (isset($_POST['character']) && strlen($_POST['character']) > 0) {
                                                                                    if (strpos(
                                                                                                    strtolower($assetPartsArray[$i]['assetPartsSerialNumber']), strtolower($_POST['character'])
                                                                                            ) !== false
                                                                                    ) {
                                                                                        echo str_replace(
                                                                                                $_POST['character'], "<span class=\"label label-info\">" . $_POST['character'] . "</span>", $assetPartsArray[$i]['assetPartsSerialNumber']
                                                                                        );
                                                                                    } else {
                                                                                        echo $assetPartsArray[$i]['assetPartsSerialNumber'];
                                                                                    }
                                                            ...
                                                            <td>
                                                                <div class="pull-left">
                                                                    <?php
                                                                    if (isset($assetPartsArray[$i]['assetPartDescription'])) {
                                                                        if (isset($_POST['query']) || isset($_POST['character'])) {
                                                                            if (isset($_POST['query']) && strlen($_POST['query']) > 0) {
                                                                                if (strpos(
                                                                                                strtolower($assetPartsArray[$i]['assetPartDescription']), strtolower($_POST['query'])
                                                                                        ) !== false
                                                                                ) {
                                                                                    echo str_replace(
                                                                                            $_POST['query'], "<span class=\"label label-info\">" . $_POST['query'] . "</span>", $assetPartsArray[$i]['assetPartDescription']
                                                                                    );
                                                                                } else {
                                                                                    echo $assetPartsArray[$i]['assetPartDescription'];
                                                                                }
                                                                            } else {
                                                                                if (isset($_POST['character']) && strlen($_POST['character']) > 0) {
                                                                                    if (strpos(
                                                                                                    strtolower($assetPartsArray[$i]['assetPartDescription']), strtolower($_POST['character'])
                                                                                            ) !== false
                                                                                    ) {
                                                                                        echo str_replace(
                                                                                                $_POST['character'], "<span class=\"label label-info\">" . $_POST['character'] . "</span>", $assetPartsArray[$i]['assetPartDescription']
                                                                                        );
                                                                                    } else {
                                                                                        echo $assetPartsArray[$i]['assetPartDescription'];
                                                                                    }
                                                            ...
                                                            <td>
                                                                <div align="center">
                                                                    <?php
                                                                    if (isset($assetPartsArray[$i]['executeBy'])) {
                                                                        if (isset($_POST['query']) || isset($_POST['character'])) {
                                                                            if (isset($_POST['query']) && strlen($_POST['query']) > 0) {
                                                                                if (strpos($assetPartsArray[$i]['staffName'], $_POST['query']) !== false) {
                                                                                    echo str_replace(
                                                                                            $_POST['query'], "<span class=\"label label-info\">" . $_POST['query'] . "</span>", $assetPartsArray[$i]['staffName']
                                                                                    );
                                                                                } else {
                                                                                    echo $assetPartsArray[$i]['staffName'];
                                                                                }
                                                                            } else {
                                                                                if (isset($_POST['character']) && strlen($_POST['character']) > 0) {
                                                                                    if (strpos(
                                                                                                    $assetPartsArray[$i]['staffName'], $_POST['character']
                                                                                            ) !== false
                                                                                    ) {
                                                                                        echo str_replace(
                                                                                                $_POST['character'], "<span class=\"label label-info\">" . $_POST['character'] . "</span>", $assetPartsArray[$i]['staffName']
                                                                                        );
                                                                                    } else {
                                                                                        echo $assetPartsArray[$i]['staffName'];
                                                                                    }
                                                            ...
                                                            <?php
                                                            if (isset($assetPartsArray[$i]['executeTime'])) {
                                                                $valueArray = $assetPartsArray[$i]['executeTime'];
                                                            ...
                                                            ?>
                                                            <td>
                                                                <input style="display:none;" type="checkbox" name="assetPartsId[]"
                                                                       value="<?php echo $assetPartsArray[$i]['assetPartsId']; ?>">
                                                                <input <?php echo $checked; ?> type="checkbox" name="isDelete[]"
                                                                                               value="<?php echo $assetPartsArray[$i]['isDelete']; ?>">
                                                            </td>
                                                        </tr>
                                                        <?php
                                                    }
                        ...
                        <div class="col-xs-3 col-sm-3 col-md-3 pagination">
                            <div class="pull-right">
                                <button class="delete btn btn-warning" type="button" 
                                        ...
                                        echo $assetParts->getControllerPath();
                                        ?>', '<?php echo $assetParts->getViewPath(); ?>', '<?php echo $securityToken; ?>');">
...
if ((isset($_POST['method']) == 'new' || isset($_POST['method']) == 'read') && $_POST['type'] == 'form') {
        ...
        <div id="content" style="opacity: 1;">
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            <input type="hidden" name="assetPartsId" id="assetPartsId" value="<?php
                            if (isset($_POST['assetPartsId'])) {
                                echo $_POST['assetPartsId'];
                            }
                            ?>">
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                            ...
                                            <select name="assetId" id="assetId" class="chzn-select form-control">
                                                ...
                                                if (is_array($assetArray)) {
                                                    ...
                                                    if ($totalRecord > 0) {
                                                        $d = 1;
                                                        for ($i = 0; $i < $totalRecord; $i++) {
                                                            if ($assetPartsArray[0]['assetId'] == $assetArray[$i]['assetId']) {
                                                                $selected = "selected";
                                                            } else {
                                                                $selected = null;
                                                            }
                                    ...
                                    <div class="col-xs-6 col-sm-6 col-md-6 form-group" id="assetPartsCodeForm">
                                        <label for="assetPartsCode" class="control-label col-xs-4 col-sm-4 col-md-4"><strong><?php
                                                echo ucfirst(
                                                        $leafTranslation['assetPartsCodeLabel']
                                                );
                                                ?></strong></label>

                                        <div class="col-xs-8 col-sm-8 col-md-8">
                                            <div class="input-group">
                                                <input type="text" class="form-control" name="assetPartsCode" id="assetPartsCode"
                                                       value="<?php
                                                       if (isset($assetPartsArray) && is_array($assetPartsArray)) {
                                                           echo htmlentities($assetPartsArray[0]['assetPartsCode']);
                                                       }
                                                       ?>" maxlength="16">
                                                <span class="input-group-addon"><img src="./images/icons/document-code.png"></span>
                                            </div>
                                            <span class="help-block" id="assetPartsCodeHelpMe"></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="col-xs-6 col-sm-6 col-md-6 form-group" id="assetPartsSerialNumberForm">
                                        <label for="assetPartsSerialNumber" class="control-label col-xs-4 col-sm-4 col-md-4"><strong><?php
                                                echo ucfirst(
                                                        $leafTranslation['assetPartsSerialNumberLabel']
                                                );
                                                ?></strong></label>

                                        <div class="col-xs-8 col-sm-8 col-md-8">
                                            <input type="text" class="form-control" name="assetPartsSerialNumber"
                                                   id="assetPartsSerialNumber" value="<?php
                                                   if (isset($assetPartsArray) && is_array($assetPartsArray)) {
                                                       echo htmlentities($assetPartsArray[0]['assetPartsSerialNumber']);
                                                   }
                                                   ?>"> <span class="help-block" id="assetPartsSerialNumberHelpMe"></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group" id="assetPartDescriptionForm">
                                        <div class="col-xs-8 col-sm-8 col-md-8">
                                            <textarea class="form-control" rows="5" name="assetPartDescription"
                                                      id="assetPartDescription"><?php
                                                          if (isset($assetPartsArray[0]['assetPartDescription'])) {
                                                              echo htmlentities($assetPartsArray[0]['assetPartDescription']);
                                                          }
                                                          ?> </textarea> <span class="help-block" id="assetPartDescriptionHelpMe"></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <script type="text/javascript">
                $(document).ready(function() {
                    ...
                    validateMeAlphaNumeric('assetPartsCode');
                    validateMeAlphaNumeric('assetPartsSerialNumber');
    <?php if ($_POST['method'] == "new") { ?>
                        $('#resetRecordButton')
                                .removeClass().addClass('btn btn-default');
        <?php if ($leafAccess['leafAccessCreateValue'] == 1) { ?>
                            $('#newRecordButton1')
                                    .removeClass().addClass('btn btn-success').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $assetParts->getControllerPath(); ?>','<?php echo $assetParts->getViewPath(); ?>','<?php echo $securityToken; ?>',1)");
                            $('#newRecordButton2')
                                    .removeClass().addClass('btn dropdown-toggle btn-success');
                            $('#newRecordButton3').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $assetParts->getControllerPath(); ?>','<?php echo $assetParts->getViewPath(); ?>','<?php echo $securityToken; ?>',1)");
                            $('#newRecordButton4').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $assetParts->getControllerPath(); ?>','<?php echo $assetParts->getViewPath(); ?>','<?php echo $securityToken; ?>',2)");
                            $('#newRecordButton5').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $assetParts->getControllerPath(); ?>','<?php echo $assetParts->getViewPath(); ?>','<?php echo $securityToken; ?>',3)");
                            $('#newRecordButton6').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $assetParts->getControllerPath(); ?>','<?php echo $assetParts->getViewPath(); ?>','<?php echo $securityToken; ?>',4)");
                            $('#newRecordButton7').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $assetParts->getControllerPath(); ?>','<?php echo $assetParts->getViewPath(); ?>','<?php echo $securityToken; ?>',5)");
        <?php } else { ?>
                            $('#newRecordButton1')
        ...
        if ($_POST['assetPartsId']) {
            ...
            <?php if ($leafAccess['leafAccessUpdateValue'] == 1) { ?>
                                $('#updateRecordButton1')
                                        .removeClass().addClass('btn btn-info').attr('onClick', "updateRecord(<?php echo $leafId; ?>,'<?php echo $assetParts->getControllerPath(); ?>','<?php echo $assetParts->getViewPath(); ?>','<?php echo $securityToken; ?>',1,<?php echo $leafAccess['leafAccessDeleteValue']; ?>);");
                                $('#updateRecordButton2')
                                        .removeClass().addClass('btn dropdown-toggle btn-info');
                                $('#updateRecordButton3').attr('onClick', "updateRecord(<?php echo $leafId; ?>,'<?php echo $assetParts->getControllerPath(); ?>','<?php echo $assetParts->getViewPath(); ?>','<?php echo $securityToken; ?>',1,<?php echo $leafAccess['leafAccessDeleteValue']; ?>);");
                                $('#updateRecordButton4').attr('onClick', "updateRecord(<?php echo $leafId; ?>,'<?php echo $assetParts->getControllerPath(); ?>','<?php echo $assetParts->getViewPath(); ?>','<?php echo $securityToken; ?>',2,<?php echo $leafAccess['leafAccessDeleteValue']; ?>);");
                                $('#updateRecordButton5').attr('onClick', "updateRecord(<?php echo $leafId; ?>,'<?php echo $assetParts->getControllerPath(); ?>','<?php echo $assetParts->getViewPath(); ?>','<?php echo $securityToken; ?>',3,<?php echo $leafAccess['leafAccessDeleteValue']; ?>);");
            <?php } else { ?>
                                $('#updateRecordButton1')
                                        .removeClass().addClass(' btn btn-info disabled');
                                $('#updateRecordButton2')
            ...
            <?php if ($leafAccess['leafAccessDeleteValue'] == 1) { ?>
                                $('#deleteRecordButton')
                                        ...
                                        .attr('onClick', "deleteRecord(<?php echo $leafId; ?>,'<?php echo $assetParts->getControllerPath(); ?>','<?php echo $assetParts->getViewPath(); ?>','<?php echo $securityToken; ?>',<?php echo $leafAccess['leafAccessDeleteValue']; ?>);");
            <?php } else { ?>
                                $('#deleteRecordButton')
                                        .removeClass().addClass('btn btn-danger disabled')
                                        .attr('onClick', '');
    ...
    <?php } ?>
    <script type="text/javascript" src="./v3/financial/fixedAsset/javascript/assetParts.js"></script>
    <hr>
