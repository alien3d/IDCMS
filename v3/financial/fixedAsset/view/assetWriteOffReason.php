...
require_once($newFakeDocumentRoot . "v3/financial/fixedAsset/controller/assetWriteOffReasonController.php");
...
$translator->setCurrentTable('assetWriteOffReason');
...
if (isset($_POST)) {
    if (isset($_POST['method'])) {
        $assetWriteOffReason = new \Core\Financial\FixedAsset\AssetWriteOffReason\Controller\AssetWriteOffReasonClass();
        define('LIMIT', 10);
        ...
        if (isset($_POST ['query'])) {
            $assetWriteOffReason->setFieldQuery($_POST ['query']);
        }
        if (isset($_POST ['filter'])) {
            $assetWriteOffReason->setGridQuery($_POST ['filter']);
        }
        if (isset($_POST ['character'])) {
            $assetWriteOffReason->setCharacterQuery($_POST['character']);
        }
        if (isset($_POST ['dateRangeStart'])) {
            $assetWriteOffReason->setDateRangeStartQuery($_POST['dateRangeStart']);
            //explode the data to get day,month,year
            $start = explode('-', $_POST ['dateRangeStart']);
            $assetWriteOffReason->setStartDay($start[2]);
            $assetWriteOffReason->setStartMonth($start[1]);
            $assetWriteOffReason->setStartYear($start[0]);
        }
        if (isset($_POST ['dateRangeEnd']) && (strlen($_POST['dateRangeEnd']) > 0)) {
            $assetWriteOffReason->setDateRangeEndQuery($_POST['dateRangeEnd']);
            //explode the data to get day,month,year
            $start = explode('-', $_POST ['dateRangeEnd']);
            $assetWriteOffReason->setEndDay($start[2]);
            $assetWriteOffReason->setEndMonth($start[1]);
            $assetWriteOffReason->setEndYear($start[0]);
        }
        if (isset($_POST ['dateRangeType'])) {
            $assetWriteOffReason->setDateRangeTypeQuery($_POST['dateRangeType']);
        }
        if (isset($_POST ['dateRangeExtraType'])) {
            $assetWriteOffReason->setDateRangeExtraTypeQuery($_POST['dateRangeExtraType']);
        }
        $assetWriteOffReason->setServiceOutput('html');
        $assetWriteOffReason->setLeafId($leafId);
        $assetWriteOffReason->execute();
        if ($_POST['method'] == 'read') {
            $assetWriteOffReason->setStart($offset);
            $assetWriteOffReason->setLimit($limit); // normal system don't like paging..
            $assetWriteOffReason->setPageOutput('html');
            $assetWriteOffReasonArray = $assetWriteOffReason->read();
            if (isset($assetWriteOffReasonArray [0]['firstRecord'])) {
                $firstRecord = $assetWriteOffReasonArray [0]['firstRecord'];
            }
            if (isset($assetWriteOffReasonArray [0]['nextRecord'])) {
                $nextRecord = $assetWriteOffReasonArray [0]['nextRecord'];
            }
            if (isset($assetWriteOffReasonArray [0]['previousRecord'])) {
                $previousRecord = $assetWriteOffReasonArray [0]['previousRecord'];
            }
            if (isset($assetWriteOffReasonArray [0]['lastRecord'])) {
                $lastRecord = $assetWriteOffReasonArray [0]['lastRecord'];
                $endRecord = $assetWriteOffReasonArray [0]['lastRecord'];
            }
            $navigation = new \Core\Paging\HtmlPaging();
            $navigation->setLeafId($leafId);
            $navigation->setViewPath($assetWriteOffReason->getViewPath());
            ...
            if (isset($assetWriteOffReasonArray [0]['total'])) {
                $total = $assetWriteOffReasonArray [0]['total'];
            } else {
                $total = 0;
            }
            ...
            <div class="row">
                <div class="pull-left btn-group col-xs-10 col-sm-10 col-md-10">
                    <button title="A" class="btn btn-success btn-sm" type="button" 
                            ...
                            echo $assetWriteOffReason->getViewPath();
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu" style="text-align:left">
                                <li>
                                    ...
                                    echo $assetWriteOffReason->getControllerPath();
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form class="form-horizontal">
                                        <input type="hidden" name="assetWriteOffReasonIdPreview" id="assetWriteOffReasonIdPreview">

                                        <div class="form-group" id="assetWriteOffReasonCodeDiv">
                                            <label for="assetWriteOffReasonCodePreview" class="control-label
                                                   col-md-4"><?php echo $leafTranslation['assetWriteOffReasonCodeLabel']; ?></label>

                                            <div class="col-xs-8 col-sm-8 col-md-8">
                                                <input class="form-control" type="text"
                                                       name="assetWriteOffReasonCodePreview" id="assetWriteOffReasonCodePreview">
                                            </div>
                                        </div>
                                        <div class="form-group" id="assetWriteOffReasonDescriptionDiv">
                                            <label for="assetWriteOffReasonDescriptionPreview"
                                                   class="control-label col-xs-4 col-sm-4 col-md-4"><?php echo $leafTranslation['assetWriteOffReasonDescriptionLabel']; ?></label>

                                            <div class="col-xs-8 col-sm-8 col-md-8">
                                                <input class="form-control" type="text"
                                                       name="assetWriteOffReasonDescriptionPreview"
                                                       id="assetWriteOffReasonDescriptionPreview">
                                            </div>
                                        </div>
                                    </form>
                                </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="panel panel-default">
                                <table class="table table table-bordered table-striped table-condensed table-hover smart-form has-tickbox" id="tableData">
                                    ...
                                    <th width="75px">
                                    <div align="center"><?php echo ucwords($leafTranslation['assetWriteOffReasonCodeLabel']); ?></div>
                                    </th>
                                    <th><?php echo ucwords($leafTranslation['assetWriteOffReasonDescriptionLabel']); ?></th>
                                    <th width="100px">
                                            ...
                                            if (is_array($assetWriteOffReasonArray)) {
                                                ...
                                                if ($totalRecord > 0) {
                                                    ...
                                                    for ($i = 0; $i < $totalRecord; $i++) {
                                                        ...
                                                        ?>
                                                        <tr <?php
                                                        if ($assetWriteOffReasonArray[$i]['isDelete'] == 1) {
                                                            echo "class=\"danger\"";
                                                        } else {
                                                            if ($assetWriteOffReasonArray[$i]['isDraft'] == 1) {
                                                                echo "class=\"warning\"";
                                                            }
                                                        }
                                                        ?>>
                                                            ...
                                                            <td align="center">
																	<?php if($assetWriteOffReasonArray [$i]['assetWriteOffReasonCode'] !='UNBL') { ?>
                                                                <div class="btn-group" align="center">
                                                                    <button type="button"  class="btn btn-info btn-sm" title="Edit"
                                                                            ...
                                                                            echo intval(
                                                                                    $assetWriteOffReasonArray [$i]['assetWriteOffReasonId']
                                                                            );
                                                                    ...
                                                                    <button type="button"  class="btn btn-danger btn-sm" title="Delete"
                                                                            ...
                                                                            ?>', '<?php
                                                                            echo rawurlencode(
                                                                                    $assetWriteOffReasonArray [$i]['assetWriteOffReasonCode']
                                                                            );
                                                                            ?>', '<?php
                                                                            echo rawurlencode(
                                                                                    $assetWriteOffReasonArray [$i]['assetWriteOffReasonDescription']
                                                                            );
                                                                            ?>');">
                                                            ...
                                                            <td>
                                                                <div align="center">
                                                                    <?php
                                                                    if (isset($assetWriteOffReasonArray[$i]['assetWriteOffReasonCode'])) {
                                                                        if (isset($_POST['query']) || isset($_POST['character'])) {
                                                                            if (isset($_POST['query']) && strlen($_POST['query']) > 0) {
                                                                                if (strpos(
                                                                                    ...
                                                                                    echo str_replace(
                                                                                            $_POST['query'], "<span class=\"label label-info\">" . $_POST['query'] . "</span>", $assetWriteOffReasonArray[$i]['assetWriteOffReasonCode']
                                                                                    );
                                                                                } else {
                                                                                    echo $assetWriteOffReasonArray[$i]['assetWriteOffReasonCode'];
                                                                                }
                                                                            } else {
                                                                                if (isset($_POST['character']) && strlen($_POST['character']) > 0) {
                                                                                    if (strpos(
                                                                                        ...
                                                                                        echo str_replace(
                                                                                                $_POST['character'], "<span class=\"label label-info\">" . $_POST['character'] . "</span>", $assetWriteOffReasonArray[$i]['assetWriteOffReasonCode']
                                                                                        );
                                                                                    } else {
                                                                                        echo $assetWriteOffReasonArray[$i]['assetWriteOffReasonCode'];
                                                                                    }
                                                            ...
                                                            <td>
                                                                <div class="pull-left">
                                                                    <?php
                                                                    if (isset($assetWriteOffReasonArray[$i]['assetWriteOffReasonDescription'])) {
                                                                        if (isset($_POST['query']) || isset($_POST['character'])) {
                                                                            if (isset($_POST['query']) && strlen($_POST['query']) > 0) {
                                                                                if (strpos(
                                                                                                strtolower(
                                                                                    ...
                                                                                    echo str_replace(
                                                                                            $_POST['query'], "<span class=\"label label-info\">" . $_POST['query'] . "</span>", $assetWriteOffReasonArray[$i]['assetWriteOffReasonDescription']
                                                                                    );
                                                                                } else {
                                                                                    echo $assetWriteOffReasonArray[$i]['assetWriteOffReasonDescription'];
                                                                                }
                                                                            } else {
                                                                                if (isset($_POST['character']) && strlen($_POST['character']) > 0) {
                                                                                    if (strpos(
                                                                                        ...
                                                                                        echo str_replace(
                                                                                                $_POST['character'], "<span class=\"label label-info\">" . $_POST['character'] . "</span>", $assetWriteOffReasonArray[$i]['assetWriteOffReasonDescription']
                                                                                        );
                                                                                    } else {
                                                                                        echo $assetWriteOffReasonArray[$i]['assetWriteOffReasonDescription'];
                                                                                    }
                                                            ...
                                                            <td>
                                                                <div align="center">
                                                                    <?php
                                                                    if (isset($assetWriteOffReasonArray[$i]['executeBy'])) {
                                                                        if (isset($_POST['query']) || isset($_POST['character'])) {
                                                                            if (isset($_POST['query']) && strlen($_POST['query']) > 0) {
                                                                                if (strpos(
                                                                                                $assetWriteOffReasonArray[$i]['staffName'], $_POST['query']
                                                                                        ) !== false
                                                                                ) {
                                                                                    echo str_replace(
                                                                                            $_POST['query'], "<span class=\"label label-info\">" . $_POST['query'] . "</span>", $assetWriteOffReasonArray[$i]['staffName']
                                                                                    );
                                                                                } else {
                                                                                    echo $assetWriteOffReasonArray[$i]['staffName'];
                                                                                }
                                                                            } else {
                                                                                if (isset($_POST['character']) && strlen($_POST['character']) > 0) {
                                                                                    if (strpos(
                                                                                                    $assetWriteOffReasonArray[$i]['staffName'], $_POST['character']
                                                                                            ) !== false
                                                                                    ) {
                                                                                        echo str_replace(
                                                                                                $_POST['character'], "<span class=\"label label-info\">" . $_POST['character'] . "</span>", $assetWriteOffReasonArray[$i]['staffName']
                                                                                        );
                                                                                    } else {
                                                                                        echo $assetWriteOffReasonArray[$i]['staffName'];
                                                                                    }
                                                            ...
                                                            <?php
                                                            if (isset($assetWriteOffReasonArray[$i]['executeTime'])) {
                                                                $valueArray = $assetWriteOffReasonArray[$i]['executeTime'];
                                                            ...
                                                            <?php
                                                            if ($assetWriteOffReasonArray[$i]['isDelete']) {
                                                                $checked = "checked";
                                                            } else {
                                                                $checked = null;
                                                            }
                                                            ...
                                                            <td>
																<?php if($assetWriteOffReasonArray [$i]['assetWriteOffReasonCode'] !='UNBL') { ?>
                                                                <input style="display:none;" type="checkbox" name="assetWriteOffReasonId[]"
                                                                       value="<?php echo $assetWriteOffReasonArray[$i]['assetWriteOffReasonId']; ?>">
                                                                <input <?php echo $checked; ?> type="checkbox" name="isDelete[]"
                                                                                               value="<?php echo $assetWriteOffReasonArray[$i]['isDelete']; ?>">
																<?php } ?>
                                                            </td>
                                                        </tr>
                                                        <?php
                                                    ...
                                                    <tr>
                                                        <td colspan="7" valign="top" align="center"><?php
                                                            $assetWriteOffReason->exceptionMessage(
...
if ((isset($_POST['method']) == 'new' || isset($_POST['method']) == 'read') && $_POST['type'] == 'form') {
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            <input type="hidden" name="assetWriteOffReasonId" id="assetWriteOffReasonId" value="<?php
                            if (isset($_POST['assetWriteOffReasonId'])) {
                                echo $_POST['assetWriteOffReasonId'];
                            }
                            ?>">

                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group" id="assetWriteOffReasonCodeForm">
                                        <label for="assetWriteOffReasonCode"
                                               class="control-label col-xs-2 col-sm-2 col-md-2"><strong><?php
                                                       echo ucfirst(
                                                               $leafTranslation['assetWriteOffReasonCodeLabel']
                                                       );
                                                       ?></strong></label>

                                        <div class="control-label col-xs-4 col-sm-4 col-md-4">
                                            <input type="text" class="form-control" name="assetWriteOffReasonCode"
                                                   id="assetWriteOffReasonCode" value="<?php
                                                   if (isset($assetWriteOffReasonArray) && is_array($assetWriteOffReasonArray)) {
                                                       if (isset($assetWriteOffReasonArray[0]['assetWriteOffReasonCode'])) {
                                                           echo htmlentities($assetWriteOffReasonArray[0]['assetWriteOffReasonCode']);
                                                       }
                                                   }
                                                   ?>" maxlength="16"> <span class="help-block" id="assetWriteOffReasonCodeHelpMe"></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group" id="assetWriteOffReasonDescriptionForm">
                                        <div class="col-xs-12 col-sm-12 col-md-12">
                                            <textarea class="form-control" rows="5" name="assetWriteOffReasonDescription"
                                                      id="assetWriteOffReasonDescription"><?php
                                                          if (isset($assetWriteOffReasonArray[0]['assetWriteOffReasonDescription'])) {
                                                              echo htmlentities(
                                                                      $assetWriteOffReasonArray[0]['assetWriteOffReasonDescription']
                                                              );
                                                          }
                                                          ?> </textarea> <span class="help-block" id="assetWriteOffReasonDescriptionHelpMe"></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <?php if ($leafAccess['leafAccessCreateValue'] == 1) { ?>
                        ...
                        if (e.which === 78 && e.which === 18  && e.shiftKey) {
                            ...
                            newRecord(<?php echo $leafId; ?>, '<?php echo $assetWriteOffReason->getControllerPath(); ?>', '<?php echo $assetWriteOffReason->getViewPath(); ?>', '<?php echo $securityToken; ?>', 1);
    ...
    <?php if ($leafAccess['leafAccessUpdateValue'] == 1) { ?>
                        ...
                        if (e.which === 83 && e.which === 18  && e.shiftKey) {
                            ...
                            updateRecord(<?php echo $leafId; ?>, '<?php echo $assetWriteOffReason->getControllerPath(); ?>', '<?php echo $assetWriteOffReason->getViewPath(); ?>', '<?php echo $securityToken; ?>', 1, <?php echo $leafAccess['leafAccessDeleteValue']; ?>);
    ...
    <?php if ($leafAccess['leafAccessDeleteValue'] == 1) { ?>
                        ...
                        if (e.which === 88 && e.which === 18 && e.shiftKey) {
                            ...
                            deleteRecord(<?php echo $leafId; ?>, '<?php echo $assetWriteOffReason->getControllerPath(); ?>', '<?php echo $assetWriteOffReason->getViewPath(); ?>', '<?php echo $securityToken; ?>', <?php echo $leafAccess['leafAccessDeleteValue']; ?>);
    ...
    <?php } ?>
                    switch (e.keyCode) {
                        case 37:
                            previousRecord(<?php echo $leafId; ?>, '<?php echo $assetWriteOffReason->getControllerPath(); ?>', '<?php echo $assetWriteOffReason->getViewPath(); ?>', '<?php echo $securityToken; ?>', <?php echo $leafAccess['leafAccessUpdateValue']; ?>, <?php echo $leafAccess['leafAccessDeleteValue']; ?>);
                            
                            return false;
                            break;
                        case 39:
                            nextRecord(<?php echo $leafId; ?>, '<?php echo $assetWriteOffReason->getControllerPath(); ?>', '<?php echo $assetWriteOffReason->getViewPath(); ?>', '<?php echo $securityToken; ?>', <?php echo $leafAccess['leafAccessUpdateValue']; ?>, <?php echo $leafAccess['leafAccessDeleteValue']; ?>);
                ...
                $(document).ready(function() {
                    ...
                    validateMeAlphaNumeric('assetWriteOffReasonCode');
    <?php if ($_POST['method'] == "new") { ?>
                        $('#resetRecordButton')
                                .removeClass().addClass('btn btn-default');
        <?php if ($leafAccess['leafAccessCreateValue'] == 1) { ?>
                            $('#newRecordButton1')
                                    .removeClass().addClass('btn btn-success').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $assetWriteOffReason->getControllerPath(); ?>','<?php echo $assetWriteOffReason->getViewPath(); ?>','<?php echo $securityToken; ?>',1)");
                            $('#newRecordButton2')
                                    .removeClass().addClass('btn dropdown-toggle btn-success');
                            $('#newRecordButton3').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $assetWriteOffReason->getControllerPath(); ?>','<?php echo $assetWriteOffReason->getViewPath(); ?>','<?php echo $securityToken; ?>',1)");
                            $('#newRecordButton4').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $assetWriteOffReason->getControllerPath(); ?>','<?php echo $assetWriteOffReason->getViewPath(); ?>','<?php echo $securityToken; ?>',2)");
                            $('#newRecordButton5').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $assetWriteOffReason->getControllerPath(); ?>','<?php echo $assetWriteOffReason->getViewPath(); ?>','<?php echo $securityToken; ?>',3)");
                            $('#newRecordButton6').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $assetWriteOffReason->getControllerPath(); ?>','<?php echo $assetWriteOffReason->getViewPath(); ?>','<?php echo $securityToken; ?>',4)");
                            $('#newRecordButton7').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $assetWriteOffReason->getControllerPath(); ?>','<?php echo $assetWriteOffReason->getViewPath(); ?>','<?php echo $securityToken; ?>',5)");
        <?php } else { ?>
                            $('#newRecordButton1')
        ...
        if ($_POST['assetWriteOffReasonId']) {
            ?>
                            $('#newRecordButton1')
                                    .removeClass().addClass('btn btn-success disabled');
                            $('#newRecordButton2')
            ...
            <?php if ($leafAccess['leafAccessUpdateValue'] == 1) { ?>
                                $('#updateRecordButton1')
                                        .removeClass().addClass('btn btn-info').attr('onClick', "updateRecord(<?php echo $leafId; ?>,'<?php echo $assetWriteOffReason->getControllerPath(); ?>','<?php echo $assetWriteOffReason->getViewPath(); ?>','<?php echo $securityToken; ?>',1,<?php echo $leafAccess['leafAccessDeleteValue']; ?>);");
                                $('#updateRecordButton2')
                                        .removeClass().addClass('btn dropdown-toggle btn-info');
                                $('#updateRecordButton3').attr('onClick', "updateRecord(<?php echo $leafId; ?>,'<?php echo $assetWriteOffReason->getControllerPath(); ?>','<?php echo $assetWriteOffReason->getViewPath(); ?>','<?php echo $securityToken; ?>',1,<?php echo $leafAccess['leafAccessDeleteValue']; ?>);");
                                $('#updateRecordButton4').attr('onClick', "updateRecord(<?php echo $leafId; ?>,'<?php echo $assetWriteOffReason->getControllerPath(); ?>','<?php echo $assetWriteOffReason->getViewPath(); ?>','<?php echo $securityToken; ?>',2,<?php echo $leafAccess['leafAccessDeleteValue']; ?>);");
                                $('#updateRecordButton5').attr('onClick', "updateRecord(<?php echo $leafId; ?>,'<?php echo $assetWriteOffReason->getControllerPath(); ?>','<?php echo $assetWriteOffReason->getViewPath(); ?>','<?php echo $securityToken; ?>',3,<?php echo $leafAccess['leafAccessDeleteValue']; ?>);");
            <?php } else { ?>
                                $('#updateRecordButton1')
                                        .removeClass().addClass(' btn btn-info disabled');
                                $('#updateRecordButton2')
            ...
            <?php if ($leafAccess['leafAccessDeleteValue'] == 1) { ?>
                                $('#deleteRecordButton')
                                        ...
                                        .attr('onClick', "deleteRecord(<?php echo $leafId; ?>,'<?php echo $assetWriteOffReason->getControllerPath(); ?>','<?php echo $assetWriteOffReason->getViewPath(); ?>','<?php echo $securityToken; ?>',<?php echo $leafAccess['leafAccessDeleteValue']; ?>);");
            <?php } else { ?>
                                $('#deleteRecordButton')
                                        .removeClass().addClass('btn btn-danger disabled')
                                        .attr('onClick', '');
    ...
    <?php } ?>
    <script type="text/javascript" src="./v3/financial/fixedAsset/javascript/assetWriteOffReason.js"></script>
    <hr>
