function getUnitOfMeasurementCategory(leafId, url, securityToken) {
    $.ajax({type: 'GET', url: url, data: {offset: 0, limit: 99999, method: 'read', type: 'filter', securityToken: securityToken, leafId: leafId, filter: 'unitOfMeasurementCategory'}, beforeSend: function() {
            ...
            if (success === false) {
                ...
                $("#unitOfMeasurementCategoryId").html('').empty().html(data.data).trigger("chosen:updated");
...
function checkDuplicate(leafId, page, securityToken) {
    var $unitOfMeasurementCode = $("#unitOfMeasurementCode");
    if ($unitOfMeasurementCode.val().length === 0) {
        alert(t['oddTextLabel']);
        return false;
    }
    $.ajax({type: 'GET', url: page, data: {unitOfMeasurementCode: $unitOfMeasurementCode.val(), method: 'duplicate', securityToken: securityToken, leafId: leafId}, beforeSend: function() {
            var smileyRoll = './images/icons/smiley-roll.png';
            var $infoPanel = $('#infoPanel');
            $infoPanel.html('').empty().html("<span class='label label-warning'><img src='" + smileyRoll + "'>&nbsp;" + decodeURIComponent(t['loadingTextLabel']) + "....</span>");
            if ($infoPanel.is(':hidden')) {
            ...
            if (success === true) {
                if (total !== 0) {
                    $("#unitOfMeasurementCode").val('').focus();
                    $("#unitOfMeasurementCodeForm").removeClass().addClass("form-group has-error");
                ...
                $("#unitOfMeasurementForm").removeClass().addClass("form-group has-error");
            }
            if ($infoPanel.is(':hidden')) {
                $infoPanel.show();
            }
...
function showFormUpdate(leafId, url, urlList, securityToken, unitOfMeasurementId, updateAccess, deleteAccess) {
    sleep(500);
    $('a[rel=tooltip]').tooltip('hide');
    $.ajax({type: 'POST', url: urlList, data: {method: 'read', type: 'form', unitOfMeasurementId: unitOfMeasurementId, securityToken: securityToken, leafId: leafId}, beforeSend: function() {
            var smileyRoll = './images/icons/smiley-roll.png';
            var $infoPanel = $('#infoPanel');
            $infoPanel.html('').empty().html("<span class='label label-warning'><img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
            if ($infoPanel.is(':hidden')) {
...
function showModalDelete(unitOfMeasurementId, unitOfMeasurementCategoryId, unitOfMeasurementCode, unitOfMeasurementDescription, unitOfMeasurementBaseValue) {
    $('#unitOfMeasurementIdPreview').val('').val(decodeURIComponent(unitOfMeasurementId));
    $('#unitOfMeasurementCategoryIdPreview').val('').val(decodeURIComponent(unitOfMeasurementCategoryId));
    $('#unitOfMeasurementCodePreview').val('').val(decodeURIComponent(unitOfMeasurementCode));
    $('#unitOfMeasurementDescriptionPreview').val('').val(decodeURIComponent(unitOfMeasurementDescription));
    $('#unitOfMeasurementBaseValuePreview').val('').val(decodeURIComponent(unitOfMeasurementBaseValue));
    showMeModal('deletePreview', 1);
}
function deleteGridRecord(leafId, url, urlList, securityToken) {
    $.ajax({type: 'POST', url: url, data: {method: 'delete', output: 'json', unitOfMeasurementId: $('#unitOfMeasurementIdPreview').val(), securityToken: securityToken, leafId: leafId}, beforeSend: function() {
            var smileyRoll = './images/icons/smiley-roll.png';
            var $infoPanel = $('#infoPanel');
            $infoPanel.html('').empty().html("<span class='label label-warning'><img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
            if ($infoPanel.is(':hidden')) {
...
function deleteGridRecordCheckbox(leafId, url, urlList, securityToken) {
    var stringText = '';
    var counter = 0;
    $('input:checkbox[name="unitOfMeasurementId[]"]').each(function() {
        stringText = stringText + "&unitOfMeasurementId[]=" + $(this).val();
    });
...
function newRecord(leafId, url, urlList, securityToken, type, createAccess, updateAccess, deleteAccess) {
    ...
    var $unitOfMeasurementCategoryId = $('#unitOfMeasurementCategoryId');
    var $unitOfMeasurementCode = $('#unitOfMeasurementCode');
    var $unitOfMeasurementDescription = $('#unitOfMeasurementDescription');
    var $unitOfMeasurementBaseValue = $('#unitOfMeasurementBaseValue');
    if (css.search('disabled') > 0) {
        return false;
    } else {
        if (type === 1) {
            if ($unitOfMeasurementCategoryId.val().length === 0) {
                $('#unitOfMeasurementCategoryIdHelpMe').html('').empty().html("<span class='label label-important'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['unitOfMeasurementCategoryIdLabel'] + " </span>");
                $unitOfMeasurementCategoryId.data('chosen').activate_action();
                return false;
            }
            if ($unitOfMeasurementCode.val().length === 0) {
                $('#unitOfMeasurementCodeHelpMe').html('').empty().html("<span class='label label-important'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['unitOfMeasurementCodeLabel'] + " </span>");
                $('#unitOfMeasurementCodeForm').removeClass().addClass('form-group has-error');
                $unitOfMeasurementCode.focus();
                return false;
            }
            if ($unitOfMeasurementDescription.val().length === 0) {
                $('#unitOfMeasurementDescriptionHelpMe').html('').empty().html("<span class='label label-important'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['unitOfMeasurementDescriptionLabel'] + " </span>");
                $('#unitOfMeasurementDescriptionForm').removeClass().addClass('form-group has-error');
                $unitOfMeasurementDescription.focus();
                return false;
            }
            if ($unitOfMeasurementBaseValue.val().length === 0) {
                $('#unitOfMeasurementBaseValueHelpMe').html('').empty().html("<span class='label label-important'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['unitOfMeasurementBaseValueLabel'] + " </span>");
                $('#unitOfMeasurementBaseValueForm').removeClass().addClass('form-group has-error');
                $unitOfMeasurementBaseValue.focus();
                return false;
            }
            $.ajax({type: 'POST', url: url, data: {method: 'create', output: 'json', unitOfMeasurementCategoryId: $unitOfMeasurementCategoryId.val(), unitOfMeasurementCode: $unitOfMeasurementCode.val(), unitOfMeasurementDescription: $unitOfMeasurementDescription.val(), unitOfMeasurementBaseValue: $unitOfMeasurementBaseValue.val(), securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                    var smileyRoll = './images/icons/smiley-roll.png';
                    var $infoPanel = $('#infoPanel');
                    $infoPanel.html('').empty().html("<span class='label label-warning'>&nbsp;<img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
                    if ($infoPanel.is(':hidden')) {
                    ...
                    if (success === true) {
                        ...
                        $unitOfMeasurementCategoryId.val('');
                        $unitOfMeasurementCategoryId.trigger("chosen:updated");
                        $('#unitOfMeasurementCategoryIdHelpMe').html('').empty();
                        $unitOfMeasurementCode.val('');
                        $('#unitOfMeasurementCodeHelpMe').html('').empty();
                        $unitOfMeasurementDescription.val('');
                        $('#unitOfMeasurementDescriptionForm').removeClass().addClass('form-group');
                        $('#unitOfMeasurementDescriptionHelpMe').html('').empty();
                        $unitOfMeasurementBaseValue.val('');
                        $('#unitOfMeasurementBaseValueHelpMe').html('').empty();
                    } else if (success === false) {
                        $infoPanel.html('').empty().html("<span class='label label-important'>&nbsp;" + message + "</span>");
                        if ($infoPanel.is(':hidden')) {
                            $infoPanel.show();
            ...
            $.ajax({type: 'POST', url: url, data: {method: 'create', output: 'json', unitOfMeasurementCategoryId: $unitOfMeasurementCategoryId.val(), unitOfMeasurementCode: $unitOfMeasurementCode.val(), unitOfMeasurementDescription: $unitOfMeasurementDescription.val(), unitOfMeasurementBaseValue: $unitOfMeasurementBaseValue.val(), securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                    ...
                    if (success === true) {
                        ...
                        $('#unitOfMeasurementId').val(data.unitOfMeasurementId);
                        $('#newRecordButton1').removeClass().addClass('btn btn-success disabled').attr('onClick', '');
                        $('#newRecordButton2').removeClass().addClass('btn dropdown-toggle btn-success disabled');
                        $('#newRecordButton3').attr('onClick', '');
                        $('#newRecordButton4').attr('onClick', '');
...
function updateRecord(leafId, url, urlList, securityToken, type, deleteAccess) {
    ...
    if (css.search('disabled') > 0) {
        ...
        if (type === 1) {
            ...
            $infoPanel.html('').empty();
            $.ajax({type: 'POST', url: url, data: {method: 'save', output: 'json', unitOfMeasurementId: $unitOfMeasurementId.val(), unitOfMeasurementCategoryId: $unitOfMeasurementCategoryId.val(), unitOfMeasurementCode: $unitOfMeasurementCode.val(), unitOfMeasurementDescription: $unitOfMeasurementDescription.val(), unitOfMeasurementBaseValue: $unitOfMeasurementBaseValue.val(), securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                    var smileyRoll = './images/icons/smiley-roll.png';
                    var $infoPanel = $('#infoPanel');
                    $infoPanel.html('').empty().html("<span class='label label-warning'>&nbsp;<img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
                    if ($infoPanel.is(':hidden')) {
    ...
    if (css.search('disabled') > 0) {
        ...
        if (deleteAccess === 1) {
            if (confirm(decodeURIComponent(t['deleteRecordMessageLabel']))) {
                var value = $unitOfMeasurementId.val();
                if (!value) {
                    ...
                    $.ajax({type: 'POST', url: url, data: {method: 'delete', output: 'json', unitOfMeasurementId: $unitOfMeasurementId.val(), securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                            var smileyRoll = './images/icons/smiley-roll.png';
                            var $infoPanel = $('#infoPanel');
                            $infoPanel.html('').empty().html("<span class='label label-warning'>&nbsp;<img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
                            if ($infoPanel.is(':hidden')) {
...
function resetRecord(leafId, url, urlList, securityToken, createAccess, updateAccess, deleteAccess) {
    ...
    $("#unitOfMeasurementCategoryId").val('');
    $("#unitOfMeasurementCategoryIdHelpMe").empty().html('');
    $('#unitOfMeasurementCategoryId').trigger("chosen:updated");
    $("#unitOfMeasurementCode").val('');
    $("#unitOfMeasurementCodeHelpMe").empty().html('');
    $("#unitOfMeasurementDescription").val('');
    $("#unitOfMeasurementDescriptionHelpMe").empty().html('');
    $('#unitOfMeasurementDescription').empty().val('');
    $("#unitOfMeasurementBaseValue").val('');
    $("#unitOfMeasurementBaseValueHelpMe").empty().html('');
}
function postRecord() {
...
function firstRecord(leafId, url, urlList, securityToken, updateAccess, deleteAccess) {
    ...
    if (css.search('disabled') > 0) {
        ...
        $.ajax({type: 'GET', url: url, data: {method: 'dataNavigationRequest', dataNavigation: 'firstRecord', output: 'json', securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                ...
                if (success === true) {
                    $.ajax({type: 'POST', url: url, data: {method: 'read', unitOfMeasurementId: firstRecord, output: 'json', securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                            var smileyRoll = './images/icons/smiley-roll.png';
                            $infoPanel.html('').empty().html("<span class='label label-warning'>&nbsp;<img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
                            if ($infoPanel.is(':hidden')) {
                                $infoPanel.show();
                            ...
                            if (success === true) {
                                $('#unitOfMeasurementId').val(data.data.unitOfMeasurementId);
                                $('#unitOfMeasurementCategoryId').val(data.data.unitOfMeasurementCategoryId).trigger("chosen:updated");
                                $('#unitOfMeasurementCode').val(data.data.unitOfMeasurementCode);
                                $('#unitOfMeasurementDescription').val(data.data.unitOfMeasurementDescription);
                                $('#unitOfMeasurementBaseValue').val(data.data.unitOfMeasurementBaseValue);
                                if (nextRecord > 0) {
                                    $('#previousRecordButton').removeClass().addClass('btn btn-default disabled').attr('onClick', '');
...
function endRecord(leafId, url, urlList, securityToken, updateAccess, deleteAccess) {
    ...
    if (css.search('disabled') > 0) {
        ...
        $.ajax({type: 'GET', url: url, data: {method: 'dataNavigationRequest', dataNavigation: 'lastRecord', output: 'json', securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                ...
                if (success === true) {
                    $.ajax({type: 'POST', url: url, data: {method: 'read', unitOfMeasurementId: lastRecord, output: 'json', securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                            var smileyRoll = './images/icons/smiley-roll.png';
                            $infoPanel.html('').empty().html("<span class='label label-warning'>&nbsp;<img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
                            if ($infoPanel.is(':hidden')) {
                                $infoPanel.show();
...
function previousRecord(leafId, url, urlList, securityToken, updateAccess, deleteAccess) {
    ...
    if (css.search('disabled') > 0) {
        ...
        if (parseFloat($previousRecordCounter.val()) > 0 && parseFloat($previousRecordCounter.val()) < parseFloat($('#lastRecordCounter').val())) {
            $.ajax({type: 'POST', url: url, data: {method: 'read', unitOfMeasurementId: $previousRecordCounter.val(), output: 'json', securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                    var smileyRoll = './images/icons/smiley-roll.png';
                    var $infoPanel = $('#infoPanel');
                    $infoPanel.html('').empty().html("<span class='label label-warning'>&nbsp;<img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
                    if ($infoPanel.is(':hidden')) {
...
function nextRecord(leafId, url, urlList, securityToken, updateAccess, deleteAccess) {
    ...
    if (css.search('disabled') > 0) {
        ...
        if (parseFloat($nextRecordCounter.val()) <= parseFloat($('#lastRecordCounter').val())) {
            $.ajax({type: 'POST', url: url, data: {method: 'read', unitOfMeasurementId: $nextRecordCounter.val(), output: 'json', securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                    var smileyRoll = './images/icons/smiley-roll.png';
                    var $infoPanel = $('#infoPanel');
                    $infoPanel.html('').empty().html("<span class='label label-warning'>&nbsp;<img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
                    if ($infoPanel.is(':hidden')) {
