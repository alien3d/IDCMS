function getItemCategoryAccumulativeDepreciationAccounts(leafId, url, securityToken) {
    $.ajax({type: 'GET', url: url, data: {offset: 0, limit: 99999, method: 'read', type: 'filter', securityToken: securityToken, leafId: leafId, filter: 'itemCategoryAccumulativeDepreciationAccounts'}, beforeSend: function() {
            ...
            if (success === false) {
                ...
                $("#itemCategoryAccumulativeDepreciationAccounts").html('').empty().html(data.data).trigger("chosen:updated");
...
function checkDuplicate(leafId, page, securityToken) {
    var $itemCategoryCode = $("#itemCategoryCode");
    if ($itemCategoryCode.val().length === 0) {
        alert(t['oddTextLabel']);
        return false;
    }
    $.ajax({type: 'GET', url: page, data: {itemCategoryCode: $itemCategoryCode.val(), method: 'duplicate', securityToken: securityToken, leafId: leafId}, beforeSend: function() {
            var smileyRoll = './images/icons/smiley-roll.png';
            var $infoPanel = $('#infoPanel');
            $infoPanel.html('').empty().html("<span class='label label-warning'><img src='" + smileyRoll + "'>&nbsp;" + decodeURIComponent(t['loadingTextLabel']) + "....</span>");
            if ($infoPanel.is(':hidden')) {
            ...
            if (success === true) {
                if (total !== 0) {
                    $("#itemCategoryCode").val('').focus();
                    $("#itemCategoryCodeForm").removeClass().addClass("form-group has-error");
                ...
                $("#itemCategoryForm").removeClass().addClass("form-group has-error");
            }
            if ($infoPanel.is(':hidden')) {
                $infoPanel.show();
            }
...
function showFormUpdate(leafId, url, urlList, securityToken, itemCategoryId, updateAccess, deleteAccess) {
    sleep(500);
    $('a[rel=tooltip]').tooltip('hide');
    $.ajax({type: 'POST', url: urlList, data: {method: 'read', type: 'form', itemCategoryId: itemCategoryId, securityToken: securityToken, leafId: leafId}, beforeSend: function() {
            var smileyRoll = './images/icons/smiley-roll.png';
            var $infoPanel = $('#infoPanel');
            $infoPanel.html('').empty().html("<span class='label label-warning'><img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
            if ($infoPanel.is(':hidden')) {
...
function showModalDelete(itemCategoryId, itemCategoryAccumulativeDepreciationAccounts, itemCategoryCode, itemCategoryDepreciationRate, itemCategoryLife, itemCategoryMinimumReOrder, itemCategoryMinimumValue, itemCategoryDescription, isDepreciate) {
    $('#itemCategoryIdPreview').val('').val(decodeURIComponent(itemCategoryId));
    $('#itemCategoryAccumulativeDepreciationAccountsPreview').val('').val(decodeURIComponent(itemCategoryAccumulativeDepreciationAccounts));
    $('#itemCategoryCodePreview').val('').val(decodeURIComponent(itemCategoryCode));
    $('#itemCategoryDepreciationRatePreview').val('').val(decodeURIComponent(itemCategoryDepreciationRate));
    $('#itemCategoryLifePreview').val('').val(decodeURIComponent(itemCategoryLife));
    $('#itemCategoryMinimumReOrderPreview').val('').val(decodeURIComponent(itemCategoryMinimumReOrder));
    $('#itemCategoryMinimumValuePreview').val('').val(decodeURIComponent(itemCategoryMinimumValue));
    $('#itemCategoryDescriptionPreview').val('').val(decodeURIComponent(itemCategoryDescription));
...
function deleteGridRecord(leafId, url, urlList, securityToken) {
    $.ajax({type: 'POST', url: url, data: {method: 'delete', output: 'json', itemCategoryId: $('#itemCategoryIdPreview').val(), securityToken: securityToken, leafId: leafId}, beforeSend: function() {
            var smileyRoll = './images/icons/smiley-roll.png';
            var $infoPanel = $('#infoPanel');
            $infoPanel.html('').empty().html("<span class='label label-warning'><img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
            if ($infoPanel.is(':hidden')) {
...
function deleteGridRecordCheckbox(leafId, url, urlList, securityToken) {
    var stringText = '';
    var counter = 0;
    $('input:checkbox[name="itemCategoryId[]"]').each(function() {
        stringText = stringText + "&itemCategoryId[]=" + $(this).val();
    });
...
function newRecord(leafId, url, urlList, securityToken, type, createAccess, updateAccess, deleteAccess) {
    ...
    var $itemCategoryAccumulativeDepreciationAccounts = $('#itemCategoryAccumulativeDepreciationAccounts');
    var $itemCategoryCode = $('#itemCategoryCode');
    var $itemCategoryDepreciationRate = $('#itemCategoryDepreciationRate');
    var $itemCategoryLife = $('#itemCategoryLife');
    var $itemCategoryMinimumReOrder = $('#itemCategoryMinimumReOrder');
    var $itemCategoryMinimumValue = $('#itemCategoryMinimumValue');
    var $itemCategoryDescription = $('#itemCategoryDescription');
    var $isDepreciate = $('#isDepreciate');
    if (css.search('disabled') > 0) {
        return false;
    } else {
        if (type === 1) {
            if ($itemCategoryAccumulativeDepreciationAccounts.val().length === 0) {
                $('#itemCategoryAccumulativeDepreciationAccountsHelpMe').html('').empty().html("<span class='label label-important'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['itemCategoryAccumulativeDepreciationAccountsLabel'] + " </span>");
                $itemCategoryAccumulativeDepreciationAccounts.data('chosen').activate_action();
                return false;
            }
            if ($itemCategoryCode.val().length === 0) {
                $('#itemCategoryCodeHelpMe').html('').empty().html("<span class='label label-important'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['itemCategoryCodeLabel'] + " </span>");
                $('#itemCategoryCodeForm').removeClass().addClass('form-group has-error');
                $itemCategoryCode.focus();
                return false;
            }
            if ($itemCategoryDepreciationRate.val().length === 0) {
                $('#itemCategoryDepreciationRateHelpMe').html('').empty().html("<span class='label label-important'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['itemCategoryDepreciationRateLabel'] + " </span>");
                $('#itemCategoryDepreciationRateForm').removeClass().addClass('form-group has-error');
                $itemCategoryDepreciationRate.focus();
                return false;
            }
            if ($itemCategoryLife.val().length === 0) {
                $('#itemCategoryLifeHelpMe').html('').empty().html("<span class='label label-important'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['itemCategoryLifeLabel'] + " </span>");
                $('#itemCategoryLifeForm').removeClass().addClass('form-group has-error');
                $itemCategoryLife.focus();
                return false;
            }
            if ($itemCategoryMinimumReOrder.val().length === 0) {
                $('#itemCategoryMinimumReOrderHelpMe').html('').empty().html("<span class='label label-important'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['itemCategoryMinimumReOrderLabel'] + " </span>");
                $('#itemCategoryMinimumReOrderForm').removeClass().addClass('form-group has-error');
                $itemCategoryMinimumReOrder.focus();
                return false;
            }
            if ($itemCategoryMinimumValue.val().length === 0) {
                $('#itemCategoryMinimumValueHelpMe').html('').empty().html("<span class='label label-important'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['itemCategoryMinimumValueLabel'] + " </span>");
                $('#itemCategoryMinimumValueForm').removeClass().addClass('form-group has-error');
                $itemCategoryMinimumValue.focus();
                return false;
            }
            if ($itemCategoryDescription.val().length === 0) {
                $('#itemCategoryDescriptionHelpMe').html('').empty().html("<span class='label label-important'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['itemCategoryDescriptionLabel'] + " </span>");
                $('#itemCategoryDescriptionForm').removeClass().addClass('form-group has-error');
                $itemCategoryDescription.focus();
                return false;
            }
            ...
            $.ajax({type: 'POST', url: url, data: {method: 'create', output: 'json', itemCategoryAccumulativeDepreciationAccounts: $itemCategoryAccumulativeDepreciationAccounts.val(), itemCategoryCode: $itemCategoryCode.val(), itemCategoryDepreciationRate: $itemCategoryDepreciationRate.val(), itemCategoryLife: $itemCategoryLife.val(), itemCategoryMinimumReOrder: $itemCategoryMinimumReOrder.val(), itemCategoryMinimumValue: $itemCategoryMinimumValue.val(), itemCategoryDescription: $itemCategoryDescription.val(), isDepreciate: $isDepreciate.val(), securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                    var smileyRoll = './images/icons/smiley-roll.png';
                    var $infoPanel = $('#infoPanel');
                    $infoPanel.html('').empty().html("<span class='label label-warning'>&nbsp;<img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
                    if ($infoPanel.is(':hidden')) {
                    ...
                    if (success === true) {
                        ...
                        $itemCategoryAccumulativeDepreciationAccounts.val('');
                        $itemCategoryAccumulativeDepreciationAccounts.trigger("chosen:updated");
                        $('#itemCategoryAccumulativeDepreciationAccountsHelpMe').html('').empty();
                        $itemCategoryCode.val('');
                        $('#itemCategoryCodeHelpMe').html('').empty();
                        $itemCategoryDepreciationRate.val('');
                        $('#itemCategoryDepreciationRateHelpMe').html('').empty();
                        $itemCategoryLife.val('');
                        $('#itemCategoryLifeHelpMe').html('').empty();
                        $itemCategoryMinimumReOrder.val('');
                        $('#itemCategoryMinimumReOrderHelpMe').html('').empty();
                        $itemCategoryMinimumValue.val('');
                        $('#itemCategoryMinimumValueHelpMe').html('').empty();
                        $itemCategoryDescription.val('');
                        $('#itemCategoryDescriptionForm').removeClass().addClass('form-group');
                        $('#itemCategoryDescriptionHelpMe').html('').empty();
                        $isDepreciate.val('');
...
function updateRecord(leafId, url, urlList, securityToken, type, deleteAccess) {
    ...
    if (css.search('disabled') > 0) {
        ...
        if (type === 1) {
            ...
            $infoPanel.html('').empty();
            $.ajax({type: 'POST', url: url, data: {method: 'save', output: 'json', itemCategoryId: $itemCategoryId.val(), itemCategoryAccumulativeDepreciationAccounts: $itemCategoryAccumulativeDepreciationAccounts.val(), itemCategoryCode: $itemCategoryCode.val(), itemCategoryDepreciationRate: $itemCategoryDepreciationRate.val(), itemCategoryLife: $itemCategoryLife.val(), itemCategoryMinimumReOrder: $itemCategoryMinimumReOrder.val(), itemCategoryMinimumValue: $itemCategoryMinimumValue.val(), itemCategoryDescription: $itemCategoryDescription.val(), isDepreciate: $isDepreciate.val(), securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                    var smileyRoll = './images/icons/smiley-roll.png';
                    var $infoPanel = $('#infoPanel');
                    $infoPanel.html('').empty().html("<span class='label label-warning'>&nbsp;<img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
                    if ($infoPanel.is(':hidden')) {
        ...
        if (deleteAccess === 1) {
            if (confirm(decodeURIComponent(t['deleteRecordMessageLabel']))) {
                ...
                if (!value) {
                    ...
                    $.ajax({type: 'POST', url: url, data: {method: 'delete', output: 'json', itemCategoryId: $itemCategoryId.val(), securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                            var smileyRoll = './images/icons/smiley-roll.png';
                            var $infoPanel = $('#infoPanel');
                            $infoPanel.html('').empty().html("<span class='label label-warning'>&nbsp;<img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
                            if ($infoPanel.is(':hidden')) {
...
function resetRecord(leafId, url, urlList, securityToken, createAccess, updateAccess, deleteAccess) {
    ...
    $("#itemCategoryAccumulativeDepreciationAccounts").val('');
    $("#itemCategoryAccumulativeDepreciationAccountsHelpMe").empty().html('');
    $('#itemCategoryAccumulativeDepreciationAccounts').trigger("chosen:updated");
    $("#itemCategoryCode").val('');
    $("#itemCategoryCodeHelpMe").empty().html('');
    $("#itemCategoryDepreciationRate").val('');
    $("#itemCategoryDepreciationRateHelpMe").empty().html('');
    $("#itemCategoryLife").val('');
    $("#itemCategoryLifeHelpMe").empty().html('');
    $("#itemCategoryMinimumReOrder").val('');
    $("#itemCategoryMinimumReOrderHelpMe").empty().html('');
    $("#itemCategoryMinimumValue").val('');
    $("#itemCategoryMinimumValueHelpMe").empty().html('');
    $("#itemCategoryDescription").val('');
    $("#itemCategoryDescriptionHelpMe").empty().html('');
    $('#itemCategoryDescription').empty().val('');
    $("#isDepreciate").val('');
...
function firstRecord(leafId, url, urlList, securityToken, updateAccess, deleteAccess) {
    ...
    if (css.search('disabled') > 0) {
        ...
        $.ajax({type: 'GET', url: url, data: {method: 'dataNavigationRequest', dataNavigation: 'firstRecord', output: 'json', securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                ...
                if (success === true) {
                    $.ajax({type: 'POST', url: url, data: {method: 'read', itemCategoryId: firstRecord, output: 'json', securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                            var smileyRoll = './images/icons/smiley-roll.png';
                            $infoPanel.html('').empty().html("<span class='label label-warning'>&nbsp;<img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
                            if ($infoPanel.is(':hidden')) {
                                $infoPanel.show();
                            ...
                            if (success === true) {
                                $('#itemCategoryId').val(data.data.itemCategoryId);
                                $('#itemCategoryAccumulativeDepreciationAccounts').val(data.data.itemCategoryAccumulativeDepreciationAccounts).trigger("chosen:updated");
                                $('#itemCategoryCode').val(data.data.itemCategoryCode);
                                $('#itemCategoryDepreciationRate').val(data.data.itemCategoryDepreciationRate);
                                $('#itemCategoryLife').val(data.data.itemCategoryLife);
                                $('#itemCategoryMinimumReOrder').val(data.data.itemCategoryMinimumReOrder);
                                $('#itemCategoryMinimumValue').val(data.data.itemCategoryMinimumValue);
                                $('#itemCategoryDescription').val(data.data.itemCategoryDescription);
...
function endRecord(leafId, url, urlList, securityToken, updateAccess, deleteAccess) {
    ...
    if (css.search('disabled') > 0) {
        ...
        $.ajax({type: 'GET', url: url, data: {method: 'dataNavigationRequest', dataNavigation: 'lastRecord', output: 'json', securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                ...
                if (success === true) {
                    $.ajax({type: 'POST', url: url, data: {method: 'read', itemCategoryId: lastRecord, output: 'json', securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                            var smileyRoll = './images/icons/smiley-roll.png';
                            $infoPanel.html('').empty().html("<span class='label label-warning'>&nbsp;<img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
                            if ($infoPanel.is(':hidden')) {
                                $infoPanel.show();
...
function previousRecord(leafId, url, urlList, securityToken, updateAccess, deleteAccess) {
    ...
    if (css.search('disabled') > 0) {
        ...
        if (parseFloat($previousRecordCounter.val()) > 0 && parseFloat($previousRecordCounter.val()) < parseFloat($('#lastRecordCounter').val())) {
            $.ajax({type: 'POST', url: url, data: {method: 'read', itemCategoryId: $previousRecordCounter.val(), output: 'json', securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                    var smileyRoll = './images/icons/smiley-roll.png';
                    var $infoPanel = $('#infoPanel');
                    $infoPanel.html('').empty().html("<span class='label label-warning'>&nbsp;<img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
                    if ($infoPanel.is(':hidden')) {
...
function nextRecord(leafId, url, urlList, securityToken, updateAccess, deleteAccess) {
    ...
    if (css.search('disabled') > 0) {
        ...
        if (parseFloat($nextRecordCounter.val()) <= parseFloat($('#lastRecordCounter').val())) {
            $.ajax({type: 'POST', url: url, data: {method: 'read', itemCategoryId: $nextRecordCounter.val(), output: 'json', securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                    var smileyRoll = './images/icons/smiley-roll.png';
                    var $infoPanel = $('#infoPanel');
                    $infoPanel.html('').empty().html("<span class='label label-warning'>&nbsp;<img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
                    if ($infoPanel.is(':hidden')) {
