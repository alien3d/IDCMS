...
namespace Core\Financial\Cashbook\CollectionDetail\Model;
 ...
 * This is collectionDetail model file.This is to ensure strict setting enable for all variable enter to database
 *
 * @name IDCMS .
 * @version 2
 * @author hafizan
 * @package Core\Financial\Cashbook\CollectionDetail\Model;
 * @subpackage Cashbook
 * @link http://www.hafizan.com
 * @license http://www.gnu.org/copyleft/lesser.html LGPL
 */
class CollectionDetailModel extends ValidationClass {
     ...
     * @var double
     */
    private $collectionDetailAmount;
    ...
    public function execute() {
         ...
         * */
        $this->setTableName('collectionDetail');
        $this->setPrimaryKeyName('collectionDetailId');
        $this->setMasterForeignKeyName('collectionDetailId');
        $this->setFilterCharacter('collectionDetailDescription');
        //$this->setFilterCharacter('collectionDetailNote');
        $this->setFilterDate('executeTime');
        /**
         * All the $_POST Environment
         */
        if (isset($_POST ['collectionDetailId'])) {
            $this->setCollectionDetailId($this->strict($_POST ['collectionDetailId'], 'integer'), 0, 'single');
        }
        ...
        if (isset($_POST ['collectionDetailAmount'])) {
            $this->setCollectionDetailAmount($this->strict($_POST ['collectionDetailAmount'], 'double'));
        }
        /**
         * All the $_GET Environment
         */
        if (isset($_GET ['collectionDetailId'])) {
            $this->setCollectionDetailId($this->strict($_GET ['collectionDetailId'], 'integer'), 0, 'single');
        }
        ...
        if (isset($_GET ['collectionDetailAmount'])) {
            $this->setCollectionDetailAmount($this->strict($_GET ['collectionDetailAmount'], 'double'));
        }
        if (isset($_GET ['collectionDetailId'])) {
            $this->setTotal(count($_GET ['collectionDetailId']));
            if (is_array($_GET ['collectionDetailId'])) {
                $this->collectionDetailId = array();
            }
        }
        ...
        for ($i = 0; $i < $this->getTotal(); $i++) {
            if (isset($_GET ['collectionDetailId'])) {
                $this->setCollectionDetailId($this->strict($_GET ['collectionDetailId'] [$i], 'numeric'), $i, 'array');
            }
            if (isset($_GET ['isDefault'])) {
            ...
            $primaryKeyAll .= $this->getCollectionDetailId($i, 'array') . ",";
        }
     ...
     * @return \Core\Financial\Cashbook\CollectionDetail\Model\CollectionDetailModel
     */
    public function setCollectionDetailId($value, $key, $type) {
        if ($type == 'single') {
            $this->collectionDetailId = $value;
            return $this;
        } else {
            if ($type == 'array') {
                $this->collectionDetailId[$key] = $value;
                return $this;
            } else {
                echo json_encode(
                        array(
                            "success" => false,
                            "message" => "Cannot Identify Type String Or Array:setCollectionDetailId?"
                        )
                );
                exit();
            }
     ...
     */
    public function getCollectionDetailId($key, $type) {
        if ($type == 'single') {
            return $this->collectionDetailId;
        } else {
            if ($type == 'array') {
                return $this->collectionDetailId [$key];
            } else {
                echo json_encode(
                        array(
                            "success" => false,
                            "message" => "Cannot Identify Type String Or Array:getCollectionDetailId ?"
                        )
                );
                exit();
            }
    ...
    /**
     * To Return Amount
     * @return double $collectionDetailAmount
     */
    public function getCollectionDetailAmount() {
        return $this->collectionDetailAmount;
    }

    /**
     * To Set Amount
     * @param double $collectionDetailAmount Amount
     * @return \Core\Financial\Cashbook\CollectionDetail\Model\CollectionDetailModel
     */
    public function setCollectionDetailAmount($collectionDetailAmount) {
        $this->collectionDetailAmount = $collectionDetailAmount;
        return $this;
    }
