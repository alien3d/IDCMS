function checkDuplicate(leafId, page, securityToken) {
    if ($("#collectionCancellationTypeCode").val().length == 0) {
    ...
    $.ajax({
        ...
        url: page,
        data: {
            collectionCancellationTypeCode: $("#collectionCancellationTypeCode").val(),
            method: 'duplicate',
        ...
        success: function(data) {
            ...
            if (data.success == true) {
                if (data.total != 0) {
                    $("#collectionCancellationTypeCode").empty();
                    $("#collectionCancellationTypeCode").val('');
                    $("#collectionCancellationTypeCode").focus();
                    $("#collectionCancellationTypeCodeForm").removeClass();
                    $("#collectionCancellationTypeCodeForm").addClass("col-md-12 form-group has-error");
                    $('#infoPanel').empty();
                    $('#infoPanel').html('');
                ...
                $("#collectionCancellationTypeForm").removeClass();
                $("#collectionCancellationTypeForm").addClass("col-md-12 form-group has-error");
            }
        },
        error: function(xhr) {
            $('#infoError').empty();
...
function showFormUpdate(leafId, url, urlList, securityToken, collectionCancellationTypeId, updateAccess, deleteAccess) {
    sleep(500);
    // unlimited for searching because  lazy paging.
    $.ajax({
        type: 'POST',
...
function showModalDelete(collectionCancellationTypeId, collectionCancellationTypeCode, collectionCancellationTypeDescription) {
    ...
    $('#collectionCancellationTypeCodePreview').val('');
    $('#collectionCancellationTypeCodePreview').val(decodeURIComponent(collectionCancellationTypeCode));

    $('#collectionCancellationTypeDescriptionPreview').val('');
    $('#collectionCancellationTypeDescriptionPreview').val(decodeURIComponent(collectionCancellationTypeDescription));
...
function deleteGridRecord(leafId, url, urlList, securityToken) {
    $.ajax({
        ...
        data: {
            method: 'delete',
            output: 'json',
            collectionCancellationTypeId: $('#collectionCancellationTypeIdPreview').val(),
            securityToken: securityToken,
            leafId: leafId
        },
        beforeSend: function() {
...
function deleteGridRecordCheckbox(leafId, url, urlList, securityToken) {
    var stringText = '';
    var counter = 0;
    $('input:checkbox[name="collectionCancellationTypeId[]"]').each(function() {
        stringText = stringText + "&collectionCancellationTypeId[]=" + $(this).val();
    });
...
function newRecord(leafId, url, urlList, securityToken, type, createAccess, updateAccess, deleteAccess) {
    ...
    if (css.search('disabled') > 0) {
        ...
        if (type == 1) {
            ...
            if ($('#collectionCancellationTypeCode').val().length == 0) {
                $('#collectionCancellationTypeCodeHelpMe').empty();
                $('#collectionCancellationTypeCodeHelpMe').html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['collectionCancellationTypeCodeLabel'] + " </span>");
                $('#collectionCancellationTypeCodeForm').addClass('form-group has-error');
                $('#collectionCancellationTypeCode').focus();
                return false;
            }
            if ($('#collectionCancellationTypeDescription').val().length == 0) {
                $('#collectionCancellationTypeDescriptionHelpMe').empty();
                $('#collectionCancellationTypeDescriptionHelpMe').html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['collectionCancellationTypeDescriptionLabel'] + " </span>");
                $('#collectionCancellationTypeDescriptionForm').addClass('form-group has-error');
                $('#collectionCancellationTypeDescription').focus();
                return false;
            }
            $.ajax({
                type: 'POST',
                ...
                data: {
                    ...
                    output: 'json',
                    collectionCancellationTypeCode: $('#collectionCancellationTypeCode').val(),
                    collectionCancellationTypeDescription: $('#collectionCancellationTypeDescription').val(),
                    securityToken: securityToken,
                    leafId: leafId
                },
                beforeSend: function() {
                ...
                success: function(data) {
                    ...
                    if (data.success == true) {
                        ...
                        $('#collectionCancellationTypeCode').val('');
                        $('#collectionCancellationTypeCodeHelpMe').empty();
                        $('#collectionCancellationTypeCodeHelpMe').html('');
                        $('#collectionCancellationTypeDescription').val('');
                        $('#collectionCancellationTypeDescriptionForm').removeClass().addClass('form-group');
                        $('#collectionCancellationTypeDescription').val('');
                        $('#collectionCancellationTypeDescriptionHelpMe').empty();
                        $('#collectionCancellationTypeDescriptionHelpMe').html('');
                    } else if (data.success == false) {
                        $('#infoPanel').empty();
                        $('#infoPanel').html("<span class='label label-danger'>&nbsp;" + data.message + "</span>");
                        if ($('#infoPanel').is(':hidden')) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data.success == true) {
                        ...
                        $('#collectionCancellationTypeId').val(data.collectionCancellationTypeId);
                        $('#newRecordButton1').removeClass();
                        $('#newRecordButton2').removeClass();
                        $('#newRecordButton3').removeClass();
                        $('#newRecordButton4').removeClass();
    ...
    if (css.search('disabled') > 0) {
        ...
        if (deleteAccess == 1) {
            if (confirm(decodeURIComponent(t['deleteRecordMessageLabel']))) {
                var value = $('#collectionCancellationTypeId').val();
                if (!value) {
                    $('#infoPanel').empty();
                    $('#infoPanel').html('');
...
function resetRecord(leafId, url, urlList, securityToken, createAccess, updateAccess, deleteAccess) {
    ...
    $("#collectionCancellationTypeCode").val('');
    $("#collectionCancellationTypeDescription").val('');
    $('#collectionCancellationTypeDescription').empty();
    $('#collectionCancellationTypeDescription').val('');
}
            ...
            success: function(data) {
                ...
                if (data.success == true) {
                    $.ajax({
                        ...
                        data: {
                            method: 'read',
                            collectionCancellationTypeId: data.firstRecord,
                            output: 'json',
                            securityToken: securityToken,
                            leafId: leafId
                        },
                        ...
                        success: function(data) {
                            ...
                            if (data.success == true) {
                                ...
                                $('#collectionCancellationTypeCode').val(data.data.collectionCancellationTypeCode);
                                $('#collectionCancellationTypeDescription').val(data.data.collectionCancellationTypeDescription);
            ...
            success: function(data) {
                ...
                if (data.success == true) {
                    $.ajax({
                        ...
                        data: {
                            method: 'read',
                            collectionCancellationTypeId: data.lastRecord,
                            output: 'json',
                            securityToken: securityToken,
                            leafId: leafId
                        },
    ...
    if (css.search('disabled') > 0) {
        ...
        if (parseFloat($('#previousRecordCounter').val()) > 0 && parseFloat($('#previousRecordCounter').val()) < parseFloat($('#lastRecordCounter').val())) {
            $.ajax({
                ...
                data: {
                    method: 'read',
                    collectionCancellationTypeId: $('#previousRecordCounter').val(),
                    output: 'json',
                    securityToken: securityToken,
                    leafId: leafId
                },
    ...
    if (css.search('disabled') > 0) {
        ...
        if (parseFloat($('#nextRecordCounter').val()) <= parseFloat($('#lastRecordCounter').val())) {
            $.ajax({
                ...
                data: {
                    method: 'read',
                    collectionCancellationTypeId: $('#nextRecordCounter').val(),
                    output: 'json',
                    securityToken: securityToken,
                    leafId: leafId
                },
