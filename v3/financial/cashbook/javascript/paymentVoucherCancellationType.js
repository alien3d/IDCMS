function checkDuplicate(leafId, page, securityToken) {
    var $paymentVoucherCancellationTypeCode = $("#paymentVoucherCancellationTypeCode");
    if ($paymentVoucherCancellationTypeCode.val().length === 0) {
    ...
    $.ajax({
        ...
        url: page,
        data: {
            paymentVoucherCancellationTypeCode: $paymentVoucherCancellationTypeCode.val(),
            method: 'duplicate',
        ...
        success: function(data) {
            ...
            if (success === true) {
                if (total !== 0) {
                    $("#paymentVoucherCancellationTypeCode").val('').focus();
                    $("#paymentVoucherCancellationTypeCodeForm").removeClass().addClass("form-group has-error");
                ...
                $("#paymentVoucherCancellationTypeForm").removeClass().addClass("form-group has-error");
            }
            if ($infoPanel.is(':hidden')) {
                $infoPanel.show();
            }
...
function showFormUpdate(leafId, url, urlList, securityToken, paymentVoucherCancellationTypeId, updateAccess, deleteAccess) {
    sleep(500);
...
function showModalDelete(paymentVoucherCancellationTypeId, paymentVoucherCancellationTypeCode, paymentVoucherCancellationTypeDescription) {
    $('#paymentVoucherCancellationTypeIdPreview').val('').val(decodeURIComponent(paymentVoucherCancellationTypeId));
    $('#paymentVoucherCancellationTypeCodePreview').val('').val(decodeURIComponent(paymentVoucherCancellationTypeCode));
    $('#paymentVoucherCancellationTypeDescriptionPreview').val('').val(decodeURIComponent(paymentVoucherCancellationTypeDescription));
...
function deleteGridRecord(leafId, url, urlList, securityToken) {
    $.ajax({
        ...
        data: {
            method: 'delete',
            output: 'json',
            paymentVoucherCancellationTypeId: $('#paymentVoucherCancellationTypeIdPreview').val(),
            securityToken: securityToken,
            leafId: leafId
        },
        beforeSend: function() {
...
function deleteGridRecordCheckbox(leafId, url, urlList, securityToken) {
    var stringText = '';
    var counter = 0;
    $('input:checkbox[name="paymentVoucherCancellationTypeId[]"]').each(function() {
        stringText = stringText + "&paymentVoucherCancellationTypeId[]=" + $(this).val();
    });
...
function newRecord(leafId, url, urlList, securityToken, type, createAccess, updateAccess, deleteAccess) {
    ...
    var $paymentVoucherCancellationTypeCode = $('#paymentVoucherCancellationTypeCode');
    var $paymentVoucherCancellationTypeDescription = $('#paymentVoucherCancellationTypeDescription');
    if (css.search('disabled') > 0) {
        return false;
    } else {
        if (type === 1) {
            if ($paymentVoucherCancellationTypeCode.val().length === 0) {
                $('#paymentVoucherCancellationTypeCodeHelpMe').html('').empty().html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['paymentVoucherCancellationTypeCodeLabel'] + " </span>");
                $('#paymentVoucherCancellationTypeCodeForm').removeClass().addClass('form-group has-error');
                $paymentVoucherCancellationTypeCode.focus();
                return false;
            }
            if ($paymentVoucherCancellationTypeDescription.val().length === 0) {
                $('#paymentVoucherCancellationTypeDescriptionHelpMe').html('').empty().html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['paymentVoucherCancellationTypeDescriptionLabel'] + " </span>");
                $('#paymentVoucherCancellationTypeDescriptionForm').removeClass().addClass('form-group has-error');
                $paymentVoucherCancellationTypeDescription.focus();
                return false;
            }
            $.ajax({
                type: 'POST',
                ...
                data: {
                    ...
                    output: 'json',
                    paymentVoucherCancellationTypeCode: $paymentVoucherCancellationTypeCode.val(),
                    paymentVoucherCancellationTypeDescription: $paymentVoucherCancellationTypeDescription.val(),
                    securityToken: securityToken,
                    leafId: leafId
                },
                beforeSend: function() {
                ...
                success: function(data) {
                    ...
                    if (success === true) {
                        ...
                        $paymentVoucherCancellationTypeCode.val('');
                        $('#paymentVoucherCancellationTypeCodeHelpMe').html('').empty();
                        $paymentVoucherCancellationTypeDescription.val('');
                        $('#paymentVoucherCancellationTypeDescriptionForm').removeClass().addClass('form-group');
                        $('#paymentVoucherCancellationTypeDescriptionHelpMe').html('').empty();
                    } else if (success === false) {
                        $infoPanel.html('').empty().html("<span class='label label-danger'>&nbsp;" + message + "</span>");
                        if ($infoPanel.is(':hidden')) {
                            $infoPanel.show();
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (success === true) {
                        ...
                        $('#paymentVoucherCancellationTypeId').val(data.paymentVoucherCancellationTypeId);
                        $('#newRecordButton1').removeClass().addClass('btn btn-success disabled').attr('onClick', '');
                        $('#newRecordButton2').removeClass().addClass('btn dropdown-toggle btn-success disabled');
                        $('#newRecordButton3').attr('onClick', '');
                        $('#newRecordButton4').attr('onClick', '');
        ...
        if (type === 1) {
            ...
            $.ajax({
                ...
                data: {
                    method: 'save',
                    output: 'json',
                    paymentVoucherCancellationTypeId: $paymentVoucherCancellationTypeId.val(),
                    paymentVoucherCancellationTypeCode: $paymentVoucherCancellationTypeCode.val(),
                    paymentVoucherCancellationTypeDescription: $paymentVoucherCancellationTypeDescription.val(),
                    securityToken: securityToken,
                    leafId: leafId
...
function deleteRecord(leafId, url, urlList, securityToken, deleteAccess) {
    var $infoPanel = $('#infoPanel');
    var $paymentVoucherCancellationTypeId = $('#paymentVoucherCancellationTypeId');
    ...
    if (css.search('disabled') > 0) {
        ...
        if (deleteAccess === 1) {
            if (confirm(decodeURIComponent(t['deleteRecordMessageLabel']))) {
                var value = $paymentVoucherCancellationTypeId.val();
                if (!value) {
...
function resetRecord(leafId, url, urlList, securityToken, createAccess, updateAccess, deleteAccess) {
    ...
    $("#paymentVoucherCancellationTypeId").val('');
    $("#paymentVoucherCancellationTypeIdHelpMe").empty().html('');

    $("#paymentVoucherCancellationTypeCode").val('');
    $("#paymentVoucherCancellationTypeCodeHelpMe").empty().html('');
    $("#paymentVoucherCancellationTypeDescription").val('');
    $("#paymentVoucherCancellationTypeDescriptionHelpMe").empty().html('');
    $('#paymentVoucherCancellationTypeDescription').empty().val('');
}
function postRecord() {
            ...
            success: function(data) {
                ...
                if (success === true) {
                    $.ajax({
                        ...
                        data: {
                            method: 'read',
                            paymentVoucherCancellationTypeId: firstRecord,
                            output: 'json',
                            securityToken: securityToken,
                            leafId: leafId
                        },
                        ...
                        success: function(data) {
                            ...
                            if (success === true) {
                                $('#paymentVoucherCancellationTypeId').val(data.data.paymentVoucherCancellationTypeId);
                                $('#paymentVoucherCancellationTypeCode').val(data.data.paymentVoucherCancellationTypeCode);
                                $('#paymentVoucherCancellationTypeDescription').val(data.data.paymentVoucherCancellationTypeDescription);
                                if (nextRecord > 0) {
                                    $('#previousRecordButton').removeClass().addClass('btn btn-default disabled').attr('onClick', '');
            ...
            success: function(data) {
                ...
                if (success === true) {
                    $.ajax({
                        ...
                        data: {
                            method: 'read',
                            paymentVoucherCancellationTypeId: lastRecord,
                            output: 'json',
                            securityToken: securityToken,
                            leafId: leafId
                        },
    ...
    if (css.search('disabled') > 0) {
        ...
        if (parseFloat($previousRecordCounter.val()) > 0 && parseFloat($previousRecordCounter.val()) < parseFloat($('#lastRecordCounter').val())) {
            $.ajax({
                ...
                data: {
                    method: 'read',
                    paymentVoucherCancellationTypeId: $previousRecordCounter.val(),
                    output: 'json',
                    securityToken: securityToken,
                    leafId: leafId
                },
    ...
    if (css.search('disabled') > 0) {
        ...
        if (parseFloat($nextRecordCounter.val()) <= parseFloat($('#lastRecordCounter').val())) {
            $.ajax({
                ...
                data: {
                    method: 'read',
                    paymentVoucherCancellationTypeId: $nextRecordCounter.val(),
                    output: 'json',
                    securityToken: securityToken,
                    leafId: leafId
                },
