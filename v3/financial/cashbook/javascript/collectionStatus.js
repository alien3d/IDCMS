function checkDuplicate(leafId, page, securityToken) {
    var $collectionStatusCode = $("#collectionStatusCode");
    if ($collectionStatusCode.val().length === 0) {
    ...
    $.ajax({
        ...
        url: page,
        data: {
            collectionStatusCode: $collectionStatusCode.val(),
            method: 'duplicate',
...
function showFormUpdate(leafId, url, urlList, securityToken, collectionStatusId, updateAccess, deleteAccess) {
    sleep(500);
...
function showModalDelete(collectionStatusId, collectionStatusCode, collectionStatusDescription, collectionStatusDays) {
    // clear first old record if exist
    $('#collectionStatusIdPreview').val('').val(decodeURIComponent(collectionStatusId));
    $('#collectionStatusCodePreview').val('').val(decodeURIComponent(collectionStatusCode));
    $('#collectionStatusDescriptionPreview').val('').val(decodeURIComponent(collectionStatusDescription));
    $('#collectionStatusDaysPreview').val('').val(decodeURIComponent(collectionStatusDays));
...
function deleteGridRecord(leafId, url, urlList, securityToken) {
    $.ajax({
        ...
        data: {
            method: 'delete',
            output: 'json',
            collectionStatusId: $('#collectionStatusIdPreview').val(),
            securityToken: securityToken,
            leafId: leafId
        },
        beforeSend: function() {
...
function deleteGridRecordCheckbox(leafId, url, urlList, securityToken) {
    var stringText = '';
    var counter = 0;
    $('input:checkbox[name="collectionStatusId[]"]').each(function() {
        stringText = stringText + "&collectionStatusId[]=" + $(this).val();
    });
...
function newRecord(leafId, url, urlList, securityToken, type, createAccess, updateAccess, deleteAccess) {
    ...
    var $collectionStatusCode = $('#collectionStatusCode');
    var $collectionStatusDescription = $('#collectionStatusDescription');
    var $collectionStatusDays = $('#collectionStatusDays');
    if (css.search('disabled') > 0) {
        return false;
    } else {
        if (type === 1) {
            if ($collectionStatusCode.val().length === 0) {
                $('#collectionStatusCodeHelpMe')
                        .html('').empty()
                        .html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['collectionStatusCodeLabel'] + " </span>");
                $('#collectionStatusCodeForm')
                        .removeClass().addClass('form-group has-error');
                $collectionStatusCode.focus();
                return false;
            }
            if ($collectionStatusDescription.val().length === 0) {
                $('#collectionStatusDescriptionHelpMe')
                        .html('').empty()
                        .html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['collectionStatusDescriptionLabel'] + " </span>");
                $('#collectionStatusDescriptionForm')
                        .removeClass().addClass('form-group has-error');
                $collectionStatusDescription.focus();
                return false;
            }
            if ($collectionStatusDays.val().length === 0) {
                $('#collectionStatusDaysHelpMe')
                        .html('').empty()
                        .html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['collectionStatusDaysLabel'] + " </span>");
                $('#collectionStatusDaysForm')
                        .removeClass().addClass('form-group has-error');
                $collectionStatusDays.focus();
                return false;
            }
            $.ajax({
                type: 'POST',
                ...
                data: {
                    ...
                    output: 'json',
                    collectionStatusCode: $collectionStatusCode.val(),
                    collectionStatusDescription: $collectionStatusDescription.val(),
                    collectionStatusDays: $collectionStatusDays.val(),
                    securityToken: securityToken,
                    leafId: leafId
                },
                beforeSend: function() {
                ...
                success: function(data) {
                    ...
                    if (success === true) {
                        ...
                        $collectionStatusCode.val('');
                        $('#collectionStatusCodeHelpMe')
                                .html('').empty();
                        $collectionStatusDescription.val('');
                        $('#collectionStatusDescriptionHelpMe')
                                .html('').empty();
                        $collectionStatusDays.val('');
                        $('#collectionStatusDaysHelpMe')
                                .html('').empty();
                    } else if (success === false) {
                        $infoPanel
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (success === true) {
                        ...
                        $('#collectionStatusId').val(data.collectionStatusId);
...
function updateRecord(leafId, url, urlList, securityToken, type, deleteAccess) {
    ...
    var $collectionStatusId = $('#collectionStatusId');
    var $collectionStatusCode = $('#collectionStatusCode');
    var $collectionStatusDescription = $('#collectionStatusDescription');
    var $collectionStatusDays = $('#collectionStatusDays');
    if (css.search('disabled') > 0) {
        ...
        if (type === 1) {
            ...
            $.ajax({
                ...
                data: {
                    method: 'save',
                    output: 'json',
                    collectionStatusId: $collectionStatusId.val(),
                    collectionStatusCode: $collectionStatusCode.val(),
                    collectionStatusDescription: $collectionStatusDescription.val(),
                    collectionStatusDays: $collectionStatusDays.val(),
                    securityToken: securityToken,
            ...
            if ($collectionStatusCode.val().length === 0) {
                $('#collectionStatusCodeHelpMe')
                        .html('').empty()
                        .html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['collectionStatusCodeLabel'] + " </span>");
                $('#collectionStatusCodeForm').removeClass().addClass('form-group has-error');
                $collectionStatusCode.focus();
                return false;
            }
            if ($collectionStatusDescription.val().length === 0) {
                $('#collectionStatusDescriptionHelpMe')
                        .html('').empty()
                        .html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['collectionStatusDescriptionLabel'] + " </span>");
                $('#collectionStatusDescriptionForm').removeClass().addClass('form-group has-error');
                $collectionStatusDescription.focus();
                return false;
            }
            if ($collectionStatusDays.val().length === 0) {
                $('#collectionStatusDaysHelpMe')
                        .html('').empty()
                        .html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['collectionStatusDaysLabel'] + " </span>");
                $('#collectionStatusDaysForm').removeClass().addClass('form-group has-error');
                $collectionStatusDays.focus();
                return false;
            }
            if ($infoPanel.is(':hidden')) {
    ...
    if (css.search('disabled') > 0) {
        ...
        if (deleteAccess === 1) {
            if (confirm(decodeURIComponent(t['deleteRecordMessageLabel']))) {
                var value = $collectionStatusId.val();
                if (!value) {
                    $infoPanel
                            .html('').empty()
...
function resetRecord(leafId, url, urlList, securityToken, createAccess, updateAccess, deleteAccess) {
    ...
    $("#collectionStatusId").val('');
    $("#collectionStatusIdHelpMe")
            .empty().html('');
    $("#collectionStatusCode").val('');
    $("#collectionStatusCodeHelpMe")
            .empty().html('');
            ...
            success: function(data) {
                ...
                if (success === true) {
                    $.ajax({
                        ...
                        data: {
                            method: 'read',
                            collectionStatusId: firstRecord,
                            output: 'json',
                            securityToken: securityToken,
                            leafId: leafId
                        },
                        ...
                        success: function(data) {
                            ...
                            if (success === true) {
                                $('#collectionStatusId').val(data.data.collectionStatusId);
                                $('#collectionStatusCode').val(data.data.collectionStatusCode);
                                $('#collectionStatusDescription').val(data.data.collectionStatusDescription);
                                $('#collectionStatusDays').val(data.data.collectionStatusDays);
                                if (nextRecord > 0) {
                                    $('#previousRecordButton')
                                            .removeClass().addClass('btn btn-default disabled')
                                            .attr('onClick', '');
    ...
    if (css.search('disabled') > 0) {
        ...
        if (parseFloat($previousRecordCounter.val()) > 0 && parseFloat($previousRecordCounter.val()) < parseFloat($('#lastRecordCounter').val())) {
            $.ajax({
                ...
                data: {
                    method: 'read',
                    collectionStatusId: $previousRecordCounter.val(),
                    output: 'json',
                    securityToken: securityToken,
                    leafId: leafId
                },
    ...
    if (css.search('disabled') > 0) {
        ...
        if (parseFloat($nextRecordCounter.val()) <= parseFloat($('#lastRecordCounter').val())) {
            $.ajax({
                ...
                data: {
                    method: 'read',
                    collectionStatusId: $nextRecordCounter.val(),
                    output: 'json',
                    securityToken: securityToken,
                    leafId: leafId
                },
