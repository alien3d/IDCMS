function getCollectionType(leafId, url, securityToken) {
    $.ajax({
        type: 'GET',
        url: url,
        data: {
...
function checkDuplicate(leafId, page, securityToken) {
    ...
    if ($collectionCode.val().length === 0) {
    ...
    $.ajax({
        ...
        url: page,
        data: {
            collectionCode: $collectionCode.val(),
            method: 'duplicate',
            securityToken: securityToken,
            leafId: leafId
        },
...
function showFormUpdate(leafId, url, urlList, securityToken, collectionId, updateAccess, deleteAccess) {
    sleep(500);
...
function showModalDelete(collectionId, collectionTypeId, businessPartnerId, countryId, bankId, paymentTypeId, documentNumber, referenceNumber, chequeNumber, collectionAmount, collectionDate, collectionBankInSlipNumber, collectionBankInSlipDate, collectionTextAmount, collectionDescription, isBalance) {
    ...
    $('#collectionTextAmountPreview').val('').val(decodeURIComponent(collectionTextAmount));
...
function deleteGridRecord(leafId, url, urlList, securityToken) {
    $.ajax({
        ...
        data: {
            method: 'delete',
            output: 'json',
            collectionId: $('#collectionIdPreview').val(),
            securityToken: securityToken,
            leafId: leafId
        },
        beforeSend: function() {
...
function deleteGridRecordCheckbox(leafId, url, urlList, securityToken) {
    var stringText = '';
    var counter = 0;
    $('input:checkbox[name="collectionId[]"]').each(function() {
        stringText = stringText + "&collectionId[]=" + $(this).val();
    });
...
function newRecord(leafId, url, urlList, securityToken, type, createAccess, updateAccess, deleteAccess) {
    ...
    var $collectionTypeId = $('#collectionTypeId');
    ...
    var $chequeNumber = $('#chequeNumber');
    var $collectionAmount = $('#collectionAmount');
    var $collectionDate = $('#collectionDate');
    var $collectionBankInSlipNumber = $('#collectionBankInSlipNumber');
    var $collectionBankInSlipDate = $('#collectionBankInSlipDate');
    var $collectionTextAmount = $('#collectionTextAmount');
    ...
    if (css.search('disabled') > 0) {
        ...
        if (type === 1) {
            if ($collectionTypeId.val().length === 0) {
                $('#collectionTypeIdHelpMe')
                        .html('').empty()
                        .html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['collectionTypeIdLabel'] + " </span>");
                $collectionTypeId.data('chosen').activate_action();
                return false;
            }
            ...
            if ($paymentTypeId.val().length === 0) {
                $('#paymentTypeIdHelpMe')
                        .html('').empty()
                        .html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['paymentTypeIdLabel'] + " </span>");
            ...
            if ($chequeNumber.val().length === 0) {
                $('#chequeNumberHelpMe')
                        .html('').empty()
                        .html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['chequeNumberLabel'] + " </span>");
                $('#chequeNumberForm')
                        .removeClass().addClass('form-group has-error');
                $chequeNumber.focus();
                return false;
            ...
            if ($collectionAmount.val().length === 0) {
                $('#collectionAmountHelpMe')
                        .html('').empty()
                        .html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['collectionAmountLabel'] + " </span>");
                $('#collectionAmountForm')
                        .removeClass().addClass('form-group has-error');
                $collectionAmount.focus();
                return false;
            }
            if ($collectionDate.val().length === 0) {
                $('#collectionDateHelpMe')
                        .html('').empty()
                        .html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['collectionDateLabel'] + " </span>");
                $('#collectionDateForm')
                        .removeClass().addClass('form-group has-error');
                $collectionDate.focus();
                return false;
            }
            if ($collectionBankInSlipNumber.val().length === 0) {
                $('#collectionBankInSlipNumberHelpMe')
                        .html('').empty()
                        .html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['collectionBankInSlipNumberLabel'] + " </span>");
                $('#collectionBankInSlipNumberForm')
                        .removeClass().addClass('form-group has-error');
                $collectionBankInSlipNumber.focus();
                return false;
            }
            if ($collectionBankInSlipDate.val().length === 0) {
                $('#collectionBankInSlipDateHelpMe')
                        .html('').empty()
                        .html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['collectionBankInSlipDateLabel'] + " </span>");
                $('#collectionBankInSlipDateForm')
                        .removeClass().addClass('form-group has-error');
                $collectionBankInSlipDate.focus();
                return false;
            }
            if ($collectionTextAmount.val().length === 0) {
                $('#collectionTextAmountHelpMe')
                        .html('').empty()
                        .html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['collectionTextAmountLabel'] + " </span>");
                $('#collectionTextAmountForm')
                        .removeClass().addClass('form-group has-error');
                $collectionTextAmount.focus();
                return false;
            }
            if ($collectionDescription.val().length === 0) {
                $('#collectionDescriptionHelpMe')
                        .html('').empty()
                        .html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['collectionDescriptionLabel'] + " </span>");
                $('#collectionDescriptionForm')
                        .removeClass().addClass('form-group has-error');
            ...
            if ($isBalance.val().length === 0) {
                $('#isBalanceHelpMe')
                        .html('').empty()
                        .html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['isBalanceLabel'] + " </span>");
                $('#isBalanceForm')
                        .removeClass().addClass('form-group has-error');
                $isBalance.focus();
                return false;
            ...
            $.ajax({
                ...
                data: {
                    method: 'create',
                    output: 'json',
                    collectionTypeId: $collectionTypeId.val(),
                    ...
                    collectionBankInSlipNumber: $collectionBankInSlipNumber.val(),
                    collectionBankInSlipDate: $collectionBankInSlipDate.val(),
                    collectionTextAmount: $collectionTextAmount.val(),
        ...
        if (type === 1) {
            ...
            if ($chequeNumber.val().length === 0) {
                $('#chequeNumberHelpMe')
                        .html('').empty()
                        .html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['chequeNumberLabel'] + " </span>");
                $('#chequeNumberForm').removeClass().addClass('form-group has-error');
                $chequeNumber.focus();
                return false;
            }
            if ($collectionAmount.val().length === 0) {
                $('#collectionAmountHelpMe')
                        .html('').empty()
                        .html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['collectionAmountLabel'] + " </span>");
                $('#collectionAmountForm').removeClass().addClass('form-group has-error');
                $collectionAmount.focus();
                return false;
            }
            if ($collectionDate.val().length === 0) {
                $('#collectionDateHelpMe')
                        .html('').empty()
                        .html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['collectionDateLabel'] + " </span>");
                $('#collectionDateForm').removeClass().addClass('form-group has-error');
                $collectionDate.focus();
                return false;
            }
            if ($collectionBankInSlipNumber.val().length === 0) {
                $('#collectionBankInSlipNumberHelpMe')
                        .html('').empty()
                        .html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['collectionBankInSlipNumberLabel'] + " </span>");
                $('#collectionBankInSlipNumberForm').removeClass().addClass('form-group has-error');
                $collectionBankInSlipNumber.focus();
                return false;
            }
            if ($collectionBankInSlipDate.val().length === 0) {
                $('#collectionBankInSlipDateHelpMe')
                        .html('').empty()
                        .html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['collectionBankInSlipDateLabel'] + " </span>");
                $('#collectionBankInSlipDateForm').removeClass().addClass('form-group has-error');
                $collectionBankInSlipDate.focus();
                return false;
            }
            if ($collectionTextAmount.val().length === 0) {
                $('#collectionTextAmountHelpMe')
                        .html('').empty()
                        .html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['collectionTextAmountLabel'] + " </span>");
                $('#collectionTextAmountForm').removeClass().addClass('form-group has-error');
                $collectionTextAmount.focus();
                return false;
            }
            if ($collectionDescription.val().length === 0) {
                $('#collectionDescriptionHelpMe')
                        .html('').empty()
                        .html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['collectionDescriptionLabel'] + " </span>");
                $('#collectionDescriptionForm').removeClass().addClass('form-group has-error');
                $collectionDescription.focus();
                return false;
            }
            if ($isBalance.val().length === 0) {
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            if (success === true) {
                                ...
                                $('#collectionTextAmount').val(data.data.collectionTextAmount);
