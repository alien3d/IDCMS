function checkDuplicate(leafId, page, securityToken) {
    var $paymentVoucherStatusCode = $("#paymentVoucherStatusCode");
    if ($paymentVoucherStatusCode.val().length === 0) {
    ...
    $.ajax({
        ...
        url: page,
        data: {
            paymentVoucherStatusCode: $paymentVoucherStatusCode.val(),
            method: 'duplicate',
...
function showFormUpdate(leafId, url, urlList, securityToken, paymentVoucherStatusId, updateAccess, deleteAccess) {
    sleep(500);
...
function showModalDelete(paymentVoucherStatusId, paymentVoucherStatusCode, paymentVoucherStatusDescription, paymentVoucherStatusDays) {
    // clear first old record if exist
    $('#paymentVoucherStatusIdPreview').val('').val(decodeURIComponent(paymentVoucherStatusId));
    $('#paymentVoucherStatusCodePreview').val('').val(decodeURIComponent(paymentVoucherStatusCode));
    $('#paymentVoucherStatusDescriptionPreview').val('').val(decodeURIComponent(paymentVoucherStatusDescription));
    $('#paymentVoucherStatusDaysPreview').val('').val(decodeURIComponent(paymentVoucherStatusDays));
...
function deleteGridRecord(leafId, url, urlList, securityToken) {
    $.ajax({
        ...
        data: {
            method: 'delete',
            output: 'json',
            paymentVoucherStatusId: $('#paymentVoucherStatusIdPreview').val(),
            securityToken: securityToken,
            leafId: leafId
        },
        beforeSend: function() {
...
function deleteGridRecordCheckbox(leafId, url, urlList, securityToken) {
    var stringText = '';
    var counter = 0;
    $('input:checkbox[name="paymentVoucherStatusId[]"]').each(function() {
        stringText = stringText + "&paymentVoucherStatusId[]=" + $(this).val();
    });
...
function newRecord(leafId, url, urlList, securityToken, type, createAccess, updateAccess, deleteAccess) {
    ...
    var $paymentVoucherStatusCode = $('#paymentVoucherStatusCode');
    var $paymentVoucherStatusDescription = $('#paymentVoucherStatusDescription');
    var $paymentVoucherStatusDays = $('#paymentVoucherStatusDays');
    if (css.search('disabled') > 0) {
        return false;
    } else {
        if (type === 1) {
            if ($paymentVoucherStatusCode.val().length === 0) {
                $('#paymentVoucherStatusCodeHelpMe')
                        .html('').empty()
                        .html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['paymentVoucherStatusCodeLabel'] + " </span>");
                $('#paymentVoucherStatusCodeForm')
                        .removeClass().addClass('form-group has-error');
                $paymentVoucherStatusCode.focus();
                return false;
            }
            if ($paymentVoucherStatusDescription.val().length === 0) {
                $('#paymentVoucherStatusDescriptionHelpMe')
                        .html('').empty()
                        .html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['paymentVoucherStatusDescriptionLabel'] + " </span>");
                $('#paymentVoucherStatusDescriptionForm')
                        .removeClass().addClass('form-group has-error');
                $paymentVoucherStatusDescription.focus();
                return false;
            }
            if ($paymentVoucherStatusDays.val().length === 0) {
                $('#paymentVoucherStatusDaysHelpMe')
                        .html('').empty()
                        .html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['paymentVoucherStatusDaysLabel'] + " </span>");
                $('#paymentVoucherStatusDaysForm')
                        .removeClass().addClass('form-group has-error');
                $paymentVoucherStatusDays.focus();
                return false;
            }
            $.ajax({
                type: 'POST',
                ...
                data: {
                    ...
                    output: 'json',
                    paymentVoucherStatusCode: $paymentVoucherStatusCode.val(),
                    paymentVoucherStatusDescription: $paymentVoucherStatusDescription.val(),
                    paymentVoucherStatusDays: $paymentVoucherStatusDays.val(),
                    securityToken: securityToken,
                    leafId: leafId
                },
                beforeSend: function() {
                ...
                success: function(data) {
                    ...
                    if (success === true) {
                        ...
                        $paymentVoucherStatusCode.val('');
                        $('#paymentVoucherStatusCodeHelpMe')
                                .html('').empty();
                        $paymentVoucherStatusDescription.val('');
                        $('#paymentVoucherStatusDescriptionHelpMe')
                                .html('').empty();
                        $paymentVoucherStatusDays.val('');
                        $('#paymentVoucherStatusDaysHelpMe')
                                .html('').empty();
                    } else if (success === false) {
                        $infoPanel
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (success === true) {
                        ...
                        $('#paymentVoucherStatusId').val(data.paymentVoucherStatusId);
...
function updateRecord(leafId, url, urlList, securityToken, type, deleteAccess) {
    ...
    var $paymentVoucherStatusId = $('#paymentVoucherStatusId');
    var $paymentVoucherStatusCode = $('#paymentVoucherStatusCode');
    var $paymentVoucherStatusDescription = $('#paymentVoucherStatusDescription');
    var $paymentVoucherStatusDays = $('#paymentVoucherStatusDays');
    if (css.search('disabled') > 0) {
        ...
        if (type === 1) {
            ...
            $.ajax({
                ...
                data: {
                    method: 'save',
                    output: 'json',
                    paymentVoucherStatusId: $paymentVoucherStatusId.val(),
                    paymentVoucherStatusCode: $paymentVoucherStatusCode.val(),
                    paymentVoucherStatusDescription: $paymentVoucherStatusDescription.val(),
                    paymentVoucherStatusDays: $paymentVoucherStatusDays.val(),
                    securityToken: securityToken,
            ...
            if ($paymentVoucherStatusCode.val().length === 0) {
                $('#paymentVoucherStatusCodeHelpMe')
                        .html('').empty()
                        .html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['paymentVoucherStatusCodeLabel'] + " </span>");
                $('#paymentVoucherStatusCodeForm').removeClass().addClass('form-group has-error');
                $paymentVoucherStatusCode.focus();
                return false;
            }
            if ($paymentVoucherStatusDescription.val().length === 0) {
                $('#paymentVoucherStatusDescriptionHelpMe')
                        .html('').empty()
                        .html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['paymentVoucherStatusDescriptionLabel'] + " </span>");
                $('#paymentVoucherStatusDescriptionForm').removeClass().addClass('form-group has-error');
                $paymentVoucherStatusDescription.focus();
                return false;
            }
            if ($paymentVoucherStatusDays.val().length === 0) {
                $('#paymentVoucherStatusDaysHelpMe')
                        .html('').empty()
                        .html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['paymentVoucherStatusDaysLabel'] + " </span>");
                $('#paymentVoucherStatusDaysForm').removeClass().addClass('form-group has-error');
                $paymentVoucherStatusDays.focus();
                return false;
            }
            if ($infoPanel.is(':hidden')) {
    ...
    if (css.search('disabled') > 0) {
        ...
        if (deleteAccess === 1) {
            if (confirm(decodeURIComponent(t['deleteRecordMessageLabel']))) {
                var value = $paymentVoucherStatusId.val();
                if (!value) {
                    $infoPanel
                            .html('').empty()
...
function resetRecord(leafId, url, urlList, securityToken, createAccess, updateAccess, deleteAccess) {
    ...
    $("#paymentVoucherStatusId").val('');
    $("#paymentVoucherStatusIdHelpMe")
            .empty().html('');
    $("#paymentVoucherStatusCode").val('');
    $("#paymentVoucherStatusCodeHelpMe")
            .empty().html('');
            ...
            success: function(data) {
                ...
                if (success === true) {
                    $.ajax({
                        ...
                        data: {
                            method: 'read',
                            paymentVoucherStatusId: firstRecord,
                            output: 'json',
                            securityToken: securityToken,
                            leafId: leafId
                        },
                        ...
                        success: function(data) {
                            ...
                            if (success === true) {
                                $('#paymentVoucherStatusId').val(data.data.paymentVoucherStatusId);
                                $('#paymentVoucherStatusCode').val(data.data.paymentVoucherStatusCode);
                                $('#paymentVoucherStatusDescription').val(data.data.paymentVoucherStatusDescription);
                                $('#paymentVoucherStatusDays').val(data.data.paymentVoucherStatusDays);
                                if (nextRecord > 0) {
                                    $('#previousRecordButton')
                                            .removeClass().addClass('btn btn-default disabled')
                                            .attr('onClick', '');
            ...
            success: function(data) {
                ...
                if (success === true) {
                    $.ajax({
                        ...
                        data: {
                            method: 'read',
                            paymentVoucherStatusId: lastRecord,
                            output: 'json',
                            securityToken: securityToken,
                            leafId: leafId
                        },
    ...
    if (css.search('disabled') > 0) {
        ...
        if (parseFloat($previousRecordCounter.val()) > 0 && parseFloat($previousRecordCounter.val()) < parseFloat($('#lastRecordCounter').val())) {
            $.ajax({
                ...
                data: {
                    method: 'read',
                    paymentVoucherStatusId: $previousRecordCounter.val(),
                    output: 'json',
                    securityToken: securityToken,
                    leafId: leafId
                },
    ...
    if (css.search('disabled') > 0) {
        ...
        if (parseFloat($nextRecordCounter.val()) <= parseFloat($('#lastRecordCounter').val())) {
            $.ajax({
                ...
                data: {
                    method: 'read',
                    paymentVoucherStatusId: $nextRecordCounter.val(),
                    output: 'json',
                    securityToken: securityToken,
                    leafId: leafId
                },
