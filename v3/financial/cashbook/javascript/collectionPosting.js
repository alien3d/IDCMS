...
function showModalDeleteDetail(collectionDetailId) {
    $('#collectionDetailIdPreview').val('').val(decodeURIComponent($("#collectionDetailId" + collectionDetailId).val()));
    $('#chartOfAccountIdPreview').val('').val(decodeURIComponent($("#chartOfAccountId" + collectionDetailId + " option:selected").text()));
    $('#documentNumberPreview').val('').val(decodeURIComponent($("#documentNumber" + collectionDetailId).val()));
    if ($("#journalNumber" + paymentVoucherDetailId).val() === undefined) {
        ...
        $('#journalNumberPreview').val('').val(decodeURIComponent($("#journalNumber" + collectionDetailId).val()));
    }
    $('#collectionDetailAmountPreview').val('').val(decodeURIComponent($("#collectionDetailAmount" + collectionDetailId).val()));
