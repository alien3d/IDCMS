...
require_once($newFakeDocumentRoot . "v3/financial/cashbook/controller/paymentVoucherAllocationController.php");
...
$_POST['from'] = 'paymentVoucherInvoice.php';
$_GET['from'] = 'paymentVoucherInvoice.php';
if (isset($_POST)) {
    if (isset($_POST['method'])) {
        ...
        $paymentVoucherArray = $paymentVoucher->getBusinessPartnerCategory();
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group" id="bankIdDiv">
                                        <label for="bankIdPreview"><?php echo $leafTranslation['bankIdLabel']; ?></label>
                                    ...
                                    <div class="form-group" id="businessPartnerCategoryIdDiv">
                                        <label
                                            for="businessPartnerCategoryIdPreview"><?php echo $leafTranslation['businessPartnerCategoryIdLabel']; ?></label>
                                    ...
                                    <div class="form-group" id="businessPartnerIdDiv">
                                        <label for="businessPartnerIdPreview"><?php echo $leafTranslation['businessPartnerIdLabel']; ?></label>
                                    ...
                                    <div class="form-group" id="paymentTypeIdDiv">
                                        <label for="paymentTypeIdPreview"><?php echo $leafTranslation['paymentTypeIdLabel']; ?></label>
                                        <input type="text" class="form-control" name="paymentTypeIdPreview" id="paymentTypeIdPreview">
                                    </div>
                                    <div class="form-group" id="documentNumberDiv">
                                        ...
                                        <input type="text" class="form-control" name="documentNumberPreview" id="documentNumberPreview">
                                    </div>
                                    <div class="form-group" id="referenceNumberDiv">
                                        <label for="referenceNumberPreview"><?php echo $leafTranslation['referenceNumberLabel']; ?></label>
                                        <input type="text" class="form-control" name="referenceNumberPreview" id="referenceNumberPreview">
                                    </div>
                                    <div class="form-group" id="paymentVoucherDescriptionDiv">
                                        <label
                                            for="paymentVoucherDescriptionPreview"><?php echo $leafTranslation['paymentVoucherDescriptionLabel']; ?></label>
                                    ...
                                    <div class="form-group" id="paymentVoucherDateDiv">
                                        <label for="paymentVoucherDatePreview"><?php echo $leafTranslation['paymentVoucherDateLabel']; ?></label>
                                    ...
                                    <div class="form-group" id="paymentVoucherAmountDiv">
                                        <label
                                            for="paymentVoucherAmountPreview"><?php echo $leafTranslation['paymentVoucherAmountLabel']; ?></label>
                                    ...
                                    <div class="form-group" id="paymentVoucherChequeNumberDiv">
                                        <label
                                            for="paymentVoucherChequeNumberPreview"><?php echo $leafTranslation['paymentVoucherChequeNumberLabel']; ?></label>
                                    ...
                                    <div class="form-group" id="paymentVoucherPayeeDiv">
                                        <label for="paymentVoucherPayeePreview"><?php echo $leafTranslation['paymentVoucherPayeeLabel']; ?></label>
                                        <input type="text" class="form-control" name="paymentVoucherPayeePreview"
                                               id="paymentVoucherPayeePreview">
                                    </div>
                                    <div class="form-group" id="isPrintedDiv">
                                        <label for="isPrintedPreview"><?php echo $leafTranslation['isPrintedLabel']; ?></label>
                                        <input type="text" class="form-control" name="isPrintedPreview" id="isPrintedPreview">
                                    </div>
                                    <div class="form-group" id="isConformDiv">
                                        <label for="isConformPreview"><?php echo $leafTranslation['isConformLabel']; ?></label>
                                        <input type="text" class="form-control" name="isConformPreview" id="isConformPreview">
                                    </div>
                                    <div class="form-group" id="isChequePrintedDiv">
                                        <label for="isChequePrintedPreview"><?php echo $leafTranslation['isChequePrintedLabel']; ?></label>
                                        <input type="text" class="form-control" name="isChequePrintedPreview" id="isChequePrintedPreview">
                                    </div>
                                </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="panel panel-default">
                                <table class="table table table-bordered table-striped table-condensed table-hover smart-form has-tickbox" id="tableData">
                                    ...
                                    <th><?php echo ucwords($leafTranslation['bankIdLabel']); ?></th>
                                    <th><?php echo ucwords($leafTranslation['businessPartnerIdLabel']); ?></th>
                                    <th><?php echo ucwords($leafTranslation['documentNumberLabel']); ?></th>
                                    <th><?php echo ucwords($leafTranslation['paymentVoucherDateLabel']); ?></th>
                                    <th><?php echo ucwords($leafTranslation['paymentVoucherChequeNumberLabel']); ?></th>
                                    <th><?php echo ucwords($leafTranslation['paymentVoucherDescriptionLabel']); ?></th>
                                    <th><?php echo ucwords($leafTranslation['paymentVoucherAmountLabel']); ?></th>
                                                    ...
                                                    for ($i = 0; $i < $totalRecord; $i++) {
                                                        ...
                                                        ?>>
                                                                ...
                                                                <div class="pull-left">
                                                                    ...
                                                                    if (isset($paymentVoucherArray[$i]['bankDescription'])) {
                                                                        if (isset($_POST['query']) || isset($_POST['character'])) {
                                                                            if (isset($_POST['query'])) {
                                                                                if (@strpos($paymentVoucherArray[$i]['bankDescription'], $_POST['query']) !== false) {
                                                                                    echo str_replace(
                                                            ...
                                                            <td>
                                                                <div class="pull-left">
                                                                    <?php
                                                                    if (isset($paymentVoucherArray[$i]['paymentVoucherChequeNumber'])) {
                                                                        if (isset($_POST['query']) || isset($_POST['character'])) {
                                                                            if (isset($_POST['query'])) {
                                                                                if (@strpos(
                                                                                                strtolower($paymentVoucherArray[$i]['paymentVoucherChequeNumber']), strtolower($_POST['query'])
                                                                                        ) !== false
                                                                                ) {
                                                                                    echo str_replace(
                                                                                            $_POST['query'], "<span class=\"label label-info\">" . $_POST['query'] . "</span>", $paymentVoucherArray[$i]['paymentVoucherChequeNumber']
                                                                                    );
                                                                                } else {
                                                                                    echo $paymentVoucherArray[$i]['paymentVoucherChequeNumber'];
                                                                                }
                                                                            } else {
                                                                                if (isset($_POST['character'])) {
                                                                                    if (@strpos(
                                                                                                    strtolower($paymentVoucherArray[$i]['paymentVoucherChequeNumber']), strtolower($_POST['character'])
                                                                                            ) !== false
                                                                                    ) {
                                                                                        echo str_replace(
                                                                                                $_POST['query'], "<span class=\"label label-info\">" . $_POST['character'] . "</span>", $paymentVoucherArray[$i]['paymentVoucherChequeNumber']
                                                                                        );
                                                                                    } else {
                                                                                        echo $paymentVoucherArray[$i]['paymentVoucherChequeNumber'];
                                                                                    }
...
if ((isset($_POST['method']) == 'new' || isset($_POST['method']) == 'read') && $_POST['type'] == 'form') {
    ?>
    <?php
    $paymentVoucherAllocation = new \Core\Financial\Cashbook\PaymentVoucherAllocation\Controller\PaymentVoucherAllocationClass();
    $paymentVoucherAllocation->setServiceOutput('html');
    $paymentVoucherAllocation->setLeafId($leafId);
    $paymentVoucherAllocation->execute();
    //$countryArray = $paymentVoucherAllocation->getCountry();
    $purchaseInvoiceArray = $paymentVoucherAllocation->getPurchaseInvoice();
    $paymentVoucherAllocation->setStart(0);
    $paymentVoucherAllocation->setLimit(999999); // normal system don't like paging..
    $paymentVoucherAllocation->setPageOutput('html');
    if (isset($_POST['paymentVoucherId'])) {
        $paymentVoucherAllocationArray = $paymentVoucherAllocation->read();
    }
    ?>
    <form class="form-horizontal">
        ...
        <div id="content" style="opacity: 1;">
                        ...
                        <div class="panel-heading">
                            <div class="btn-group">
                                <a id="firstRecordbutton"  href="javascript:void(0)" class="btn btn-default"
                                   ...
                                   echo $paymentVoucher->getViewPath();
                                   ?>', '<?php
                                   echo $paymentVoucherAllocation->getControllerPath();
                                        ...
                                        <div class="col-xs-8 col-sm-8 col-md-8">
                                            <select name="businessPartnerId" id="businessPartnerId" class="chzn-select form-control">
                                                ...
                                                if (is_array($businessPartnerArray)) {
                                                    ...
                                                    $paymentVoucherDescription = null;
                                                    if ($totalRecord > 0) {
                                                        $d = 1;
                                                        for ($i = 0; $i < $totalRecord; $i++) {
                                                            if ($i != 0) {
                                                                if ($paymentVoucherDescription != $businessPartnerArray[$i]['businessPartnerCategoryDescription']) {
                                                            ...
                                                            $paymentVoucherDescription = $businessPartnerArray[$i]['businessPartnerCategoryDescription'];
            ...
            <div class="modal hide" id="deleteDetailPreview" tabindex="-1">
                ...
                <div class="modal-body">
                    <input type="hidden" name="paymentVoucherAllocationIdPreview" id="paymentVoucherAllocationIdPreview">
                    ...
                    <div class="form-group" id="purchaseInvoiceIdDiv">
                        ...
                        <input type="text" class="form-control" name="purchaseInvoiceIdPreview"
                               id="purchaseInvoiceIdPreview">
                    </div>
                    <div class="form-group" id="paymentVoucherAllocationAmountDiv">
                        <label for="paymentVoucherAllocationAmountPreview"
                               class="control-label col-xs-4 col-sm-4 col-md-4"><?php echo $leafTranslation['paymentVoucherAllocationAmountLabel']; ?></label>
                        <input type="text" class="form-control" name="paymentVoucherAllocationAmountPreview"
                               id="paymentVoucherAllocationAmountPreview">
                    </div>
                </div>
                <div class="modal-footer">
                    ...
                    echo $paymentVoucherAllocation->getControllerPath();
                    ?>', '<?php
                    echo $paymentVoucherAllocation->getViewPath();
                    ?>', '<?php echo $securityToken; ?>');"><?php echo $t['deleteButtonLabel']; ?></button>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <table class="table table-bordered table-striped table-condensed table-hover" id="tableData">
                        ...
                        <th>
                        <div class="pull-left"><?php echo ucfirst($leafTranslation['purchaseInvoiceIdLabel']); ?></div>
                        </th>
                        <th width="200px">
                        <div align="center"><?php
                            echo ucfirst(
                                    $leafTranslation['paymentVoucherAllocationAmountLabel']
                            );
                            ?></div>
                        </th>
                        </tr>
                        ...
                        <tbody id="tableBody">
                            <?php
                            if (isset($_POST['paymentVoucherId'])) {
                                if (is_array($paymentVoucherAllocationArray)) {
                                    $totalRecordDetail = intval(count($paymentVoucherAllocationArray));
                                    if ($totalRecordDetail > 0) {
                                        $counter = 0;
                                        for ($j = 0; $j < $totalRecordDetail; $j++) {
                                            $counter++;
                                            ?>
                                            <tr id="<?php echo $paymentVoucherAllocationArray[$j]['paymentVoucherAllocationId']; ?>">
                                                <td>
                                                    <div class="form-group"
                                                         id="purchaseInvoiceId<?php echo $paymentVoucherAllocationArray[$j]['paymentVoucherAllocationId']; ?>Detail">
                                                        <select name="purchaseInvoiceId[]"
                                                                id="purchaseInvoiceId<?php echo $paymentVoucherAllocationArray[$j]['paymentVoucherAllocationId']; ?>"
                                                                class="chzn-select form-control"
                                                                onChange="removeMeErrorDetail('purchaseInvoiceId<?php echo $paymentVoucherAllocationArray[$j]['paymentVoucherAllocationId']; ?>');">
                                                            <option value=""></option>
                                                            <?php
                                                            if (is_array($purchaseInvoiceArray)) {
                                                                ...
                                                                if ($totalRecord > 0) {
                                                                    for ($i = 0; $i < $totalRecord; $i++) {
                                                                        if (isset($paymentVoucherAllocationArray[$j]['purchaseInvoiceId'])) {
                                                                            if ($paymentVoucherAllocationArray[$j]['purchaseInvoiceId'] == $purchaseInvoiceArray[$i]['purchaseInvoiceId']) {
                                                                                $selected = "selected";
                                                                            } else {
                                                                                $selected = null;
                                                                            }
                                                                        ...
                                                                        ?>
                                                                        <option
                                                                            value="<?php echo $purchaseInvoiceArray[$i]['purchaseInvoiceId']; ?>" <?php echo $selected; ?>><?php echo $purchaseInvoiceArray[$i]['purchaseInvoiceDescription']; ?></option>
                                                                            <?php
                                                                        }
                                                                    } else {
                                                                        ?>
                                                    ...
                                                    <input type="hidden" name="paymentVoucherId[]"
                                                           id="paymentVoucherId<?php echo $paymentVoucherAllocationArray[$j]['paymentVoucherAllocationId']; ?>"
                                                           value="<?php
                                                           if (isset($paymentVoucherAllocationArray) && is_array(
                                                                           $paymentVoucherAllocationArray
                                                                   )
                                                           ) {
                                                               echo $paymentVoucherAllocationArray[$j]['paymentVoucherId'];
                                                           }
                                                           ?>">
                                                </td>
                                                ...
                                                <td>
                                                    <input class="form-control" style="text-align:right" type="text"
                                                           name="paymentVoucherAllocationAmount[]"
                                                           id="paymentVoucherAllocationAmount<?php echo $paymentVoucherAllocationArray[$j]['paymentVoucherAllocationId']; ?>"
                                                           value="<?php
                                                           if (isset($paymentVoucherAllocationArray) && is_array(
                                                                           $paymentVoucherAllocationArray
                                                                   )
                                                           ) {
                                                               echo $paymentVoucherAllocationArray[$j]['paymentVoucherAllocationAmount'];
                                                           }
                                                           ?>"></td>
                                            </tr>
                                            <?php
                                        ...
                                        <tr>
                                            <td colspan="6" vAlign="top" align="center"><?php
                                                $paymentVoucherAllocation->exceptionMessage(
                                                        $t['recordNotFoundLabel']
                                                );
                                                ?></td>
                                        </tr>
    ...
    <?php } ?>
        ...
        $(document).ready(function() {
            ...
            validateMeNumericRange('paymentVoucherAllocationId');
            validateMeNumericRange('purchaseInvoiceId');
            validateMeCurrencyRange('paymentVoucherAllocationAmount');
    <?php if ($_POST['method'] == "new") { ?>
        ...
        if ($_POST['paymentVoucherId']) {
            ...
            <?php if ($leafAccess['leafAccessUpdateValue'] == 1) { ?>
                        ...
                        $('#updateRecordButton3').attr('onClick', "updateRecord(<?php echo $leafId; ?>,'<?php echo $paymentVoucher->getControllerPath(); ?>','<?php echo $paymentVoucher->getViewPath(); ?>','<?php echo $securityToken; ?>',1,<?php echo $leafAccess['leafAccessDeleteValue']; ?>);");
                        $('#updateRecordButton4').attr('onClick', "updateRecord(<?php echo $leafId; ?>,'<?php echo $paymentVoucher->getControllerPath(); ?>','<?php echo $paymentVoucher->getViewPath(); ?>','<?php echo $securityToken; ?>',2,<?php echo $leafAccess['leafAccessDeleteValue']; ?>);");
                        $('#updateRecordButton5').attr('onClick', "updateRecord(<?php echo $leafId; ?>,'<?php echo $paymentVoucher->getControllerPath(); ?>','<?php echo $paymentVoucher->getViewPath(); ?>','<?php echo $securityToken; ?>',3,<?php echo $leafAccess['leafAccessDeleteValue']; ?>);");
            <?php } else { ?>
                        $('#updateRecordButton1').removeClass().addClass(' btn btn-info disabled').attr('onClick', '');
                        $('#updateRecordButton2').removeClass().addClass('btn dropdown-toggle btn-info disabled');
                        $('#updateRecordButton3').attr('onClick', '');
...
<?php } ?>
<script type="text/javascript" src="./v3/financial/cashbook/javascript/paymentVoucher.js"></script>
<hr>
