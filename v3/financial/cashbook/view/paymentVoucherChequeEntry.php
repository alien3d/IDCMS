...
$_POST['from'] = 'paymentVoucherChequeEntry.php';
$_GET['from'] = 'paymentVoucherChequeEntry.php';
if (isset($_POST)) {
                                ...
                                <div class="modal-body">
                                    <form class="form-horizontal">
                                        ...
                                        <div class="form-group" id="isPrintedDiv">
                                            <label for="isPrintedPreview"
                                                   class="control-label col-xs-4 col-sm-4 col-md-4"><?php echo $leafTranslation['isPrintedLabel']; ?></label>

                                            <div class="col-xs-8 col-sm-8 col-md-8">
                                                <input type="text" class="form-control" name="isPrintedPreview"
                                                       id="isPrintedPreview">
                                            </div>
                                        </div>
                                        <div class="form-group" id="isConformDiv">
                                            <label for="isConformPreview"
                                                   class="control-label col-xs-4 col-sm-4 col-md-4"><?php echo $leafTranslation['isConformLabel']; ?></label>

                                            <div class="col-xs-8 col-sm-8 col-md-8">
                                                <input type="text" class="form-control" name="isConformPreview"
                                                       id="isConformPreview">
                                            </div>
                                        </div>
                                        <div class="form-group" id="isChequePrintedDiv">
                                            <label for="isChequePrintedPreview"
                                                   class="control-label col-xs-4 col-sm-4 col-md-4"><?php echo $leafTranslation['isChequePrintedLabel']; ?></label>

                                            <div class="col-xs-8 col-sm-8 col-md-8">
                                                <input type="text" class="form-control" name="isChequePrintedPreview"
                                                       id="isChequePrintedPreview">
                                            </div>
                                        </div>
                                    </form>
                                </div>
...
if ((isset($_POST['method']) == 'new' || isset($_POST['method']) == 'read') && $_POST['type'] == 'form') {
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="panel panel-info">
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="col-md-4 form-group" id="businessPartnerIdForm">
                                        ...
                                        <div class="col-xs-8 col-sm-8 col-md-8">
                                            <select name="businessPartnerId" id="businessPartnerId" class="chzn-select disabled" disabled>
                                                <option value=""></option>
                                                <?php
                                        ...
                                        <div class="col-xs-8 col-sm-8 col-md-8">
                                            <div class="input-group">
                                                <input type="text" class="form-control" name="paymentVoucherPayee"
                                                       id="paymentVoucherPayee" disabled value="<?php
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="col-md-4 form-group" id="bankIdForm">
                                        ...
                                        <div class="col-xs-8 col-sm-8 col-md-8">
                                            <select name="bankId" id="bankId" class="chzn-select form-control" disabled>
                                                <option value=""></option>
                                                <?php
                                        ...
                                        <div class="col-xs-8 col-sm-8 col-md-8">
                                            <div class="input-group">
                                                <input type="text" class="form-control" name="paymentVoucherDate"
                                                       id="paymentVoucherDate" disabled value="<?php
                                                       if (isset($value)) {
                                                           echo $value;
                                                       }
                                                       ?>">
                                        ...
                                        <div class="col-xs-8 col-sm-8 col-md-8">
                                            <div class="input-group">
                                                <input type="text" class="form-control" name="paymentVoucherAmount"
                                                       id="paymentVoucherAmount" disabled value="<?php
                                                       if (isset($paymentVoucherArray) && is_array($paymentVoucherArray)) {
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group" id="paymentVoucherDescriptionForm">
                                        <div class="col-xs-12 col-sm-12 col-md-12">
                                            <textarea rows="3" class="form-control" name="paymentVoucherDescription"
                                                      id="paymentVoucherDescription" disabled><?php
                        ...
                        <div class="panel-footer" align="center">
                            <div class="btn-group" align="center">
                                <div class="btn-group">
                                    <button id="updateRecordbutton"  name="updateRecordbutton"><i
                                            class="glyphicon glyphicon-plus"></i> <?php echo $t['updateButtonLabel']; ?>
                                    </button>
                                </div>
                                <div class="btn-group">
                                    <button id="resetRecordbutton"  class="btn btn-info" onClick="resetRecord(<?php echo $leafId; ?>, '<?php echo $paymentVoucher->getControllerPath(); ?>', '<?php echo $paymentVoucher->getViewPath(); ?>', '<?php echo $securityToken; ?>',<?php echo $leafAccess['leafAccessCreateValue']; ?>,<?php echo $leafAccess['leafAccessUpdateValue']; ?>,<?php echo $leafAccess['leafAccessDeleteValue']; ?>);"><i
                                            class="glyphicon glyphicon-refresh glyphicon-white"></i> <?php echo $t['resetButtonLabel']; ?>
                                    </button>
                                </div>
                                <div class="btn-group">
                                    <button id="listRecordbutton"  class="btn btn-info"
                                            onClick="showGrid(<?php echo $leafId; ?>, '<?php
                                            echo $paymentVoucher->getViewPath();
            ...
            <div class="modal fade" id="deletePreview" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <input type="hidden" name="paymentVoucherAllocationIdPreview"
                                   id="paymentVoucherAllocationIdPreview">
                            ...
                            <div class="form-group" id="paymentVoucherAllocationAmountDiv">
                                ...
                                <div class="control-label col-md-8">
                                    <input type="text" class="form-control"
                                           name="paymentVoucherAllocationAmountPreview"
                                            ...
                                            for ($j = 0; $j < $totalRecordDetail; $j++) {
                                                ...
                                                <tr id="<?php echo $paymentVoucherAllocationArray[$j]['paymentVoucherAllocationId']; ?>">
                                                    <td>
                                                        ...
                                                        <input type="hidden" name="paymentVoucherId[]" id="paymentVoucherId<?php echo $paymentVoucherAllocationArray[$j]['paymentVoucherAllocationId']; ?>"
                                                               value="<?php
                                                               if (isset($paymentVoucherAllocationArray) && is_array($paymentVoucherAllocationArray)) {
    ...
    if ($_POST['paymentVoucherId']) {
        if ($leafAccess['leafAccessUpdateValue'] == 1) {
            ?>
                    $('#updateRecordButton').removeClass().addClass('btn btn-info').attr('onClick', "updateRecord(<?php echo $leafId; ?>,'<?php echo $paymentVoucher->getControllerPath(); ?>','<?php echo $securityToken; ?>');");
        <?php } else { ?>
...
<?php } ?>
<script type="text/javascript" src="./v3/financial/cashbook/javascript/paymentVoucherChequeEntry.js"></script>
<hr>
