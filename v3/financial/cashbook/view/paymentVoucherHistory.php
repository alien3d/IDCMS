...
$_POST['from'] = 'paymentVoucherHistory.php';
$_GET['from'] = 'paymentVoucherHistory.php';
if (isset($_POST)) {
        ...
        <div id="content" style="opacity: 1;">
            ...
            <div class="row">
                ...
                <div id="rightViewport" class="col-xs-9 col-sm-9 col-md-9">
                    <div class="modal fade" id="historyPreview" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                         aria-hidden="true">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group" id="paymentTypeIdDiv">
                                        ...
                                        <div class="col-xs-8 col-sm-8 col-md-8"><input type="text" class="form-control"
                                                                                       name="paymentTypeIdPreview" id="paymentTypeIdPreview">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group" id="referenceNumberDiv">
                                        ...
                                        <div class="col-xs-8 col-sm-8 col-md-8"><input type="text" class="form-control"
                                                                                       name="referenceNumberPreview" id="referenceNumberPreview">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group" id="paymentVoucherDateDiv">
                                        ...
                                        <div class="col-xs-8 col-sm-8 col-md-8"><input type="text" class="form-control"
                                                                                       name="paymentVoucherDatePreview"
                                    ...
                                    <div class="form-group" id="paymentVoucherChequeDateDiv">
                                        ...
                                        <div class="col-xs-8 col-sm-8 col-md-8"><input type="text" class="form-control"
                                                                                       name="paymentVoucherChequeDatePreview"
                                                                                       id="paymentVoucherChequeDatePreview">
                                        </div>
                                    </div>
                                    <div class="form-group" id="paymentVoucherAmountDiv">
                                        <label for="paymentVoucherAmountPreview" class="control-label col-xs-4 col-sm-4 col-md-4"
                                               ><?php echo $leafTranslation['paymentVoucherAmountLabel']; ?></label>
                                        <div class="col-xs-8 col-sm-8 col-md-8"><input type="text" class="form-control"
                                                                                       name="paymentVoucherAmountPreview"
                                    ...
                                    <div class="form-group" id="paymentVoucherPayeeDiv">
                                        ...
                                        <div class="col-xs-8 col-sm-8 col-md-8"><input type="text" class="form-control"
                                                                                       name="paymentVoucherPayeePreview"
                                                                                       id="paymentVoucherPayeePreview">
                                        </div>
                                    </div>
                                </div>
                                <div class="modal-footer">
                                    <button type="button"  onClick="showMeModal('historyPreview', 0);" class="btn btn-default"
                                                            ...
                                                            <td align="center">
                                                                <div class="btn-group" align="center">
                                                                    <button type="button"  class="btn btn-info btn-xs" title="Edit"
                                                                        ...
                                                                        <i class="glyphicon glyphicon-zoom-in glyphicon-white"></i></button>
    ...
    <form class="form-horizontal">
        ...
        <div id="content" style="opacity: 1;">
            <div class="row">
                ...
                <div class="modal hide" id="postDetailPreview" tabindex="-1">
                    <div class="modal-header">
                        <button type="button"  class="close" data-dismiss="modal" aria-hidden="false">&times;</button>
                    ...
                    <div class="modal-footer">
                        <button type="button"  class="btn btn-danger" onClick="postGridRecordDetail(<?php echo $leafId; ?>, '<?php
                        echo $paymentVoucherDetail->getControllerPath();
                        ?>', '<?php
                        echo $paymentVoucherDetail->getViewPath();
                        ?>', '<?php echo $securityToken; ?>');"><?php echo $t['deleteButtonLabel']; ?></button>
                        <button type="button"  onClick="showMeModal('postDetailPreview', 0);" class="btn btn-default"
...
<?php } ?>
<script type="text/javascript" src="./v3/financial/cashbook/javascript/paymentVoucherHistory.js"></script>
<hr>
