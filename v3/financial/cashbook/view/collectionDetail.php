...
$_POST['from'] = 'collectionDetail.php';
$_GET['from'] = 'collectionDetail.php';
if (isset($_POST)) {
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="panel panel-default">
                                <table class="table table table-bordered table-striped table-condensed table-hover smart-form has-tickbox" id="tableData">
                                    ...
                                    <th width="75px"><?php echo ucwords($leafTranslation['collectionDateLabel']); ?></th>
                                    ...
                                    <th width="100px"><?php echo ucwords($leafTranslation['executeTimeLabel']); ?></th>
                                    <th width="25px" align="center">
                                                        ...
                                                        ?>>
                                                            ...
                                                            <td align="center">
                                                                <div class="btn-group" align="center">
                                                                    ...
                                                                    ?>', '<?php
                                                                    echo rawurlencode(
                                                                            $collectionArray [$i]['collectionTypeDescription']
                                                                    );
                                                                    ?>', '<?php
                                                                    echo rawurlencode(
                                                                            $collectionArray [$i]['businessPartnerCompany']
                                                                    );
                                                                    ?>', '<?php
                                                                    echo rawurlencode(
                                                                            $collectionArray [$i]['countryDescription']
                                                                    );
                                                                    ?>', '<?php
                                                                    echo rawurlencode(
                                                                            $collectionArray [$i]['bankDescription']
                                                                    );
                                                                    ?>', '<?php
                                                                    echo rawurlencode(
                                                                            $collectionArray [$i]['paymentTypeDescription']
                                                                    );
                                                                    ?>', '<?php
                                                                    echo rawurlencode(
...
if ((isset($_POST['method']) == 'new' || isset($_POST['method']) == 'read') && $_POST['type'] == 'form') {
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="col-md-4 form-group" id="collectionTypeIdForm">
                                        <label for="collectionTypeId" class="control-label col-xs-4 col-sm-4 col-md-4"><strong><?php
                                                echo ucfirst(
        ...
        <div class="modal hide" id="deleteDetailPreview" tabindex="-1">
            ...
            <div class="modal-body">
                ...
                <div class="form-group" id="collectionDetailAmountDiv">
                    <label for="collectionDetailAmountPreview"
                           class="control-label col-xs-4 col-sm-4 col-md-4"><?php echo $leafTranslation['collectionDetailAmountLabel']; ?></label>
    ...
    <?php if ($leafAccess['leafAccessCreateValue'] == 1) { ?>
                ...
                if (e.which === 78 && e.which === 18 && e.shiftKey) {
                    ...
                    newRecord(<?php echo $leafId; ?>, '<?php echo $collection->getControllerPath(); ?>', '<?php echo $collection->getViewPath(); ?>', '<?php echo $securityToken; ?>', 1);
    ...
    <?php if ($leafAccess['leafAccessUpdateValue'] == 1) { ?>
                ...
                if (e.which === 83 && e.which === 18 && e.shiftKey) {
                    ...
                    updateRecord(<?php echo $leafId; ?>, '<?php echo $collection->getControllerPath(); ?>', '<?php echo $collection->getViewPath(); ?>', '<?php echo $securityToken; ?>', 1, <?php echo $leafAccess['leafAccessDeleteValue']; ?>);
    ...
    <?php if ($leafAccess['leafAccessDeleteValue'] == 1) { ?>
                ...
                if (e.which === 88 && e.which === 18 && e.shiftKey) {
                    ...
                    deleteRecord(<?php echo $leafId; ?>, '<?php echo $collection->getControllerPath(); ?>', '<?php echo $collection->getViewPath(); ?>', '<?php echo $securityToken; ?>', <?php echo $leafAccess['leafAccessDeleteValue']; ?>);
    ...
    <?php } ?>
        ...
        $(document).ready(function() {
            ...
            validateMeNumericRange('collectionDetailId');
            ...
            validateMeCurrencyRange('collectionDetailAmount');
...
<?php } ?>
<script type="text/javascript" src="./v3/financial/cashbook/javascript/collectionDetail.js"></script>
<hr>
