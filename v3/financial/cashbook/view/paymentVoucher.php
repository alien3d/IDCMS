...
$_POST['from'] = 'paymentVoucher.php';
$_GET['from'] = 'paymentVoucher.php';
if (isset($_POST)) {
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12">
                                            <div class="panel panel-default">
                                                <table class="table table table-bordered table-striped table-condensed table-hover smart-form has-tickbox" id="tableData">
                                                    ...
                                                    <th width="100px"><?php echo ucwords($leafTranslation['paymentVoucherAmountLabel']); ?></th>
                                                    <th width="100px">
                                                    ...
                                                    <tfoot>
                                                        ...
                                                        <tr class="success">
                                                            ...
                                                            <td>
                                                                <div class="pull-right total"><strong><?php
                                                                        if (class_exists('NumberFormatter')) {
                                                                            $a = new \NumberFormatter($systemFormat['languageCode'], \NumberFormatter::CURRENCY);
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group" id="purchaseInvoiceIdDiv">
                                            ...
                                            <div class="col-xs-8 col-sm-8 col-md-8"><input type="text" class="form-control"
                                                                                           name="purchaseInvoiceIdPreview" id="purchaseInvoiceIdPreview">
                                            </div>
                                        </div>
                                        <div class="form-group" id="paymentVoucherAllocationAmountDiv">
                                            <label
                                                for="paymentVoucherAllocationAmountPreview"><?php echo $leafTranslation['paymentVoucherAllocationAmountLabel']; ?></label>
