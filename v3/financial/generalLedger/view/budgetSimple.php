...
$_POST['from'] = 'budgetSimple.php';
$_GET['from'] = 'budgetSimple.php';
if (isset($_POST)) {
                                    ...
                                    <form class="form-horizontal">
                                        ...
                                        <div class="form-group" id="budgetTargetMonthOneDiv">
                                            <label for="budgetTargetMonthOnePreview"
                                                   class="control-label col-xs-4 col-sm-4 col-md-4"><?php
                                                       echo ucfirst(
                                                               $t['januaryTextLabel']
                                                       );
                                                       ?></label>
...
if ((isset($_POST['method']) == 'new' || isset($_POST['method']) == 'read') && $_POST['type'] == 'form') {
    ...
    <?php if ($leafAccess['leafAccessCreateValue'] == 1) { ?>
                            ...
                            if (e.which === 78 && e.which === 18 && e.shiftKey) {
                                ...
                                newRecord(<?php echo $leafId; ?>, '<?php echo $budget->getControllerPath(); ?>', '<?php echo $budget->getViewPath(); ?>', '<?php echo $securityToken; ?>', 1);
    ...
    <?php if ($leafAccess['leafAccessUpdateValue'] == 1) { ?>
                                updateRecord(<?php echo $leafId; ?>, '<?php echo $budget->getControllerPath(); ?>', '<?php echo $budget->getViewPath(); ?>', '<?php echo $securityToken; ?>', 1, <?php echo $leafAccess['leafAccessDeleteValue']; ?>);
    <?php } ?>
                            return false;
                        }
    ...
    <?php if ($leafAccess['leafAccessDeleteValue'] == 1) { ?>
                                deleteRecord(<?php echo $leafId; ?>, '<?php echo $budget->getControllerPath(); ?>', '<?php echo $budget->getViewPath(); ?>', '<?php echo $securityToken; ?>', <?php echo $leafAccess['leafAccessDeleteValue']; ?>);
    ...
    <?php } ?>
                        ...
                        switch (e.keyCode) {
                            case 37:
                                previousRecord(<?php echo $leafId; ?>, '<?php echo $budget->getControllerPath(); ?>', '<?php echo $budget->getViewPath(); ?>', '<?php echo $securityToken; ?>', <?php echo $leafAccess['leafAccessUpdateValue']; ?>, <?php echo $leafAccess['leafAccessDeleteValue']; ?>);

                                return false;
                                break;
                            case 39:
                                nextRecord(<?php echo $leafId; ?>, '<?php echo $budget->getControllerPath(); ?>', '<?php echo $budget->getViewPath(); ?>', '<?php echo $securityToken; ?>', <?php echo $leafAccess['leafAccessUpdateValue']; ?>, <?php echo $leafAccess['leafAccessDeleteValue']; ?>);
...
<script type="text/javascript" src="./v3/financial/generalLedger/javascript/budgetSimple.js"></script>
<hr>
