...
$_POST['from'] = 'profitAndLoss.php';
$_GET['from'] = 'profitAndLoss.php';
if (isset($_POST)) {
                                ...
                                <div class="modal-body">
                                    <form class="form-horizontal">
                                        ...
                                        <div class="form-group" id="documentNumberDiv">
                                            ...
                                            <div class="col-xs-8 col-sm-8 col-md-8">
                                                <input class="form-control" type="text" name="documentNumberPreview"
                                                       id="documentNumberPreview" class="control-label col-xs-4 col-sm-4 col-md-4">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group" id="transactionTypeCodeDiv"
                                             class="control-label col-xs-4 col-sm-4 col-md-4">
    ...
    if (isset($_POST ['dateRangeType'])) {
        if ($_POST ['dateRangeType'] == 'day') {
            ...
            if ($_POST['dateRangeType'] == 'week') {
                ...
                $series = "
		{
			name	:	'" . $t['salesTextLabel'] . "',
			color	: 	'#058DC7',
			type	: 	'column',
			data	: 	[";
                $Weekly = $generalLedger->getCrossTabWeeklyChartOfAccountType('H');
                $seriesInside = null;
                for ($i = 0; $i <= 7; $i++) {
			...
			name	: 	'" . $t['salesAdjustmentTextLabel'] . "',
			color	: 	'#50B432',
			type	: 	'column',
			data	:	[";
                $Weekly = $generalLedger->getCrossTabWeeklyChartOfAccountType('I');
                $seriesInside = null;
                for ($i = 0; $i <= 7; $i++) {
                    $seriesInside .= $Weekly[$i] . ",";
                }
                ...
                $series .= "
					...
					name	:	'" . $t['costOfGoodSoldsTextLabel'] . "',
					color	: 	'#ED561B',
					type	: 	'column',
					data	: 	[";
                $Weekly = $generalLedger->getCrossTabWeeklyChartOfAccountType('J');
                $seriesInside = null;
                for ($i = 0; $i <= 7; $i++) {
                    $seriesInside .= $Weekly[$i] . ",";
                }
                ...
                $series .= "
					...
					name	:	'" . $t['otherIncomeTextLabel'] . "',
					color	: 	'#DDDF00',
					type	: 	'column',
					data	:	[";
                $Weekly = $generalLedger->getCrossTabWeeklyChartOfAccountType('L');
                $seriesInside = null;
                for ($i = 0; $i <= 7; $i++) {
                    $seriesInside .= $Weekly[$i] . ",";
                }
			...
			name	:	'" . $t['expensesTextLabel'] . "',
			color	: 	'#24CBE5',
			type	: 	'column',
			data	: 	[";
                $Weekly = $generalLedger->getCrossTabWeeklyChartOfAccountType('M');
                $seriesInside = null;
                for ($i = 0; $i <= 7; $i++) {
                    $seriesInside .= $Weekly[$i] . ",";
                }
			...
			name	:	'" . $t['taxationTextLabel'] . "',
			color	: 	'#24CBE5',
			type	: 	'column',
			data	: 	[";
                $Weekly = $generalLedger->getCrossTabWeeklyChartOfAccountType('P');
                $seriesInside = null;
                for ($i = 0; $i <= 7; $i++) {
                    $seriesInside .= $Weekly[$i] . ",";
                }
			...
			name	:	'" . $t['ordinaryTextLabel'] . "',
			color	: 	'#24CBE5',
			type	: 	'column',
			data	: 	[";
                $Weekly = $generalLedger->getCrossTabWeeklyChartOfAccountType('S');
                $seriesInside = null;
                for ($i = 0; $i <= 7; $i++) {
                    $seriesInside .= $Weekly[$i] . ",";
                }
			...
			name	:	'" . $t['appriopiationTextLabel'] . "',
			color	: 	'#24CBE5',
			type	: 	'column',
			data	: 	[";
                $Weekly = $generalLedger->getCrossTabWeeklyChartOfAccountType('T');
                $seriesInside = null;
                for ($i = 0; $i <= 7; $i++) {
                    $seriesInside .= $Weekly[$i] . ",";
                }
                    ...
                    $series = "
		{
			...
			type	: 	'column',
			data	:	[";
                    $daily = $generalLedger->getCrossTabDailyChartOfAccountType('H');
					...
					type	: 	'column',
					data	:	[";
                    $daily = $generalLedger->getCrossTabDailyChartOfAccountType('I');
                    $seriesInside = null;
                    for ($i = 1; $i <= $totalDayInMonth; $i++) {
                        $seriesInside .= ($daily[$i] + 0) . ",";
                    }
					...
					type	: 	'column',
					data	: 	[";
                    $daily = $generalLedger->getCrossTabDailyChartOfAccountType('J');
                    $seriesInside = null;
                    for ($i = 1; $i <= $totalDayInMonth; $i++) {
                        $seriesInside .= ($daily[$i] + 0) . ",";
                    }
					...
					type	: 'column',
					data	: [";
                    $daily = $generalLedger->getCrossTabDailyChartOfAccountType('L');
                    $seriesInside = null;
                    for ($i = 1; $i <= $totalDayInMonth; $i++) {
                        $seriesInside .= ($daily[$i] + 0) . ",";
                    }
					...
					type	: 	'column',
					data	:	[";
                    $daily = $generalLedger->getCrossTabDailyChartOfAccountType('M');
                    $seriesInside = null;
                    for ($i = 1; $i <= $totalDayInMonth; $i++) {
                        $seriesInside .= ($daily[$i] + 0) . ",";
                    }
					...
					type	: 	'column',
					data	:	[";
                    $daily = $generalLedger->getCrossTabDailyChartOfAccountType('P');
                    $seriesInside = null;
                    for ($i = 1; $i <= $totalDayInMonth; $i++) {
                        $seriesInside .= ($daily[$i] + 0) . ",";
                    }
					...
					type	: 	'column',
					data	:	[";
                    $daily = $generalLedger->getCrossTabDailyChartOfAccountType('S');
                    $seriesInside = null;
                    for ($i = 1; $i <= $totalDayInMonth; $i++) {
                        $seriesInside .= ($daily[$i] + 0) . ",";
                    }
					...
					type	: 	'column',
					data	:	[";
                    $daily = $generalLedger->getCrossTabDailyChartOfAccountType('T');
                    $seriesInside = null;
                    for ($i = 1; $i <= $totalDayInMonth; $i++) {
                        $seriesInside .= ($daily[$i] + 0) . ",";
                    }
                        ...
                        $xAxis = "
		{
			categories: [
                        ...
                        $series = "
				{
					...
					type	: 	'column',
					data	: 	[";
                        $Monthly = $generalLedger->getCrossTabMonthlyChartOfAccountType('H');
					...
					type	: 	'column',
					data	: 	[";
                        $Monthly = $generalLedger->getCrossTabMonthlyChartOfAccountType('I');
                        $series .= ($Monthly['jan'] + 0) . "," . ($Monthly['feb'] + 0) . "," . ($Monthly['mac'] + 0) . "," . ($Monthly['apr'] + 0) . "," . ($Monthly['may'] + 0) . "," . ($Monthly['jun'] + 0) . "," . ($Monthly['jul'] + 0) . "," . ($Monthly['aug'] + 0) . "," . ($Monthly['sep'] + 0) . "," . ($Monthly['oct'] + 0) . "," . ($Monthly['nov'] + 0) . "," . ($Monthly['dec'] + 0);
                        $series .= "
					]
				},{
					...
					type	: 	'column',
					data	:	[";
                        $Monthly = $generalLedger->getCrossTabMonthlyChartOfAccountType('J');
                        $series .= ($Monthly['jan'] + 0) . "," . ($Monthly['feb'] + 0) . "," . ($Monthly['mac'] + 0) . "," . ($Monthly['apr'] + 0) . "," . ($Monthly['may'] + 0) . "," . ($Monthly['jun'] + 0) . "," . ($Monthly['jul'] + 0) . "," . ($Monthly['aug'] + 0) . "," . ($Monthly['sep'] + 0) . "," . ($Monthly['oct'] + 0) . "," . ($Monthly['nov'] + 0) . "," . ($Monthly['dec'] + 0);
                        $series .= "
					]
				},{
					...
					type	: 	'column',
					data	: 	[";
                        $Monthly = $generalLedger->getCrossTabMonthlyChartOfAccountType('L');
                        $series .= ($Monthly['jan'] + 0) . "," . ($Monthly['feb'] + 0) . "," . ($Monthly['mac'] + 0) . "," . ($Monthly['apr'] + 0) . "," . ($Monthly['may'] + 0) . "," . ($Monthly['jun'] + 0) . "," . ($Monthly['jul'] + 0) . "," . ($Monthly['aug'] + 0) . "," . ($Monthly['sep'] + 0) . "," . ($Monthly['oct'] + 0) . "," . ($Monthly['nov'] + 0) . "," . ($Monthly['dec'] + 0);
                        $series .= "]
				},{
					name	: 	'" . $t['expensesTextLabel'] . "',
					...
					type	: 	'column',
					data	:	[ ";
                        $Monthly = $generalLedger->getCrossTabMonthlyChartOfAccountType('M');
					...
					type	: 	'column',
					data	:	[ ";
                        $Monthly = $generalLedger->getCrossTabMonthlyChartOfAccountType('P');
					...
					type	: 	'column',
					data	:	[ ";
                        $Monthly = $generalLedger->getCrossTabMonthlyChartOfAccountType('S');
                        $series .= $Monthly['jan'] . "," . ($Monthly['feb'] + 0) . "," . ($Monthly['mac'] + 0) . "," . ($Monthly['apr'] + 0) . "," . ($Monthly['may'] + 0) . "," . ($Monthly['jun'] + 0) . "," . $Monthly['jul'] . "," . $Monthly['aug'] . "," . $Monthly['sep'] . "," . $Monthly['oct'] . "," . $Monthly['nov'] . "," . $Monthly['dec'];
                        $series .= "
					]
				},{
					...
					type	: 	'column',
					data	:	[ ";
                        $Monthly = $generalLedger->getCrossTabMonthlyChartOfAccountType('T');
                        $series .= $Monthly['jan'] . "," . ($Monthly['feb'] + 0) . "," . ($Monthly['mac'] + 0) . "," . ($Monthly['apr'] + 0) . "," . ($Monthly['may'] + 0) . "," . ($Monthly['jun'] + 0) . "," . $Monthly['jul'] . "," . $Monthly['aug'] . "," . $Monthly['sep'] . "," . $Monthly['oct'] . "," . $Monthly['nov'] . "," . $Monthly['dec'];
                        $series .= "
					]
				}";
                            ...
                            $xAxis = "
		{
			categories: [
							'" . $t['salesTextLabel'] . "',
							'" . $t['salesAdjustmentTextLabel'] . "',
							'" . $t['costOfGoodSoldsTextLabel'] . "',
							'" . $t['otherIncomeTextLabel'] . "',
							'" . $t['expensesTextLabel'] . "',
							'" . $t['taxationTextLabel'] . "',
							'" . $t['ordinaryTextLabel'] . "',
							'" . $t['appriopiationTextLabel'] . "'
			]
		}";
                            $series = "
		{
			...
			type	: 	'column',
			data	:	[
							" . intval($between['sales'] + 0) . ",
								" . intval($between['salesAdjustment'] + 0) . ",
								" . intval($between['costOfGoodSolds'] + 0) . ",
								" . intval($between['otherIncome'] + 0) . ",
								" . intval($between['expenses'] + 0) . ",
								" . intval($between['ordinary'] + 0) . ",
								" . intval($between['appropriation'] + 0) . "
			]
		}";
                        }
                    }
...
<?php
$yAxis = '';
echo $generalLedger->lineGraphs($containerName, $t['chartOfAccountTypeTextLabel'], 'Total Category', $xAxis, $yAxis, $series)
?>
        });
