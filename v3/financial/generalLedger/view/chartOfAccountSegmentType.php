...
require_once($newFakeDocumentRoot . "v3/financial/generalLedger/controller/chartOfAccountSegmentTypeController.php");
...
$translator->setCurrentTable('chartOfAccountSegmentType');
...
if (isset($_POST)) {
    if (isset($_POST['method'])) {
        $chartOfAccountSegmentType = new \Core\Financial\GeneralLedger\ChartOfAccountSegmentType\Controller\ChartOfAccountSegmentTypeClass( );
        define('LIMIT', 10);
        ...
        if (isset($_POST ['query'])) {
            $chartOfAccountSegmentType->setFieldQuery($_POST ['query']);
        }
        if (isset($_POST ['filter'])) {
            $chartOfAccountSegmentType->setGridQuery($_POST ['filter']);
        }
        if (isset($_POST ['character'])) {
            $chartOfAccountSegmentType->setCharacterQuery($_POST['character']);
        }
        if (isset($_POST ['dateRangeStart'])) {
            $chartOfAccountSegmentType->setDateRangeStartQuery($_POST['dateRangeStart']);
            //explode the data to get day,month,year
            $start = explode('-', $_POST ['dateRangeStart']);
            $chartOfAccountSegmentType->setStartDay($start[2]);
            $chartOfAccountSegmentType->setStartMonth($start[1]);
            $chartOfAccountSegmentType->setStartYear($start[0]);
        }
        if (isset($_POST ['dateRangeEnd']) && (strlen($_POST['dateRangeEnd']) > 0)) {
            $chartOfAccountSegmentType->setDateRangeEndQuery($_POST['dateRangeEnd']);
            //explode the data to get day,month,year
            $start = explode('-', $_POST ['dateRangeEnd']);
            $chartOfAccountSegmentType->setEndDay($start[2]);
            $chartOfAccountSegmentType->setEndMonth($start[1]);
            $chartOfAccountSegmentType->setEndYear($start[0]);
        }
        if (isset($_POST ['dateRangeType'])) {
            $chartOfAccountSegmentType->setDateRangeTypeQuery($_POST['dateRangeType']);
        }
        if (isset($_POST ['dateRangeExtraType'])) {
            $chartOfAccountSegmentType->setDateRangeExtraTypeQuery($_POST['dateRangeExtraType']);
        }
        $chartOfAccountSegmentType->setServiceOutput('html');
        $chartOfAccountSegmentType->setLeafId($leafId);
        $chartOfAccountSegmentType->execute();
        if ($_POST['method'] == 'read') {
            $chartOfAccountSegmentType->setStart($offset);
            $chartOfAccountSegmentType->setLimit($limit); // normal system don't like paging..
            $chartOfAccountSegmentType->setPageOutput('html');
            $chartOfAccountSegmentTypeArray = $chartOfAccountSegmentType->read();
            if (isset($chartOfAccountSegmentTypeArray [0]['firstRecord'])) {
                $firstRecord = $chartOfAccountSegmentTypeArray [0]['firstRecord'];
            }
            if (isset($chartOfAccountSegmentTypeArray [0]['nextRecord'])) {
                $nextRecord = $chartOfAccountSegmentTypeArray [0]['nextRecord'];
            }
            if (isset($chartOfAccountSegmentTypeArray [0]['previousRecord'])) {
                $previousRecord = $chartOfAccountSegmentTypeArray [0]['previousRecord'];
            }
            if (isset($chartOfAccountSegmentTypeArray [0]['lastRecord'])) {
                $lastRecord = $chartOfAccountSegmentTypeArray [0]['lastRecord'];
                $endRecord = $chartOfAccountSegmentTypeArray [0]['lastRecord'];
            }
            $navigation = new \Core\Paging\HtmlPaging();
            $navigation->setLeafId($leafId);
            $navigation->setViewPath($chartOfAccountSegmentType->getViewPath());
            ...
            if (isset($chartOfAccountSegmentTypeArray [0]['total'])) {
                $total = $chartOfAccountSegmentTypeArray [0]['total'];
            } else {
                $total = 0;
            }
            ...
            <div class="row">
                <div class="pull-left btn-group col-xs-10 col-sm-10 col-md-10">
                    <button title="A" class="btn btn-success btn-sm" type="button" 
                            ...
                            echo $chartOfAccountSegmentType->getViewPath();
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu" style="text-align:left">
                                <li>
                                    ...
                                    echo $chartOfAccountSegmentType->getControllerPath();
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form class="form-horizontal">
                                        <input type="hidden" name="chartOfAccountSegmentTypeIdPreview"
                                               id="chartOfAccountSegmentTypeIdPreview">

                                        <div class="form-group" id="chartOfAccountSegmentTypeCodeDiv">
                                            <label for="chartOfAccountSegmentTypeCodePreview"
                                                   class="control-label col-xs-4 col-sm-4 col-md-4"><?php echo $leafTranslation['chartOfAccountSegmentTypeCodeLabel']; ?></label>

                                            <div class="col-xs-8 col-sm-8 col-md-8">
                                                <input class="form-control" type="text"
                                                       name="chartOfAccountSegmentTypeCodePreview"
                                                       id="chartOfAccountSegmentTypeCodePreview">
                                            </div>
                                        </div>
                                        <div class="form-group" id="chartOfAccountSegmentTypeDescriptionDiv">
                                            <label for="chartOfAccountSegmentTypeDescriptionPreview"
                                                   class="control-label col-xs-4 col-sm-4 col-md-4"><?php echo $leafTranslation['chartOfAccountSegmentTypeDescriptionLabel']; ?></label>

                                            <div class="col-xs-8 col-sm-8 col-md-8">
                                                <input class="form-control" type="text"
                                                       name="chartOfAccountSegmentTypeDescriptionPreview"
                                                       id="chartOfAccountSegmentTypeDescriptionPreview">
                                            </div>
                                        </div>
                                    </form>
                                </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="panel panel-default">
                                <table class="table table table-bordered table-striped table-condensed table-hover smart-form has-tickbox" id="tableData">
                                    ...
                                    <th width="75px"><?php echo ucwords($leafTranslation['chartOfAccountSegmentTypeCodeLabel']); ?></th>
                                    <th><?php echo ucwords($leafTranslation['chartOfAccountSegmentTypeDescriptionLabel']); ?></th>
                                    <th width="100px">
                                            ...
                                            if (is_array($chartOfAccountSegmentTypeArray)) {
                                                ...
                                                if ($totalRecord > 0) {
                                                    ...
                                                    for ($i = 0; $i < $totalRecord; $i++) {
                                                        ...
                                                        ?>
                                                        <tr <?php
                                                        if ($chartOfAccountSegmentTypeArray[$i]['isDelete'] == 1) {
                                                            echo "class=\"danger\"";
                                                        } else {
                                                            if ($chartOfAccountSegmentTypeArray[$i]['isDraft'] == 1) {
                                                                echo "class=\"warning\"";
                                                            }
                                                        }
                                                        ?>>
                                                            ...
                                                            <td align="center">
                                                                ...
                                                                <div class="btn-group" align="center">
                                                                    <?php if ($chartOfAccountSegmentTypeArray [$i]['chartOfAccountSegmentTypeCode'] != 'UNBL') { ?>
                                                                        <button type="button"  class="btn btn-info btn-sm" title="Edit"
                                                                                ...
                                                                                echo intval(
                                                                                        $chartOfAccountSegmentTypeArray [$i]['chartOfAccountSegmentTypeId']
                                                                                );
                                                                        ...
                                                                        <button type="button"  class="btn btn-danger btn-sm" title="Delete"
                                                                                ...
                                                                                ?>', '<?php
                                                                                echo rawurlencode(
                                                                                        $chartOfAccountSegmentTypeArray [$i]['chartOfAccountSegmentTypeCode']
                                                                                );
                                                                                ?>', '<?php
                                                                                echo rawurlencode(
                                                                                        $chartOfAccountSegmentTypeArray [$i]['chartOfAccountSegmentTypeDescription']
                                                                                );
                                                                                ?>');">
                                                            ...
                                                            <td>
                                                                <div class="pull-left">
                                                                    <?php
                                                                    if (isset($chartOfAccountSegmentTypeArray[$i]['chartOfAccountSegmentTypeCode'])) {
                                                                        if (isset($_POST['query']) || isset($_POST['character'])) {
                                                                            if (isset($_POST['query']) && strlen($_POST['query']) > 0) {
                                                                                if (strpos(
                                                                                    ...
                                                                                    echo str_replace(
                                                                                            $_POST['query'], "<span class=\"label label-info\">" . $_POST['query'] . "</span>", $chartOfAccountSegmentTypeArray[$i]['chartOfAccountSegmentTypeCode']
                                                                                    );
                                                                                } else {
                                                                                    echo $chartOfAccountSegmentTypeArray[$i]['chartOfAccountSegmentTypeCode'];
                                                                                }
                                                                            } else {
                                                                                if (isset($_POST['character']) && strlen($_POST['character']) > 0) {
                                                                                    if (strpos(
                                                                                        ...
                                                                                        echo str_replace(
                                                                                                $_POST['character'], "<span class=\"label label-info\">" . $_POST['character'] . "</span>", $chartOfAccountSegmentTypeArray[$i]['chartOfAccountSegmentTypeCode']
                                                                                        );
                                                                                    } else {
                                                                                        echo $chartOfAccountSegmentTypeArray[$i]['chartOfAccountSegmentTypeCode'];
                                                                                    }
                                                            ...
                                                            <td>
                                                                <div class="pull-left">
                                                                    <?php
                                                                    if (isset($chartOfAccountSegmentTypeArray[$i]['chartOfAccountSegmentTypeDescription'])) {
                                                                        if (isset($_POST['query']) || isset($_POST['character'])) {
                                                                            if (isset($_POST['query']) && strlen($_POST['query']) > 0) {
                                                                                if (strpos(
                                                                                                strtolower(
                                                                                    ...
                                                                                    echo str_replace(
                                                                                            $_POST['query'], "<span class=\"label label-info\">" . $_POST['query'] . "</span>", $chartOfAccountSegmentTypeArray[$i]['chartOfAccountSegmentTypeDescription']
                                                                                    );
                                                                                } else {
                                                                                    echo $chartOfAccountSegmentTypeArray[$i]['chartOfAccountSegmentTypeDescription'];
                                                                                }
                                                                            } else {
                                                                                if (isset($_POST['character']) && strlen($_POST['character']) > 0) {
                                                                                    if (strpos(
                                                                                        ...
                                                                                        echo str_replace(
                                                                                                $_POST['character'], "<span class=\"label label-info\">" . $_POST['character'] . "</span>", $chartOfAccountSegmentTypeArray[$i]['chartOfAccountSegmentTypeDescription']
                                                                                        );
                                                                                    } else {
                                                                                        echo $chartOfAccountSegmentTypeArray[$i]['chartOfAccountSegmentTypeDescription'];
                                                                                    }
                                                            ...
                                                            <td>
                                                                <div align="center">
                                                                    <?php
                                                                    if (isset($chartOfAccountSegmentTypeArray[$i]['executeBy'])) {
                                                                        if (isset($_POST['query']) || isset($_POST['character'])) {
                                                                            if (isset($_POST['query']) && strlen($_POST['query']) > 0) {
                                                                                if (strpos(
                                                                                                $chartOfAccountSegmentTypeArray[$i]['staffName'], $_POST['query']
                                                                                        ) !== false
                                                                                ) {
                                                                                    echo str_replace(
                                                                                            $_POST['query'], "<span class=\"label label-info\">" . $_POST['query'] . "</span>", $chartOfAccountSegmentTypeArray[$i]['staffName']
                                                                                    );
                                                                                } else {
                                                                                    echo $chartOfAccountSegmentTypeArray[$i]['staffName'];
                                                                                }
                                                                            } else {
                                                                                if (isset($_POST['character']) && strlen($_POST['character']) > 0) {
                                                                                    if (strpos(
                                                                                                    $chartOfAccountSegmentTypeArray[$i]['staffName'], $_POST['character']
                                                                                            ) !== false
                                                                                    ) {
                                                                                        echo str_replace(
                                                                                                $_POST['character'], "<span class=\"label label-info\">" . $_POST['character'] . "</span>", $chartOfAccountSegmentTypeArray[$i]['staffName']
                                                                                        );
                                                                                    } else {
                                                                                        echo $chartOfAccountSegmentTypeArray[$i]['staffName'];
                                                                                    }
                                                            ...
                                                            <?php
                                                            if (isset($chartOfAccountSegmentTypeArray[$i]['executeTime'])) {
                                                                $valueArray = $chartOfAccountSegmentTypeArray[$i]['executeTime'];
                                                            ...
                                                            <?php
                                                            if ($chartOfAccountSegmentTypeArray[$i]['isDelete']) {
                                                                $checked = "checked";
                                                            } else {
                                                                $checked = null;
                                                            }
                                                            ...
                                                            <td>
                                                                <?php if ($chartOfAccountSegmentTypeArray [$i]['chartOfAccountSegmentTypeCode'] != 'UNBL') { ?>
                                                                    <input style="display:none;" type="checkbox" name="chartOfAccountSegmentTypeId[]"
                                                                           value="<?php echo $chartOfAccountSegmentTypeArray[$i]['chartOfAccountSegmentTypeId']; ?>">
                                                                    <input <?php echo $checked; ?> type="checkbox" name="isDelete[]"
                                                                                                   value="<?php echo $chartOfAccountSegmentTypeArray[$i]['isDelete']; ?>">
                                                                                               <?php } ?>
                                                            </td>
                                                        </tr>
                                                        <?php
                                                    ...
                                                    <tr>
                                                        <td colspan="7" valign="top" align="center"><?php
                                                            $chartOfAccountSegmentType->exceptionMessage(
...
if ((isset($_POST['method']) == 'new' || isset($_POST['method']) == 'read') && $_POST['type'] == 'form') {
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            <input type="hidden" name="chartOfAccountSegmentTypeId" id="chartOfAccountSegmentTypeId" value="<?php
                            if (isset($_POST['chartOfAccountSegmentTypeId'])) {
                                echo $_POST['chartOfAccountSegmentTypeId'];
                            }
                            ?>">

                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="col-xs-6 col-sm-6 col-md-6 form-group" id="chartOfAccountSegmentTypeCodeForm">
                                        <label for="chartOfAccountSegmentTypeCode"
                                               class="control-label col-xs-4 col-sm-4 col-md-4"><strong><?php
                                                       echo ucfirst(
                                                               $leafTranslation['chartOfAccountSegmentTypeCodeLabel']
                                                       );
                                                       ?></strong></label>
                                        ...
                                        <div class="col-xs-8 col-sm-8 col-md-8">
                                            <div class="input-group">
                                                <input type="text" class="form-control"
                                                       name="chartOfAccountSegmentTypeCode"
                                                       id="chartOfAccountSegmentTypeCode" value="<?php
                                                       if (isset($chartOfAccountSegmentTypeArray) && is_array(
                                                                       $chartOfAccountSegmentTypeArray
                                                               )
                                                       ) {
                                                           if (isset($chartOfAccountSegmentTypeArray[0]['chartOfAccountSegmentTypeCode'])) {
                                                               echo htmlentities(
                                                                       $chartOfAccountSegmentTypeArray[0]['chartOfAccountSegmentTypeCode']
                                                               );
                                                           }
                                                       }
                                                       ?>" maxlength="16">
                                            ...
                                            <span class="help-block" id="chartOfAccountSegmentTypeCodeHelpMe"></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group" id="chartOfAccountSegmentTypeDescriptionForm">
                                        <div class="col-xs-12 col-sm-12 col-md-12">
                                            <textarea class="form-control" rows="5"
                                                      name="chartOfAccountSegmentTypeDescription"
                                                      id="chartOfAccountSegmentTypeDescription"><?php
                                                          if (isset($chartOfAccountSegmentTypeArray[0]['chartOfAccountSegmentTypeDescription'])) {
                                                              echo htmlentities(
                                                                      $chartOfAccountSegmentTypeArray[0]['chartOfAccountSegmentTypeDescription']
                                                              );
                                                          }
                                                          ?></textarea>
                                            <span class="help-block" id="chartOfAccountSegmentTypeDescriptionHelpMe"></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <?php if ($leafAccess['leafAccessCreateValue'] == 1) { ?>
                    newRecord(<?php echo $leafId; ?>, '<?php echo $chartOfAccountSegmentType->getControllerPath(); ?>', '<?php echo $chartOfAccountSegmentType->getViewPath(); ?>', '<?php echo $securityToken; ?>', 1);
    <?php } ?>
                return false;
            }
            // shift+s save event
    ...
    <?php if ($leafAccess['leafAccessUpdateValue'] == 1) { ?>
                    updateRecord(<?php echo $leafId; ?>, '<?php echo $chartOfAccountSegmentType->getControllerPath(); ?>', '<?php echo $chartOfAccountSegmentType->getViewPath(); ?>', '<?php echo $securityToken; ?>', 1, <?php echo $leafAccess['leafAccessDeleteValue']; ?>);
    <?php } ?>
                return false;
            }
    ...
    <?php if ($leafAccess['leafAccessDeleteValue'] == 1) { ?>
                    deleteRecord(<?php echo $leafId; ?>, '<?php echo $chartOfAccountSegmentType->getControllerPath(); ?>', '<?php echo $chartOfAccountSegmentType->getViewPath(); ?>', '<?php echo $securityToken; ?>', <?php echo $leafAccess['leafAccessDeleteValue']; ?>);
    ...
    <?php } ?>
            ...
            switch (e.keyCode) {
                case 37:
                    previousRecord(<?php echo $leafId; ?>, '<?php echo $chartOfAccountSegmentType->getControllerPath(); ?>', '<?php echo $chartOfAccountSegmentType->getViewPath(); ?>', '<?php echo $securityToken; ?>', <?php echo $leafAccess['leafAccessUpdateValue']; ?>, <?php echo $leafAccess['leafAccessDeleteValue']; ?>);

                    return false;
                    break;
                case 39:
                    nextRecord(<?php echo $leafId; ?>, '<?php echo $chartOfAccountSegmentType->getControllerPath(); ?>', '<?php echo $chartOfAccountSegmentType->getViewPath(); ?>', '<?php echo $securityToken; ?>', <?php echo $leafAccess['leafAccessUpdateValue']; ?>, <?php echo $leafAccess['leafAccessDeleteValue']; ?>);
        ...
        $(document).ready(function() {
            ...
            validateMeAlphaNumeric('chartOfAccountSegmentTypeCode');
    <?php if ($_POST['method'] == "new") { ?>
                $('#resetRecordButton').removeClass().addClass('btn btn-default');
        <?php if ($leafAccess['leafAccessCreateValue'] == 1) { ?>
                    $('#newRecordButton1').removeClass().addClass('btn btn-success').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $chartOfAccountSegmentType->getControllerPath(); ?>','<?php echo $chartOfAccountSegmentType->getViewPath(); ?>','<?php echo $securityToken; ?>',1)");
                    $('#newRecordButton2').removeClass().addClass('btn dropdown-toggle btn-success');
                    $('#newRecordButton3').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $chartOfAccountSegmentType->getControllerPath(); ?>','<?php echo $chartOfAccountSegmentType->getViewPath(); ?>','<?php echo $securityToken; ?>',1)");
                    $('#newRecordButton4').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $chartOfAccountSegmentType->getControllerPath(); ?>','<?php echo $chartOfAccountSegmentType->getViewPath(); ?>','<?php echo $securityToken; ?>',2)");
                    $('#newRecordButton5').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $chartOfAccountSegmentType->getControllerPath(); ?>','<?php echo $chartOfAccountSegmentType->getViewPath(); ?>','<?php echo $securityToken; ?>',3)");
                    $('#newRecordButton6').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $chartOfAccountSegmentType->getControllerPath(); ?>','<?php echo $chartOfAccountSegmentType->getViewPath(); ?>','<?php echo $securityToken; ?>',4)");
                    $('#newRecordButton7').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $chartOfAccountSegmentType->getControllerPath(); ?>','<?php echo $chartOfAccountSegmentType->getViewPath(); ?>','<?php echo $securityToken; ?>',5)");
        <?php } else { ?>
        ...
        if ($_POST['chartOfAccountSegmentTypeId']) {
            ?>
                    $('#newRecordButton1').removeClass().addClass('btn btn-success disabled').attr('onClick', '');
                    $('#newRecordButton2').removeClass().addClass('btn dropdown-toggle btn-success disabled');
            ...
            <?php if ($leafAccess['leafAccessUpdateValue'] == 1) { ?>
                        $('#updateRecordButton1').removeClass().addClass('btn btn-info').attr('onClick', "updateRecord(<?php echo $leafId; ?>,'<?php echo $chartOfAccountSegmentType->getControllerPath(); ?>','<?php echo $chartOfAccountSegmentType->getViewPath(); ?>','<?php echo $securityToken; ?>',1,<?php echo $leafAccess['leafAccessDeleteValue']; ?>);");
                        $('#updateRecordButton2').removeClass().addClass('btn dropdown-toggle btn-info');
                        $('#updateRecordButton3').attr('onClick', "updateRecord(<?php echo $leafId; ?>,'<?php echo $chartOfAccountSegmentType->getControllerPath(); ?>','<?php echo $chartOfAccountSegmentType->getViewPath(); ?>','<?php echo $securityToken; ?>',1,<?php echo $leafAccess['leafAccessDeleteValue']; ?>);");
                        $('#updateRecordButton4').attr('onClick', "updateRecord(<?php echo $leafId; ?>,'<?php echo $chartOfAccountSegmentType->getControllerPath(); ?>','<?php echo $chartOfAccountSegmentType->getViewPath(); ?>','<?php echo $securityToken; ?>',2,<?php echo $leafAccess['leafAccessDeleteValue']; ?>);");
                        $('#updateRecordButton5').attr('onClick', "updateRecord(<?php echo $leafId; ?>,'<?php echo $chartOfAccountSegmentType->getControllerPath(); ?>','<?php echo $chartOfAccountSegmentType->getViewPath(); ?>','<?php echo $securityToken; ?>',3,<?php echo $leafAccess['leafAccessDeleteValue']; ?>);");
            <?php } else { ?>
                        $('#updateRecordButton1').removeClass().addClass(' btn btn-info disabled').attr('onClick', '');
                        $('#updateRecordButton2').removeClass().addClass('btn dropdown-toggle btn-info disabled');
                        $('#updateRecordButton3').attr('onClick', '');
            ...
            <?php } ?>
            <?php if ($leafAccess['leafAccessDeleteValue'] == 1) { ?>
                        $('#deleteRecordButton').removeClass().addClass('btn btn-danger').attr('onClick', "deleteRecord(<?php echo $leafId; ?>,'<?php echo $chartOfAccountSegmentType->getControllerPath(); ?>','<?php echo $chartOfAccountSegmentType->getViewPath(); ?>','<?php echo $securityToken; ?>',<?php echo $leafAccess['leafAccessDeleteValue']; ?>);");
            <?php } else { ?>
...
<?php } ?>
<script type="text/javascript" src="./v3/financial/generalLedger/javascript/chartOfAccountSegmentType.js"></script>
<hr>
