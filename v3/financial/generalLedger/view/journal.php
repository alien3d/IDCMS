...
$_POST['from'] = 'journal.php';
$_GET['from'] = 'journal.php';
if (isset($_POST)) {
                    ...
                    <div class="pull-right">
                        <div class="btn-group">
                            <button class="btn btn-warning btn-sm" type="button" ><i
                                    class="glyphicon glyphicon-print glyphicon-white"></i></button>
                            ...
                            <ul class="dropdown-menu" style="text-align:left">
                                <li><a href="javascript:void(0)" onclick="reportRequest(<?php echo $leafId; ?>, '<?php
                                    ...
                                    ?>', '<?php echo $securityToken; ?>', 'excel');"> <i
                                            class="pull-right glyphicon glyphicon-download"></i>&nbsp;&nbsp;Excel 2007&nbsp;&nbsp;
                                    </a></li>
                                <li><a href="javascript:void(0)" onclick="reportRequest(<?php echo $leafId; ?>, '<?php
                                    echo $journal->getControllerPath();
                                    ?>', '<?php echo $securityToken; ?>', 'csv');"> <i
                                            class="pull-right glyphicon glyphicon-download"></i>&nbsp;&nbsp;CSV&nbsp;&nbsp;
                                    </a></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <form class="form-forizontal">
                                ...
                                <input type="text" class="form-control" name="queryWidget" id="queryWidget"
                                       value="<?php
                                ...
                                <h5><img src="./images/icons/calendar-select-days-span.png"
                                         alt="<?php echo $t['rangeTextLabel']; ?>"><?php echo $t['rangeTextLabel']; ?> </h5>
                                                ...
                                                if ($totalRecord > 0) {
                                                    ...
                                                    for ($i = 0; $i < $totalRecord; $i++) {
                                                        ...
                                                        ?>>
                                                            ...
                                                            ?>
                                                            <td><input style="display:none;" type="checkbox" name="journalId[]"
                        ...
                        <div class="col-xs-3 col-sm-3 col-md-3 pagination">
                            <div class="pull-right">
                                <button class="delete btn btn-warning" type="button" 
                                        ...
                                        echo $journal->getControllerPath();
                                        ?>', '<?php echo $journal->getViewPath(); ?>', '<?php echo $securityToken; ?>');"><i
                                        class="glyphicon glyphicon-white glyphicon-trash"></i></button>
                            </div>
                        </div>
                    </div>
...
if ((isset($_POST['method']) == 'new' || isset($_POST['method']) == 'read') && $_POST['type'] == 'form') {
    ...
    $chartOfAccountCategoryArray = $journalDetail->getChartOfAccountCategory();
    $chartOfAccountTypeArray = $journalDetail->getChartOfAccountType();
    ...
    ?>
    <form class="form-horizontal">
        <div class="modal fade" id="newChartOfAccount" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
             aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button"  class="close" data-dismiss="modal" aria-hidden="false">&times;</button>
                        <strong><?php echo $t['newRecordMessageLabel']; ?></strong>
                    </div>
                    <div class="modal-body">
                        <div class="form-group" id="newChartOfAccountCategoryIdDiv">
                            <label for="newChartOfAccountCategoryId"
                                   class="control-label col-xs-4 col-sm-4 col-md-4"><?php echo $leafTranslation['chartOfAccountCategoryIdLabel']; ?></label>

                            <div class="col-xs-8 col-sm-8 col-md-8">
                                <select class="chzn-select form-control" style="width:350px"
                                        name="newChartOfAccountCategoryId"
                                        id="newChartOfAccountCategoryId"
                        ...
                        <div class="form-group" id="chartOfAccountTypeIdDiv">
                            <label for="newChartOfAccountTypeId"
                                   class="control-label col-xs-4 col-sm-4 col-md-4"><?php echo $leafTranslation['chartOfAccountTypeIdLabel']; ?></label>

                            <div class="col-xs-8 col-sm-8 col-md-8">
                                <select class="chzn-select form-control" name="newChartOfAccountTypeId"
                                        id="newChartOfAccountTypeId" style="width:350px">
                                            <?php
                                            if (is_array($chartOfAccountTypeArray)) {
                                                ...
                                                if ($totalRecord > 0) {
                                                    ...
                                                    for ($i = 0; $i < $totalRecord; $i++) {
                                                        ?>
                                                <option
                                                    value="<?php echo $chartOfAccountTypeArray[$i]['chartOfAccountTypeId']; ?>"><?php echo $d; ?>
                        ...
                        <div class="form-group" id="newChartOfAccountNumberDiv">
                            <label for="newChartOfAccountNumber"
                                   class="control-label col-xs-4 col-sm-4 col-md-4"><?php echo $leafTranslation['chartOfAccountNumberLabel']; ?></label>

                            <div class="col-xs-8 col-sm-8 col-md-8">
                                <input class="form-control" type="text" name="newChartOfAccountNumber"
                                       id="newChartOfAccountNumber">
                            </div>
                            <!-- unknown required or not <a href="javascript:void(0)" onClick="checkDuplicateChartOfAccount()" class="btn btn-info btn-xs"><?php echo $t['duplicateTextLabel']; ?></a -->
                        </div>
                        <div class="form-group" id="newChartOfAccountTitleDiv">
                            <label
                                for="newChartOfAccountTitle"
                                class="control-label col-xs-4 col-sm-4 col-md-4"><?php echo $leafTranslation['chartOfAccountTitleLabel']; ?></label>

                            <div class="col-xs-8 col-sm-8 col-md-8">
                                <input class="form-control" type="text" name="newChartOfAccountTitle"
                                       id="newChartOfAccountTitle">
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button"  class="btn btn-danger"
                                onclick="newChartOfAccount(<?php echo $leafId; ?>, '<?php
                                echo $journalDetail->getControllerPath();
                                ?>', '<?php echo $securityToken; ?>');">
                            <?php echo $t['newButtonLabel']; ?></button>
                        <button type="button"  onclick="resetNewChartOfAccount();"
                                class="btn btn-info"><?php echo $t['resetButtonLabel']; ?></button>
                        <button type="button"  href="javascript:void(0)" onclick="showMeModal('newChartOfAccount', 0);"
                    ...
                    <div class="panel panel-info" id="masterForm">
                        <div class="panel-heading">
                            <div align="right">
                                ...
                                <div class="btn-group"><a id="previousRecordbutton"  href="javascript:void(0)"
                                ...
                                <div class="btn-group"><a id="nextRecordbutton"  href="javascript:void(0)" class="btn btn-default disabled"
                                                          ...
                                                          echo $journal->getViewPath();
                                                          ?>', '<?php echo $securityToken; ?>',<?php echo $leafAccess['leafAccessUpdateValue']; ?>,<?php echo $leafAccess['leafAccessDeleteValue']; ?>);"><i
                                            class="glyphicon glyphicon-forward glyphicon-white"></i><?php echo $t['nextButtonLabel']; ?></a>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="col-xs-6 col-sm-6 col-md-6 form-group" id="journalTypeIdForm">
                                        <label for="journalTypeId" class="control-label col-xs-4 col-sm-4 col-md-4"><strong>
                                                <?php
                                                echo ucfirst(
                                        ...
                                        <div class="col-xs-8 col-sm-8 col-md-8">
                                            <select name="journalTypeId" id="journalTypeId" class="chzn-select form-control">
                                                <option value=""></option>
                                                <?php
                                            ...
                                            <span class="help-block" id="journalTypeIdHelpMe"></span></div>
                                    </div>
                                        ...
                                        <div class="col-xs-8 col-sm-8 col-md-8">
                                            <div class="input-group">
                                                ...
                                                ?>
                                                       ...
                                                       ?>">
                                                <span class="input-group-addon"><img src="./images/icons/document-number.png"
                                                                                     alt="<?php echo $t['documentNumberTextLabel']; ?>"></span></div>
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="col-xs-6 col-sm-6 col-md-6 form-group" id="journalTitleForm">
                                        <label for="journalTitle" class="control-label col-xs-4 col-sm-4 col-md-4"><strong>
                                                <?php
                                                echo ucfirst(
                                        ...
                                        <div class="col-xs-8 col-sm-8 col-md-8">
                                            <div class="input-group">
                                                <input type="text" class="form-control" name="journalTitle" id="journalTitle"
                                                       value="<?php
                                                       if (isset($journalArray) && is_array($journalArray)) {
                                                ...
                                                <span class="input-group-addon"><img
                                                        src="./images/icons/ui-text-field-medium.png" alt=""></span></div>
                                            <span class="help-block" id="journalTitleHelpMe"></span></div>
                                    </div>
                                        ...
                                        <div class="col-xs-8 col-sm-8 col-md-8">
                                            <div class="input-group">
                                                <input type="text" class="form-control" name="referenceNumber" id="referenceNumber"
                                                       ...
                                                       ?>">
                                                <span class="input-group-addon"><img src="./images/icons/document-number.png"
                                                                                     alt="<?php echo $t['referenceNumberTextLabel']; ?>"></span> <span
                                                    class="help-block" id="referenceNumberHelpMe"></span></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    ...
                                    <div class="col-xs-6 col-sm-6 col-md-6 form-group" id="journalDateForm">
                                        <label for="journalDate" class="control-label col-xs-4 col-sm-4 col-md-4"><strong>
                                                <?php
                                                echo ucfirst(
                                        ...
                                        <div class="col-xs-8 col-sm-8 col-md-8">
                                            <div class="input-group">
                                                <input type="text" class="form-control" name="journalDate" id="journalDate"
                                                       ...
                                                       ?>">
                                                <span class="input-group-addon"><img src="./images/icons/calendar.png" id="journalDateImage"
                                                                                     alt=""></span></div>
                                            <span class="help-block" id="journalDateHelpMe"></span></div>
                                    </div>
                                    <div class="col-xs-6 col-sm-6 col-md-6 form-group" id="journalAmountForm">
                                        <label for="journalAmount" class="control-label col-xs-4 col-sm-4 col-md-4"><strong>
                                                <?php
                                                echo ucfirst(
                                        ...
                                        <div class="col-xs-8 col-sm-8 col-md-8">
                                            <div class="input-group">
                                                <input type="text" class="form-control" name="journalAmount" id="journalAmount"
                                                       ...
                                                       ?>">
                                                <span class="input-group-addon"><img src="./images/icons/currency.png"
                                                                                     alt=""></span></div>
                                            <span class="help-block" id="journalAmountHelpMe"></span></div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group" id="journalDescriptionForm">
                                        <div class="col-xs-12 col-sm-12 col-md-12">
                                            <textarea class="form-control" rows="2" name="journalDescription"
                                                      id="journalDescription"><?php
                                                          if (isset($journalArray[0]['journalDescription'])) {
                                                              echo htmlentities($journalArray[0]['journalDescription']);
                                                          }
                                                          ?></textarea>
                                            <span class="help-block" id="journalDescriptionHelpMe"></span></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="panel-footer" align="center">
                            <div class="btn-group" align="left"><a id="newRecordButton1" href="javascript:void(0)"
                                                                   class="btn btn-success disabled"><i
                                        class="glyphicon glyphicon-plus glyphicon-white"></i> <?php echo $t['newButtonLabel']; ?> </a> <a
                                    id="newRecordButton2" href="javascript:void(0)" data-toggle="dropdown"
                            ...
                            <div class="btn-group" align="left"><a id="updateRecordButton1" href="javascript:void(0)"
                                                                   class="btn btn-info disabled"><i
                                        class="glyphicon glyphicon-edit glyphicon-white"></i><?php echo $t['updateButtonLabel']; ?> </a> <a
                                    id="updateRecordButton2" href="javascript:void(0)" data-toggle="dropdown"
                            ...
                            <div class="btn-group">
                                <button type="button"  id="deleteRecordbutton"  class="btn btn-danger disabled"><i
                                        class="glyphicon glyphicon-trash glyphicon-white"></i> <?php echo $t['deleteButtonLabel']; ?>
                                </button>
                            </div>
                            <div class="btn-group"><a id="resetRecordbutton"  href="javascript:void(0)" class="btn btn-info"
                                        ...
                                        class="glyphicon glyphicon-refresh glyphicon-white"></i> <?php echo $t['resetButtonLabel']; ?> </a>
                            </div>
                            <div class="btn-group"><a id="listRecordbutton"  href="javascript:void(0)" class="btn btn-info"
                                        ...
                                        class="glyphicon glyphicon-list glyphicon-white"></i> <?php echo $t['gridButtonLabel']; ?> </a>
                            </div>
                        </div>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group" id="journalDetailAmountDiv">
                                    ...
                                    <div class="col-xs-8 col-sm-8 col-md-8">
                                        <input class="form-control" type="text" name="journalDetailAmountPreview"
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="panel panel-default">
                        <table class="table table-bordered table-striped table-condensed table-hover" id="tableData">
                            ...
                            <th width="110px" align="center"><div align="center"><?php echo ucfirst($t['actionTextLabel']); ?></div></th>
                            <th><?php echo ucfirst($leafTranslation['chartOfAccountIdLabel']); ?></th>
                            <th width="200px"><div align="center"><?php echo ucfirst($leafTranslation['journalDetailAmountLabel']); ?></div></th>
                            ...
                            <tr>
                                ...
                                <td valign="top" class="form-group" id="chartOfAccountId9999Detail">
                                    ...
                                    <select name="chartOfAccountId[]" id="chartOfAccountId9999"class="chzn-select form-control" <?php echo $disabledDetail; ?> >
                                        <option value=""></option>
                                        <?php
                                ...
                                <td valign="top" class="form-group">
                                    <div class="input-group" id="journalDetailAmount9999Detail">
                                        <input class="form-control" style="text-align:right"   <?php echo $disabledDetail; ?>
                                               type="text" name="journalDetailAmount[]" id="journalDetailAmount9999">
                                        <span class="help-block" id="journalDetailAmount9999HelpMe"></span></div>
                                </td>
                                <td>&nbsp;</td>
                                <td>&nbsp;</td>
                            </tr>
                            ...
                            <tbody id="tableBody">
                                        ...
                                        if ($totalRecordDetail > 0) {
                                            ...
                                            for ($j = 0; $j < $totalRecordDetail; $j++) {
                                                ...
                                                <tr id="<?php echo $journalDetailArray[$j]['journalDetailId']; ?>">
                                                    ...
                                                    <td valign="top" class="form-group"
                                                        name="chartOfAccountId<?php echo $journalDetailArray[$j]['journalDetailId']; ?>Detail"
                                                        ...
                                                        <select name="chartOfAccountId[]"
                                                                ...
                                                                class="chzn-select form-control" style="min-width:300px;width:300px;max-width:350px">
                                                            <option value=""></option>
                                                            <?php
                                                            if (is_array($chartOfAccountArray)) {
                                                                $totalRecord = intval(count($chartOfAccountArray));
                                                    ...
                                                    <td valign="top" name="journalDetailAmount<?php echo $journalDetailArray[$j]['journalDetailId']; ?>Detail"
                                                        id="journalDetailAmount<?php echo $journalDetailArray[$j]['journalDetailId']; ?>Detail"><input
                                ...
                                <tr id="totalDetail" class="<?php echo $balanceColor; ?>">
                                    <td colspan="4">&nbsp;</td>
                                    <td>
                                        <div class="pull-right" id="totalDebit">
                                            <?php
                                            if (class_exists('NumberFormatter')) {
                                                if (is_array($systemFormat) && $systemFormat['languageCode'] != '') {
                                                    $a = new \NumberFormatter($systemFormat['languageCode'], \NumberFormatter::CURRENCY);
...
<?php } ?>
<script type="text/javascript" src="./v3/financial/generalLedger/javascript/journal.js"></script>
<hr>
<footer>
    <p>IDCMS 2012/2013</p>
</footer>
