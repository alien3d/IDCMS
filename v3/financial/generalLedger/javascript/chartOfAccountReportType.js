...
function showFormCreateDetail(leafId, url, securityToken) {
    var $infoPanel = $('#infoPanel');
    if ($('#chartOfAccountDimensionId9999').val().length === 0) {
        $infoPanel.html('').empty().html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['chartOfAccountDimensionIdLabel'] + "</span>");
        $('#chartOfAccountDimensionId9999HelpMe').html('').empty().html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['chartOfAccountDimensionIdLabel'] + "</span>");
        $('#chartOfAccountDimensionId9999Form').removeClass().addClass('form-group has-error');
        $('#chartOfAccountDimensionId9999').focus();
        return false;
    }
    if ($('#transactionTypeId9999').val().length === 0) {
        ...
        $('#transactionTypeId9999Form').removeClass().addClass('form-group has-error');
    ...
    $.ajax({type: 'POST', url: url, data: {method: 'create', output: 'json', chartOfAccountReportTypeId: $('#chartOfAccountReportTypeId').val(), chartOfAccountDimensionId: $('#chartOfAccountDimensionId9999').val(), transactionTypeId: $('#transactionTypeId9999').val(), chartOfAccountId: $('#chartOfAccountId9999').val(), securityToken: securityToken, leafId: leafId}, beforeSend: function() {
            var smileyRoll = './images/icons/smiley-roll.png';
            var $infoPanel = $('#infoPanel');
            $infoPanel.html('').empty().html("<span class='label label-warning'>&nbsp;<img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
...
function showFormUpdateDetail(leafId, url, securityToken, chartOfAccountDimensionFormulaId) {
    var $infoPanel = $('#infoPanel');
    if ($('#chartOfAccountDimensionId' + chartOfAccountDimensionFormulaId).val().length === 0) {
        $infoPanel.html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + ' :' + leafTranslation['chartOfAccountDimensionIdLabel'] + "</span>");
        $('#chartOfAccountDimensionId' + chartOfAccountDimensionFormulaId + 'HelpMe').html('').empty().html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + ' :' + leafTranslation['chartOfAccountDimensionIdLabel'] + "</span>");
        $('#chartOfAccountDimensionId' + chartOfAccountDimensionFormulaId).removeClass().addClass('form-group has-error');
        $('#chartOfAccountDimensionId' + chartOfAccountDimensionFormulaId).focus();
        return false;
    }
    if ($('#transactionTypeId' + chartOfAccountDimensionFormulaId).val().length === 0) {
        ...
        $('#transactionTypeId' + chartOfAccountDimensionFormulaId).removeClass().addClass('form-group has-error');
        $('#transactionTypeId' + chartOfAccountDimensionFormulaId).focus();
        return false;
    }
...
function showModalDeleteDetail(chartOfAccountDimensionFormulaId) {
    ...
    $('#chartOfAccountDimensionIdPreview').val('').val(decodeURIComponent($("#chartOfAccountDimensionId" + chartOfAccountDimensionFormulaId + " option:selected").text()));
                ...
                if (success === true) {
                    $.ajax({type: 'POST', url: url, data: {method: 'read', chartOfAccountReportTypeId: firstRecord, output: 'json', securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                            ...
                            if (success === true) {
                                ...
                                $.ajax({type: 'POST', url: urlChartOfAccountDimensionFormula, data: {method: 'read', chartOfAccountReportTypeId: data.firstRecord, output: 'table', securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                                        var smileyRoll = './images/icons/smiley-roll.png';
                                        var $infoPanel = $('#infoPanel');
                                        $infoPanel.html('').empty().html("<span class='label label-warning'><img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
                                        if ($infoPanel.is(':hidden')) {
                ...
                if (success === true) {
                    $.ajax({type: 'POST', url: url, data: {method: 'read', chartOfAccountReportTypeId: lastRecord, output: 'json', securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                            ...
                            if (success === true) {
                                ...
                                $.ajax({type: 'POST', url: urlChartOfAccountDimensionFormula, data: {method: 'read', chartOfAccountReportTypeId: lastRecord, output: 'table', securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                                        var smileyRoll = './images/icons/smiley-roll.png';
                                        var $infoPanel = $('#infoPanel');
                                        $infoPanel.html('').empty().html("<span class='label label-warning'><img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
                                        if ($infoPanel.is(':hidden')) {
        ...
        if (parseFloat($previousRecordCounter.val()) > 0 && parseFloat($previousRecordCounter.val()) < parseFloat($('#lastRecordCounter').val())) {
            $.ajax({type: 'POST', url: url, data: {method: 'read', chartOfAccountReportTypeId: $previousRecordCounter.val(), output: 'json', securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                    ...
                    if (success === true) {
                        ...
                        $.ajax({type: 'POST', url: urlChartOfAccountDimensionFormula, data: {method: 'read', chartOfAccountReportTypeId: $('#previousRecordCounter').val(), output: 'table', securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                                var smileyRoll = './images/icons/smiley-roll.png';
                                var $infoPanel = $('#infoPanel');
                                $infoPanel.html('').empty().html("<span class='label label-warning'><img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
                                if ($infoPanel.is(':hidden')) {
        ...
        if (parseFloat($nextRecordCounter.val()) <= parseFloat($('#lastRecordCounter').val())) {
            $.ajax({type: 'POST', url: url, data: {method: 'read', chartOfAccountReportTypeId: $nextRecordCounter.val(), output: 'json', securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                    ...
                    if (success === true) {
                        ...
                        $.ajax({type: 'POST', url: urlChartOfAccountDimensionFormula, data: {method: 'read', chartOfAccountReportTypeId: $('#nextRecordCounter').val(), output: 'table', securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                                var smileyRoll = './images/icons/smiley-roll.png';
                                var $infoPanel = $('#infoPanel');
                                $infoPanel.html('').empty().html("<span class='label label-warning'><img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
                                if ($infoPanel.is(':hidden')) {
