...
function checkDuplicate(leafId, page, securityToken) {
    var $financePeriodRangeCode = $("#financePeriodRangeCode");
    if ($financePeriodRangeCode.val().length === 0) {
    ...
    $.ajax({
        ...
        url: page,
        data: {
            financePeriodRangeCode: $financePeriodRangeCode.val(),
            method: 'duplicate',
            securityToken: securityToken,
            leafId: leafId
        },
        ...
        success: function(data) {
            ...
            if (success === true) {
                if (total !== 0) {
                    $("#financePeriodRangeCode").val('').focus();
                    $("#financePeriodRangeCodeForm").removeClass().addClass("form-group has-error");
                ...
                $("#financePeriodRangeForm").removeClass().addClass("form-group has-error");
            }
            if ($infoPanel.is(':hidden')) {
                $infoPanel.show();
            }
...
function showFormUpdate(leafId, url, urlList, securityToken, financePeriodRangeId, updateAccess, deleteAccess) {
    sleep(500);
...
function showModalDelete(financePeriodRangeId, financeYearId, financePeriodRangePeriod, financePeriodRangeStartDate, financePeriodRangeEndDate, isClose) {
    ...
    $('#financePeriodRangeStartDatePreview').val('').val(decodeURIComponent(financePeriodRangeStartDate));
    $('#financePeriodRangeEndDatePreview').val('').val(decodeURIComponent(financePeriodRangeEndDate));
    $('#isClosePreview').val('').val(decodeURIComponent(isClose));
...
function deleteGridRecord(leafId, url, urlList, securityToken) {
    $.ajax({
        ...
        data: {
            method: 'delete',
            output: 'json',
            financePeriodRangeId: $('#financePeriodRangeIdPreview').val(),
            securityToken: securityToken,
            leafId: leafId
        },
        beforeSend: function() {
...
function deleteGridRecordCheckbox(leafId, url, urlList, securityToken) {
    var stringText = '';
    var counter = 0;
    $('input:checkbox[name="financePeriodRangeId[]"]').each(function() {
        stringText = stringText + "&financePeriodRangeId[]=" + $(this).val();
    });
...
function newRecord(leafId, url, urlList, securityToken, type, createAccess, updateAccess, deleteAccess) {
    ...
    var $financePeriodRangePeriod = $('#financePeriodRangePeriod');
    var $financePeriodRangeStartDate = $('#financePeriodRangeStartDate');
    var $financePeriodRangeEndDate = $('#financePeriodRangeEndDate');
    var $isClose = $('#isClose').is(":checked") ? 1 : 0;
    if (css.search('disabled') > 0) {
        return false;
    } else {
        if (type === 1) {
            ...
            if ($financePeriodRangePeriod.val().length === 0) {
                $('#financePeriodRangePeriodHelpMe').html('').empty().html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['financePeriodRangePeriodLabel'] + " </span>");
                $('#financePeriodRangePeriodForm').removeClass().addClass('form-group has-error');
                $financePeriodRangePeriod.focus();
                return false;
            }
            $.ajax({
                type: 'POST',
                ...
                data: {
                    ...
                    financePeriodRangePeriod: $financePeriodRangePeriod.val(),
                    financePeriodRangeStartDate: $financePeriodRangeStartDate.val(),
                    financePeriodRangeEndDate: $financePeriodRangeEndDate.val(),
                    isClose: $isClose,
                    securityToken: securityToken,
                    leafId: leafId
                },
                ...
                success: function(data) {
                    ...
                    if (success === true) {
                        ...
                        $('#financePeriodRangePeriodHelpMe').html('').empty();
                        $financePeriodRangeStartDate.val('');
                        $('#financePeriodRangeStartDateHelpMe').html('').empty();
                        $financePeriodRangeEndDate.val('');
                        $('#financePeriodRangeEndDateHelpMe').html('').empty();
                        $("#isClose").val('');
                        $('#isCloseHelpMe').html('').empty();
                    } else if (success === false) {
                        $infoPanel.html('').empty().html("<span class='label label-danger'>&nbsp;" + message + "</span>");
                        if ($infoPanel.is(':hidden')) {
                            $infoPanel.show();
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (success === true) {
                        ...
                        $('#financePeriodRangeId').val(data.financePeriodRangeId);
                        $('#newRecordButton1').removeClass().addClass('btn btn-success disabled');
                        $('#newRecordButton2').removeClass().addClass('btn dropdown-toggle btn-success disabled');
                        $('#newRecordButton3').attr('onClick', '');
                        $('#newRecordButton4').attr('onClick', '');
    ...
    if (css.search('disabled') > 0) {
        ...
        if (deleteAccess === 1) {
            if (confirm(decodeURIComponent(t['deleteRecordMessageLabel']))) {
                var value = $financePeriodRangeId.val();
                if (!value) {
...
function resetRecord(leafId, url, urlList, securityToken, createAccess, updateAccess, deleteAccess) {
    ...
    $("#financePeriodRangeStartDate").val('');
    $("#financePeriodRangeStartDateHelpMe").empty().html('');
    $("#financePeriodRangeEndDate").val('');
    $("#financePeriodRangeEndDateHelpMe").empty().html('');
    $("#isClose").val('');
    $("#isCloseHelpMe").empty().html('');
    $("#isClose").removeAttr("checked");
    $('input[name="isClose"]').bootstrapSwitch('state', false);
}
function postRecord() {
            ...
            success: function(data) {
                ...
                if (success === true) {
                    $.ajax({
                        ...
                        data: {
                            method: 'read',
                            financePeriodRangeId: firstRecord,
                            output: 'json',
                            securityToken: securityToken,
                            leafId: leafId
                        },
                        ...
                        success: function(data) {
                            ...
                            if (success === true) {
                                $('#financePeriodRangeId').val(data.data.financePeriodRangeId);
                                $('#financeYearId').val(data.data.financeYearId).trigger("chosen:updated");
                                $('#financePeriodRangePeriod').val(data.data.financePeriodRangePeriod);
                                x = data.data.financePeriodRangeStartDate;
                                x = x.split("-");
                                output = x[2] + "-" + x[1] + "-" + x[0];
                                output = output.toString();
                                $('#financePeriodRangeStartDate').val(output);
                                x = data.data.financePeriodRangeEndDate;
                                x = x.split("-");
                                output = x[2] + "-" + x[1] + "-" + x[0];
                                output = output.toString();
                                $('#financePeriodRangeEndDate').val(output);
                                if (data.data.isClose == true || data.data.isClose == 1) {
                                    $("#isClose").attr("checked", "checked");
                                    $('input[name="isClose"]').bootstrapSwitch('state', true);
                                } else {
                                    $("#isClose").removeAttr("checked");
                                    $('input[name="isClose"]').bootstrapSwitch('state', false);
                                }
                                $("#isClose").val(data.data.isClose);
                                ;
                                if (nextRecord > 0) {
                                    $('#previousRecordButton').removeClass().addClass('btn btn-default disabled').attr('onClick', '');
            ...
            success: function(data) {
                ...
                if (success === true) {
                    $.ajax({
                        ...
                        data: {
                            method: 'read',
                            financePeriodRangeId: lastRecord,
                            output: 'json',
                            securityToken: securityToken,
                            leafId: leafId
                        },
    ...
    if (css.search('disabled') > 0) {
        ...
        if (parseFloat($previousRecordCounter.val()) > 0 && parseFloat($previousRecordCounter.val()) < parseFloat($('#lastRecordCounter').val())) {
            $.ajax({
                ...
                data: {
                    method: 'read',
                    financePeriodRangeId: $previousRecordCounter.val(),
                    output: 'json',
                    securityToken: securityToken,
                    leafId: leafId
                },
    ...
    if (css.search('disabled') > 0) {
        ...
        if (parseFloat($nextRecordCounter.val()) <= parseFloat($('#lastRecordCounter').val())) {
            $.ajax({
                ...
                data: {
                    method: 'read',
                    financePeriodRangeId: $nextRecordCounter.val(),
                    output: 'json',
                    securityToken: securityToken,
                    leafId: leafId
                },
