function resetNewChartOfAccount() {
    $("#newChartOfAccountNumber").val('');
    $("#newChartOfAccountTitle").val('');
    $("#newChartOfAccountCategoryId").val('');
    $("#newChartOfAccountTypeId").val('');
}
function newChartOfAccount(leafId, url, securityToken) {
    $.ajax({
        type: 'POST',
        url: url,
        data: {
            method: 'fastChartOfAccount',
            output: 'json',
            from: 'journal.php',
            securityToken: securityToken,
            chartOfAccountNumber: $("#newChartOfAccountNumber").val(),
            chartOfAccountTitle: $("#newChartOfAccountTitle").val(),
            chartOfAccountCategoryId: $("#newChartOfAccountCategoryId").val(),
            chartOfAccountTypeId: $("#newChartOfAccountTypeId").val(),
            leafId: leafId
        },
        beforeSend: function() {
        ...
        success: function(data) {
            if (data.success === true) {
                getChartOfAccount(leafId, url, securityToken, data.chartOfAccountId);
            } else {
                alert(data.message);
            }
        },
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            if (data.success === false) {
                ...
                $("#newChartOfAccountTypeId").empty().html('').html(data.data).trigger("chosen:updated");
...
function getChartOfAccount(leafId, url, securityToken, chartOfAccountId) {
    $.ajax({
        type: 'GET',
        url: url,
        data: {
        ...
        success: function(data) {
            ...
            if (data.success === false) {
                ...
                $("#chartOfAccountId9999").empty();
                $("#chartOfAccountId9999").html('');
                $("#chartOfAccountId9999").html(data.data);
                $("#chartOfAccountId9999").val(chartOfAccountId);
                $("#chartOfAccountId9999").trigger("chosen:updated");
                showMeModal('newChartOfAccount', 0);
                $infoPanel.html('').empty().html("<span class='label label-success'>&nbsp;<img src='./images/icons/smiley-lol.png'>  " + decodeURIComponent(t['loadingCompleteTextLabel']) + "</spanm>").delay(5000).fadeOut();
            }
            if ($infoPanel.is(':hidden')) {
                $infoPanel.show();
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            if (success === false) {
                ...
                $("#journalTypeId").html('').empty().html(data.data).trigger("chosen:updated");
...
function checkDuplicate(leafId, page, securityToken) {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            if (success === true) {
                if (total !== 0) {
                    $("#journalCode").val('').focus();
                    $("#journalCodeForm").removeClass().addClass("form-group has-error");
                ...
                $("#journalForm").removeClass().addClass("form-group has-error");
            }
            if ($infoPanel.is(':hidden')) {
                $infoPanel.show();
            }
...
function showModalDelete(journalId, journalTypeId, documentNumber, journalTitle, referenceNumber, journalDescription, journalDate, journalAmount) {
    $('#journalIdPreview').val('').val(decodeURIComponent(journalId));
    $('#journalTypeIdPreview').val('').val(decodeURIComponent(journalTypeId));
    $('#documentNumberPreview').val('').val(decodeURIComponent(documentNumber));
    $('#journalTitlePreview').val('').val(decodeURIComponent(journalTitle));
    ...
    $('#journalAmountPreview').val('').val(decodeURIComponent(journalAmount));
...
function newRecord(leafId, url, urlList, securityToken, type, createAccess, updateAccess, deleteAccess) {
    ...
    var $journalTypeId = $('#journalTypeId');
    ...
    if (css.search('disabled') > 0) {
        ...
        if (type === 1) {
            if ($journalTypeId.val().length === 0) {
                $('#journalTypeIdHelpMe').html('').empty().html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['journalTypeIdLabel'] + " </span>");
                $journalTypeId.data('chosen').activate_action();
                return false;
            }
            if ($journalTitle.val().length === 0) {
                $('#journalTitleHelpMe').html('').empty().html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['journalTitleLabel'] + " </span>");
                $('#journalTitleForm').removeClass().addClass('form-group has-error');
                $journalTitle.focus();
                return false;
            }
            ...
            if ($journalAmount.val().length === 0) {
                $('#journalAmountHelpMe').html('').empty().html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['journalAmountLabel'] + " </span>");
                $('#journalAmountForm').removeClass().addClass('form-group has-error');
                $journalAmount.focus();
                return false;
            }
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (success === true) {
                        ...
                        $('#journalTypeIdHelpMe').html('').empty();
                        $journalTitle.val('');
                        $('#journalTitleHelpMe').html('').empty();
                        $journalDescription.val('');
                        $('#journalDescriptionHelpMe').html('').empty();
                        $journalDate.val('');
                        $('#journalDateHelpMe').html('').empty();
                        $journalAmount.val('');
                        $('#journalAmountHelpMe').html('').empty();
                    } else if (success === false) {
                        $infoPanel.html('').empty().html("<span class='label label-danger'>&nbsp;" + message + "</span>");
                        if ($infoPanel.is(':hidden')) {
                            $infoPanel.show();
...
function resetRecord(leafId, url, urlList, urlJournalDetail, securityToken, createAccess, updateAccess, deleteAccess) {
    ...
    $("#journalTypeId").val('');
    $("#journalTypeIdHelpMe").empty().html('');
    $('#journalTypeId').trigger("chosen:updated");
    $("#documentNumber").val('');
    $("#documentNumberHelpMe").empty().html('');
    $("#journalTitle").val('');
    $("#journalTitleHelpMe").empty().html('');
    $("#referenceNumber").val('');
    ...
    $("#journalAmount").val('');
    $("#journalAmountHelpMe").empty().html('');
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            if (success === true) {
                                ...
                                $('#journalTypeId').val(data.data.journalTypeId).trigger("chosen:updated");
