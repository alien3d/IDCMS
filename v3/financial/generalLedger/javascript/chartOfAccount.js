...
function showModalDelete(chartOfAccountId, chartOfAccountCategoryId, chartOfAccountTypeId, chartOfAccountNumber, chartOfAccountTitle, chartOfAccountDescription) {
...
function newRecord(leafId, url, urlList, securityToken, type, createAccess, updateAccess, deleteAccess) {
    ...
    var $chartOfAccountLevel = $('#chartOfAccountLevel');
    var $isSlice = $('#isSlice');
    var $isDebtor = $('#isDebtor');
    var $isCreditor = $('#isCreditor');
    var $isDefaultIncome = $('#isDefaultIncome');
    var $isDefaultExpenses = $('#isDefaultExpenses');
    if (css.search('disabled') > 0) {
        return false;
    } else {
        if (type === 1) {
            if ($chartOfAccountCode.val().length === 0) {
                $('#chartOfAccountCodeHelpMe').html('').empty().html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['chartOfAccountCodeLabel'] + " </span>");
                $('#chartOfAccountCodeForm').removeClass().addClass('form-group has-error');
                $chartOfAccountCode.focus();
                return false;
            }
            ...
            $.ajax({type: 'POST', url: url, data: {method: 'create', output: 'json', chartOfAccountCategoryId: $chartOfAccountCategoryId.val(), chartOfAccountTypeId: $chartOfAccountTypeId.val(), chartOfAccountCode: $chartOfAccountCode.val(), chartOfAccountNumber: $chartOfAccountNumber.val(), chartOfAccountTitle: $chartOfAccountTitle.val(), chartOfAccountDescription: $chartOfAccountDescription.val(), chartOfAccountLevel: $chartOfAccountLevel.val(), isSlice: $isSlice.val(), isDebtor: $isDebtor.val(), isCreditor: $isCreditor.val(), isDefaultIncome: $isDefaultIncome.val(), isDefaultExpenses: $isDefaultExpenses.val(), securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                    var smileyRoll = './images/icons/smiley-roll.png';
                    var $infoPanel = $('#infoPanel');
                    $infoPanel.html('').empty().html("<span class='label label-warning'>&nbsp;<img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
                    if ($infoPanel.is(':hidden')) {
                    ...
                    if (success === true) {
                        ...
                        $chartOfAccountCode.val('');
                        $('#chartOfAccountCodeHelpMe').html('').empty();
                        ...
                        $chartOfAccountLevel.val('');
                        $('#chartOfAccountLevelHelpMe').html('').empty();
                        $isConsolidation.val('');
                        ...
                        $isDefaultIncome.val('');
                        $('#isDefaultIncomeHelpMe').html('').empty();
                        $isDefaultExpenses.val('');
                        $('#isDefaultExpensesHelpMe').html('').empty();
                    } else if (success === false) {
                        $infoPanel.html('').empty().html("<span class='label label-danger'>&nbsp;" + message + "</span>");
                        if ($infoPanel.is(':hidden')) {
                            $infoPanel.show();
            ...
            if ($chartOfAccountTypeId.val().length === 0) {
                ...
                $chartOfAccountTypeId.data('chosen').activate_action();
                return false;
            }
            if ($chartOfAccountCode.val().length === 0) {
                $('#chartOfAccountCodeHelpMe').html('').empty().html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['chartOfAccountCodeLabel'] + " </span>");
            ...
            if ($chartOfAccountLevel.val().length === 0) {
                $('#chartOfAccountLevelHelpMe').html('').empty().html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['chartOfAccountLevelLabel'] + " </span>");
                $('#chartOfAccountLevelForm').removeClass().addClass('form-group has-error');
                $chartOfAccountLevel.focus();
                return false;
            }
            ...
            if ($isDefaultIncome.val().length === 0) {
                $('#isDefaultIncomeHelpMe').html('').empty().html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['isDefaultIncomeLabel'] + " </span>");
                $('#isDefaultIncomeForm').removeClass().addClass('form-group has-error');
                $isDefaultIncome.focus();
                return false;
            }
            if ($isDefaultExpenses.val().length === 0) {
                $('#isDefaultExpensesHelpMe').html('').empty().html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['isDefaultExpensesLabel'] + " </span>");
                $('#isDefaultExpensesForm').removeClass().addClass('form-group has-error');
                $isDefaultExpenses.focus();
                return false;
            }
            $.ajax({type: 'POST', url: url, data: {method: 'create', output: 'json', chartOfAccountCategoryId: $chartOfAccountCategoryId.val(), chartOfAccountTypeId: $chartOfAccountTypeId.val(), chartOfAccountCode: $chartOfAccountCode.val(), chartOfAccountNumber: $chartOfAccountNumber.val(), chartOfAccountTitle: $chartOfAccountTitle.val(), chartOfAccountDescription: $chartOfAccountDescription.val(), chartOfAccountLevel: $chartOfAccountLevel.val(), isConsolidation: $isConsolidation.val(), isSlice: $isSlice.val(), isDebtor: $isDebtor.val(), isCreditor: $isCreditor.val(), isDefaultIncome: $isDefaultIncome.val(), isDefaultExpenses: $isDefaultExpenses.val(), securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                    var smileyRoll = './images/icons/smiley-roll.png';
                    var $infoPanel = $('#infoPanel');
                    $infoPanel.html('').empty().html("<span class='label label-warning'>&nbsp;<img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
                    if ($infoPanel.is(':hidden')) {
            ...
            $.ajax({type: 'POST', url: url, data: {method: 'create', output: 'json', chartOfAccountCategoryId: $chartOfAccountCategoryId.val(), chartOfAccountTypeId: $chartOfAccountTypeId.val(), chartOfAccountCode: $chartOfAccountCode.val(), chartOfAccountNumber: $chartOfAccountNumber.val(), chartOfAccountTitle: $chartOfAccountTitle.val(), chartOfAccountDescription: $chartOfAccountDescription.val(), chartOfAccountLevel: $chartOfAccountLevel.val(), isDebtor: $isDebtor.val(), isCreditor: $isCreditor.val(), isDefaultIncome: $isDefaultIncome.val(), isDefaultExpenses: $isDefaultExpenses.val(), securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                    var smileyRoll = './images/icons/smiley-roll.png';
                    var $infoPanel = $('#infoPanel');
                    $infoPanel.html('').empty().html("<span class='label label-warning'>&nbsp;<img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
                    if ($infoPanel.is(':hidden')) {
...
function resetRecord(leafId, url, urlList, securityToken, createAccess, updateAccess, deleteAccess) {
    ...
    $('#chartOfAccountTypeId').trigger("chosen:updated");
    $("#chartOfAccountCode").val('');
    $("#chartOfAccountCodeHelpMe").empty().html('');
    $("#chartOfAccountNumber").val('');
    ...
    $("#chartOfAccountLevel").val('');
    $("#chartOfAccountLevelHelpMe").empty().html('');
    $("#isDebtor").val('');
    $("#isDebtorHelpMe").empty().html('');
    $("#isCreditor").val('');
    $("#isCreditorHelpMe").empty().html('');
    $("#isDefaultIncome").val('');
    $("#isDefaultIncomeHelpMe").empty().html('');
    $("#isDefaultExpenses").val('');
    $("#isDefaultExpensesHelpMe").empty().html('');
}
function postRecord() {
                ...
                if (success === true) {
                    $.ajax({type: 'POST', url: url, data: {method: 'read', chartOfAccountId: firstRecord, output: 'json', securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                            ...
                            if (success === true) {
                                ...
                                $('#chartOfAccountCode').val(data.data.chartOfAccountCode);
                                ...
                                $('#chartOfAccountLevel').val(data.data.chartOfAccountLevel);
                                ...
                                $('#isDefaultIncome').val(data.data.isDefaultIncome);
                                $('#isDefaultExpenses').val(data.data.isDefaultExpenses);
                                if (nextRecord > 0) {
                                    $('#previousRecordButton').removeClass().addClass('btn btn-default disabled').attr('onClick', '');
