...
function checkDuplicate(leafId, page, securityToken) {
    var $chartOfAccountMergeCode = $("#chartOfAccountMergeCode");
    if ($chartOfAccountMergeCode.val().length === 0) {
        alert(t['oddTextLabel']);
        return false;
    }
    $.ajax({type: 'GET', url: page, data: {chartOfAccountMergeCode: $chartOfAccountMergeCode.val(), method: 'duplicate', securityToken: securityToken, leafId: leafId}, beforeSend: function() {
            var smileyRoll = './images/icons/smiley-roll.png';
            var $infoPanel = $('#infoPanel');
            $infoPanel.html('').empty().html("<span class='label label-warning'><img src='" + smileyRoll + "'>&nbsp;" + decodeURIComponent(t['loadingTextLabel']) + "....</span>");
            if ($infoPanel.is(':hidden')) {
            ...
            if (success === true) {
                if (total !== 0) {
                    $("#chartOfAccountMergeCode").val('').focus();
                    $("#chartOfAccountMergeCodeForm").removeClass().addClass("form-group has-error");
                ...
                $("#chartOfAccountMergeForm").removeClass().addClass("form-group has-error");
            }
            if ($infoPanel.is(':hidden')) {
                $infoPanel.show();
            }
...
function showFormUpdate(leafId, url, urlList, securityToken, chartOfAccountMergeId, updateAccess, deleteAccess) {
    sleep(500);
    $('a[rel=tooltip]').tooltip('hide');
    $.ajax({type: 'POST', url: urlList, data: {method: 'read', type: 'form', chartOfAccountMergeId: chartOfAccountMergeId, securityToken: securityToken, leafId: leafId}, beforeSend: function() {
            var smileyRoll = './images/icons/smiley-roll.png';
            var $infoPanel = $('#infoPanel');
            $infoPanel.html('').empty().html("<span class='label label-warning'><img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
            if ($infoPanel.is(':hidden')) {
...
function showModalDelete(chartOfAccountMergeId, chartOfAccountId, documentNumber, chartOfAccountMergeDate, chartOfAccountMergeAmount, chartOfAccountMergeDescription, isBalance) {
    $('#chartOfAccountMergeIdPreview').val('').val(decodeURIComponent(chartOfAccountMergeId));
    ...
    $('#chartOfAccountMergeDatePreview').val('').val(decodeURIComponent(chartOfAccountMergeDate));
    $('#chartOfAccountMergeAmountPreview').val('').val(decodeURIComponent(chartOfAccountMergeAmount));
    $('#chartOfAccountMergeDescriptionPreview').val('').val(decodeURIComponent(chartOfAccountMergeDescription));
    $('#isBalancePreview').val('').val(decodeURIComponent(isBalance));
    showMeModal('deletePreview', 1);
}
function deleteGridRecord(leafId, url, urlList, securityToken) {
    $.ajax({type: 'POST', url: url, data: {method: 'delete', output: 'json', chartOfAccountMergeId: $('#chartOfAccountMergeIdPreview').val(), securityToken: securityToken, leafId: leafId}, beforeSend: function() {
            var smileyRoll = './images/icons/smiley-roll.png';
            var $infoPanel = $('#infoPanel');
            $infoPanel.html('').empty().html("<span class='label label-warning'><img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
            if ($infoPanel.is(':hidden')) {
...
function showFormCreateDetail(leafId, url, securityToken) {
    ...
    if ($('#chartOfAccountMergeDetailAmount9999').val().length === 0) {
        $infoPanel.html('').empty().html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['chartOfAccountMergeDetailAmountLabel'] + "</span>");
        $('#chartOfAccountMergeDetailAmount9999HelpMe').html('').empty().html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['chartOfAccountMergeDetailAmountLabel'] + "</span>");
        $('#chartOfAccountMergeDetailAmount9999Form').removeClass().addClass('form-group has-error');
        $('#chartOfAccountMergeDetailAmount9999').focus();
        return false;
    }
    ...
    $.ajax({type: 'POST', url: url, data: {method: 'create', output: 'json', chartOfAccountMergeId: $('#chartOfAccountMergeId').val(), chartOfAccountId: $('#chartOfAccountId9999').val(), documentNumber: $('#documentNumber9999').val(), chartOfAccountMergeDetailAmount: $('#chartOfAccountMergeDetailAmount9999').val(), securityToken: securityToken, leafId: leafId}, beforeSend: function() {
            var smileyRoll = './images/icons/smiley-roll.png';
            var $infoPanel = $('#infoPanel');
            $infoPanel.html('').empty().html("<span class='label label-warning'>&nbsp;<img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
            ...
            var message = data.message;
            if (success === true) {
                $.ajax({type: 'POST', url: url, data: {method: 'read', output: 'table', offset: '0', limit: '9999', chartOfAccountMergeId: $('#chartOfAccountMergeId').val(), securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                        var smileyRoll = './images/icons/smiley-roll.png';
                        var $infoPanel = $('#infoPanel');
                        $infoPanel.html('').empty().html("<span class='label label-warning'>&nbsp;<img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
                        ...
                        if (success === true) {
                            ...
                            $("#chartOfAccountMergeDetailAmount9999").prop("disabled", "false").removeAttr("disabled", "").val('');
                            $(".chzn-select").chosen();
                            $infoPanel.html('').empty().html("<span class='label label-success'>&nbsp;<img src='" + smileyLol + "'> " + decodeURIComponent(t['loadingCompleteTextLabel']) + "</span>").delay(1000).fadeOut();
                            if ($infoPanel.is(':hidden')) {
                                $infoPanel.show();
...
function showFormUpdateDetail(leafId, url, securityToken, chartOfAccountMergeDetailId) {
    var $infoPanel = $('#infoPanel');
    if ($('#chartOfAccountId' + chartOfAccountMergeDetailId).val().length === 0) {
        ...
        $('#chartOfAccountId' + chartOfAccountMergeDetailId + 'HelpMe').html('').empty().html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + ' :' + leafTranslation['chartOfAccountIdLabel'] + "</span>");
        $('#chartOfAccountId' + chartOfAccountMergeDetailId).removeClass().addClass('form-group has-error');
        $('#chartOfAccountId' + chartOfAccountMergeDetailId).focus();
        return false;
    }
    if ($('#documentNumber' + chartOfAccountMergeDetailId).val().length === 0) {
        ...
        $('#documentNumber' + chartOfAccountMergeDetailId + 'HelpMe').html('').empty().html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + ' :' + leafTranslation['documentNumberLabel'] + "</span>");
        $('#documentNumber' + chartOfAccountMergeDetailId).removeClass().addClass('form-group has-error');
        $('#documentNumber' + chartOfAccountMergeDetailId).focus();
        return false;
    }
    if ($('#journalNumber' + chartOfAccountMergeDetailId).val().length === 0) {
        ...
        $('#journalNumber' + chartOfAccountMergeDetailId + 'HelpMe').html('').empty().html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + ' :' + leafTranslation['journalNumberLabel'] + "</span>");
        $('#journalNumber' + chartOfAccountMergeDetailId).removeClass().addClass('form-group has-error');
        $('#journalNumber' + chartOfAccountMergeDetailId).focus();
        return false;
    }
    if ($('#chartOfAccountMergeDetailAmount' + chartOfAccountMergeDetailId).val().length === 0) {
        $infoPanel.html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + ' :' + leafTranslation['chartOfAccountMergeDetailAmountLabel'] + "</span>");
        $('#chartOfAccountMergeDetailAmount' + chartOfAccountMergeDetailId + 'HelpMe').html('').empty().html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + ' :' + leafTranslation['chartOfAccountMergeDetailAmountLabel'] + "</span>");
        $('#chartOfAccountMergeDetailAmount' + chartOfAccountMergeDetailId).removeClass().addClass('form-group has-error');
        $('#chartOfAccountMergeDetailAmount' + chartOfAccountMergeDetailId).focus();
        return false;
    }
    $.ajax({type: 'POST', url: url, data: {method: 'save', output: 'json', chartOfAccountMergeDetailId: $('#chartOfAccountMergeDetailId' + chartOfAccountMergeDetailId).val(), chartOfAccountMergeId: $('#chartOfAccountMergeId').val(), chartOfAccountId: $('#chartOfAccountId' + chartOfAccountMergeDetailId).val(), documentNumber: $('#documentNumber' + chartOfAccountMergeDetailId).val(), journalNumber: $('#journalNumber' + chartOfAccountMergeDetailId).val(), chartOfAccountMergeDetailAmount: $('#chartOfAccountMergeDetailAmount' + chartOfAccountMergeDetailId).val(), securityToken: securityToken, leafId: leafId}, beforeSend: function() {
            var smileyRoll = './images/icons/smiley-roll.png';
            var $infoPanel = $('#infoPanel');
            $infoPanel.html('').empty().html("<span class='label label-warning'>&nbsp;<img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
            $('#miniInfoPanel' + chartOfAccountMergeDetailId).html('').empty().html("<span class='label label-warning'> <img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
            if ($infoPanel.is(':hidden')) {
                $infoPanel.show();
            }
        }, success: function(data) {
            var $infoPanel = $('#infoPanel');
            var $miniInfoPanel = $('#miniInfoPanel' + chartOfAccountMergeDetailId);
            var smileyLol = './images/icons/smiley-lol.png';
            var success = data.success;
            var message = data.message;
            if (success === true) {
...
function showModalDeleteDetail(chartOfAccountMergeDetailId) {
    $('#chartOfAccountMergeDetailIdPreview').val('').val(decodeURIComponent($("#chartOfAccountMergeDetailId" + chartOfAccountMergeDetailId).val()));
    $('#chartOfAccountIdPreview').val('').val(decodeURIComponent($("#chartOfAccountId" + chartOfAccountMergeDetailId + " option:selected").text()));
    $('#documentNumberPreview').val('').val(decodeURIComponent($("#documentNumber" + chartOfAccountMergeDetailId).val()));
    $('#journalNumberPreview').val('').val(decodeURIComponent($("#journalNumber" + chartOfAccountMergeDetailId).val()));
    $('#chartOfAccountMergeDetailAmountPreview').val('').val(decodeURIComponent($("#chartOfAccountMergeDetailAmount" + chartOfAccountMergeDetailId).val()));
    showMeModal('deleteDetailPreview', 1);
}
function deleteGridRecordDetail(leafId, url, urlList, securityToken) {
    $.ajax({type: 'POST', url: url, data: {method: 'delete', output: 'json', chartOfAccountMergeDetailId: $('#chartOfAccountMergeDetailIdPreview').val(), securityToken: securityToken, leafId: leafId}, beforeSend: function() {
            var smileyRoll = './images/icons/smiley-roll.png';
            var $infoPanel = $('#infoPanel');
            $infoPanel.html('').empty().html("<span class='label label-warning'>&nbsp;<img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
            if ($infoPanel.is(':hidden')) {
            ...
            if (success === true) {
                ...
                removeMeTr($('#chartOfAccountMergeDetailIdPreview').val())
            } else if (success === false) {
                $infoPanel.html('').empty().html("<span class='label label-danger'> " + message + "</span>");
                if ($infoPanel.is(':hidden')) {
                    $infoPanel.show();
...
function deleteGridRecordCheckbox(leafId, url, urlList, securityToken) {
    var stringText = '';
    var counter = 0;
    $('input:checkbox[name="chartOfAccountMergeId[]"]').each(function() {
        stringText = stringText + "&chartOfAccountMergeId[]=" + $(this).val();
    });
...
function newRecord(leafId, url, urlList, securityToken, type, createAccess, updateAccess, deleteAccess) {
    ...
    var $chartOfAccountMergeDate = $('#chartOfAccountMergeDate');
    var $chartOfAccountMergeAmount = $('#chartOfAccountMergeAmount');
    var $chartOfAccountMergeDescription = $('#chartOfAccountMergeDescription');
    ...
    if (css.search('disabled') > 0) {
        ...
        if (type === 1) {
            ...
            if ($chartOfAccountMergeDate.val().length === 0) {
                $('#chartOfAccountMergeDateHelpMe').html('').empty().html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['chartOfAccountMergeDateLabel'] + " </span>");
                $('#chartOfAccountMergeDateForm').removeClass().addClass('form-group has-error');
                $chartOfAccountMergeDate.focus();
                return false;
            }
            if ($chartOfAccountMergeAmount.val().length === 0) {
                $('#chartOfAccountMergeAmountHelpMe').html('').empty().html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['chartOfAccountMergeAmountLabel'] + " </span>");
                $('#chartOfAccountMergeAmountForm').removeClass().addClass('form-group has-error');
                $chartOfAccountMergeAmount.focus();
                return false;
            }
            $.ajax({type: 'POST', url: url, data: {method: 'create', output: 'json', chartOfAccountId: $chartOfAccountId.val(), chartOfAccountMergeDate: $chartOfAccountMergeDate.val(), chartOfAccountMergeAmount: $chartOfAccountMergeAmount.val(), chartOfAccountMergeDescription: $chartOfAccountMergeDescription.val(), isBalance: $isBalance.val(), securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                    var smileyRoll = './images/icons/smiley-roll.png';
                    var $infoPanel = $('#infoPanel');
                    $infoPanel.html('').empty().html("<span class='label label-warning'>&nbsp;<img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
                    if ($infoPanel.is(':hidden')) {
                    ...
                    if (success === true) {
                        ...
                        $chartOfAccountMergeDate.val('');
                        $('#chartOfAccountMergeDateHelpMe').html('').empty();
                        $chartOfAccountMergeAmount.val('');
                        $('#chartOfAccountMergeAmountHelpMe').html('').empty();
                        $chartOfAccountMergeDescription.val('');
                        $('#chartOfAccountMergeDescriptionForm').removeClass().addClass('form-group');
                        $('#chartOfAccountMergeDescriptionHelpMe').html('').empty();
                        $isBalance.val('');
            ...
            $.ajax({type: 'POST', url: url, data: {method: 'create', output: 'json', chartOfAccountId: $chartOfAccountId.val(), chartOfAccountMergeDate: $chartOfAccountMergeDate.val(), chartOfAccountMergeAmount: $chartOfAccountMergeAmount.val(), chartOfAccountMergeDescription: $chartOfAccountMergeDescription.val(), isBalance: $isBalance.val(), securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                    ...
                    if (success === true) {
                        ...
                        $('#chartOfAccountMergeId').val(data.chartOfAccountMergeId);
                        $('#newRecordButton1').removeClass().addClass('btn btn-success disabled').attr('onClick', '');
                        $('#newRecordButton2').removeClass().addClass('btn dropdown-toggle btn-success disabled');
                        $('#newRecordButton3').attr('onClick', '');
                        $('#newRecordButton4').attr('onClick', '');
                        ...
                        $("#chartOfAccountMergeId9999").prop("disabled", "false").removeAttr("disabled", "").val('').trigger("chosen:updated");
                        $("#chartOfAccountId9999").prop("disabled", "false").removeAttr("disabled", "").val('').trigger("chosen:updated");
            ...
            if ($chartOfAccountMergeDescription.val().length === 0) {
                $('#chartOfAccountMergeDescriptionHelpMe').html('').empty().html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['chartOfAccountMergeDescriptionLabel'] + " </span>");
                $('#chartOfAccountMergeDescriptionForm').removeClass().addClass('form-group has-error');
                $chartOfAccountMergeDescription.focus();
                return false;
            }
...
function updateRecord(leafId, url, urlList, securityToken, type, deleteAccess) {
    ...
    if (css.search('disabled') > 0) {
        ...
        if (type === 1) {
            ...
            $infoPanel.html('').empty();
            $.ajax({type: 'POST', url: url, data: {method: 'save', output: 'json', chartOfAccountMergeId: $chartOfAccountMergeId.val(), chartOfAccountId: $chartOfAccountId.val(), chartOfAccountMergeDate: $chartOfAccountMergeDate.val(), chartOfAccountMergeAmount: $chartOfAccountMergeAmount.val(), chartOfAccountMergeDescription: $chartOfAccountMergeDescription.val(), isBalance: $isBalance.val(), securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                    var smileyRoll = './images/icons/smiley-roll.png';
                    var $infoPanel = $('#infoPanel');
                    $infoPanel.html('').empty().html("<span class='label label-warning'>&nbsp;<img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
                    if ($infoPanel.is(':hidden')) {
...
function deleteRecord(leafId, url, urlList, securityToken, deleteAccess) {
    var $infoPanel = $('#infoPanel');
    var $chartOfAccountMergeId = $('#chartOfAccountMergeId');
    ...
    if (css.search('disabled') > 0) {
        ...
        if (deleteAccess === 1) {
            if (confirm(decodeURIComponent(t['deleteRecordMessageLabel']))) {
                var value = $chartOfAccountMergeId.val();
                if (!value) {
                    ...
                    $.ajax({type: 'POST', url: url, data: {method: 'delete', output: 'json', chartOfAccountMergeId: $chartOfAccountMergeId.val(), securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                            var smileyRoll = './images/icons/smiley-roll.png';
                            var $infoPanel = $('#infoPanel');
                            $infoPanel.html('').empty().html("<span class='label label-warning'>&nbsp;<img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
                            if ($infoPanel.is(':hidden')) {
...
function resetRecord(leafId, url, urlList, urlChartOfAccountMergeDetail, securityToken, createAccess, updateAccess, deleteAccess) {
    var $infoPanel = $('#infoPanel');
    ...
    $('#firstRecordButton').removeClass().addClass('btn btn-default').attr('onClick', "firstRecord(" + leafId + ",'" + url + "','" + urlList + "','" + urlChartOfAccountMergeDetail + "','" + securityToken + "'," + updateAccess + "," + deleteAccess + ")");
    ...
    $('#endRecordButton').removeClass().addClass('btn btn-default').attr('onClick', "endRecord(" + leafId + ",'" + url + "','" + urlList + "','" + urlChartOfAccountMergeDetail + "','" + securityToken + "'," + updateAccess + ")");
    $("#chartOfAccountMergeId").val('');
    $("#chartOfAccountMergeIdHelpMe").empty().html('');
    ...
    $("#chartOfAccountMergeDate").val('');
    $("#chartOfAccountMergeDateHelpMe").empty().html('');
    $("#chartOfAccountMergeAmount").val('');
    $("#chartOfAccountMergeAmountHelpMe").empty().html('');
    $("#chartOfAccountMergeDescription").val('');
    $("#chartOfAccountMergeDescriptionHelpMe").empty().html('');
    $('#chartOfAccountMergeDescription').empty().val('');
    $("#isBalance").val('');
    $("#isBalanceHelpMe").empty().html('');
    $("#chartOfAccountMergeDetailId9999").prop("disabled", "true").attr("disabled", "disabled").val('');
    $("#chartOfAccountMergeId9999").prop("disabled", "true").attr("disabled", "disabled").val('').trigger("chosen:updated");
    ...
    $("#chartOfAccountMergeDetailAmount9999").prop("disabled", "true").attr("disabled", "disabled").val('');
...
function firstRecord(leafId, url, urlList, urlChartOfAccountMergeDetail, securityToken, updateAccess, deleteAccess) {
    ...
    if (css.search('disabled') > 0) {
        ...
        $.ajax({type: 'GET', url: url, data: {method: 'dataNavigationRequest', dataNavigation: 'firstRecord', output: 'json', securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                ...
                if (success === true) {
                    $.ajax({type: 'POST', url: url, data: {method: 'read', chartOfAccountMergeId: firstRecord, output: 'json', securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                            var smileyRoll = './images/icons/smiley-roll.png';
                            $infoPanel.html('').empty().html("<span class='label label-warning'>&nbsp;<img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
                            if ($infoPanel.is(':hidden')) {
                                $infoPanel.show();
                            ...
                            if (success === true) {
                                $('#chartOfAccountMergeId').val(data.data.chartOfAccountMergeId);
                                $('#chartOfAccountId').val(data.data.chartOfAccountId).trigger("chosen:updated");
                                $('#documentNumber').val(data.data.documentNumber);
                                x = data.data.chartOfAccountMergeDate;
                                x = x.split("-");
                                output = x[2] + "-" + x[1] + "-" + x[0];
                                output = output.toString();
                                $('#chartOfAccountMergeDate').val(output);
                                $('#chartOfAccountMergeAmount').val(data.data.chartOfAccountMergeAmount);
                                $('#chartOfAccountMergeDescription').val(data.data.chartOfAccountMergeDescription);
                                ...
                                $.ajax({type: 'POST', url: urlChartOfAccountMergeDetail, data: {method: 'read', chartOfAccountMergeId: data.firstRecord, output: 'table', securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                                        var smileyRoll = './images/icons/smiley-roll.png';
                                        var $infoPanel = $('#infoPanel');
                                        $infoPanel.html('').empty().html("<span class='label label-warning'><img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
                                        if ($infoPanel.is(':hidden')) {
                                ...
                                if (nextRecord > 0) {
                                    $('#previousRecordButton').removeClass().addClass('btn btn-default disabled').attr('onClick', '');
                                    $('#nextRecordButton').removeClass().addClass('btn btn-default').attr('onClick', '').attr('onClick', "nextRecord(" + leafId + ",'" + url + "','" + urlList + "','" + urlChartOfAccountMergeDetail + "','" + securityToken + "'," + updateAccess + "," + deleteAccess + ")");
...
function endRecord(leafId, url, urlList, urlChartOfAccountMergeDetail, securityToken, updateAccess, deleteAccess) {
    var $infoPanel = $('#infoPanel');
    ...
    if (css.search('disabled') > 0) {
        ...
        $.ajax({type: 'GET', url: url, data: {method: 'dataNavigationRequest', dataNavigation: 'lastRecord', output: 'json', securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                ...
                if (success === true) {
                    $.ajax({type: 'POST', url: url, data: {method: 'read', chartOfAccountMergeId: lastRecord, output: 'json', securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                            var smileyRoll = './images/icons/smiley-roll.png';
                            $infoPanel.html('').empty().html("<span class='label label-warning'>&nbsp;<img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
                            if ($infoPanel.is(':hidden')) {
                                $infoPanel.show();
                            ...
                            if (success === true) {
                                ...
                                $.ajax({type: 'POST', url: urlChartOfAccountMergeDetail, data: {method: 'read', chartOfAccountMergeId: lastRecord, output: 'table', securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                                        var smileyRoll = './images/icons/smiley-roll.png';
                                        var $infoPanel = $('#infoPanel');
                                        $infoPanel.html('').empty().html("<span class='label label-warning'><img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
                                        if ($infoPanel.is(':hidden')) {
                                ...
                                if (lastRecord !== 0) {
                                    $('#previousRecordButton').removeClass().addClass('btn btn-default').attr('onClick', "previousRecord(" + leafId + ",'" + url + "','" + urlList + "','" + urlChartOfAccountMergeDetail + "','" + securityToken + "'," + updateAccess + "," + deleteAccess + ")");
                                    $('#nextRecordButton').removeClass().addClass('btn btn-default disabled').attr('onClick', '');
                                    $('#firstRecordCounter').val(firstRecord);
                                    $('#previousRecordCounter').val(previousRecord);
                                    $('#nextRecordCounter').val(nextRecord);
...
function previousRecord(leafId, url, urlList, urlChartOfAccountMergeDetail, securityToken, updateAccess, deleteAccess) {
    ...
    if (css.search('disabled') > 0) {
        ...
        if (parseFloat($previousRecordCounter.val()) > 0 && parseFloat($previousRecordCounter.val()) < parseFloat($('#lastRecordCounter').val())) {
            $.ajax({type: 'POST', url: url, data: {method: 'read', chartOfAccountMergeId: $previousRecordCounter.val(), output: 'json', securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                    var smileyRoll = './images/icons/smiley-roll.png';
                    var $infoPanel = $('#infoPanel');
                    $infoPanel.html('').empty().html("<span class='label label-warning'>&nbsp;<img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
                    if ($infoPanel.is(':hidden')) {
                    ...
                    if (success === true) {
                        ...
                        $.ajax({type: 'POST', url: urlChartOfAccountMergeDetail, data: {method: 'read', chartOfAccountMergeId: $('#previousRecordCounter').val(), output: 'table', securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                                var smileyRoll = './images/icons/smiley-roll.png';
                                var $infoPanel = $('#infoPanel');
                                $infoPanel.html('').empty().html("<span class='label label-warning'><img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
                                if ($infoPanel.is(':hidden')) {
...
function nextRecord(leafId, url, urlList, urlChartOfAccountMergeDetail, securityToken, updateAccess, deleteAccess) {
    var $infoPanel = $('#infoPanel');
    ...
    if (css.search('disabled') > 0) {
        ...
        if (parseFloat($nextRecordCounter.val()) <= parseFloat($('#lastRecordCounter').val())) {
            $.ajax({type: 'POST', url: url, data: {method: 'read', chartOfAccountMergeId: $nextRecordCounter.val(), output: 'json', securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                    var smileyRoll = './images/icons/smiley-roll.png';
                    var $infoPanel = $('#infoPanel');
                    $infoPanel.html('').empty().html("<span class='label label-warning'>&nbsp;<img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
                    if ($infoPanel.is(':hidden')) {
                    ...
                    if (success === true) {
                        ...
                        $.ajax({type: 'POST', url: urlChartOfAccountMergeDetail, data: {method: 'read', chartOfAccountMergeId: $('#nextRecordCounter').val(), output: 'table', securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                                var smileyRoll = './images/icons/smiley-roll.png';
                                var $infoPanel = $('#infoPanel');
                                $infoPanel.html('').empty().html("<span class='label label-warning'><img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
                                if ($infoPanel.is(':hidden')) {
