...
function showFormCreateDetail(leafId, url, securityToken) {
    ...
    if ($('#roleId9999').val().length === 0) {
        $infoPanel.html('').empty().html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['roleIdLabel'] + "</span>");
        $('#roleId9999HelpMe').html('').empty().html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['roleIdLabel'] + "</span>");
        $('#roleId9999Form').removeClass().addClass('form-group has-error');
        $('#roleId9999').focus();
        return false;
    }
    if ($('#chartOfAccountRoleAccessValue9999').val().length === 0) {
        $infoPanel.html('').empty().html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['chartOfAccountRoleAccessValueLabel'] + "</span>");
        $('#chartOfAccountRoleAccessValue9999HelpMe').html('').empty().html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['chartOfAccountRoleAccessValueLabel'] + "</span>");
        $('#chartOfAccountRoleAccessValue9999Form').removeClass().addClass('form-group has-error');
        $('#chartOfAccountRoleAccessValue9999').focus();
        return false;
    }
    ...
    $.ajax({type: 'POST', url: url, data: {method: 'create', output: 'json', chartOfAccountReportTypeId: $('#chartOfAccountReportTypeId').val(), chartOfAccountId: $('#chartOfAccountId9999').val(), roleId: $('#roleId9999').val(), chartOfAccountRoleAccessValue: $('#chartOfAccountRoleAccessValue9999').val(), securityToken: securityToken, leafId: leafId}, beforeSend: function() {
            var smileyRoll = './images/icons/smiley-roll.png';
            var $infoPanel = $('#infoPanel');
            $infoPanel.html('').empty().html("<span class='label label-warning'>&nbsp;<img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
            ...
            if (success === true) {
                $.ajax({type: 'POST', url: url, data: {method: 'read', output: 'table', offset: '0', limit: '9999', chartOfAccountReportTypeId: $('#chartOfAccountReportTypeId').val(), securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                        ...
                        if (success === true) {
                            ...
                            $("#roleId9999").prop("disabled", "false").removeAttr("disabled", "").val('').trigger("chosen:updated");
                            $(".chzn-select").chosen();
                            $infoPanel.html('').empty().html("<span class='label label-success'>&nbsp;<img src='" + smileyLol + "'> " + decodeURIComponent(t['loadingCompleteTextLabel']) + "</span>").delay(1000).fadeOut();
                            if ($infoPanel.is(':hidden')) {
                                $infoPanel.show();
...
function showFormUpdateDetail(leafId, url, securityToken, chartOfAccountRoleAccess) {
    var $infoPanel = $('#infoPanel');
    if ($('#chartOfAccountId' + chartOfAccountRoleAccess).val().length === 0) {
        ...
        $('#chartOfAccountId' + chartOfAccountRoleAccess + 'HelpMe').html('').empty().html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + ' :' + leafTranslation['chartOfAccountIdLabel'] + "</span>");
        $('#chartOfAccountId' + chartOfAccountRoleAccess).removeClass().addClass('form-group has-error');
        $('#chartOfAccountId' + chartOfAccountRoleAccess).focus();
        return false;
    }
    if ($('#roleId' + chartOfAccountRoleAccess).val().length === 0) {
        $infoPanel.html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + ' :' + leafTranslation['roleIdLabel'] + "</span>");
        $('#roleId' + chartOfAccountRoleAccess + 'HelpMe').html('').empty().html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + ' :' + leafTranslation['roleIdLabel'] + "</span>");
        $('#roleId' + chartOfAccountRoleAccess).removeClass().addClass('form-group has-error');
        $('#roleId' + chartOfAccountRoleAccess).focus();
        return false;
    }
    if ($('#chartOfAccountRoleAccessValue' + chartOfAccountRoleAccess).val().length === 0) {
        $infoPanel.html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + ' :' + leafTranslation['chartOfAccountRoleAccessValueLabel'] + "</span>");
        $('#chartOfAccountRoleAccessValue' + chartOfAccountRoleAccess + 'HelpMe').html('').empty().html("<span class='label label-danger'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + ' :' + leafTranslation['chartOfAccountRoleAccessValueLabel'] + "</span>");
        $('#chartOfAccountRoleAccessValue' + chartOfAccountRoleAccess).removeClass().addClass('form-group has-error');
        $('#chartOfAccountRoleAccessValue' + chartOfAccountRoleAccess).focus();
        return false;
    }
    $.ajax({type: 'POST', url: url, data: {method: 'save', output: 'json', chartOfAccountRoleAccess: $('#chartOfAccountRoleAccess' + chartOfAccountRoleAccess).val(), chartOfAccountId: $('#chartOfAccountId' + chartOfAccountRoleAccess).val(), roleId: $('#roleId' + chartOfAccountRoleAccess).val(), chartOfAccountRoleAccessValue: $('#chartOfAccountRoleAccessValue' + chartOfAccountRoleAccess).val(), securityToken: securityToken, leafId: leafId}, beforeSend: function() {
            var smileyRoll = './images/icons/smiley-roll.png';
            var $infoPanel = $('#infoPanel');
            $infoPanel.html('').empty().html("<span class='label label-warning'>&nbsp;<img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
            $('#miniInfoPanel' + chartOfAccountRoleAccess).html('').empty().html("<span class='label label-warning'> <img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
            if ($infoPanel.is(':hidden')) {
                $infoPanel.show();
            }
        }, success: function(data) {
            var $infoPanel = $('#infoPanel');
            var $miniInfoPanel = $('#miniInfoPanel' + chartOfAccountRoleAccess);
            var smileyLol = './images/icons/smiley-lol.png';
            var success = data.success;
            var message = data.message;
            if (success === true) {
...
function showModalDeleteDetail(chartOfAccountRoleAccess) {
    $('#chartOfAccountRoleAccessPreview').val('').val(decodeURIComponent($("#chartOfAccountRoleAccess" + chartOfAccountRoleAccess).val()));
    $('#chartOfAccountIdPreview').val('').val(decodeURIComponent($("#chartOfAccountId" + chartOfAccountRoleAccess + " option:selected").text()));
    $('#roleIdPreview').val('').val(decodeURIComponent($("#roleId" + chartOfAccountRoleAccess + " option:selected").text()));
    $('#chartOfAccountRoleAccessValuePreview').val('').val(decodeURIComponent($("#chartOfAccountRoleAccessValue" + chartOfAccountRoleAccess).val()));
    showMeModal('deleteDetailPreview', 1);
}
function deleteGridRecordDetail(leafId, url, urlList, securityToken) {
    $.ajax({type: 'POST', url: url, data: {method: 'delete', output: 'json', chartOfAccountRoleAccess: $('#chartOfAccountRoleAccessPreview').val(), securityToken: securityToken, leafId: leafId}, beforeSend: function() {
            var smileyRoll = './images/icons/smiley-roll.png';
            var $infoPanel = $('#infoPanel');
            $infoPanel.html('').empty().html("<span class='label label-warning'>&nbsp;<img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
            if ($infoPanel.is(':hidden')) {
            ...
            if (success === true) {
                ...
                removeMeTr($('#chartOfAccountRoleAccessPreview').val())
            } else if (success === false) {
                $infoPanel.html('').empty().html("<span class='label label-danger'> " + message + "</span>");
                if ($infoPanel.is(':hidden')) {
                    $infoPanel.show();
        ...
        if (type === 1) {
            ...
            $.ajax({type: 'POST', url: url, data: {method: 'create', output: 'json', chartOfAccountReportTypeCode: $chartOfAccountReportTypeCode.val(), chartOfAccountReportTypeDescription: $chartOfAccountReportTypeDescription.val(), securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                    ...
                    if (success === true) {
                        ...
                        $("#chartOfAccountId9999").prop("disabled", "false").removeAttr("disabled", "").val('').trigger("chosen:updated");
                        $("#roleId9999").prop("disabled", "false").removeAttr("disabled", "").val('').trigger("chosen:updated");
                        $("#chartOfAccountRoleAccessValue9999").prop("disabled", "false").removeAttr("disabled", "").val('');
                    }
                }, error: function(xhr) {
                    var smileyRollSweat = './images/icons/smiley-roll-sweat.png';
                    $('#infoError').html('').empty().html("<span class='alert alert-error col-xs-12 col-sm-12 col-md-12'><img src='" + smileyRollSweat + "'><strong>" + xhr.status + "</strong> : " + decodeURIComponent(t['loadingErrorTextLabel']) + "</span>");
...
function firstRecord(leafId, url, urlList, urlChartOfAccountRoleAccess, securityToken, updateAccess, deleteAccess) {
                ...
                if (success === true) {
                    $.ajax({type: 'POST', url: url, data: {method: 'read', chartOfAccountReportTypeId: firstRecord, output: 'json', securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                            ...
                            if (success === true) {
                                ...
                                $("#roleId9999").prop("disabled", "false").removeAttr("disabled", "").val('').trigger("chosen:updated");
                                $("#chartOfAccountRoleAccessValue9999").prop("disabled", "false").removeAttr("disabled", "").val('');
                                $.ajax({type: 'POST', url: urlChartOfAccountRoleAccess, data: {method: 'read', chartOfAccountReportTypeId: data.firstRecord, output: 'table', securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                                        var smileyRoll = './images/icons/smiley-roll.png';
                                        var $infoPanel = $('#infoPanel');
                                        $infoPanel.html('').empty().html("<span class='label label-warning'><img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
                                        if ($infoPanel.is(':hidden')) {
                                ...
                                if (nextRecord > 0) {
                                    $('#previousRecordButton').removeClass().addClass('btn btn-default disabled').attr('onClick', '');
                                    $('#nextRecordButton').removeClass().addClass('btn btn-default').attr('onClick', '').attr('onClick', "nextRecord(" + leafId + ",'" + url + "','" + urlList + "','" + urlChartOfAccountRoleAccess + "','" + securityToken + "'," + updateAccess + "," + deleteAccess + ")");
...
function endRecord(leafId, url, urlList, urlChartOfAccountRoleAccess, securityToken, updateAccess, deleteAccess) {
    var $infoPanel = $('#infoPanel');
                ...
                if (success === true) {
                    $.ajax({type: 'POST', url: url, data: {method: 'read', chartOfAccountReportTypeId: lastRecord, output: 'json', securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                            ...
                            if (success === true) {
                                ...
                                $("#roleId9999").prop("disabled", "false").removeAttr("disabled", "").val('').trigger("chosen:updated");
                                $("#chartOfAccountRoleAccessValue9999").prop("disabled", "false").removeAttr("disabled", "").val('');
                                $.ajax({type: 'POST', url: urlChartOfAccountRoleAccess, data: {method: 'read', chartOfAccountReportTypeId: lastRecord, output: 'table', securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                                        var smileyRoll = './images/icons/smiley-roll.png';
                                        var $infoPanel = $('#infoPanel');
                                        $infoPanel.html('').empty().html("<span class='label label-warning'><img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
                                        if ($infoPanel.is(':hidden')) {
                                ...
                                if (lastRecord !== 0) {
                                    $('#previousRecordButton').removeClass().addClass('btn btn-default').attr('onClick', "previousRecord(" + leafId + ",'" + url + "','" + urlList + "','" + urlChartOfAccountRoleAccess + "','" + securityToken + "'," + updateAccess + "," + deleteAccess + ")");
                                    $('#nextRecordButton').removeClass().addClass('btn btn-default disabled').attr('onClick', '');
                                    $('#firstRecordCounter').val(firstRecord);
                                    $('#previousRecordCounter').val(previousRecord);
                                    $('#nextRecordCounter').val(nextRecord);
...
function previousRecord(leafId, url, urlList, urlChartOfAccountRoleAccess, securityToken, updateAccess, deleteAccess) {
        ...
        if (parseFloat($previousRecordCounter.val()) > 0 && parseFloat($previousRecordCounter.val()) < parseFloat($('#lastRecordCounter').val())) {
            $.ajax({type: 'POST', url: url, data: {method: 'read', chartOfAccountReportTypeId: $previousRecordCounter.val(), output: 'json', securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                    ...
                    if (success === true) {
                        ...
                        $("#roleId9999").prop("disabled", "false").removeAttr("disabled", "").val('').trigger("chosen:updated");
                        $("#chartOfAccountRoleAccessValue9999").prop("disabled", "false").removeAttr("disabled", "").val('');
                        $.ajax({type: 'POST', url: urlChartOfAccountRoleAccess, data: {method: 'read', chartOfAccountReportTypeId: $('#previousRecordCounter').val(), output: 'table', securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                                var smileyRoll = './images/icons/smiley-roll.png';
                                var $infoPanel = $('#infoPanel');
                                $infoPanel.html('').empty().html("<span class='label label-warning'><img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
                                if ($infoPanel.is(':hidden')) {
...
function nextRecord(leafId, url, urlList, urlChartOfAccountRoleAccess, securityToken, updateAccess, deleteAccess) {
    var $infoPanel = $('#infoPanel');
        ...
        if (parseFloat($nextRecordCounter.val()) <= parseFloat($('#lastRecordCounter').val())) {
            $.ajax({type: 'POST', url: url, data: {method: 'read', chartOfAccountReportTypeId: $nextRecordCounter.val(), output: 'json', securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                    ...
                    if (success === true) {
                        ...
                        $("#roleId9999").prop("disabled", "false").removeAttr("disabled", "").val('').trigger("chosen:updated");
                        $("#chartOfAccountRoleAccessValue9999").prop("disabled", "false").removeAttr("disabled", "").val('');
                        $.ajax({type: 'POST', url: urlChartOfAccountRoleAccess, data: {method: 'read', chartOfAccountReportTypeId: $('#nextRecordCounter').val(), output: 'table', securityToken: securityToken, leafId: leafId}, beforeSend: function() {
                                var smileyRoll = './images/icons/smiley-roll.png';
                                var $infoPanel = $('#infoPanel');
                                $infoPanel.html('').empty().html("<span class='label label-warning'><img src='" + smileyRoll + "'> " + decodeURIComponent(t['loadingTextLabel']) + "</span>");
                                if ($infoPanel.is(':hidden')) {
