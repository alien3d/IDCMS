...
namespace Core\Financial\GeneralLedger\Tax\Service;
 ...
 * @version 2 
 * @author hafizan 
 * @package Core\Financial\GeneralLedger\Tax\Service
 * @subpackage GeneralLedger 
 * @link http://www.hafizan.com 
 * @license http://www.gnu.org/copyleft/lesser.html LGPL 
 */
class TaxService extends ConfigClass {
...
* Class Loader  
    ...
    public function getTaxCategory() {
        ...
        if ($this->getVendor() == self::MYSQL) {
         ...
         SELECT      TAXCATEGORYID AS \"taxCategoryId\",
                     TAXCATEGORYDESCRIPTION AS \"taxCategoryDescription\"
         FROM        TAXCATEGORY  
         WHERE       ISACTIVE    =   1
         AND         COMPANYID   =   '" . $this->getCompanyId() . "'
         ORDER BY    ISDEFAULT";
        ...
        if ($result) {
            ...
            while (($row = $this->q->fetchArray($result)) == TRUE) {
                if ($this->getServiceOutput() == 'option') {
                    $str.="<option value='" . $row['taxCategoryId'] . "'>" . $d . ". " . $row['taxCategoryDescription'] . "</option>";
    ...
    /**
     * Return Tax Category Default Value
     * @return int
     * @throws \Exception
     */
    public function getTaxCategoryDefaultValue() {
        //initialize dummy value.. no content header.pure html  
        $sql = null;
        $str = null;
        $taxCategoryId = null;
    ...
    public function getTaxType() {
        ...
        if ($this->getVendor() == self::MYSQL) {
         ...
         ORDER BY    [isDefault]";
            ...
            $sql = " 
         SELECT      TAXTYPEID AS \"taxTypeId\",
                     TAXTYPEDESCRIPTION AS \"taxTypeDescription\"
         FROM        TAXTYPE  
         WHERE       ISACTIVE    =   1
         AND         COMPANYID   =   '" . $this->getCompanyId() . "'
         ORDER BY    ISDEFAULT";
        ...
        if ($result) {
            ...
            while (($row = $this->q->fetchArray($result)) == TRUE) {
                if ($this->getServiceOutput() == 'option') {
                    $str.="<option value='" . $row['taxTypeId'] . "'>" . $d . ". " . $row['taxTypeDescription'] . "</option>";
                } else if ($this->getServiceOutput() == 'html') {
                    $items[] = $row;
                }
                $d++;
    ...
    /**
     * Return Tax Type Default Value
     * @return int
     * @throws \Exception
     */
    public function getTaxTypeDefaultValue() {
        //initialize dummy value.. no content header.pure html  
        $sql = null;
        $str = null;
        $taxTypeId = null;
