...
namespace Core\Financial\GeneralLedger\ChartOfAccount\Service;
 ...
 * @version 2
 * @author hafizan
 * @package Core\Financial\GeneralLedger\ChartOfAccount\Service
 * @subpackage GeneralLedger
 * @link http://www.hafizan.com
 * @license http://www.gnu.org/copyleft/lesser.html LGPL
 */
class ChartOfAccountService extends ConfigClass {
     ...
     * @return int
     */
    public function getChartOfAccountCategoryDefaultValue() {
        //initialize dummy value.. no content header.pure html
        $sql = null;
    ...
    /**
     * Return Chart Of Account Type Default Value
     * @return int
     */
    public function getChartOfAccountTypeDefaultValue() {
        //initialize dummy value.. no content header.pure html
        $sql = null;
