function checkDuplicate(leafId, page, securityToken) {
    var $jobRateTypeCode = $("#jobRateTypeCode");
    if ($jobRateTypeCode.val().length === 0) {
    ...
    $.ajax({
        ...
        url: page,
        data: {
            jobRateTypeCode: $jobRateTypeCode.val(),
            method: 'duplicate',
        ...
        success: function(data) {
            ...
            if (success === true) {
                if (total !== 0) {
                    $("#jobRateTypeCode").val('').focus();
                    $("#jobRateTypeCodeForm").removeClass().addClass("form-group has-error");
                ...
                $("#jobRateTypeForm").removeClass().addClass("form-group has-error");
            }
            if ($infoPanel.is(':hidden')) {
                $infoPanel.show();
            }
...
function showFormUpdate(leafId, url, urlList, securityToken, jobRateTypeId, updateAccess, deleteAccess) {
    sleep(500);
...
function showModalDelete(jobRateTypeId, jobRateTypeCode, jobRateTypeMultiplier, jobRateTypeDescription) {
    $('#jobRateTypeIdPreview').val('').val(decodeURIComponent(jobRateTypeId));
    $('#jobRateTypeCodePreview').val('').val(decodeURIComponent(jobRateTypeCode));
    $('#jobRateTypeMultiplierPreview').val('').val(decodeURIComponent(jobRateTypeMultiplier));
    $('#jobRateTypeDescriptionPreview').val('').val(decodeURIComponent(jobRateTypeDescription));
...
function deleteGridRecord(leafId, url, urlList, securityToken) {
    $.ajax({
        ...
        data: {
            method: 'delete',
            output: 'json',
            jobRateTypeId: $('#jobRateTypeIdPreview').val(),
            securityToken: securityToken,
            leafId: leafId
        },
        beforeSend: function() {
...
function deleteGridRecordCheckbox(leafId, url, urlList, securityToken) {
    var stringText = '';
    var counter = 0;
    $('input:checkbox[name="jobRateTypeId[]"]').each(function() {
        stringText = stringText + "&jobRateTypeId[]=" + $(this).val();
    });
...
function newRecord(leafId, url, urlList, securityToken, type, createAccess, updateAccess, deleteAccess) {
    ...
    var $jobRateTypeCode = $('#jobRateTypeCode');
    var $jobRateTypeMultiplier = $('#jobRateTypeMultiplier');
    var $jobRateTypeDescription = $('#jobRateTypeDescription');
    if (css.search('disabled') > 0) {
        return false;
    } else {
        if (type === 1) {
            if ($jobRateTypeCode.val().length === 0) {
                $('#jobRateTypeCodeHelpMe').html('').empty().html("<span class='label label-important'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['jobRateTypeCodeLabel'] + " </span>");
                $('#jobRateTypeCodeForm').removeClass().addClass('form-group has-error');
                $jobRateTypeCode.focus();
                return false;
            }
            if ($jobRateTypeMultiplier.val().length === 0) {
                $('#jobRateTypeMultiplierHelpMe').html('').empty().html("<span class='label label-important'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['jobRateTypeMultiplierLabel'] + " </span>");
                $('#jobRateTypeMultiplierForm').removeClass().addClass('form-group has-error');
                $jobRateTypeMultiplier.focus();
                return false;
            }
            if ($jobRateTypeDescription.val().length === 0) {
                $('#jobRateTypeDescriptionHelpMe').html('').empty().html("<span class='label label-important'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['jobRateTypeDescriptionLabel'] + " </span>");
                $('#jobRateTypeDescriptionForm').removeClass().addClass('form-group has-error');
                $jobRateTypeDescription.focus();
                return false;
            }
            $.ajax({
                type: 'POST',
                ...
                data: {
                    ...
                    output: 'json',
                    jobRateTypeCode: $jobRateTypeCode.val(),
                    jobRateTypeMultiplier: $jobRateTypeMultiplier.val(),
                    jobRateTypeDescription: $jobRateTypeDescription.val(),
                    securityToken: securityToken,
                    leafId: leafId
                },
                beforeSend: function() {
                ...
                success: function(data) {
                    ...
                    if (success === true) {
                        ...
                        $jobRateTypeCode.val('');
                        $('#jobRateTypeCodeHelpMe').html('').empty();
                        $jobRateTypeMultiplier.val('');
                        $('#jobRateTypeMultiplierHelpMe').html('').empty();
                        $jobRateTypeDescription.val('');
                        $('#jobRateTypeDescriptionForm').removeClass().addClass('form-group');
                        $('#jobRateTypeDescriptionHelpMe').html('').empty();
                    } else if (success === false) {
                        $infoPanel.html('').empty().html("<span class='label label-important'>&nbsp;" + message + "</span>");
                        if ($infoPanel.is(':hidden')) {
                            $infoPanel.show();
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (success === true) {
                        ...
                        $('#jobRateTypeId').val(data.jobRateTypeId);
                        $('#newRecordButton1').removeClass().addClass('btn btn-success disabled').attr('onClick', '');
                        $('#newRecordButton2').removeClass().addClass('btn dropdown-toggle btn-success disabled');
                        $('#newRecordButton3').attr('onClick', '');
                        $('#newRecordButton4').attr('onClick', '');
...
function resetRecord(leafId, url, urlList, securityToken, createAccess, updateAccess, deleteAccess) {
    ...
    $("#jobRateTypeCode").val('');
    $("#jobRateTypeCodeHelpMe").empty().html('');
    $("#jobRateTypeMultiplier").val('');
    $("#jobRateTypeMultiplierHelpMe").empty().html('');
    $("#jobRateTypeDescription").val('');
    $("#jobRateTypeDescriptionHelpMe").empty().html('');
    $('#jobRateTypeDescription').empty().val('');
}
function postRecord() {
                ...
                if (success === true) {
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            if (success === true) {
                                $('#jobRateTypeId').val(data.data.jobRateTypeId);
                                $('#jobRateTypeCode').val(data.data.jobRateTypeCode);
                                $('#jobRateTypeMultiplier').val(data.data.jobRateTypeMultiplier);
                                $('#jobRateTypeDescription').val(data.data.jobRateTypeDescription);
                                if (nextRecord > 0) {
                                    $('#previousRecordButton').removeClass().addClass('btn btn-default disabled').attr('onClick', '');
    ...
    if (css.search('disabled') > 0) {
        ...
        if (parseFloat($previousRecordCounter.val()) > 0 && parseFloat($previousRecordCounter.val()) < parseFloat($('#lastRecordCounter').val())) {
            $.ajax({
                ...
                data: {
                    method: 'read',
                    jobRateTypeId: $previousRecordCounter.val(),
                    output: 'json',
                    securityToken: securityToken,
                    leafId: leafId
                },
    ...
    if (css.search('disabled') > 0) {
        ...
        if (parseFloat($nextRecordCounter.val()) <= parseFloat($('#lastRecordCounter').val())) {
            $.ajax({
                ...
                data: {
                    method: 'read',
                    jobRateTypeId: $nextRecordCounter.val(),
                    output: 'json',
                    securityToken: securityToken,
                    leafId: leafId
                },
