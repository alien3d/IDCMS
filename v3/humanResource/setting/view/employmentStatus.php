...
require_once($newFakeDocumentRoot . "v3/humanResource/setting/controller/employmentStatusController.php");
...
$translator->setCurrentTable('employmentStatus');
...
if (isset($_POST)) {
    if (isset($_POST['method'])) {
        $employmentStatus = new \Core\HumanResource\Setting\EmploymentStatus\Controller\EmploymentStatusClass();
        define('LIMIT', 10);
        ...
        if (isset($_POST ['query'])) {
            $employmentStatus->setFieldQuery($_POST ['query']);
        }
        if (isset($_POST ['filter'])) {
            $employmentStatus->setGridQuery($_POST ['filter']);
        }
        if (isset($_POST ['character'])) {
            $employmentStatus->setCharacterQuery($_POST['character']);
        }
        if (isset($_POST ['dateRangeStart'])) {
            $employmentStatus->setDateRangeStartQuery($_POST['dateRangeStart']);
            //explode the data to get day,month,year
            $start = explode('-', $_POST ['dateRangeStart']);
            $employmentStatus->setStartDay($start[2]);
            $employmentStatus->setStartMonth($start[1]);
            $employmentStatus->setStartYear($start[0]);
        }
        if (isset($_POST ['dateRangeEnd']) && (strlen($_POST['dateRangeEnd']) > 0)) {
            $employmentStatus->setDateRangeEndQuery($_POST['dateRangeEnd']);
            //explode the data to get day,month,year
            $start = explode('-', $_POST ['dateRangeEnd']);
            $employmentStatus->setEndDay($start[2]);
            $employmentStatus->setEndMonth($start[1]);
            $employmentStatus->setEndYear($start[0]);
        }
        if (isset($_POST ['dateRangeType'])) {
            $employmentStatus->setDateRangeTypeQuery($_POST['dateRangeType']);
        }
        if (isset($_POST ['dateRangeExtraType'])) {
            $employmentStatus->setDateRangeExtraTypeQuery($_POST['dateRangeExtraType']);
        }
        $employmentStatus->setServiceOutput('html');
        $employmentStatus->setLeafId($leafId);
        $employmentStatus->execute();
        if ($_POST['method'] == 'read') {
            $employmentStatus->setStart($offset);
            $employmentStatus->setLimit($limit); // normal system don't like paging..
            $employmentStatus->setPageOutput('html');
            $employmentStatusArray = $employmentStatus->read();
            if (isset($employmentStatusArray [0]['firstRecord'])) {
                $firstRecord = $employmentStatusArray [0]['firstRecord'];
            }
            if (isset($employmentStatusArray [0]['nextRecord'])) {
                $nextRecord = $employmentStatusArray [0]['nextRecord'];
            }
            if (isset($employmentStatusArray [0]['previousRecord'])) {
                $previousRecord = $employmentStatusArray [0]['previousRecord'];
            }
            if (isset($employmentStatusArray [0]['lastRecord'])) {
                $lastRecord = $employmentStatusArray [0]['lastRecord'];
                $endRecord = $employmentStatusArray [0]['lastRecord'];
            }
            $navigation = new \Core\Paging\HtmlPaging();
            $navigation->setLeafId($leafId);
            $navigation->setViewPath($employmentStatus->getViewPath());
            ...
            if (isset($employmentStatusArray [0]['total'])) {
                $total = $employmentStatusArray [0]['total'];
            } else {
                $total = 0;
            }
            ...
            <div class="row">
                <div class="pull-left btn-group col-xs-10 col-sm-10 col-md-10">
                    <button title="A" class="btn btn-success btn-sm" type="button" 
                            ...
                            echo $employmentStatus->getViewPath();
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu" style="text-align:left">
                                <li>
                                    ...
                                    echo $employmentStatus->getControllerPath();
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form class="form-horizontal">
                                        <input type="hidden" name="employmentStatusIdPreview" id="employmentStatusIdPreview">

                                        <div class="form-group" id="employmentStatusCodeDiv">
                                            <label for="employmentStatusCodePreview"
                                                   class="control-label col-xs-4 col-sm-4 col-md-4"><?php echo $leafTranslation['employmentStatusCodeLabel']; ?></label>

                                            <div class="col-xs-8 col-sm-8 col-md-8">
                                                <input class="form-control" type="text" name="employmentStatusCodePreview"
                                                       id="employmentStatusCodePreview">
                                            </div>
                                        </div>
                                        <div class="form-group" id="employmentStatusDescriptionDiv">
                                            <label for="employmentStatusDescriptionPreview"
                                                   class="control-label col-xs-4 col-sm-4 col-md-4"><?php echo $leafTranslation['employmentStatusDescriptionLabel']; ?></label>

                                            <div class="col-xs-8 col-sm-8 col-md-8">
                                                <input class="form-control" type="text"
                                                       name="employmentStatusDescriptionPreview"
                                                       id="employmentStatusDescriptionPreview">
                                            </div>
                                        </div>
                                        <div class="form-group" id="isPaidSalaryDiv">
                                            <label for="isPaidSalaryPreview"
                                                   class="control-label col-xs-4 col-sm-4 col-md-4"><?php echo $leafTranslation['isPaidSalaryLabel']; ?></label>

                                            <div class="col-xs-8 col-sm-8 col-md-8">
                                                <input class="form-control" type="text" name="isPaidSalaryPreview"
                                                       id="isPaidSalaryPreview">
                                            </div>
                                        </div>
                                    </form>
                                </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="panel panel-default">
                                <table class="table table table-bordered table-striped table-condensed table-hover smart-form has-tickbox" id="tableData">
                                    ...
                                    <th width="75px">
                                    <div align="center"><?php echo ucwords($leafTranslation['employmentStatusCodeLabel']); ?></div>
                                    </th>
                                    <th><?php echo ucwords($leafTranslation['employmentStatusDescriptionLabel']); ?></th>
                                    <th width="75px" align="center">
                                    <div align="center"><?php echo ucwords($leafTranslation['isPaidSalaryLabel']); ?></div>
                                    </th>
                                    <th width="100px">
                                            ...
                                            if (is_array($employmentStatusArray)) {
                                                ...
                                                if ($totalRecord > 0) {
                                                    ...
                                                    for ($i = 0; $i < $totalRecord; $i++) {
                                                        ...
                                                        ?>
                                                        <tr <?php
                                                        if ($employmentStatusArray[$i]['isDelete'] == 1) {
                                                            echo "class=\"danger\"";
                                                        } else {
                                                            if ($employmentStatusArray[$i]['isDraft'] == 1) {
                                                                echo "class=\"warning\"";
                                                            }
                                                        }
                                                        ?>>
                                                            ...
                                                            <td align="center">
                                                                <div class="btn-group" align="center">
                                                                    <button type="button"  class="btn btn-info btn-sm" title="Edit"
                                                                            ...
                                                                            echo intval(
                                                                                    $employmentStatusArray [$i]['employmentStatusId']
                                                                            );
                                                                    ...
                                                                    <button type="button"  class="btn btn-danger btn-sm" title="Delete"
                                                                            ...
                                                                            ?>', '<?php
                                                                            echo rawurlencode(
                                                                                    $employmentStatusArray [$i]['employmentStatusCode']
                                                                            );
                                                                            ?>', '<?php
                                                                            echo rawurlencode(
                                                                                    $employmentStatusArray [$i]['employmentStatusDescription']
                                                                            );
                                                                            ?>', '<?php
                                                                            echo rawurlencode(
                                                            ...
                                                            <td>
                                                                <div align="center">
                                                                    <?php
                                                                    if (isset($employmentStatusArray[$i]['employmentStatusCode'])) {
                                                                        if (isset($_POST['query']) || isset($_POST['character'])) {
                                                                            if (isset($_POST['query']) && strlen($_POST['query']) > 0) {
                                                                                if (strpos(
                                                                                                strtolower($employmentStatusArray[$i]['employmentStatusCode']), strtolower($_POST['query'])
                                                                                        ) !== false
                                                                                ) {
                                                                                    echo str_replace(
                                                                                            $_POST['query'], "<span class=\"label label-info\">" . $_POST['query'] . "</span>", $employmentStatusArray[$i]['employmentStatusCode']
                                                                                    );
                                                                                } else {
                                                                                    echo $employmentStatusArray[$i]['employmentStatusCode'];
                                                                                }
                                                                            } else {
                                                                                if (isset($_POST['character']) && strlen($_POST['character']) > 0) {
                                                                                    if (strpos(
                                                                                                    strtolower($employmentStatusArray[$i]['employmentStatusCode']), strtolower($_POST['character'])
                                                                                            ) !== false
                                                                                    ) {
                                                                                        echo str_replace(
                                                                                                $_POST['character'], "<span class=\"label label-info\">" . $_POST['character'] . "</span>", $employmentStatusArray[$i]['employmentStatusCode']
                                                                                        );
                                                                                    } else {
                                                                                        echo $employmentStatusArray[$i]['employmentStatusCode'];
                                                                                    }
                                                            ...
                                                            <td>
                                                                <div class="pull-left">
                                                                    <?php
                                                                    if (isset($employmentStatusArray[$i]['employmentStatusDescription'])) {
                                                                        if (isset($_POST['query']) || isset($_POST['character'])) {
                                                                            if (isset($_POST['query']) && strlen($_POST['query']) > 0) {
                                                                                if (strpos(
                                                                                                strtolower(
                                                                                    ...
                                                                                    echo str_replace(
                                                                                            $_POST['query'], "<span class=\"label label-info\">" . $_POST['query'] . "</span>", $employmentStatusArray[$i]['employmentStatusDescription']
                                                                                    );
                                                                                } else {
                                                                                    echo $employmentStatusArray[$i]['employmentStatusDescription'];
                                                                                }
                                                                            } else {
                                                                                if (isset($_POST['character']) && strlen($_POST['character']) > 0) {
                                                                                    if (strpos(
                                                                                        ...
                                                                                        echo str_replace(
                                                                                                $_POST['character'], "<span class=\"label label-info\">" . $_POST['character'] . "</span>", $employmentStatusArray[$i]['employmentStatusDescription']
                                                                                        );
                                                                                    } else {
                                                                                        echo $employmentStatusArray[$i]['employmentStatusDescription'];
                                                                                    }
                                                            ...
                                                            <td>
                                                                <div align="center">
                                                                    <?php
                                                                    if (isset($employmentStatusArray[$i]['isPaidSalary'])) {
                                                                        if (isset($_POST['query']) || isset($_POST['character'])) {
                                                                            if (isset($_POST['query']) && strlen($_POST['query']) > 0) {
                                                                                if (strpos(
                                                                                                strtolower($employmentStatusArray[$i]['isPaidSalary']), strtolower($_POST['query'])
                                                                                        ) !== false
                                                                                ) {
                                                                                    echo str_replace(
                                                                                            $_POST['query'], "<span class=\"label label-info\">" . $_POST['query'] . "</span>", $employmentStatusArray[$i]['isPaidSalary']
                                                                                    );
                                                                                } else {
                                                                                    echo $employmentStatusArray[$i]['isPaidSalary'];
                                                                                }
                                                                            } else {
                                                                                if (isset($_POST['character']) && strlen($_POST['character']) > 0) {
                                                                                    if (strpos(
                                                                                                    strtolower($employmentStatusArray[$i]['isPaidSalary']), strtolower($_POST['character'])
                                                                                            ) !== false
                                                                                    ) {
                                                                                        echo str_replace(
                                                                                                $_POST['character'], "<span class=\"label label-info\">" . $_POST['character'] . "</span>", $employmentStatusArray[$i]['isPaidSalary']
                                                                                        );
                                                                                    } else {
                                                                                        echo $employmentStatusArray[$i]['isPaidSalary'];
                                                                                    }
                                                                                } else {
                                                                                    if ($employmentStatusArray[$i]['isPaidSalary'] == 1) {
                                                            ...
                                                            <td>
                                                                <div align="center">
                                                                    <?php
                                                                    if (isset($employmentStatusArray[$i]['executeBy'])) {
                                                                        if (isset($_POST['query']) || isset($_POST['character'])) {
                                                                            if (isset($_POST['query']) && strlen($_POST['query']) > 0) {
                                                                                if (strpos(
                                                                                                $employmentStatusArray[$i]['staffName'], $_POST['query']
                                                                                        ) !== false
                                                                                ) {
                                                                                    echo str_replace(
                                                                                            $_POST['query'], "<span class=\"label label-info\">" . $_POST['query'] . "</span>", $employmentStatusArray[$i]['staffName']
                                                                                    );
                                                                                } else {
                                                                                    echo $employmentStatusArray[$i]['staffName'];
                                                                                }
                                                                            } else {
                                                                                if (isset($_POST['character']) && strlen($_POST['character']) > 0) {
                                                                                    if (strpos(
                                                                                                    $employmentStatusArray[$i]['staffName'], $_POST['character']
                                                                                            ) !== false
                                                                                    ) {
                                                                                        echo str_replace(
                                                                                                $_POST['character'], "<span class=\"label label-info\">" . $_POST['character'] . "</span>", $employmentStatusArray[$i]['staffName']
                                                                                        );
                                                                                    } else {
                                                                                        echo $employmentStatusArray[$i]['staffName'];
                                                                                    }
                                                            ...
                                                            <?php
                                                            if (isset($employmentStatusArray[$i]['executeTime'])) {
                                                                $valueArray = $employmentStatusArray[$i]['executeTime'];
                                                            ...
                                                            <?php } ?>
                                                            <?php
                                                            if ($employmentStatusArray[$i]['isDelete']) {
                                                                $checked = "checked";
                                                            } else {
                                                                $checked = null;
                                                            }
                                                            ?>
                                                            <td>
                                                                <input style="display:none;" type="checkbox" name="employmentStatusId[]"
                                                                       value="<?php echo $employmentStatusArray[$i]['employmentStatusId']; ?>">
                                                                <input <?php echo $checked; ?> type="checkbox" name="isDelete[]"
                                                                                               value="<?php echo $employmentStatusArray[$i]['isDelete']; ?>">
                                                            </td>
                                                        </tr>
                                                        <?php
                                                    }
                                                    ...
                                                    <tr>
                                                        <td colspan="7" vAlign="top" align="center"><?php
                                                            $employmentStatus->exceptionMessage(
                        ...
                        <div class="col-xs-3 col-sm-3 col-md-3 pagination">
                            <div class="pull-right">
                                <button class="delete btn btn-warning" type="button" 
                                        ...
                                        echo $employmentStatus->getControllerPath();
                                        ?>', '<?php echo $employmentStatus->getViewPath(); ?>', '<?php echo $securityToken; ?>');">
...
if ((isset($_POST['method']) == 'new' || isset($_POST['method']) == 'read') && $_POST['type'] == 'form') {
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            <input type="hidden" name="employmentStatusId" id="employmentStatusId" value="<?php
                            if (isset($_POST['employmentStatusId'])) {
                                echo $_POST['employmentStatusId'];
                            }
                            ?>">

                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="col-xs-6 col-sm-6 col-md-6 form-group" id="employmentStatusCodeForm">
                                        <label for="employmentStatusCode" class="control-label col-xs-4 col-sm-4 col-md-4"><strong><?php
                                                echo ucfirst(
                                                        $leafTranslation['employmentStatusCodeLabel']
                                                );
                                                ?></strong></label>

                                        <div class="col-xs-8 col-sm-8 col-md-8">
                                            <input type="text" class="form-control" name="employmentStatusCode"
                                                   id="employmentStatusCode" onKeyUp="removeMeError('employmentStatusCode');"
                                                   value="<?php
                                                   if (isset($employmentStatusArray) && is_array($employmentStatusArray)) {
                                                       if (isset($employmentStatusArray[0]['employmentStatusCode'])) {
                                                           echo htmlentities($employmentStatusArray[0]['employmentStatusCode']);
                                                       }
                                                   }
                                                   ?>" maxlength="16"> <span class="help-block"
                                                   id="employmentStatusCodeHelpMe"></span>
                                        </div>
                                    </div>
                                    <div class="col-xs-6 col-sm-6 col-md-6 form-group" id="isPaidSalaryForm">
                                        <label for="isPaidSalary" class="control-label col-xs-4 col-sm-4 col-md-4"><strong><?php
                                                echo ucfirst(
                                                        $leafTranslation['isPaidSalaryLabel']
                                                );
                                                ?></strong></label>

                                        <div class="col-xs-8 col-sm-8 col-md-8">
                                            <div id="isCloseSwitch" class="switch" data-on-label="<?php echo $t['yesTextLabel']; ?>"
                                                 data-off-label="<?php echo $t['noTextLabel']; ?>" data-on="success"
                                                 data-off="danger">
                                                <input type="checkbox" name="isPaidSalary" id="isPaidSalary"
                                                       class="form-control" value="<?php
                                                       if (isset($employmentStatusArray) && is_array($employmentStatusArray)) {
                                                           if (isset($employmentStatusArray[0]['isPaidSalary'])) {
                                                               echo $employmentStatusArray[0]['isPaidSalary'];
                                                           }
                                                       }
                                                       ?>"></div>
                                            <span class="help-block" id="isPaidSalaryHelpMe"></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group" id="employmentStatusDescriptionForm">
                                        <div class="col-xs-12 col-sm-12 col-md-12">
                                            <textarea class="form-control" name="employmentStatusDescription"
                                                      id="employmentStatusDescription"><?php
                                                          if (isset($employmentStatusArray[0]['employmentStatusDescription'])) {
                                                              echo htmlentities($employmentStatusArray[0]['employmentStatusDescription']);
                                                          }
                                                          ?></textarea> <span class="help-block"
                                                              id="employmentStatusDescriptionHelpMe"></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <?php if ($leafAccess['leafAccessCreateValue'] == 1) { ?>
                            newRecord(<?php echo $leafId; ?>, '<?php echo $employmentStatus->getControllerPath(); ?>', '<?php echo $employmentStatus->getViewPath(); ?>', '<?php echo $securityToken; ?>', 1);
    <?php } ?>
                        return false;
                    }
                    // shift+s save event
    ...
    <?php if ($leafAccess['leafAccessUpdateValue'] == 1) { ?>
                            updateRecord(<?php echo $leafId; ?>, '<?php echo $employmentStatus->getControllerPath(); ?>', '<?php echo $employmentStatus->getViewPath(); ?>', '<?php echo $securityToken; ?>', 1, <?php echo $leafAccess['leafAccessDeleteValue']; ?>);
    <?php } ?>
                        return false;
                    }
    ...
    <?php if ($leafAccess['leafAccessDeleteValue'] == 1) { ?>
                            deleteRecord(<?php echo $leafId; ?>, '<?php echo $employmentStatus->getControllerPath(); ?>', '<?php echo $employmentStatus->getViewPath(); ?>', '<?php echo $securityToken; ?>', <?php echo $leafAccess['leafAccessDeleteValue']; ?>);
    ...
    <?php } ?>
                    ...
                    switch (e.keyCode) {
                        case 37:
                            previousRecord(<?php echo $leafId; ?>, '<?php echo $employmentStatus->getControllerPath(); ?>', '<?php echo $employmentStatus->getViewPath(); ?>', '<?php echo $securityToken; ?>', <?php echo $leafAccess['leafAccessUpdateValue']; ?>, <?php echo $leafAccess['leafAccessDeleteValue']; ?>);
                            
                            return false;
                            break;
                        case 39:
                            nextRecord(<?php echo $leafId; ?>, '<?php echo $employmentStatus->getControllerPath(); ?>', '<?php echo $employmentStatus->getViewPath(); ?>', '<?php echo $securityToken; ?>', <?php echo $leafAccess['leafAccessUpdateValue']; ?>, <?php echo $leafAccess['leafAccessDeleteValue']; ?>);
                ...
                $(document).ready(function() {
                    ...
                    validateMeAlphaNumeric('employmentStatusCode');
                    validateMeNumeric('isPaidSalary');
    <?php if ($_POST['method'] == "new") { ?>
                        $('#resetRecordButton').removeClass().addClass('btn btn-default');
        <?php if ($leafAccess['leafAccessCreateValue'] == 1) { ?>
                            $('#newRecordButton1').removeClass().addClass('btn btn-success').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $employmentStatus->getControllerPath(); ?>','<?php echo $employmentStatus->getViewPath(); ?>','<?php echo $securityToken; ?>',1)");
                            $('#newRecordButton2').removeClass().addClass('btn dropdown-toggle btn-success');
                            $('#newRecordButton3').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $employmentStatus->getControllerPath(); ?>','<?php echo $employmentStatus->getViewPath(); ?>','<?php echo $securityToken; ?>',1)");
                            $('#newRecordButton4').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $employmentStatus->getControllerPath(); ?>','<?php echo $employmentStatus->getViewPath(); ?>','<?php echo $securityToken; ?>',2)");
                            $('#newRecordButton5').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $employmentStatus->getControllerPath(); ?>','<?php echo $employmentStatus->getViewPath(); ?>','<?php echo $securityToken; ?>',3)");
                            $('#newRecordButton6').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $employmentStatus->getControllerPath(); ?>','<?php echo $employmentStatus->getViewPath(); ?>','<?php echo $securityToken; ?>',4)");
                            $('#newRecordButton7').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $employmentStatus->getControllerPath(); ?>','<?php echo $employmentStatus->getViewPath(); ?>','<?php echo $securityToken; ?>',5)");
        <?php } else { ?>
        ...
        if ($_POST['employmentStatusId']) {
            ...
            <?php if ($leafAccess['leafAccessUpdateValue'] == 1) { ?>
                                $('#updateRecordButton1').removeClass().addClass('btn btn-info').attr('onClick', "updateRecord(<?php echo $leafId; ?>,'<?php echo $employmentStatus->getControllerPath(); ?>','<?php echo $employmentStatus->getViewPath(); ?>','<?php echo $securityToken; ?>',1,<?php echo $leafAccess['leafAccessDeleteValue']; ?>);");
                                $('#updateRecordButton2').removeClass().addClass('btn dropdown-toggle btn-info');
                                $('#updateRecordButton3').attr('onClick', "updateRecord(<?php echo $leafId; ?>,'<?php echo $employmentStatus->getControllerPath(); ?>','<?php echo $employmentStatus->getViewPath(); ?>','<?php echo $securityToken; ?>',1,<?php echo $leafAccess['leafAccessDeleteValue']; ?>);");
                                $('#updateRecordButton4').attr('onClick', "updateRecord(<?php echo $leafId; ?>,'<?php echo $employmentStatus->getControllerPath(); ?>','<?php echo $employmentStatus->getViewPath(); ?>','<?php echo $securityToken; ?>',2,<?php echo $leafAccess['leafAccessDeleteValue']; ?>);");
                                $('#updateRecordButton5').attr('onClick', "updateRecord(<?php echo $leafId; ?>,'<?php echo $employmentStatus->getControllerPath(); ?>','<?php echo $employmentStatus->getViewPath(); ?>','<?php echo $securityToken; ?>',3,<?php echo $leafAccess['leafAccessDeleteValue']; ?>);");
            <?php } else { ?>
                                $('#updateRecordButton1').removeClass().addClass(' btn btn-info disabled').attr('onClick', '');
                                $('#updateRecordButton2').removeClass().addClass('btn dropdown-toggle btn-info disabled');
                                $('#updateRecordButton3').attr('onClick', '');
            ...
            <?php } ?>
            <?php if ($leafAccess['leafAccessDeleteValue'] == 1) { ?>
                                $('#deleteRecordButton').removeClass().addClass('btn btn-danger').attr('onClick', "deleteRecord(<?php echo $leafId; ?>,'<?php echo $employmentStatus->getControllerPath(); ?>','<?php echo $employmentStatus->getViewPath(); ?>','<?php echo $securityToken; ?>',<?php echo $leafAccess['leafAccessDeleteValue']; ?>);");
            <?php } else { ?>
                                $('#deleteRecordButton').removeClass().addClass('btn btn-danger disabled').attr('onClick', '');
            <?php } ?>
            <?php
...
<?php } ?>
<script type="text/javascript" src="./v3/humanResource/setting/javascript/employmentStatus.js"></script>
<hr>
