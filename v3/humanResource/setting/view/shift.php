...
require_once($newFakeDocumentRoot . "v3/humanResource/setting/controller/shiftController.php");
...
$translator->setCurrentTable('shift');
...
if (isset($_POST)) {
    if (isset($_POST['method'])) {
        $shift = new \Core\HumanResource\Setting\Shift\Controller\ShiftClass();
        define('LIMIT', 10);
        ...
        if (isset($_POST ['query'])) {
            $shift->setFieldQuery($_POST ['query']);
        }
        if (isset($_POST ['filter'])) {
            $shift->setGridQuery($_POST ['filter']);
        }
        if (isset($_POST ['character'])) {
            $shift->setCharacterQuery($_POST['character']);
        }
        if (isset($_POST ['dateRangeStart'])) {
            $shift->setDateRangeStartQuery($_POST['dateRangeStart']);
            //explode the data to get day,month,year
            $start = explode('-', $_POST ['dateRangeStart']);
            $shift->setStartDay($start[2]);
            $shift->setStartMonth($start[1]);
            $shift->setStartYear($start[0]);
        }
        if (isset($_POST ['dateRangeEnd']) && (strlen($_POST['dateRangeEnd']) > 0)) {
            $shift->setDateRangeEndQuery($_POST['dateRangeEnd']);
            //explode the data to get day,month,year
            $start = explode('-', $_POST ['dateRangeEnd']);
            $shift->setEndDay($start[2]);
            $shift->setEndMonth($start[1]);
            $shift->setEndYear($start[0]);
        }
        if (isset($_POST ['dateRangeType'])) {
            $shift->setDateRangeTypeQuery($_POST['dateRangeType']);
        }
        if (isset($_POST ['dateRangeExtraType'])) {
            $shift->setDateRangeExtraTypeQuery($_POST['dateRangeExtraType']);
        }
        $shift->setServiceOutput('html');
        $shift->setLeafId($leafId);
        $shift->execute();
        if ($_POST['method'] == 'read') {
            $shift->setStart($offset);
            $shift->setLimit($limit); // normal system don't like paging..
            $shift->setPageOutput('html');
            $shiftArray = $shift->read();
            if (isset($shiftArray [0]['firstRecord'])) {
                $firstRecord = $shiftArray [0]['firstRecord'];
            }
            if (isset($shiftArray [0]['nextRecord'])) {
                $nextRecord = $shiftArray [0]['nextRecord'];
            }
            if (isset($shiftArray [0]['previousRecord'])) {
                $previousRecord = $shiftArray [0]['previousRecord'];
            }
            if (isset($shiftArray [0]['lastRecord'])) {
                $lastRecord = $shiftArray [0]['lastRecord'];
                $endRecord = $shiftArray [0]['lastRecord'];
            }
            $navigation = new \Core\Paging\HtmlPaging();
            $navigation->setLeafId($leafId);
            $navigation->setViewPath($shift->getViewPath());
            ...
            if (isset($shiftArray [0]['total'])) {
                $total = $shiftArray [0]['total'];
            } else {
                $total = 0;
            }
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form class="form-horizontal">
                                        <input type="hidden" name="shiftIdPreview" id="shiftIdPreview">

                                        <div class="form-group" id="shiftNameDiv">
                                            <label for="shiftNamePreview"
                                                   class="control-label col-xs-4 col-sm-4 col-md-4"><?php echo $leafTranslation['shiftNameLabel']; ?></label>

                                            <div class="col-xs-8 col-sm-8 col-md-8">
                                                <input class="form-control" type="text" name="shiftNamePreview"
                                                       id="shiftNamePreview">
                                            </div>
                                        </div>
                                        <div class="form-group" id="shiftCodeDiv">
                                            <label for="shiftCodePreview"
                                                   class="control-label col-xs-4 col-sm-4 col-md-4"><?php echo $leafTranslation['shiftCodeLabel']; ?></label>

                                            <div class="col-xs-8 col-sm-8 col-md-8">
                                                <input class="form-control" type="text" name="shiftCodePreview"
                                                       id="shiftCodePreview">
                                            </div>
                                        </div>
                                        <div class="form-group" id="shiftStartTimeDiv">
                                            <label for="shiftStartTimePreview"
                                                   class="control-label col-xs-4 col-sm-4 col-md-4"><?php echo $leafTranslation['shiftStartTimeLabel']; ?></label>

                                            <div class="col-xs-8 col-sm-8 col-md-8">
                                                <input class="form-control" type="text" name="shiftStartTimePreview"
                                                       id="shiftStartTimePreview">
                                            </div>
                                        </div>
                                        <div class="form-group" id="shiftEndTimeDiv">
                                            <label for="shiftEndTimePreview"
                                                   class="control-label col-xs-4 col-sm-4 col-md-4"><?php echo $leafTranslation['shiftEndTimeLabel']; ?></label>

                                            <div class="col-xs-8 col-sm-8 col-md-8">
                                                <input class="form-control" type="text" name="shiftEndTimePreview"
                                                       id="shiftEndTimePreview">
                                            </div>
                                        </div>
                                        <div class="form-group" id="shiftDescriptionDiv">
                                            <label for="shiftDescriptionPreview"
                                                   class="control-label col-xs-4 col-sm-4 col-md-4"><?php echo $leafTranslation['shiftDescriptionLabel']; ?></label>

                                            <div class="col-xs-8 col-sm-8 col-md-8">
                                                <input class="form-control" type="text" name="shiftDescriptionPreview"
                                                       id="shiftDescriptionPreview">
                                            </div>
                                        </div>
                                    </form>
                                </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="panel panel-default">
                                <table class="table table table-bordered table-striped table-condensed table-hover smart-form has-tickbox" id="tableData">
                                    ...
                                    <th width="100px"><?php echo ucwords($leafTranslation['shiftNameLabel']); ?></th>
                                    <th width="75px">
                                    <div align="center"><?php echo ucwords($leafTranslation['shiftCodeLabel']); ?></div>
                                    </th>
                                    <th width="75px">
                                    <div align="center"><?php echo ucwords($leafTranslation['shiftStartTimeLabel']); ?></div>
                                    </th>
                                    <th width="75px">
                                    <div align="center"><?php echo ucwords($leafTranslation['shiftEndTimeLabel']); ?></div>
                                    </th>
                                    <th><?php echo ucwords($leafTranslation['shiftDescriptionLabel']); ?></th>
                                    <th width="100px">
                                            ...
                                            if (is_array($shiftArray)) {
                                                ...
                                                if ($totalRecord > 0) {
                                                    ...
                                                    for ($i = 0; $i < $totalRecord; $i++) {
                                                        ...
                                                        ?>
                                                        <tr <?php
                                                        if ($shiftArray[$i]['isDelete'] == 1) {
                                                            echo "class=\"danger\"";
                                                        } else {
                                                            if ($shiftArray[$i]['isDraft'] == 1) {
                                                                echo "class=\"warning\"";
                                                            }
                                                        }
                                                        ?>>
                                                            ...
                                                            <td align="center">
                                                                <div class="btn-group" align="center">
                                                                    ...
                                                                    <button type="button"  class="btn btn-danger btn-sm" title="Delete"
                                                                            ...
                                                                            ?>', '<?php
                                                                            echo rawurlencode(
                                                                                    $shiftArray [$i]['shiftName']
                                                                            );
                                                                            ?>', '<?php
                                                                            echo rawurlencode(
                                                                                    $shiftArray [$i]['shiftCode']
                                                                            );
                                                                            ?>', '<?php
                                                                            echo rawurlencode(
                                                                                    $shiftArray [$i]['shiftStartTime']
                                                                            );
                                                                            ?>', '<?php
                                                                            echo rawurlencode(
                                                                                    $shiftArray [$i]['shiftEndTime']
                                                                            );
                                                                            ?>', '<?php echo rawurlencode($shiftArray [$i]['shiftDescription']); ?>');">
                                                            ...
                                                            <td>
                                                                <div class="pull-left">
                                                                    <?php
                                                                    if (isset($shiftArray[$i]['shiftName'])) {
                                                                        if (isset($_POST['query']) || isset($_POST['character'])) {
                                                                            if (isset($_POST['query']) && strlen($_POST['query']) > 0) {
                                                                                if (strpos(
                                                                                                strtolower($shiftArray[$i]['shiftName']), strtolower($_POST['query'])
                                                                                        ) !== false
                                                                                ) {
                                                                                    echo str_replace(
                                                                                            $_POST['query'], "<span class=\"label label-info\">" . $_POST['query'] . "</span>", $shiftArray[$i]['shiftName']
                                                                                    );
                                                                                } else {
                                                                                    echo $shiftArray[$i]['shiftName'];
                                                                                }
                                                                            } else {
                                                                                if (isset($_POST['character']) && strlen($_POST['character']) > 0) {
                                                                                    if (strpos(
                                                                                                    strtolower($shiftArray[$i]['shiftName']), strtolower($_POST['character'])
                                                                                            ) !== false
                                                                                    ) {
                                                                                        echo str_replace(
                                                                                                $_POST['character'], "<span class=\"label label-info\">" . $_POST['character'] . "</span>", $shiftArray[$i]['shiftName']
                                                                                        );
                                                                                    } else {
                                                                                        echo $shiftArray[$i]['shiftName'];
                                                                                    }
                                                            ...
                                                            <td>
                                                                <div align="center">
                                                                    <?php
                                                                    if (isset($shiftArray[$i]['shiftCode'])) {
                                                                        if (isset($_POST['query']) || isset($_POST['character'])) {
                                                                            if (isset($_POST['query']) && strlen($_POST['query']) > 0) {
                                                                                if (strpos(
                                                                                                strtolower($shiftArray[$i]['shiftCode']), strtolower($_POST['query'])
                                                                                        ) !== false
                                                                                ) {
                                                                                    echo str_replace(
                                                                                            $_POST['query'], "<span class=\"label label-info\">" . $_POST['query'] . "</span>", $shiftArray[$i]['shiftCode']
                                                                                    );
                                                                                } else {
                                                                                    echo $shiftArray[$i]['shiftCode'];
                                                                                }
                                                                            } else {
                                                                                if (isset($_POST['character']) && strlen($_POST['character']) > 0) {
                                                                                    if (strpos(
                                                                                                    strtolower($shiftArray[$i]['shiftCode']), strtolower($_POST['character'])
                                                                                            ) !== false
                                                                                    ) {
                                                                                        echo str_replace(
                                                                                                $_POST['character'], "<span class=\"label label-info\">" . $_POST['character'] . "</span>", $shiftArray[$i]['shiftCode']
                                                                                        );
                                                                                    } else {
                                                                                        echo $shiftArray[$i]['shiftCode'];
                                                                                    }
                                                            ...
                                                            <td>
                                                                <div align="center">
                                                                    <?php
                                                                    if (isset($shiftArray[$i]['shiftStartTime'])) {
                                                                        if (isset($_POST['query']) || isset($_POST['character'])) {
                                                                            if (isset($_POST['query']) && strlen($_POST['query']) > 0) {
                                                                                if (strpos(
                                                                                                strtolower($shiftArray[$i]['shiftStartTime']), strtolower($_POST['query'])
                                                                                        ) !== false
                                                                                ) {
                                                                                    echo str_replace(
                                                                                            $_POST['query'], "<span class=\"label label-info\">" . $_POST['query'] . "</span>", $shiftArray[$i]['shiftStartTime']
                                                                                    );
                                                                                } else {
                                                                                    echo $shiftArray[$i]['shiftStartTime'];
                                                                                }
                                                                            } else {
                                                                                if (isset($_POST['character']) && strlen($_POST['character']) > 0) {
                                                                                    if (strpos(
                                                                                                    strtolower($shiftArray[$i]['shiftStartTime']), strtolower($_POST['character'])
                                                                                            ) !== false
                                                                                    ) {
                                                                                        echo str_replace(
                                                                                                $_POST['character'], "<span class=\"label label-info\">" . $_POST['character'] . "</span>", $shiftArray[$i]['shiftStartTime']
                                                                                        );
                                                                                    } else {
                                                                                        echo $shiftArray[$i]['shiftStartTime'];
                                                                                    }
                                                            ...
                                                            <td>
                                                                <div align="center">
                                                                    <?php
                                                                    if (isset($shiftArray[$i]['shiftEndTime'])) {
                                                                        if (isset($_POST['query']) || isset($_POST['character'])) {
                                                                            if (isset($_POST['query']) && strlen($_POST['query']) > 0) {
                                                                                if (strpos(
                                                                                                strtolower($shiftArray[$i]['shiftEndTime']), strtolower($_POST['query'])
                                                                                        ) !== false
                                                                                ) {
                                                                                    echo str_replace(
                                                                                            $_POST['query'], "<span class=\"label label-info\">" . $_POST['query'] . "</span>", $shiftArray[$i]['shiftEndTime']
                                                                                    );
                                                                                } else {
                                                                                    echo $shiftArray[$i]['shiftEndTime'];
                                                                                }
                                                                            } else {
                                                                                if (isset($_POST['character']) && strlen($_POST['character']) > 0) {
                                                                                    if (strpos(
                                                                                                    strtolower($shiftArray[$i]['shiftEndTime']), strtolower($_POST['character'])
                                                                                            ) !== false
                                                                                    ) {
                                                                                        echo str_replace(
                                                                                                $_POST['character'], "<span class=\"label label-info\">" . $_POST['character'] . "</span>", $shiftArray[$i]['shiftEndTime']
                                                                                        );
                                                                                    } else {
                                                                                        echo $shiftArray[$i]['shiftEndTime'];
                                                                                    }
                                                            ...
                                                            <td>
                                                                <div class="pull-left">
                                                                    <?php
                                                                    if (isset($shiftArray[$i]['shiftDescription'])) {
                                                                        if (isset($_POST['query']) || isset($_POST['character'])) {
                                                                            if (isset($_POST['query']) && strlen($_POST['query']) > 0) {
                                                                                if (strpos(
                                                                                                strtolower($shiftArray[$i]['shiftDescription']), strtolower($_POST['query'])
                                                                                        ) !== false
                                                                                ) {
                                                                                    echo str_replace(
                                                                                            $_POST['query'], "<span class=\"label label-info\">" . $_POST['query'] . "</span>", $shiftArray[$i]['shiftDescription']
                                                                                    );
                                                                                } else {
                                                                                    echo $shiftArray[$i]['shiftDescription'];
                                                                                }
                                                                            } else {
                                                                                if (isset($_POST['character']) && strlen($_POST['character']) > 0) {
                                                                                    if (strpos(
                                                                                                    strtolower($shiftArray[$i]['shiftDescription']), strtolower($_POST['character'])
                                                                                            ) !== false
                                                                                    ) {
                                                                                        echo str_replace(
                                                                                                $_POST['character'], "<span class=\"label label-info\">" . $_POST['character'] . "</span>", $shiftArray[$i]['shiftDescription']
                                                                                        );
                                                                                    } else {
                                                                                        echo $shiftArray[$i]['shiftDescription'];
                                                                                    }
                                                            ...
                                                            <td>
                                                                <div align="center">
                                                                    <?php
                                                                    if (isset($shiftArray[$i]['executeBy'])) {
                                                                        if (isset($_POST['query']) || isset($_POST['character'])) {
                                                                            if (isset($_POST['query']) && strlen($_POST['query']) > 0) {
                                                                                if (strpos($shiftArray[$i]['staffName'], $_POST['query']) !== false) {
                                                                                    echo str_replace(
                                                                                            $_POST['query'], "<span class=\"label label-info\">" . $_POST['query'] . "</span>", $shiftArray[$i]['staffName']
                                                                                    );
                                                                                } else {
                                                                                    echo $shiftArray[$i]['staffName'];
                                                                                }
                                                                            } else {
                                                                                if (isset($_POST['character']) && strlen($_POST['character']) > 0) {
                                                                                    if (strpos($shiftArray[$i]['staffName'], $_POST['character']) !== false) {
                                                                                        echo str_replace(
                                                                                                $_POST['character'], "<span class=\"label label-info\">" . $_POST['character'] . "</span>", $shiftArray[$i]['staffName']
                                                                                        );
                                                                                    } else {
                                                                                        echo $shiftArray[$i]['staffName'];
                                                                                    }
                                                            ...
                                                            <?php
                                                            if (isset($shiftArray[$i]['executeTime'])) {
                                                                $valueArray = $shiftArray[$i]['executeTime'];
                                                            ...
                                                            ?>
                                                            <td>
                                                                <input style="display:none;" type="checkbox" name="shiftId[]"
                                                                       value="<?php echo $shiftArray[$i]['shiftId']; ?>">
                                                                <input <?php echo $checked; ?> type="checkbox" name="isDelete[]"
                                                                                               value="<?php echo $shiftArray[$i]['isDelete']; ?>">
                                                            </td>
                                                        </tr>
                                                        <?php
                                                    }
                        ...
                        <div class="col-xs-3 col-sm-3 col-md-3 pagination">
                            <div class="pull-right">
                                <button class="delete btn btn-warning" type="button" 
                                        ...
                                        echo $shift->getControllerPath();
                                        ?>', '<?php echo $shift->getViewPath(); ?>', '<?php echo $securityToken; ?>');">
...
if ((isset($_POST['method']) == 'new' || isset($_POST['method']) == 'read') && $_POST['type'] == 'form') {
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            <input type="hidden" name="shiftId" id="shiftId" value="<?php
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="col-xs-6 col-sm-6 col-md-6 form-group" id="shiftNameForm">
                                        <label for="shiftName" class="control-label col-xs-4 col-sm-4 col-md-4"><strong><?php
                                                echo ucfirst(
                                                        $leafTranslation['shiftNameLabel']
                                                );
                                                ?></strong></label>

                                        <div class="col-xs-8 col-sm-8 col-md-8">
                                            <input type="text" class="form-control" name="shiftName" id="shiftName"
                                                   onKeyUp="removeMeError('shiftName');" value="<?php
                                                   if (isset($shiftArray) && is_array($shiftArray)) {
                                                       if (isset($shiftArray[0]['shiftName'])) {
                                                           if (isset($shiftArray[0]['shiftName'])) {
                                                               echo htmlentities($shiftArray[0]['shiftName']);
                                                           }
                                                       }
                                                   }
                                                   ?>"> <span class="help-block" id="shiftNameHelpMe"></span>
                                        </div>
                                    </div>
                                    <div class="col-xs-6 col-sm-6 col-md-6 form-group" id="shiftCodeForm">
                                        <label for="shiftCode" class="control-label col-xs-4 col-sm-4 col-md-4"><strong><?php
                                                echo ucfirst(
                                                        $leafTranslation['shiftCodeLabel']
                                                );
                                                ?></strong></label>

                                        <div class="col-xs-8 col-sm-8 col-md-8">
                                            <input type="text" class="form-control" name="shiftCode" id="shiftCode"
                                                   onKeyUp="removeMeError('shiftCode');" value="<?php
                                                   if (isset($shiftArray) && is_array($shiftArray)) {
                                                       if (isset($shiftArray[0]['shiftCode'])) {
                                                           echo htmlentities($shiftArray[0]['shiftCode']);
                                                       }
                                                   }
                                                   ?>" maxlength="16"> <span class="help-block" id="shiftCodeHelpMe"></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="col-xs-6 col-sm-6 col-md-6 form-group" id="shiftStartTimeForm">
                                        <label for="shiftStartTime" class="control-label col-xs-4 col-sm-4 col-md-4"><strong><?php
                                                echo ucfirst(
                                                        $leafTranslation['shiftStartTimeLabel']
                                                );
                                                ?></strong></label>

                                        <div class="col-xs-8 col-sm-8 col-md-8">
                                            <div class="input-group bootstrap-timepicker">
                                                <input id="shiftStartTime" name="shiftStartTime" type="text" class="form-control"
                                                       value="<?php
                                                       if (isset($shiftArray) && is_array($shiftArray)) {
                                                           if (isset($shiftArray[0]['shiftStartTime'])) {
                                                               echo htmlentities($shiftArray[0]['shiftStartTime']);
                                                           }
                                                       }
                                                       ?>"> <span class="input-group-addon"><i class="glyphicontime"></i></span>
                                            </div>
                                            <span class="help-block" id="shiftStartTimeHelpMe"></span>
                                        </div>
                                    </div>
                                    <div class="col-xs-6 col-sm-6 col-md-6 form-group" id="shiftEndTimeForm">
                                        <label for="shiftEndTime" class="control-label col-xs-4 col-sm-4 col-md-4"><strong><?php
                                                echo ucfirst(
                                                        $leafTranslation['shiftEndTimeLabel']
                                                );
                                                ?></strong></label>

                                        <div class="col-xs-8 col-sm-8 col-md-8">
                                            <div class="input-group bootstrap-timepicker">
                                                <input id="shiftEndTime" name="shiftEndTime" type="text" class="form-control"
                                                       value="<?php
                                                       if (isset($shiftArray) && is_array($shiftArray)) {
                                                           if (isset($shiftArray[0]['shiftEndTime'])) {
                                                               echo htmlentities($shiftArray[0]['shiftEndTime']);
                                                           }
                                                       }
                                                       ?>"> <span class="input-group-addon"><i class="glyphicontime"></i></span>
                                            </div>
                                            <span class="help-block" id="shiftEndTimeHelpMe"></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group" id="shiftDescriptionForm">
                                        <div class="col-xs-12 col-sm-12 col-md-12">
                                            <textarea class="form-control" name="shiftDescription" id="shiftDescription"
                                                      onKeyUp="removeMeError('shiftDescription');"><?php
                                                          if (isset($shiftArray[0]['shiftDescription'])) {
                                                              echo htmlentities($shiftArray[0]['shiftDescription']);
                                                          }
                                                          ?></textarea> <span class="help-block" id="shiftDescriptionHelpMe"></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <?php if ($leafAccess['leafAccessCreateValue'] == 1) { ?>
                            newRecord(<?php echo $leafId; ?>, '<?php echo $shift->getControllerPath(); ?>', '<?php echo $shift->getViewPath(); ?>', '<?php echo $securityToken; ?>', 1);
    <?php } ?>
                        return false;
                    }
                    // shift+s save event
    ...
    <?php if ($leafAccess['leafAccessUpdateValue'] == 1) { ?>
                            updateRecord(<?php echo $leafId; ?>, '<?php echo $shift->getControllerPath(); ?>', '<?php echo $shift->getViewPath(); ?>', '<?php echo $securityToken; ?>', 1, <?php echo $leafAccess['leafAccessDeleteValue']; ?>);
    <?php } ?>
                        return false;
                    }
    ...
    <?php if ($leafAccess['leafAccessDeleteValue'] == 1) { ?>
                            deleteRecord(<?php echo $leafId; ?>, '<?php echo $shift->getControllerPath(); ?>', '<?php echo $shift->getViewPath(); ?>', '<?php echo $securityToken; ?>', <?php echo $leafAccess['leafAccessDeleteValue']; ?>);
    ...
    <?php } ?>
                    ...
                    switch (e.keyCode) {
                        case 37:
                            previousRecord(<?php echo $leafId; ?>, '<?php echo $shift->getControllerPath(); ?>', '<?php echo $shift->getViewPath(); ?>', '<?php echo $securityToken; ?>', <?php echo $leafAccess['leafAccessUpdateValue']; ?>, <?php echo $leafAccess['leafAccessDeleteValue']; ?>);
                            
                            return false;
                            break;
                        case 39:
                            nextRecord(<?php echo $leafId; ?>, '<?php echo $shift->getControllerPath(); ?>', '<?php echo $shift->getViewPath(); ?>', '<?php echo $securityToken; ?>', <?php echo $leafAccess['leafAccessUpdateValue']; ?>, <?php echo $leafAccess['leafAccessDeleteValue']; ?>);
                ...
                $(document).ready(function() {
                    ...
                    validateMeAlphaNumeric('shiftName');
                    validateMeAlphaNumeric('shiftCode');
    ...
    <?php if ($_POST['method'] == "new") { ?>
        ...
        <?php if ($leafAccess['leafAccessCreateValue'] == 1) { ?>
                            ...
                            $('#newRecordButton3').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $shift->getControllerPath(); ?>','<?php echo $shift->getViewPath(); ?>','<?php echo $securityToken; ?>',1)");
                            $('#newRecordButton4').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $shift->getControllerPath(); ?>','<?php echo $shift->getViewPath(); ?>','<?php echo $securityToken; ?>',2)");
                            $('#newRecordButton5').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $shift->getControllerPath(); ?>','<?php echo $shift->getViewPath(); ?>','<?php echo $securityToken; ?>',3)");
                            $('#newRecordButton6').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $shift->getControllerPath(); ?>','<?php echo $shift->getViewPath(); ?>','<?php echo $securityToken; ?>',4)");
                            $('#newRecordButton7').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $shift->getControllerPath(); ?>','<?php echo $shift->getViewPath(); ?>','<?php echo $securityToken; ?>',5)");
        <?php } else { ?>
        ...
        if ($_POST['shiftId']) {
            ...
            <?php if ($leafAccess['leafAccessUpdateValue'] == 1) { ?>
                                $('#updateRecordButton1').removeClass().addClass('btn btn-info').attr('onClick', "updateRecord(<?php echo $leafId; ?>,'<?php echo $shift->getControllerPath(); ?>','<?php echo $shift->getViewPath(); ?>','<?php echo $securityToken; ?>',1,<?php echo $leafAccess['leafAccessDeleteValue']; ?>);");
                                $('#updateRecordButton2').removeClass().addClass('btn dropdown-toggle btn-info');
                                $('#updateRecordButton3').attr('onClick', "updateRecord(<?php echo $leafId; ?>,'<?php echo $shift->getControllerPath(); ?>','<?php echo $shift->getViewPath(); ?>','<?php echo $securityToken; ?>',1,<?php echo $leafAccess['leafAccessDeleteValue']; ?>);");
                                $('#updateRecordButton4').attr('onClick', "updateRecord(<?php echo $leafId; ?>,'<?php echo $shift->getControllerPath(); ?>','<?php echo $shift->getViewPath(); ?>','<?php echo $securityToken; ?>',2,<?php echo $leafAccess['leafAccessDeleteValue']; ?>);");
                                $('#updateRecordButton5').attr('onClick', "updateRecord(<?php echo $leafId; ?>,'<?php echo $shift->getControllerPath(); ?>','<?php echo $shift->getViewPath(); ?>','<?php echo $securityToken; ?>',3,<?php echo $leafAccess['leafAccessDeleteValue']; ?>);");
            <?php } else { ?>
                                $('#updateRecordButton1').removeClass().addClass(' btn btn-info disabled').attr('onClick', '');
                                $('#updateRecordButton2').removeClass().addClass('btn dropdown-toggle btn-info disabled');
                                $('#updateRecordButton3').attr('onClick', '');
            ...
            <?php } ?>
            <?php if ($leafAccess['leafAccessDeleteValue'] == 1) { ?>
                                $('#deleteRecordButton').removeClass().addClass('btn btn-danger').attr('onClick', "deleteRecord(<?php echo $leafId; ?>,'<?php echo $shift->getControllerPath(); ?>','<?php echo $shift->getViewPath(); ?>','<?php echo $securityToken; ?>',<?php echo $leafAccess['leafAccessDeleteValue']; ?>);");
            <?php } else { ?>
                                $('#deleteRecordButton').removeClass().addClass('btn btn-danger disabled').attr('onClick', '');
            <?php } ?>
            <?php
...
<?php } ?>
<script type="text/javascript" src="./v3/humanResource/setting/javascript/shift.js"></script>
<hr>
