...
require_once($newFakeDocumentRoot . "v3/humanResource/setting/controller/marriageController.php");
...
if (isset($_POST)) {
    if (isset($_POST['method'])) {
        $marriage = new \Core\HumanResource\Setting\Marriage\Controller\MarriageClass();
        define('LIMIT', 10);
                                ...
                                <div class="modal-body">
                                    <form class="form-horizontal">
                                        ...
                                        <div class="form-group" id="marriageCodeDiv">
                                            <label for="marriageCodePreview"
                                                   class="control-label col-xs-4 col-sm-4 col-md-4"><?php echo $leafTranslation['marriageCodeLabel']; ?></label>

                                            <div class="col-xs-8 col-sm-8 col-md-8">
                                                <input class="form-control" type="text" name="marriageCodePreview"
                                                       id="marriageCodePreview">
                                            </div>
                                        </div>
                                        <div class="form-group" id="marriageDescriptionDiv">
                                            <label for="marriageDescriptionPreview"
                                                   class="control-label col-xs-4 col-sm-4 col-md-4"><?php echo $leafTranslation['marriageDescriptionLabel']; ?></label>

                                            <div class="col-xs-8 col-sm-8 col-md-8">
                                                <input class="form-control" type="text" name="marriageDescriptionPreview"
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="panel panel-default">
                                <table class="table table table-bordered table-striped table-condensed table-hover smart-form has-tickbox" id="tableData">
                                    ...
                                    <th width="75px">
                                    <div align="center"><?php echo ucwords($leafTranslation['marriageCodeLabel']); ?></div>
                                    </th>
                                                            ...
                                                            <td align="center">
                                                                <div class="btn-group" align="center">
                                                                    ...
                                                                    <button type="button"  class="btn btn-danger btn-sm" title="Delete"
                                                                            ...
                                                                            ?>', '<?php
                                                                            echo rawurlencode(
                                                                                    $marriageArray [$i]['marriageDescription']
                                                                            );
                                                                            ?>');">
                                                                    ...
                                                                    if (isset($marriageArray[$i]['executeBy'])) {
                                                                        if (isset($_POST['query']) || isset($_POST['character'])) {
                                                                            if (isset($_POST['query']) && strlen($_POST['query']) > 0) {
                                                                                ...
                                                                                if (isset($_POST['character']) && strlen($_POST['character']) > 0) {
                                                                                    if (strpos(
                                                                                                    $marriageArray[$i]['staffName'], $_POST['character']
                                                                                            ) !== false
                                                                                    ) {
                                                                                        echo str_replace(
...
if ((isset($_POST['method']) == 'new' || isset($_POST['method']) == 'read') && $_POST['type'] == 'form') {
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group" id="marriageCodeForm">
                                <label for="marriageCode" class="control-label col-xs-2 col-sm-2 col-md-2"><strong><?php
                                        echo ucfirst(
                                ...
                                <div class="control-label col-xs-4 col-sm-4 col-md-4">
                                    <div class="input-group">
                                        <input class="form-control" type="text" name="marriageCode" id="marriageCode"
                                               onKeyUp="removeMeError('marriageCode');" value="<?php
                                    ...
                                    <span class="help-block" id="marriageCodeHelpMe"></span>
                                </div>
                            </div>
                            <div class="form-group" id="marriageDescriptionForm">
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <textarea class="form-control" name="marriageDescription"
    ...
    <?php if ($_POST['method'] == "new") { ?>
        ...
        <?php if ($leafAccess['leafAccessCreateValue'] == 1) { ?>
                            $('#newRecordButton1').removeClass().addClass('btn btn-success').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $marriage->getControllerPath(); ?>','<?php echo $marriage->getViewPath(); ?>','<?php echo $securityToken; ?>',1)");
        ...
        if ($_POST['marriageId']) {
            ...
            <?php if ($leafAccess['leafAccessUpdateValue'] == 1) { ?>
                                $('#updateRecordButton1').removeClass().addClass('btn btn-info').attr('onClick', "updateRecord(<?php echo $leafId; ?>,'<?php echo $marriage->getControllerPath(); ?>','<?php echo $marriage->getViewPath(); ?>','<?php echo $securityToken; ?>',1,<?php echo $leafAccess['leafAccessDeleteValue']; ?>);");
            ...
            <?php } ?>
            <?php if ($leafAccess['leafAccessDeleteValue'] == 1) { ?>
                                $('#deleteRecordButton').removeClass().addClass('btn btn-danger').attr('onClick', "deleteRecord(<?php echo $leafId; ?>,'<?php echo $marriage->getControllerPath(); ?>','<?php echo $marriage->getViewPath(); ?>','<?php echo $securityToken; ?>',<?php echo $leafAccess['leafAccessDeleteValue']; ?>);");
            <?php } else { ?>
                                $('#deleteRecordButton').removeClass().addClass('btn btn-danger disabled').attr('onClick', '');
            <?php } ?>
            <?php
...
<?php } ?>
<script type="text/javascript" src="./v3/humanResource/setting/javascript/marriage.js"></script>
<hr>
