...
namespace Core\HumanResource\Setting\Gender\Controller;

use Core\ConfigClass;
use Core\Document\Trail\DocumentTrailClass;
use Core\HumanResource\Setting\Gender\Model\GenderModel;
use Core\HumanResource\Setting\Gender\Service\GenderService;
...
require_once($newFakeDocumentRoot . "v3/humanResource/setting/model/genderModel.php");
require_once($newFakeDocumentRoot . "v3/humanResource/setting/service/genderService.php");
 ...
 * @version 2
 * @author hafizan
 * @package  Core\HumanResource\Setting\Gender\Controller
 * @subpackage Setting
...
class GenderClass extends ConfigClass {
    ...
    /**
     * Model
     * @var \Core\HumanResource\Setting\Gender\Model\GenderModel
     */
    public $model;
     ...
     * @var \Core\HumanResource\Setting\Gender\Service\GenderService
     */
    public $service;
    ...
    function __construct() {
        ...
        $this->setViewPath("./v3/humanResource/setting/view/gender.php");
        $this->setControllerPath("./v3/humanResource/setting/controller/genderController.php");
        $this->setServicePath("./v3/humanResource/setting/service/genderService.php");
    }
   ...
   /** 
    ...
    function excel() {
        ...
        $this->excel->getActiveSheet()->setCellValue('D3', $this->translate['genderDescriptionLabel']);
        ...
        while (($row = $this->q->fetchAssoc()) == true) {
            ...
            $this->excel->getActiveSheet()->setCellValue('D' . $loopRow, strip_tags($row ['genderDescription']));
...
if (isset($_GET ['method'])) {
    ...
    if (isset($_GET ['databaseRequest'])) {
        $genderObject->setRequestDatabase($_GET ['databaseRequest']);
    }
    /*
     *  Load the dynamic value
     */
