function checkDuplicate(leafId, page, securityToken) {
    var $employmentStatusCode = $("#employmentStatusCode");
    if ($employmentStatusCode.val().length === 0) {
    ...
    $.ajax({
        ...
        url: page,
        data: {
            employmentStatusCode: $employmentStatusCode.val(),
            method: 'duplicate',
        ...
        success: function(data) {
            ...
            if (success === true) {
                if (total !== 0) {
                    $("#employmentStatusCode").val('').focus();
                    $("#employmentStatusCodeForm").removeClass().addClass("form-group has-error");
                ...
                $("#employmentStatusForm").removeClass().addClass("form-group has-error");
            }
            if ($infoPanel.is(':hidden')) {
                $infoPanel.show();
            }
...
function showFormUpdate(leafId, url, urlList, securityToken, employmentStatusId, updateAccess, deleteAccess) {
    sleep(500);
...
function showModalDelete(employmentStatusId, employmentStatusCode, employmentStatusDescription, isPaidSalary) {
    $('#employmentStatusIdPreview').val('').val(decodeURIComponent(employmentStatusId));
    $('#employmentStatusCodePreview').val('').val(decodeURIComponent(employmentStatusCode));
    $('#employmentStatusDescriptionPreview').val('').val(decodeURIComponent(employmentStatusDescription));
    $('#isPaidSalaryPreview').val('').val(decodeURIComponent(isPaidSalary));
...
function deleteGridRecord(leafId, url, urlList, securityToken) {
    $.ajax({
        ...
        data: {
            method: 'delete',
            output: 'json',
            employmentStatusId: $('#employmentStatusIdPreview').val(),
            securityToken: securityToken,
            leafId: leafId
        },
        beforeSend: function() {
...
function deleteGridRecordCheckbox(leafId, url, urlList, securityToken) {
    var stringText = '';
    var counter = 0;
    $('input:checkbox[name="employmentStatusId[]"]').each(function() {
        stringText = stringText + "&employmentStatusId[]=" + $(this).val();
    });
...
function newRecord(leafId, url, urlList, securityToken, type, createAccess, updateAccess, deleteAccess) {
    ...
    var $employmentStatusCode = $('#employmentStatusCode');
    var $employmentStatusDescription = $('#employmentStatusDescription');
    var $isPaidSalary = $('#isPaidSalary');
    if (css.search('disabled') > 0) {
        return false;
    } else {
        if (type === 1) {
            if ($employmentStatusCode.val().length === 0) {
                $('#employmentStatusCodeHelpMe').html('').empty().html("<span class='label label-important'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['employmentStatusCodeLabel'] + " </span>");
                $('#employmentStatusCodeForm').removeClass().addClass('form-group has-error');
                $employmentStatusCode.focus();
                return false;
            }
            if ($employmentStatusDescription.val().length === 0) {
                $('#employmentStatusDescriptionHelpMe').html('').empty().html("<span class='label label-important'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['employmentStatusDescriptionLabel'] + " </span>");
                $('#employmentStatusDescriptionForm').removeClass().addClass('form-group has-error');
                $employmentStatusDescription.focus();
                return false;
            }
            if ($isPaidSalary.val().length === 0) {
                $('#isPaidSalaryHelpMe').html('').empty().html("<span class='label label-important'>&nbsp;" + decodeURIComponent(t['requiredTextLabel']) + " : " + leafTranslation['isPaidSalaryLabel'] + " </span>");
                $('#isPaidSalaryForm').removeClass().addClass('form-group has-error');
                $isPaidSalary.focus();
                return false;
            }
            $.ajax({
                ...
                data: {
                    ...
                    output: 'json',
                    employmentStatusCode: $employmentStatusCode.val(),
                    employmentStatusDescription: $employmentStatusDescription.val(),
                    isPaidSalary: $isPaidSalary.val(),
                    securityToken: securityToken,
                    leafId: leafId
                },
                beforeSend: function() {
                ...
                success: function(data) {
                    ...
                    if (success === true) {
                        ...
                        $('#employmentStatusCodeHelpMe').html('').empty();
                        $employmentStatusDescription.val('');
                        $('#employmentStatusDescriptionForm').removeClass().addClass('form-group');
                        $('#employmentStatusDescriptionHelpMe').html('').empty();
                        $isPaidSalary.val('');
                        $('#isPaidSalaryHelpMe').html('').empty();
                    } else if (success === false) {
                        $infoPanel.html('').empty().html("<span class='label label-important'>&nbsp;" + message + "</span>");
                        if ($infoPanel.is(':hidden')) {
                            $infoPanel.show();
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (success === true) {
                        ...
                        $('#employmentStatusId').val(data.employmentStatusId);
                        $('#newRecordButton1').removeClass().addClass('btn btn-success disabled').attr('onClick', '');
                        $('#newRecordButton2').removeClass().addClass('btn dropdown-toggle btn-success disabled');
                        $('#newRecordButton3').attr('onClick', '');
                        $('#newRecordButton4').attr('onClick', '');
    ...
    if (css.search('disabled') > 0) {
        ...
        if (deleteAccess === 1) {
            if (confirm(decodeURIComponent(t['deleteRecordMessageLabel']))) {
                var value = $employmentStatusId.val();
                if (!value) {
...
function resetRecord(leafId, url, urlList, securityToken, createAccess, updateAccess, deleteAccess) {
    ...
    $("#employmentStatusCode").val('');
    $("#employmentStatusCodeHelpMe").empty().html('');
    $("#employmentStatusDescription").val('');
    $("#employmentStatusDescriptionHelpMe").empty().html('');
    $('#employmentStatusDescription').empty().val('');
    $("#isPaidSalary").val('');
    $("#isPaidSalaryHelpMe").empty().html('');
}
function postRecord() {
            ...
            success: function(data) {
                ...
                if (success === true) {
                    $.ajax({
                        ...
                        data: {
                            method: 'read',
                            employmentStatusId: firstRecord,
                            output: 'json',
                            securityToken: securityToken,
                            leafId: leafId
                        },
                        ...
                        success: function(data) {
                            ...
                            if (success === true) {
                                ...
                                $('#employmentStatusCode').val(data.data.employmentStatusCode);
                                $('#employmentStatusDescription').val(data.data.employmentStatusDescription);
                                $('#isPaidSalary').val(data.data.isPaidSalary);
                                if (nextRecord > 0) {
                                    $('#previousRecordButton').removeClass().addClass('btn btn-default disabled').attr('onClick', '');
    ...
    if (css.search('disabled') > 0) {
        ...
        if (parseFloat($previousRecordCounter.val()) > 0 && parseFloat($previousRecordCounter.val()) < parseFloat($('#lastRecordCounter').val())) {
            $.ajax({
                ...
                data: {
                    method: 'read',
                    employmentStatusId: $previousRecordCounter.val(),
                    output: 'json',
                    securityToken: securityToken,
                    leafId: leafId
                },
    ...
    if (css.search('disabled') > 0) {
        ...
        if (parseFloat($nextRecordCounter.val()) <= parseFloat($('#lastRecordCounter').val())) {
            $.ajax({
                ...
                data: {
                    method: 'read',
                    employmentStatusId: $nextRecordCounter.val(),
                    output: 'json',
                    securityToken: securityToken,
                    leafId: leafId
                },
