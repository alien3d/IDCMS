...
require_once($newFakeDocumentRoot . "v3/humanResource/recruitment/controller/vacancyController.php");
...
$translator->setCurrentTable('vacancy');
...
if (isset($_POST)) {
    if (isset($_POST['method'])) {
        $vacancy = new \Core\HumanResource\Recruitment\Vacancy\Controller\VacancyClass();
        define('LIMIT', 10);
        ...
        if (isset($_POST ['query'])) {
            $vacancy->setFieldQuery($_POST ['query']);
        }
        if (isset($_POST ['filter'])) {
            $vacancy->setGridQuery($_POST ['filter']);
        }
        if (isset($_POST ['character'])) {
            $vacancy->setCharacterQuery($_POST['character']);
        }
        if (isset($_POST ['dateRangeStart'])) {
            $vacancy->setDateRangeStartQuery($_POST['dateRangeStart']);
            //explode the data to get day,month,year
            $start = explode('-', $_POST ['dateRangeStart']);
            $vacancy->setStartDay($start[2]);
            $vacancy->setStartMonth($start[1]);
            $vacancy->setStartYear($start[0]);
        }
        if (isset($_POST ['dateRangeEnd']) && (strlen($_POST['dateRangeEnd']) > 0)) {
            $vacancy->setDateRangeEndQuery($_POST['dateRangeEnd']);
            //explode the data to get day,month,year
            $start = explode('-', $_POST ['dateRangeEnd']);
            $vacancy->setEndDay($start[2]);
            $vacancy->setEndMonth($start[1]);
            $vacancy->setEndYear($start[0]);
        }
        if (isset($_POST ['dateRangeType'])) {
            $vacancy->setDateRangeTypeQuery($_POST['dateRangeType']);
        }
        if (isset($_POST ['dateRangeExtraType'])) {
            $vacancy->setDateRangeExtraTypeQuery($_POST['dateRangeExtraType']);
        }
        $vacancy->setServiceOutput('html');
        $vacancy->setLeafId($leafId);
        $vacancy->execute();
        $jobArray = $vacancy->getJob();
        if ($_POST['method'] == 'read') {
            $vacancy->setStart($offset);
            $vacancy->setLimit($limit); // normal system don't like paging..
            $vacancy->setPageOutput('html');
            $vacancyArray = $vacancy->read();
            if (isset($vacancyArray [0]['firstRecord'])) {
                $firstRecord = $vacancyArray [0]['firstRecord'];
            }
            if (isset($vacancyArray [0]['nextRecord'])) {
                $nextRecord = $vacancyArray [0]['nextRecord'];
            }
            if (isset($vacancyArray [0]['previousRecord'])) {
                $previousRecord = $vacancyArray [0]['previousRecord'];
            }
            if (isset($vacancyArray [0]['lastRecord'])) {
                $lastRecord = $vacancyArray [0]['lastRecord'];
                $endRecord = $vacancyArray [0]['lastRecord'];
            }
            $navigation = new \Core\Paging\HtmlPaging();
            $navigation->setLeafId($leafId);
            $navigation->setViewPath($vacancy->getViewPath());
            ...
            if (isset($vacancyArray [0]['total'])) {
                $total = $vacancyArray [0]['total'];
            } else {
                $total = 0;
            }
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu" style="text-align:left">
                                <li>
                                    ...
                                    echo $vacancy->getControllerPath();
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form class="form-horizontal">
                                        <input type="hidden" name="vacancyIdPreview" id="vacancyIdPreview">
                                        ...
                                        <div class="form-group" id="jobIdDiv">
                                            ...
                                            <div class="col-xs-8 col-sm-8 col-md-8">
                                                <input class="form-control" type="text" name="jobIdPreview"
                                                       id="jobIdPreview">
                                            </div>
                                        </div>
                                        <div class="form-group" id="vacancyTitleDiv">
                                            <label for="vacancyTitlePreview"
                                                   class="control-label col-xs-4 col-sm-4 col-md-4"><?php echo $leafTranslation['vacancyTitleLabel']; ?></label>

                                            <div class="col-xs-8 col-sm-8 col-md-8">
                                                <input class="form-control" type="text" name="vacancyTitlePreview"
                                                       id="vacancyTitlePreview">
                                            </div>
                                        </div>
                                        <div class="form-group" id="vacancyRequiredDateDiv">
                                            <label for="vacancyRequiredDatePreview"
                                                   class="control-label col-xs-4 col-sm-4 col-md-4"><?php echo $leafTranslation['vacancyRequiredDateLabel']; ?></label>

                                            <div class="col-xs-8 col-sm-8 col-md-8">
                                                <input class="form-control" type="text" name="vacancyRequiredDatePreview"
                                                       id="vacancyRequiredDatePreview">
                                            </div>
                                        </div>
                                        <div class="form-group" id="vacancyRequiredPeopleDiv">
                                            <label for="vacancyRequiredPeoplePreview"
                                                   class="control-label col-xs-4 col-sm-4 col-md-4"><?php echo $leafTranslation['vacancyRequiredPeopleLabel']; ?></label>

                                            <div class="col-xs-8 col-sm-8 col-md-8">
                                                <input class="form-control" type="text" name="vacancyRequiredPeoplePreview"
                                                       id="vacancyRequiredPeoplePreview">
                                            </div>
                                        </div>
                                        <div class="form-group" id="vacancyDescriptionDiv">
                                            <label for="vacancyDescriptionPreview"
                                                   class="control-label col-xs-4 col-sm-4 col-md-4"><?php echo $leafTranslation['vacancyDescriptionLabel']; ?></label>

                                            <div class="col-xs-8 col-sm-8 col-md-8">
                                                <textarea class="form-control" rows="3" name="vacancyDescriptionPreview"
                                                          id="vacancyDescriptionPreview"></textarea>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="panel panel-default">
                                <table class="table table table-bordered table-striped table-condensed table-hover smart-form has-tickbox" id="tableData">
                                    ...
                                    <th width="150px"><?php echo ucwords($leafTranslation['jobIdLabel']); ?></th>
                                    <th width="150px"><?php echo ucwords($leafTranslation['vacancyTitleLabel']); ?></th>
                                    <th width="75px"><?php echo ucwords($leafTranslation['vacancyRequiredDateLabel']); ?></th>
                                    <th width="75px"><?php echo ucwords($leafTranslation['vacancyRequiredPeopleLabel']); ?></th>
                                    <th><?php echo ucwords($leafTranslation['vacancyDescriptionLabel']); ?></th>
                                    ...
                                    <tbody id="tableBody">
                                        ...
                                        if ($_POST['method'] == 'read' && $_POST['type'] == 'list' && $_POST['detail'] == 'body') {
                                            if (is_array($vacancyArray)) {
                                                $totalRecord = intval(count($vacancyArray));
                                                if ($totalRecord > 0) {
                                                    $counter = 0;
                                                    for ($i = 0; $i < $totalRecord; $i++) {
                                                        ...
                                                        ?>
                                                        <tr <?php
                                                        if ($vacancyArray[$i]['isDelete'] == 1) {
                                                            echo "class=\"danger\"";
                                                        } else {
                                                            if ($vacancyArray[$i]['isDraft'] == 1) {
                                                                echo "class=\"warning\"";
                                                            }
                                                        }
                                                        ?>>
                                                            ...
                                                            <td align="center">
                                                                <div class="btn-group" align="center">
                                                                    ...
                                                                    <button type="button"  class="btn btn-danger btn-sm" title="Delete"
                                                                            ...
                                                                            ?>', '<?php
                                                                            echo rawurlencode(
                                                                                    $vacancyArray [$i]['jobTitle']
                                                                            );
                                                                            ?>', '<?php
                                                                            echo rawurlencode(
                                                                                    $vacancyArray [$i]['vacancyTitle']
                                                                            );
                                                                            ?>', '<?php
                                                                            echo rawurlencode(
                                                                                    $vacancyArray [$i]['vacancyRequiredDate']
                                                                            );
                                                                            ?>', '<?php
                                                                            echo rawurlencode(
                                                                                    $vacancyArray [$i]['vacancyRequiredPeople']
                                                                            );
                                                                            ?>', '<?php
                                                                            echo rawurlencode(
                                                                                    $vacancyArray [$i]['vacancyDescription']
                                                                            );
                                                                            ?>');">
                                                            ...
                                                            <td>
                                                                <div class="pull-left">
                                                                    <?php
                                                                    if (isset($vacancyArray[$i]['jobTitle'])) {
                                                                        if (isset($_POST['query']) || isset($_POST['character'])) {
                                                                            if (isset($_POST['query']) && strlen($_POST['query']) > 0) {
                                                                                if (strpos($vacancyArray[$i]['jobTitle'], $_POST['query']) !== false) {
                                                                                    echo str_replace(
                                                                                            $_POST['query'], "<span class=\"label label-info\">" . $_POST['query'] . "</span>", $vacancyArray[$i]['jobTitle']
                                                                                    );
                                                                                } else {
                                                                                    echo $vacancyArray[$i]['jobTitle'];
                                                                                }
                                                                            } else {
                                                                                if (isset($_POST['character']) && strlen($_POST['character']) > 0) {
                                                                                    if (strpos($vacancyArray[$i]['jobTitle'], $_POST['character']) !== false) {
                                                                                        echo str_replace(
                                                                                                $_POST['character'], "<span class=\"label label-info\">" . $_POST['character'] . "</span>", $vacancyArray[$i]['jobTitle']
                                                                                        );
                                                                                    } else {
                                                                                        echo $vacancyArray[$i]['jobTitle'];
                                                                                    }
                                                            ...
                                                            <td>
                                                                <div class="pull-left">
                                                                    <?php
                                                                    if (isset($vacancyArray[$i]['vacancyTitle'])) {
                                                                        if (isset($_POST['query']) || isset($_POST['character'])) {
                                                                            if (isset($_POST['query']) && strlen($_POST['query']) > 0) {
                                                                                if (strpos(
                                                                                                strtolower($vacancyArray[$i]['vacancyTitle']), strtolower($_POST['query'])
                                                                                        ) !== false
                                                                                ) {
                                                                                    echo str_replace(
                                                                                            $_POST['query'], "<span class=\"label label-info\">" . $_POST['query'] . "</span>", $vacancyArray[$i]['vacancyTitle']
                                                                                    );
                                                                                } else {
                                                                                    echo $vacancyArray[$i]['vacancyTitle'];
                                                                                }
                                                                            } else {
                                                                                if (isset($_POST['character']) && strlen($_POST['character']) > 0) {
                                                                                    if (strpos(
                                                                                                    strtolower($vacancyArray[$i]['vacancyTitle']), strtolower($_POST['character'])
                                                                                            ) !== false
                                                                                    ) {
                                                                                        echo str_replace(
                                                                                                $_POST['character'], "<span class=\"label label-info\">" . $_POST['character'] . "</span>", $vacancyArray[$i]['vacancyTitle']
                                                                                        );
                                                                                    } else {
                                                                                        echo $vacancyArray[$i]['vacancyTitle'];
                                                                                    }
                                                            ...
                                                            <?php
                                                            if (isset($vacancyArray[$i]['vacancyRequiredDate'])) {
                                                                $valueArray = $vacancyArray[$i]['vacancyRequiredDate'];
                                                            ...
                                                            <td>
                                                                <div class="pull-left">
                                                                    <?php
                                                                    if (isset($vacancyArray[$i]['vacancyRequiredPeople'])) {
                                                                        if (isset($_POST['query']) || isset($_POST['character'])) {
                                                                            if (isset($_POST['query']) && strlen($_POST['query']) > 0) {
                                                                                if (strpos(
                                                                                                strtolower($vacancyArray[$i]['vacancyRequiredPeople']), strtolower($_POST['query'])
                                                                                        ) !== false
                                                                                ) {
                                                                                    echo str_replace(
                                                                                            $_POST['query'], "<span class=\"label label-info\">" . $_POST['query'] . "</span>", $vacancyArray[$i]['vacancyRequiredPeople']
                                                                                    );
                                                                                } else {
                                                                                    echo $vacancyArray[$i]['vacancyRequiredPeople'];
                                                                                }
                                                                            } else {
                                                                                if (isset($_POST['character']) && strlen($_POST['character']) > 0) {
                                                                                    if (strpos(
                                                                                                    strtolower($vacancyArray[$i]['vacancyRequiredPeople']), strtolower($_POST['character'])
                                                                                            ) !== false
                                                                                    ) {
                                                                                        echo str_replace(
                                                                                                $_POST['character'], "<span class=\"label label-info\">" . $_POST['character'] . "</span>", $vacancyArray[$i]['vacancyRequiredPeople']
                                                                                        );
                                                                                    } else {
                                                                                        echo $vacancyArray[$i]['vacancyRequiredPeople'];
                                                                                    }
                                                            ...
                                                            <td>
                                                                <div class="pull-left">
                                                                    <?php
                                                                    if (isset($vacancyArray[$i]['vacancyDescription'])) {
                                                                        if (isset($_POST['query']) || isset($_POST['character'])) {
                                                                            if (isset($_POST['query']) && strlen($_POST['query']) > 0) {
                                                                                if (strpos(
                                                                                                strtolower($vacancyArray[$i]['vacancyDescription']), strtolower($_POST['query'])
                                                                                        ) !== false
                                                                                ) {
                                                                                    echo str_replace(
                                                                                            $_POST['query'], "<span class=\"label label-info\">" . $_POST['query'] . "</span>", $vacancyArray[$i]['vacancyDescription']
                                                                                    );
                                                                                } else {
                                                                                    echo $vacancyArray[$i]['vacancyDescription'];
                                                                                }
                                                                            } else {
                                                                                if (isset($_POST['character']) && strlen($_POST['character']) > 0) {
                                                                                    if (strpos(
                                                                                                    strtolower($vacancyArray[$i]['vacancyDescription']), strtolower($_POST['character'])
                                                                                            ) !== false
                                                                                    ) {
                                                                                        echo str_replace(
                                                                                                $_POST['character'], "<span class=\"label label-info\">" . $_POST['character'] . "</span>", $vacancyArray[$i]['vacancyDescription']
                                                                                        );
                                                                                    } else {
                                                                                        echo $vacancyArray[$i]['vacancyDescription'];
                                                                                    }
                                                            ...
                                                            <td>
                                                                <div class="pull-left">
                                                                    <?php
                                                                    if (isset($vacancyArray[$i]['executeBy'])) {
                                                                        if (isset($_POST['query']) || isset($_POST['character'])) {
                                                                            if (isset($_POST['query']) && strlen($_POST['query']) > 0) {
                                                                                if (strpos($vacancyArray[$i]['staffName'], $_POST['query']) !== false) {
                                                                                    echo str_replace(
                                                                                            $_POST['query'], "<span class=\"label label-info\">" . $_POST['query'] . "</span>", $vacancyArray[$i]['staffName']
                                                                                    );
                                                                                } else {
                                                                                    echo $vacancyArray[$i]['staffName'];
                                                                                }
                                                                            } else {
                                                                                if (isset($_POST['character']) && strlen($_POST['character']) > 0) {
                                                                                    if (strpos($vacancyArray[$i]['staffName'], $_POST['character']) !== false) {
                                                                                        echo str_replace(
                                                                                                $_POST['character'], "<span class=\"label label-info\">" . $_POST['character'] . "</span>", $vacancyArray[$i]['staffName']
                                                                                        );
                                                                                    } else {
                                                                                        echo $vacancyArray[$i]['staffName'];
                                                                                    }
                                                            ...
                                                            <?php
                                                            if (isset($vacancyArray[$i]['executeTime'])) {
                                                                $valueArray = $vacancyArray[$i]['executeTime'];
                                                            ...
                                                            ?>
                                                            <td>
                                                                <input style="display:none;" type="checkbox" name="vacancyId[]"
                                                                       value="<?php echo $vacancyArray[$i]['vacancyId']; ?>">
                                                                <input <?php echo $checked; ?> type="checkbox" name="isDelete[]"
                                                                                               value="<?php echo $vacancyArray[$i]['isDelete']; ?>">
                                                            </td>
                                                        </tr>
                                                        <?php
                                                    }
                        ...
                        <div class="col-xs-3 col-sm-3 col-md-3 pagination">
                            <div class="pull-right">
                                <button class="delete btn btn-warning" type="button" 
                                        ...
                                        echo $vacancy->getControllerPath();
                                        ?>', '<?php echo $vacancy->getViewPath(); ?>', '<?php echo $securityToken; ?>');">
...
if ((isset($_POST['method']) == 'new' || isset($_POST['method']) == 'read') && $_POST['type'] == 'form') {
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            <input type="hidden" name="vacancyId" id="vacancyId" value="<?php
                            if (isset($_POST['vacancyId'])) {
                                echo $_POST['vacancyId'];
                            }
                            ?>">

                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="col-xs-6 col-sm-6 col-md-6 form-group" id="jobIdForm">
                                        <label for="jobId" class="control-label col-xs-4 col-sm-4 col-md-4"><strong><?php
                                                echo ucfirst(
                                            ...
                                            <select name="jobId" id="jobId" class="chzn-select form-control"
                                                ...
                                                if (is_array($jobArray)) {
                                                    ...
                                                    if ($totalRecord > 0) {
                                                        $d = 1;
                                                        for ($i = 0; $i < $totalRecord; $i++) {
                                                            if ($vacancyArray[0]['jobId'] == $jobArray[$i]['jobId']) {
                                                                $selected = "selected";
                                                            } else {
                                                                $selected = null;
                                                            }
                                    ...
                                    <div class="col-xs-6 col-sm-6 col-md-6 form-group" id="vacancyTitleForm">
                                        <label for="vacancyTitle" class="control-label col-xs-4 col-sm-4 col-md-4"><strong><?php
                                                echo ucfirst(
                                                        $leafTranslation['vacancyTitleLabel']
                                                );
                                                ?></strong></label>

                                        <div class="col-xs-8 col-sm-8 col-md-8">
                                            <input type="text" class="form-control" name="vacancyTitle" id="vacancyTitle"
                                                   onKeyUp="removeMeError('vacancyTitle');" value="<?php
                                                   if (isset($vacancyArray) && is_array($vacancyArray)) {
                                                       echo htmlentities($vacancyArray[0]['vacancyTitle']);
                                                   }
                                                   ?>"> <span class="help-block" id="vacancyTitleHelpMe"></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <?php
                                    if (isset($vacancyArray) && is_array($vacancyArray)) {
                                        $valueArray = $vacancyArray[0]['vacancyRequiredDate'];
                                        if ($dateConvert->checkDate($valueArray)) {
                                            $valueData = explode('-', $valueArray);
                                            $year = $valueData[0];
                                            $month = $valueData[1];
                                    ...
                                    ?>
                                    <div class="col-xs-6 col-sm-6 col-md-6 form-group" id="vacancyRequiredDateForm">
                                        <label for="vacancyRequiredDate" class="control-label col-xs-4 col-sm-4 col-md-4"><strong><?php
                                                echo ucfirst(
                                                        $leafTranslation['vacancyRequiredDateLabel']
                                                );
                                                ?></strong></label>

                                        <div class="col-xs-8 col-sm-8 col-md-8">
                                            <div class="input-group">
                                                <input type="text" class="form-control" name="vacancyRequiredDate"
                                                       id="vacancyRequiredDate" value="<?php
                                                       if (isset($value)) {
                                                           echo $value;
                                                       }
                                                       ?>"><span class="input-group-addon"><img src="./images/icons/calendar.png"
                                                                                       id="vacancyRequiredDateImage"></span>
                                            </div>
                                            <span class="help-block" id="vacancyRequiredDateHelpMe"></span>
                                        </div>
                                    </div>
                                    <div class="col-xs-6 col-sm-6 col-md-6 form-group" id="vacancyRequiredPeopleForm">
                                        <label for="vacancyRequiredPeople" class="control-label col-xs-4 col-sm-4 col-md-4"><strong><?php
                                                echo ucfirst(
                                                        $leafTranslation['vacancyRequiredPeopleLabel']
                                                );
                                                ?></strong></label>

                                        <div class="col-xs-8 col-sm-8 col-md-8">
                                            <div class="input-group">
                                                <input type="text" class="form-control" name="vacancyRequiredPeople"
                                                       id="vacancyRequiredPeople" value="<?php
                                                       if (isset($vacancyArray[0]['vacancyRequiredPeople'])) {
                                                           echo htmlentities($vacancyArray[0]['vacancyRequiredPeople']);
                                                       }
                                                       ?>"><span class="input-group-addon"><img src="./images/icons/counter-reset.png"></span>
                                            </div>
                                            <span class="help-block" id="vacancyRequiredPeopleHelpMe"></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group" id="vacancyDescriptionForm">
                                        <div class="col-xs-12 col-sm-12 col-md-12">
                                            <textarea class="form-control" name="vacancyDescription" id="vacancyDescription"
                                                      onKeyUp="removeMeError('vacancyDescription');"><?php
                                                          if (isset($vacancyArray[0]['vacancyDescription'])) {
                                                              echo htmlentities($vacancyArray[0]['vacancyDescription']);
                                                          }
                                                          ?></textarea> <span class="help-block" id="vacancyDescriptionHelpMe"></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <?php if ($leafAccess['leafAccessCreateValue'] == 1) { ?>
                            newRecord(<?php echo $leafId; ?>, '<?php echo $vacancy->getControllerPath(); ?>', '<?php echo $vacancy->getViewPath(); ?>', '<?php echo $securityToken; ?>', 1);
    <?php } ?>
                        return false;
                    }
                    // shift+s save event
    ...
    <?php if ($leafAccess['leafAccessUpdateValue'] == 1) { ?>
                            updateRecord(<?php echo $leafId; ?>, '<?php echo $vacancy->getControllerPath(); ?>', '<?php echo $vacancy->getViewPath(); ?>', '<?php echo $securityToken; ?>', 1, <?php echo $leafAccess['leafAccessDeleteValue']; ?>);
    <?php } ?>
                        return false;
                    }
    ...
    <?php if ($leafAccess['leafAccessDeleteValue'] == 1) { ?>
                            deleteRecord(<?php echo $leafId; ?>, '<?php echo $vacancy->getControllerPath(); ?>', '<?php echo $vacancy->getViewPath(); ?>', '<?php echo $securityToken; ?>', <?php echo $leafAccess['leafAccessDeleteValue']; ?>);
    ...
    <?php } ?>
                    ...
                    switch (e.keyCode) {
                        case 37:
                            previousRecord(<?php echo $leafId; ?>, '<?php echo $vacancy->getControllerPath(); ?>', '<?php echo $vacancy->getViewPath(); ?>', '<?php echo $securityToken; ?>', <?php echo $leafAccess['leafAccessUpdateValue']; ?>, <?php echo $leafAccess['leafAccessDeleteValue']; ?>);
                            
                            return false;
                            break;
                        case 39:
                            nextRecord(<?php echo $leafId; ?>, '<?php echo $vacancy->getControllerPath(); ?>', '<?php echo $vacancy->getViewPath(); ?>', '<?php echo $securityToken; ?>', <?php echo $leafAccess['leafAccessUpdateValue']; ?>, <?php echo $leafAccess['leafAccessDeleteValue']; ?>);
                ...
                $(document).ready(function() {
                    ...
                    validateMeNumeric('vacancyId');
                    validateMeNumeric('jobId');
                    validateMeAlphaNumeric('vacancyTitle');
                    var a = $('#vacancyRequiredDate').datepicker({
                        format: "<?php echo $systemFormat['systemSettingDateFormat']; ?>"
                    }).on('changeDate', function() {
                        $(this).datepicker('hide');
                    });
                    $("#vacancyRequiredDateImage").on('click', function() {
                        a.datepicker('show');
                    });
                    validateMeNumeric('vacancyRequiredPeople');
    <?php if ($_POST['method'] == "new") { ?>
                        $('#resetRecordButton').removeClass().addClass('btn btn-default');
        <?php if ($leafAccess['leafAccessCreateValue'] == 1) { ?>
                            $('#newRecordButton1').removeClass().addClass('btn btn-success').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $vacancy->getControllerPath(); ?>','<?php echo $vacancy->getViewPath(); ?>','<?php echo $securityToken; ?>',1)");
                            $('#newRecordButton2').removeClass().addClass('btn dropdown-toggle btn-success');
                            $('#newRecordButton3').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $vacancy->getControllerPath(); ?>','<?php echo $vacancy->getViewPath(); ?>','<?php echo $securityToken; ?>',1)");
                            $('#newRecordButton4').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $vacancy->getControllerPath(); ?>','<?php echo $vacancy->getViewPath(); ?>','<?php echo $securityToken; ?>',2)");
                            $('#newRecordButton5').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $vacancy->getControllerPath(); ?>','<?php echo $vacancy->getViewPath(); ?>','<?php echo $securityToken; ?>',3)");
                            $('#newRecordButton6').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $vacancy->getControllerPath(); ?>','<?php echo $vacancy->getViewPath(); ?>','<?php echo $securityToken; ?>',4)");
                            $('#newRecordButton7').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $vacancy->getControllerPath(); ?>','<?php echo $vacancy->getViewPath(); ?>','<?php echo $securityToken; ?>',5)");
        <?php } else { ?>
        ...
        if ($_POST['vacancyId']) {
            ...
            <?php if ($leafAccess['leafAccessUpdateValue'] == 1) { ?>
                                $('#updateRecordButton1').removeClass().addClass('btn btn-info').attr('onClick', "updateRecord(<?php echo $leafId; ?>,'<?php echo $vacancy->getControllerPath(); ?>','<?php echo $vacancy->getViewPath(); ?>','<?php echo $securityToken; ?>',1,<?php echo $leafAccess['leafAccessDeleteValue']; ?>);");
                                $('#updateRecordButton2').removeClass().addClass('btn dropdown-toggle btn-info');
                                $('#updateRecordButton3').attr('onClick', "updateRecord(<?php echo $leafId; ?>,'<?php echo $vacancy->getControllerPath(); ?>','<?php echo $vacancy->getViewPath(); ?>','<?php echo $securityToken; ?>',1,<?php echo $leafAccess['leafAccessDeleteValue']; ?>);");
                                $('#updateRecordButton4').attr('onClick', "updateRecord(<?php echo $leafId; ?>,'<?php echo $vacancy->getControllerPath(); ?>','<?php echo $vacancy->getViewPath(); ?>','<?php echo $securityToken; ?>',2,<?php echo $leafAccess['leafAccessDeleteValue']; ?>);");
                                $('#updateRecordButton5').attr('onClick', "updateRecord(<?php echo $leafId; ?>,'<?php echo $vacancy->getControllerPath(); ?>','<?php echo $vacancy->getViewPath(); ?>','<?php echo $securityToken; ?>',3,<?php echo $leafAccess['leafAccessDeleteValue']; ?>);");
            <?php } else { ?>
                                $('#updateRecordButton1').removeClass().addClass(' btn btn-info disabled').attr('onClick', '');
                                $('#updateRecordButton2').removeClass().addClass('btn dropdown-toggle btn-info disabled');
                                $('#updateRecordButton3').attr('onClick', '');
            ...
            <?php } ?>
            <?php if ($leafAccess['leafAccessDeleteValue'] == 1) { ?>
                                $('#deleteRecordButton').removeClass().addClass('btn btn-danger').attr('onClick', "deleteRecord(<?php echo $leafId; ?>,'<?php echo $vacancy->getControllerPath(); ?>','<?php echo $vacancy->getViewPath(); ?>','<?php echo $securityToken; ?>',<?php echo $leafAccess['leafAccessDeleteValue']; ?>);");
            <?php } else { ?>
                                $('#deleteRecordButton').removeClass().addClass('btn btn-danger disabled').attr('onClick', '');
            <?php } ?>
            <?php
...
<?php } ?>
<script type="text/javascript" src="./v3/humanResource/recruitment/javascript/vacancy.js"></script>
<hr>
