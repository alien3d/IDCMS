...
namespace Core\HumanResource\Recruitment\Candidate\Service;
 ...
 * @version 2
 * @author hafizan
 * @package Core\HumanResource\Recruitment\Candidate\Service
 * @subpackage Recruitment
 * @link http://www.hafizan.com
 * @license http://www.gnu.org/copyleft/lesser.html LGPL
 */
class CandidateService extends ConfigClass {
    ...
    function __construct() {
        ...
        // set upload path
        $this->setUploadPath($this->getFakeDocumentRoot() . "v3/humanResource/candidate/images/");
    }
...
// to pass data through iframe you will need to encode all html tags
        if ($this->getVendor() == self::MYSQL) {
            $sql = "
        INSERT INTO `imageCandidateTemp`(
             `companyId`,
             `staffId`,
             `leafId`,
             `imageTempName`, 
