...
namespace Core\HumanResource\WorkOrder\EmployeeWorkOrder\Model;
 ...
 * @version 2
 * @author hafizan
 * @package Core\HumanResource\WorkOrder\EmployeeWorkOrder\Model;
...
class EmployeeWorkOrderModel extends ValidationClass {
     ...
     * @var double
     */
    private $employeeWorkOrderColor;
    ...
    public function execute() {
        ...
        if (isset($_POST ['employeeWorkOrderStartDate'])) {
            $this->setEmployeeWorkOrderStartDate($this->strict($_POST ['employeeWorkOrderStartDate'], 'timestamp'));
        }
        if (isset($_POST ['employeeWorkOrderEndDate'])) {
            $this->setEmployeeWorkOrderEndDate($this->strict($_POST ['employeeWorkOrderEndDate'], 'timestamp'));
        }
        ...
        if (isset($_POST ['employeeWorkOrderColor'])) {
            $this->setEmployeeWorkOrderColor($this->strict($_POST ['employeeWorkOrderColor'], 'string'));
        }
        ...
        if (isset($_POST ['viewtype'])) {
            $this->setViewType($this->strict($_POST ['viewtype'], 'string'));
        }
        if (isset($_POST ['showdate'])) {
            $this->setShowDate($this->strict($_POST ['showdate'], 'date'));
        }
        /**
        ...
        if (isset($_GET ['employeeWorkOrderStartDate'])) {
            $this->setEmployeeWorkOrderStartDate($this->strict($_GET ['employeeWorkOrderStartDate'], 'timestamp'));
        }
        if (isset($_GET ['employeeWorkOrderEndDate'])) {
            $this->setEmployeeWorkOrderEndDate($this->strict($_GET ['employeeWorkOrderEndDate'], 'timestamp'));
        }
        ...
        if (isset($_GET ['employeeWorkOrderColor'])) {
            $this->setEmployeeWorkOrderColor($this->strict($_GET ['employeeWorkOrderColor'], 'string'));
        }
     ...
     * @param array|int $key List Of Primary Key.
     * @param array|int|string $type  List Of Type.0 As 'single' 1 As 'array'
     * @return \Core\HumanResource\WorkOrder\EmployeeWorkOrder\Model\EmployeeWorkOrderModel
     */
     ...
     * @return timestamp $employeeWorkOrderStartDate
     */
    ...
    /**
     * To Set Start Date
     * @param timestamp $employeeWorkOrderStartDate Start Date
     * @return \Core\HumanResource\WorkOrder\EmployeeWorkOrder\Model\EmployeeWorkOrderModel
     */
    ...
    /**
     * To Return End Date
     * @return timestamp $employeeWorkOrderEndDate
     */
    ...
    /**
     * To Set End Date
     * @param timestamp $employeeWorkOrderEndDate End Date
     * @return \Core\HumanResource\WorkOrder\EmployeeWorkOrder\Model\EmployeeWorkOrderModel
     */
    ...
    /**
     * To Return Color
     * @return string $employeeWorkOrderColor
     */
    public function getEmployeeWorkOrderColor() {
        return $this->employeeWorkOrderColor;
    }

    /**
     * To Set Color
     * @param string $employeeWorkOrderColor Color
     * @return \Core\HumanResource\WorkOrder\EmployeeWorkOrder\Model\EmployeeWorkOrderModel
     */
    public function setEmployeeWorkOrderColor($employeeWorkOrderColor) {
        $this->employeeWorkOrderColor = $employeeWorkOrderColor;
        return $this;
    }
