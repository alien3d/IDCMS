...
require_once($newFakeDocumentRoot . "v3/humanResource/timeSheet/controller/timeSheetController.php");
...
$translator->setCurrentTable('timeSheet');
...
if (isset($_POST)) {
    if (isset($_POST['method'])) {
        $timeSheet = new \Core\HumanResource\TimeSheet\TimeSheet\Controller\TimeSheetClass();
        define('LIMIT', 10);
        ...
        if (isset($_POST ['query'])) {
            $timeSheet->setFieldQuery($_POST ['query']);
        }
        if (isset($_POST ['filter'])) {
            $timeSheet->setGridQuery($_POST ['filter']);
        }
        if (isset($_POST ['character'])) {
            $timeSheet->setCharacterQuery($_POST['character']);
        }
        if (isset($_POST ['dateRangeStart'])) {
            $timeSheet->setDateRangeStartQuery($_POST['dateRangeStart']);
            //explode the data to get day,month,year 
            $start = explode('-', $_POST ['dateRangeStart']);
            $timeSheet->setStartDay($start[2]);
            $timeSheet->setStartMonth($start[1]);
            $timeSheet->setStartYear($start[0]);
        }
        if (isset($_POST ['dateRangeEnd']) && (strlen($_POST['dateRangeEnd']) > 0)) {
            $timeSheet->setDateRangeEndQuery($_POST['dateRangeEnd']);
            //explode the data to get day,month,year 
            $start = explode('-', $_POST ['dateRangeEnd']);
            $timeSheet->setEndDay($start[2]);
            $timeSheet->setEndMonth($start[1]);
            $timeSheet->setEndYear($start[0]);
        }
        if (isset($_POST ['dateRangeType'])) {
            $timeSheet->setDateRangeTypeQuery($_POST['dateRangeType']);
        }
        if (isset($_POST ['dateRangeExtraType'])) {
            $timeSheet->setDateRangeExtraTypeQuery($_POST['dateRangeExtraType']);
        }
        $timeSheet->setServiceOutput('html');
        $timeSheet->setLeafId($leafId);
        $timeSheet->execute();
        $employeeArray = $timeSheet->getEmployee();
        if ($_POST['method'] == 'read') {
            $timeSheet->setStart($offset);
            $timeSheet->setLimit($limit); // normal system don't like paging..  
            $timeSheet->setPageOutput('html');
            $timeSheetArray = $timeSheet->read();
            if (isset($timeSheetArray [0]['firstRecord'])) {
                $firstRecord = $timeSheetArray [0]['firstRecord'];
            }
            if (isset($timeSheetArray [0]['nextRecord'])) {
                $nextRecord = $timeSheetArray [0]['nextRecord'];
            }
            if (isset($timeSheetArray [0]['previousRecord'])) {
                $previousRecord = $timeSheetArray [0]['previousRecord'];
            }
            if (isset($timeSheetArray [0]['lastRecord'])) {
                $lastRecord = $timeSheetArray [0]['lastRecord'];
                $endRecord = $timeSheetArray [0]['lastRecord'];
            }
            $navigation = new \Core\Paging\HtmlPaging();
            $navigation->setLeafId($leafId);
            $navigation->setViewPath($timeSheet->getViewPath());
            ...
            if (isset($timeSheetArray [0]['total'])) {
                $total = $timeSheetArray [0]['total'];
            } else {
                $total = 0;
            }
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu" style="text-align:left">
                                <li>
                                    ...
                                    echo $timeSheet->getControllerPath();
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form class="form-horizontal">
                                        <input type="hidden" name="timeSheetIdPreview" id="timeSheetIdPreview">
                                        ...
                                        <div class="form-group" id="employeeIdDiv">
                                            ...
                                            <div class="col-xs-8 col-sm-8 col-md-8">
                                                <input type="text" class="form-control" name="employeeIdPreview"
                                                       id="employeeIdPreview">
                                            </div>
                                        </div>
                                        <div class="form-group" id="timeSheetNoteDiv">
                                            <label for="timeSheetNotePreview"
                                                   class="control-label col-xs-4 col-sm-4 col-md-4"><?php echo $leafTranslation['timeSheetNoteLabel']; ?></label>

                                            <div class="col-xs-8 col-sm-8 col-md-8">
                                                <input class="form-control" type="text" name="timeSheetNotePreview"
                                                       id="timeSheetNotePreview">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group" id="timeSheetStartDateDiv">
                                            <label for="timeSheetStartDatePreview"
                                                   class="control-label col-xs-4 col-sm-4 col-md-4"><?php echo $leafTranslation['timeSheetStartDateLabel']; ?></label>

                                            <div class="col-xs-8 col-sm-8 col-md-8">
                                                <input class="form-control" type="text" name="timeSheetStartDatePreview"
                                                       id="timeSheetStartDatePreview">
                                            </div>
                                        </div>
                                        <div class="form-group" id="timeSheetEndDateDiv">
                                            <label for="timeSheetEndDatePreview"
                                                   class="control-label col-xs-4 col-sm-4 col-md-4"><?php echo $leafTranslation['timeSheetEndDateLabel']; ?></label>

                                            <div class="col-xs-8 col-sm-8 col-md-8">
                                                <input class="form-control" type="text" name="timeSheetEndDatePreview"
                                                       id="timeSheetEndDatePreview">
                                            </div>
                                        </div>
                                        <div class="form-group" id="timeSheetStartTimeDiv">
                                            <label for="timeSheetStartTimePreview"
                                                   class="control-label col-xs-4 col-sm-4 col-md-4"><?php echo $leafTranslation['timeSheetStartTimeLabel']; ?></label>

                                            <div class="col-xs-8 col-sm-8 col-md-8">
                                                <input class="form-control" type="text" name="timeSheetStartTimePreview"
                                                       id="timeSheetStartTimePreview">
                                            </div>
                                        </div>
                                        <div class="form-group" id="timeSheetEndTimeDiv">
                                            <label for="timeSheetEndTimePreview"
                                                   class="control-label col-xs-4 col-sm-4 col-md-4"><?php echo $leafTranslation['timeSheetEndTimeLabel']; ?></label>

                                            <div class="col-xs-8 col-sm-8 col-md-8">
                                                <input class="form-control" type="text" name="timeSheetEndTimePreview"
                                                       id="timeSheetEndTimePreview">
                                            </div>
                                        </div>
                                    </form>
                                </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="panel panel-default">
                                <table class="table table table-bordered table-striped table-condensed table-hover smart-form has-tickbox" id="tableData">
                                    ...
                                    <th><?php echo ucwords($leafTranslation['referenceNumberLabel']); ?></th>
                                    <th><?php echo ucwords($leafTranslation['timeSheetStartDateLabel']); ?></th>
                                    <th><?php echo ucwords($leafTranslation['timeSheetEndDateLabel']); ?></th>
                                    <th><?php echo ucwords($leafTranslation['timeSheetStartTimeLabel']); ?></th>
                                    <th><?php echo ucwords($leafTranslation['timeSheetEndTimeLabel']); ?></th>
                                    <th><?php echo ucwords($leafTranslation['timeSheetNoteLabel']); ?></th>
                                    <th width="100px">
                                    ...
                                    <tbody id="tableBody">
                                        ...
                                        if ($_POST['method'] == 'read' && $_POST['type'] == 'list' && $_POST['detail'] == 'body') {
                                            if (is_array($timeSheetArray)) {
                                                $totalRecord = intval(count($timeSheetArray));
                                                if ($totalRecord > 0) {
                                                    $counter = 0;
                                                    for ($i = 0; $i < $totalRecord; $i++) {
                                                        ...
                                                        ?>
                                                        <tr <?php
                                                        if ($timeSheetArray[$i]['isDelete'] == 1) {
                                                            echo "class=\"danger\"";
                                                        } else {
                                                            if ($timeSheetArray[$i]['isDraft'] == 1) {
                                                                echo "class=\"warning\"";
                                                            }
                                                        }
                                                        ?>>
                                                            ...
                                                            <td>
                                                                <div class="btn-group">
                                                                    ...
                                                                    <button type="button"  class="btn btn-danger btn-sm" title="Delete"
                                                                            ...
                                                                            ?>', '<?php
                                                                            echo rawurlencode(
                                                                                    $timeSheetArray [$i]['employeeName']
                                                                            );
                                                                            ?>', '<?php
                                                                            echo rawurlencode(
                                                                                    $timeSheetArray [$i]['timeSheetNote']
                                                                            );
                                                                            ?>', '<?php
                                                                            echo rawurlencode(
                                                                                    $timeSheetArray [$i]['documentNumber']
                                                                            );
                                                                            ?>', '<?php
                                                                            echo rawurlencode(
                                                                                    $timeSheetArray [$i]['referenceNumber']
                                                                            );
                                                                            ?>', '<?php
                                                                            echo rawurlencode(
                                                                                    $timeSheetArray [$i]['timeSheetStartDate']
                                                                            );
                                                                            ?>', '<?php
                                                                            echo rawurlencode(
                                                                                    $timeSheetArray [$i]['timeSheetEndDate']
                                                                            );
                                                                            ?>', '<?php
                                                                            echo rawurlencode(
                                                                                    $timeSheetArray [$i]['timeSheetStartTime']
                                                                            );
                                                                            ?>', '<?php
                                                                            echo rawurlencode(
                                                                                    $timeSheetArray [$i]['timeSheetEndTime']
                                                                            );
                                                                            ?>');">
                                                            ...
                                                            <td>
                                                                <div class="pull-left">
                                                                    <?php
                                                                    if (isset($timeSheetArray[$i]['employeeName'])) {
                                                                        if (isset($_POST['query']) || isset($_POST['character'])) {
                                                                            if (isset($_POST['query']) && strlen($_POST['query']) > 0) {
                                                                                if (strpos($timeSheetArray[$i]['employeeName'], $_POST['query']) !== false) {
                                                                                    echo str_replace(
                                                                                            $_POST['query'], "<span class=\"label label-info\">" . $_POST['query'] . "</span>", $timeSheetArray[$i]['employeeName']
                                                                                    );
                                                                                } else {
                                                                                    echo $timeSheetArray[$i]['employeeName'];
                                                                                }
                                                                            } else {
                                                                                if (isset($_POST['character']) && strlen($_POST['character']) > 0) {
                                                                                    if (strpos(
                                                                                                    $timeSheetArray[$i]['employeeName'], $_POST['character']
                                                                                            ) !== false
                                                                                    ) {
                                                                                        echo str_replace(
                                                                                                $_POST['character'], "<span class=\"label label-info\">" . $_POST['character'] . "</span>", $timeSheetArray[$i]['employeeName']
                                                                                        );
                                                                                    } else {
                                                                                        echo $timeSheetArray[$i]['employeeName'];
                                                                                    }
                                                            ...
                                                            <td>
                                                                <div class="pull-left">
                                                                    <?php
                                                                    if (isset($timeSheetArray[$i]['documentNumber'])) {
                                                                        if (isset($_POST['query']) || isset($_POST['character'])) {
                                                                            if (isset($_POST['query']) && strlen($_POST['query']) > 0) {
                                                                                if (strpos(
                                                                                                strtolower($timeSheetArray[$i]['documentNumber']), strtolower($_POST['query'])
                                                                                        ) !== false
                                                                                ) {
                                                                                    echo str_replace(
                                                                                            $_POST['query'], "<span class=\"label label-info\">" . $_POST['query'] . "</span>", $timeSheetArray[$i]['documentNumber']
                                                                                    );
                                                                                } else {
                                                                                    echo $timeSheetArray[$i]['documentNumber'];
                                                                                }
                                                                            } else {
                                                                                if (isset($_POST['character']) && strlen($_POST['character']) > 0) {
                                                                                    if (strpos(
                                                                                                    strtolower($timeSheetArray[$i]['documentNumber']), strtolower($_POST['character'])
                                                                                            ) !== false
                                                                                    ) {
                                                                                        echo str_replace(
                                                                                                $_POST['character'], "<span class=\"label label-info\">" . $_POST['character'] . "</span>", $timeSheetArray[$i]['documentNumber']
                                                                                        );
                                                                                    } else {
                                                                                        echo $timeSheetArray[$i]['documentNumber'];
                                                                                    }
                                                            ...
                                                            <td>
                                                                <div class="pull-left">
                                                                    <?php
                                                                    if (isset($timeSheetArray[$i]['referenceNumber'])) {
                                                                        if (isset($_POST['query']) || isset($_POST['character'])) {
                                                                            if (isset($_POST['query']) && strlen($_POST['query']) > 0) {
                                                                                if (strpos(
                                                                                                strtolower($timeSheetArray[$i]['referenceNumber']), strtolower($_POST['query'])
                                                                                        ) !== false
                                                                                ) {
                                                                                    echo str_replace(
                                                                                            $_POST['query'], "<span class=\"label label-info\">" . $_POST['query'] . "</span>", $timeSheetArray[$i]['referenceNumber']
                                                                                    );
                                                                                } else {
                                                                                    echo $timeSheetArray[$i]['referenceNumber'];
                                                                                }
                                                                            } else {
                                                                                if (isset($_POST['character']) && strlen($_POST['character']) > 0) {
                                                                                    if (strpos(
                                                                                                    strtolower($timeSheetArray[$i]['referenceNumber']), strtolower($_POST['character'])
                                                                                            ) !== false
                                                                                    ) {
                                                                                        echo str_replace(
                                                                                                $_POST['character'], "<span class=\"label label-info\">" . $_POST['character'] . "</span>", $timeSheetArray[$i]['referenceNumber']
                                                                                        );
                                                                                    } else {
                                                                                        echo $timeSheetArray[$i]['referenceNumber'];
                                                                                    }
                                                            ...
                                                            <?php
                                                            if (isset($timeSheetArray[$i]['timeSheetStartDate'])) {
                                                                $valueArray = $timeSheetArray[$i]['timeSheetStartDate'];
                                                            ...
                                                            <?php } ?>
                                                            <?php
                                                            if (isset($timeSheetArray[$i]['timeSheetEndDate'])) {
                                                                $valueArray = $timeSheetArray[$i]['timeSheetEndDate'];
                                                                if ($dateConvert->checkDate($valueArray)) {
                                                                    $valueData = explode('-', $valueArray);
                                                                    $year = $valueData[0];
                                                                    $month = $valueData[1];
                                                            ...
                                                            <td>
                                                                <div class="pull-left">
                                                                    <?php
                                                                    if (isset($timeSheetArray[$i]['timeSheetStartTime'])) {
                                                                        if (isset($_POST['query']) || isset($_POST['character'])) {
                                                                            if (isset($_POST['query']) && strlen($_POST['query']) > 0) {
                                                                                if (strpos(
                                                                                                strtolower($timeSheetArray[$i]['timeSheetStartTime']), strtolower($_POST['query'])
                                                                                        ) !== false
                                                                                ) {
                                                                                    echo str_replace(
                                                                                            $_POST['query'], "<span class=\"label label-info\">" . $_POST['query'] . "</span>", $timeSheetArray[$i]['timeSheetStartTime']
                                                                                    );
                                                                                } else {
                                                                                    echo $timeSheetArray[$i]['timeSheetStartTime'];
                                                                                }
                                                                            } else {
                                                                                if (isset($_POST['character']) && strlen($_POST['character']) > 0) {
                                                                                    if (strpos(
                                                                                                    strtolower($timeSheetArray[$i]['timeSheetStartTime']), strtolower($_POST['character'])
                                                                                            ) !== false
                                                                                    ) {
                                                                                        echo str_replace(
                                                                                                $_POST['character'], "<span class=\"label label-info\">" . $_POST['character'] . "</span>", $timeSheetArray[$i]['timeSheetStartTime']
                                                                                        );
                                                                                    } else {
                                                                                        echo $timeSheetArray[$i]['timeSheetStartTime'];
                                                                                    }
                                                            ...
                                                            <td>
                                                                <div class="pull-left">
                                                                    <?php
                                                                    if (isset($timeSheetArray[$i]['timeSheetEndTime'])) {
                                                                        if (isset($_POST['query']) || isset($_POST['character'])) {
                                                                            if (isset($_POST['query']) && strlen($_POST['query']) > 0) {
                                                                                if (strpos(
                                                                                                strtolower($timeSheetArray[$i]['timeSheetEndTime']), strtolower($_POST['query'])
                                                                                        ) !== false
                                                                                ) {
                                                                                    echo str_replace(
                                                                                            $_POST['query'], "<span class=\"label label-info\">" . $_POST['query'] . "</span>", $timeSheetArray[$i]['timeSheetEndTime']
                                                                                    );
                                                                                } else {
                                                                                    echo $timeSheetArray[$i]['timeSheetEndTime'];
                                                                                }
                                                                            } else {
                                                                                if (isset($_POST['character']) && strlen($_POST['character']) > 0) {
                                                                                    if (strpos(
                                                                                                    strtolower($timeSheetArray[$i]['timeSheetEndTime']), strtolower($_POST['character'])
                                                                                            ) !== false
                                                                                    ) {
                                                                                        echo str_replace(
                                                                                                $_POST['character'], "<span class=\"label label-info\">" . $_POST['character'] . "</span>", $timeSheetArray[$i]['timeSheetEndTime']
                                                                                        );
                                                                                    } else {
                                                                                        echo $timeSheetArray[$i]['timeSheetEndTime'];
                                                                                    }
                                                            ...
                                                            <td>
                                                                <div class="pull-left">
                                                                    <?php
                                                                    if (isset($timeSheetArray[$i]['timeSheetNote'])) {
                                                                        if (isset($_POST['query']) || isset($_POST['character'])) {
                                                                            if (isset($_POST['query']) && strlen($_POST['query']) > 0) {
                                                                                if (strpos(
                                                                                                strtolower($timeSheetArray[$i]['timeSheetNote']), strtolower($_POST['query'])
                                                                                        ) !== false
                                                                                ) {
                                                                                    echo str_replace(
                                                                                            $_POST['query'], "<span class=\"label label-info\">" . $_POST['query'] . "</span>", $timeSheetArray[$i]['timeSheetNote']
                                                                                    );
                                                                                } else {
                                                                                    echo $timeSheetArray[$i]['timeSheetNote'];
                                                                                }
                                                                            } else {
                                                                                if (isset($_POST['character']) && strlen($_POST['character']) > 0) {
                                                                                    if (strpos(
                                                                                                    strtolower($timeSheetArray[$i]['timeSheetNote']), strtolower($_POST['character'])
                                                                                            ) !== false
                                                                                    ) {
                                                                                        echo str_replace(
                                                                                                $_POST['character'], "<span class=\"label label-info\">" . $_POST['character'] . "</span>", $timeSheetArray[$i]['timeSheetNote']
                                                                                        );
                                                                                    } else {
                                                                                        echo $timeSheetArray[$i]['timeSheetNote'];
                                                                                    }
                                                            ...
                                                            <td>
                                                                <div align="center">
                                                                    <?php
                                                                    if (isset($timeSheetArray[$i]['executeBy'])) {
                                                                        if (isset($_POST['query']) || isset($_POST['character'])) {
                                                                            if (isset($_POST['query']) && strlen($_POST['query']) > 0) {
                                                                                if (strpos($timeSheetArray[$i]['staffName'], $_POST['query']) !== false) {
                                                                                    echo str_replace(
                                                                                            $_POST['query'], "<span class=\"label label-info\">" . $_POST['query'] . "</span>", $timeSheetArray[$i]['staffName']
                                                                                    );
                                                                                } else {
                                                                                    echo $timeSheetArray[$i]['staffName'];
                                                                                }
                                                                            } else {
                                                                                if (isset($_POST['character']) && strlen($_POST['character']) > 0) {
                                                                                    if (strpos(
                                                                                                    $timeSheetArray[$i]['staffName'], $_POST['character']
                                                                                            ) !== false
                                                                                    ) {
                                                                                        echo str_replace(
                                                                                                $_POST['character'], "<span class=\"label label-info\">" . $_POST['character'] . "</span>", $timeSheetArray[$i]['staffName']
                                                                                        );
                                                                                    } else {
                                                                                        echo $timeSheetArray[$i]['staffName'];
                                                                                    }
                                                            ...
                                                            <?php
                                                            if (isset($timeSheetArray[$i]['executeTime'])) {
                                                                $valueArray = $timeSheetArray[$i]['executeTime'];
                                                            ...
                                                            ?>
                                                            <td>
                                                                <input style="display:none;" type="checkbox" name="timeSheetId[]"
                                                                       value="<?php echo $timeSheetArray[$i]['timeSheetId']; ?>">
                                                                <input <?php echo $checked; ?> type="checkbox" name="isDelete[]"
                                                                                               value="<?php echo $timeSheetArray[$i]['isDelete']; ?>">
                                                            </td>
                                                        </tr>
                                                        <?php
                                                    }
                        ...
                        <div class="col-xs-3 col-sm-3 col-md-3 pagination">
                            <div class="pull-right">
                                <button class="delete btn btn-warning" type="button" 
                                        ...
                                        echo $timeSheet->getControllerPath();
                                        ?>', '<?php echo $timeSheet->getViewPath(); ?>', '<?php echo $securityToken; ?>');">
...
if ((isset($_POST['method']) == 'new' || isset($_POST['method']) == 'read') && $_POST['type'] == 'form') {
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            <input type="hidden" name="timeSheetId" id="timeSheetId" value="<?php
                            if (isset($_POST['timeSheetId'])) {
                                echo $_POST['timeSheetId'];
                            }
                            ?>">
                                            ...
                                            <select name="employeeId" id="employeeId" class="chzn-select form-control"
                                                ...
                                                if (is_array($employeeArray)) {
                                                    ...
                                                    if ($totalRecord > 0) {
                                                        $d = 1;
                                                        for ($i = 0; $i < $totalRecord; $i++) {
                                                            if (isset($timeSheetArray[0]['employeeId'])) {
                                                                if ($timeSheetArray[0]['employeeId'] == $employeeArray[$i]['employeeId']) {
                                                                    $selected = "selected";
                                                                } else {
                                                                    $selected = null;
                                                                }
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="col-xs-6 col-sm-6 col-md-6 form-group" id="documentNumberForm">
                                        ...
                                        <div class="col-xs-8 col-sm-8 col-md-8">
                                            <input type="text" class="form-control" name="documentNumber" id="documentNumber" value="<?php
                                            if (isset($timeSheetArray) && is_array($timeSheetArray)) {
                                                if (isset($timeSheetArray[0]['documentNumber'])) {
                                                    echo htmlentities($timeSheetArray[0]['documentNumber']);
                                                }
                                            }
                                    ...
                                    <div class="col-xs-6 col-sm-6 col-md-6 form-group" id="referenceNumberForm">
                                        ...
                                        <div class="col-xs-8 col-sm-8 col-md-8">
                                            <input type="text" class="form-control" name="referenceNumber" id="referenceNumber"
                                                   onKeyUp="removeMeError('referenceNumber');" value="<?php
                                                   if (isset($timeSheetArray) && is_array($timeSheetArray)) {
                                                       if (isset($timeSheetArray[0]['referenceNumber'])) {
                                                           echo htmlentities($timeSheetArray[0]['referenceNumber']);
                                                       }
                                                   }
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <?php
                                    if (isset($timeSheetArray) && is_array($timeSheetArray)) {
                                        if (isset($timeSheetArray[0]['timeSheetStartDate'])) {
                                            $valueArray = $timeSheetArray[0]['timeSheetStartDate'];
                                            if ($dateConvert->checkDate($valueArray)) {
                                                $valueData = explode('-', $valueArray);
                                                $year = $valueData[0];
                                                $month = $valueData[1];
                                    ...
                                    ?>
                                    <div class="col-xs-6 col-sm-6 col-md-6 form-group" id="timeSheetStartDateForm">
                                        <label for="timeSheetStartDate" class="control-label col-xs-4 col-sm-4 col-md-4"><strong><?php
                                                echo ucfirst(
                                                        $leafTranslation['timeSheetStartDateLabel']
                                                );
                                                ?></strong></label>

                                        <div class="col-xs-8 col-sm-8 col-md-8">
                                            <input type="text" class="form-control" name="timeSheetStartDate" id="timeSheetStartDate"
                                                   value="<?php
                                                   if (isset($value)) {
                                                       echo $value;
                                                   }
                                                   ?>"> <span class="help-block" id="timeSheetStartDateHelpMe"></span>
                                        </div>
                                    </div>
                                    <?php
                                    if (isset($timeSheetArray) && is_array($timeSheetArray)) {
                                        if (isset($timeSheetArray[0]['timeSheetEndDate'])) {
                                            $valueArray = $timeSheetArray[0]['timeSheetEndDate'];
                                            if ($dateConvert->checkDate($valueArray)) {
                                                $valueData = explode('-', $valueArray);
                                                $year = $valueData[0];
                                                $month = $valueData[1];
                                    ...
                                    ?>
                                    <div class="col-xs-6 col-sm-6 col-md-6 form-group" id="timeSheetEndDateForm">
                                        <label for="timeSheetEndDate" class="control-label col-xs-4 col-sm-4 col-md-4"><strong><?php
                                                echo ucfirst(
                                                        $leafTranslation['timeSheetEndDateLabel']
                                                );
                                                ?></strong></label>

                                        <div class="col-xs-8 col-sm-8 col-md-8">
                                            <input type="text" class="form-control" name="timeSheetEndDate" id="timeSheetEndDate"
                                                   value="<?php
                                                   if (isset($value)) {
                                                       echo $value;
                                                   }
                                                   ?>"> <span class="help-block" id="timeSheetEndDateHelpMe"></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="col-xs-6 col-sm-6 col-md-6 form-group" id="timeSheetStartTimeForm">
                                        <label for="timeSheetStartTime" class="control-label col-xs-4 col-sm-4 col-md-4"><strong><?php
                                                echo ucfirst(
                                                        $leafTranslation['timeSheetStartTimeLabel']
                                                );
                                                ?></strong></label>

                                        <div class="col-xs-8 col-sm-8 col-md-8">
                                            <div class="input-group bootstrap-timepicker">
                                                <input id="timeSheetStartTime" name="timeSheetStartTime" type="text" class="form-control">
                                                <span class="input-group-addon"><i class="glyphicontime"></i></span>
                                            </div>
                                            <span class="help-block" id="timeSheetStartTimeHelpMe"></span>
                                        </div>
                                    </div>
                                    <div class="col-xs-6 col-sm-6 col-md-6 form-group" id="timeSheetEndTimeForm">
                                        <label for="timeSheetEndTime" class="control-label col-xs-4 col-sm-4 col-md-4"><strong><?php
                                                echo ucfirst(
                                                        $leafTranslation['timeSheetEndTimeLabel']
                                                );
                                                ?></strong></label>

                                        <div class="col-xs-8 col-sm-8 col-md-8">
                                            <div class="input-group bootstrap-timepicker">
                                                <input id="timeSheetEndTime" name="timeSheetEndTime" type="text" class="form-control">
                                                <span class="input-group-addon"><i class="glyphicontime"></i></span>
                                            </div>
                                            <span class="help-block" id="timeSheetEndTimeHelpMe"></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group" id="timeSheetNoteForm">
                                        <div class="col-xs-12 col-sm-12 col-md-12">
                                            <textarea rows="5" class="form-control" name="timeSheetNote" id="timeSheetNote"
                                                      onKeyUp="removeMeError('timeSheetNote', 12)"><?php
                                                          if (isset($timeSheetArray[0]['timeSheetNote'])) {
                                                              echo htmlentities($timeSheetArray[0]['timeSheetNote']);
                                                          }
                                                          ?></textarea> <span class="help-block" id="timeSheetNoteHelpMe"></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <?php if ($leafAccess['leafAccessCreateValue'] == 1) { ?>
                            newRecord(<?php echo $leafId; ?>, '<?php echo $timeSheet->getControllerPath(); ?>', '<?php echo $timeSheet->getViewPath(); ?>', '<?php echo $securityToken; ?>', 1);
    <?php } ?>
                        return false;
                    }
                    // shift+s save event
    ...
    <?php if ($leafAccess['leafAccessUpdateValue'] == 1) { ?>
                            updateRecord(<?php echo $leafId; ?>, '<?php echo $timeSheet->getControllerPath(); ?>', '<?php echo $timeSheet->getViewPath(); ?>', '<?php echo $securityToken; ?>', 1, <?php echo $leafAccess['leafAccessDeleteValue']; ?>);
    <?php } ?>
                        return false;
                    }
    ...
    <?php if ($leafAccess['leafAccessDeleteValue'] == 1) { ?>
                            deleteRecord(<?php echo $leafId; ?>, '<?php echo $timeSheet->getControllerPath(); ?>', '<?php echo $timeSheet->getViewPath(); ?>', '<?php echo $securityToken; ?>', <?php echo $leafAccess['leafAccessDeleteValue']; ?>);
    ...
    <?php } ?>
                    ...
                    switch (e.keyCode) {
                        case 37:
                            previousRecord(<?php echo $leafId; ?>, '<?php echo $timeSheet->getControllerPath(); ?>', '<?php echo $timeSheet->getViewPath(); ?>', '<?php echo $securityToken; ?>', <?php echo $leafAccess['leafAccessUpdateValue']; ?>, <?php echo $leafAccess['leafAccessDeleteValue']; ?>);
                            
                            return false;
                            break;
                        case 39:
                            nextRecord(<?php echo $leafId; ?>, '<?php echo $timeSheet->getControllerPath(); ?>', '<?php echo $timeSheet->getViewPath(); ?>', '<?php echo $securityToken; ?>', <?php echo $leafAccess['leafAccessUpdateValue']; ?>, <?php echo $leafAccess['leafAccessDeleteValue']; ?>);
                ...
                $(document).ready(function() {
                    ...
                    $('#timeSheetStartTime').timepicker();
                    $('#timeSheetEndTime').timepicker();
    <?php if ($_POST['method'] == "new") { ?>
                        $('#resetRecordButton').removeClass().addClass('btn btn-default');
        <?php if ($leafAccess['leafAccessCreateValue'] == 1) { ?>
                            $('#newRecordButton1').removeClass().addClass('btn btn-success').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $timeSheet->getControllerPath(); ?>','<?php echo $timeSheet->getViewPath(); ?>','<?php echo $securityToken; ?>',1)");
                            $('#newRecordButton2').removeClass().addClass('btn dropdown-toggle btn-success');
                            $('#newRecordButton3').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $timeSheet->getControllerPath(); ?>','<?php echo $timeSheet->getViewPath(); ?>','<?php echo $securityToken; ?>',1)");
                            $('#newRecordButton4').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $timeSheet->getControllerPath(); ?>','<?php echo $timeSheet->getViewPath(); ?>','<?php echo $securityToken; ?>',2)");
                            $('#newRecordButton5').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $timeSheet->getControllerPath(); ?>','<?php echo $timeSheet->getViewPath(); ?>','<?php echo $securityToken; ?>',3)");
                            $('#newRecordButton6').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $timeSheet->getControllerPath(); ?>','<?php echo $timeSheet->getViewPath(); ?>','<?php echo $securityToken; ?>',4)");
                            $('#newRecordButton7').attr('onClick', "newRecord(<?php echo $leafId; ?>,'<?php echo $timeSheet->getControllerPath(); ?>','<?php echo $timeSheet->getViewPath(); ?>','<?php echo $securityToken; ?>',5)");
        <?php } else { ?>
        ...
        if ($_POST['timeSheetId']) {
            ...
            <?php if ($leafAccess['leafAccessUpdateValue'] == 1) { ?>
                                $('#updateRecordButton1').removeClass().addClass('btn btn-info').attr('onClick', "updateRecord(<?php echo $leafId; ?>,'<?php echo $timeSheet->getControllerPath(); ?>','<?php echo $timeSheet->getViewPath(); ?>','<?php echo $securityToken; ?>',1,<?php echo $leafAccess['leafAccessDeleteValue']; ?>);");
                                $('#updateRecordButton2').removeClass().addClass('btn dropdown-toggle btn-info');
                                $('#updateRecordButton3').attr('onClick', "updateRecord(<?php echo $leafId; ?>,'<?php echo $timeSheet->getControllerPath(); ?>','<?php echo $timeSheet->getViewPath(); ?>','<?php echo $securityToken; ?>',1,<?php echo $leafAccess['leafAccessDeleteValue']; ?>);");
                                $('#updateRecordButton4').attr('onClick', "updateRecord(<?php echo $leafId; ?>,'<?php echo $timeSheet->getControllerPath(); ?>','<?php echo $timeSheet->getViewPath(); ?>','<?php echo $securityToken; ?>',2,<?php echo $leafAccess['leafAccessDeleteValue']; ?>);");
                                $('#updateRecordButton5').attr('onClick', "updateRecord(<?php echo $leafId; ?>,'<?php echo $timeSheet->getControllerPath(); ?>','<?php echo $timeSheet->getViewPath(); ?>','<?php echo $securityToken; ?>',3,<?php echo $leafAccess['leafAccessDeleteValue']; ?>);");
            <?php } else { ?>
                                $('#updateRecordButton1').removeClass().addClass(' btn btn-info disabled').attr('onClick', '');
                                $('#updateRecordButton2').removeClass().addClass('btn dropdown-toggle btn-info disabled');
                                $('#updateRecordButton3').attr('onClick', '');
            ...
            <?php } ?>
            <?php if ($leafAccess['leafAccessDeleteValue'] == 1) { ?>
                                $('#deleteRecordButton').removeClass().addClass('btn btn-danger').attr('onClick', "deleteRecord(<?php echo $leafId; ?>,'<?php echo $timeSheet->getControllerPath(); ?>','<?php echo $timeSheet->getViewPath(); ?>','<?php echo $securityToken; ?>',<?php echo $leafAccess['leafAccessDeleteValue']; ?>);");
            <?php } else { ?>
                                $('#deleteRecordButton').removeClass().addClass('btn btn-danger disabled').attr('onClick', '');
            <?php } ?>
            <?php
...
<?php } ?>
<script type="text/javascript" src="./v3/humanResource/timeSheet/javascript/timeSheet.js"></script>
<hr>
