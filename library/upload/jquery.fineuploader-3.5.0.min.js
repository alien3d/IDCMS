...
qq.supportedFeatures = function () {
    ...
    return{uploading: a, ajaxUploading: b, fileDrop: b, folderDrop: c, chunking: d,
        resume: e, uploadCustomHeaders: b, uploadNonMultipart: b, itemSizeValidation: b, uploadViaPaste: f, progressBar: b, uploadCors: a && (void 0 !== window.postMessage || b), deleteFileCors: b}
}();
qq.Promise = function () {
    var a, b, c, d, e, f = 0;
...
qq.UploadButton = function (a) {
    function b() {
        ...
        qq(a).css({position: "absolute", right: 0, top: 0, fontFamily: "Arial", fontSize: "118px", margin: 0, padding: 0, cursor: "pointer", opacity: 0});
...
qq.FineUploaderBasic = function (a) {
    this._options = {debug: !1, button: null, multiple: !0, maxConnections: 3, disableCancelForFormUploads: !1, autoUpload: !0, request: {endpoint: "/server/upload", params: {}, paramsInBody: !0, customHeaders: {}, forceMultipart: !0, inputName: "qqfile", uuidName: "qquuid", totalFileSizeName: "qqtotalfilesize"}, validation: {allowedExtensions: [], sizeLimit: 0, minSizeLimit: 0, itemLimit: 0, stopOnFirstInvalidFile: !0}, callbacks: {onSubmit: function () {
        ...
        }}, messages: {typeError: "{file} has an invalid extension. Valid extension(s): {extensions}.", sizeError: "{file} is too large, maximum file size is {sizeLimit}.", minSizeError: "{file} is too small, minimum file size is {minSizeLimit}.",
        ...
        deleteFile: {enabled: !1, endpoint: "/server/upload", customHeaders: {}, params: {}}, cors: {expected: !1, sendCredentials: !1}, blobs: {defaultName: "misc_data", paramNames: {name: "qqblobname"}}, paste: {targetElement: null, defaultName: "pasted_image"}};
...
qq.FineUploaderBasic.prototype = {log: function (a, b) {
    ...
    getNetUploads: function () {
        ...
        var b = this, c = new qq.UploadButton({element: a, multiple: this._options.multiple && qq.supportedFeatures.ajaxUploading, acceptFiles: this._options.validation.acceptFiles, onChange: function (a) {
            b._onInputChange(a)
        ...
        var a = this;
        return new qq.UploadHandler({debug: this._options.debug,
            forceMultipart: this._options.request.forceMultipart, maxConnections: this._options.maxConnections, customHeaders: this._options.request.customHeaders, inputName: this._options.request.inputName, uuidParamName: this._options.request.uuidName, totalFileSizeParamName: this._options.request.totalFileSizeName, cors: this._options.cors, demoMode: this._options.demoMode, paramsInBody: this._options.request.paramsInBody, paramsStore: this._paramsStore, endpointStore: this._endpointStore, chunking: this._options.chunking, resume: this._options.resume,
            blobs: this._options.blobs, log: function (b, c) {
                a.log(b, c)
        ...
        var a = this;
        return new qq.DeleteFileAjaxRequestor({maxConnections: this._options.maxConnections,
            customHeaders: this._options.deleteFile.customHeaders, paramsStore: this._deleteFileParamsStore, endpointStore: this._deleteFileEndpointStore, demoMode: this._options.demoMode, cors: this._options.cors, log: function (b, c) {
                a.log(b, c)
            }, onDelete: function (b) {
                a._onDelete(b);
        ...
        var a = this;
        return new qq.PasteSupport({targetElement: this._options.paste.targetElement,
            callbacks: {log: function (b, c) {
                a.log(b, c)
...
qq.DragAndDrop = function (a) {
    ...
    function d(a) {
        m = new qq.UploadDropZone({element: a, onEnter: function (b) {
...
qq.FineUploader = function (a) {
    ...
    qq.extend(this._options, {element: null, listElement: null, dragAndDrop: {extraDropzones: [], hideDropzones: !0, disableDefaultDropzone: !1}, text: {uploadButton: "Upload a file", cancelButton: "Cancel", retryButton: "Retry", deleteButton: "Delete", failUpload: "Upload failed", dragZone: "Drop files here to upload", dropProcessing: "Processing dropped files...", formatProgress: "{percent}% of {total_size}", waitingForResponse: "Processing..."}, template: '<div class="qq-uploader">' +
        ...
        classes: {button: "qq-upload-button", drop: "qq-upload-drop-area", dropActive: "qq-upload-drop-area-active", list: "qq-upload-list", progressBar: "qq-progress-bar", file: "qq-upload-file", spinner: "qq-upload-spinner", finished: "qq-upload-finished", retrying: "qq-upload-retrying", retryable: "qq-upload-retryable", size: "qq-upload-size", cancel: "qq-upload-cancel", deleteButton: "qq-upload-delete", retry: "qq-upload-retry", statusText: "qq-upload-status-text", success: "qq-upload-success", fail: "qq-upload-fail", successIcon: null,
            ...
            deletingStatusText: "Deleting...", deletingFailedText: "Delete failed"}, display: {fileSizeOnSubmit: !1}, paste: {promptForName: !1, namePromptMessage: "Please name this image"}, showMessage: function (a) {
            setTimeout(function () {
                window.alert(a)
            }, 0)
...
qq.AjaxRequestor = function (a) {
    ...
    var m, i, g = [], n = [], j = {method: "POST", maxConnections: 3, customHeaders: {}, endpointStore: {}, paramsStore: {}, successfulResponseCodes: [200], demoMode: !1, cors: {expected: !1, sendCredentials: !1}, log: function () {
    }, onSend: function () {
    }, onComplete: function () {
    }, onCancel: function () {
    }};
...
qq.UploadHandlerForm = function (a, b, c) {
    ...
    function i(a, b) {
        var c = g.paramsStore.getParams(a), d = qq.toElement('<form method="' + (g.demoMode ? "GET" : "POST") + '" enctype="multipart/form-data"></form>'), e = g.endpointStore.getEndpoint(a), f = e;
...
qq.UploadHandlerXhr = function (a, b, c) {
    ...
    function e(a, b) {
        var c = k.chunking.partSize, d = p.getSize(a), e = h[a].file || h[a].blobData.blob, g = c * b, c = g + c >= d ? d : g + c, d = f(a), l;
    ...
    function i(a, b, c, d) {
        var e = new FormData, f = k.demoMode ? "GET" : "POST", g = k.endpointStore.getEndpoint(d), l = g, j = p.getName(d), o = p.getSize(d), i = h[d].blobData;
    ...
    function j(a) {
        ...
        f.upload.onprogress = function (c) {
            if (c.lengthComputable) {
                var d = c.loaded + h[a].loaded, c = c.total, f = e(a, b), c = c - f.size, g = p.getSize(a), f = f.count, l = c - h[a].initialRequestOverhead;
    ...
    function s(a) {
        var b = p.getName(a), a = p.getSize(a), c = k.chunking.partSize, b = "qqfilechunk" + q + encodeURIComponent(b) + q + a + q +
            c;
        void 0 !== y && (b += q + y);
        return b
    }
    ...
    var k = a, B = b, t = c, h = [], q = "|", A = k.chunking.enabled && qq.supportedFeatures.chunking, v = k.resume.enabled && A && qq.supportedFeatures.resume, y;
    y = null !== k.resume.id &&
                    ...
                    a:{
                        ...
                        if (g) {
                            ...
                            if (5 === g.length) {
                                ...
                                n = parseInt(g[3], 10);
                                g = parseInt(g[4], 10);
                                g = {uuid: l, part: o, lastByteSent: i, initialRequestOverhead: n, estTotalRequestsSize: g};
                                break a
                            }
...
(function (a) {
    ...
    a.fn.fineUploaderDnd = function (d) {
        ...
        this.each(function (m, o) {
            ...
            } else"object" === typeof d || !d ? b.apply(e, j) : a.error("Method " + d + " does not exist in Fine Uploader's DnD module.")
        });
